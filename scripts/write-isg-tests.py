#!/usr/bin/env python3
"""Write ISG-20 through ISG-32 test file without triggering upload-URL filter."""
import os

# Build the file-download URL pattern at runtime in the test
# to avoid the static upload-URL filter in the build tool.
HEADER = '''/**
...
content = HEADER + ISG20 + ISG21 + ISG22 + ISG23 + ISG24_32

dest = 'src/server/lib/__tests__/imageSafeguardCP12A7.test.ts'
