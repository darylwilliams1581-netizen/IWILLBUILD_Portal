import{createRequire as o}from"module";import{d}from"../server.bundle.mjs";import{s as _}from"./drizzle-Bu3hp1FF.js";import"./express-WU0_rYSr.js";import"tty";import"os";import"util";import"path";import"./iconv-DatUeE_T.js";import"buffer";import"string_decoder";import"node:zlib";import"./es-abstract-B57Whf45.js";import"url";import"node:fs";import"node:path";import"fs";import"crypto";import"node:http";import"node:buffer";import"node:querystring";import"node:net";import"stream";import"node:events";import"./radix-ui-CM1-jrUu.js";import"./react-router-8V4KISLV.js";import"./react-dom-D6zqUVF0.js";import"async_hooks";import"./zod-B-vvil1C.js";import"node:url";import"./mysql2-BJ7xsy_S.js";import"net";import"events";import"process";import"timers";import"tls";import"zlib";import"node:process";import"./better-auth-DxltITEC.js";import"./kysely-9kO2vj_T.js";import"node:crypto";import"./noble-DY0vnRA-.js";import"node:fs/promises";import"node:os";import"./multer-DNTYjcWN.js";import"fs/promises";import"http";import"https";import"assert";const e=o(import.meta.url);async function oi(A,E){const t=[];async function i(T,L){try{await d.execute(_.raw(L)),t.push(`✓ ${T}`)}catch(r){const N=String((r==null?void 0:r.message)??r);N.includes("already exists")||N.includes("Duplicate column name")||N.includes("ER_TABLE_EXISTS")||N.includes("ER_DUP_FIELDNAME")?t.push(`~ ${T} (already exists)`):(t.push(`✗ ${T}: ${N}`),console.warn(`[migrate-plan-manager] ${T} failed:`,N))}}await i("project_drawings",`
  ...
  `);const a=t.filter(T=>T.startsWith("✗"));return E.status(a.length?500:200).json({results:t,ok:a.length===0})}export{oi as default};
