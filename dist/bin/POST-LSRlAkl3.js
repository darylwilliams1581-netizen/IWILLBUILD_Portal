import{createRequire as a}from"module";import{d as i}from"../server.bundle.mjs";import{s as r}from"./drizzle-CZ2vWAZ3.js";import"./express-C3pMhyZZ.js";import"tty";import"os";import"util";import"path";import"./iconv-DatUeE_T.js";import"buffer";import"string_decoder";import"node:zlib";import"./es-abstract-B57Whf45.js";import"url";import"node:fs";import"node:path";import"fs";import"crypto";import"node:http";import"node:buffer";import"node:querystring";import"node:net";import"stream";import"node:events";import"./mysql2-HVwznT_d.js";import"net";import"events";import"process";import"timers";import"tls";import"zlib";import"node:process";import"./better-auth-B2r-Xofv.js";import"./kysely-9kO2vj_T.js";import"node:crypto";import"./noble-DY0vnRA-.js";import"node:fs/promises";import"node:os";import"./multer-RX-gfMuA.js";import"fs/promises";import"./jszip-BoIs7TcQ.js";import"node:util";import"http";import"https";import"assert";import"./pdf-lib-MF9mTnF3.js";const s=a(import.meta.url);async function rt(A,m){var e,p;const t=[];try{await i.execute(r`
    ...
    `);Number(((e=o[0])==null?void 0:e.cnt)??0)===0?(await i.execute(r`ALTER TABLE job_photos ADD COLUMN uploaded_by_user_id VARCHAR(36) NULL`),t.push("added uploaded_by_user_id")):t.push("uploaded_by_user_id: already exists")}catch(o){t.push(`uploaded_by_user_id: ${String(o)}`)}try{const o=await i.execute(r`
      SELECT COUNT(*) as cnt FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_SCHEMA = DATABASE()
        AND TABLE_NAME = 'job_photos'
        AND COLUMN_NAME = 'uploaded_by_name'
    `);Number(((p=o[0])==null?void 0:p.cnt)??0)===0?(await i.execute(r`ALTER TABLE job_photos ADD COLUMN uploaded_by_name VARCHAR(255) NULL`),t.push("added uploaded_by_name")):t.push("uploaded_by_name: already exists")}catch(o){t.push(`uploaded_by_name: ${String(o)}`)}m.json({ok:!0,results:t})}export{rt as default};
