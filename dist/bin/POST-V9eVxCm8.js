import{createRequire as m}from"module";import{m as a,d as p}from"../server.bundle.mjs";import{s as L}from"./drizzle-Bu3hp1FF.js";import"./express-WU0_rYSr.js";import"tty";import"os";import"util";import"path";import"./iconv-DatUeE_T.js";import"buffer";import"string_decoder";import"node:zlib";import"./es-abstract-B57Whf45.js";import"url";import"node:fs";import"node:path";import"fs";import"crypto";import"node:http";import"node:buffer";import"node:querystring";import"node:net";import"stream";import"node:events";import"./mysql2-BJ7xsy_S.js";import"net";import"events";import"process";import"timers";import"tls";import"zlib";import"node:process";import"./better-auth-CQVzbiZe.js";import"./kysely-9kO2vj_T.js";import"node:crypto";import"./noble-DY0vnRA-.js";import"./opentelemetry-MOfsRXlr.js";import"node:fs/promises";import"node:os";import"./multer-DNTYjcWN.js";import"fs/promises";import"http";import"https";import"assert";const n=m(import.meta.url);async function rr(e,r){const o=await a(e,r);if(o){if(o.profile.role!=="owner"&&o.profile.role!=="admin")return r.status(403).json({error:"Admin access required"});try{return await p.execute(L.raw(`
    ...
    `)),r.json({ok:!0})}catch(t){const i=t instanceof Error?t.message:String(t);return i.includes("already exists")?r.json({ok:!0,skipped:!0}):(console.error("migrate-emergency-alerts error:",t),r.status(500).json({error:i}))}}}export{rr as default};
