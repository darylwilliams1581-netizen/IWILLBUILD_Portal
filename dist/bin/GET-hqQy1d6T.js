...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
</Relationships>`,"utf8")},{name:"word/document.xml",data:Buffer.from(g,"utf8")}],I=k(y),L=l.replace(/[^a-z0-9_\-. ]/gi,"_");r.setHeader("Content-Type","application/vnd.openxmlformats-officedocument.wordprocessingml.document"),r.setHeader("Content-Disposition",`attachment; filename="${L}.docx"`),r.setHeader("Content-Length",I.length),r.send(I)}catch(t){console.error("Document export DOCX error:",t),r.status(500).json({error:"Export failed",message:String(t)})}}export{Dt as default};
