import{createRequire as N}from"module";import{v as L,d as m}from"../server.bundle.mjs";import{s as n}from"./drizzle-CZ2vWAZ3.js";import"./express-C3pMhyZZ.js";import"tty";import"os";import"util";import"path";import"./iconv-DatUeE_T.js";import"buffer";import"string_decoder";import"node:zlib";import"./es-abstract-B57Whf45.js";import"url";import"node:fs";import"node:path";import"fs";import"crypto";import"node:http";import"node:buffer";import"node:querystring";import"node:net";import"stream";import"node:events";import"./mysql2-HVwznT_d.js";import"net";import"events";import"process";import"timers";import"tls";import"zlib";import"node:process";import"./better-auth-B2r-Xofv.js";import"./kysely-9kO2vj_T.js";import"node:crypto";import"./noble-DY0vnRA-.js";import"node:fs/promises";import"node:os";import"./multer-RX-gfMuA.js";import"fs/promises";import"./jszip-BoIs7TcQ.js";import"node:util";import"http";import"https";import"assert";import"./pdf-lib-MF9mTnF3.js";const a=N(import.meta.url);async function e(s,r){try{return await m.execute(n.raw(r)),{label:s,ok:!0}}catch(t){const i=t instanceof Error?t.message:String(t);return i.includes("Duplicate column")||i.includes("already exists")?{label:s,ok:!0,skipped:!0}:{label:s,ok:!1,error:i}}}async function se(s,r){const t=await L(s,r);if(!t)return;if(t.profile.role!=="owner"&&t.profile.role!=="admin")return r.status(403).json({error:"Admin access required"});const i=await Promise.all([e("fds.total_distance_km","ALTER TABLE fleet_driver_sessions ADD COLUMN IF NOT EXISTS total_distance_km DECIMAL(10,3) NULL"),e("fds.active_drive_seconds","ALTER TABLE fleet_driver_sessions ADD COLUMN IF NOT EXISTS active_drive_seconds INT NULL"),e("fds.avg_speed_kmh","ALTER TABLE fleet_driver_sessions ADD COLUMN IF NOT EXISTS avg_speed_kmh DECIMAL(6,2) NULL"),e("fds.max_speed_kmh","ALTER TABLE fleet_driver_sessions ADD COLUMN IF NOT EXISTS max_speed_kmh DECIMAL(6,2) NULL"),e("fds.collision_count","ALTER TABLE fleet_driver_sessions ADD COLUMN IF NOT EXISTS collision_count INT NOT NULL DEFAULT 0"),e("fds.summary_computed_at","ALTER TABLE fleet_driver_sessions ADD COLUMN IF NOT EXISTS summary_computed_at TIMESTAMP NULL"),e("create fleet_session_telemetry",`
    ...
    `)]),o=i.filter(T=>!T.ok);return o.length?r.status(500).json({ok:!1,results:i,failed:o}):r.json({ok:!0,results:i})}export{se as default};
