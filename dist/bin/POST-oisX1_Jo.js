import{createRequire as s}from"module";import{d as A}from"../server.bundle.mjs";import{s as _}from"./drizzle-CZ2vWAZ3.js";import"./express-C3pMhyZZ.js";import"tty";import"os";import"util";import"path";import"./iconv-DatUeE_T.js";import"buffer";import"string_decoder";import"node:zlib";import"./es-abstract-B57Whf45.js";import"url";import"node:fs";import"node:path";import"fs";import"crypto";import"node:http";import"node:buffer";import"node:querystring";import"node:net";import"stream";import"node:events";import"./radix-ui-DB7-u4XC.js";import"./react-router-5dh9OgMp.js";import"./react-dom-CZsMFu04.js";import"async_hooks";import"node:url";import"./mysql2-HVwznT_d.js";import"net";import"events";import"process";import"timers";import"tls";import"zlib";import"node:process";import"./better-auth-B2r-Xofv.js";import"./kysely-9kO2vj_T.js";import"node:crypto";import"./noble-DY0vnRA-.js";import"node:fs/promises";import"node:os";import"./multer-RX-gfMuA.js";import"fs/promises";import"./jszip-BoIs7TcQ.js";import"node:util";import"http";import"https";import"assert";import"./pdf-lib-MF9mTnF3.js";const m=s(import.meta.url);async function _i(p,e){const a=[];async function i(t,L){try{await A.execute(_.raw(L)),a.push(`✓ ${t}`)}catch(o){const r=String((o==null?void 0:o.message)??o);r.includes("already exists")||r.includes("Duplicate column name")||r.includes("ER_DUP_FIELDNAME")||r.includes("ER_TABLE_EXISTS")?a.push(`~ ${t} (already exists)`):(a.push(`✗ ${t}: ${r}`),console.warn(`[migrate-plan-manager-v3] ${t} failed:`,r))}}await i("project_drawings.title",`
  ...
  `);const n=a.filter(t=>t.startsWith("✗"));return e.status(n.length?500:200).json({results:a,ok:n.length===0})}export{_i as default};
