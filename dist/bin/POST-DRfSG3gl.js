import{createRequire as _}from"module";import{d as o}from"../server.bundle.mjs";import{s as i}from"./drizzle-CZ2vWAZ3.js";import"./express-C3pMhyZZ.js";import"tty";import"os";import"util";import"path";import"./iconv-DatUeE_T.js";import"buffer";import"string_decoder";import"node:zlib";import"./es-abstract-B57Whf45.js";import"url";import"node:fs";import"node:path";import"fs";import"crypto";import"node:http";import"node:buffer";import"node:querystring";import"node:net";import"stream";import"node:events";import"./mysql2-HVwznT_d.js";import"net";import"events";import"process";import"timers";import"tls";import"zlib";import"node:process";import"./better-auth-B2r-Xofv.js";import"./kysely-9kO2vj_T.js";import"node:crypto";import"./noble-DY0vnRA-.js";import"node:fs/promises";import"node:os";import"./multer-CH1RChRJ.js";import"fs/promises";import"./jszip-DFkTEOyz.js";import"node:util";import"http";import"https";import"assert";const E=_(import.meta.url);async function tr(l,a){const e=[];try{async function t(r,p){const s=(await o.execute(i`
      ...
      `),e.push("owner profiles: all permissions locked on")}catch(r){e.push(`owner perm lock error: ${String(r)}`)}try{await o.execute(i`
        ...
        SET perm_admin          = 1,
            ...
            perm_delete_records = 1
        WHERE role = 'admin'
      `),e.push("admin profiles: permissions backfilled")}catch(r){e.push(`admin backfill error: ${String(r)}`)}a.json({ok:!0,results:e})}catch(t){console.error("migrate-owner-role error:",t),a.status(500).json({ok:!1,error:String(t),results:e})}}export{tr as default};
