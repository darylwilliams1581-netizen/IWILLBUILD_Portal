import{createRequire as R}from"module";import{g as T,d as a,p as b}from"../server.bundle.mjs";import{j as w,s as r}from"./drizzle-Bu3hp1FF.js";import"./express-WU0_rYSr.js";import"tty";import"os";import"util";import"path";import"./iconv-DatUeE_T.js";import"buffer";import"string_decoder";import"node:zlib";import"./es-abstract-B57Whf45.js";import"url";import"node:fs";import"node:path";import"fs";import"crypto";import"node:http";import"node:buffer";import"node:querystring";import"node:net";import"stream";import"node:events";import"./radix-ui-CM1-jrUu.js";import"./react-router-8V4KISLV.js";import"./react-dom-D6zqUVF0.js";import"async_hooks";import"./zod-B-vvil1C.js";import"node:url";import"./mysql2-BJ7xsy_S.js";import"net";import"events";import"process";import"timers";import"tls";import"zlib";import"node:process";import"./better-auth-DxltITEC.js";import"./kysely-9kO2vj_T.js";import"node:crypto";import"./noble-DY0vnRA-.js";import"node:fs/promises";import"node:os";import"./multer-DNTYjcWN.js";import"fs/promises";import"http";import"https";import"assert";const v=R(import.meta.url);async function Rt(c,o){var m,u,l,_,h;try{const d=T(),f=new Headers;for(const[j,p]of Object.entries(c.headers))p&&f.set(j,Array.isArray(p)?p[0]:p);const s=await d.api.getSession({headers:f});if(!(s!=null&&s.user))return o.status(401).json({error:"Unauthorised"});const i=await a.query.profiles.findFirst({where:w(b.userId,s.user.id)});if(!(i!=null&&i.companyId))return o.status(403).json({error:"No company"});const e=parseInt(String(c.params.poId),10);if(isNaN(e))return o.status(400).json({error:"Invalid PO ID"});const[n]=await a.execute(r`
    ...
    `);o.json({purchaseOrder:{...I[0],lines:$??[]}})}catch(d){console.error("PUT /api/jobs/:id/purchase-orders/:poId error:",d),o.status(500).json({error:"Failed to update purchase order"})}}export{Rt as default};
