import{createRequire as T}from"module";import{d as e}from"../server.bundle.mjs";import{s as a}from"./drizzle-Bu3hp1FF.js";import"./express-WU0_rYSr.js";import"tty";import"os";import"util";import"path";import"./iconv-DatUeE_T.js";import"buffer";import"string_decoder";import"node:zlib";import"./es-abstract-B57Whf45.js";import"url";import"node:fs";import"node:path";import"fs";import"crypto";import"node:http";import"node:buffer";import"node:querystring";import"node:net";import"stream";import"node:events";import"./radix-ui-BjnQoRNV.js";import"./react-router-8V4KISLV.js";import"./react-dom-D6zqUVF0.js";import"async_hooks";import"./zod-Bgt4uOIp.js";import"node:url";import"./mysql2-BJ7xsy_S.js";import"net";import"events";import"process";import"timers";import"tls";import"zlib";import"node:process";import"./better-auth-CQVzbiZe.js";import"./kysely-9kO2vj_T.js";import"node:crypto";import"./noble-DY0vnRA-.js";import"./opentelemetry-MOfsRXlr.js";import"node:fs/promises";import"node:os";import"./multer-DNTYjcWN.js";import"fs/promises";import"http";import"https";import"assert";const n=T(import.meta.url);async function m(r,i,t,o){var s;try{const[p]=await e.execute(a`
      ...
      WHERE TABLE_SCHEMA = DATABASE()
        AND TABLE_NAME = ${r}
        AND COLUMN_NAME = ${i}
    `);(((s=p[0])==null?void 0:s.cnt)??0)===0?(await e.execute(a.raw(`ALTER TABLE \`${r}\` ADD COLUMN \`${i}\` ${t}`)),o.push(`Added ${i} to ${r}`)):o.push(`${i} already exists on ${r}`)}catch(p){o.push(`${r}.${i}: ${String(p)}`)}}async function st(r,i){const t=[];await m("profiles","notification_prefs","TEXT",t),await m("profiles","last_login_at","TIMESTAMP NULL",t),await m("profiles","last_active_at","TIMESTAMP NULL",t);try{await e.execute(a`
    ...
    `),t.push("user_activity_events table ready")}catch(o){t.push(`user_activity_events: ${String(o)}`)}i.json({ok:!0,results:t})}export{st as default};
