import{createRequire as a}from"module";import{d as p}from"../server.bundle.mjs";import{s as A}from"./drizzle-CZ2vWAZ3.js";import"./express-C3pMhyZZ.js";import"tty";import"os";import"util";import"path";import"./iconv-DatUeE_T.js";import"buffer";import"string_decoder";import"node:zlib";import"./es-abstract-B57Whf45.js";import"url";import"node:fs";import"node:path";import"fs";import"crypto";import"node:http";import"node:buffer";import"node:querystring";import"node:net";import"stream";import"node:events";import"./mysql2-HVwznT_d.js";import"net";import"events";import"process";import"timers";import"tls";import"zlib";import"node:process";import"./better-auth-B2r-Xofv.js";import"./kysely-9kO2vj_T.js";import"node:crypto";import"./noble-DY0vnRA-.js";import"node:fs/promises";import"node:os";import"./multer-RX-gfMuA.js";import"fs/promises";import"./jszip-BoIs7TcQ.js";import"node:util";import"http";import"https";import"assert";import"./pdf-lib-MF9mTnF3.js";const R=a(import.meta.url);async function Ni(_,r){const i=[];async function E(t,e){try{await p.execute(A.raw(e)),i.push(`✅ ${t}`)}catch(T){const o=String(T);o.includes("Duplicate")||o.includes("already exists")||o.includes("Multiple primary key")?i.push(`⚠️  ${t}: already exists`):i.push(`❌ ${t}: ${o.slice(0,300)}`)}}await E("Create job_attendance",`
  ...
  `);const N=i.every(t=>!t.startsWith("❌"));r.json({ok:N,results:i})}export{Ni as default};
