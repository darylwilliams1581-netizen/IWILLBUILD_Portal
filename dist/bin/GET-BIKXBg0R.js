import{createRequire as l}from"module";import{g as b,d as e,p as E,o as j}from"../server.bundle.mjs";import{j as m,k as y,s as n}from"./drizzle-CZ2vWAZ3.js";import"./express-C3pMhyZZ.js";import"tty";import"os";import"util";import"path";import"./iconv-DatUeE_T.js";import"buffer";import"string_decoder";import"node:zlib";import"./es-abstract-B57Whf45.js";import"url";import"node:fs";import"node:path";import"fs";import"crypto";import"node:http";import"node:buffer";import"node:querystring";import"node:net";import"stream";import"node:events";import"./radix-ui-DB7-u4XC.js";import"./react-router-5dh9OgMp.js";import"./react-dom-CZsMFu04.js";import"async_hooks";import"node:url";import"./mysql2-HVwznT_d.js";import"net";import"events";import"process";import"timers";import"tls";import"zlib";import"node:process";import"./better-auth-B2r-Xofv.js";import"./kysely-9kO2vj_T.js";import"node:crypto";import"./noble-DY0vnRA-.js";import"node:fs/promises";import"node:os";import"./multer-RX-gfMuA.js";import"fs/promises";import"./jszip-BoIs7TcQ.js";import"node:util";import"http";import"https";import"assert";import"./pdf-lib-MF9mTnF3.js";const R=l(import.meta.url);async function yr(c,o){try{const a=b(),d=new Headers;for(const[r,t]of Object.entries(c.headers))t&&d.set(r,Array.isArray(t)?t[0]:t);const p=await a.api.getSession({headers:d});if(!(p!=null&&p.user))return o.status(401).json({error:"Unauthorised"});const i=await e.query.profiles.findFirst({where:m(E.userId,p.user.id)});if(!(i!=null&&i.companyId))return o.status(403).json({error:"No company"});const s=parseInt(String(c.params.id),10);if(isNaN(s))return o.status(400).json({error:"Invalid job ID"});if(!await e.query.jobs.findFirst({where:y(m(j.id,s),m(j.companyId,i.companyId))}))return o.status(404).json({error:"Job not found"});const[u]=await e.execute(n`
    ...
    `),h=(u??[]).map(r=>r.id);let f=[];if(h.length>0){const[r]=await e.execute(n`
      ...
      `);f=r??[]}const _=(u??[]).map(r=>({...r,lines:f.filter(t=>t.purchase_order_id===r.id)}));o.json({purchaseOrders:_})}catch(a){console.error("GET /api/jobs/:id/purchase-orders error:",a),o.status(500).json({error:"Failed to fetch purchase orders"})}}export{yr as default};
