import{createRequire as d}from"module";import{d as o}from"../server.bundle.mjs";import{s as _}from"./drizzle-CZ2vWAZ3.js";import"./express-C3pMhyZZ.js";import"tty";import"os";import"util";import"path";import"./iconv-DatUeE_T.js";import"buffer";import"string_decoder";import"node:zlib";import"./es-abstract-B57Whf45.js";import"url";import"node:fs";import"node:path";import"fs";import"crypto";import"node:http";import"node:buffer";import"node:querystring";import"node:net";import"stream";import"node:events";import"./mysql2-HVwznT_d.js";import"net";import"events";import"process";import"timers";import"tls";import"zlib";import"node:process";import"./better-auth-B2r-Xofv.js";import"./kysely-9kO2vj_T.js";import"node:crypto";import"./noble-DY0vnRA-.js";import"node:fs/promises";import"node:os";import"./multer-RX-gfMuA.js";import"fs/promises";import"./jszip-BoIs7TcQ.js";import"node:util";import"http";import"https";import"assert";const e=d(import.meta.url);async function ai(A,r){const t=[];async function i(T,L){try{await o.execute(_.raw(L)),t.push(`✓ ${T}`)}catch(a){const N=String((a==null?void 0:a.message)??a);N.includes("already exists")||N.includes("Duplicate column name")||N.includes("ER_TABLE_EXISTS")||N.includes("ER_DUP_FIELDNAME")?t.push(`~ ${T} (already exists)`):(t.push(`✗ ${T}: ${N}`),console.warn(`[migrate-plan-manager] ${T} failed:`,N))}}await i("project_drawings",`
  ...
  `);const E=t.filter(T=>T.startsWith("✗"));return r.status(E.length?500:200).json({results:t,ok:E.length===0})}export{ai as default};
