import{createRequire as o}from"module";import{d as N}from"../server.bundle.mjs";import{s as E}from"./drizzle-Bu3hp1FF.js";import"./express-WU0_rYSr.js";import"tty";import"os";import"util";import"path";import"./iconv-DatUeE_T.js";import"buffer";import"string_decoder";import"node:zlib";import"./es-abstract-B57Whf45.js";import"url";import"node:fs";import"node:path";import"fs";import"crypto";import"node:http";import"node:buffer";import"node:querystring";import"node:net";import"stream";import"node:events";import"./mysql2-BJ7xsy_S.js";import"net";import"events";import"process";import"timers";import"tls";import"zlib";import"node:process";import"./better-auth-CQVzbiZe.js";import"./kysely-9kO2vj_T.js";import"node:crypto";import"./noble-DY0vnRA-.js";import"./opentelemetry-MOfsRXlr.js";import"node:fs/promises";import"node:os";import"fs/promises";import"./multer-aeOynLMg.js";import"http";import"https";import"assert";const s=o(import.meta.url);async function et(_,T){const e=[];async function t(r,L){try{await N.execute(E.raw(L)),e.push(`✓ ${r}`)}catch(A){const i=String(A);i.includes("Duplicate column")||i.includes("already exists")||i.includes("ER_DUP_FIELDNAME")||i.includes("ER_TABLE_EXISTS_ERROR")?e.push(`— ${r} (already exists)`):e.push(`✗ ${r}: ${i}`)}}await t("Create password_reset_tokens table",`
  ...
  `),T.json({ok:!0,results:e})}export{et as default};
