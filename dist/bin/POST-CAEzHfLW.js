import{createRequire as o}from"module";import{d as _}from"../server.bundle.mjs";import{s as L}from"./drizzle-Bu3hp1FF.js";import"./express-WU0_rYSr.js";import"tty";import"os";import"util";import"path";import"./iconv-DatUeE_T.js";import"buffer";import"string_decoder";import"node:zlib";import"./es-abstract-B57Whf45.js";import"url";import"node:fs";import"node:path";import"fs";import"crypto";import"node:http";import"node:buffer";import"node:querystring";import"node:net";import"stream";import"node:events";import"./mysql2-BJ7xsy_S.js";import"net";import"events";import"process";import"timers";import"tls";import"zlib";import"node:process";import"./better-auth-CQVzbiZe.js";import"./kysely-9kO2vj_T.js";import"node:crypto";import"./noble-DY0vnRA-.js";import"./opentelemetry-MOfsRXlr.js";import"node:fs/promises";import"node:os";import"./multer-DNTYjcWN.js";import"fs/promises";import"http";import"https";import"assert";const A=o(import.meta.url);async function Ei(m,r){const i=[];async function T(t,N){try{await _.execute(L.raw(N)),i.push(`✅ ${t}`)}catch(a){const E=String(a);E.includes("Duplicate")||E.includes("already exists")||E.includes("Multiple primary key")?i.push(`⚠️  ${t}: already exists`):i.push(`❌ ${t}: ${E.slice(0,200)}`)}}await T("Create library_items",`
  ...
  `);const e=i.every(t=>!t.startsWith("❌"));r.json({ok:e,results:i})}export{Ei as default};
