import{createRequire as p}from"module";import{d as a}from"../server.bundle.mjs";import{s as A}from"./drizzle-Bu3hp1FF.js";import"./express-WU0_rYSr.js";import"tty";import"os";import"util";import"path";import"./iconv-DatUeE_T.js";import"buffer";import"string_decoder";import"node:zlib";import"./es-abstract-B57Whf45.js";import"url";import"node:fs";import"node:path";import"fs";import"crypto";import"node:http";import"node:buffer";import"node:querystring";import"node:net";import"stream";import"node:events";import"./radix-ui-CM1-jrUu.js";import"./react-router-8V4KISLV.js";import"./react-dom-D6zqUVF0.js";import"async_hooks";import"./zod-B-vvil1C.js";import"node:url";import"./mysql2-BJ7xsy_S.js";import"net";import"events";import"process";import"timers";import"tls";import"zlib";import"node:process";import"./better-auth-CdAfVNtR.js";import"./kysely-9kO2vj_T.js";import"node:crypto";import"./noble-DY0vnRA-.js";import"node:fs/promises";import"node:os";import"./multer-DNTYjcWN.js";import"fs/promises";import"http";import"https";import"assert";const m=p(import.meta.url);async function pi(_,r){const i=[];async function E(t,e){try{await a.execute(A.raw(e)),i.push(`✅ ${t}`)}catch(T){const o=String(T);o.includes("Duplicate")||o.includes("already exists")||o.includes("Multiple primary key")?i.push(`⚠️  ${t}: already exists`):i.push(`❌ ${t}: ${o.slice(0,300)}`)}}await E("Create job_attendance",`
  ...
  `);const N=i.every(t=>!t.startsWith("❌"));r.json({ok:N,results:i})}export{pi as default};
