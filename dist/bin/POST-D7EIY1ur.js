import{createRequire as A}from"module";import{d as _}from"../server.bundle.mjs";import{s as U}from"./drizzle-Bu3hp1FF.js";import"./express-WU0_rYSr.js";import"tty";import"os";import"util";import"path";import"./iconv-DatUeE_T.js";import"buffer";import"string_decoder";import"node:zlib";import"./es-abstract-B57Whf45.js";import"url";import"node:fs";import"node:path";import"fs";import"crypto";import"node:http";import"node:buffer";import"node:querystring";import"node:net";import"stream";import"node:events";import"./mysql2-BJ7xsy_S.js";import"net";import"events";import"process";import"timers";import"tls";import"zlib";import"node:process";import"./better-auth-CQVzbiZe.js";import"./kysely-9kO2vj_T.js";import"node:crypto";import"./noble-DY0vnRA-.js";import"./opentelemetry-MOfsRXlr.js";import"node:fs/promises";import"node:os";import"./multer-DNTYjcWN.js";import"fs/promises";import"http";import"https";import"assert";const d=A(import.meta.url);async function ET(R,e){const E=[];async function T(t,a){try{await _.execute(U.raw(a)),E.push(`✓ ${t}`)}catch(i){const N=String((i==null?void 0:i.message)??i);N.includes("already exists")||N.includes("Duplicate column name")||N.includes("ER_TABLE_EXISTS")||N.includes("ER_DUP_FIELDNAME")?E.push(`~ ${t} (already exists)`):(E.push(`✗ ${t}: ${N}`),console.warn(`[migrate-asset-manager] ${t} failed:`,N))}}await T("am_assets",`
  ...
  `);const L=E.filter(t=>t.startsWith("✗"));return e.status(L.length?500:200).json({results:E,ok:L.length===0})}export{ET as default};
