import{createRequire as m}from"module";import{v as p,d as a}from"../server.bundle.mjs";import{s as L}from"./drizzle-Bu3hp1FF.js";import"./express-WU0_rYSr.js";import"tty";import"os";import"util";import"path";import"./iconv-DatUeE_T.js";import"buffer";import"string_decoder";import"node:zlib";import"./es-abstract-B57Whf45.js";import"url";import"node:fs";import"node:path";import"fs";import"crypto";import"node:http";import"node:buffer";import"node:querystring";import"node:net";import"stream";import"node:events";import"./radix-ui-CM1-jrUu.js";import"./react-router-8V4KISLV.js";import"./react-dom-D6zqUVF0.js";import"async_hooks";import"./zod-B-vvil1C.js";import"node:url";import"./mysql2-BJ7xsy_S.js";import"net";import"events";import"process";import"timers";import"tls";import"zlib";import"node:process";import"./better-auth-DxltITEC.js";import"./kysely-9kO2vj_T.js";import"node:crypto";import"./noble-DY0vnRA-.js";import"node:fs/promises";import"node:os";import"./multer-DNTYjcWN.js";import"fs/promises";import"./jszip-Yfw9Muqe.js";import"http";import"https";import"assert";const n=m(import.meta.url);async function pr(e,r){const o=await p(e,r);if(o){if(o.profile.role!=="owner"&&o.profile.role!=="admin")return r.status(403).json({error:"Admin access required"});try{return await a.execute(L.raw(`
    ...
    `)),r.json({ok:!0})}catch(t){const i=t instanceof Error?t.message:String(t);return i.includes("already exists")?r.json({ok:!0,skipped:!0}):(console.error("migrate-emergency-alerts error:",t),r.status(500).json({error:i}))}}}export{pr as default};
