import{createRequire as a}from"module";import{d as m}from"../server.bundle.mjs";import{s as _}from"./drizzle-Bu3hp1FF.js";import"./express-WU0_rYSr.js";import"tty";import"os";import"util";import"path";import"./iconv-DatUeE_T.js";import"buffer";import"string_decoder";import"node:zlib";import"./es-abstract-B57Whf45.js";import"url";import"node:fs";import"node:path";import"fs";import"crypto";import"node:http";import"node:buffer";import"node:querystring";import"node:net";import"stream";import"node:events";import"./radix-ui-BjnQoRNV.js";import"./react-router-8V4KISLV.js";import"./react-dom-D6zqUVF0.js";import"async_hooks";import"./zod-Bgt4uOIp.js";import"node:url";import"./mysql2-BJ7xsy_S.js";import"net";import"events";import"process";import"timers";import"tls";import"zlib";import"node:process";import"./better-auth-CQVzbiZe.js";import"./kysely-9kO2vj_T.js";import"node:crypto";import"./noble-DY0vnRA-.js";import"./opentelemetry-MOfsRXlr.js";import"node:fs/promises";import"node:os";import"./multer-DNTYjcWN.js";import"fs/promises";import"http";import"https";import"assert";const A=a(import.meta.url);async function mi(L,E){const i=[];async function r(t,N){try{await m.execute(_.raw(N)),i.push(`✅ ${t}`)}catch(o){const T=String(o);T.includes("Duplicate")||T.includes("already exists")||T.includes("Multiple primary key")?i.push(`⚠️  ${t}: already exists`):i.push(`❌ ${t}: ${T.slice(0,200)}`)}}await r("Create library_items",`
  ...
  `);const e=i.every(t=>!t.startsWith("❌"));E.json({ok:e,results:i})}export{mi as default};
