...
</html>`;n.setHeader("Content-Type","text/html; charset=utf-8"),n.setHeader("Content-Disposition",`inline; filename="${t.po_number}.html"`),n.send(L)}catch(g){console.error("GET /api/jobs/:id/purchase-orders/:poId/pdf error:",g),n.status(500).json({error:"Failed to generate PDF"})}}export{Rt as default};
