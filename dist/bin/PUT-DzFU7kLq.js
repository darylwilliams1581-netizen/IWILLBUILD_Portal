import{createRequire as R}from"module";import{g as T,d as a,p as b}from"../server.bundle.mjs";import{j as w,s as r}from"./drizzle-CZ2vWAZ3.js";import"./express-C3pMhyZZ.js";import"tty";import"os";import"util";import"path";import"./iconv-DatUeE_T.js";import"buffer";import"string_decoder";import"node:zlib";import"./es-abstract-B57Whf45.js";import"url";import"node:fs";import"node:path";import"fs";import"crypto";import"node:http";import"node:buffer";import"node:querystring";import"node:net";import"stream";import"node:events";import"./mysql2-HVwznT_d.js";import"net";import"events";import"process";import"timers";import"tls";import"zlib";import"node:process";import"./better-auth-B2r-Xofv.js";import"./kysely-9kO2vj_T.js";import"node:crypto";import"./noble-DY0vnRA-.js";import"node:fs/promises";import"node:os";import"./multer-RX-gfMuA.js";import"fs/promises";import"./jszip-BoIs7TcQ.js";import"node:util";import"http";import"https";import"assert";const v=R(import.meta.url);async function yt(c,o){var m,u,l,_,h;try{const d=T(),f=new Headers;for(const[j,p]of Object.entries(c.headers))p&&f.set(j,Array.isArray(p)?p[0]:p);const s=await d.api.getSession({headers:f});if(!(s!=null&&s.user))return o.status(401).json({error:"Unauthorised"});const e=await a.query.profiles.findFirst({where:w(b.userId,s.user.id)});if(!(e!=null&&e.companyId))return o.status(403).json({error:"No company"});const i=parseInt(String(c.params.poId),10);if(isNaN(i))return o.status(400).json({error:"Invalid PO ID"});const[n]=await a.execute(r`
    ...
    `);o.json({purchaseOrder:{...I[0],lines:$??[]}})}catch(d){console.error("PUT /api/jobs/:id/purchase-orders/:poId error:",d),o.status(500).json({error:"Failed to update purchase order"})}}export{yt as default};
