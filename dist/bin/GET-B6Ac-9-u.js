...
</html>`;t.setHeader("Content-Type","text/html; charset=utf-8"),t.setHeader("Content-Disposition",`inline; filename="${m.replace(/[^a-z0-9_\-. ]/gi,"_")}.pdf"`),t.send(b)}catch(e){console.error("Document export PDF error:",e),t.status(500).json({error:"Export failed",message:String(e)})}}export{gt as default};
