...
</html>`;t.setHeader("Content-Type","text/html; charset=utf-8"),t.setHeader("Content-Disposition",`inline; filename="${p.replace(/[^a-z0-9_\-. ]/gi,"_")}.pdf"`),t.send(f)}catch(o){console.error("Document export PDF error:",o),t.status(500).json({error:"Export failed",message:String(o)})}}export{yt as default};
