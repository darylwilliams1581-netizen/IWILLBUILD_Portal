 ...
 *   field       — Work section (Jobs, Work, Service Jobs, Scheduler)
...
import {
  HardHat, Briefcase, Zap, CalendarDays, Wrench,
...
export const FIELD_ICON_DEFS: HomeIconDef[] = [
  ...
  { key: 'job_card',    label: 'Service Jobs',   icon: Zap,          href: '/job-cards',                   bg: 'bg-yellow-500',  fg: 'text-white', group: 'field' },
...
export const SAFETY_ICON_DEFS: HomeIconDef[] = [
  ...
  { key: 'risk_register', label: 'Hazard Register', icon: TriangleAlert, href: '/risk-register',          bg: 'bg-orange-600',  fg: 'text-white', group: 'safety' },
