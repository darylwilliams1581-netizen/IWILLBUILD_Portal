...
export const FIELD_ICON_DEFS: HomeIconDef[] = [
  ...
  { key: 'delays',        label: 'Delays',           icon: Clock,            href: '?panel=delays-picker',        bg: 'bg-orange-600',  fg: 'text-white', group: 'field' },
  { key: 'progress',      label: 'Progress',         icon: TrendingUp,       href: '?panel=progress-picker',      bg: 'bg-emerald-600', fg: 'text-white', group: 'field' },
  { key: 'drawings',      label: 'Drawings',         icon: Layers,           href: '?panel=drawings-picker',      bg: 'bg-blue-400',    fg: 'text-white', group: 'field' },
  { key: 'equipment',     label: 'Equipment',        icon: Wrench,           href: '/studio/asset-manager',       bg: 'bg-orange-400',  fg: 'text-white', group: 'field' },
];

// ── SAFETY ────────────────────────────────────────────────────────────────────
// Palette: red / rose / pink — danger signals; amber for inspection
export const SAFETY_ICON_DEFS: HomeIconDef[] = [
  ...
  { key: 'forms',         label: 'Forms',            icon: FileText,         href: '?panel=forms-picker',         bg: 'bg-pink-600',    fg: 'text-white', group: 'safety' },
  { key: 'field_docs',    label: 'Docs',             icon: FileCheck,        href: '/job-docs',                   bg: 'bg-rose-500',    fg: 'text-white', group: 'safety' },
  { key: 'prestart',      label: 'Vehicle Prestart', icon: ClipboardCheck,   href: '?panel=prestart-picker',      bg: 'bg-amber-500',   fg: 'text-white', group: 'safety' },
  { key: 'incidents',     label: 'Incidents',        icon: AlertTriangle,    href: '/incidents',                  bg: 'bg-red-600',     fg: 'text-white', group: 'safety' },
];
...
export const TOOLS_ICON_DEFS: HomeIconDef[] = [
  ...
  { key: 'builders_calc', label: 'Builders Calc',    icon: Ruler,            href: '/builders-calc',              bg: 'bg-purple-500',  fg: 'text-white', group: 'tools' },
  { key: 'takeoff_pad',   label: 'Takeoff Pad',      icon: ClipboardList,    href: '/takeoff-pad',                bg: 'bg-sky-500',     fg: 'text-white', group: 'tools' },
  { key: 'estimating',    label: 'Estimating',       icon: Calculator,       href: '/estimating',                 bg: 'bg-purple-600',  fg: 'text-white', group: 'tools' },
  ...
  { key: 'site_escape',   label: 'SE',               icon: Gamepad2,         href: '/site-escape',                bg: 'bg-sky-600',     fg: 'text-white', group: 'tools' },
];
