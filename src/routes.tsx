...
const ElectricalTestsPage = lazy(() => import('./pages/electrical-tests'));
...
export const routes: RouteObject[] = [{
  path: '/',
  element: <NativeStartupGate><HomePage /></NativeStartupGate>
}, {
  path: '/home',
  element: protect(<ShellRouter />),
  ...
  path: '/download-app',
  element: <Suspense fallback={<PageLoader />}><DownloadAppPage /></Suspense>
}, {
  path: '/subscribe',
  element: <Suspense fallback={<PageLoader />}><SubscribePage /></Suspense>
}, {
  path: '/prestart',
  element: <ProtectedRoute><DriverSessionProvider><Suspense fallback={<PageLoader />}><PrestartPage /></Suspense></DriverSessionProvider></ProtectedRoute>,
  errorElement: routeError
}, {
  path: '/site-escape',
...
// Customer portal — token-based, no staff login required
{
  ...
  element: <Suspense fallback={<PageLoader />}><PortalDashboardPage /></Suspense>
}, {
  path: '/portal/jobs/:id',
  element: <Suspense fallback={<PageLoader />}><PortalJobDetailPage /></Suspense>
}, {
  path: '/portal/payment-success',
  element: <Suspense fallback={<PageLoader />}><PortalPaymentSuccessPage /></Suspense>
}, {
  path: '/dashboard',
...
{
  path: '/projects',
  loader: () => redirect('/jobs')
}, {
  path: '/stakeholders',
  loader: () => redirect('/customers')
}, {
  path: '/subscription',
  loader: () => redirect('/billing')
}, {
  path: '/tools',
  loader: () => redirect('/estimating')
}, {
  path: '/jobs',
  element: protect(<JobsPage />),
  errorElement: routeError
}, {
  path: '/jobs/:id',
  element: protect(<JobDetailPage />),
  errorElement: routeError
}, {
  path: '/jobs/:id/photos',
  element: protect(<Suspense fallback={<PageLoader />}><JobPhotosPage /></Suspense>),
  errorElement: routeError
}, {
  path: '/jobs/:id/camera',
  element: protect(<Suspense fallback={<PageLoader />}><JobPhotosCameraPage /></Suspense>),
  errorElement: routeError
}, {
  path: '/job-cards/:id/camera',
  element: protect(<Suspense fallback={<PageLoader />}><JobPhotosCameraPage /></Suspense>),
  errorElement: routeError
}, {
  path: '/jobs/:id/notes',
  element: protect(<Suspense fallback={<PageLoader />}><JobNotesPage /></Suspense>),
  errorElement: routeError
}, {
  path: '/jobs/:id/delays',
  element: protect(<Suspense fallback={<PageLoader />}><JobDelaysPage /></Suspense>),
  errorElement: routeError
}, {
  path: '/jobs/:id/forms',
  element: protect(<Suspense fallback={<PageLoader />}><JobFormsPage /></Suspense>),
  errorElement: routeError
}, {
  path: '/jobs/:id/quotes',
  element: protect(<Suspense fallback={<PageLoader />}><JobQuotesPage /></Suspense>),
  errorElement: routeError
}, {
  path: '/jobs/:id/progress',
  element: protect(<Suspense fallback={<PageLoader />}><JobProgressPage /></Suspense>),
  errorElement: routeError
}, {
  path: '/jobs/:id/schedule',
  element: protect(<Suspense fallback={<PageLoader />}><JobSchedulePage /></Suspense>),
  errorElement: routeError
}, {
  path: '/jobs/:id/drawings',
  element: protect(<Suspense fallback={<PageLoader />}><JobDrawingsPage /></Suspense>),
  errorElement: routeError
}, {
  path: '/jobs/:id/site-prestart',
  element: protect(<Suspense fallback={<PageLoader />}><JobSitePrestartPage /></Suspense>),
  errorElement: routeError
}, {
  path: '/jobs/:id/risky',
  element: protect(<Suspense fallback={<PageLoader />}><JobRiskyPage /></Suspense>),
  errorElement: routeError
}, {
  path: '/incidents',
  element: protect(<Suspense fallback={<PageLoader />}><IncidentsPage /></Suspense>),
  errorElement: routeError
}, {
  path: '/incidents/:id',
  element: protect(<Suspense fallback={<PageLoader />}><IncidentDetailPage /></Suspense>),
  errorElement: routeError
}, {
  path: '/risk-register',
  element: protect(<Suspense fallback={<PageLoader />}><RiskRegisterPage /></Suspense>),
  errorElement: routeError
}, {
  path: '/fleet/:id/drive',
  element: protect(<Suspense fallback={<PageLoader />}><FleetDrivePage /></Suspense>),
  errorElement: routeError
}, {
  path: '/jobs/:id/costs',
...
{
  path: '/jobs/:id/signin',
  element: <Suspense fallback={<PageLoader />}><JobSignInPage /></Suspense>,
  errorElement: routeError
},
// Deep-link: open a specific form instance directly — full-page runner in new tab
{
  path: '/jobs/:id/forms/:formInstanceId',
  element: protect(<JobFormRunnerPage />),
  errorElement: routeError
}, {
  path: '/scheduler',
  element: protect(<SchedulerPage />),
  errorElement: routeError
}, {
  path: '/fleet',
  element: protect(<FleetPage />),
  errorElement: routeError
}, {
  path: '/fleet/:id',
  element: protect(<FleetDetailPage />),
  errorElement: routeError
}, {
  path: '/forms',
  loader: () => redirect('/studio/forms')
}, {
  path: '/files',
  ...
  path: '/estimating',
  element: protect(<EstimatingPage />),
  errorElement: routeError
}, {
  path: '/builders-calc',
  element: protect(<BuildersCalcPage />),
  errorElement: routeError
}, {
  path: '/takeoff-pad',
  ...
  path: '/electrical-tests',
  element: protect(<ElectricalTestsPage />),
  errorElement: routeError
}, {
  ...
  path: '/estimates/:id',
  element: protect(<EstimateEditorPage />),
  errorElement: routeError
}, {
  path: '/safety',
  ...
  path: '/customers/:id',
  element: protect(<CustomerDetailPage />),
  errorElement: routeError
}, {
  path: '/invoices',
  element: protect(<InvoicesPage />),
  errorElement: routeError
}, {
  path: '/invoices/:id',
  element: protect(<InvoiceBuilderPage />),
  errorElement: routeError
}, {
  path: '/studio',
  element: protectDesktop(<StudioPage />, 'Studio'),
  errorElement: routeError
}, {
  path: '/studio/builder/:id',
  element: protectDesktop(<StudioBuilderPage />, 'Studio Builder'),
  errorElement: routeError
}, {
  ...
  path: '/studio/forms',
  element: protect(<Suspense fallback={<PageLoader />}><StudioFormsPage /></Suspense>),
  errorElement: routeError
}, {
  ...
  path: '/safety/posters',
  element: protect(<Suspense fallback={<PageLoader />}><SafetyPostersPage /></Suspense>),
  errorElement: routeError
}, {
  path: '/job-docs',
...
{
  path: '/plan-manager',
  element: protect(<PlanManagerPage />),
  errorElement: routeError
}, {
  path: '/plan-manager/share/:token',
  element: <Suspense fallback={<PageLoader />}><PlanManagerSharePage /></Suspense>,
  errorElement: routeError
}, {
  path: '/plan-manager/:drawingId',
  element: protect(<PlanManagerDrawingPage />),
  errorElement: routeError
},
// Asset Manager
{
  ...
  element: <Suspense fallback={<PageLoader />}><AssetReportSharePage /></Suspense>,
  errorElement: routeError
},
// Public job photo gallery — token-validated, no login required
{
  path: '/photos/share/:token',
  element: <Suspense fallback={<PageLoader />}><PhotoSharePage /></Suspense>,
  errorElement: routeError
},
// Lens — company-wide photo gallery (Phase 1: read-only)
{
  path: '/lens',
  element: protect(<LensPage />),
  errorElement: routeError
},
// Sign-in history
{
  path: '/signin-history',
  element: protect(<SignInHistoryPage />),
  errorElement: routeError
},
// Standalone form instance
{
  path: '/forms/:id',
  element: protect(<FormDetailPage />),
  errorElement: routeError
},
// Primary module short-paths — redirect to canonical portal routes (SSR-safe loader redirects)
{
  ...
  path: '/studio/estimates',
  loader: () => redirect('/estimating')
}, {
  path: '/studio/fleet',
  loader: () => redirect('/fleet')
}, {
  path: '/studio/accounts',
  loader: () => redirect('/settings')
}, {
  path: '/dazza-ai',
  element: protectDev(<DazzaAIPage />),
  errorElement: routeError
}, {
  path: '/annette',
  loader: () => redirect('/owner-console?tab=health-check')
}, {
  path: '/team',
  element: protect(<TeamPage />),
  errorElement: routeError
}, {
  path: '/team/schedule',
  loader: () => redirect('/scheduler?tab=team-shifts')
}, {
  path: '/quick-links',
  element: protect(<QuickLinksPage />),
  errorElement: routeError
}, {
  path: '/settings',
  ...
  path: '/help',
  element: protect(<Suspense fallback={<PageLoader />}><HelpPage /></Suspense>),
  errorElement: routeError
}, {
  path: '/owner-console',
  element: protectDev(<OwnerConsolePage />),
  errorElement: routeError
}, {
  ...
  path: '/billing',
  element: protect(<BillingPage />),
  errorElement: routeError
}, {
  path: '/lists',
  element: protect(<ListsPage />),
  errorElement: routeError
}, {
  path: '/user-logs',
  element: protect(<UserLogsPage />),
  errorElement: routeError
}, {
  path: '/job-cards',
  element: protect(<Suspense fallback={<PageLoader />}><JobCardsPage /></Suspense>),
  errorElement: routeError
}, {
  path: '/job-cards/new',
  element: protect(<Suspense fallback={<PageLoader />}><JobCardNewPage /></Suspense>),
  errorElement: routeError
}, {
  path: '/job-cards/:id',
  element: protect(<Suspense fallback={<PageLoader />}><JobCardDetailPage /></Suspense>),
  errorElement: routeError
}, {
  path: '/documents/:id',
  element: protect(<DocumentViewerPage />),
  errorElement: routeError
},
// New-tab viewer routes (authenticated, no sidebar)
{
  path: '/view/file/:id',
  element: protect(<ViewFilePage />),
  errorElement: routeError
}, {
  path: '/view/estimate/:id',
  element: protect(<ViewEstimatePage />),
  errorElement: routeError
}, {
  path: '/view/invoice/:id',
  element: protect(<ViewInvoicePage />),
  errorElement: routeError
}, {
  path: '*',
  element: <NotFoundPage />
}];
export type Path = '/' | '/login' | '/signup' | '/check-email' | '/verify-email' | '/verify-required' | '/forgot-password' | '/reset-password' | '/dashboard' | '/jobs' | '/fleet' | '/forms' | '/files' | '/estimating' | '/dazza-ai' | '/team' | '/settings';
