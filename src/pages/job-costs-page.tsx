...
export default function JobCostsPage() {
  ...
  return (
    <div className="flex-1 bg-gray-50 flex flex-col overflow-hidden">
      ...
      <button
        onClick={() => addEntryRef.current?.()}
        className="md:hidden fixed z-20 h-9 px-3 rounded-xl bg-emerald-500 shadow-sm flex items-center gap-1.5 text-xs font-bold text-white active:bg-emerald-600 transition-colors"
