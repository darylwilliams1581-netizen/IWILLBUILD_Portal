...
export default function ExternalFormPage() {
  ...
  return <>
      <Helmet>
        <title>
          {data ? `${data.submission.template_name} — ${data.submission.company_name}` : 'Form — IWIIlBUILD'}
        </title>
        <meta name="description" content="Complete and submit a form from IWIIlBUILD." />
