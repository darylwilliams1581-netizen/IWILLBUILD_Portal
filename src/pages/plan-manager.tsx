      ...
      <div className="portal-page bg-[#F4F5F7] text-slate-900">
        ...
        <div className="portal-main">
          ...
          <div className="flex items-center gap-3 px-4 md:px-6 py-4 border-b border-slate-200 flex-shrink-0 bg-white">
            <button onClick={() => navigate('/')} className="p-2 -ml-1 rounded-md text-muted-foreground hover:text-foreground hover:bg-muted transition-colors" aria-label="Go to home">
              <Home size={20} />
            </button>
            <button onClick={() => window.dispatchEvent(new Event('portal:open-menu'))} className="md:hidden p-2 rounded-md text-muted-foreground hover:text-foreground hover:bg-muted transition-colors" aria-label="Open menu">
              <Menu size={20} />
            </button>
          ...
          {/* List / loading / error */}
          {listLoading ? <div className="flex-1 overflow-auto p-4 md:p-6 space-y-3">
              {Array.from({
            length: 5
          }).map((_, i) => <div key={i} className="bg-white rounded-xl border border-slate-200 p-4 flex items-center gap-4">
            ...
            </div> : listError ? <div className="flex-1 flex flex-col items-center justify-center py-20 gap-4">
