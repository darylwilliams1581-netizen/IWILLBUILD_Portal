...
export default function SubscribePage() {
  ...
  return <>
      <Helmet>
        <title>Subscribe — IWIIlBUILD</title>
        <meta name="description" content="Choose a plan and start your 30-day free trial of IWIIlBUILD construction management software." />
      ...
      <div className="min-h-screen bg-gray-950 text-white flex flex-col">
        ...
        paddingTop: native ? 'max(env(safe-area-inset-top), 16px)' : undefined
          ...
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-bold text-white text-sm">IWIIlBUILD</span>
          </div>
        </div>
