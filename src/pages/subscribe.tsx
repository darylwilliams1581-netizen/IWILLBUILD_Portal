/**
 * /subscribe — In-app subscribe / sign-up page
 * ─────────────────────────────────────────────────────────────────────────────
 * Shown when a user opens the app and wants to create a new account.
 * Designed for native (no header/footer), but works on web too.
 *
 * Shows plan cards with pricing, then links to /signup for account creation.
 * On native, opens /signup in the same webview (React Router navigation).
 */
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-950 text-white flex flex-col">
        ...
        <div
          ...
          style={{ paddingTop: native ? 'max(env(safe-area-inset-top), 16px)' : undefined }}
        >
          <Link
            to="/login"
            ...
            return (
              ...
              >
                ...
                <Link
                  ...
                  className={[
                    'mt-4 flex items-center justify-center gap-2 w-full py-3 rounded-xl font-bold text-sm transition-all',
                    plan.highlight
        ...
        {/* Footer */}
        <div
          className="px-5 pb-8 text-center space-y-3"
          style={{ paddingBottom: native ? 'max(env(safe-area-inset-bottom), 32px)' : undefined }}
        >
