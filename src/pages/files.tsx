...
export default function FilesPage() {
  ...
  return <div className="flex-1 bg-gray-50 flex flex-col lg-portal">
      ...
      <DesktopDock />
      <Helmet>
        <title>Files — IWIIlBUILD Portal</title>
        <meta name="description" content="Store and organise job files, plans and documents in the IWIIlBUILD portal." />
        <link rel="canonical" href="https://iwillbuild.com/files" />
        <meta name="robots" content="noindex" />
        <meta property="og:title" content="Files — IWIIlBUILD Portal" />
        <meta property="og:description" content="Store and organise job files, plans and documents in the IWIIlBUILD portal." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://iwillbuild.com/files" />
        <meta property="og:image" content="https://iwillbuild.com/airo-assets/images/pages/home/og-image" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Files — IWIIlBUILD Portal" />
        <meta name="twitter:description" content="Store and organise job files, plans and documents in the IWIIlBUILD portal." />
