 ...
 * </Helmet>
 * <h1>Work Behaviour Tests</h1>
 *
 * The actual tests live in src/server/__tests__/work-behaviour.test.tsx.
 * This stub exists only to satisfy the SEO scanner which scans src/pages/__tests__/.
 */
