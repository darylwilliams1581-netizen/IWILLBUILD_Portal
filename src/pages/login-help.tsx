...
const sections: HelpSection[] = [{
  ...
  steps: [{
    ...
    body: 'Emails from IWIIlBUILD may be filtered by your email provider. Search for "iwillbuild" in all folders.'
  }, {
...
export default function LoginHelpPage() {
  return <div className="min-h-screen bg-slate-50">
      <Helmet>
        <title>Login Help — IWIIlBUILD Portal</title>
        <meta name="description" content="Troubleshoot login issues with the IWIIlBUILD portal. Reset your password, resend verification emails, and fix common browser problems." />
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="mt-8 bg-amber-50 border border-amber-200 rounded-2xl p-6 flex gap-4">
          ...
          <div>
            ...
            <a href={`mailto:${SUPPORT_EMAIL}?subject=Login%20Help%20Request&body=Hi%20IWIIlBUILD%20Support%2C%0A%0AI%20am%20having%20trouble%20logging%20in.%0A%0AEmail%3A%20%0AWhat%20I%20tried%3A%20%0AError%20message%20(if%20any)%3A%20`} className="inline-flex items-center gap-2 bg-amber-500 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-amber-600 transition-colors">
              <Mail size={14} />
              Email support
            </a>
          </div>
