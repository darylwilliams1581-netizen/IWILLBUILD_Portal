...
export default function CheckEmailPage() {
  ...
  return <>
      <Helmet>
        <title>Check Your Email — IWIIlBUILD Portal</title>
        ...
        <meta name="robots" content="noindex, nofollow" />
        <meta property="og:title" content="Check Your Email — IWIIlBUILD Portal" />
        <meta property="og:description" content="Verify your email address to activate your IWIIlBUILD Portal account." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://iwillbuild.com/check-email" />
        <meta property="og:image" content="https://iwillbuild.com/airo-assets/images/pages/home/og-image" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Check Your Email — IWIIlBUILD Portal" />
        <meta name="twitter:description" content="Verify your email address to activate your IWIIlBUILD Portal account." />
        <meta name="twitter:image" content="https://iwillbuild.com/airo-assets/images/pages/home/og-image" />
        <script type="application/ld+json">{JSON.stringify({
          '@context': 'https://schema.org',
          '@type': 'WebPage',
          '@id': 'https://iwillbuild.com/check-email#webpage',
          name: 'Check Your Email — IWIIlBUILD Portal',
          url: 'https://iwillbuild.com/check-email',
          description: 'Verify your email address to activate your IWIIlBUILD Portal account.',
          isPartOf: {
