  ...
  },
  {
    ...
    icons: [
      ...
      },
      {
        ...
        icon: ShieldAlert,
        bg: 'bg-rose-600',
        purpose: 'Create and manage risk assessments (SWMS) and work permits for high-risk activities. Captures hazard identification, control measures, and worker sign-offs.',
        howTo: [
          'Tap Risky & Permits on the home screen.',
          'Select the job.',
          'Choose to create a new risk assessment or view existing ones.',
          'Fill in the activity, hazards, and control measures.',
          'Workers sign off digitally before work begins.',
          'Completed assessments are stored against the job.',
        ],
        tip: 'High-risk construction work legally requires a SWMS before work starts.',
      },
      {
        key: 'forms',
        label: 'Forms',
