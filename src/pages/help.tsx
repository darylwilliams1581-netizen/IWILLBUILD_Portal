...
const GROUPS: GroupDoc[] = [
  {
    ...
    icons: [
      ...
      },
      {
        ...
        howTo: [
          'Tap Field Docs on the home screen or dock.',
          'Pick the job from the job list.',
          'Switch between the Documents and Sign-ons tabs.',
          'Tap a document to open the preview — read through all content sections.',
          'Tap Mark as Reviewed or Sign On to record your acknowledgement.',
          'Completed sign-ons are recorded against your profile and the job.',
        ],
    ...
    icons: [
      {
        ...
        howTo: [
          'Tap Safety on the dock.',
          'Browse the SWMS library or tap + to create a new SWMS.',
          'Fill in the work activity, hazards, controls, PPE, and plant/equipment.',
          'Assign the SWMS to a job.',
          'Workers review and sign on via Field Docs.',
        ],
      ...
      },
      {
        ...
        howTo: [
          'Tap Safety Posters on the dock.',
          'Browse the poster library by category.',
          'Tap a poster to view it full screen.',
          'Use the share button to send a poster or print it for site display.',
        ],
      },
      {
        key: 'site_prestart',
    ...
    icons: [
      {
        ...
        howTo: [
          'Tap Estimating on the dock.',
          'Use the Cost Guide tab to browse standard rates.',
          'Use Recipes to build reusable cost bundles.',
          'Use Builders Calc for on-site construction calculations.',
          'Use Take-off Pad to measure quantities from drawings.',
          'Create a new estimate, add sections and line items, apply margins and GST.',
      ...
      },
      {
        ...
        howTo: [
          'Tap Plan Manager on the dock.',
          'Select a job to view its plans.',
          'Tap + to upload a new plan set.',
          'Tap any plan to open the full-screen viewer.',
          'Pinch to zoom, use the annotation tools to mark up the plan.',
        ],
      },
      {
        key: 'studio_docs',
      ...
      },
      {
        ...
        howTo: [
          'Tap Library on the dock.',
          'Browse categories or search for a document.',
          'Tap any item to read it.',
          'Admins can add, edit, or archive library items.',
        ],
      },
      {
        key: 'quick_links',
        ...
        howTo: [
          'Tap Quick Links on the dock.',
          'Browse the links your admin has set up.',
          'Tap any link to open it.',
          'Admins can add, edit, or remove links from the company settings.',
        ],
      },
      {
        key: 'lists',
        ...
        howTo: [
          'Tap Lists on the dock.',
          'Select the list type you want to manage.',
          'Add, edit, or remove items from the list.',
          'Changes take effect immediately across all jobs and forms.',
        ],
    ...
    icons: [
      {
        ...
        howTo: [
          'Tap Dashboard on the dock.',
          'View KPI widgets, active jobs, recent sign-ins, and outstanding items.',
          'Check the fleet flags panel for vehicles needing attention.',
      ...
      },
      {
        ...
        howTo: [
          ...
          'Use the tabs to navigate between all job data.',
      ...
      },
      {
        ...
        howTo: [
          'Tap Job Cards on the dock.',
          'Browse jobs displayed as visual cards.',
          'Use filters to narrow by status, date, or assigned worker.',
          'Tap a card to open the full job detail.',
        ],
      },
      {
        key: 'invoices_mgmt',
      ...
      },
      {
        ...
        howTo: [
          'Tap your avatar in the top bar to access Settings.',
    ...
    icons: [
      {
        ...
        howTo: [
          'Tap User Logs on the dock (Admin/Owner only).',
          'Browse the log feed — newest events at the top.',
          'Use filters to narrow by user, action type, or date range.',
      ...
      },
      {
        ...
        howTo: [
          'Tap Sign-in History on the dock (Admin/Owner only).',
          'Browse the compact sign-in/out log.',
