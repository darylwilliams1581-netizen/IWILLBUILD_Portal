...
function ErrorShell({
  ...
  return <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 max-w-sm w-full text-center">
        ...
        <p className="text-xs text-slate-400 mt-4">Powered by IWIIlBUILD</p>
      </div>
    </div>;
}
...
export default function PhotoSharePage() {
  ...
  return <>
      <Helmet>
        <title>{job.name} — Photos · IWIIlBUILD</title>
      ...
      <div className="min-h-screen bg-slate-50">
        ...
        boxShadow: '0 1px 0 rgba(0,0,0,0.05)'
          ...
          <div className="max-w-5xl mx-auto px-4 py-3 flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              ...
              <span className="text-xs text-slate-400 font-semibold">IWIIlBUILD</span>
            </div>
          </div>
        </div>
        ...
        <div className="hidden md:block max-w-5xl mx-auto px-4 pb-8 pt-2 text-center">
          <p className="text-xs text-slate-300">Shared via IWIIlBUILD · View only</p>
        </div>
        ...
        paddingBottom: 'env(safe-area-inset-bottom)'
          ...
          <div className="flex items-center gap-3 px-4 py-3">
            ...
            <div className="flex items-center gap-1 shrink-0">
              ...
              <span className="text-[10px] text-slate-500 font-semibold">IWIIlBUILD</span>
            </div>
          </div>
        </div>
      </div>
