...
export default function FleetDrivePage() {
  ...
  return <div className="flex-1 bg-gray-50 flex flex-col overflow-hidden">
      ...
      boxShadow: '0 1px 0 rgba(0,0,0,0.05)'
        ...
        <button onClick={() => goBack(navigate, '/home')} className="w-9 h-9 rounded-xl bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-gray-200 transition-colors shrink-0">
          <ArrowLeft size={18} />
        </button>
      ...
      {/* ── Mobile: back arrow ── */}
      <button onClick={() => goBack(navigate, '/home')} className="md:hidden fixed top-3 left-3 z-20 w-9 h-9 rounded-xl bg-white/90 backdrop-blur-sm shadow-sm border border-gray-100 flex items-center justify-center text-gray-600 active:bg-gray-100 transition-colors" aria-label="Back">
        <ArrowLeft size={18} />
      </button>
