/**
 * /jobs/:jobId/purchase-orders — Standalone Purchase Orders page (Path B).
 * Wraps the canonical JobPurchaseOrders component in the shared feature shell.
 * @seo-exempt
 */
...
const FEATURE = getFeatureByKey('purchase-orders')!;
...
export default function JobPurchaseOrdersPage() {
  ...
  function handleChangeJob() {
    navigate('/work-field/purchase-orders');
  }
  ...
  return (
    <div className="portal-page">
      ...
      <PortalSidebar />
      <h1 className="sr-only">{job ? `Purchase Orders — ${job.name}` : 'Job Purchase Orders'}</h1>
