...
import {
  ChevronLeft, Zap, Plus, RefreshCw, AlertCircle,
} from 'lucide-react';
            ...
            <form id="new-jc-form" onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="flex items-center gap-3 pt-2 pb-8">
                ...
                <button
                  ...
                  form="new-jc-form"
                  disabled={saving}
                  className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl bg-yellow-500 hover:bg-yellow-600 text-white text-sm font-bold transition-colors disabled:opacity-50 shadow-sm"
                >
