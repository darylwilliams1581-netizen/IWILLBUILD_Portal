  ...
  return <>
      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        ...
        scale: 1
          ...
          <button onClick={() => goBack(navigate, `/portal/dashboard?token=${token}`)} className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-violet-500 text-white text-sm font-bold hover:bg-violet-700 transition-colors">
