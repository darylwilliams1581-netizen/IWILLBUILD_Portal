...
export function austenPlanDefaults(): Partial<WHS_PlanData> {
  return {
    ...
    contacts: [
      { ...emptyContact('Site Supervisor'), name: '', company: '', position: 'Site Supervisor', phone: '', email: '' },
      { ...emptyContact('First Aid Officer'), name: '', company: '', position: 'First Aid Officer', phone: '', email: '' },
      { ...emptyContact('WHS Representative'), name: '', company: '', position: 'WHS Representative', phone: '', email: '' },
      { ...emptyContact('Emergency Coordinator / Warden'), name: '', company: '', position: 'Emergency Coordinator', phone: '', email: '' },
    ],
    ...
    hrcwDetails: {
      'Risk of a person falling more than 2 metres': { linkedSwms: '', responsibleContractor: '', responsibleSupervisor: '', workLocation: 'All elevated work areas', scheduledStart: '', permitRequired: false, monitoringMethod: 'Daily pre-start inspection and supervisor monitoring', workerConsultation: true, status: 'Planned' },
      'Work in or near a shaft or trench deeper than 1.5 metres': { linkedSwms: '', responsibleContractor: '', responsibleSupervisor: '', workLocation: 'Excavation areas', scheduledStart: '', permitRequired: true, monitoringMethod: 'Competent person inspection before each entry', workerConsultation: true, status: 'Planned' },
    },
    ...
    recordsStorageLocation: 'Portal — Safety section.',
