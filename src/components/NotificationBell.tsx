      ...
      <AnimatePresence>
        ...
        maxHeight: '480px'
          ...
          maxHeight: '400px'
            ...
            return <div key={alert.id} onClick={() => handleAlertClick(alert)} className={`flex items-start gap-3 px-4 py-3 border-b border-slate-50 cursor-pointer transition-colors duration-100 ${alert.read ? 'bg-white hover:bg-slate-50' : 'bg-blue-50/40 hover:bg-blue-50/70'}`}>
                      {/* Icon */}
