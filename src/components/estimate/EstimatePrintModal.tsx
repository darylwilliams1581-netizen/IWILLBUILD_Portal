...
.totals-wrap{display:flex;justify-content:flex-end;margin-top:12px;margin-bottom:16px}.totals-table{border-collapse:collapse;font-size:13px;min-width:240px}.totals-table td{padding:5px 10px}.tot-label{color:#475569;text-align:left}.tot-val{text-align:right;font-variant-numeric:tabular-nums;font-weight:500}.tot-total-row td{font-size:15px;font-weight:800;color:#ffffff;background:#7c3aed;padding-top:9px;padding-bottom:9px}.tot-total-row td:first-child{border-radius:6px 0 0 6px;padding-left:14px}.tot-total-row td:last-child{border-radius:0 6px 6px 0;padding-right:14px}
