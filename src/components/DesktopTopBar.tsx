...
export default function DesktopTopBar() {
  ...
  return <div className="hidden md:flex" style={{
    position: 'fixed',
    top: 0,
    left: 0,
    right: 0,
      ...
      gap: 6
        ...
        {isOwnerEmail && <>
          ...
          (e.currentTarget as HTMLElement).style.color = 'rgba(255,255,255,0.95)';
            ...
            <Link to="/owner-console" title="Dev Console" style={pillLink} onMouseEnter={e => {
        ...
        {/* Avatar → settings */}
        <Link to="/settings" title={displayName || 'Account settings'} style={iconBtn} onMouseEnter={e => {
        ...
        (e.currentTarget as HTMLElement).style.color = 'rgba(255,255,255,0.95)';
          ...
          flexShrink: 0
            ...
            </span> : <UserCircle size={16} />}
        </Link>

        {/* Sign out */}
        <button onClick={() => void handleSignOut()} title="Sign out" style={iconBtn} onMouseEnter={e => {
        (e.currentTarget as HTMLElement).style.background = 'rgba(220,38,38,0.30)';
