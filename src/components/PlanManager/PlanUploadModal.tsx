      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="mobile-sheet plan-upload-phone-sheet fixed left-1/2 z-50 bg-background rounded-2xl shadow-2xl flex flex-col w-[calc(100vw-2rem)] sm:w-[520px] sm:max-w-[92vw]"
            style={{
              translateX: '-50%',
              translateY: '-50%',
              top: 'calc(50% + 40px)',
