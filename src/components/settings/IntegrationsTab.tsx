 ...
 * ─────────────────────────────────────────────────────────────────────────────
 * Manages third-party integrations. Currently: OneDrive / SharePoint, Xero.
 */
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-0.5">Connect IWIIlBUILD to external services.</p>
      </div>
          ...
          {!status?.configured ? (
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-2 bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-xs text-slate-600">
                ...
                <span>
                  Files are transferred to <strong>/IWIIlBUILD/</strong> in your OneDrive.
                  Job files go into <strong>/IWIIlBUILD/Job [ID]/</strong> and general files into <strong>/IWIIlBUILD/Company Files/</strong>.
                </span>
              </div>
