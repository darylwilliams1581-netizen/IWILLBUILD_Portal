    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-xl border border-slate-200 px-4 divide-y divide-slate-100">
        ...
        <PermRow
          ...
          status={perms.photos}
          showSettingsLink
          limitedNote="You've allowed access to selected photos only (iOS Limited Access). The photo picker still works, but you can only see the photos you explicitly allowed. To allow all photos, open iPhone Settings → IWIIlBUILD → Photos → All Photos."
        />
      ...
      {isNative() && (
        <div className="bg-slate-50 rounded-xl border border-slate-200 px-4 py-3">
          <p className="text-xs text-slate-500 leading-relaxed">
            ...
            Open iPhone Settings → IWIIlBUILD to update any permission at any time.
          </p>
        </div>
      )}
