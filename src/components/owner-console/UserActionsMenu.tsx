...
import {
  ...
  UserCheck, Mail, Shield, ChevronDown,
} from 'lucide-react';
...
export default function UserActionsMenu({ user, onAction }: Props) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 w-52 bg-white rounded-xl border border-slate-200 shadow-xl z-50 overflow-hidden py-1">
          {/* Verify manually */}
          {!isVerified && (
            <button
