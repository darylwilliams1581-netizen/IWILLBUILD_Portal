/**
 * TermsAcceptanceGate — compact phone sheet + sticky acknowledgement.
 * Sized with dvw/dvh so a bloated html/body cannot stretch the dialog.
 * Does not lock html/body height.
 */
    ...
    <AnimatePresence>
      {!accepted && (
        <motion.div
          ...
          className="z-[9999] flex items-center justify-center overflow-hidden"
          style={{
            position: 'fixed',
            top: 0,
            left: 0,
        ...
        >
          <motion.div
            ...
            style={{
              width: 'min(20rem, calc(100dvw - 32px))',
              maxWidth: 'min(20rem, calc(100dvw - 32px))',
              maxHeight: 'min(72dvh, calc(100dvh - 48px))',
              boxSizing: 'border-box',
            }}
            role="dialog"
            aria-modal="true"
