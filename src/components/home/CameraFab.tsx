...
function JobSearchList({
  ...
  return (
    <div className="flex flex-col gap-0">
      {/* Error banner */}
      {uploadError && (
        <div className="mx-4 mt-3 px-3 py-2.5 bg-destructive/10 border border-destructive/20 rounded-xl text-xs font-semibold text-destructive">
          {uploadError}
        </div>
      )}
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed z-40 flex items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg active:scale-90 transition-transform"
        style={{
            ...
            {sheetState === 'uploading' && (
              <div className="flex flex-col items-center justify-center gap-3 py-12 px-6">
                ...
                <div className="text-center">
                  ...
                  {selectedJob && (
                    <p className="text-xs text-muted-foreground mt-1">{jobLabel(selectedJob)}</p>
                  )}
                </div>
              </div>
            )}
