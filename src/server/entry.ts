...
// <api-imports>
// Heavy handlers — lazified as dynamic imports to reduce Rollup SSR peak memory.
// </api-imports>
// Asset Manager
...
// <api-registrations>
app.post("/api/active-ping", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/active-ping/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/asset-manager/assets", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/assets/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/asset-manager/assets", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/assets/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/asset-manager/assets/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/assets/[id]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.patch("/api/asset-manager/assets/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/assets/[id]/PATCH.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/asset-manager/assets/:id/archive", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/assets/[id]/archive/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/asset-manager/assets/:id/permanent", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/assets/[id]/permanent/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/asset-manager/assets/:id/restore", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/assets/[id]/restore/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.patch("/api/asset-manager/defects/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/defects/[id]/PATCH.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/asset-manager/defects/:id/archive", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/defects/[id]/archive/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/asset-manager/inspections", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/inspections/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/asset-manager/inspections", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/inspections/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/asset-manager/inspections/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/inspections/[id]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.patch("/api/asset-manager/inspections/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/inspections/[id]/PATCH.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/asset-manager/inspections/:id/archive", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/inspections/[id]/archive/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/asset-manager/inspections/:id/closeout", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/inspections/[id]/closeout/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/asset-manager/inspections/:id/defects", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/inspections/[id]/defects/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/asset-manager/inspections/:id/permanent", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/inspections/[id]/permanent/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/asset-manager/inspections/:id/photos", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/inspections/[id]/photos/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/asset-manager/inspections/:id/report/share", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/inspections/[id]/report/share/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/asset-manager/inspections/:id/restore", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/inspections/[id]/restore/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/asset-manager/inspections/:id/tenders", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/inspections/[id]/tenders/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/asset-manager/monitoring", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/monitoring/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/asset-manager/reports/:shareToken", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/reports/[shareToken]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.patch("/api/asset-manager/tenders/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/tenders/[id]/PATCH.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/asset-manager/tenders/:id/complete", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/tenders/[id]/complete/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/asset-manager/tenders/:id/contracts", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/asset-manager/tenders/[id]/contracts/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/auth/change-email", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/change-email/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/auth/change-password", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/change-password/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/auth/check-signup-status", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/check-signup-status/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/auth/forgot-password", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/forgot-password/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/auth/pin-login", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/pin-login/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/auth/resend-verification", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/resend-verification/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/auth/reset-password", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/reset-password/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/auth/resume-signup", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/resume-signup/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/auth/self-verify", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/self-verify/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/auth/send-sms-code", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/send-sms-code/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/auth/sms-configured", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/sms-configured/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/auth/sms-recovery", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/sms-recovery/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/auth/trusted-devices", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/trusted-devices/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/auth/trusted-devices", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/trusted-devices/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/auth/trusted-devices/:deviceId", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/trusted-devices/[deviceId]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/auth/validate-reset-token", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/validate-reset-token/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/auth/verify-email", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/verify-email/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/auth/verify-sms-code", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/verify-sms-code/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/auth/:action", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/[action]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/auth/:action", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/[action]/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/auth/:action/:detail", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/[action]/[detail]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/auth/:action/:detail", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/auth/[action]/[detail]/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/billing/cancel-subscription", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/billing/cancel-subscription/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/billing/cancellation-feedback", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/billing/cancellation-feedback/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/billing/customer-portal", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/billing/customer-portal/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/billing/reactivate-subscription", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/billing/reactivate-subscription/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/billing/upgrade-subscription", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/billing/upgrade-subscription/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/company", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/company/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/company", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/company/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/company/logo", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/company/logo/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/company-settings", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/company-settings/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/company-settings", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/company-settings/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/contact", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/contact/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/cost-guide", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/cost-guide/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/cost-guide", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/cost-guide/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/cost-guide/export-csv", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/cost-guide/export-csv/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/cost-guide/import-csv", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/cost-guide/import-csv/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/cost-guide/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/cost-guide/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/cost-guide/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/cost-guide/[id]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/customers", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/customers/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/customers", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/customers/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/customers/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/customers/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/customers/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/customers/[id]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/customers/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/customers/[id]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/dashboard/kpi", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/dashboard/kpi/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/dashboard/setup-check", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/dashboard/setup-check/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/dashboard/todos", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/dashboard/todos/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
...
app.post("/api/dazza/brain/hive/approve", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/dazza/brain/hive/approve/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/dazza/brain/hive/reject", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/dazza/brain/hive/reject/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/dazza/brain/status", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/dazza/brain/status/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
...
app.get("/api/dazza/context", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/dazza/context/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/dazza/key-status", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/dazza/key-status/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/dazza/knowledge", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/dazza/knowledge/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/dazza/knowledge", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/dazza/knowledge/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/dazza/knowledge/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/dazza/knowledge/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/dazza/knowledge/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/dazza/knowledge/[id]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/developer/activity-log", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/activity-log/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/developer/audit-log", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/audit-log/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/developer/companies/:id/archive", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/companies/[id]/archive/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/developer/company-health", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/company-health/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/developer/email-log", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/email-log/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/developer/email-settings", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/email-settings/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/developer/email-settings", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/email-settings/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/developer/email-settings/test", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/email-settings/test/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/developer/support-notes", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/support-notes/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/developer/support-notes", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/support-notes/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/developer/support-notes/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/support-notes/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/developer/users/:id/assign-company", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/users/[id]/assign-company/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/developer/users/:id/deactivate", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/users/[id]/deactivate/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/developer/users/:id/delete-orphan", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/users/[id]/delete-orphan/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/developer/users/:id/force-temp-password", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/users/[id]/force-temp-password/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/developer/users/:id/impersonate", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/users/[id]/impersonate/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/developer/users/:id/impersonate", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/users/[id]/impersonate/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/developer/users/:id/reactivate", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/users/[id]/reactivate/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/developer/users/:id/resend-verification", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/users/[id]/resend-verification/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/developer/users/:id/role", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/users/[id]/role/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/developer/users/:id/send-reset-email", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/users/[id]/send-reset-email/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/developer/users/:id/sessions", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/users/[id]/sessions/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/developer/users/:id/sessions", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/users/[id]/sessions/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/developer/users/:id/unlock-account", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/developer/users/[id]/unlock-account/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/document-templates", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/document-templates/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/document-templates", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/document-templates/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/document-templates/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/document-templates/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/document-templates/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/document-templates/[id]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/document-templates/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/document-templates/[id]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/document-templates/:id/import-docx", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/document-templates/[id]/import-docx/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/documents", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/documents/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/documents/share/:token", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/documents/share/[token]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/documents/share/:token", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/documents/share/[token]/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/documents/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/documents/[id]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/documents/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/documents/[id]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/documents/:id/events", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/documents/[id]/events/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/documents/:id/share", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/documents/[id]/share/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/documents/:id/share", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/documents/[id]/share/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/drawings", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/drawings/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/drawings", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/drawings/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/drawings/upload", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/drawings/upload/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/drawings/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/drawings/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.patch("/api/drawings/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/drawings/[id]/PATCH.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/drawings/:id/markup", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/drawings/[id]/markup/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/estimates", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/estimates/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/estimates", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/estimates/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/estimates/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/estimates/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/estimates/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/estimates/[id]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/estimates/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/estimates/[id]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/estimates/:id/export-csv", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/estimates/[id]/export-csv/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/estimates/:id/export-pdf", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/estimates/[id]/export-pdf/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/estimates/:id/import-csv", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/estimates/[id]/import-csv/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/external/form/:token", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/external/form/[token]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/external/form/:token", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/external/form/[token]/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/files", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/files/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/files", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/files/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/files/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/files/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/files/:id/download", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/files/[id]/download/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/fleet", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/fleet/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/fleet", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/fleet/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/fleet/driver-sessions", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/fleet/driver-sessions/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/fleet/driver-sessions/active", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/fleet/driver-sessions/active/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/fleet/driver-sessions/:id/stop", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/fleet/driver-sessions/[id]/stop/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/fleet/flags", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/fleet/flags/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/fleet/service-logs/:logId", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/fleet/service-logs/[logId]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.patch("/api/fleet/service-logs/:logId", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/fleet/service-logs/[logId]/PATCH.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/fleet/vehicles", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/fleet/vehicles/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/fleet/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/fleet/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/fleet/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/fleet/[id]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/fleet/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/fleet/[id]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/fleet/:id/driver-sessions", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/fleet/[id]/driver-sessions/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/fleet/:id/files", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/fleet/[id]/files/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/fleet/:id/prestarts", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/fleet/[id]/prestarts/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/fleet/:id/prestarts", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/fleet/[id]/prestarts/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/fleet/:id/service-logs", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/fleet/[id]/service-logs/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/fleet/:id/service-logs", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/fleet/[id]/service-logs/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/form-templates", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/form-templates/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/form-templates", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/form-templates/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
...
app.delete("/api/form-templates/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/form-templates/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/form-templates/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/form-templates/[id]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/forms/submissions", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/forms/submissions/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/forms/templates/:id/share-link", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/forms/templates/[id]/share-link/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/forms/:id/fields", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/forms/[id]/fields/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/forms/:id/fields", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/forms/[id]/fields/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/forms/:id/fields/reorder", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/forms/[id]/fields/reorder/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/forms/:id/fields/:fieldId", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/forms/[id]/fields/[fieldId]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.patch("/api/forms/:id/fields/:fieldId", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/forms/[id]/fields/[fieldId]/PATCH.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/forms/:id/fields/:fieldId/thumbnail", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/forms/[id]/fields/[fieldId]/thumbnail/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/health", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/health/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/integrations/myob/auth-url", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/myob/auth-url/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/integrations/myob/callback", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/myob/callback/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/integrations/myob/disconnect", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/myob/disconnect/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/integrations/myob/status", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/myob/status/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/integrations/myob/sync-invoice", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/myob/sync-invoice/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/integrations/onedrive/auth-url", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/onedrive/auth-url/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/integrations/onedrive/callback", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/onedrive/callback/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/integrations/onedrive/disconnect", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/onedrive/disconnect/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/integrations/onedrive/status", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/onedrive/status/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/integrations/onedrive/upload-file", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/onedrive/upload-file/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/integrations/qbo/auth-url", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/qbo/auth-url/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/integrations/qbo/callback", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/qbo/callback/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/integrations/qbo/disconnect", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/qbo/disconnect/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/integrations/qbo/status", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/qbo/status/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/integrations/qbo/sync-invoice", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/qbo/sync-invoice/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/integrations/xero/auth-url", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/xero/auth-url/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/integrations/xero/callback", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/xero/callback/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/integrations/xero/disconnect", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/xero/disconnect/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/integrations/xero/status", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/xero/status/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/integrations/xero/sync-customer", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/xero/sync-customer/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/integrations/xero/sync-invoice", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/xero/sync-invoice/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/integrations/xero/webhook", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/integrations/xero/webhook/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/invoices", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/invoices/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/invoices", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/invoices/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/invoices/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/invoices/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/invoices/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/invoices/[id]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/invoices/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/invoices/[id]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/invoices/:id/duplicate", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/invoices/[id]/duplicate/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/invoices/:id/export-pdf", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/invoices/[id]/export-pdf/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/invoices/:id/mark-sent", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/invoices/[id]/mark-sent/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/invoices/:id/record-payment", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/invoices/[id]/record-payment/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/invoices/:id/void", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/invoices/[id]/void/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/job-forms/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/job-forms/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/job-forms/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/job-forms/[id]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/job-forms/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/job-forms/[id]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/job-forms/:id/reset", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/job-forms/[id]/reset/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/job-forms/:id/share", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/job-forms/[id]/share/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/job-forms/:id/share", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/job-forms/[id]/share/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/job-forms/:id/share", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/job-forms/[id]/share/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/jobs", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/jobs", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/jobs/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/jobs/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/jobs/:id/costs", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/costs/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/jobs/:id/costs", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/costs/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/jobs/:id/costs/export", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/costs/export/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/jobs/:id/costs/:costId", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/costs/[costId]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/jobs/:id/costs/:costId", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/costs/[costId]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/jobs/:id/costs/:costId/receipt", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/costs/[costId]/receipt/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/jobs/:id/costs/:costId/receipt", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/costs/[costId]/receipt/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/jobs/:id/delays", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/delays/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/jobs/:id/delays", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/delays/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/jobs/:id/delays/:delayId", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/delays/[delayId]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/jobs/:id/delays/:delayId", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/delays/[delayId]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/jobs/:id/files", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/files/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/jobs/:id/forms", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/forms/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/jobs/:id/forms", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/forms/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/jobs/:id/ledger", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/ledger/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/jobs/:id/ledger", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/ledger/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/jobs/:id/ledger/export", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/ledger/export/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
...
app.delete("/api/jobs/:id/ledger/:entryId", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/ledger/[entryId]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/jobs/:id/ledger/:entryId", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/ledger/[entryId]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/jobs/:id/ledger/:entryId/correct", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/ledger/[entryId]/correct/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/jobs/:id/photos", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/photos/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/jobs/:id/photos", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/photos/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/jobs/:id/photos/:photoId", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/photos/[photoId]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.patch("/api/jobs/:id/photos/:photoId", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/photos/[photoId]/PATCH.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/jobs/:id/photos/:photoId/download", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/photos/[photoId]/download/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/jobs/:id/photos/:photoId/replace", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/photos/[photoId]/replace/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/jobs/:id/progress", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/progress/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/jobs/:id/progress", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/progress/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/jobs/:id/progress/sync", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/progress/sync/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
...
app.get("/api/jobs/:id/swms", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/swms/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/jobs/:id/swms", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/swms/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/jobs/:id/swms/:swmsId/signoff", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/swms/[swmsId]/signoff/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/jobs/:id/todos", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/todos/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/jobs/:id/todos", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/todos/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/jobs/:id/todos/:todoId", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/todos/[todoId]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/jobs/:id/todos/:todoId", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/jobs/[id]/todos/[todoId]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/me", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/me/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/me", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/me/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/me/2fa/disable", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/me/2fa/disable/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/me/2fa/enable", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/me/2fa/enable/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/me/2fa/setup", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/me/2fa/setup/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/me/2fa/status", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/me/2fa/status/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/me/2fa/verify", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/me/2fa/verify/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/me/change-password", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/me/change-password/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/me/email-status", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/me/email-status/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/me/phone", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/me/phone/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/me/phone", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/me/phone/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
...
app.get("/api/notifications/prefs", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/notifications/prefs/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/notifications/prefs", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/notifications/prefs/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/notifications/read", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/notifications/read/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/owner-console/activity", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/owner-console/activity/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/owner-console/cancellation-feedback", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/owner-console/cancellation-feedback/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/owner-console/companies", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/owner-console/companies/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/owner-console/companies", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/owner-console/companies/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/owner-console/companies/usage", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/owner-console/companies/usage/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/owner-console/companies/:id/limits", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/owner-console/companies/[id]/limits/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/owner-console/form-templates", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/owner-console/form-templates/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/owner-console/form-templates", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/owner-console/form-templates/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/owner-console/starter-pack", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/owner-console/starter-pack/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/owner-console/starter-pack", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/owner-console/starter-pack/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/owner-console/stats", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/owner-console/stats/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/owner-console/storage", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/owner-console/storage/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
...
app.get("/api/owner-console/users", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/owner-console/users/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/owner-console/users/verify", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/owner-console/users/verify/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/plan-manager/drawings", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/plan-manager/drawings/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/plan-manager/drawings", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/plan-manager/drawings/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/plan-manager/drawings/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/plan-manager/drawings/[id]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/plan-manager/drawings/:id/annotations", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/plan-manager/drawings/[id]/annotations/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/plan-manager/drawings/:id/archive", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/plan-manager/drawings/[id]/archive/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/plan-manager/drawings/:id/job-links", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/plan-manager/drawings/[id]/job-links/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/plan-manager/drawings/:id/pages/:pageNo/annotations", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/plan-manager/drawings/[id]/pages/[pageNo]/annotations/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/plan-manager/drawings/:id/permanent", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/plan-manager/drawings/[id]/permanent/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/plan-manager/drawings/:id/restore", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/plan-manager/drawings/[id]/restore/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/plan-manager/drawings/:id/revisions", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/plan-manager/drawings/[id]/revisions/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/plan-manager/drawings/:id/revisions/:revisionId/finalize", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/plan-manager/drawings/[id]/revisions/[revisionId]/finalize/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/plan-manager/drawings/:id/upload", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/plan-manager/drawings/[id]/upload/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/plan-manager/share", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/plan-manager/share/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/plan-manager/share/validate", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/plan-manager/share/validate/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/portal/estimates/:id/approve", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/portal/estimates/[id]/approve/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/portal/invite", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/portal/invite/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/portal/invoices/:id/pay", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/portal/invoices/[id]/pay/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/portal/jobs", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/portal/jobs/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/portal/jobs/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/portal/jobs/[id]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/portal/migrate", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/portal/migrate/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/portal/validate", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/portal/validate/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/public/form/:token", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/public/form/[token]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/public/form/:token/submit", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/public/form/[token]/submit/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/public/swms/:token", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/public/swms/[token]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/public/swms/:token/signoff", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/public/swms/[token]/signoff/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/push/subscribe", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/push/subscribe/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/push/subscribe", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/push/subscribe/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/push/vapid-key", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/push/vapid-key/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/recipes", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/recipes/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/recipes", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/recipes/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/recipes/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/recipes/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/recipes/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/recipes/[id]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/safety/ai/draft", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/ai/draft/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/safety/documents", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/documents/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/safety/documents", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/documents/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/safety/documents/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/documents/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/safety/documents/:id/download", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/documents/[id]/download/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/safety/generated-posters", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/generated-posters/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/safety/generated-posters", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/generated-posters/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/safety/generated-posters/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/generated-posters/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/safety/job-safety-plans", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/job-safety-plans/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/safety/job-safety-plans", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/job-safety-plans/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/safety/job-safety-plans/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/job-safety-plans/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/safety/job-safety-plans/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/job-safety-plans/[id]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/safety/job-swms", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/job-swms/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/safety/job-swms", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/job-swms/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/safety/job-swms/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/job-swms/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/safety/job-swms/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/job-swms/[id]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/safety/job-swms/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/job-swms/[id]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/safety/job-swms/:id/share-token", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/job-swms/[id]/share-token/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/safety/job-swms/:id/signoffs", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/job-swms/[id]/signoffs/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/safety/job-swms/:id/signoffs", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/job-swms/[id]/signoffs/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/safety/plans", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/plans/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/safety/plans", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/plans/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/safety/plans/seed", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/plans/seed/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/safety/plans/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/plans/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/safety/plans/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/plans/[id]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/safety/plans/:id/export", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/plans/[id]/export/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/safety/plans/:id/pack", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/plans/[id]/pack/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/safety/posters", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/posters/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/safety/posters", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/posters/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/safety/posters/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/posters/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/safety/swms", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/swms/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/safety/swms", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/swms/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/safety/swms/import-docx", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/swms/import-docx/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/safety/swms/seed", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/swms/seed/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/safety/swms/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/swms/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/safety/swms/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/swms/[id]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/safety/swms/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/swms/[id]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/safety/swms/:id/duplicate", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/swms/[id]/duplicate/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/safety/swms/:id/export", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/safety/swms/[id]/export/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/scheduler/crew", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/scheduler/crew/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/scheduler/jobs", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/scheduler/jobs/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.patch("/api/scheduler/jobs/:id/reschedule", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/scheduler/jobs/[id]/reschedule/PATCH.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/secure-share", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/secure-share/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/secure-share", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/secure-share/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/secure-share/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/secure-share/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/secure-share/:token", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/secure-share/[token]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/secure-share/:token", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/secure-share/[token]/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/settings/backup", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/settings/backup/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/settings/backup", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/settings/backup/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/settings/backup/export", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/settings/backup/export/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/settings/backup/run", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/settings/backup/run/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/settings/backup-destination", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/settings/backup-destination/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/settings/backup-destination", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/settings/backup-destination/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/settings/dazza-ai-key", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/settings/dazza-ai-key/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/settings/dazza-ai-key", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/settings/dazza-ai-key/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/settings/file-transfer-backup", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/settings/file-transfer-backup/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/settings/file-transfer-backup", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/settings/file-transfer-backup/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/settings/retention", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/settings/retention/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/settings/retention", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/settings/retention/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/settings/storage-provider", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/settings/storage-provider/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/settings/storage-provider/debug", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/settings/storage-provider/debug/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/settings/storage-provider/test", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/settings/storage-provider/test/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/settings/terminology", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/settings/terminology/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/settings/terminology", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/settings/terminology/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/settings/xero-credentials", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/settings/xero-credentials/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/settings/xero-credentials", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/settings/xero-credentials/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/share/:token", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/share/[token]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/signup", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/signup/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/stripe/create-checkout-session", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/stripe/create-checkout-session/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/stripe/session/:sessionId", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/stripe/session/[sessionId]/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/subscription/create-checkout", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/subscription/create-checkout/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/subscription/status", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/subscription/status/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/subscription/webhook", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/subscription/webhook/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/support-mode/audit", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/support-mode/audit/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/support-mode/checklist", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/support-mode/checklist/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/support-mode/checklist", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/support-mode/checklist/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/support-mode/enter", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/support-mode/enter/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/support-mode/exit", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/support-mode/exit/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/support-mode/status", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/support-mode/status/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/takeoff-pad", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/takeoff-pad/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/takeoff-pad", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/takeoff-pad/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/team", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/team/invite", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/invite/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/team/invites", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/invites/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/team/invites", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/invites/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/team/invites/:id/cancel", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/invites/[id]/cancel/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/team/invites/:id/resend", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/invites/[id]/resend/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/team/members", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/members/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/team/resend-verification", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/resend-verification/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/team/schedule/migrate", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/schedule/migrate/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/team/shifts", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/shifts/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/team/shifts", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/shifts/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/team/shifts/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/shifts/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/team/shifts/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/shifts/[id]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/team/time-entries", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/time-entries/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/team/time-entries", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/time-entries/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/team/time-entries/export", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/time-entries/export/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/team/time-entries/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/time-entries/[id]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.post("/api/team/verify-user", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/verify-user/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.delete("/api/team/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/[id]/DELETE.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.put("/api/team/:id", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/team/[id]/PUT.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
app.get("/api/usage", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/usage/GET.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
// </api-registrations>
