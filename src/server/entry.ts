...
import jobs_id_swms_get_503 from "./api/jobs/[id]/swms/GET";
import jobs_id_swms_post_504 from "./api/jobs/[id]/swms/POST";
import jobs_id_swms_swmsId_signoff_post_505 from "./api/jobs/[id]/swms/[swmsId]/signoff/POST";
import jobs_id_todos_get_506 from "./api/jobs/[id]/todos/GET";
import jobs_id_todos_post_507 from "./api/jobs/[id]/todos/POST";
import jobs_id_todos_todoId_delete_508 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import jobs_id_todos_todoId_put_509 from "./api/jobs/[id]/todos/[todoId]/PUT";
import lens_photos_get_510 from "./api/lens/photos/GET";
import lens_photos_export_zip_post_511 from "./api/lens/photos/export-zip/POST";
import lens_photos_photoId_download_get_512 from "./api/lens/photos/[photoId]/download/GET";
import library_check_published_get_513 from "./api/library/check-published/GET";
import library_items_get_514 from "./api/library/items/GET";
import library_items_id_get_515 from "./api/library/items/[id]/GET";
import library_items_id_patch_516 from "./api/library/items/[id]/PATCH";
import library_items_id_download_get_517 from "./api/library/items/[id]/download/GET";
import library_items_id_install_delete_518 from "./api/library/items/[id]/install/DELETE";
import library_items_id_install_post_519 from "./api/library/items/[id]/install/POST";
import library_my_installed_get_520 from "./api/library/my-installed/GET";
import library_my_installed_id_get_521 from "./api/library/my-installed/[id]/GET";
import library_my_submissions_get_522 from "./api/library/my-submissions/GET";
import lists_get_523 from "./api/lists/GET";
import me_get_524 from "./api/me/GET";
import me_put_525 from "./api/me/PUT";
import me_2fa_disable_post_526 from "./api/me/2fa/disable/POST";
import me_2fa_enable_post_527 from "./api/me/2fa/enable/POST";
import me_2fa_recover_post_528 from "./api/me/2fa/recover/POST";
import me_2fa_setup_get_529 from "./api/me/2fa/setup/GET";
import me_2fa_sms_disable_post_530 from "./api/me/2fa/sms/disable/POST";
import me_2fa_sms_enable_post_531 from "./api/me/2fa/sms/enable/POST";
import me_2fa_sms_send_post_532 from "./api/me/2fa/sms/send/POST";
import me_2fa_sms_send_setup_post_533 from "./api/me/2fa/sms/send-setup/POST";
import me_2fa_sms_verify_post_534 from "./api/me/2fa/sms/verify/POST";
import me_2fa_status_get_535 from "./api/me/2fa/status/GET";
import me_2fa_verify_post_536 from "./api/me/2fa/verify/POST";
import me_active_status_get_537 from "./api/me/active-status/GET";
import me_change_password_post_538 from "./api/me/change-password/POST";
import me_email_status_get_539 from "./api/me/email-status/GET";
import me_phone_get_540 from "./api/me/phone/GET";
import me_phone_put_541 from "./api/me/phone/PUT";
import me_profile_attachments_delete_542 from "./api/me/profile-attachments/DELETE";
import me_profile_attachments_post_543 from "./api/me/profile-attachments/POST";
import me_profile_attachments_download_get_544 from "./api/me/profile-attachments/download/GET";
import me_profile_attachments_thumbnail_get_545 from "./api/me/profile-attachments/thumbnail/GET";
import me_profile_extras_get_546 from "./api/me/profile-extras/GET";
import me_profile_extras_put_547 from "./api/me/profile-extras/PUT";
import migrate_account_recovery_post_548 from "./api/migrate-account-recovery/POST";
import migrate_anatomy_post_549 from "./api/migrate-anatomy/POST";
import migrate_asset_manager_post_550 from "./api/migrate-asset-manager/POST";
import migrate_attendance_post_551 from "./api/migrate-attendance/POST";
import migrate_company_settings_post_552 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_553 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_554 from "./api/migrate-dazza-knowledge/POST";
import migrate_emergency_alerts_post_555 from "./api/migrate-emergency-alerts/POST";
import migrate_estimates_post_556 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_557 from "./api/migrate-estimating-library/POST";
import migrate_files_post_558 from "./api/migrate-files/POST";
import migrate_fleet_post_559 from "./api/migrate-fleet/POST";
import migrate_fleet_analytics_post_560 from "./api/migrate-fleet-analytics/POST";
import migrate_fleet_driver_sessions_post_561 from "./api/migrate-fleet-driver-sessions/POST";
import migrate_fleet_usage_post_562 from "./api/migrate-fleet-usage/POST";
import migrate_form_fields_post_563 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_564 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_565 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_566 from "./api/migrate-job-forms/POST";
import migrate_job_photo_shares_post_567 from "./api/migrate-job-photo-shares/POST";
import migrate_job_photos_post_568 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_569 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_570 from "./api/migrate-jobs/POST";
import migrate_ledger_photo_post_571 from "./api/migrate-ledger-photo/POST";
import migrate_library_post_572 from "./api/migrate-library/POST";
import migrate_library_downloads_post_573 from "./api/migrate-library-downloads/POST";
import migrate_notifications_post_574 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_575 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_576 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_577 from "./api/migrate-pdf-settings/POST";
import migrate_photo_gps_post_578 from "./api/migrate-photo-gps/POST";
import migrate_plan_manager_post_579 from "./api/migrate-plan-manager/POST";
import migrate_plan_manager_v2_post_580 from "./api/migrate-plan-manager-v2/POST";
import migrate_plan_manager_v3_post_581 from "./api/migrate-plan-manager-v3/POST";
...
import migrate_studio_pdf_post_586 from "./api/migrate-studio-pdf/POST";
import migrate_subscriptions_post_587 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_588 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_589 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_590 from "./api/migrate-team/POST";
import notes_get_591 from "./api/notes/GET";
import notes_post_592 from "./api/notes/POST";
import notes_comments_post_593 from "./api/notes/comments/POST";
import notes_migrate_post_594 from "./api/notes/migrate/POST";
import notes_id_delete_595 from "./api/notes/[id]/DELETE";
import notifications_alerts_get_596 from "./api/notifications/alerts/GET";
import notifications_prefs_get_597 from "./api/notifications/prefs/GET";
import notifications_prefs_put_598 from "./api/notifications/prefs/PUT";
import notifications_read_post_599 from "./api/notifications/read/POST";
import owner_console_activity_get_600 from "./api/owner-console/activity/GET";
import owner_console_cancellation_feedback_get_601 from "./api/owner-console/cancellation-feedback/GET";
import owner_console_companies_get_602 from "./api/owner-console/companies/GET";
import owner_console_companies_post_603 from "./api/owner-console/companies/POST";
import owner_console_companies_usage_get_604 from "./api/owner-console/companies/usage/GET";
import owner_console_companies_id_limits_put_605 from "./api/owner-console/companies/[id]/limits/PUT";
import owner_console_form_templates_get_606 from "./api/owner-console/form-templates/GET";
import owner_console_form_templates_post_607 from "./api/owner-console/form-templates/POST";
import owner_console_library_items_get_608 from "./api/owner-console/library/items/GET";
import owner_console_library_items_post_609 from "./api/owner-console/library/items/POST";
import owner_console_library_items_from_template_post_610 from "./api/owner-console/library/items/from-template/POST";
import owner_console_library_items_id_delete_611 from "./api/owner-console/library/items/[id]/DELETE";
import owner_console_library_items_id_patch_612 from "./api/owner-console/library/items/[id]/PATCH";
import owner_console_library_items_id_put_613 from "./api/owner-console/library/items/[id]/PUT";
import owner_console_library_items_id_push_update_post_614 from "./api/owner-console/library/items/[id]/push-update/POST";
import owner_console_library_submissions_get_615 from "./api/owner-console/library/submissions/GET";
import owner_console_library_submissions_id_review_post_616 from "./api/owner-console/library/submissions/[id]/review/POST";
import owner_console_starter_pack_get_617 from "./api/owner-console/starter-pack/GET";
import owner_console_starter_pack_post_618 from "./api/owner-console/starter-pack/POST";
import owner_console_stats_get_619 from "./api/owner-console/stats/GET";
import owner_console_storage_get_620 from "./api/owner-console/storage/GET";
import owner_console_swms_masters_get_621 from "./api/owner-console/swms/masters/GET";
import owner_console_swms_masters_post_622 from "./api/owner-console/swms/masters/POST";
import owner_console_swms_masters_publish_all_post_623 from "./api/owner-console/swms/masters/publish-all/POST";
import owner_console_swms_masters_id_delete_624 from "./api/owner-console/swms/masters/[id]/DELETE";
import owner_console_swms_masters_id_get_625 from "./api/owner-console/swms/masters/[id]/GET";
import owner_console_swms_masters_id_put_626 from "./api/owner-console/swms/masters/[id]/PUT";
import owner_console_swms_masters_id_publish_post_627 from "./api/owner-console/swms/masters/[id]/publish/POST";
import owner_console_swms_migrate_master_library_post_628 from "./api/owner-console/swms/migrate-master-library/POST";
import owner_console_swms_push_post_629 from "./api/owner-console/swms/push/POST";
import owner_console_swms_seed_bricklaying_post_630 from "./api/owner-console/swms/seed-bricklaying/POST";
import owner_console_swms_seed_building_inspection_post_631 from "./api/owner-console/swms/seed-building-inspection/POST";
import owner_console_swms_seed_cabinets_post_632 from "./api/owner-console/swms/seed-cabinets/POST";
import owner_console_swms_seed_carpenter_fixing_post_633 from "./api/owner-console/swms/seed-carpenter-fixing/POST";
import owner_console_swms_seed_carpenter_framing_post_634 from "./api/owner-console/swms/seed-carpenter-framing/POST";
import owner_console_swms_seed_carpenter_lockup_post_635 from "./api/owner-console/swms/seed-carpenter-lockup/POST";
import owner_console_swms_seed_ceramic_tiling_post_636 from "./api/owner-console/swms/seed-ceramic-tiling/POST";
import owner_console_swms_seed_concreting_slab_post_637 from "./api/owner-console/swms/seed-concreting-slab/POST";
import owner_console_swms_seed_delivery_loading_post_638 from "./api/owner-console/swms/seed-delivery-loading/POST";
import owner_console_swms_seed_environmental_spill_post_639 from "./api/owner-console/swms/seed-environmental-spill/POST";
import owner_console_swms_seed_ewp_post_640 from "./api/owner-console/swms/seed-ewp/POST";
import owner_console_swms_seed_excavations_substation_post_641 from "./api/owner-console/swms/seed-excavations-substation/POST";
import owner_console_swms_seed_fencing_post_642 from "./api/owner-console/swms/seed-fencing/POST";
import owner_console_swms_seed_heat_stress_post_643 from "./api/owner-console/swms/seed-heat-stress/POST";
import owner_console_swms_seed_landscaping_post_644 from "./api/owner-console/swms/seed-landscaping/POST";
import owner_console_swms_seed_live_parts_post_645 from "./api/owner-console/swms/seed-live-parts/POST";
import owner_console_swms_seed_manual_handling_post_646 from "./api/owner-console/swms/seed-manual-handling/POST";
import owner_console_swms_seed_moving_plant_post_647 from "./api/owner-console/swms/seed-moving-plant/POST";
import owner_console_swms_seed_painting_post_648 from "./api/owner-console/swms/seed-painting/POST";
import owner_console_swms_seed_power_tools_post_649 from "./api/owner-console/swms/seed-power-tools/POST";
import owner_console_swms_seed_silica_dust_post_650 from "./api/owner-console/swms/seed-silica-dust/POST";
import owner_console_swms_seed_traffic_management_post_651 from "./api/owner-console/swms/seed-traffic-management/POST";
import owner_console_swms_seed_underground_services_post_652 from "./api/owner-console/swms/seed-underground-services/POST";
import owner_console_swms_seed_vacuum_excavation_post_653 from "./api/owner-console/swms/seed-vacuum-excavation/POST";
import owner_console_system_ai_builtin_checks_post_654 from "./api/owner-console/system-ai/builtin-checks/POST";
import owner_console_users_get_655 from "./api/owner-console/users/GET";
import owner_console_users_verify_post_656 from "./api/owner-console/users/verify/POST";
import plan_manager_drawings_get_657 from "./api/plan-manager/drawings/GET";
import plan_manager_drawings_post_658 from "./api/plan-manager/drawings/POST";
import plan_manager_drawings_id_get_659 from "./api/plan-manager/drawings/[id]/GET";
import plan_manager_drawings_id_annotations_put_660 from "./api/plan-manager/drawings/[id]/annotations/PUT";
import plan_manager_drawings_id_archive_post_661 from "./api/plan-manager/drawings/[id]/archive/POST";
import plan_manager_drawings_id_job_links_delete_662 from "./api/plan-manager/drawings/[id]/job-links/DELETE";
import plan_manager_drawings_id_job_links_post_663 from "./api/plan-manager/drawings/[id]/job-links/POST";
import plan_manager_drawings_id_pages_pageNo_annotations_get_664 from "./api/plan-manager/drawings/[id]/pages/[pageNo]/annotations/GET";
import plan_manager_drawings_id_permanent_delete_665 from "./api/plan-manager/drawings/[id]/permanent/DELETE";
import plan_manager_drawings_id_reorder_patch_666 from "./api/plan-manager/drawings/[id]/reorder/PATCH";
import plan_manager_drawings_id_restore_post_667 from "./api/plan-manager/drawings/[id]/restore/POST";
import plan_manager_drawings_id_revisions_post_668 from "./api/plan-manager/drawings/[id]/revisions/POST";
import plan_manager_drawings_id_revisions_revisionId_finalize_post_669 from "./api/plan-manager/drawings/[id]/revisions/[revisionId]/finalize/POST";
import plan_manager_drawings_id_upload_post_670 from "./api/plan-manager/drawings/[id]/upload/POST";
import plan_manager_jobs_jobId_drawings_zip_get_671 from "./api/plan-manager/jobs/[jobId]/drawings-zip/GET";
import plan_manager_jobs_with_drawings_get_672 from "./api/plan-manager/jobs-with-drawings/GET";
import plan_manager_share_post_673 from "./api/plan-manager/share/POST";
import plan_manager_share_validate_get_674 from "./api/plan-manager/share/validate/GET";
import plan_manager_upload_post_675 from "./api/plan-manager/upload/POST";
import portal_estimates_id_approve_post_676 from "./api/portal/estimates/[id]/approve/POST";
import portal_invite_post_677 from "./api/portal/invite/POST";
import portal_invoices_id_pay_post_678 from "./api/portal/invoices/[id]/pay/POST";
import portal_jobs_get_679 from "./api/portal/jobs/GET";
import portal_jobs_id_get_680 from "./api/portal/jobs/[id]/GET";
import portal_migrate_post_681 from "./api/portal/migrate/POST";
import portal_validate_post_682 from "./api/portal/validate/POST";
import public_form_token_get_683 from "./api/public/form/[token]/GET";
import public_form_token_submit_post_684 from "./api/public/form/[token]/submit/POST";
import public_job_photos_token_get_685 from "./api/public/job-photos/[token]/GET";
import public_job_photos_token_photo_photoId_get_686 from "./api/public/job-photos/[token]/photo/[photoId]/GET";
import public_swms_token_get_687 from "./api/public/swms/[token]/GET";
import public_swms_token_signoff_post_688 from "./api/public/swms/[token]/signoff/POST";
import purchase_orders_poId_compose_defaults_get_689 from "./api/purchase-orders/[poId]/compose-defaults/GET";
import purchase_orders_poId_send_email_post_690 from "./api/purchase-orders/[poId]/send-email/POST";
import push_subscribe_delete_691 from "./api/push/subscribe/DELETE";
import push_subscribe_post_692 from "./api/push/subscribe/POST";
import push_vapid_key_get_693 from "./api/push/vapid-key/GET";
import quick_links_site_meta_get_694 from "./api/quick-links/site-meta/GET";
import recipes_get_695 from "./api/recipes/GET";
import recipes_post_696 from "./api/recipes/POST";
import recipes_id_delete_697 from "./api/recipes/[id]/DELETE";
import recipes_id_put_698 from "./api/recipes/[id]/PUT";
import risk_register_get_699 from "./api/risk-register/GET";
import risk_register_post_700 from "./api/risk-register/POST";
import risk_register_id_get_701 from "./api/risk-register/[id]/GET";
import risk_register_id_put_702 from "./api/risk-register/[id]/PUT";
import risk_register_id_archive_post_703 from "./api/risk-register/[id]/archive/POST";
import risk_register_id_unarchive_post_704 from "./api/risk-register/[id]/unarchive/POST";
import rl_register_get_705 from "./api/rl-register/GET";
import rl_register_post_706 from "./api/rl-register/POST";
import rl_register_points_id_delete_707 from "./api/rl-register/points/[id]/DELETE";
import rl_register_points_id_put_708 from "./api/rl-register/points/[id]/PUT";
import rl_register_benchmarkId_points_get_709 from "./api/rl-register/[benchmarkId]/points/GET";
import rl_register_benchmarkId_points_post_710 from "./api/rl-register/[benchmarkId]/points/POST";
import rl_register_jobId_export_csv_get_711 from "./api/rl-register/[jobId]/export/csv/GET";
import rl_register_jobId_export_pdf_get_712 from "./api/rl-register/[jobId]/export/pdf/GET";
import safety_ai_draft_post_713 from "./api/safety/ai/draft/POST";
import safety_documents_get_714 from "./api/safety/documents/GET";
import safety_documents_post_715 from "./api/safety/documents/POST";
import safety_documents_new_post_716 from "./api/safety/documents/new/POST";
import safety_documents_id_delete_717 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_718 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_719 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_720 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_721 from "./api/safety/generated-posters/[id]/DELETE";
import safety_generated_posters_id_pdf_get_722 from "./api/safety/generated-posters/[id]/pdf/GET";
import safety_job_safety_plans_get_723 from "./api/safety/job-safety-plans/GET";
import safety_job_safety_plans_post_724 from "./api/safety/job-safety-plans/POST";
import safety_job_safety_plans_id_delete_725 from "./api/safety/job-safety-plans/[id]/DELETE";
import safety_job_safety_plans_id_put_726 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_727 from "./api/safety/job-swms/GET";
import safety_job_swms_post_728 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_729 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_730 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_731 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_share_token_post_732 from "./api/safety/job-swms/[id]/share-token/POST";
import safety_job_swms_id_signoffs_get_733 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_734 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_735 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_736 from "./api/safety/plans/GET";
import safety_plans_post_737 from "./api/safety/plans/POST";
import safety_plans_seed_post_738 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_739 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_740 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_741 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_742 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_743 from "./api/safety/posters/GET";
import safety_posters_post_744 from "./api/safety/posters/POST";
import safety_posters_id_delete_745 from "./api/safety/posters/[id]/DELETE";
import safety_posters_id_download_get_746 from "./api/safety/posters/[id]/download/GET";
import safety_swms_get_747 from "./api/safety/swms/GET";
import safety_swms_post_748 from "./api/safety/swms/POST";
import safety_swms_import_docx_post_749 from "./api/safety/swms/import-docx/POST";
import safety_swms_seed_post_750 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_751 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_752 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_753 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_754 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_755 from "./api/safety/swms/[id]/export/GET";
import safety_swms_id_publish_to_library_post_756 from "./api/safety/swms/[id]/publish-to-library/POST";
import safety_swms_submissions_get_757 from "./api/safety/swms-submissions/GET";
import scheduler_crew_get_758 from "./api/scheduler/crew/GET";
import scheduler_jobs_get_759 from "./api/scheduler/jobs/GET";
import scheduler_jobs_id_reschedule_patch_760 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
import scheduler_tasks_get_761 from "./api/scheduler/tasks/GET";
import sds_register_get_762 from "./api/sds-register/GET";
import sds_register_post_763 from "./api/sds-register/POST";
import sds_register_id_delete_764 from "./api/sds-register/[id]/DELETE";
import sds_register_id_put_765 from "./api/sds-register/[id]/PUT";
import sds_register_id_download_get_766 from "./api/sds-register/[id]/download/GET";
import sds_register_id_replace_post_767 from "./api/sds-register/[id]/replace/POST";
import secure_share_get_768 from "./api/secure-share/GET";
import secure_share_post_769 from "./api/secure-share/POST";
import secure_share_active_get_770 from "./api/secure-share/active/GET";
import secure_share_id_delete_771 from "./api/secure-share/[id]/DELETE";
import secure_share_id_revoke_and_rotate_post_772 from "./api/secure-share/[id]/revoke-and-rotate/POST";
import secure_share_token_get_773 from "./api/secure-share/[token]/GET";
import secure_share_token_post_774 from "./api/secure-share/[token]/POST";
import secure_share_token_content_get_775 from "./api/secure-share/[token]/content/GET";
import settings_backup_get_776 from "./api/settings/backup/GET";
import settings_backup_post_777 from "./api/settings/backup/POST";
import settings_backup_company_data_get_778 from "./api/settings/backup/company-data/GET";
import settings_backup_csv_pack_get_779 from "./api/settings/backup/csv-pack/GET";
import settings_backup_export_get_780 from "./api/settings/backup/export/GET";
import settings_backup_run_post_781 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_782 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_783 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_784 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_785 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_786 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_787 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_788 from "./api/settings/retention/GET";
import settings_retention_post_789 from "./api/settings/retention/POST";
import settings_storage_provider_get_790 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_791 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_792 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_793 from "./api/settings/terminology/GET";
import settings_terminology_post_794 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_795 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_796 from "./api/settings/xero-credentials/POST";
import share_token_get_797 from "./api/share/[token]/GET";
import signin_history_get_798 from "./api/signin-history/GET";
import signup_post_799 from "./api/signup/POST";
import sos_get_800 from "./api/sos/GET";
import sos_acknowledge_post_801 from "./api/sos/acknowledge/POST";
import sos_trigger_post_802 from "./api/sos/trigger/POST";
import stakeholders_sms_post_803 from "./api/stakeholders/sms/POST";
import stripe_create_checkout_session_post_804 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_805 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_806 from "./api/subscription/create-checkout/POST";
import subscription_status_get_807 from "./api/subscription/status/GET";
import subscription_webhook_post_808 from "./api/subscription/webhook/POST";
import support_mode_audit_get_809 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_810 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_811 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_812 from "./api/support-mode/enter/POST";
import support_mode_exit_post_813 from "./api/support-mode/exit/POST";
import support_mode_status_get_814 from "./api/support-mode/status/GET";
import tag_tasks_get_815 from "./api/tag-tasks/GET";
import tag_tasks_id_patch_816 from "./api/tag-tasks/[id]/PATCH";
import takeoff_pad_get_817 from "./api/takeoff-pad/GET";
import takeoff_pad_put_818 from "./api/takeoff-pad/PUT";
import tasks_post_819 from "./api/tasks/POST";
import tasks_id_put_820 from "./api/tasks/[id]/PUT";
import team_get_821 from "./api/team/GET";
import team_invite_post_822 from "./api/team/invite/POST";
import team_invites_get_823 from "./api/team/invites/GET";
import team_invites_post_824 from "./api/team/invites/POST";
import team_invites_id_cancel_post_825 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_826 from "./api/team/invites/[id]/resend/POST";
import team_members_get_827 from "./api/team/members/GET";
import team_members_id_icon_permissions_get_828 from "./api/team/members/[id]/icon-permissions/GET";
import team_members_id_icon_permissions_put_829 from "./api/team/members/[id]/icon-permissions/PUT";
import team_resend_verification_post_830 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_831 from "./api/team/schedule/migrate/POST";
import team_shifts_get_832 from "./api/team/shifts/GET";
import team_shifts_post_833 from "./api/team/shifts/POST";
import team_shifts_id_delete_834 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_835 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_836 from "./api/team/time-entries/GET";
import team_time_entries_post_837 from "./api/team/time-entries/POST";
import team_time_entries_export_get_838 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_839 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_840 from "./api/team/verify-user/POST";
import team_id_delete_841 from "./api/team/[id]/DELETE";
import team_id_put_842 from "./api/team/[id]/PUT";
import usage_get_843 from "./api/usage/GET";
import user_logs_get_844 from "./api/user-logs/GET";
import user_logs_users_get_845 from "./api/user-logs/users/GET";
import work_attendance_get_846 from "./api/work/attendance/GET";
import work_delays_get_847 from "./api/work/delays/GET";
import work_notes_get_848 from "./api/work/notes/GET";
import work_progress_get_849 from "./api/work/progress/GET";
import work_tasks_get_850 from "./api/work/tasks/GET";
// </api-imports>
// ── Job Cards ─────────────────────────────────────────────────────────────────
...
app.get("/api/jobs/:id/swms", jobs_id_swms_get_503);
app.post("/api/jobs/:id/swms", jobs_id_swms_post_504);
app.post("/api/jobs/:id/swms/:swmsId/signoff", jobs_id_swms_swmsId_signoff_post_505);
app.get("/api/jobs/:id/todos", jobs_id_todos_get_506);
app.post("/api/jobs/:id/todos", jobs_id_todos_post_507);
app.delete("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_delete_508);
app.put("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_put_509);
app.get("/api/lens/photos", lens_photos_get_510);
app.post("/api/lens/photos/export-zip", lens_photos_export_zip_post_511);
app.get("/api/lens/photos/:photoId/download", lens_photos_photoId_download_get_512);
app.get("/api/library/check-published", library_check_published_get_513);
app.get("/api/library/items", library_items_get_514);
app.get("/api/library/items/:id", library_items_id_get_515);
app.patch("/api/library/items/:id", library_items_id_patch_516);
app.get("/api/library/items/:id/download", library_items_id_download_get_517);
app.delete("/api/library/items/:id/install", library_items_id_install_delete_518);
app.post("/api/library/items/:id/install", library_items_id_install_post_519);
app.get("/api/library/my-installed", library_my_installed_get_520);
app.get("/api/library/my-installed/:id", library_my_installed_id_get_521);
app.get("/api/library/my-submissions", library_my_submissions_get_522);
app.get("/api/lists", lists_get_523);
app.get("/api/me", me_get_524);
app.put("/api/me", me_put_525);
app.post("/api/me/2fa/disable", me_2fa_disable_post_526);
app.post("/api/me/2fa/enable", me_2fa_enable_post_527);
app.post("/api/me/2fa/recover", me_2fa_recover_post_528);
app.get("/api/me/2fa/setup", me_2fa_setup_get_529);
app.post("/api/me/2fa/sms/disable", me_2fa_sms_disable_post_530);
app.post("/api/me/2fa/sms/enable", me_2fa_sms_enable_post_531);
app.post("/api/me/2fa/sms/send", me_2fa_sms_send_post_532);
app.post("/api/me/2fa/sms/send-setup", me_2fa_sms_send_setup_post_533);
app.post("/api/me/2fa/sms/verify", me_2fa_sms_verify_post_534);
app.get("/api/me/2fa/status", me_2fa_status_get_535);
app.post("/api/me/2fa/verify", me_2fa_verify_post_536);
app.get("/api/me/active-status", me_active_status_get_537);
app.post("/api/me/change-password", me_change_password_post_538);
app.get("/api/me/email-status", me_email_status_get_539);
app.get("/api/me/phone", me_phone_get_540);
app.put("/api/me/phone", me_phone_put_541);
app.delete("/api/me/profile-attachments", me_profile_attachments_delete_542);
app.post("/api/me/profile-attachments", me_profile_attachments_post_543);
app.get("/api/me/profile-attachments/download", me_profile_attachments_download_get_544);
app.get("/api/me/profile-attachments/thumbnail", me_profile_attachments_thumbnail_get_545);
app.get("/api/me/profile-extras", me_profile_extras_get_546);
app.put("/api/me/profile-extras", me_profile_extras_put_547);
app.post("/api/migrate-account-recovery", migrate_account_recovery_post_548);
app.post("/api/migrate-anatomy", migrate_anatomy_post_549);
app.post("/api/migrate-asset-manager", migrate_asset_manager_post_550);
app.post("/api/migrate-attendance", migrate_attendance_post_551);
app.post("/api/migrate-company-settings", migrate_company_settings_post_552);
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_553);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_554);
app.post("/api/migrate-emergency-alerts", migrate_emergency_alerts_post_555);
app.post("/api/migrate-estimates", migrate_estimates_post_556);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_557);
app.post("/api/migrate-files", migrate_files_post_558);
app.post("/api/migrate-fleet", migrate_fleet_post_559);
app.post("/api/migrate-fleet-analytics", migrate_fleet_analytics_post_560);
app.post("/api/migrate-fleet-driver-sessions", migrate_fleet_driver_sessions_post_561);
app.post("/api/migrate-fleet-usage", migrate_fleet_usage_post_562);
app.post("/api/migrate-form-fields", migrate_form_fields_post_563);
app.post("/api/migrate-form-logic", migrate_form_logic_post_564);
app.post("/api/migrate-form-templates", migrate_form_templates_post_565);
app.post("/api/migrate-job-forms", migrate_job_forms_post_566);
app.post("/api/migrate-job-photo-shares", migrate_job_photo_shares_post_567);
app.post("/api/migrate-job-photos", migrate_job_photos_post_568);
app.post("/api/migrate-job-tabs", migrate_job_tabs_post_569);
app.post("/api/migrate-jobs", migrate_jobs_post_570);
app.post("/api/migrate-ledger-photo", migrate_ledger_photo_post_571);
app.post("/api/migrate-library", migrate_library_post_572);
app.post("/api/migrate-library-downloads", migrate_library_downloads_post_573);
app.post("/api/migrate-notifications", migrate_notifications_post_574);
app.post("/api/migrate-owner-console", migrate_owner_console_post_575);
app.post("/api/migrate-owner-role", migrate_owner_role_post_576);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_577);
app.post("/api/migrate-photo-gps", migrate_photo_gps_post_578);
app.post("/api/migrate-plan-manager", migrate_plan_manager_post_579);
app.post("/api/migrate-plan-manager-v2", migrate_plan_manager_v2_post_580);
app.post("/api/migrate-plan-manager-v3", migrate_plan_manager_v3_post_581);
...
app.post("/api/migrate-studio-pdf", migrate_studio_pdf_post_586);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_587);
app.post("/api/migrate-support-mode", migrate_support_mode_post_588);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_589);
app.post("/api/migrate-team", migrate_team_post_590);
app.get("/api/notes", notes_get_591);
app.post("/api/notes", notes_post_592);
app.post("/api/notes/comments", notes_comments_post_593);
app.post("/api/notes/migrate", notes_migrate_post_594);
app.delete("/api/notes/:id", notes_id_delete_595);
app.get("/api/notifications/alerts", notifications_alerts_get_596);
app.get("/api/notifications/prefs", notifications_prefs_get_597);
app.put("/api/notifications/prefs", notifications_prefs_put_598);
app.post("/api/notifications/read", notifications_read_post_599);
app.get("/api/owner-console/activity", owner_console_activity_get_600);
app.get("/api/owner-console/cancellation-feedback", owner_console_cancellation_feedback_get_601);
app.get("/api/owner-console/companies", owner_console_companies_get_602);
app.post("/api/owner-console/companies", owner_console_companies_post_603);
app.get("/api/owner-console/companies/usage", owner_console_companies_usage_get_604);
app.put("/api/owner-console/companies/:id/limits", owner_console_companies_id_limits_put_605);
app.get("/api/owner-console/form-templates", owner_console_form_templates_get_606);
app.post("/api/owner-console/form-templates", owner_console_form_templates_post_607);
app.get("/api/owner-console/library/items", owner_console_library_items_get_608);
app.post("/api/owner-console/library/items", owner_console_library_items_post_609);
app.post("/api/owner-console/library/items/from-template", owner_console_library_items_from_template_post_610);
app.delete("/api/owner-console/library/items/:id", owner_console_library_items_id_delete_611);
app.patch("/api/owner-console/library/items/:id", owner_console_library_items_id_patch_612);
app.put("/api/owner-console/library/items/:id", owner_console_library_items_id_put_613);
app.post("/api/owner-console/library/items/:id/push-update", owner_console_library_items_id_push_update_post_614);
app.get("/api/owner-console/library/submissions", owner_console_library_submissions_get_615);
app.post("/api/owner-console/library/submissions/:id/review", owner_console_library_submissions_id_review_post_616);
app.get("/api/owner-console/starter-pack", owner_console_starter_pack_get_617);
app.post("/api/owner-console/starter-pack", owner_console_starter_pack_post_618);
app.get("/api/owner-console/stats", owner_console_stats_get_619);
app.get("/api/owner-console/storage", owner_console_storage_get_620);
app.get("/api/owner-console/swms/masters", owner_console_swms_masters_get_621);
app.post("/api/owner-console/swms/masters", owner_console_swms_masters_post_622);
app.post("/api/owner-console/swms/masters/publish-all", owner_console_swms_masters_publish_all_post_623);
app.delete("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_delete_624);
app.get("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_get_625);
app.put("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_put_626);
app.post("/api/owner-console/swms/masters/:id/publish", owner_console_swms_masters_id_publish_post_627);
app.post("/api/owner-console/swms/migrate-master-library", owner_console_swms_migrate_master_library_post_628);
app.post("/api/owner-console/swms/push", owner_console_swms_push_post_629);
app.post("/api/owner-console/swms/seed-bricklaying", owner_console_swms_seed_bricklaying_post_630);
app.post("/api/owner-console/swms/seed-building-inspection", owner_console_swms_seed_building_inspection_post_631);
app.post("/api/owner-console/swms/seed-cabinets", owner_console_swms_seed_cabinets_post_632);
app.post("/api/owner-console/swms/seed-carpenter-fixing", owner_console_swms_seed_carpenter_fixing_post_633);
app.post("/api/owner-console/swms/seed-carpenter-framing", owner_console_swms_seed_carpenter_framing_post_634);
app.post("/api/owner-console/swms/seed-carpenter-lockup", owner_console_swms_seed_carpenter_lockup_post_635);
app.post("/api/owner-console/swms/seed-ceramic-tiling", owner_console_swms_seed_ceramic_tiling_post_636);
app.post("/api/owner-console/swms/seed-concreting-slab", owner_console_swms_seed_concreting_slab_post_637);
app.post("/api/owner-console/swms/seed-delivery-loading", owner_console_swms_seed_delivery_loading_post_638);
app.post("/api/owner-console/swms/seed-environmental-spill", owner_console_swms_seed_environmental_spill_post_639);
app.post("/api/owner-console/swms/seed-ewp", owner_console_swms_seed_ewp_post_640);
app.post("/api/owner-console/swms/seed-excavations-substation", owner_console_swms_seed_excavations_substation_post_641);
app.post("/api/owner-console/swms/seed-fencing", owner_console_swms_seed_fencing_post_642);
app.post("/api/owner-console/swms/seed-heat-stress", owner_console_swms_seed_heat_stress_post_643);
app.post("/api/owner-console/swms/seed-landscaping", owner_console_swms_seed_landscaping_post_644);
app.post("/api/owner-console/swms/seed-live-parts", owner_console_swms_seed_live_parts_post_645);
app.post("/api/owner-console/swms/seed-manual-handling", owner_console_swms_seed_manual_handling_post_646);
app.post("/api/owner-console/swms/seed-moving-plant", owner_console_swms_seed_moving_plant_post_647);
app.post("/api/owner-console/swms/seed-painting", owner_console_swms_seed_painting_post_648);
app.post("/api/owner-console/swms/seed-power-tools", owner_console_swms_seed_power_tools_post_649);
app.post("/api/owner-console/swms/seed-silica-dust", owner_console_swms_seed_silica_dust_post_650);
app.post("/api/owner-console/swms/seed-traffic-management", owner_console_swms_seed_traffic_management_post_651);
app.post("/api/owner-console/swms/seed-underground-services", owner_console_swms_seed_underground_services_post_652);
app.post("/api/owner-console/swms/seed-vacuum-excavation", owner_console_swms_seed_vacuum_excavation_post_653);
app.post("/api/owner-console/system-ai/builtin-checks", owner_console_system_ai_builtin_checks_post_654);
app.get("/api/owner-console/users", owner_console_users_get_655);
app.post("/api/owner-console/users/verify", owner_console_users_verify_post_656);
app.get("/api/plan-manager/drawings", plan_manager_drawings_get_657);
app.post("/api/plan-manager/drawings", plan_manager_drawings_post_658);
app.get("/api/plan-manager/drawings/:id", plan_manager_drawings_id_get_659);
app.put("/api/plan-manager/drawings/:id/annotations", plan_manager_drawings_id_annotations_put_660);
app.post("/api/plan-manager/drawings/:id/archive", plan_manager_drawings_id_archive_post_661);
app.delete("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_delete_662);
app.post("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_post_663);
app.get("/api/plan-manager/drawings/:id/pages/:pageNo/annotations", plan_manager_drawings_id_pages_pageNo_annotations_get_664);
app.delete("/api/plan-manager/drawings/:id/permanent", plan_manager_drawings_id_permanent_delete_665);
app.patch("/api/plan-manager/drawings/:id/reorder", plan_manager_drawings_id_reorder_patch_666);
app.post("/api/plan-manager/drawings/:id/restore", plan_manager_drawings_id_restore_post_667);
app.post("/api/plan-manager/drawings/:id/revisions", plan_manager_drawings_id_revisions_post_668);
app.post("/api/plan-manager/drawings/:id/revisions/:revisionId/finalize", plan_manager_drawings_id_revisions_revisionId_finalize_post_669);
app.post("/api/plan-manager/drawings/:id/upload", plan_manager_drawings_id_upload_post_670);
app.get("/api/plan-manager/jobs/:jobId/drawings-zip", plan_manager_jobs_jobId_drawings_zip_get_671);
app.get("/api/plan-manager/jobs-with-drawings", plan_manager_jobs_with_drawings_get_672);
app.post("/api/plan-manager/share", plan_manager_share_post_673);
app.get("/api/plan-manager/share/validate", plan_manager_share_validate_get_674);
app.post("/api/plan-manager/upload", plan_manager_upload_post_675);
app.post("/api/portal/estimates/:id/approve", portal_estimates_id_approve_post_676);
app.post("/api/portal/invite", portal_invite_post_677);
app.post("/api/portal/invoices/:id/pay", portal_invoices_id_pay_post_678);
app.get("/api/portal/jobs", portal_jobs_get_679);
app.get("/api/portal/jobs/:id", portal_jobs_id_get_680);
app.post("/api/portal/migrate", portal_migrate_post_681);
app.post("/api/portal/validate", portal_validate_post_682);
app.get("/api/public/form/:token", public_form_token_get_683);
app.post("/api/public/form/:token/submit", public_form_token_submit_post_684);
app.get("/api/public/job-photos/:token", public_job_photos_token_get_685);
app.get("/api/public/job-photos/:token/photo/:photoId", public_job_photos_token_photo_photoId_get_686);
app.get("/api/public/swms/:token", public_swms_token_get_687);
app.post("/api/public/swms/:token/signoff", public_swms_token_signoff_post_688);
app.get("/api/purchase-orders/:poId/compose-defaults", purchase_orders_poId_compose_defaults_get_689);
app.post("/api/purchase-orders/:poId/send-email", purchase_orders_poId_send_email_post_690);
app.delete("/api/push/subscribe", push_subscribe_delete_691);
app.post("/api/push/subscribe", push_subscribe_post_692);
app.get("/api/push/vapid-key", push_vapid_key_get_693);
app.get("/api/quick-links/site-meta", quick_links_site_meta_get_694);
app.get("/api/recipes", recipes_get_695);
app.post("/api/recipes", recipes_post_696);
app.delete("/api/recipes/:id", recipes_id_delete_697);
app.put("/api/recipes/:id", recipes_id_put_698);
app.get("/api/risk-register", risk_register_get_699);
app.post("/api/risk-register", risk_register_post_700);
app.get("/api/risk-register/:id", risk_register_id_get_701);
app.put("/api/risk-register/:id", risk_register_id_put_702);
app.post("/api/risk-register/:id/archive", risk_register_id_archive_post_703);
app.post("/api/risk-register/:id/unarchive", risk_register_id_unarchive_post_704);
app.get("/api/rl-register", rl_register_get_705);
app.post("/api/rl-register", rl_register_post_706);
app.delete("/api/rl-register/points/:id", rl_register_points_id_delete_707);
app.put("/api/rl-register/points/:id", rl_register_points_id_put_708);
app.get("/api/rl-register/:benchmarkId/points", rl_register_benchmarkId_points_get_709);
app.post("/api/rl-register/:benchmarkId/points", rl_register_benchmarkId_points_post_710);
app.get("/api/rl-register/:jobId/export/csv", rl_register_jobId_export_csv_get_711);
app.get("/api/rl-register/:jobId/export/pdf", rl_register_jobId_export_pdf_get_712);
app.post("/api/safety/ai/draft", safety_ai_draft_post_713);
app.get("/api/safety/documents", safety_documents_get_714);
app.post("/api/safety/documents", safety_documents_post_715);
app.post("/api/safety/documents/new", safety_documents_new_post_716);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_717);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_718);
app.get("/api/safety/generated-posters", safety_generated_posters_get_719);
app.post("/api/safety/generated-posters", safety_generated_posters_post_720);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_721);
app.get("/api/safety/generated-posters/:id/pdf", safety_generated_posters_id_pdf_get_722);
app.get("/api/safety/job-safety-plans", safety_job_safety_plans_get_723);
app.post("/api/safety/job-safety-plans", safety_job_safety_plans_post_724);
app.delete("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_delete_725);
app.put("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_put_726);
app.get("/api/safety/job-swms", safety_job_swms_get_727);
app.post("/api/safety/job-swms", safety_job_swms_post_728);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_729);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_730);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_731);
app.post("/api/safety/job-swms/:id/share-token", safety_job_swms_id_share_token_post_732);
app.get("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_get_733);
app.post("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_post_734);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", safety_job_swms_id_signoffs_signoffId_delete_735);
app.get("/api/safety/plans", safety_plans_get_736);
app.post("/api/safety/plans", safety_plans_post_737);
app.post("/api/safety/plans/seed", safety_plans_seed_post_738);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_739);
app.put("/api/safety/plans/:id", safety_plans_id_put_740);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_741);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_742);
app.get("/api/safety/posters", safety_posters_get_743);
app.post("/api/safety/posters", safety_posters_post_744);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_745);
app.get("/api/safety/posters/:id/download", safety_posters_id_download_get_746);
app.get("/api/safety/swms", safety_swms_get_747);
app.post("/api/safety/swms", safety_swms_post_748);
app.post("/api/safety/swms/import-docx", safety_swms_import_docx_post_749);
app.post("/api/safety/swms/seed", safety_swms_seed_post_750);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_751);
app.get("/api/safety/swms/:id", safety_swms_id_get_752);
app.put("/api/safety/swms/:id", safety_swms_id_put_753);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_754);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_755);
app.post("/api/safety/swms/:id/publish-to-library", safety_swms_id_publish_to_library_post_756);
app.get("/api/safety/swms-submissions", safety_swms_submissions_get_757);
app.get("/api/scheduler/crew", scheduler_crew_get_758);
app.get("/api/scheduler/jobs", scheduler_jobs_get_759);
app.patch("/api/scheduler/jobs/:id/reschedule", scheduler_jobs_id_reschedule_patch_760);
app.get("/api/scheduler/tasks", scheduler_tasks_get_761);
app.get("/api/sds-register", sds_register_get_762);
app.post("/api/sds-register", sds_register_post_763);
app.delete("/api/sds-register/:id", sds_register_id_delete_764);
app.put("/api/sds-register/:id", sds_register_id_put_765);
app.get("/api/sds-register/:id/download", sds_register_id_download_get_766);
app.post("/api/sds-register/:id/replace", sds_register_id_replace_post_767);
app.get("/api/secure-share", secure_share_get_768);
app.post("/api/secure-share", secure_share_post_769);
app.get("/api/secure-share/active", secure_share_active_get_770);
app.delete("/api/secure-share/:id", secure_share_id_delete_771);
app.post("/api/secure-share/:id/revoke-and-rotate", secure_share_id_revoke_and_rotate_post_772);
app.get("/api/secure-share/:token", secure_share_token_get_773);
app.post("/api/secure-share/:token", secure_share_token_post_774);
app.get("/api/secure-share/:token/content", secure_share_token_content_get_775);
app.get("/api/settings/backup", settings_backup_get_776);
app.post("/api/settings/backup", settings_backup_post_777);
app.get("/api/settings/backup/company-data", settings_backup_company_data_get_778);
app.get("/api/settings/backup/csv-pack", settings_backup_csv_pack_get_779);
app.get("/api/settings/backup/export", settings_backup_export_get_780);
app.post("/api/settings/backup/run", settings_backup_run_post_781);
app.get("/api/settings/backup-destination", settings_backup_destination_get_782);
app.post("/api/settings/backup-destination", settings_backup_destination_post_783);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_784);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_785);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_786);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_787);
app.get("/api/settings/retention", settings_retention_get_788);
app.post("/api/settings/retention", settings_retention_post_789);
app.get("/api/settings/storage-provider", settings_storage_provider_get_790);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_791);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_792);
app.get("/api/settings/terminology", settings_terminology_get_793);
app.post("/api/settings/terminology", settings_terminology_post_794);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_795);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_796);
app.get("/api/share/:token", share_token_get_797);
app.get("/api/signin-history", signin_history_get_798);
app.post("/api/signup", signup_post_799);
app.get("/api/sos", sos_get_800);
app.post("/api/sos/acknowledge", sos_acknowledge_post_801);
app.post("/api/sos/trigger", sos_trigger_post_802);
app.post("/api/stakeholders/sms", stakeholders_sms_post_803);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_804);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_805);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_806);
app.get("/api/subscription/status", subscription_status_get_807);
app.post("/api/subscription/webhook", subscription_webhook_post_808);
app.get("/api/support-mode/audit", support_mode_audit_get_809);
app.get("/api/support-mode/checklist", support_mode_checklist_get_810);
app.put("/api/support-mode/checklist", support_mode_checklist_put_811);
app.post("/api/support-mode/enter", support_mode_enter_post_812);
app.post("/api/support-mode/exit", support_mode_exit_post_813);
app.get("/api/support-mode/status", support_mode_status_get_814);
app.get("/api/tag-tasks", tag_tasks_get_815);
app.patch("/api/tag-tasks/:id", tag_tasks_id_patch_816);
app.get("/api/takeoff-pad", takeoff_pad_get_817);
app.put("/api/takeoff-pad", takeoff_pad_put_818);
app.post("/api/tasks", tasks_post_819);
app.put("/api/tasks/:id", tasks_id_put_820);
app.get("/api/team", team_get_821);
app.post("/api/team/invite", team_invite_post_822);
app.get("/api/team/invites", team_invites_get_823);
app.post("/api/team/invites", team_invites_post_824);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_825);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_826);
app.get("/api/team/members", team_members_get_827);
app.get("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_get_828);
app.put("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_put_829);
app.post("/api/team/resend-verification", team_resend_verification_post_830);
app.post("/api/team/schedule/migrate", team_schedule_migrate_post_831);
app.get("/api/team/shifts", team_shifts_get_832);
app.post("/api/team/shifts", team_shifts_post_833);
app.delete("/api/team/shifts/:id", team_shifts_id_delete_834);
app.put("/api/team/shifts/:id", team_shifts_id_put_835);
app.get("/api/team/time-entries", team_time_entries_get_836);
app.post("/api/team/time-entries", team_time_entries_post_837);
app.get("/api/team/time-entries/export", team_time_entries_export_get_838);
app.put("/api/team/time-entries/:id", team_time_entries_id_put_839);
app.post("/api/team/verify-user", team_verify_user_post_840);
app.delete("/api/team/:id", team_id_delete_841);
app.put("/api/team/:id", team_id_put_842);
app.get("/api/usage", usage_get_843);
app.get("/api/user-logs", user_logs_get_844);
app.get("/api/user-logs/users", user_logs_users_get_845);
app.get("/api/work/attendance", work_attendance_get_846);
app.get("/api/work/delays", work_delays_get_847);
app.get("/api/work/notes", work_notes_get_848);
app.get("/api/work/progress", work_progress_get_849);
app.get("/api/work/tasks", work_tasks_get_850);
// </api-registrations>
