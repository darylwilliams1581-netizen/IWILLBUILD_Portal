...
import _h_migrate_notifications_post_36 from "./api/migrate-notifications/POST";
import _h_migrate_owner_console_post_37 from "./api/migrate-owner-console/POST";
import _h_migrate_owner_role_post_38 from "./api/migrate-owner-role/POST";
import _h_migrate_pdf_settings_post_39 from "./api/migrate-pdf-settings/POST";
import _h_migrate_plan_manager_post_40 from "./api/migrate-plan-manager/POST";
import _h_migrate_plan_manager_v2_post_41 from "./api/migrate-plan-manager-v2/POST";
import _h_migrate_plan_manager_v3_post_42 from "./api/migrate-plan-manager-v3/POST";
import _h_migrate_safety_post_43 from "./api/migrate-safety/POST";
import _h_migrate_starter_pack_post_44 from "./api/migrate-starter-pack/POST";
import _h_migrate_studio_pdf_post_45 from "./api/migrate-studio-pdf/POST";
import _h_migrate_subscriptions_post_46 from "./api/migrate-subscriptions/POST";
import _h_migrate_support_mode_post_47 from "./api/migrate-support-mode/POST";
import _h_migrate_takeoff_pad_post_48 from "./api/migrate-takeoff-pad/POST";
import _h_migrate_team_post_49 from "./api/migrate-team/POST";
import _h_notifications_alerts_get_50 from "./api/notifications/alerts/GET";
import _h_owner_console_system_ai_builtin_checks_post_51 from "./api/owner-console/system-ai/builtin-checks/POST";
...
import fleet_driver_sessions_live_get from "./api/fleet/driver-sessions/live/GET";
import fleet_driver_sessions_id_telemetry_latest_get from "./api/fleet/driver-sessions/[id]/telemetry/latest/GET";
...
import owner_console_library_items_post from "./api/owner-console/library/items/POST";
import owner_console_library_items_id_patch from "./api/owner-console/library/items/[id]/PATCH";
import owner_console_library_items_id_delete from "./api/owner-console/library/items/[id]/DELETE";
...
app.get("/api/fleet/driver-sessions/live", fleet_driver_sessions_live_get);
...
app.get("/api/fleet/driver-sessions/:id/telemetry/latest", fleet_driver_sessions_id_telemetry_latest_get);
...
app.post("/api/migrate-notifications", _h_migrate_notifications_post_36);
app.post("/api/migrate-owner-console", _h_migrate_owner_console_post_37);
app.post("/api/migrate-owner-role", _h_migrate_owner_role_post_38);
app.post("/api/migrate-pdf-settings", _h_migrate_pdf_settings_post_39);
app.post("/api/migrate-plan-manager", _h_migrate_plan_manager_post_40);
app.post("/api/migrate-plan-manager-v2", _h_migrate_plan_manager_v2_post_41);
app.post("/api/migrate-plan-manager-v3", _h_migrate_plan_manager_v3_post_42);
app.post("/api/migrate-safety", _h_migrate_safety_post_43);
app.post("/api/migrate-starter-pack", _h_migrate_starter_pack_post_44);
app.post("/api/migrate-studio-pdf", _h_migrate_studio_pdf_post_45);
app.post("/api/migrate-subscriptions", _h_migrate_subscriptions_post_46);
app.post("/api/migrate-support-mode", _h_migrate_support_mode_post_47);
app.post("/api/migrate-takeoff-pad", _h_migrate_takeoff_pad_post_48);
app.post("/api/migrate-team", _h_migrate_team_post_49);
...
app.get("/api/notifications/alerts", _h_notifications_alerts_get_50);
...
app.post("/api/owner-console/library/items", owner_console_library_items_post);
app.patch("/api/owner-console/library/items/:id", owner_console_library_items_id_patch);
app.delete("/api/owner-console/library/items/:id", owner_console_library_items_id_delete);
...
app.post("/api/owner-console/system-ai/builtin-checks", _h_owner_console_system_ai_builtin_checks_post_51);
