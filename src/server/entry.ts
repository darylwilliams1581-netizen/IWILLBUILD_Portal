...
import _h_migrate_sms_verified_at_post_15 from "./api/migrate-sms-verified-at/POST";
import _h_migrate_asset_manager_post_16 from "./api/migrate-asset-manager/POST";
import _h_migrate_attendance_post_17 from "./api/migrate-attendance/POST";
import _h_migrate_company_settings_post_18 from "./api/migrate-company-settings/POST";
import _h_migrate_dazza_audit_post_19 from "./api/migrate-dazza-audit/POST";
import _h_migrate_dazza_knowledge_post_20 from "./api/migrate-dazza-knowledge/POST";
import _h_migrate_emergency_alerts_post_21 from "./api/migrate-emergency-alerts/POST";
import _h_migrate_estimates_post_22 from "./api/migrate-estimates/POST";
import _h_migrate_estimating_library_post_23 from "./api/migrate-estimating-library/POST";
import _h_migrate_files_post_24 from "./api/migrate-files/POST";
import _h_migrate_fleet_post_25 from "./api/migrate-fleet/POST";
import _h_migrate_fleet_analytics_post_26 from "./api/migrate-fleet-analytics/POST";
import _h_migrate_fleet_driver_sessions_post_27 from "./api/migrate-fleet-driver-sessions/POST";
import _h_migrate_fleet_usage_post_28 from "./api/migrate-fleet-usage/POST";
import _h_migrate_form_fields_post_29 from "./api/migrate-form-fields/POST";
import _h_migrate_form_logic_post_30 from "./api/migrate-form-logic/POST";
import _h_migrate_form_templates_post_31 from "./api/migrate-form-templates/POST";
import _h_migrate_job_forms_post_32 from "./api/migrate-job-forms/POST";
import _h_migrate_job_photo_shares_post_33 from "./api/migrate-job-photo-shares/POST";
import _h_migrate_job_photos_post_34 from "./api/migrate-job-photos/POST";
import _h_migrate_job_tabs_post_35 from "./api/migrate-job-tabs/POST";
import _h_migrate_jobs_post_36 from "./api/migrate-jobs/POST";
import _h_migrate_ledger_photo_post_37 from "./api/migrate-ledger-photo/POST";
import _h_migrate_library_post_38 from "./api/migrate-library/POST";
import _h_migrate_library_downloads_post_39 from "./api/migrate-library-downloads/POST";
import _h_migrate_notifications_post_40 from "./api/migrate-notifications/POST";
import _h_migrate_owner_console_post_41 from "./api/migrate-owner-console/POST";
import _h_migrate_owner_role_post_42 from "./api/migrate-owner-role/POST";
import _h_migrate_pdf_settings_post_43 from "./api/migrate-pdf-settings/POST";
import _h_migrate_plan_manager_post_44 from "./api/migrate-plan-manager/POST";
import _h_migrate_plan_manager_v2_post_45 from "./api/migrate-plan-manager-v2/POST";
import _h_migrate_plan_manager_v3_post_46 from "./api/migrate-plan-manager-v3/POST";
import _h_migrate_safety_post_47 from "./api/migrate-safety/POST";
import _h_migrate_site_prestart_post_48 from "./api/migrate-site-prestart/POST";
import _h_migrate_starter_pack_post_49 from "./api/migrate-starter-pack/POST";
import _h_migrate_studio_pdf_post_50 from "./api/migrate-studio-pdf/POST";
import _h_migrate_subscriptions_post_51 from "./api/migrate-subscriptions/POST";
import _h_migrate_support_mode_post_52 from "./api/migrate-support-mode/POST";
import _h_migrate_takeoff_pad_post_53 from "./api/migrate-takeoff-pad/POST";
import _h_migrate_team_post_54 from "./api/migrate-team/POST";
import _h_notifications_alerts_get_55 from "./api/notifications/alerts/GET";
import _h_owner_console_system_ai_builtin_checks_post_56 from "./api/owner-console/system-ai/builtin-checks/POST";
...
app.post("/api/migrate-sms-verified-at", _h_migrate_sms_verified_at_post_15);
app.post("/api/migrate-asset-manager", _h_migrate_asset_manager_post_16);
app.post("/api/migrate-attendance", _h_migrate_attendance_post_17);
app.post("/api/migrate-company-settings", _h_migrate_company_settings_post_18);
app.post("/api/migrate-dazza-audit", _h_migrate_dazza_audit_post_19);
app.post("/api/migrate-dazza-knowledge", _h_migrate_dazza_knowledge_post_20);
app.post("/api/migrate-emergency-alerts", _h_migrate_emergency_alerts_post_21);
app.post("/api/migrate-estimates", _h_migrate_estimates_post_22);
app.post("/api/migrate-estimating-library", _h_migrate_estimating_library_post_23);
app.post("/api/migrate-files", _h_migrate_files_post_24);
app.post("/api/migrate-fleet", _h_migrate_fleet_post_25);
app.post("/api/migrate-fleet-analytics", _h_migrate_fleet_analytics_post_26);
app.post("/api/migrate-fleet-driver-sessions", _h_migrate_fleet_driver_sessions_post_27);
app.post("/api/migrate-fleet-usage", _h_migrate_fleet_usage_post_28);
app.post("/api/migrate-form-fields", _h_migrate_form_fields_post_29);
app.post("/api/migrate-form-logic", _h_migrate_form_logic_post_30);
app.post("/api/migrate-form-templates", _h_migrate_form_templates_post_31);
app.post("/api/migrate-job-forms", _h_migrate_job_forms_post_32);
app.post("/api/migrate-job-photo-shares", _h_migrate_job_photo_shares_post_33);
app.post("/api/migrate-job-photos", _h_migrate_job_photos_post_34);
app.post("/api/migrate-job-tabs", _h_migrate_job_tabs_post_35);
app.post("/api/migrate-jobs", _h_migrate_jobs_post_36);
app.post("/api/migrate-ledger-photo", _h_migrate_ledger_photo_post_37);
app.post("/api/migrate-library", _h_migrate_library_post_38);
app.post("/api/migrate-library-downloads", _h_migrate_library_downloads_post_39);
app.post("/api/migrate-notifications", _h_migrate_notifications_post_40);
app.post("/api/migrate-owner-console", _h_migrate_owner_console_post_41);
app.post("/api/migrate-owner-role", _h_migrate_owner_role_post_42);
app.post("/api/migrate-pdf-settings", _h_migrate_pdf_settings_post_43);
app.post("/api/migrate-plan-manager", _h_migrate_plan_manager_post_44);
app.post("/api/migrate-plan-manager-v2", _h_migrate_plan_manager_v2_post_45);
app.post("/api/migrate-plan-manager-v3", _h_migrate_plan_manager_v3_post_46);
app.post("/api/migrate-safety", _h_migrate_safety_post_47);
app.post("/api/migrate-site-prestart", _h_migrate_site_prestart_post_48);
app.post("/api/migrate-starter-pack", _h_migrate_starter_pack_post_49);
app.post("/api/migrate-studio-pdf", _h_migrate_studio_pdf_post_50);
app.post("/api/migrate-subscriptions", _h_migrate_subscriptions_post_51);
app.post("/api/migrate-support-mode", _h_migrate_support_mode_post_52);
app.post("/api/migrate-takeoff-pad", _h_migrate_takeoff_pad_post_53);
app.post("/api/migrate-team", _h_migrate_team_post_54);
...
app.get("/api/notifications/alerts", _h_notifications_alerts_get_55);
...
app.post("/api/owner-console/system-ai/builtin-checks", _h_owner_console_system_ai_builtin_checks_post_56);
