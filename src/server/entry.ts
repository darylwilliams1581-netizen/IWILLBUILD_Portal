...
import auth_check_signup_status_post_2 from "./api/auth/check-signup-status/POST";
import auth_forgot_password_post_3 from "./api/auth/forgot-password/POST";
import auth_pin_login_post_4 from "./api/auth/pin-login/POST";
import auth_resend_verification_post_5 from "./api/auth/resend-verification/POST";
import auth_reset_password_post_6 from "./api/auth/reset-password/POST";
import auth_resume_signup_post_7 from "./api/auth/resume-signup/POST";
import auth_self_verify_post_8 from "./api/auth/self-verify/POST";
import auth_send_sms_code_post_9 from "./api/auth/send-sms-code/POST";
import auth_sms_configured_get_10 from "./api/auth/sms-configured/GET";
import auth_sms_recovery_post_11 from "./api/auth/sms-recovery/POST";
import auth_trusted_devices_get_12 from "./api/auth/trusted-devices/GET";
import auth_trusted_devices_post_13 from "./api/auth/trusted-devices/POST";
import auth_trusted_devices_deviceId_delete_14 from "./api/auth/trusted-devices/[deviceId]/DELETE";
import auth_validate_reset_token_get_15 from "./api/auth/validate-reset-token/GET";
import auth_verify_email_post_16 from "./api/auth/verify-email/POST";
import auth_verify_sms_code_post_17 from "./api/auth/verify-sms-code/POST";
import auth_action_get_18 from "./api/auth/[action]/GET";
import auth_action_post_19 from "./api/auth/[action]/POST";
import auth_action_detail_get_20 from "./api/auth/[action]/[detail]/GET";
import auth_action_detail_post_21 from "./api/auth/[action]/[detail]/POST";
import billing_cancel_subscription_post_22 from "./api/billing/cancel-subscription/POST";
import billing_cancellation_feedback_post_23 from "./api/billing/cancellation-feedback/POST";
import billing_customer_portal_post_24 from "./api/billing/customer-portal/POST";
import billing_reactivate_subscription_post_25 from "./api/billing/reactivate-subscription/POST";
...
import cost_guide_get_32 from "./api/cost-guide/GET";
import cost_guide_post_33 from "./api/cost-guide/POST";
import cost_guide_export_csv_get_34 from "./api/cost-guide/export-csv/GET";
import cost_guide_import_csv_post_35 from "./api/cost-guide/import-csv/POST";
import cost_guide_id_delete_36 from "./api/cost-guide/[id]/DELETE";
import cost_guide_id_put_37 from "./api/cost-guide/[id]/PUT";
import customers_get_38 from "./api/customers/GET";
import customers_post_39 from "./api/customers/POST";
import customers_id_delete_40 from "./api/customers/[id]/DELETE";
import customers_id_get_41 from "./api/customers/[id]/GET";
import customers_id_put_42 from "./api/customers/[id]/PUT";
import dashboard_setup_check_get_43 from "./api/dashboard/setup-check/GET";
import dashboard_todos_get_44 from "./api/dashboard/todos/GET";
import dazza_annette_post_45 from "./api/dazza/annette/POST";
import dazza_brain_hive_approve_post_46 from "./api/dazza/brain/hive/approve/POST";
import dazza_brain_hive_reject_post_47 from "./api/dazza/brain/hive/reject/POST";
import dazza_brain_status_get_48 from "./api/dazza/brain/status/GET";
import dazza_chat_post_49 from "./api/dazza/chat/POST";
import dazza_context_get_50 from "./api/dazza/context/GET";
import dazza_key_status_get_51 from "./api/dazza/key-status/GET";
import dazza_knowledge_get_52 from "./api/dazza/knowledge/GET";
import dazza_knowledge_post_53 from "./api/dazza/knowledge/POST";
import dazza_knowledge_id_delete_54 from "./api/dazza/knowledge/[id]/DELETE";
import dazza_knowledge_id_put_55 from "./api/dazza/knowledge/[id]/PUT";
import developer_activity_log_get_56 from "./api/developer/activity-log/GET";
import developer_audit_log_get_57 from "./api/developer/audit-log/GET";
import developer_users_id_assign_company_post_58 from "./api/developer/users/[id]/assign-company/POST";
import developer_users_id_deactivate_post_59 from "./api/developer/users/[id]/deactivate/POST";
import developer_users_id_delete_orphan_post_60 from "./api/developer/users/[id]/delete-orphan/POST";
import developer_users_id_reactivate_post_61 from "./api/developer/users/[id]/reactivate/POST";
import developer_users_id_resend_verification_post_62 from "./api/developer/users/[id]/resend-verification/POST";
import developer_users_id_role_put_63 from "./api/developer/users/[id]/role/PUT";
import documents_get_64 from "./api/documents/GET";
import documents_share_token_get_65 from "./api/documents/share/[token]/GET";
import documents_share_token_post_66 from "./api/documents/share/[token]/POST";
import documents_id_get_67 from "./api/documents/[id]/GET";
import documents_id_put_68 from "./api/documents/[id]/PUT";
import documents_id_events_get_69 from "./api/documents/[id]/events/GET";
import documents_id_share_delete_70 from "./api/documents/[id]/share/DELETE";
import documents_id_share_post_71 from "./api/documents/[id]/share/POST";
import drawings_get_72 from "./api/drawings/GET";
import drawings_post_73 from "./api/drawings/POST";
import drawings_upload_post_74 from "./api/drawings/upload/POST";
import drawings_id_delete_75 from "./api/drawings/[id]/DELETE";
import drawings_id_patch_76 from "./api/drawings/[id]/PATCH";
import drawings_id_markup_post_77 from "./api/drawings/[id]/markup/POST";
import estimates_get_78 from "./api/estimates/GET";
import estimates_post_79 from "./api/estimates/POST";
import estimates_id_delete_80 from "./api/estimates/[id]/DELETE";
import estimates_id_get_81 from "./api/estimates/[id]/GET";
import estimates_id_put_82 from "./api/estimates/[id]/PUT";
import estimates_id_export_csv_get_83 from "./api/estimates/[id]/export-csv/GET";
import estimates_id_import_csv_post_84 from "./api/estimates/[id]/import-csv/POST";
import external_form_token_get_85 from "./api/external/form/[token]/GET";
import external_form_token_post_86 from "./api/external/form/[token]/POST";
import files_get_87 from "./api/files/GET";
import files_post_88 from "./api/files/POST";
import files_id_delete_89 from "./api/files/[id]/DELETE";
import files_id_download_get_90 from "./api/files/[id]/download/GET";
import fleet_get_91 from "./api/fleet/GET";
import fleet_post_92 from "./api/fleet/POST";
import fleet_driver_sessions_post_93 from "./api/fleet/driver-sessions/POST";
import fleet_driver_sessions_active_get_94 from "./api/fleet/driver-sessions/active/GET";
import fleet_driver_sessions_id_stop_post_95 from "./api/fleet/driver-sessions/[id]/stop/POST";
import fleet_flags_get_96 from "./api/fleet/flags/GET";
import fleet_vehicles_get_97 from "./api/fleet/vehicles/GET";
import fleet_id_get_98 from "./api/fleet/[id]/GET";
import fleet_id_put_99 from "./api/fleet/[id]/PUT";
import fleet_id_delete from "./api/fleet/[id]/DELETE";
import fleet_id_driver_sessions_get_100 from "./api/fleet/[id]/driver-sessions/GET";
import fleet_id_files_get_101 from "./api/fleet/[id]/files/GET";
import fleet_id_prestarts_get_102 from "./api/fleet/[id]/prestarts/GET";
import fleet_id_prestarts_post_103 from "./api/fleet/[id]/prestarts/POST";
import form_templates_get_104 from "./api/form-templates/GET";
import form_templates_post_105 from "./api/form-templates/POST";
import form_templates_seed_post_106 from "./api/form-templates/seed/POST";
import form_templates_id_delete_107 from "./api/form-templates/[id]/DELETE";
import form_templates_id_put_108 from "./api/form-templates/[id]/PUT";
import forms_id_fields_get_109 from "./api/forms/[id]/fields/GET";
import forms_id_fields_post_110 from "./api/forms/[id]/fields/POST";
import forms_id_fields_reorder_post_111 from "./api/forms/[id]/fields/reorder/POST";
import forms_id_fields_fieldId_delete_112 from "./api/forms/[id]/fields/[fieldId]/DELETE";
import forms_id_fields_fieldId_patch_113 from "./api/forms/[id]/fields/[fieldId]/PATCH";
import forms_id_fields_fieldId_thumbnail_post_114 from "./api/forms/[id]/fields/[fieldId]/thumbnail/POST";
import health_get_115 from "./api/health/GET";
import integrations_onedrive_auth_url_get_116 from "./api/integrations/onedrive/auth-url/GET";
import integrations_onedrive_callback_get_117 from "./api/integrations/onedrive/callback/GET";
import integrations_onedrive_disconnect_post_118 from "./api/integrations/onedrive/disconnect/POST";
import integrations_onedrive_status_get_119 from "./api/integrations/onedrive/status/GET";
import integrations_onedrive_upload_file_post_120 from "./api/integrations/onedrive/upload-file/POST";
import integrations_xero_auth_url_get_121 from "./api/integrations/xero/auth-url/GET";
import integrations_xero_callback_get_122 from "./api/integrations/xero/callback/GET";
import integrations_xero_disconnect_post_123 from "./api/integrations/xero/disconnect/POST";
import integrations_xero_status_get_124 from "./api/integrations/xero/status/GET";
import integrations_xero_sync_customer_post_125 from "./api/integrations/xero/sync-customer/POST";
import integrations_xero_sync_invoice_post_126 from "./api/integrations/xero/sync-invoice/POST";
import integrations_xero_webhook_post_127 from "./api/integrations/xero/webhook/POST";
import invoices_get_128 from "./api/invoices/GET";
import invoices_post_129 from "./api/invoices/POST";
import invoices_id_delete_130 from "./api/invoices/[id]/DELETE";
import invoices_id_get_131 from "./api/invoices/[id]/GET";
import invoices_id_put_132 from "./api/invoices/[id]/PUT";
import invoices_id_duplicate_post_133 from "./api/invoices/[id]/duplicate/POST";
import invoices_id_mark_sent_post_134 from "./api/invoices/[id]/mark-sent/POST";
import invoices_id_record_payment_post_135 from "./api/invoices/[id]/record-payment/POST";
import invoices_id_void_post_136 from "./api/invoices/[id]/void/POST";
import job_forms_id_delete_137 from "./api/job-forms/[id]/DELETE";
import job_forms_id_get_138 from "./api/job-forms/[id]/GET";
import job_forms_id_put_139 from "./api/job-forms/[id]/PUT";
import job_forms_id_reset_post_140 from "./api/job-forms/[id]/reset/POST";
import job_forms_id_share_delete_141 from "./api/job-forms/[id]/share/DELETE";
import job_forms_id_share_get_142 from "./api/job-forms/[id]/share/GET";
import job_forms_id_share_post_143 from "./api/job-forms/[id]/share/POST";
import jobs_get_144 from "./api/jobs/GET";
import jobs_post_145 from "./api/jobs/POST";
import jobs_id_get_146 from "./api/jobs/[id]/GET";
import jobs_id_put_147 from "./api/jobs/[id]/PUT";
import jobs_id_costs_get_148 from "./api/jobs/[id]/costs/GET";
import jobs_id_costs_post_149 from "./api/jobs/[id]/costs/POST";
import jobs_id_costs_export_get_150 from "./api/jobs/[id]/costs/export/GET";
import jobs_id_costs_costId_delete_151 from "./api/jobs/[id]/costs/[costId]/DELETE";
import jobs_id_costs_costId_put_152 from "./api/jobs/[id]/costs/[costId]/PUT";
import jobs_id_costs_costId_receipt_get_153 from "./api/jobs/[id]/costs/[costId]/receipt/GET";
import jobs_id_costs_costId_receipt_post_154 from "./api/jobs/[id]/costs/[costId]/receipt/POST";
import jobs_id_delays_get_155 from "./api/jobs/[id]/delays/GET";
import jobs_id_delays_post_156 from "./api/jobs/[id]/delays/POST";
import jobs_id_delays_delayId_delete_157 from "./api/jobs/[id]/delays/[delayId]/DELETE";
import jobs_id_delays_delayId_put_158 from "./api/jobs/[id]/delays/[delayId]/PUT";
import jobs_id_files_get_159 from "./api/jobs/[id]/files/GET";
import jobs_id_forms_get_160 from "./api/jobs/[id]/forms/GET";
import jobs_id_forms_post_161 from "./api/jobs/[id]/forms/POST";
import jobs_id_ledger_get_162 from "./api/jobs/[id]/ledger/GET";
import jobs_id_ledger_post_163 from "./api/jobs/[id]/ledger/POST";
import jobs_id_ledger_export_get_164 from "./api/jobs/[id]/ledger/export/GET";
import jobs_id_ledger_sync_post_165 from "./api/jobs/[id]/ledger/sync/POST";
import jobs_id_ledger_entryId_delete_166 from "./api/jobs/[id]/ledger/[entryId]/DELETE";
import jobs_id_ledger_entryId_put_167 from "./api/jobs/[id]/ledger/[entryId]/PUT";
import jobs_id_photos_get_168 from "./api/jobs/[id]/photos/GET";
import jobs_id_photos_post_169 from "./api/jobs/[id]/photos/POST";
import jobs_id_photos_photoId_delete_170 from "./api/jobs/[id]/photos/[photoId]/DELETE";
import jobs_id_photos_photoId_patch_171 from "./api/jobs/[id]/photos/[photoId]/PATCH";
import jobs_id_photos_photoId_download_get_172 from "./api/jobs/[id]/photos/[photoId]/download/GET";
import jobs_id_photos_photoId_replace_post_173 from "./api/jobs/[id]/photos/[photoId]/replace/POST";
import jobs_id_progress_get_174 from "./api/jobs/[id]/progress/GET";
import jobs_id_progress_put_175 from "./api/jobs/[id]/progress/PUT";
import jobs_id_progress_sync_post_176 from "./api/jobs/[id]/progress/sync/POST";
import jobs_id_purchase_orders_get_177 from "./api/jobs/[id]/purchase-orders/GET";
import jobs_id_purchase_orders_post_178 from "./api/jobs/[id]/purchase-orders/POST";
import jobs_id_purchase_orders_poId_delete_179 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import jobs_id_purchase_orders_poId_get_180 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
import jobs_id_purchase_orders_poId_put_181 from "./api/jobs/[id]/purchase-orders/[poId]/PUT";
import jobs_id_purchase_orders_poId_pdf_get_182 from "./api/jobs/[id]/purchase-orders/[poId]/pdf/GET";
import jobs_id_swms_get_183 from "./api/jobs/[id]/swms/GET";
import jobs_id_swms_post_184 from "./api/jobs/[id]/swms/POST";
import jobs_id_swms_swmsId_signoff_post_185 from "./api/jobs/[id]/swms/[swmsId]/signoff/POST";
import jobs_id_todos_get_186 from "./api/jobs/[id]/todos/GET";
import jobs_id_todos_post_187 from "./api/jobs/[id]/todos/POST";
import jobs_id_todos_todoId_delete_188 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import jobs_id_todos_todoId_put_189 from "./api/jobs/[id]/todos/[todoId]/PUT";
import me_get_190 from "./api/me/GET";
import me_put_191 from "./api/me/PUT";
import me_2fa_disable_post_192 from "./api/me/2fa/disable/POST";
import me_2fa_enable_post_193 from "./api/me/2fa/enable/POST";
import me_2fa_setup_get_194 from "./api/me/2fa/setup/GET";
import me_2fa_status_get_195 from "./api/me/2fa/status/GET";
import me_2fa_verify_post_196 from "./api/me/2fa/verify/POST";
import me_change_password_post_197 from "./api/me/change-password/POST";
import me_email_status_get_198 from "./api/me/email-status/GET";
import me_phone_get_199 from "./api/me/phone/GET";
import me_phone_put_200 from "./api/me/phone/PUT";
import migrate_account_recovery_post_201 from "./api/migrate-account-recovery/POST";
import migrate_company_settings_post_202 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_203 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_204 from "./api/migrate-dazza-knowledge/POST";
import migrate_estimates_post_205 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_206 from "./api/migrate-estimating-library/POST";
import migrate_files_post_207 from "./api/migrate-files/POST";
import migrate_fleet_post_208 from "./api/migrate-fleet/POST";
import migrate_fleet_driver_sessions_post_209 from "./api/migrate-fleet-driver-sessions/POST";
import migrate_form_fields_post_210 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_211 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_212 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_213 from "./api/migrate-job-forms/POST";
import migrate_job_photos_post_214 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_215 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_216 from "./api/migrate-jobs/POST";
import migrate_notifications_post_217 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_218 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_219 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_220 from "./api/migrate-pdf-settings/POST";
import migrate_safety_post_221 from "./api/migrate-safety/POST";
import migrate_starter_pack_post_222 from "./api/migrate-starter-pack/POST";
import migrate_subscriptions_post_223 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_224 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_225 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_226 from "./api/migrate-team/POST";
import notifications_alerts_get_227 from "./api/notifications/alerts/GET";
import notifications_prefs_get_228 from "./api/notifications/prefs/GET";
import notifications_prefs_put_229 from "./api/notifications/prefs/PUT";
import notifications_read_post_230 from "./api/notifications/read/POST";
import owner_console_activity_get_231 from "./api/owner-console/activity/GET";
import owner_console_cancellation_feedback_get_232 from "./api/owner-console/cancellation-feedback/GET";
import owner_console_companies_get_233 from "./api/owner-console/companies/GET";
import owner_console_companies_post_234 from "./api/owner-console/companies/POST";
import owner_console_companies_usage_get_235 from "./api/owner-console/companies/usage/GET";
import owner_console_companies_id_limits_put_236 from "./api/owner-console/companies/[id]/limits/PUT";
import owner_console_form_templates_get_237 from "./api/owner-console/form-templates/GET";
import owner_console_form_templates_post_238 from "./api/owner-console/form-templates/POST";
import owner_console_starter_pack_get_239 from "./api/owner-console/starter-pack/GET";
import owner_console_starter_pack_post_240 from "./api/owner-console/starter-pack/POST";
import owner_console_stats_get_241 from "./api/owner-console/stats/GET";
import owner_console_storage_get_242 from "./api/owner-console/storage/GET";
import owner_console_system_ai_builtin_checks_post_243 from "./api/owner-console/system-ai/builtin-checks/POST";
import owner_console_users_get_244 from "./api/owner-console/users/GET";
import owner_console_users_verify_post_245 from "./api/owner-console/users/verify/POST";
import recipes_get_246 from "./api/recipes/GET";
import recipes_post_247 from "./api/recipes/POST";
import recipes_id_delete_248 from "./api/recipes/[id]/DELETE";
import recipes_id_put_249 from "./api/recipes/[id]/PUT";
import safety_ai_draft_post_250 from "./api/safety/ai/draft/POST";
import safety_documents_get_251 from "./api/safety/documents/GET";
import safety_documents_post_252 from "./api/safety/documents/POST";
import safety_documents_id_delete_253 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_254 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_255 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_256 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_257 from "./api/safety/generated-posters/[id]/DELETE";
import safety_job_safety_plans_get_258 from "./api/safety/job-safety-plans/GET";
import safety_job_safety_plans_post_259 from "./api/safety/job-safety-plans/POST";
import safety_job_safety_plans_id_delete_260 from "./api/safety/job-safety-plans/[id]/DELETE";
import safety_job_safety_plans_id_put_261 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_262 from "./api/safety/job-swms/GET";
import safety_job_swms_post_263 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_264 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_265 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_266 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_signoffs_get_267 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_268 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_269 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_270 from "./api/safety/plans/GET";
import safety_plans_post_271 from "./api/safety/plans/POST";
import safety_plans_seed_post_272 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_273 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_274 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_275 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_276 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_277 from "./api/safety/posters/GET";
import safety_posters_post_278 from "./api/safety/posters/POST";
import safety_posters_id_delete_279 from "./api/safety/posters/[id]/DELETE";
import safety_swms_get_280 from "./api/safety/swms/GET";
import safety_swms_post_281 from "./api/safety/swms/POST";
import safety_swms_seed_post_282 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_283 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_284 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_285 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_286 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_287 from "./api/safety/swms/[id]/export/GET";
import scheduler_jobs_get_288 from "./api/scheduler/jobs/GET";
import secure_share_get_289 from "./api/secure-share/GET";
import secure_share_post_290 from "./api/secure-share/POST";
import secure_share_id_delete_291 from "./api/secure-share/[id]/DELETE";
import secure_share_token_get_292 from "./api/secure-share/[token]/GET";
import secure_share_token_post_293 from "./api/secure-share/[token]/POST";
import settings_backup_get_294 from "./api/settings/backup/GET";
import settings_backup_post_295 from "./api/settings/backup/POST";
import settings_backup_export_get_296 from "./api/settings/backup/export/GET";
import settings_backup_run_post_297 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_298 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_299 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_300 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_301 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_302 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_303 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_304 from "./api/settings/retention/GET";
import settings_retention_post_305 from "./api/settings/retention/POST";
import settings_storage_provider_get_306 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_307 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_308 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_309 from "./api/settings/terminology/GET";
import settings_terminology_post_310 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_311 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_312 from "./api/settings/xero-credentials/POST";
import share_token_get_313 from "./api/share/[token]/GET";
import signup_post_314 from "./api/signup/POST";
import stripe_create_checkout_session_post_315 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_316 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_317 from "./api/subscription/create-checkout/POST";
import subscription_status_get_318 from "./api/subscription/status/GET";
import subscription_webhook_post_319 from "./api/subscription/webhook/POST";
import support_mode_audit_get_320 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_321 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_322 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_323 from "./api/support-mode/enter/POST";
import support_mode_exit_post_324 from "./api/support-mode/exit/POST";
import support_mode_status_get_325 from "./api/support-mode/status/GET";
import takeoff_pad_get_326 from "./api/takeoff-pad/GET";
import takeoff_pad_put_327 from "./api/takeoff-pad/PUT";
import team_get_328 from "./api/team/GET";
import team_invite_post_329 from "./api/team/invite/POST";
import team_members_get_330 from "./api/team/members/GET";
import team_resend_verification_post_331 from "./api/team/resend-verification/POST";
import team_verify_user_post_332 from "./api/team/verify-user/POST";
...
import developer_users_force_temp_password_post from "./api/developer/users/[id]/force-temp-password/POST";
import developer_users_unlock_account_post from "./api/developer/users/[id]/unlock-account/POST";
import developer_users_send_reset_email_post from "./api/developer/users/[id]/send-reset-email/POST";
import auth_change_password_post from "./api/auth/change-password/POST";
...
app.post("/api/auth/check-signup-status", auth_check_signup_status_post_2);
app.post("/api/auth/forgot-password", auth_forgot_password_post_3);
app.post("/api/auth/pin-login", auth_pin_login_post_4);
app.post("/api/auth/resend-verification", auth_resend_verification_post_5);
app.post("/api/auth/reset-password", auth_reset_password_post_6);
app.post("/api/auth/resume-signup", auth_resume_signup_post_7);
app.post("/api/auth/self-verify", auth_self_verify_post_8);
app.post("/api/auth/send-sms-code", auth_send_sms_code_post_9);
app.get("/api/auth/sms-configured", auth_sms_configured_get_10);
app.post("/api/auth/sms-recovery", auth_sms_recovery_post_11);
app.get("/api/auth/trusted-devices", auth_trusted_devices_get_12);
app.post("/api/auth/trusted-devices", auth_trusted_devices_post_13);
app.delete("/api/auth/trusted-devices/:deviceId", auth_trusted_devices_deviceId_delete_14);
app.get("/api/auth/validate-reset-token", auth_validate_reset_token_get_15);
app.post("/api/auth/verify-email", auth_verify_email_post_16);
app.post("/api/auth/verify-sms-code", auth_verify_sms_code_post_17);
app.get("/api/auth/:action", auth_action_get_18);
app.post("/api/auth/:action", auth_action_post_19);
app.get("/api/auth/:action/:detail", auth_action_detail_get_20);
app.post("/api/auth/:action/:detail", auth_action_detail_post_21);
app.post("/api/billing/cancel-subscription", billing_cancel_subscription_post_22);
app.post("/api/billing/cancellation-feedback", billing_cancellation_feedback_post_23);
app.post("/api/billing/customer-portal", billing_customer_portal_post_24);
app.post("/api/billing/reactivate-subscription", billing_reactivate_subscription_post_25);
...
app.get("/api/cost-guide", cost_guide_get_32);
app.post("/api/cost-guide", cost_guide_post_33);
app.get("/api/cost-guide/export-csv", cost_guide_export_csv_get_34);
app.post("/api/cost-guide/import-csv", cost_guide_import_csv_post_35);
app.delete("/api/cost-guide/:id", cost_guide_id_delete_36);
app.put("/api/cost-guide/:id", cost_guide_id_put_37);
app.get("/api/customers", customers_get_38);
app.post("/api/customers", customers_post_39);
app.delete("/api/customers/:id", customers_id_delete_40);
app.get("/api/customers/:id", customers_id_get_41);
app.put("/api/customers/:id", customers_id_put_42);
app.get("/api/dashboard/setup-check", dashboard_setup_check_get_43);
app.get("/api/dashboard/todos", dashboard_todos_get_44);
app.post("/api/dazza/annette", dazza_annette_post_45);
app.post("/api/dazza/brain/hive/approve", dazza_brain_hive_approve_post_46);
app.post("/api/dazza/brain/hive/reject", dazza_brain_hive_reject_post_47);
app.get("/api/dazza/brain/status", dazza_brain_status_get_48);
app.post("/api/dazza/chat", dazza_chat_post_49);
app.get("/api/dazza/context", dazza_context_get_50);
app.get("/api/dazza/key-status", dazza_key_status_get_51);
app.get("/api/dazza/knowledge", dazza_knowledge_get_52);
app.post("/api/dazza/knowledge", dazza_knowledge_post_53);
app.delete("/api/dazza/knowledge/:id", dazza_knowledge_id_delete_54);
app.put("/api/dazza/knowledge/:id", dazza_knowledge_id_put_55);
app.get("/api/developer/activity-log", developer_activity_log_get_56);
app.get("/api/developer/audit-log", developer_audit_log_get_57);
app.post("/api/developer/users/:id/assign-company", developer_users_id_assign_company_post_58);
app.post("/api/developer/users/:id/deactivate", developer_users_id_deactivate_post_59);
app.post("/api/developer/users/:id/delete-orphan", developer_users_id_delete_orphan_post_60);
...
app.post("/api/developer/users/:id/force-temp-password", requirePlatformOwner, developer_users_force_temp_password_post);
app.post("/api/developer/users/:id/unlock-account", requirePlatformOwner, developer_users_unlock_account_post);
app.post("/api/developer/users/:id/send-reset-email", requirePlatformOwner, developer_users_send_reset_email_post);
app.post("/api/auth/change-password", auth_change_password_post);
...
app.get("/api/documents/:id", documents_id_get_67);
app.put("/api/documents/:id", documents_id_put_68);
app.get("/api/documents/:id/events", documents_id_events_get_69);
app.delete("/api/documents/:id/share", documents_id_share_delete_70);
app.post("/api/documents/:id/share", documents_id_share_post_71);
app.get("/api/drawings", drawings_get_72);
app.post("/api/drawings", drawings_post_73);
app.post("/api/drawings/upload", drawings_upload_post_74);
app.delete("/api/drawings/:id", drawings_id_delete_75);
app.patch("/api/drawings/:id", drawings_id_patch_76);
app.post("/api/drawings/:id/markup", drawings_id_markup_post_77);
app.get("/api/estimates", estimates_get_78);
app.post("/api/estimates", estimates_post_79);
app.delete("/api/estimates/:id", estimates_id_delete_80);
app.get("/api/estimates/:id", estimates_id_get_81);
app.put("/api/estimates/:id", estimates_id_put_82);
app.get("/api/estimates/:id/export-csv", estimates_id_export_csv_get_83);
app.post("/api/estimates/:id/import-csv", estimates_id_import_csv_post_84);
app.get("/api/external/form/:token", external_form_token_get_85);
app.post("/api/external/form/:token", external_form_token_post_86);
app.get("/api/files", files_get_87);
app.post("/api/files", files_post_88);
app.delete("/api/files/:id", files_id_delete_89);
app.get("/api/files/:id/download", files_id_download_get_90);
app.get("/api/fleet", fleet_get_91);
app.post("/api/fleet", fleet_post_92);
app.post("/api/fleet/driver-sessions", fleet_driver_sessions_post_93);
app.get("/api/fleet/driver-sessions/active", fleet_driver_sessions_active_get_94);
app.post("/api/fleet/driver-sessions/:id/stop", fleet_driver_sessions_id_stop_post_95);
app.get("/api/fleet/flags", fleet_flags_get_96);
app.get("/api/fleet/vehicles", fleet_vehicles_get_97);
app.get("/api/fleet/:id", fleet_id_get_98);
app.put("/api/fleet/:id", fleet_id_put_99);
app.delete("/api/fleet/:id", fleet_id_delete);
app.get("/api/fleet/:id/driver-sessions", fleet_id_driver_sessions_get_100);
app.get("/api/fleet/:id/files", fleet_id_files_get_101);
app.get("/api/fleet/:id/prestarts", fleet_id_prestarts_get_102);
app.post("/api/fleet/:id/prestarts", fleet_id_prestarts_post_103);
app.get("/api/form-templates", form_templates_get_104);
app.post("/api/form-templates", form_templates_post_105);
app.post("/api/form-templates/seed", form_templates_seed_post_106);
app.delete("/api/form-templates/:id", form_templates_id_delete_107);
app.put("/api/form-templates/:id", form_templates_id_put_108);
app.get("/api/forms/:id/fields", forms_id_fields_get_109);
app.post("/api/forms/:id/fields", forms_id_fields_post_110);
app.post("/api/forms/:id/fields/reorder", forms_id_fields_reorder_post_111);
app.delete("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_delete_112);
app.patch("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_patch_113);
app.post("/api/forms/:id/fields/:fieldId/thumbnail", forms_id_fields_fieldId_thumbnail_post_114);
app.get("/api/health", health_get_115);
app.get("/api/integrations/onedrive/auth-url", integrations_onedrive_auth_url_get_116);
app.get("/api/integrations/onedrive/callback", integrations_onedrive_callback_get_117);
app.post("/api/integrations/onedrive/disconnect", integrations_onedrive_disconnect_post_118);
app.get("/api/integrations/onedrive/status", integrations_onedrive_status_get_119);
app.post("/api/integrations/onedrive/upload-file", integrations_onedrive_upload_file_post_120);
app.get("/api/integrations/xero/auth-url", integrations_xero_auth_url_get_121);
app.get("/api/integrations/xero/callback", integrations_xero_callback_get_122);
app.post("/api/integrations/xero/disconnect", integrations_xero_disconnect_post_123);
app.get("/api/integrations/xero/status", integrations_xero_status_get_124);
app.post("/api/integrations/xero/sync-customer", integrations_xero_sync_customer_post_125);
app.post("/api/integrations/xero/sync-invoice", integrations_xero_sync_invoice_post_126);
app.post("/api/integrations/xero/webhook", integrations_xero_webhook_post_127);
app.get("/api/invoices", invoices_get_128);
app.post("/api/invoices", invoices_post_129);
app.delete("/api/invoices/:id", invoices_id_delete_130);
app.get("/api/invoices/:id", invoices_id_get_131);
app.put("/api/invoices/:id", invoices_id_put_132);
app.post("/api/invoices/:id/duplicate", invoices_id_duplicate_post_133);
app.post("/api/invoices/:id/mark-sent", invoices_id_mark_sent_post_134);
app.post("/api/invoices/:id/record-payment", invoices_id_record_payment_post_135);
app.post("/api/invoices/:id/void", invoices_id_void_post_136);
app.delete("/api/job-forms/:id", job_forms_id_delete_137);
app.get("/api/job-forms/:id", job_forms_id_get_138);
app.put("/api/job-forms/:id", job_forms_id_put_139);
app.post("/api/job-forms/:id/reset", job_forms_id_reset_post_140);
app.delete("/api/job-forms/:id/share", job_forms_id_share_delete_141);
app.get("/api/job-forms/:id/share", job_forms_id_share_get_142);
app.post("/api/job-forms/:id/share", job_forms_id_share_post_143);
app.get("/api/jobs", jobs_get_144);
app.post("/api/jobs", jobs_post_145);
app.get("/api/jobs/:id", jobs_id_get_146);
app.put("/api/jobs/:id", jobs_id_put_147);
app.get("/api/jobs/:id/costs", jobs_id_costs_get_148);
app.post("/api/jobs/:id/costs", jobs_id_costs_post_149);
app.get("/api/jobs/:id/costs/export", jobs_id_costs_export_get_150);
app.delete("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_delete_151);
app.put("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_put_152);
app.get("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_get_153);
app.post("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_post_154);
app.get("/api/jobs/:id/delays", jobs_id_delays_get_155);
app.post("/api/jobs/:id/delays", jobs_id_delays_post_156);
app.delete("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_delete_157);
app.put("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_put_158);
app.get("/api/jobs/:id/files", jobs_id_files_get_159);
app.get("/api/jobs/:id/forms", jobs_id_forms_get_160);
app.post("/api/jobs/:id/forms", jobs_id_forms_post_161);
app.get("/api/jobs/:id/ledger", jobs_id_ledger_get_162);
app.post("/api/jobs/:id/ledger", jobs_id_ledger_post_163);
app.get("/api/jobs/:id/ledger/export", jobs_id_ledger_export_get_164);
app.post("/api/jobs/:id/ledger/sync", jobs_id_ledger_sync_post_165);
app.delete("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_delete_166);
app.put("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_put_167);
app.get("/api/jobs/:id/photos", jobs_id_photos_get_168);
app.post("/api/jobs/:id/photos", jobs_id_photos_post_169);
app.delete("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_delete_170);
app.patch("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_patch_171);
app.get("/api/jobs/:id/photos/:photoId/download", jobs_id_photos_photoId_download_get_172);
app.post("/api/jobs/:id/photos/:photoId/replace", jobs_id_photos_photoId_replace_post_173);
app.get("/api/jobs/:id/progress", jobs_id_progress_get_174);
app.put("/api/jobs/:id/progress", jobs_id_progress_put_175);
app.post("/api/jobs/:id/progress/sync", jobs_id_progress_sync_post_176);
app.get("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_get_177);
app.post("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_post_178);
app.delete("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_delete_179);
app.get("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_get_180);
app.put("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_put_181);
app.get("/api/jobs/:id/purchase-orders/:poId/pdf", jobs_id_purchase_orders_poId_pdf_get_182);
app.get("/api/jobs/:id/swms", jobs_id_swms_get_183);
app.post("/api/jobs/:id/swms", jobs_id_swms_post_184);
app.post("/api/jobs/:id/swms/:swmsId/signoff", jobs_id_swms_swmsId_signoff_post_185);
app.get("/api/jobs/:id/todos", jobs_id_todos_get_186);
app.post("/api/jobs/:id/todos", jobs_id_todos_post_187);
app.delete("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_delete_188);
app.put("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_put_189);
app.get("/api/me", me_get_190);
app.put("/api/me", me_put_191);
app.post("/api/me/2fa/disable", me_2fa_disable_post_192);
app.post("/api/me/2fa/enable", me_2fa_enable_post_193);
app.get("/api/me/2fa/setup", me_2fa_setup_get_194);
app.get("/api/me/2fa/status", me_2fa_status_get_195);
app.post("/api/me/2fa/verify", me_2fa_verify_post_196);
app.post("/api/me/change-password", me_change_password_post_197);
app.get("/api/me/email-status", me_email_status_get_198);
app.get("/api/me/phone", me_phone_get_199);
app.put("/api/me/phone", me_phone_put_200);
app.post("/api/migrate-account-recovery", migrate_account_recovery_post_201);
app.post("/api/migrate-company-settings", migrate_company_settings_post_202);
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_203);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_204);
app.post("/api/migrate-estimates", migrate_estimates_post_205);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_206);
app.post("/api/migrate-files", migrate_files_post_207);
app.post("/api/migrate-fleet", migrate_fleet_post_208);
app.post("/api/migrate-fleet-driver-sessions", migrate_fleet_driver_sessions_post_209);
app.post("/api/migrate-form-fields", migrate_form_fields_post_210);
app.post("/api/migrate-form-logic", migrate_form_logic_post_211);
app.post("/api/migrate-form-templates", migrate_form_templates_post_212);
app.post("/api/migrate-job-forms", migrate_job_forms_post_213);
app.post("/api/migrate-job-photos", migrate_job_photos_post_214);
app.post("/api/migrate-job-tabs", migrate_job_tabs_post_215);
app.post("/api/migrate-jobs", migrate_jobs_post_216);
app.post("/api/migrate-notifications", migrate_notifications_post_217);
app.post("/api/migrate-owner-console", migrate_owner_console_post_218);
app.post("/api/migrate-owner-role", migrate_owner_role_post_219);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_220);
app.post("/api/migrate-safety", migrate_safety_post_221);
app.post("/api/migrate-starter-pack", migrate_starter_pack_post_222);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_223);
app.post("/api/migrate-support-mode", migrate_support_mode_post_224);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_225);
app.post("/api/migrate-team", migrate_team_post_226);
app.get("/api/notifications/alerts", notifications_alerts_get_227);
app.get("/api/notifications/prefs", notifications_prefs_get_228);
app.put("/api/notifications/prefs", notifications_prefs_put_229);
app.post("/api/notifications/read", notifications_read_post_230);
app.get("/api/owner-console/activity", owner_console_activity_get_231);
app.get("/api/owner-console/cancellation-feedback", owner_console_cancellation_feedback_get_232);
app.get("/api/owner-console/companies", owner_console_companies_get_233);
app.post("/api/owner-console/companies", owner_console_companies_post_234);
app.get("/api/owner-console/companies/usage", owner_console_companies_usage_get_235);
app.put("/api/owner-console/companies/:id/limits", owner_console_companies_id_limits_put_236);
app.get("/api/owner-console/form-templates", owner_console_form_templates_get_237);
app.post("/api/owner-console/form-templates", owner_console_form_templates_post_238);
app.get("/api/owner-console/starter-pack", owner_console_starter_pack_get_239);
app.post("/api/owner-console/starter-pack", owner_console_starter_pack_post_240);
app.get("/api/owner-console/stats", owner_console_stats_get_241);
app.get("/api/owner-console/storage", owner_console_storage_get_242);
app.post("/api/owner-console/system-ai/builtin-checks", owner_console_system_ai_builtin_checks_post_243);
app.get("/api/owner-console/users", owner_console_users_get_244);
app.post("/api/owner-console/users/verify", owner_console_users_verify_post_245);
app.get("/api/recipes", recipes_get_246);
app.post("/api/recipes", recipes_post_247);
app.delete("/api/recipes/:id", recipes_id_delete_248);
app.put("/api/recipes/:id", recipes_id_put_249);
app.post("/api/safety/ai/draft", safety_ai_draft_post_250);
app.get("/api/safety/documents", safety_documents_get_251);
app.post("/api/safety/documents", safety_documents_post_252);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_253);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_254);
app.get("/api/safety/generated-posters", safety_generated_posters_get_255);
app.post("/api/safety/generated-posters", safety_generated_posters_post_256);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_257);
app.get("/api/safety/job-safety-plans", safety_job_safety_plans_get_258);
app.post("/api/safety/job-safety-plans", safety_job_safety_plans_post_259);
app.delete("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_delete_260);
app.put("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_put_261);
app.get("/api/safety/job-swms", safety_job_swms_get_262);
app.post("/api/safety/job-swms", safety_job_swms_post_263);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_264);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_265);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_266);
app.get("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_get_267);
app.post("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_post_268);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", safety_job_swms_id_signoffs_signoffId_delete_269);
app.get("/api/safety/plans", safety_plans_get_270);
app.post("/api/safety/plans", safety_plans_post_271);
app.post("/api/safety/plans/seed", safety_plans_seed_post_272);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_273);
app.put("/api/safety/plans/:id", safety_plans_id_put_274);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_275);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_276);
app.get("/api/safety/posters", safety_posters_get_277);
app.post("/api/safety/posters", safety_posters_post_278);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_279);
app.get("/api/safety/swms", safety_swms_get_280);
app.post("/api/safety/swms", safety_swms_post_281);
app.post("/api/safety/swms/seed", safety_swms_seed_post_282);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_283);
app.get("/api/safety/swms/:id", safety_swms_id_get_284);
app.put("/api/safety/swms/:id", safety_swms_id_put_285);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_286);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_287);
app.get("/api/scheduler/jobs", scheduler_jobs_get_288);
app.get("/api/secure-share", secure_share_get_289);
app.post("/api/secure-share", secure_share_post_290);
app.delete("/api/secure-share/:id", secure_share_id_delete_291);
app.get("/api/secure-share/:token", secure_share_token_get_292);
app.post("/api/secure-share/:token", secure_share_token_post_293);
app.get("/api/settings/backup", settings_backup_get_294);
app.post("/api/settings/backup", settings_backup_post_295);
app.get("/api/settings/backup/export", settings_backup_export_get_296);
app.post("/api/settings/backup/run", settings_backup_run_post_297);
app.get("/api/settings/backup-destination", settings_backup_destination_get_298);
app.post("/api/settings/backup-destination", settings_backup_destination_post_299);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_300);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_301);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_302);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_303);
app.get("/api/settings/retention", settings_retention_get_304);
app.post("/api/settings/retention", settings_retention_post_305);
app.get("/api/settings/storage-provider", settings_storage_provider_get_306);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_307);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_308);
app.get("/api/settings/terminology", settings_terminology_get_309);
app.post("/api/settings/terminology", settings_terminology_post_310);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_311);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_312);
app.get("/api/share/:token", share_token_get_313);
app.post("/api/signup", signup_post_314);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_315);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_316);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_317);
app.get("/api/subscription/status", subscription_status_get_318);
app.post("/api/subscription/webhook", subscription_webhook_post_319);
app.get("/api/support-mode/audit", support_mode_audit_get_320);
app.get("/api/support-mode/checklist", support_mode_checklist_get_321);
app.put("/api/support-mode/checklist", support_mode_checklist_put_322);
app.post("/api/support-mode/enter", support_mode_enter_post_323);
app.post("/api/support-mode/exit", support_mode_exit_post_324);
app.get("/api/support-mode/status", support_mode_status_get_325);
app.get("/api/takeoff-pad", takeoff_pad_get_326);
app.put("/api/takeoff-pad", takeoff_pad_put_327);
app.get("/api/team", team_get_328);
app.post("/api/team/invite", team_invite_post_329);
app.get("/api/team/members", team_members_get_330);
app.post("/api/team/resend-verification", team_resend_verification_post_331);
