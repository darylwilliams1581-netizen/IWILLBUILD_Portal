...
import fleet_driver_sessions_migrate_gps_status_post from "./api/fleet/driver-sessions/migrate-gps-status/POST";
...
import fleet_driver_sessions_id_heartbeat_post from "./api/fleet/driver-sessions/[id]/heartbeat/POST";
...
import form_templates_seed_post_217 from "./api/form-templates/seed/POST";
...
import jobs_report_generate_post_289 from "./api/jobs/report/generate/POST";
import jobs_id_get_290 from "./api/jobs/[id]/GET";
import jobs_id_put_291 from "./api/jobs/[id]/PUT";
import jobs_id_attendance_attendanceId_close_post_292 from "./api/jobs/[id]/attendance/[attendanceId]/close/POST";
import jobs_id_costs_get_293 from "./api/jobs/[id]/costs/GET";
import jobs_id_costs_post_294 from "./api/jobs/[id]/costs/POST";
import jobs_id_costs_export_get_295 from "./api/jobs/[id]/costs/export/GET";
import jobs_id_costs_costId_delete_296 from "./api/jobs/[id]/costs/[costId]/DELETE";
import jobs_id_costs_costId_put_297 from "./api/jobs/[id]/costs/[costId]/PUT";
import jobs_id_costs_costId_receipt_get_298 from "./api/jobs/[id]/costs/[costId]/receipt/GET";
import jobs_id_costs_costId_receipt_post_299 from "./api/jobs/[id]/costs/[costId]/receipt/POST";
import jobs_id_delays_get_300 from "./api/jobs/[id]/delays/GET";
import jobs_id_delays_post_301 from "./api/jobs/[id]/delays/POST";
import jobs_id_delays_export_csv_get_302 from "./api/jobs/[id]/delays/export-csv/GET";
import jobs_id_delays_delayId_delete_303 from "./api/jobs/[id]/delays/[delayId]/DELETE";
import jobs_id_delays_delayId_put_304 from "./api/jobs/[id]/delays/[delayId]/PUT";
import jobs_id_documents_get_305 from "./api/jobs/[id]/documents/GET";
import jobs_id_documents_post_306 from "./api/jobs/[id]/documents/POST";
import jobs_id_field_docs_get_307 from "./api/jobs/[id]/field-docs/GET";
import jobs_id_files_get_308 from "./api/jobs/[id]/files/GET";
import jobs_id_forms_get_309 from "./api/jobs/[id]/forms/GET";
import jobs_id_forms_post_310 from "./api/jobs/[id]/forms/POST";
import jobs_id_forms_export_csv_get_311 from "./api/jobs/[id]/forms/export-csv/GET";
import jobs_id_forms_submissionId_delete_312 from "./api/jobs/[id]/forms/[submissionId]/DELETE";
import jobs_id_forms_submissionId_reopen_post_313 from "./api/jobs/[id]/forms/[submissionId]/reopen/POST";
import jobs_id_generate_qr_post_314 from "./api/jobs/[id]/generate-qr/POST";
import jobs_id_ledger_get_315 from "./api/jobs/[id]/ledger/GET";
import jobs_id_ledger_post_316 from "./api/jobs/[id]/ledger/POST";
import jobs_id_ledger_export_get_317 from "./api/jobs/[id]/ledger/export/GET";
import jobs_id_ledger_sync_post_318 from "./api/jobs/[id]/ledger/sync/POST";
import jobs_id_ledger_entryId_delete_319 from "./api/jobs/[id]/ledger/[entryId]/DELETE";
import jobs_id_ledger_entryId_put_320 from "./api/jobs/[id]/ledger/[entryId]/PUT";
import jobs_id_ledger_entryId_correct_post_321 from "./api/jobs/[id]/ledger/[entryId]/correct/POST";
import jobs_id_milestones_get_322 from "./api/jobs/[id]/milestones/GET";
import jobs_id_milestones_post_323 from "./api/jobs/[id]/milestones/POST";
import jobs_id_milestones_milestoneId_delete_324 from "./api/jobs/[id]/milestones/[milestoneId]/DELETE";
import jobs_id_milestones_milestoneId_patch_325 from "./api/jobs/[id]/milestones/[milestoneId]/PATCH";
import jobs_id_notes_export_csv_get_326 from "./api/jobs/[id]/notes/export-csv/GET";
import jobs_id_photos_get_327 from "./api/jobs/[id]/photos/GET";
import jobs_id_photos_post_328 from "./api/jobs/[id]/photos/POST";
import jobs_id_photos_export_zip_post_329 from "./api/jobs/[id]/photos/export-zip/POST";
import jobs_id_photos_picker_get_330 from "./api/jobs/[id]/photos/picker/GET";
import jobs_id_photos_share_post_331 from "./api/jobs/[id]/photos/share/POST";
import jobs_id_photos_photoId_delete_332 from "./api/jobs/[id]/photos/[photoId]/DELETE";
import jobs_id_photos_photoId_patch_333 from "./api/jobs/[id]/photos/[photoId]/PATCH";
import jobs_id_photos_photoId_download_get_334 from "./api/jobs/[id]/photos/[photoId]/download/GET";
import jobs_id_photos_photoId_replace_post_335 from "./api/jobs/[id]/photos/[photoId]/replace/POST";
import jobs_id_photos_photoId_report_image_get_336 from "./api/jobs/[id]/photos/[photoId]/report-image/GET";
import jobs_id_progress_get_337 from "./api/jobs/[id]/progress/GET";
import jobs_id_progress_put_338 from "./api/jobs/[id]/progress/PUT";
import jobs_id_progress_export_csv_get_339 from "./api/jobs/[id]/progress/export-csv/GET";
import jobs_id_progress_report_get_340 from "./api/jobs/[id]/progress/report/GET";
import jobs_id_progress_report_put_341 from "./api/jobs/[id]/progress/report/PUT";
import jobs_id_progress_report_pdf_get_342 from "./api/jobs/[id]/progress/report/pdf/GET";
import jobs_id_progress_sync_post_343 from "./api/jobs/[id]/progress/sync/POST";
import jobs_id_purchase_orders_get_344 from "./api/jobs/[id]/purchase-orders/GET";
import jobs_id_purchase_orders_post_345 from "./api/jobs/[id]/purchase-orders/POST";
import jobs_id_purchase_orders_poId_delete_346 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import jobs_id_purchase_orders_poId_get_347 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
import jobs_id_purchase_orders_poId_put_348 from "./api/jobs/[id]/purchase-orders/[poId]/PUT";
import jobs_id_purchase_orders_poId_pdf_get_349 from "./api/jobs/[id]/purchase-orders/[poId]/pdf/GET";
import jobs_id_report_pdf_post_350 from "./api/jobs/[id]/report/pdf/POST";
import jobs_id_risky_get_351 from "./api/jobs/[id]/risky/GET";
import jobs_id_risky_post_352 from "./api/jobs/[id]/risky/POST";
import jobs_id_risky_riskyId_get_353 from "./api/jobs/[id]/risky/[riskyId]/GET";
import jobs_id_risky_riskyId_put_354 from "./api/jobs/[id]/risky/[riskyId]/PUT";
import jobs_id_risky_riskyId_finalise_post_355 from "./api/jobs/[id]/risky/[riskyId]/finalise/POST";
import jobs_id_risky_riskyId_signatures_post_356 from "./api/jobs/[id]/risky/[riskyId]/signatures/POST";
import jobs_id_risky_riskyId_supervisor_signoff_post_357 from "./api/jobs/[id]/risky/[riskyId]/supervisor-signoff/POST";
import jobs_id_signin_post_358 from "./api/jobs/[id]/signin/POST";
import jobs_id_signin_qr_post_359 from "./api/jobs/[id]/signin-qr/POST";
import jobs_id_signin_status_get_360 from "./api/jobs/[id]/signin-status/GET";
import jobs_id_signout_post_361 from "./api/jobs/[id]/signout/POST";
import jobs_id_signout_qr_post_362 from "./api/jobs/[id]/signout-qr/POST";
import jobs_id_signout_user_post_363 from "./api/jobs/[id]/signout-user/POST";
import jobs_id_site_prestarts_get_364 from "./api/jobs/[id]/site-prestarts/GET";
import jobs_id_site_prestarts_post_365 from "./api/jobs/[id]/site-prestarts/POST";
import jobs_id_site_prestarts_prestartId_get_366 from "./api/jobs/[id]/site-prestarts/[prestartId]/GET";
import jobs_id_site_prestarts_prestartId_put_367 from "./api/jobs/[id]/site-prestarts/[prestartId]/PUT";
import jobs_id_site_prestarts_prestartId_finalise_post_368 from "./api/jobs/[id]/site-prestarts/[prestartId]/finalise/POST";
import jobs_id_site_prestarts_prestartId_workers_post_369 from "./api/jobs/[id]/site-prestarts/[prestartId]/workers/POST";
import jobs_id_swms_get_370 from "./api/jobs/[id]/swms/GET";
import jobs_id_swms_post_371 from "./api/jobs/[id]/swms/POST";
import jobs_id_swms_swmsId_signoff_post_372 from "./api/jobs/[id]/swms/[swmsId]/signoff/POST";
import jobs_id_todos_get_373 from "./api/jobs/[id]/todos/GET";
import jobs_id_todos_post_374 from "./api/jobs/[id]/todos/POST";
import jobs_id_todos_todoId_delete_375 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import jobs_id_todos_todoId_put_376 from "./api/jobs/[id]/todos/[todoId]/PUT";
import library_items_get_377 from "./api/library/items/GET";
import library_items_id_get_378 from "./api/library/items/[id]/GET";
import library_items_id_patch_379 from "./api/library/items/[id]/PATCH";
import library_items_id_download_get_380 from "./api/library/items/[id]/download/GET";
import library_items_id_install_delete_381 from "./api/library/items/[id]/install/DELETE";
import library_items_id_install_post_382 from "./api/library/items/[id]/install/POST";
import library_my_installed_get_383 from "./api/library/my-installed/GET";
import library_my_submissions_get_384 from "./api/library/my-submissions/GET";
import me_get_385 from "./api/me/GET";
import me_put_386 from "./api/me/PUT";
import me_2fa_disable_post_387 from "./api/me/2fa/disable/POST";
import me_2fa_enable_post_388 from "./api/me/2fa/enable/POST";
import me_2fa_setup_get_389 from "./api/me/2fa/setup/GET";
import me_2fa_status_get_390 from "./api/me/2fa/status/GET";
import me_2fa_verify_post_391 from "./api/me/2fa/verify/POST";
import me_active_status_get_392 from "./api/me/active-status/GET";
import me_change_password_post_393 from "./api/me/change-password/POST";
import me_email_status_get_394 from "./api/me/email-status/GET";
import me_phone_get_395 from "./api/me/phone/GET";
import me_phone_put_396 from "./api/me/phone/PUT";
import me_profile_attachments_delete_397 from "./api/me/profile-attachments/DELETE";
import me_profile_attachments_post_398 from "./api/me/profile-attachments/POST";
import me_profile_extras_get_399 from "./api/me/profile-extras/GET";
import me_profile_extras_put_400 from "./api/me/profile-extras/PUT";
import migrate_account_recovery_post_401 from "./api/migrate-account-recovery/POST";
import migrate_asset_manager_post_402 from "./api/migrate-asset-manager/POST";
import migrate_attendance_post_403 from "./api/migrate-attendance/POST";
import migrate_company_settings_post_404 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_405 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_406 from "./api/migrate-dazza-knowledge/POST";
import migrate_emergency_alerts_post_407 from "./api/migrate-emergency-alerts/POST";
import migrate_estimates_post_408 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_409 from "./api/migrate-estimating-library/POST";
import migrate_files_post_410 from "./api/migrate-files/POST";
import migrate_fleet_post_411 from "./api/migrate-fleet/POST";
import migrate_fleet_analytics_post_412 from "./api/migrate-fleet-analytics/POST";
import migrate_fleet_driver_sessions_post_413 from "./api/migrate-fleet-driver-sessions/POST";
import migrate_fleet_usage_post_414 from "./api/migrate-fleet-usage/POST";
import migrate_form_fields_post_415 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_416 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_417 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_418 from "./api/migrate-job-forms/POST";
import migrate_job_photo_shares_post_419 from "./api/migrate-job-photo-shares/POST";
import migrate_job_photos_post_420 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_421 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_422 from "./api/migrate-jobs/POST";
import migrate_ledger_photo_post_423 from "./api/migrate-ledger-photo/POST";
import migrate_library_post_424 from "./api/migrate-library/POST";
import migrate_library_downloads_post_425 from "./api/migrate-library-downloads/POST";
import migrate_notifications_post_426 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_427 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_428 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_429 from "./api/migrate-pdf-settings/POST";
import migrate_plan_manager_post_430 from "./api/migrate-plan-manager/POST";
import migrate_plan_manager_v2_post_431 from "./api/migrate-plan-manager-v2/POST";
import migrate_plan_manager_v3_post_432 from "./api/migrate-plan-manager-v3/POST";
import migrate_safety_post_433 from "./api/migrate-safety/POST";
import migrate_site_prestart_post_434 from "./api/migrate-site-prestart/POST";
import migrate_starter_pack_post_435 from "./api/migrate-starter-pack/POST";
import migrate_studio_pdf_post_436 from "./api/migrate-studio-pdf/POST";
import migrate_subscriptions_post_437 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_438 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_439 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_440 from "./api/migrate-team/POST";
import notes_get_441 from "./api/notes/GET";
import notes_post_442 from "./api/notes/POST";
import notes_id_delete from "./api/notes/[id]/DELETE";
import notes_comments_post_443 from "./api/notes/comments/POST";
import notes_migrate_post_444 from "./api/notes/migrate/POST";
import notifications_alerts_get_445 from "./api/notifications/alerts/GET";
import notifications_prefs_get_446 from "./api/notifications/prefs/GET";
import notifications_prefs_put_447 from "./api/notifications/prefs/PUT";
import notifications_read_post_448 from "./api/notifications/read/POST";
import owner_console_activity_get_449 from "./api/owner-console/activity/GET";
import owner_console_cancellation_feedback_get_450 from "./api/owner-console/cancellation-feedback/GET";
import owner_console_companies_get_451 from "./api/owner-console/companies/GET";
import owner_console_companies_post_452 from "./api/owner-console/companies/POST";
import owner_console_companies_usage_get_453 from "./api/owner-console/companies/usage/GET";
import owner_console_companies_id_limits_put_454 from "./api/owner-console/companies/[id]/limits/PUT";
import owner_console_form_templates_get_455 from "./api/owner-console/form-templates/GET";
import owner_console_form_templates_post_456 from "./api/owner-console/form-templates/POST";
import owner_console_library_items_get_457 from "./api/owner-console/library/items/GET";
import owner_console_library_items_post_458 from "./api/owner-console/library/items/POST";
import owner_console_library_items_id_delete_459 from "./api/owner-console/library/items/[id]/DELETE";
import owner_console_library_items_id_patch_460 from "./api/owner-console/library/items/[id]/PATCH";
import owner_console_library_items_id_put_461 from "./api/owner-console/library/items/[id]/PUT";
import owner_console_library_items_id_push_update_post_462 from "./api/owner-console/library/items/[id]/push-update/POST";
import owner_console_library_submissions_get_463 from "./api/owner-console/library/submissions/GET";
import owner_console_library_submissions_id_review_post_464 from "./api/owner-console/library/submissions/[id]/review/POST";
import owner_console_starter_pack_get_465 from "./api/owner-console/starter-pack/GET";
import owner_console_starter_pack_post_466 from "./api/owner-console/starter-pack/POST";
import owner_console_stats_get_467 from "./api/owner-console/stats/GET";
import owner_console_storage_get_468 from "./api/owner-console/storage/GET";
import owner_console_swms_masters_get_469 from "./api/owner-console/swms/masters/GET";
import owner_console_swms_masters_post_470 from "./api/owner-console/swms/masters/POST";
import owner_console_swms_masters_publish_all_post_471 from "./api/owner-console/swms/masters/publish-all/POST";
import owner_console_swms_masters_id_delete_472 from "./api/owner-console/swms/masters/[id]/DELETE";
import owner_console_swms_masters_id_get_473 from "./api/owner-console/swms/masters/[id]/GET";
import owner_console_swms_masters_id_put_474 from "./api/owner-console/swms/masters/[id]/PUT";
import owner_console_swms_masters_id_publish_post_475 from "./api/owner-console/swms/masters/[id]/publish/POST";
import owner_console_swms_migrate_master_library_post_476 from "./api/owner-console/swms/migrate-master-library/POST";
import owner_console_swms_push_post_477 from "./api/owner-console/swms/push/POST";
import owner_console_swms_seed_bricklaying_post_478 from "./api/owner-console/swms/seed-bricklaying/POST";
import owner_console_swms_seed_building_inspection_post_479 from "./api/owner-console/swms/seed-building-inspection/POST";
import owner_console_swms_seed_cabinets_post_480 from "./api/owner-console/swms/seed-cabinets/POST";
import owner_console_swms_seed_carpenter_fixing_post_481 from "./api/owner-console/swms/seed-carpenter-fixing/POST";
import owner_console_swms_seed_carpenter_framing_post_482 from "./api/owner-console/swms/seed-carpenter-framing/POST";
import owner_console_swms_seed_carpenter_lockup_post_483 from "./api/owner-console/swms/seed-carpenter-lockup/POST";
import owner_console_swms_seed_ceramic_tiling_post_484 from "./api/owner-console/swms/seed-ceramic-tiling/POST";
import owner_console_swms_seed_concreting_slab_post_485 from "./api/owner-console/swms/seed-concreting-slab/POST";
import owner_console_swms_seed_delivery_loading_post_486 from "./api/owner-console/swms/seed-delivery-loading/POST";
import owner_console_swms_seed_environmental_spill_post_487 from "./api/owner-console/swms/seed-environmental-spill/POST";
import owner_console_swms_seed_ewp_post_488 from "./api/owner-console/swms/seed-ewp/POST";
import owner_console_swms_seed_excavations_substation_post_489 from "./api/owner-console/swms/seed-excavations-substation/POST";
import owner_console_swms_seed_fencing_post_490 from "./api/owner-console/swms/seed-fencing/POST";
import owner_console_swms_seed_heat_stress_post_491 from "./api/owner-console/swms/seed-heat-stress/POST";
import owner_console_swms_seed_landscaping_post_492 from "./api/owner-console/swms/seed-landscaping/POST";
import owner_console_swms_seed_live_parts_post_493 from "./api/owner-console/swms/seed-live-parts/POST";
import owner_console_swms_seed_manual_handling_post_494 from "./api/owner-console/swms/seed-manual-handling/POST";
import owner_console_swms_seed_moving_plant_post_495 from "./api/owner-console/swms/seed-moving-plant/POST";
import owner_console_swms_seed_painting_post_496 from "./api/owner-console/swms/seed-painting/POST";
import owner_console_swms_seed_power_tools_post_497 from "./api/owner-console/swms/seed-power-tools/POST";
import owner_console_swms_seed_silica_dust_post_498 from "./api/owner-console/swms/seed-silica-dust/POST";
import owner_console_swms_seed_traffic_management_post_499 from "./api/owner-console/swms/seed-traffic-management/POST";
import owner_console_swms_seed_underground_services_post_500 from "./api/owner-console/swms/seed-underground-services/POST";
import owner_console_swms_seed_vacuum_excavation_post_501 from "./api/owner-console/swms/seed-vacuum-excavation/POST";
import owner_console_system_ai_builtin_checks_post_502 from "./api/owner-console/system-ai/builtin-checks/POST";
import owner_console_users_get_503 from "./api/owner-console/users/GET";
import owner_console_users_verify_post_504 from "./api/owner-console/users/verify/POST";
import plan_manager_drawings_get_505 from "./api/plan-manager/drawings/GET";
import plan_manager_drawings_post_506 from "./api/plan-manager/drawings/POST";
import plan_manager_drawings_id_get_507 from "./api/plan-manager/drawings/[id]/GET";
import plan_manager_drawings_id_annotations_put_508 from "./api/plan-manager/drawings/[id]/annotations/PUT";
import plan_manager_drawings_id_archive_post_509 from "./api/plan-manager/drawings/[id]/archive/POST";
import plan_manager_drawings_id_job_links_delete_510 from "./api/plan-manager/drawings/[id]/job-links/DELETE";
import plan_manager_drawings_id_job_links_post_511 from "./api/plan-manager/drawings/[id]/job-links/POST";
import plan_manager_drawings_id_pages_pageNo_annotations_get_512 from "./api/plan-manager/drawings/[id]/pages/[pageNo]/annotations/GET";
import plan_manager_drawings_id_permanent_delete_513 from "./api/plan-manager/drawings/[id]/permanent/DELETE";
import plan_manager_drawings_id_reorder_patch_514 from "./api/plan-manager/drawings/[id]/reorder/PATCH";
import plan_manager_drawings_id_restore_post_515 from "./api/plan-manager/drawings/[id]/restore/POST";
import plan_manager_drawings_id_revisions_post_516 from "./api/plan-manager/drawings/[id]/revisions/POST";
import plan_manager_drawings_id_revisions_revisionId_finalize_post_517 from "./api/plan-manager/drawings/[id]/revisions/[revisionId]/finalize/POST";
import plan_manager_drawings_id_upload_post_518 from "./api/plan-manager/drawings/[id]/upload/POST";
import plan_manager_jobs_with_drawings_get_519 from "./api/plan-manager/jobs-with-drawings/GET";
import plan_manager_share_post_520 from "./api/plan-manager/share/POST";
import plan_manager_share_validate_get_521 from "./api/plan-manager/share/validate/GET";
import portal_estimates_id_approve_post_522 from "./api/portal/estimates/[id]/approve/POST";
import portal_invite_post_523 from "./api/portal/invite/POST";
import portal_invoices_id_pay_post_524 from "./api/portal/invoices/[id]/pay/POST";
import portal_jobs_get_525 from "./api/portal/jobs/GET";
import portal_jobs_id_get_526 from "./api/portal/jobs/[id]/GET";
import portal_migrate_post_527 from "./api/portal/migrate/POST";
import portal_validate_post_528 from "./api/portal/validate/POST";
import public_form_token_get_529 from "./api/public/form/[token]/GET";
import public_form_token_submit_post_530 from "./api/public/form/[token]/submit/POST";
import public_job_photos_token_get_531 from "./api/public/job-photos/[token]/GET";
import public_job_photos_token_photo_photoId_get_532 from "./api/public/job-photos/[token]/photo/[photoId]/GET";
import public_swms_token_get_533 from "./api/public/swms/[token]/GET";
import public_swms_token_signoff_post_534 from "./api/public/swms/[token]/signoff/POST";
import push_subscribe_delete_535 from "./api/push/subscribe/DELETE";
import push_subscribe_post_536 from "./api/push/subscribe/POST";
import push_vapid_key_get_537 from "./api/push/vapid-key/GET";
import recipes_get_538 from "./api/recipes/GET";
import recipes_post_539 from "./api/recipes/POST";
import recipes_id_delete_540 from "./api/recipes/[id]/DELETE";
import recipes_id_put_541 from "./api/recipes/[id]/PUT";
import safety_ai_draft_post_542 from "./api/safety/ai/draft/POST";
import safety_documents_get_543 from "./api/safety/documents/GET";
import safety_documents_post_544 from "./api/safety/documents/POST";
import safety_documents_id_delete_545 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_546 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_547 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_548 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_549 from "./api/safety/generated-posters/[id]/DELETE";
import safety_job_safety_plans_get_550 from "./api/safety/job-safety-plans/GET";
import safety_job_safety_plans_post_551 from "./api/safety/job-safety-plans/POST";
import safety_job_safety_plans_id_delete_552 from "./api/safety/job-safety-plans/[id]/DELETE";
import safety_job_safety_plans_id_put_553 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_554 from "./api/safety/job-swms/GET";
import safety_job_swms_post_555 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_556 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_557 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_558 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_share_token_post_559 from "./api/safety/job-swms/[id]/share-token/POST";
import safety_job_swms_id_signoffs_get_560 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_561 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_562 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_563 from "./api/safety/plans/GET";
import safety_plans_post_564 from "./api/safety/plans/POST";
import safety_plans_seed_post_565 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_566 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_567 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_568 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_569 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_570 from "./api/safety/posters/GET";
import safety_posters_post_571 from "./api/safety/posters/POST";
import safety_posters_id_delete_572 from "./api/safety/posters/[id]/DELETE";
import safety_swms_get_573 from "./api/safety/swms/GET";
import safety_swms_post_574 from "./api/safety/swms/POST";
import safety_swms_import_docx_post_575 from "./api/safety/swms/import-docx/POST";
import safety_swms_seed_post_576 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_577 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_578 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_579 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_580 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_581 from "./api/safety/swms/[id]/export/GET";
import safety_swms_id_publish_to_library_post_582 from "./api/safety/swms/[id]/publish-to-library/POST";
import scheduler_crew_get_583 from "./api/scheduler/crew/GET";
import scheduler_jobs_get_584 from "./api/scheduler/jobs/GET";
import scheduler_jobs_id_reschedule_patch_585 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
import secure_share_get_586 from "./api/secure-share/GET";
import secure_share_post_587 from "./api/secure-share/POST";
import secure_share_id_delete_588 from "./api/secure-share/[id]/DELETE";
import secure_share_token_get_589 from "./api/secure-share/[token]/GET";
import secure_share_token_post_590 from "./api/secure-share/[token]/POST";
import settings_backup_get_591 from "./api/settings/backup/GET";
import settings_backup_post_592 from "./api/settings/backup/POST";
import settings_backup_export_get_593 from "./api/settings/backup/export/GET";
import settings_backup_run_post_594 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_595 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_596 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_597 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_598 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_599 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_600 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_601 from "./api/settings/retention/GET";
import settings_retention_post_602 from "./api/settings/retention/POST";
import settings_storage_provider_get_603 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_604 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_605 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_606 from "./api/settings/terminology/GET";
import settings_terminology_post_607 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_608 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_609 from "./api/settings/xero-credentials/POST";
import share_token_get_610 from "./api/share/[token]/GET";
import signin_history_get_611 from "./api/signin-history/GET";
import signup_post_612 from "./api/signup/POST";
import sos_get_613 from "./api/sos/GET";
import sos_acknowledge_post_614 from "./api/sos/acknowledge/POST";
import sos_trigger_post_615 from "./api/sos/trigger/POST";
import stakeholders_sms_post_616 from "./api/stakeholders/sms/POST";
import stripe_create_checkout_session_post_617 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_618 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_619 from "./api/subscription/create-checkout/POST";
import subscription_status_get_620 from "./api/subscription/status/GET";
import subscription_webhook_post_621 from "./api/subscription/webhook/POST";
import support_mode_audit_get_622 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_623 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_624 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_625 from "./api/support-mode/enter/POST";
import support_mode_exit_post_626 from "./api/support-mode/exit/POST";
import support_mode_status_get_627 from "./api/support-mode/status/GET";
import tag_tasks_get_628 from "./api/tag-tasks/GET";
import tag_tasks_id_patch_629 from "./api/tag-tasks/[id]/PATCH";
import takeoff_pad_get_630 from "./api/takeoff-pad/GET";
import takeoff_pad_put_631 from "./api/takeoff-pad/PUT";
import team_get_632 from "./api/team/GET";
import team_invite_post_633 from "./api/team/invite/POST";
import team_invites_get_634 from "./api/team/invites/GET";
import team_invites_post_635 from "./api/team/invites/POST";
import team_invites_id_cancel_post_636 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_637 from "./api/team/invites/[id]/resend/POST";
import team_members_get_638 from "./api/team/members/GET";
import team_members_id_icon_permissions_get_639 from "./api/team/members/[id]/icon-permissions/GET";
import team_members_id_icon_permissions_put_640 from "./api/team/members/[id]/icon-permissions/PUT";
import team_resend_verification_post_641 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_642 from "./api/team/schedule/migrate/POST";
import team_shifts_get_643 from "./api/team/shifts/GET";
import team_shifts_post_644 from "./api/team/shifts/POST";
import team_shifts_id_delete_645 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_646 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_647 from "./api/team/time-entries/GET";
import team_time_entries_post_648 from "./api/team/time-entries/POST";
import team_time_entries_export_get_649 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_650 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_651 from "./api/team/verify-user/POST";
import team_id_delete_652 from "./api/team/[id]/DELETE";
import team_id_put_653 from "./api/team/[id]/PUT";
import usage_get_654 from "./api/usage/GET";
// </api-imports>
...
app.post("/api/fleet/driver-sessions/migrate-gps-status", fleet_driver_sessions_migrate_gps_status_post);
...
app.post("/api/fleet/driver-sessions/:id/heartbeat", fleet_driver_sessions_id_heartbeat_post);
...
app.post("/api/form-templates/seed", form_templates_seed_post_217);
...
app.post("/api/jobs/report/generate", jobs_report_generate_post_289);
app.get("/api/jobs/:id", jobs_id_get_290);
app.put("/api/jobs/:id", jobs_id_put_291);
app.post("/api/jobs/:id/attendance/:attendanceId/close", jobs_id_attendance_attendanceId_close_post_292);
app.get("/api/jobs/:id/costs", jobs_id_costs_get_293);
app.post("/api/jobs/:id/costs", jobs_id_costs_post_294);
app.get("/api/jobs/:id/costs/export", jobs_id_costs_export_get_295);
app.delete("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_delete_296);
app.put("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_put_297);
app.get("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_get_298);
app.post("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_post_299);
app.get("/api/jobs/:id/delays", jobs_id_delays_get_300);
app.post("/api/jobs/:id/delays", jobs_id_delays_post_301);
app.get("/api/jobs/:id/delays/export-csv", jobs_id_delays_export_csv_get_302);
app.delete("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_delete_303);
app.put("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_put_304);
app.get("/api/jobs/:id/documents", jobs_id_documents_get_305);
app.post("/api/jobs/:id/documents", jobs_id_documents_post_306);
app.get("/api/jobs/:id/field-docs", jobs_id_field_docs_get_307);
app.get("/api/jobs/:id/files", jobs_id_files_get_308);
app.get("/api/jobs/:id/forms", jobs_id_forms_get_309);
app.post("/api/jobs/:id/forms", jobs_id_forms_post_310);
app.get("/api/jobs/:id/forms/export-csv", jobs_id_forms_export_csv_get_311);
app.delete("/api/jobs/:id/forms/:submissionId", jobs_id_forms_submissionId_delete_312);
app.post("/api/jobs/:id/forms/:submissionId/reopen", jobs_id_forms_submissionId_reopen_post_313);
app.post("/api/jobs/:id/generate-qr", jobs_id_generate_qr_post_314);
app.get("/api/jobs/:id/ledger", jobs_id_ledger_get_315);
app.post("/api/jobs/:id/ledger", jobs_id_ledger_post_316);
app.get("/api/jobs/:id/ledger/export", jobs_id_ledger_export_get_317);
app.post("/api/jobs/:id/ledger/sync", jobs_id_ledger_sync_post_318);
app.delete("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_delete_319);
app.put("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_put_320);
app.post("/api/jobs/:id/ledger/:entryId/correct", jobs_id_ledger_entryId_correct_post_321);
app.get("/api/jobs/:id/milestones", jobs_id_milestones_get_322);
app.post("/api/jobs/:id/milestones", jobs_id_milestones_post_323);
app.delete("/api/jobs/:id/milestones/:milestoneId", jobs_id_milestones_milestoneId_delete_324);
app.patch("/api/jobs/:id/milestones/:milestoneId", jobs_id_milestones_milestoneId_patch_325);
app.get("/api/jobs/:id/notes/export-csv", jobs_id_notes_export_csv_get_326);
app.get("/api/jobs/:id/photos", jobs_id_photos_get_327);
app.post("/api/jobs/:id/photos", jobs_id_photos_post_328);
app.post("/api/jobs/:id/photos/export-zip", jobs_id_photos_export_zip_post_329);
app.get("/api/jobs/:id/photos/picker", jobs_id_photos_picker_get_330);
app.post("/api/jobs/:id/photos/share", jobs_id_photos_share_post_331);
app.delete("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_delete_332);
app.patch("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_patch_333);
app.get("/api/jobs/:id/photos/:photoId/download", jobs_id_photos_photoId_download_get_334);
app.post("/api/jobs/:id/photos/:photoId/replace", jobs_id_photos_photoId_replace_post_335);
app.get("/api/jobs/:id/photos/:photoId/report-image", jobs_id_photos_photoId_report_image_get_336);
app.get("/api/jobs/:id/progress", jobs_id_progress_get_337);
app.put("/api/jobs/:id/progress", jobs_id_progress_put_338);
app.get("/api/jobs/:id/progress/export-csv", jobs_id_progress_export_csv_get_339);
app.get("/api/jobs/:id/progress/report", jobs_id_progress_report_get_340);
app.put("/api/jobs/:id/progress/report", jobs_id_progress_report_put_341);
app.get("/api/jobs/:id/progress/report/pdf", jobs_id_progress_report_pdf_get_342);
app.post("/api/jobs/:id/progress/sync", jobs_id_progress_sync_post_343);
app.get("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_get_344);
app.post("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_post_345);
app.delete("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_delete_346);
app.get("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_get_347);
app.put("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_put_348);
app.get("/api/jobs/:id/purchase-orders/:poId/pdf", jobs_id_purchase_orders_poId_pdf_get_349);
app.post("/api/jobs/:id/report/pdf", jobs_id_report_pdf_post_350);
app.get("/api/jobs/:id/risky", jobs_id_risky_get_351);
app.post("/api/jobs/:id/risky", jobs_id_risky_post_352);
app.get("/api/jobs/:id/risky/:riskyId", jobs_id_risky_riskyId_get_353);
app.put("/api/jobs/:id/risky/:riskyId", jobs_id_risky_riskyId_put_354);
app.post("/api/jobs/:id/risky/:riskyId/finalise", jobs_id_risky_riskyId_finalise_post_355);
app.post("/api/jobs/:id/risky/:riskyId/signatures", jobs_id_risky_riskyId_signatures_post_356);
app.post("/api/jobs/:id/risky/:riskyId/supervisor-signoff", jobs_id_risky_riskyId_supervisor_signoff_post_357);
app.post("/api/jobs/:id/signin", jobs_id_signin_post_358);
app.post("/api/jobs/:id/signin-qr", jobs_id_signin_qr_post_359);
app.get("/api/jobs/:id/signin-status", jobs_id_signin_status_get_360);
app.post("/api/jobs/:id/signout", jobs_id_signout_post_361);
app.post("/api/jobs/:id/signout-qr", jobs_id_signout_qr_post_362);
app.post("/api/jobs/:id/signout-user", jobs_id_signout_user_post_363);
app.get("/api/jobs/:id/site-prestarts", jobs_id_site_prestarts_get_364);
app.post("/api/jobs/:id/site-prestarts", jobs_id_site_prestarts_post_365);
app.get("/api/jobs/:id/site-prestarts/:prestartId", jobs_id_site_prestarts_prestartId_get_366);
app.put("/api/jobs/:id/site-prestarts/:prestartId", jobs_id_site_prestarts_prestartId_put_367);
app.post("/api/jobs/:id/site-prestarts/:prestartId/finalise", jobs_id_site_prestarts_prestartId_finalise_post_368);
app.post("/api/jobs/:id/site-prestarts/:prestartId/workers", jobs_id_site_prestarts_prestartId_workers_post_369);
app.get("/api/jobs/:id/swms", jobs_id_swms_get_370);
app.post("/api/jobs/:id/swms", jobs_id_swms_post_371);
app.post("/api/jobs/:id/swms/:swmsId/signoff", jobs_id_swms_swmsId_signoff_post_372);
app.get("/api/jobs/:id/todos", jobs_id_todos_get_373);
app.post("/api/jobs/:id/todos", jobs_id_todos_post_374);
app.delete("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_delete_375);
app.put("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_put_376);
app.get("/api/library/items", library_items_get_377);
app.get("/api/library/items/:id", library_items_id_get_378);
app.patch("/api/library/items/:id", library_items_id_patch_379);
app.get("/api/library/items/:id/download", library_items_id_download_get_380);
app.delete("/api/library/items/:id/install", library_items_id_install_delete_381);
app.post("/api/library/items/:id/install", library_items_id_install_post_382);
app.get("/api/library/my-installed", library_my_installed_get_383);
app.get("/api/library/my-submissions", library_my_submissions_get_384);
app.get("/api/me", me_get_385);
app.put("/api/me", me_put_386);
app.post("/api/me/2fa/disable", me_2fa_disable_post_387);
app.post("/api/me/2fa/enable", me_2fa_enable_post_388);
app.get("/api/me/2fa/setup", me_2fa_setup_get_389);
app.get("/api/me/2fa/status", me_2fa_status_get_390);
app.post("/api/me/2fa/verify", me_2fa_verify_post_391);
app.get("/api/me/active-status", me_active_status_get_392);
app.post("/api/me/change-password", me_change_password_post_393);
app.get("/api/me/email-status", me_email_status_get_394);
app.get("/api/me/phone", me_phone_get_395);
app.put("/api/me/phone", me_phone_put_396);
app.delete("/api/me/profile-attachments", me_profile_attachments_delete_397);
app.post("/api/me/profile-attachments", me_profile_attachments_post_398);
app.get("/api/me/profile-extras", me_profile_extras_get_399);
app.put("/api/me/profile-extras", me_profile_extras_put_400);
app.post("/api/migrate-account-recovery", migrate_account_recovery_post_401);
app.post("/api/migrate-asset-manager", migrate_asset_manager_post_402);
app.post("/api/migrate-attendance", migrate_attendance_post_403);
app.post("/api/migrate-company-settings", migrate_company_settings_post_404);
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_405);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_406);
app.post("/api/migrate-emergency-alerts", migrate_emergency_alerts_post_407);
app.post("/api/migrate-estimates", migrate_estimates_post_408);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_409);
app.post("/api/migrate-files", migrate_files_post_410);
app.post("/api/migrate-fleet", migrate_fleet_post_411);
app.post("/api/migrate-fleet-analytics", migrate_fleet_analytics_post_412);
app.post("/api/migrate-fleet-driver-sessions", migrate_fleet_driver_sessions_post_413);
app.post("/api/migrate-fleet-usage", migrate_fleet_usage_post_414);
app.post("/api/migrate-form-fields", migrate_form_fields_post_415);
app.post("/api/migrate-form-logic", migrate_form_logic_post_416);
app.post("/api/migrate-form-templates", migrate_form_templates_post_417);
app.post("/api/migrate-job-forms", migrate_job_forms_post_418);
app.post("/api/migrate-job-photo-shares", migrate_job_photo_shares_post_419);
app.post("/api/migrate-job-photos", migrate_job_photos_post_420);
app.post("/api/migrate-job-tabs", migrate_job_tabs_post_421);
app.post("/api/migrate-jobs", migrate_jobs_post_422);
app.post("/api/migrate-ledger-photo", migrate_ledger_photo_post_423);
app.post("/api/migrate-library", migrate_library_post_424);
app.post("/api/migrate-library-downloads", migrate_library_downloads_post_425);
app.post("/api/migrate-notifications", migrate_notifications_post_426);
app.post("/api/migrate-owner-console", migrate_owner_console_post_427);
app.post("/api/migrate-owner-role", migrate_owner_role_post_428);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_429);
app.post("/api/migrate-plan-manager", migrate_plan_manager_post_430);
app.post("/api/migrate-plan-manager-v2", migrate_plan_manager_v2_post_431);
app.post("/api/migrate-plan-manager-v3", migrate_plan_manager_v3_post_432);
app.post("/api/migrate-safety", migrate_safety_post_433);
app.post("/api/migrate-site-prestart", migrate_site_prestart_post_434);
app.post("/api/migrate-starter-pack", migrate_starter_pack_post_435);
app.post("/api/migrate-studio-pdf", migrate_studio_pdf_post_436);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_437);
app.post("/api/migrate-support-mode", migrate_support_mode_post_438);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_439);
app.post("/api/migrate-team", migrate_team_post_440);
app.get("/api/notes", notes_get_441);
app.post("/api/notes", notes_post_442);
app.delete("/api/notes/:id", notes_id_delete);
app.post("/api/notes/comments", notes_comments_post_443);
app.post("/api/notes/migrate", notes_migrate_post_444);
app.get("/api/notifications/alerts", notifications_alerts_get_445);
app.get("/api/notifications/prefs", notifications_prefs_get_446);
app.put("/api/notifications/prefs", notifications_prefs_put_447);
app.post("/api/notifications/read", notifications_read_post_448);
app.get("/api/owner-console/activity", owner_console_activity_get_449);
app.get("/api/owner-console/cancellation-feedback", owner_console_cancellation_feedback_get_450);
app.get("/api/owner-console/companies", owner_console_companies_get_451);
app.post("/api/owner-console/companies", owner_console_companies_post_452);
app.get("/api/owner-console/companies/usage", owner_console_companies_usage_get_453);
app.put("/api/owner-console/companies/:id/limits", owner_console_companies_id_limits_put_454);
app.get("/api/owner-console/form-templates", owner_console_form_templates_get_455);
app.post("/api/owner-console/form-templates", owner_console_form_templates_post_456);
app.get("/api/owner-console/library/items", owner_console_library_items_get_457);
app.post("/api/owner-console/library/items", owner_console_library_items_post_458);
app.delete("/api/owner-console/library/items/:id", owner_console_library_items_id_delete_459);
app.patch("/api/owner-console/library/items/:id", owner_console_library_items_id_patch_460);
app.put("/api/owner-console/library/items/:id", owner_console_library_items_id_put_461);
app.post("/api/owner-console/library/items/:id/push-update", owner_console_library_items_id_push_update_post_462);
app.get("/api/owner-console/library/submissions", owner_console_library_submissions_get_463);
app.post("/api/owner-console/library/submissions/:id/review", owner_console_library_submissions_id_review_post_464);
app.get("/api/owner-console/starter-pack", owner_console_starter_pack_get_465);
app.post("/api/owner-console/starter-pack", owner_console_starter_pack_post_466);
app.get("/api/owner-console/stats", owner_console_stats_get_467);
app.get("/api/owner-console/storage", owner_console_storage_get_468);
app.get("/api/owner-console/swms/masters", owner_console_swms_masters_get_469);
app.post("/api/owner-console/swms/masters", owner_console_swms_masters_post_470);
app.post("/api/owner-console/swms/masters/publish-all", owner_console_swms_masters_publish_all_post_471);
app.delete("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_delete_472);
app.get("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_get_473);
app.put("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_put_474);
app.post("/api/owner-console/swms/masters/:id/publish", owner_console_swms_masters_id_publish_post_475);
app.post("/api/owner-console/swms/migrate-master-library", owner_console_swms_migrate_master_library_post_476);
app.post("/api/owner-console/swms/push", owner_console_swms_push_post_477);
app.post("/api/owner-console/swms/seed-bricklaying", owner_console_swms_seed_bricklaying_post_478);
app.post("/api/owner-console/swms/seed-building-inspection", owner_console_swms_seed_building_inspection_post_479);
app.post("/api/owner-console/swms/seed-cabinets", owner_console_swms_seed_cabinets_post_480);
app.post("/api/owner-console/swms/seed-carpenter-fixing", owner_console_swms_seed_carpenter_fixing_post_481);
app.post("/api/owner-console/swms/seed-carpenter-framing", owner_console_swms_seed_carpenter_framing_post_482);
app.post("/api/owner-console/swms/seed-carpenter-lockup", owner_console_swms_seed_carpenter_lockup_post_483);
app.post("/api/owner-console/swms/seed-ceramic-tiling", owner_console_swms_seed_ceramic_tiling_post_484);
app.post("/api/owner-console/swms/seed-concreting-slab", owner_console_swms_seed_concreting_slab_post_485);
app.post("/api/owner-console/swms/seed-delivery-loading", owner_console_swms_seed_delivery_loading_post_486);
app.post("/api/owner-console/swms/seed-environmental-spill", owner_console_swms_seed_environmental_spill_post_487);
app.post("/api/owner-console/swms/seed-ewp", owner_console_swms_seed_ewp_post_488);
app.post("/api/owner-console/swms/seed-excavations-substation", owner_console_swms_seed_excavations_substation_post_489);
app.post("/api/owner-console/swms/seed-fencing", owner_console_swms_seed_fencing_post_490);
app.post("/api/owner-console/swms/seed-heat-stress", owner_console_swms_seed_heat_stress_post_491);
app.post("/api/owner-console/swms/seed-landscaping", owner_console_swms_seed_landscaping_post_492);
app.post("/api/owner-console/swms/seed-live-parts", owner_console_swms_seed_live_parts_post_493);
app.post("/api/owner-console/swms/seed-manual-handling", owner_console_swms_seed_manual_handling_post_494);
app.post("/api/owner-console/swms/seed-moving-plant", owner_console_swms_seed_moving_plant_post_495);
app.post("/api/owner-console/swms/seed-painting", owner_console_swms_seed_painting_post_496);
app.post("/api/owner-console/swms/seed-power-tools", owner_console_swms_seed_power_tools_post_497);
app.post("/api/owner-console/swms/seed-silica-dust", owner_console_swms_seed_silica_dust_post_498);
app.post("/api/owner-console/swms/seed-traffic-management", owner_console_swms_seed_traffic_management_post_499);
app.post("/api/owner-console/swms/seed-underground-services", owner_console_swms_seed_underground_services_post_500);
app.post("/api/owner-console/swms/seed-vacuum-excavation", owner_console_swms_seed_vacuum_excavation_post_501);
app.post("/api/owner-console/system-ai/builtin-checks", owner_console_system_ai_builtin_checks_post_502);
app.get("/api/owner-console/users", owner_console_users_get_503);
app.post("/api/owner-console/users/verify", owner_console_users_verify_post_504);
app.get("/api/plan-manager/drawings", plan_manager_drawings_get_505);
app.post("/api/plan-manager/drawings", plan_manager_drawings_post_506);
app.get("/api/plan-manager/drawings/:id", plan_manager_drawings_id_get_507);
app.put("/api/plan-manager/drawings/:id/annotations", plan_manager_drawings_id_annotations_put_508);
app.post("/api/plan-manager/drawings/:id/archive", plan_manager_drawings_id_archive_post_509);
app.delete("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_delete_510);
app.post("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_post_511);
app.get("/api/plan-manager/drawings/:id/pages/:pageNo/annotations", plan_manager_drawings_id_pages_pageNo_annotations_get_512);
app.delete("/api/plan-manager/drawings/:id/permanent", plan_manager_drawings_id_permanent_delete_513);
app.patch("/api/plan-manager/drawings/:id/reorder", plan_manager_drawings_id_reorder_patch_514);
app.post("/api/plan-manager/drawings/:id/restore", plan_manager_drawings_id_restore_post_515);
app.post("/api/plan-manager/drawings/:id/revisions", plan_manager_drawings_id_revisions_post_516);
app.post("/api/plan-manager/drawings/:id/revisions/:revisionId/finalize", plan_manager_drawings_id_revisions_revisionId_finalize_post_517);
app.post("/api/plan-manager/drawings/:id/upload", plan_manager_drawings_id_upload_post_518);
app.get("/api/plan-manager/jobs-with-drawings", plan_manager_jobs_with_drawings_get_519);
app.post("/api/plan-manager/share", plan_manager_share_post_520);
app.get("/api/plan-manager/share/validate", plan_manager_share_validate_get_521);
app.post("/api/portal/estimates/:id/approve", portal_estimates_id_approve_post_522);
app.post("/api/portal/invite", portal_invite_post_523);
app.post("/api/portal/invoices/:id/pay", portal_invoices_id_pay_post_524);
app.get("/api/portal/jobs", portal_jobs_get_525);
app.get("/api/portal/jobs/:id", portal_jobs_id_get_526);
app.post("/api/portal/migrate", portal_migrate_post_527);
app.post("/api/portal/validate", portal_validate_post_528);
app.get("/api/public/form/:token", public_form_token_get_529);
app.post("/api/public/form/:token/submit", public_form_token_submit_post_530);
app.get("/api/public/job-photos/:token", public_job_photos_token_get_531);
app.get("/api/public/job-photos/:token/photo/:photoId", public_job_photos_token_photo_photoId_get_532);
app.get("/api/public/swms/:token", public_swms_token_get_533);
app.post("/api/public/swms/:token/signoff", public_swms_token_signoff_post_534);
app.delete("/api/push/subscribe", push_subscribe_delete_535);
app.post("/api/push/subscribe", push_subscribe_post_536);
app.get("/api/push/vapid-key", push_vapid_key_get_537);
app.get("/api/recipes", recipes_get_538);
app.post("/api/recipes", recipes_post_539);
app.delete("/api/recipes/:id", recipes_id_delete_540);
app.put("/api/recipes/:id", recipes_id_put_541);
app.post("/api/safety/ai/draft", safety_ai_draft_post_542);
app.get("/api/safety/documents", safety_documents_get_543);
app.post("/api/safety/documents", safety_documents_post_544);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_545);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_546);
app.get("/api/safety/generated-posters", safety_generated_posters_get_547);
app.post("/api/safety/generated-posters", safety_generated_posters_post_548);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_549);
app.get("/api/safety/job-safety-plans", safety_job_safety_plans_get_550);
app.post("/api/safety/job-safety-plans", safety_job_safety_plans_post_551);
app.delete("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_delete_552);
app.put("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_put_553);
app.get("/api/safety/job-swms", safety_job_swms_get_554);
app.post("/api/safety/job-swms", safety_job_swms_post_555);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_556);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_557);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_558);
app.post("/api/safety/job-swms/:id/share-token", safety_job_swms_id_share_token_post_559);
app.get("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_get_560);
app.post("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_post_561);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", safety_job_swms_id_signoffs_signoffId_delete_562);
app.get("/api/safety/plans", safety_plans_get_563);
app.post("/api/safety/plans", safety_plans_post_564);
app.post("/api/safety/plans/seed", safety_plans_seed_post_565);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_566);
app.put("/api/safety/plans/:id", safety_plans_id_put_567);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_568);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_569);
app.get("/api/safety/posters", safety_posters_get_570);
app.post("/api/safety/posters", safety_posters_post_571);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_572);
app.get("/api/safety/swms", safety_swms_get_573);
app.post("/api/safety/swms", safety_swms_post_574);
app.post("/api/safety/swms/import-docx", safety_swms_import_docx_post_575);
app.post("/api/safety/swms/seed", safety_swms_seed_post_576);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_577);
app.get("/api/safety/swms/:id", safety_swms_id_get_578);
app.put("/api/safety/swms/:id", safety_swms_id_put_579);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_580);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_581);
app.post("/api/safety/swms/:id/publish-to-library", safety_swms_id_publish_to_library_post_582);
app.get("/api/scheduler/crew", scheduler_crew_get_583);
app.get("/api/scheduler/jobs", scheduler_jobs_get_584);
app.patch("/api/scheduler/jobs/:id/reschedule", scheduler_jobs_id_reschedule_patch_585);
app.get("/api/secure-share", secure_share_get_586);
app.post("/api/secure-share", secure_share_post_587);
app.delete("/api/secure-share/:id", secure_share_id_delete_588);
app.get("/api/secure-share/:token", secure_share_token_get_589);
app.post("/api/secure-share/:token", secure_share_token_post_590);
app.get("/api/settings/backup", settings_backup_get_591);
app.post("/api/settings/backup", settings_backup_post_592);
app.get("/api/settings/backup/export", settings_backup_export_get_593);
app.post("/api/settings/backup/run", settings_backup_run_post_594);
app.get("/api/settings/backup-destination", settings_backup_destination_get_595);
app.post("/api/settings/backup-destination", settings_backup_destination_post_596);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_597);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_598);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_599);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_600);
app.get("/api/settings/retention", settings_retention_get_601);
app.post("/api/settings/retention", settings_retention_post_602);
app.get("/api/settings/storage-provider", settings_storage_provider_get_603);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_604);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_605);
app.get("/api/settings/terminology", settings_terminology_get_606);
app.post("/api/settings/terminology", settings_terminology_post_607);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_608);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_609);
app.get("/api/share/:token", share_token_get_610);
app.get("/api/signin-history", signin_history_get_611);
app.post("/api/signup", signup_post_612);
app.get("/api/sos", sos_get_613);
app.post("/api/sos/acknowledge", sos_acknowledge_post_614);
app.post("/api/sos/trigger", sos_trigger_post_615);
app.post("/api/stakeholders/sms", stakeholders_sms_post_616);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_617);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_618);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_619);
app.get("/api/subscription/status", subscription_status_get_620);
app.post("/api/subscription/webhook", subscription_webhook_post_621);
app.get("/api/support-mode/audit", support_mode_audit_get_622);
app.get("/api/support-mode/checklist", support_mode_checklist_get_623);
app.put("/api/support-mode/checklist", support_mode_checklist_put_624);
app.post("/api/support-mode/enter", support_mode_enter_post_625);
app.post("/api/support-mode/exit", support_mode_exit_post_626);
app.get("/api/support-mode/status", support_mode_status_get_627);
app.get("/api/tag-tasks", tag_tasks_get_628);
app.patch("/api/tag-tasks/:id", tag_tasks_id_patch_629);
app.get("/api/takeoff-pad", takeoff_pad_get_630);
app.put("/api/takeoff-pad", takeoff_pad_put_631);
app.get("/api/team", team_get_632);
app.post("/api/team/invite", team_invite_post_633);
app.get("/api/team/invites", team_invites_get_634);
app.post("/api/team/invites", team_invites_post_635);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_636);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_637);
app.get("/api/team/members", team_members_get_638);
app.get("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_get_639);
app.put("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_put_640);
app.post("/api/team/resend-verification", team_resend_verification_post_641);
app.post("/api/team/schedule/migrate", team_schedule_migrate_post_642);
app.get("/api/team/shifts", team_shifts_get_643);
app.post("/api/team/shifts", team_shifts_post_644);
app.delete("/api/team/shifts/:id", team_shifts_id_delete_645);
app.put("/api/team/shifts/:id", team_shifts_id_put_646);
app.get("/api/team/time-entries", team_time_entries_get_647);
app.post("/api/team/time-entries", team_time_entries_post_648);
app.get("/api/team/time-entries/export", team_time_entries_export_get_649);
app.put("/api/team/time-entries/:id", team_time_entries_id_put_650);
app.post("/api/team/verify-user", team_verify_user_post_651);
app.delete("/api/team/:id", team_id_delete_652);
app.put("/api/team/:id", team_id_put_653);
app.get("/api/usage", usage_get_654);
// </api-registrations>
