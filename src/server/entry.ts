...
import incidents_get_348 from "./api/incidents/GET";
import incidents_post_349 from "./api/incidents/POST";
import incidents_id_archive_post_350 from "./api/incidents/[id]/archive/POST";
import incidents_id_unarchive_post_351 from "./api/incidents/[id]/unarchive/POST";
import incidents_incidentId_get_352 from "./api/incidents/[incidentId]/GET";
import incidents_incidentId_put_353 from "./api/incidents/[incidentId]/PUT";
import incidents_incidentId_attachments_get_354 from "./api/incidents/[incidentId]/attachments/GET";
import incidents_incidentId_attachments_post_355 from "./api/incidents/[incidentId]/attachments/POST";
import incidents_incidentId_attachments_attachId_delete_356 from "./api/incidents/[incidentId]/attachments/[attachId]/DELETE";
import incidents_incidentId_close_post_357 from "./api/incidents/[incidentId]/close/POST";
import incidents_incidentId_corrective_actions_post_358 from "./api/incidents/[incidentId]/corrective-actions/POST";
import incidents_incidentId_corrective_actions_actionId_put_359 from "./api/incidents/[incidentId]/corrective-actions/[actionId]/PUT";
import incidents_incidentId_pdf_get_360 from "./api/incidents/[incidentId]/pdf/GET";
import incidents_incidentId_third_parties_post_361 from "./api/incidents/[incidentId]/third-parties/POST";
import incidents_incidentId_third_parties_thirdPartyId_delete_362 from "./api/incidents/[incidentId]/third-parties/[thirdPartyId]/DELETE";
import integrations_myob_auth_url_get_363 from "./api/integrations/myob/auth-url/GET";
import integrations_myob_callback_get_364 from "./api/integrations/myob/callback/GET";
import integrations_myob_disconnect_post_365 from "./api/integrations/myob/disconnect/POST";
import integrations_myob_status_get_366 from "./api/integrations/myob/status/GET";
import integrations_myob_sync_invoice_post_367 from "./api/integrations/myob/sync-invoice/POST";
import integrations_onedrive_auth_url_get_368 from "./api/integrations/onedrive/auth-url/GET";
import integrations_onedrive_callback_get_369 from "./api/integrations/onedrive/callback/GET";
import integrations_onedrive_disconnect_post_370 from "./api/integrations/onedrive/disconnect/POST";
import integrations_onedrive_status_get_371 from "./api/integrations/onedrive/status/GET";
import integrations_onedrive_upload_file_post_372 from "./api/integrations/onedrive/upload-file/POST";
import integrations_qbo_auth_url_get_373 from "./api/integrations/qbo/auth-url/GET";
import integrations_qbo_callback_get_374 from "./api/integrations/qbo/callback/GET";
import integrations_qbo_disconnect_post_375 from "./api/integrations/qbo/disconnect/POST";
import integrations_qbo_status_get_376 from "./api/integrations/qbo/status/GET";
import integrations_qbo_sync_invoice_post_377 from "./api/integrations/qbo/sync-invoice/POST";
import integrations_xero_auth_url_get_378 from "./api/integrations/xero/auth-url/GET";
import integrations_xero_callback_get_379 from "./api/integrations/xero/callback/GET";
import integrations_xero_disconnect_post_380 from "./api/integrations/xero/disconnect/POST";
import integrations_xero_status_get_381 from "./api/integrations/xero/status/GET";
import integrations_xero_sync_customer_post_382 from "./api/integrations/xero/sync-customer/POST";
import integrations_xero_sync_invoice_post_383 from "./api/integrations/xero/sync-invoice/POST";
import integrations_xero_webhook_post_384 from "./api/integrations/xero/webhook/POST";
import invoices_get_385 from "./api/invoices/GET";
import invoices_post_386 from "./api/invoices/POST";
import invoices_id_delete_387 from "./api/invoices/[id]/DELETE";
import invoices_id_get_388 from "./api/invoices/[id]/GET";
import invoices_id_put_389 from "./api/invoices/[id]/PUT";
import invoices_id_compose_defaults_get_390 from "./api/invoices/[id]/compose-defaults/GET";
import invoices_id_duplicate_post_391 from "./api/invoices/[id]/duplicate/POST";
import invoices_id_export_pdf_get_392 from "./api/invoices/[id]/export-pdf/GET";
import invoices_id_mark_sent_post_393 from "./api/invoices/[id]/mark-sent/POST";
import invoices_id_record_payment_post_394 from "./api/invoices/[id]/record-payment/POST";
import invoices_id_send_email_post_395 from "./api/invoices/[id]/send-email/POST";
import invoices_id_unlock_patch_396 from "./api/invoices/[id]/unlock/PATCH";
import invoices_id_void_post_397 from "./api/invoices/[id]/void/POST";
import job_cards_get_398 from "./api/job-cards/GET";
import job_cards_post_399 from "./api/job-cards/POST";
import job_cards_id_delete_400 from "./api/job-cards/[id]/DELETE";
import job_cards_id_get_401 from "./api/job-cards/[id]/GET";
import job_cards_id_put_402 from "./api/job-cards/[id]/PUT";
import job_cards_id_convert_post_403 from "./api/job-cards/[id]/convert/POST";
import job_cards_id_invoice_post_404 from "./api/job-cards/[id]/invoice/POST";
import job_cards_id_photos_post_405 from "./api/job-cards/[id]/photos/POST";
import job_cards_id_photos_photoId_delete_406 from "./api/job-cards/[id]/photos/[photoId]/DELETE";
import job_cards_id_photos_photoId_patch_407 from "./api/job-cards/[id]/photos/[photoId]/PATCH";
import job_cards_id_photos_photoId_download_get_408 from "./api/job-cards/[id]/photos/[photoId]/download/GET";
import job_cards_id_photos_photoId_save_and_lock_post_409 from "./api/job-cards/[id]/photos/[photoId]/save-and-lock/POST";
import job_costs_post_410 from "./api/job-costs/POST";
import job_forms_id_delete_411 from "./api/job-forms/[id]/DELETE";
import job_forms_id_get_412 from "./api/job-forms/[id]/GET";
import job_forms_id_put_413 from "./api/job-forms/[id]/PUT";
import job_forms_id_compose_defaults_get_414 from "./api/job-forms/[id]/compose-defaults/GET";
import job_forms_id_export_pdf_get_415 from "./api/job-forms/[id]/export-pdf/GET";
import job_forms_id_reset_post_416 from "./api/job-forms/[id]/reset/POST";
import job_forms_id_send_email_post_417 from "./api/job-forms/[id]/send-email/POST";
import job_forms_id_share_delete_418 from "./api/job-forms/[id]/share/DELETE";
import job_forms_id_share_get_419 from "./api/job-forms/[id]/share/GET";
import job_forms_id_share_post_420 from "./api/job-forms/[id]/share/POST";
import jobs_get_421 from "./api/jobs/GET";
import jobs_post_422 from "./api/jobs/POST";
import jobs_report_generate_post_423 from "./api/jobs/report/generate/POST";
import jobs_search_get_424 from "./api/jobs/search/GET";
import jobs_id_get_425 from "./api/jobs/[id]/GET";
import jobs_id_put_426 from "./api/jobs/[id]/PUT";
import jobs_id_attendance_attendanceId_close_post_427 from "./api/jobs/[id]/attendance/[attendanceId]/close/POST";
import jobs_id_compose_defaults_get_428 from "./api/jobs/[id]/compose-defaults/GET";
import jobs_id_costs_get_429 from "./api/jobs/[id]/costs/GET";
import jobs_id_costs_post_430 from "./api/jobs/[id]/costs/POST";
import jobs_id_costs_export_get_431 from "./api/jobs/[id]/costs/export/GET";
import jobs_id_costs_costId_delete_432 from "./api/jobs/[id]/costs/[costId]/DELETE";
import jobs_id_costs_costId_put_433 from "./api/jobs/[id]/costs/[costId]/PUT";
import jobs_id_costs_costId_receipt_get_434 from "./api/jobs/[id]/costs/[costId]/receipt/GET";
import jobs_id_costs_costId_receipt_post_435 from "./api/jobs/[id]/costs/[costId]/receipt/POST";
import jobs_id_delays_get_436 from "./api/jobs/[id]/delays/GET";
import jobs_id_delays_post_437 from "./api/jobs/[id]/delays/POST";
import jobs_id_delays_export_csv_get_438 from "./api/jobs/[id]/delays/export-csv/GET";
import jobs_id_delays_delayId_delete_439 from "./api/jobs/[id]/delays/[delayId]/DELETE";
import jobs_id_delays_delayId_put_440 from "./api/jobs/[id]/delays/[delayId]/PUT";
import jobs_id_documents_get_441 from "./api/jobs/[id]/documents/GET";
import jobs_id_documents_post_442 from "./api/jobs/[id]/documents/POST";
import jobs_id_export_zip_get_443 from "./api/jobs/[id]/export-zip/GET";
import jobs_id_field_docs_get_444 from "./api/jobs/[id]/field-docs/GET";
import jobs_id_files_get_445 from "./api/jobs/[id]/files/GET";
import jobs_id_forms_get_446 from "./api/jobs/[id]/forms/GET";
import jobs_id_forms_post_447 from "./api/jobs/[id]/forms/POST";
import jobs_id_forms_export_csv_get_448 from "./api/jobs/[id]/forms/export-csv/GET";
import jobs_id_forms_submissionId_delete_449 from "./api/jobs/[id]/forms/[submissionId]/DELETE";
import jobs_id_forms_submissionId_reopen_post_450 from "./api/jobs/[id]/forms/[submissionId]/reopen/POST";
import jobs_id_generate_qr_post_451 from "./api/jobs/[id]/generate-qr/POST";
import jobs_id_ledger_get_452 from "./api/jobs/[id]/ledger/GET";
import jobs_id_ledger_post_453 from "./api/jobs/[id]/ledger/POST";
import jobs_id_ledger_export_get_454 from "./api/jobs/[id]/ledger/export/GET";
import jobs_id_ledger_sync_post_455 from "./api/jobs/[id]/ledger/sync/POST";
import jobs_id_ledger_entryId_delete_456 from "./api/jobs/[id]/ledger/[entryId]/DELETE";
import jobs_id_ledger_entryId_put_457 from "./api/jobs/[id]/ledger/[entryId]/PUT";
import jobs_id_ledger_entryId_correct_post_458 from "./api/jobs/[id]/ledger/[entryId]/correct/POST";
import jobs_id_milestones_get_459 from "./api/jobs/[id]/milestones/GET";
import jobs_id_milestones_post_460 from "./api/jobs/[id]/milestones/POST";
import jobs_id_milestones_milestoneId_delete_461 from "./api/jobs/[id]/milestones/[milestoneId]/DELETE";
import jobs_id_milestones_milestoneId_patch_462 from "./api/jobs/[id]/milestones/[milestoneId]/PATCH";
import jobs_id_notes_export_csv_get_463 from "./api/jobs/[id]/notes/export-csv/GET";
import jobs_id_photos_get_464 from "./api/jobs/[id]/photos/GET";
import jobs_id_photos_post_465 from "./api/jobs/[id]/photos/POST";
import jobs_id_photos_export_zip_post_466 from "./api/jobs/[id]/photos/export-zip/POST";
import jobs_id_photos_picker_get_467 from "./api/jobs/[id]/photos/picker/GET";
import jobs_id_photos_share_post_468 from "./api/jobs/[id]/photos/share/POST";
import jobs_id_photos_photoId_delete_469 from "./api/jobs/[id]/photos/[photoId]/DELETE";
import jobs_id_photos_photoId_patch_470 from "./api/jobs/[id]/photos/[photoId]/PATCH";
import jobs_id_photos_photoId_download_get_471 from "./api/jobs/[id]/photos/[photoId]/download/GET";
import jobs_id_photos_photoId_lock_post_472 from "./api/jobs/[id]/photos/[photoId]/lock/POST";
import jobs_id_photos_photoId_replace_post_473 from "./api/jobs/[id]/photos/[photoId]/replace/POST";
import jobs_id_photos_photoId_report_image_get_474 from "./api/jobs/[id]/photos/[photoId]/report-image/GET";
import jobs_id_progress_get_475 from "./api/jobs/[id]/progress/GET";
import jobs_id_progress_put_476 from "./api/jobs/[id]/progress/PUT";
import jobs_id_progress_export_csv_get_477 from "./api/jobs/[id]/progress/export-csv/GET";
import jobs_id_progress_lines_post_478 from "./api/jobs/[id]/progress/lines/POST";
import jobs_id_progress_lines_reorder_post_479 from "./api/jobs/[id]/progress/lines/reorder/POST";
import jobs_id_progress_lines_lineId_delete_480 from "./api/jobs/[id]/progress/lines/[lineId]/DELETE";
import jobs_id_progress_lines_lineId_patch_481 from "./api/jobs/[id]/progress/lines/[lineId]/PATCH";
import jobs_id_progress_lines_lineId_duplicate_post_482 from "./api/jobs/[id]/progress/lines/[lineId]/duplicate/POST";
import jobs_id_progress_report_get_483 from "./api/jobs/[id]/progress/report/GET";
import jobs_id_progress_report_put_484 from "./api/jobs/[id]/progress/report/PUT";
import jobs_id_progress_report_pdf_get_485 from "./api/jobs/[id]/progress/report/pdf/GET";
import jobs_id_progress_sections_post_486 from "./api/jobs/[id]/progress/sections/POST";
import jobs_id_progress_sections_reorder_post_487 from "./api/jobs/[id]/progress/sections/reorder/POST";
import jobs_id_progress_sections_sectionId_delete_488 from "./api/jobs/[id]/progress/sections/[sectionId]/DELETE";
import jobs_id_progress_sections_sectionId_patch_489 from "./api/jobs/[id]/progress/sections/[sectionId]/PATCH";
import jobs_id_progress_sync_post_490 from "./api/jobs/[id]/progress/sync/POST";
import jobs_id_purchase_orders_get_491 from "./api/jobs/[id]/purchase-orders/GET";
import jobs_id_purchase_orders_post_492 from "./api/jobs/[id]/purchase-orders/POST";
import jobs_id_purchase_orders_poId_delete_493 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import jobs_id_purchase_orders_poId_get_494 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
import jobs_id_purchase_orders_poId_put_495 from "./api/jobs/[id]/purchase-orders/[poId]/PUT";
import jobs_id_purchase_orders_poId_pdf_get_496 from "./api/jobs/[id]/purchase-orders/[poId]/pdf/GET";
import jobs_id_report_pdf_post_497 from "./api/jobs/[id]/report/pdf/POST";
import jobs_id_risky_get_498 from "./api/jobs/[id]/risky/GET";
import jobs_id_risky_post_499 from "./api/jobs/[id]/risky/POST";
import jobs_id_risky_riskyId_get_500 from "./api/jobs/[id]/risky/[riskyId]/GET";
import jobs_id_risky_riskyId_put_501 from "./api/jobs/[id]/risky/[riskyId]/PUT";
import jobs_id_risky_riskyId_finalise_post_502 from "./api/jobs/[id]/risky/[riskyId]/finalise/POST";
import jobs_id_risky_riskyId_signatures_post_503 from "./api/jobs/[id]/risky/[riskyId]/signatures/POST";
import jobs_id_risky_riskyId_supervisor_signoff_post_504 from "./api/jobs/[id]/risky/[riskyId]/supervisor-signoff/POST";
import jobs_id_send_email_post_505 from "./api/jobs/[id]/send-email/POST";
import jobs_id_signin_post_506 from "./api/jobs/[id]/signin/POST";
import jobs_id_signin_qr_post_507 from "./api/jobs/[id]/signin-qr/POST";
import jobs_id_signin_status_get_508 from "./api/jobs/[id]/signin-status/GET";
import jobs_id_signout_post_509 from "./api/jobs/[id]/signout/POST";
import jobs_id_signout_qr_post_510 from "./api/jobs/[id]/signout-qr/POST";
import jobs_id_signout_user_post_511 from "./api/jobs/[id]/signout-user/POST";
import jobs_id_site_prestarts_get_512 from "./api/jobs/[id]/site-prestarts/GET";
import jobs_id_site_prestarts_post_513 from "./api/jobs/[id]/site-prestarts/POST";
import jobs_id_site_prestarts_prestartId_get_514 from "./api/jobs/[id]/site-prestarts/[prestartId]/GET";
import jobs_id_site_prestarts_prestartId_put_515 from "./api/jobs/[id]/site-prestarts/[prestartId]/PUT";
import jobs_id_site_prestarts_prestartId_finalise_post_516 from "./api/jobs/[id]/site-prestarts/[prestartId]/finalise/POST";
import jobs_id_site_prestarts_prestartId_workers_post_517 from "./api/jobs/[id]/site-prestarts/[prestartId]/workers/POST";
import jobs_id_studio_swms_get_518 from "./api/jobs/[id]/studio-swms/GET";
import jobs_id_studio_swms_post_519 from "./api/jobs/[id]/studio-swms/POST";
import jobs_id_swms_get_520 from "./api/jobs/[id]/swms/GET";
import jobs_id_swms_post_521 from "./api/jobs/[id]/swms/POST";
import jobs_id_swms_swmsId_signoff_post_522 from "./api/jobs/[id]/swms/[swmsId]/signoff/POST";
import jobs_id_todos_get_523 from "./api/jobs/[id]/todos/GET";
import jobs_id_todos_post_524 from "./api/jobs/[id]/todos/POST";
import jobs_id_todos_todoId_delete_525 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import jobs_id_todos_todoId_put_526 from "./api/jobs/[id]/todos/[todoId]/PUT";
import lens_photos_get_527 from "./api/lens/photos/GET";
import lens_photos_export_zip_post_528 from "./api/lens/photos/export-zip/POST";
import lens_photos_photoId_download_get_529 from "./api/lens/photos/[photoId]/download/GET";
import library_check_published_get_530 from "./api/library/check-published/GET";
import library_items_get_531 from "./api/library/items/GET";
import library_items_id_get_532 from "./api/library/items/[id]/GET";
import library_items_id_patch_533 from "./api/library/items/[id]/PATCH";
import library_items_id_download_get_534 from "./api/library/items/[id]/download/GET";
import library_items_id_install_delete_535 from "./api/library/items/[id]/install/DELETE";
import library_items_id_install_post_536 from "./api/library/items/[id]/install/POST";
import library_my_installed_get_537 from "./api/library/my-installed/GET";
import library_my_installed_id_get_538 from "./api/library/my-installed/[id]/GET";
import library_my_submissions_get_539 from "./api/library/my-submissions/GET";
import lists_get_540 from "./api/lists/GET";
import me_get_541 from "./api/me/GET";
import me_put_542 from "./api/me/PUT";
import me_2fa_disable_post_543 from "./api/me/2fa/disable/POST";
import me_2fa_enable_post_544 from "./api/me/2fa/enable/POST";
import me_2fa_qr_get_545 from "./api/me/2fa/qr/GET";
import me_2fa_recover_post_546 from "./api/me/2fa/recover/POST";
import me_2fa_setup_get_547 from "./api/me/2fa/setup/GET";
import me_2fa_sms_disable_post_548 from "./api/me/2fa/sms/disable/POST";
import me_2fa_sms_enable_post_549 from "./api/me/2fa/sms/enable/POST";
import me_2fa_sms_send_post_550 from "./api/me/2fa/sms/send/POST";
import me_2fa_sms_send_setup_post_551 from "./api/me/2fa/sms/send-setup/POST";
import me_2fa_sms_verify_post_552 from "./api/me/2fa/sms/verify/POST";
import me_2fa_status_get_553 from "./api/me/2fa/status/GET";
import me_2fa_verify_post_554 from "./api/me/2fa/verify/POST";
import me_active_status_get_555 from "./api/me/active-status/GET";
import me_change_password_post_556 from "./api/me/change-password/POST";
import me_email_status_get_557 from "./api/me/email-status/GET";
import me_phone_get_558 from "./api/me/phone/GET";
import me_phone_put_559 from "./api/me/phone/PUT";
import me_profile_attachments_delete_560 from "./api/me/profile-attachments/DELETE";
import me_profile_attachments_post_561 from "./api/me/profile-attachments/POST";
import me_profile_attachments_download_get_562 from "./api/me/profile-attachments/download/GET";
import me_profile_attachments_thumbnail_get_563 from "./api/me/profile-attachments/thumbnail/GET";
...
import migrate_attendance_post_576 from "./api/migrate-attendance/POST";
import migrate_company_settings_post_577 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_578 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_579 from "./api/migrate-dazza-knowledge/POST";
import migrate_emergency_alerts_post_580 from "./api/migrate-emergency-alerts/POST";
import migrate_estimates_post_581 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_582 from "./api/migrate-estimating-library/POST";
import migrate_files_post_583 from "./api/migrate-files/POST";
import migrate_fleet_post_584 from "./api/migrate-fleet/POST";
import migrate_fleet_analytics_post_585 from "./api/migrate-fleet-analytics/POST";
import migrate_fleet_driver_sessions_post_586 from "./api/migrate-fleet-driver-sessions/POST";
import migrate_fleet_usage_post_587 from "./api/migrate-fleet-usage/POST";
import migrate_form_fields_post_588 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_589 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_590 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_591 from "./api/migrate-job-forms/POST";
import migrate_job_photo_shares_post_592 from "./api/migrate-job-photo-shares/POST";
import migrate_job_photos_post_593 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_594 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_595 from "./api/migrate-jobs/POST";
import migrate_ledger_photo_post_596 from "./api/migrate-ledger-photo/POST";
import migrate_library_post_597 from "./api/migrate-library/POST";
import migrate_library_downloads_post_598 from "./api/migrate-library-downloads/POST";
import migrate_notifications_post_599 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_600 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_601 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_602 from "./api/migrate-pdf-settings/POST";
import migrate_photo_gps_post_603 from "./api/migrate-photo-gps/POST";
import migrate_plan_manager_post_604 from "./api/migrate-plan-manager/POST";
import migrate_plan_manager_v2_post_605 from "./api/migrate-plan-manager-v2/POST";
import migrate_plan_manager_v3_post_606 from "./api/migrate-plan-manager-v3/POST";
import migrate_safety_post_607 from "./api/migrate-safety/POST";
import migrate_safety_studio_post_608 from "./api/migrate-safety-studio/POST";
import migrate_site_prestart_post_609 from "./api/migrate-site-prestart/POST";
import migrate_sms_verified_at_post_610 from "./api/migrate-sms-verified-at/POST";
import migrate_starter_pack_post_611 from "./api/migrate-starter-pack/POST";
import migrate_studio_pdf_post_612 from "./api/migrate-studio-pdf/POST";
import migrate_studio_phase2_post_613 from "./api/migrate-studio-phase2/POST";
import migrate_subscriptions_post_614 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_615 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_616 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_617 from "./api/migrate-team/POST";
import notes_get_618 from "./api/notes/GET";
import notes_post_619 from "./api/notes/POST";
import notes_comments_post_620 from "./api/notes/comments/POST";
import notes_migrate_post_621 from "./api/notes/migrate/POST";
import notes_id_delete_622 from "./api/notes/[id]/DELETE";
import notifications_alerts_get_623 from "./api/notifications/alerts/GET";
import notifications_prefs_get_624 from "./api/notifications/prefs/GET";
import notifications_prefs_put_625 from "./api/notifications/prefs/PUT";
import notifications_read_post_626 from "./api/notifications/read/POST";
import owner_console_activity_get_627 from "./api/owner-console/activity/GET";
import owner_console_cancellation_feedback_get_628 from "./api/owner-console/cancellation-feedback/GET";
import owner_console_companies_get_629 from "./api/owner-console/companies/GET";
import owner_console_companies_post_630 from "./api/owner-console/companies/POST";
import owner_console_companies_usage_get_631 from "./api/owner-console/companies/usage/GET";
import owner_console_companies_id_limits_put_632 from "./api/owner-console/companies/[id]/limits/PUT";
import owner_console_form_templates_get_633 from "./api/owner-console/form-templates/GET";
import owner_console_form_templates_post_634 from "./api/owner-console/form-templates/POST";
import owner_console_library_items_get_635 from "./api/owner-console/library/items/GET";
import owner_console_library_items_post_636 from "./api/owner-console/library/items/POST";
import owner_console_library_items_from_template_post_637 from "./api/owner-console/library/items/from-template/POST";
import owner_console_library_items_id_delete_638 from "./api/owner-console/library/items/[id]/DELETE";
import owner_console_library_items_id_patch_639 from "./api/owner-console/library/items/[id]/PATCH";
import owner_console_library_items_id_put_640 from "./api/owner-console/library/items/[id]/PUT";
import owner_console_library_items_id_push_update_post_641 from "./api/owner-console/library/items/[id]/push-update/POST";
import owner_console_library_submissions_get_642 from "./api/owner-console/library/submissions/GET";
import owner_console_library_submissions_id_review_post_643 from "./api/owner-console/library/submissions/[id]/review/POST";
import owner_console_starter_pack_get_644 from "./api/owner-console/starter-pack/GET";
import owner_console_starter_pack_post_645 from "./api/owner-console/starter-pack/POST";
import owner_console_stats_get_646 from "./api/owner-console/stats/GET";
import owner_console_storage_get_647 from "./api/owner-console/storage/GET";
import owner_console_swms_masters_get_648 from "./api/owner-console/swms/masters/GET";
import owner_console_swms_masters_post_649 from "./api/owner-console/swms/masters/POST";
import owner_console_swms_masters_publish_all_post_650 from "./api/owner-console/swms/masters/publish-all/POST";
import owner_console_swms_masters_id_delete_651 from "./api/owner-console/swms/masters/[id]/DELETE";
import owner_console_swms_masters_id_get_652 from "./api/owner-console/swms/masters/[id]/GET";
import owner_console_swms_masters_id_put_653 from "./api/owner-console/swms/masters/[id]/PUT";
import owner_console_swms_masters_id_publish_post_654 from "./api/owner-console/swms/masters/[id]/publish/POST";
import owner_console_swms_migrate_master_library_post_655 from "./api/owner-console/swms/migrate-master-library/POST";
import owner_console_swms_push_post_656 from "./api/owner-console/swms/push/POST";
import owner_console_swms_seed_bricklaying_post_657 from "./api/owner-console/swms/seed-bricklaying/POST";
import owner_console_swms_seed_building_inspection_post_658 from "./api/owner-console/swms/seed-building-inspection/POST";
import owner_console_swms_seed_cabinets_post_659 from "./api/owner-console/swms/seed-cabinets/POST";
import owner_console_swms_seed_carpenter_fixing_post_660 from "./api/owner-console/swms/seed-carpenter-fixing/POST";
import owner_console_swms_seed_carpenter_framing_post_661 from "./api/owner-console/swms/seed-carpenter-framing/POST";
import owner_console_swms_seed_carpenter_lockup_post_662 from "./api/owner-console/swms/seed-carpenter-lockup/POST";
import owner_console_swms_seed_ceramic_tiling_post_663 from "./api/owner-console/swms/seed-ceramic-tiling/POST";
import owner_console_swms_seed_concreting_slab_post_664 from "./api/owner-console/swms/seed-concreting-slab/POST";
import owner_console_swms_seed_delivery_loading_post_665 from "./api/owner-console/swms/seed-delivery-loading/POST";
import owner_console_swms_seed_environmental_spill_post_666 from "./api/owner-console/swms/seed-environmental-spill/POST";
import owner_console_swms_seed_ewp_post_667 from "./api/owner-console/swms/seed-ewp/POST";
import owner_console_swms_seed_excavations_substation_post_668 from "./api/owner-console/swms/seed-excavations-substation/POST";
import owner_console_swms_seed_fencing_post_669 from "./api/owner-console/swms/seed-fencing/POST";
import owner_console_swms_seed_heat_stress_post_670 from "./api/owner-console/swms/seed-heat-stress/POST";
import owner_console_swms_seed_landscaping_post_671 from "./api/owner-console/swms/seed-landscaping/POST";
import owner_console_swms_seed_live_parts_post_672 from "./api/owner-console/swms/seed-live-parts/POST";
import owner_console_swms_seed_manual_handling_post_673 from "./api/owner-console/swms/seed-manual-handling/POST";
import owner_console_swms_seed_moving_plant_post_674 from "./api/owner-console/swms/seed-moving-plant/POST";
import owner_console_swms_seed_painting_post_675 from "./api/owner-console/swms/seed-painting/POST";
import owner_console_swms_seed_power_tools_post_676 from "./api/owner-console/swms/seed-power-tools/POST";
import owner_console_swms_seed_silica_dust_post_677 from "./api/owner-console/swms/seed-silica-dust/POST";
import owner_console_swms_seed_traffic_management_post_678 from "./api/owner-console/swms/seed-traffic-management/POST";
import owner_console_swms_seed_underground_services_post_679 from "./api/owner-console/swms/seed-underground-services/POST";
import owner_console_swms_seed_vacuum_excavation_post_680 from "./api/owner-console/swms/seed-vacuum-excavation/POST";
...
import plan_manager_drawings_id_get_687 from "./api/plan-manager/drawings/[id]/GET";
import plan_manager_drawings_id_annotations_put_688 from "./api/plan-manager/drawings/[id]/annotations/PUT";
import plan_manager_drawings_id_archive_post_689 from "./api/plan-manager/drawings/[id]/archive/POST";
import plan_manager_drawings_id_job_links_delete_690 from "./api/plan-manager/drawings/[id]/job-links/DELETE";
import plan_manager_drawings_id_job_links_post_691 from "./api/plan-manager/drawings/[id]/job-links/POST";
import plan_manager_drawings_id_pages_pageNo_annotations_get_692 from "./api/plan-manager/drawings/[id]/pages/[pageNo]/annotations/GET";
import plan_manager_drawings_id_permanent_delete_693 from "./api/plan-manager/drawings/[id]/permanent/DELETE";
import plan_manager_drawings_id_reorder_patch_694 from "./api/plan-manager/drawings/[id]/reorder/PATCH";
import plan_manager_drawings_id_restore_post_695 from "./api/plan-manager/drawings/[id]/restore/POST";
import plan_manager_drawings_id_revisions_post_696 from "./api/plan-manager/drawings/[id]/revisions/POST";
import plan_manager_drawings_id_revisions_revisionId_finalize_post_697 from "./api/plan-manager/drawings/[id]/revisions/[revisionId]/finalize/POST";
import plan_manager_drawings_id_upload_post_698 from "./api/plan-manager/drawings/[id]/upload/POST";
import plan_manager_jobs_jobId_drawings_zip_get_699 from "./api/plan-manager/jobs/[jobId]/drawings-zip/GET";
import plan_manager_jobs_with_drawings_get_700 from "./api/plan-manager/jobs-with-drawings/GET";
import plan_manager_share_post_701 from "./api/plan-manager/share/POST";
import plan_manager_share_validate_get_702 from "./api/plan-manager/share/validate/GET";
import plan_manager_upload_post_703 from "./api/plan-manager/upload/POST";
import portal_estimates_id_approve_post_704 from "./api/portal/estimates/[id]/approve/POST";
import portal_invite_post_705 from "./api/portal/invite/POST";
import portal_invoices_id_pay_post_706 from "./api/portal/invoices/[id]/pay/POST";
import portal_jobs_get_707 from "./api/portal/jobs/GET";
import portal_jobs_id_get_708 from "./api/portal/jobs/[id]/GET";
import portal_migrate_post_709 from "./api/portal/migrate/POST";
import portal_validate_post_710 from "./api/portal/validate/POST";
import public_form_token_get_711 from "./api/public/form/[token]/GET";
import public_form_token_submit_post_712 from "./api/public/form/[token]/submit/POST";
import public_job_photos_token_get_713 from "./api/public/job-photos/[token]/GET";
import public_job_photos_token_photo_photoId_get_714 from "./api/public/job-photos/[token]/photo/[photoId]/GET";
import public_swms_token_get_715 from "./api/public/swms/[token]/GET";
import public_swms_token_signoff_post_716 from "./api/public/swms/[token]/signoff/POST";
import purchase_orders_poId_compose_defaults_get_717 from "./api/purchase-orders/[poId]/compose-defaults/GET";
import purchase_orders_poId_send_email_post_718 from "./api/purchase-orders/[poId]/send-email/POST";
import push_subscribe_delete_719 from "./api/push/subscribe/DELETE";
import push_subscribe_post_720 from "./api/push/subscribe/POST";
import push_vapid_key_get_721 from "./api/push/vapid-key/GET";
import quick_links_site_meta_get_722 from "./api/quick-links/site-meta/GET";
import recipes_get_723 from "./api/recipes/GET";
import recipes_post_724 from "./api/recipes/POST";
import recipes_id_delete_725 from "./api/recipes/[id]/DELETE";
import recipes_id_put_726 from "./api/recipes/[id]/PUT";
import risk_register_get_727 from "./api/risk-register/GET";
import risk_register_post_728 from "./api/risk-register/POST";
import risk_register_id_get_729 from "./api/risk-register/[id]/GET";
import risk_register_id_put_730 from "./api/risk-register/[id]/PUT";
import risk_register_id_archive_post_731 from "./api/risk-register/[id]/archive/POST";
import risk_register_id_unarchive_post_732 from "./api/risk-register/[id]/unarchive/POST";
import rl_register_get_733 from "./api/rl-register/GET";
import rl_register_post_734 from "./api/rl-register/POST";
import rl_register_points_id_delete_735 from "./api/rl-register/points/[id]/DELETE";
import rl_register_points_id_put_736 from "./api/rl-register/points/[id]/PUT";
import rl_register_benchmarkId_points_get_737 from "./api/rl-register/[benchmarkId]/points/GET";
import rl_register_benchmarkId_points_post_738 from "./api/rl-register/[benchmarkId]/points/POST";
import rl_register_jobId_export_csv_get_739 from "./api/rl-register/[jobId]/export/csv/GET";
import rl_register_jobId_export_pdf_get_740 from "./api/rl-register/[jobId]/export/pdf/GET";
import safety_ai_draft_post_741 from "./api/safety/ai/draft/POST";
import safety_documents_get_742 from "./api/safety/documents/GET";
import safety_documents_post_743 from "./api/safety/documents/POST";
import safety_documents_new_post_744 from "./api/safety/documents/new/POST";
import safety_documents_id_delete_745 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_746 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_747 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_748 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_749 from "./api/safety/generated-posters/[id]/DELETE";
import safety_generated_posters_id_pdf_get_750 from "./api/safety/generated-posters/[id]/pdf/GET";
import safety_job_safety_plans_get_751 from "./api/safety/job-safety-plans/GET";
import safety_job_safety_plans_post_752 from "./api/safety/job-safety-plans/POST";
import safety_job_safety_plans_id_delete_753 from "./api/safety/job-safety-plans/[id]/DELETE";
import safety_job_safety_plans_id_put_754 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_755 from "./api/safety/job-swms/GET";
import safety_job_swms_post_756 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_757 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_758 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_759 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_share_token_post_760 from "./api/safety/job-swms/[id]/share-token/POST";
import safety_job_swms_id_signoffs_get_761 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_762 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_763 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_764 from "./api/safety/plans/GET";
import safety_plans_post_765 from "./api/safety/plans/POST";
import safety_plans_seed_post_766 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_767 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_768 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_769 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_770 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_771 from "./api/safety/posters/GET";
import safety_posters_post_772 from "./api/safety/posters/POST";
import safety_posters_id_delete_773 from "./api/safety/posters/[id]/DELETE";
import safety_posters_id_download_get_774 from "./api/safety/posters/[id]/download/GET";
import safety_swms_get_775 from "./api/safety/swms/GET";
import safety_swms_post_776 from "./api/safety/swms/POST";
import safety_swms_import_docx_post_777 from "./api/safety/swms/import-docx/POST";
import safety_swms_seed_post_778 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_779 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_780 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_781 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_782 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_783 from "./api/safety/swms/[id]/export/GET";
import safety_swms_id_publish_to_library_post_784 from "./api/safety/swms/[id]/publish-to-library/POST";
import safety_swms_submissions_get_785 from "./api/safety/swms-submissions/GET";
import scheduler_crew_get_786 from "./api/scheduler/crew/GET";
import scheduler_jobs_get_787 from "./api/scheduler/jobs/GET";
import scheduler_jobs_id_reschedule_patch_788 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
import scheduler_tasks_get_789 from "./api/scheduler/tasks/GET";
import sds_register_get_790 from "./api/sds-register/GET";
import sds_register_post_791 from "./api/sds-register/POST";
import sds_register_id_delete_792 from "./api/sds-register/[id]/DELETE";
import sds_register_id_put_793 from "./api/sds-register/[id]/PUT";
import sds_register_id_download_get_794 from "./api/sds-register/[id]/download/GET";
import sds_register_id_replace_post_795 from "./api/sds-register/[id]/replace/POST";
import secure_share_get_796 from "./api/secure-share/GET";
import secure_share_post_797 from "./api/secure-share/POST";
import secure_share_active_get_798 from "./api/secure-share/active/GET";
import secure_share_id_delete_799 from "./api/secure-share/[id]/DELETE";
import secure_share_id_revoke_and_rotate_post_800 from "./api/secure-share/[id]/revoke-and-rotate/POST";
import secure_share_token_get_801 from "./api/secure-share/[token]/GET";
import secure_share_token_post_802 from "./api/secure-share/[token]/POST";
import secure_share_token_content_get_803 from "./api/secure-share/[token]/content/GET";
import settings_backup_get_804 from "./api/settings/backup/GET";
import settings_backup_post_805 from "./api/settings/backup/POST";
import settings_backup_company_data_get_806 from "./api/settings/backup/company-data/GET";
import settings_backup_csv_pack_get_807 from "./api/settings/backup/csv-pack/GET";
import settings_backup_export_get_808 from "./api/settings/backup/export/GET";
import settings_backup_run_post_809 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_810 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_811 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_812 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_813 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_814 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_815 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_816 from "./api/settings/retention/GET";
import settings_retention_post_817 from "./api/settings/retention/POST";
import settings_storage_provider_get_818 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_819 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_820 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_821 from "./api/settings/terminology/GET";
import settings_terminology_post_822 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_823 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_824 from "./api/settings/xero-credentials/POST";
import share_token_get_825 from "./api/share/[token]/GET";
import signin_history_get_826 from "./api/signin-history/GET";
import signup_post_827 from "./api/signup/POST";
import sos_get_828 from "./api/sos/GET";
import sos_acknowledge_post_829 from "./api/sos/acknowledge/POST";
import sos_trigger_post_830 from "./api/sos/trigger/POST";
import stakeholders_sms_post_831 from "./api/stakeholders/sms/POST";
import stripe_create_checkout_session_post_832 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_833 from "./api/stripe/session/[sessionId]/GET";
import studio_generate_from_safety_post_834 from "./api/studio/generate-from-safety/POST";
import studio_upload_image_post_835 from "./api/studio/upload-image/POST";
import subscription_create_checkout_post_836 from "./api/subscription/create-checkout/POST";
import subscription_status_get_837 from "./api/subscription/status/GET";
import subscription_webhook_post_838 from "./api/subscription/webhook/POST";
import support_mode_audit_get_839 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_840 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_841 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_842 from "./api/support-mode/enter/POST";
import support_mode_exit_post_843 from "./api/support-mode/exit/POST";
import support_mode_status_get_844 from "./api/support-mode/status/GET";
import tag_tasks_get_845 from "./api/tag-tasks/GET";
import tag_tasks_id_patch_846 from "./api/tag-tasks/[id]/PATCH";
import takeoff_pad_get_847 from "./api/takeoff-pad/GET";
import takeoff_pad_put_848 from "./api/takeoff-pad/PUT";
import tasks_post_849 from "./api/tasks/POST";
import tasks_id_put_850 from "./api/tasks/[id]/PUT";
import team_get_851 from "./api/team/GET";
import team_invite_post_852 from "./api/team/invite/POST";
import team_invites_get_853 from "./api/team/invites/GET";
import team_invites_post_854 from "./api/team/invites/POST";
import team_invites_id_cancel_post_855 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_856 from "./api/team/invites/[id]/resend/POST";
import team_members_get_857 from "./api/team/members/GET";
import team_members_id_icon_permissions_get_858 from "./api/team/members/[id]/icon-permissions/GET";
import team_members_id_icon_permissions_put_859 from "./api/team/members/[id]/icon-permissions/PUT";
import team_resend_verification_post_860 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_861 from "./api/team/schedule/migrate/POST";
import team_shifts_get_862 from "./api/team/shifts/GET";
import team_shifts_post_863 from "./api/team/shifts/POST";
import team_shifts_id_delete_864 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_865 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_866 from "./api/team/time-entries/GET";
import team_time_entries_post_867 from "./api/team/time-entries/POST";
import team_time_entries_export_get_868 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_869 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_870 from "./api/team/verify-user/POST";
import team_id_delete_871 from "./api/team/[id]/DELETE";
import team_id_put_872 from "./api/team/[id]/PUT";
import usage_get_873 from "./api/usage/GET";
import user_logs_get_874 from "./api/user-logs/GET";
import user_logs_users_get_875 from "./api/user-logs/users/GET";
import work_attendance_get_876 from "./api/work/attendance/GET";
import work_delays_get_877 from "./api/work/delays/GET";
import work_notes_get_878 from "./api/work/notes/GET";
import work_progress_get_879 from "./api/work/progress/GET";
import work_tasks_get_880 from "./api/work/tasks/GET";
// </api-imports>
// ── Job Cards ─────────────────────────────────────────────────────────────────
...
app.get("/api/incidents", incidents_get_348);
app.post("/api/incidents", incidents_post_349);
app.post("/api/incidents/:id/archive", incidents_id_archive_post_350);
app.post("/api/incidents/:id/unarchive", incidents_id_unarchive_post_351);
app.get("/api/incidents/:incidentId", incidents_incidentId_get_352);
app.put("/api/incidents/:incidentId", incidents_incidentId_put_353);
app.get("/api/incidents/:incidentId/attachments", incidents_incidentId_attachments_get_354);
app.post("/api/incidents/:incidentId/attachments", incidents_incidentId_attachments_post_355);
app.delete("/api/incidents/:incidentId/attachments/:attachId", incidents_incidentId_attachments_attachId_delete_356);
app.post("/api/incidents/:incidentId/close", incidents_incidentId_close_post_357);
app.post("/api/incidents/:incidentId/corrective-actions", incidents_incidentId_corrective_actions_post_358);
app.put("/api/incidents/:incidentId/corrective-actions/:actionId", incidents_incidentId_corrective_actions_actionId_put_359);
app.get("/api/incidents/:incidentId/pdf", incidents_incidentId_pdf_get_360);
app.post("/api/incidents/:incidentId/third-parties", incidents_incidentId_third_parties_post_361);
app.delete("/api/incidents/:incidentId/third-parties/:thirdPartyId", incidents_incidentId_third_parties_thirdPartyId_delete_362);
app.get("/api/integrations/myob/auth-url", integrations_myob_auth_url_get_363);
app.get("/api/integrations/myob/callback", integrations_myob_callback_get_364);
app.post("/api/integrations/myob/disconnect", integrations_myob_disconnect_post_365);
app.get("/api/integrations/myob/status", integrations_myob_status_get_366);
app.post("/api/integrations/myob/sync-invoice", integrations_myob_sync_invoice_post_367);
app.get("/api/integrations/onedrive/auth-url", integrations_onedrive_auth_url_get_368);
app.get("/api/integrations/onedrive/callback", integrations_onedrive_callback_get_369);
app.post("/api/integrations/onedrive/disconnect", integrations_onedrive_disconnect_post_370);
app.get("/api/integrations/onedrive/status", integrations_onedrive_status_get_371);
app.post("/api/integrations/onedrive/upload-file", integrations_onedrive_upload_file_post_372);
app.get("/api/integrations/qbo/auth-url", integrations_qbo_auth_url_get_373);
app.get("/api/integrations/qbo/callback", integrations_qbo_callback_get_374);
app.post("/api/integrations/qbo/disconnect", integrations_qbo_disconnect_post_375);
app.get("/api/integrations/qbo/status", integrations_qbo_status_get_376);
app.post("/api/integrations/qbo/sync-invoice", integrations_qbo_sync_invoice_post_377);
app.get("/api/integrations/xero/auth-url", integrations_xero_auth_url_get_378);
app.get("/api/integrations/xero/callback", integrations_xero_callback_get_379);
app.post("/api/integrations/xero/disconnect", integrations_xero_disconnect_post_380);
app.get("/api/integrations/xero/status", integrations_xero_status_get_381);
app.post("/api/integrations/xero/sync-customer", integrations_xero_sync_customer_post_382);
app.post("/api/integrations/xero/sync-invoice", integrations_xero_sync_invoice_post_383);
app.post("/api/integrations/xero/webhook", integrations_xero_webhook_post_384);
app.get("/api/invoices", invoices_get_385);
app.post("/api/invoices", invoices_post_386);
app.delete("/api/invoices/:id", invoices_id_delete_387);
app.get("/api/invoices/:id", invoices_id_get_388);
app.put("/api/invoices/:id", invoices_id_put_389);
app.get("/api/invoices/:id/compose-defaults", invoices_id_compose_defaults_get_390);
app.post("/api/invoices/:id/duplicate", invoices_id_duplicate_post_391);
app.get("/api/invoices/:id/export-pdf", invoices_id_export_pdf_get_392);
app.post("/api/invoices/:id/mark-sent", invoices_id_mark_sent_post_393);
app.post("/api/invoices/:id/record-payment", invoices_id_record_payment_post_394);
app.post("/api/invoices/:id/send-email", invoices_id_send_email_post_395);
app.patch("/api/invoices/:id/unlock", invoices_id_unlock_patch_396);
app.post("/api/invoices/:id/void", invoices_id_void_post_397);
app.get("/api/job-cards", job_cards_get_398);
app.post("/api/job-cards", job_cards_post_399);
app.delete("/api/job-cards/:id", job_cards_id_delete_400);
app.get("/api/job-cards/:id", job_cards_id_get_401);
app.put("/api/job-cards/:id", job_cards_id_put_402);
app.post("/api/job-cards/:id/convert", job_cards_id_convert_post_403);
app.post("/api/job-cards/:id/invoice", job_cards_id_invoice_post_404);
app.post("/api/job-cards/:id/photos", job_cards_id_photos_post_405);
app.delete("/api/job-cards/:id/photos/:photoId", job_cards_id_photos_photoId_delete_406);
app.patch("/api/job-cards/:id/photos/:photoId", job_cards_id_photos_photoId_patch_407);
app.get("/api/job-cards/:id/photos/:photoId/download", job_cards_id_photos_photoId_download_get_408);
app.post("/api/job-cards/:id/photos/:photoId/save-and-lock", job_cards_id_photos_photoId_save_and_lock_post_409);
app.post("/api/job-costs", job_costs_post_410);
app.delete("/api/job-forms/:id", job_forms_id_delete_411);
app.get("/api/job-forms/:id", job_forms_id_get_412);
app.put("/api/job-forms/:id", job_forms_id_put_413);
app.get("/api/job-forms/:id/compose-defaults", job_forms_id_compose_defaults_get_414);
app.get("/api/job-forms/:id/export-pdf", job_forms_id_export_pdf_get_415);
app.post("/api/job-forms/:id/reset", job_forms_id_reset_post_416);
app.post("/api/job-forms/:id/send-email", job_forms_id_send_email_post_417);
app.delete("/api/job-forms/:id/share", job_forms_id_share_delete_418);
app.get("/api/job-forms/:id/share", job_forms_id_share_get_419);
app.post("/api/job-forms/:id/share", job_forms_id_share_post_420);
app.get("/api/jobs", jobs_get_421);
app.post("/api/jobs", jobs_post_422);
app.post("/api/jobs/report/generate", jobs_report_generate_post_423);
app.get("/api/jobs/search", jobs_search_get_424);
app.get("/api/jobs/:id", jobs_id_get_425);
app.put("/api/jobs/:id", jobs_id_put_426);
app.post("/api/jobs/:id/attendance/:attendanceId/close", jobs_id_attendance_attendanceId_close_post_427);
app.get("/api/jobs/:id/compose-defaults", jobs_id_compose_defaults_get_428);
app.get("/api/jobs/:id/costs", jobs_id_costs_get_429);
app.post("/api/jobs/:id/costs", jobs_id_costs_post_430);
app.get("/api/jobs/:id/costs/export", jobs_id_costs_export_get_431);
app.delete("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_delete_432);
app.put("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_put_433);
app.get("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_get_434);
app.post("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_post_435);
app.get("/api/jobs/:id/delays", jobs_id_delays_get_436);
app.post("/api/jobs/:id/delays", jobs_id_delays_post_437);
app.get("/api/jobs/:id/delays/export-csv", jobs_id_delays_export_csv_get_438);
app.delete("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_delete_439);
app.put("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_put_440);
app.get("/api/jobs/:id/documents", jobs_id_documents_get_441);
app.post("/api/jobs/:id/documents", jobs_id_documents_post_442);
app.get("/api/jobs/:id/export-zip", jobs_id_export_zip_get_443);
app.get("/api/jobs/:id/field-docs", jobs_id_field_docs_get_444);
app.get("/api/jobs/:id/files", jobs_id_files_get_445);
app.get("/api/jobs/:id/forms", jobs_id_forms_get_446);
app.post("/api/jobs/:id/forms", jobs_id_forms_post_447);
app.get("/api/jobs/:id/forms/export-csv", jobs_id_forms_export_csv_get_448);
app.delete("/api/jobs/:id/forms/:submissionId", jobs_id_forms_submissionId_delete_449);
app.post("/api/jobs/:id/forms/:submissionId/reopen", jobs_id_forms_submissionId_reopen_post_450);
app.post("/api/jobs/:id/generate-qr", jobs_id_generate_qr_post_451);
app.get("/api/jobs/:id/ledger", jobs_id_ledger_get_452);
app.post("/api/jobs/:id/ledger", jobs_id_ledger_post_453);
app.get("/api/jobs/:id/ledger/export", jobs_id_ledger_export_get_454);
app.post("/api/jobs/:id/ledger/sync", jobs_id_ledger_sync_post_455);
app.delete("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_delete_456);
app.put("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_put_457);
app.post("/api/jobs/:id/ledger/:entryId/correct", jobs_id_ledger_entryId_correct_post_458);
app.get("/api/jobs/:id/milestones", jobs_id_milestones_get_459);
app.post("/api/jobs/:id/milestones", jobs_id_milestones_post_460);
app.delete("/api/jobs/:id/milestones/:milestoneId", jobs_id_milestones_milestoneId_delete_461);
app.patch("/api/jobs/:id/milestones/:milestoneId", jobs_id_milestones_milestoneId_patch_462);
app.get("/api/jobs/:id/notes/export-csv", jobs_id_notes_export_csv_get_463);
app.get("/api/jobs/:id/photos", jobs_id_photos_get_464);
app.post("/api/jobs/:id/photos", jobs_id_photos_post_465);
app.post("/api/jobs/:id/photos/export-zip", jobs_id_photos_export_zip_post_466);
app.get("/api/jobs/:id/photos/picker", jobs_id_photos_picker_get_467);
app.post("/api/jobs/:id/photos/share", jobs_id_photos_share_post_468);
app.delete("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_delete_469);
app.patch("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_patch_470);
app.get("/api/jobs/:id/photos/:photoId/download", jobs_id_photos_photoId_download_get_471);
app.post("/api/jobs/:id/photos/:photoId/lock", jobs_id_photos_photoId_lock_post_472);
app.post("/api/jobs/:id/photos/:photoId/replace", jobs_id_photos_photoId_replace_post_473);
app.get("/api/jobs/:id/photos/:photoId/report-image", jobs_id_photos_photoId_report_image_get_474);
app.get("/api/jobs/:id/progress", jobs_id_progress_get_475);
app.put("/api/jobs/:id/progress", jobs_id_progress_put_476);
app.get("/api/jobs/:id/progress/export-csv", jobs_id_progress_export_csv_get_477);
app.post("/api/jobs/:id/progress/lines", jobs_id_progress_lines_post_478);
app.post("/api/jobs/:id/progress/lines/reorder", jobs_id_progress_lines_reorder_post_479);
app.delete("/api/jobs/:id/progress/lines/:lineId", jobs_id_progress_lines_lineId_delete_480);
app.patch("/api/jobs/:id/progress/lines/:lineId", jobs_id_progress_lines_lineId_patch_481);
app.post("/api/jobs/:id/progress/lines/:lineId/duplicate", jobs_id_progress_lines_lineId_duplicate_post_482);
app.get("/api/jobs/:id/progress/report", jobs_id_progress_report_get_483);
app.put("/api/jobs/:id/progress/report", jobs_id_progress_report_put_484);
app.get("/api/jobs/:id/progress/report/pdf", jobs_id_progress_report_pdf_get_485);
app.post("/api/jobs/:id/progress/sections", jobs_id_progress_sections_post_486);
app.post("/api/jobs/:id/progress/sections/reorder", jobs_id_progress_sections_reorder_post_487);
app.delete("/api/jobs/:id/progress/sections/:sectionId", jobs_id_progress_sections_sectionId_delete_488);
app.patch("/api/jobs/:id/progress/sections/:sectionId", jobs_id_progress_sections_sectionId_patch_489);
app.post("/api/jobs/:id/progress/sync", jobs_id_progress_sync_post_490);
app.get("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_get_491);
app.post("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_post_492);
app.delete("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_delete_493);
app.get("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_get_494);
app.put("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_put_495);
app.get("/api/jobs/:id/purchase-orders/:poId/pdf", jobs_id_purchase_orders_poId_pdf_get_496);
app.post("/api/jobs/:id/report/pdf", jobs_id_report_pdf_post_497);
app.get("/api/jobs/:id/risky", jobs_id_risky_get_498);
app.post("/api/jobs/:id/risky", jobs_id_risky_post_499);
app.get("/api/jobs/:id/risky/:riskyId", jobs_id_risky_riskyId_get_500);
app.put("/api/jobs/:id/risky/:riskyId", jobs_id_risky_riskyId_put_501);
app.post("/api/jobs/:id/risky/:riskyId/finalise", jobs_id_risky_riskyId_finalise_post_502);
app.post("/api/jobs/:id/risky/:riskyId/signatures", jobs_id_risky_riskyId_signatures_post_503);
app.post("/api/jobs/:id/risky/:riskyId/supervisor-signoff", jobs_id_risky_riskyId_supervisor_signoff_post_504);
app.post("/api/jobs/:id/send-email", jobs_id_send_email_post_505);
app.post("/api/jobs/:id/signin", jobs_id_signin_post_506);
app.post("/api/jobs/:id/signin-qr", jobs_id_signin_qr_post_507);
app.get("/api/jobs/:id/signin-status", jobs_id_signin_status_get_508);
app.post("/api/jobs/:id/signout", jobs_id_signout_post_509);
app.post("/api/jobs/:id/signout-qr", jobs_id_signout_qr_post_510);
app.post("/api/jobs/:id/signout-user", jobs_id_signout_user_post_511);
app.get("/api/jobs/:id/site-prestarts", jobs_id_site_prestarts_get_512);
app.post("/api/jobs/:id/site-prestarts", jobs_id_site_prestarts_post_513);
app.get("/api/jobs/:id/site-prestarts/:prestartId", jobs_id_site_prestarts_prestartId_get_514);
app.put("/api/jobs/:id/site-prestarts/:prestartId", jobs_id_site_prestarts_prestartId_put_515);
app.post("/api/jobs/:id/site-prestarts/:prestartId/finalise", jobs_id_site_prestarts_prestartId_finalise_post_516);
app.post("/api/jobs/:id/site-prestarts/:prestartId/workers", jobs_id_site_prestarts_prestartId_workers_post_517);
app.get("/api/jobs/:id/studio-swms", jobs_id_studio_swms_get_518);
app.post("/api/jobs/:id/studio-swms", jobs_id_studio_swms_post_519);
app.get("/api/jobs/:id/swms", jobs_id_swms_get_520);
app.post("/api/jobs/:id/swms", jobs_id_swms_post_521);
app.post("/api/jobs/:id/swms/:swmsId/signoff", jobs_id_swms_swmsId_signoff_post_522);
app.get("/api/jobs/:id/todos", jobs_id_todos_get_523);
app.post("/api/jobs/:id/todos", jobs_id_todos_post_524);
app.delete("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_delete_525);
app.put("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_put_526);
app.get("/api/lens/photos", lens_photos_get_527);
app.post("/api/lens/photos/export-zip", lens_photos_export_zip_post_528);
app.get("/api/lens/photos/:photoId/download", lens_photos_photoId_download_get_529);
app.get("/api/library/check-published", library_check_published_get_530);
app.get("/api/library/items", library_items_get_531);
app.get("/api/library/items/:id", library_items_id_get_532);
app.patch("/api/library/items/:id", library_items_id_patch_533);
app.get("/api/library/items/:id/download", library_items_id_download_get_534);
app.delete("/api/library/items/:id/install", library_items_id_install_delete_535);
app.post("/api/library/items/:id/install", library_items_id_install_post_536);
app.get("/api/library/my-installed", library_my_installed_get_537);
app.get("/api/library/my-installed/:id", library_my_installed_id_get_538);
app.get("/api/library/my-submissions", library_my_submissions_get_539);
app.get("/api/lists", lists_get_540);
app.get("/api/me", me_get_541);
app.put("/api/me", me_put_542);
app.post("/api/me/2fa/disable", me_2fa_disable_post_543);
app.post("/api/me/2fa/enable", me_2fa_enable_post_544);
app.get("/api/me/2fa/qr", me_2fa_qr_get_545);
app.post("/api/me/2fa/recover", me_2fa_recover_post_546);
app.get("/api/me/2fa/setup", me_2fa_setup_get_547);
app.post("/api/me/2fa/sms/disable", me_2fa_sms_disable_post_548);
app.post("/api/me/2fa/sms/enable", me_2fa_sms_enable_post_549);
app.post("/api/me/2fa/sms/send", me_2fa_sms_send_post_550);
app.post("/api/me/2fa/sms/send-setup", me_2fa_sms_send_setup_post_551);
app.post("/api/me/2fa/sms/verify", me_2fa_sms_verify_post_552);
app.get("/api/me/2fa/status", me_2fa_status_get_553);
app.post("/api/me/2fa/verify", me_2fa_verify_post_554);
app.get("/api/me/active-status", me_active_status_get_555);
app.post("/api/me/change-password", me_change_password_post_556);
app.get("/api/me/email-status", me_email_status_get_557);
app.get("/api/me/phone", me_phone_get_558);
app.put("/api/me/phone", me_phone_put_559);
app.delete("/api/me/profile-attachments", me_profile_attachments_delete_560);
app.post("/api/me/profile-attachments", me_profile_attachments_post_561);
app.get("/api/me/profile-attachments/download", me_profile_attachments_download_get_562);
app.get("/api/me/profile-attachments/thumbnail", me_profile_attachments_thumbnail_get_563);
...
app.post("/api/migrate-attendance", migrate_attendance_post_576);
app.post("/api/migrate-company-settings", migrate_company_settings_post_577);
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_578);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_579);
app.post("/api/migrate-emergency-alerts", migrate_emergency_alerts_post_580);
app.post("/api/migrate-estimates", migrate_estimates_post_581);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_582);
app.post("/api/migrate-files", migrate_files_post_583);
app.post("/api/migrate-fleet", migrate_fleet_post_584);
app.post("/api/migrate-fleet-analytics", migrate_fleet_analytics_post_585);
app.post("/api/migrate-fleet-driver-sessions", migrate_fleet_driver_sessions_post_586);
app.post("/api/migrate-fleet-usage", migrate_fleet_usage_post_587);
app.post("/api/migrate-form-fields", migrate_form_fields_post_588);
app.post("/api/migrate-form-logic", migrate_form_logic_post_589);
app.post("/api/migrate-form-templates", migrate_form_templates_post_590);
app.post("/api/migrate-job-forms", migrate_job_forms_post_591);
app.post("/api/migrate-job-photo-shares", migrate_job_photo_shares_post_592);
app.post("/api/migrate-job-photos", migrate_job_photos_post_593);
app.post("/api/migrate-job-tabs", migrate_job_tabs_post_594);
app.post("/api/migrate-jobs", migrate_jobs_post_595);
app.post("/api/migrate-ledger-photo", migrate_ledger_photo_post_596);
app.post("/api/migrate-library", migrate_library_post_597);
app.post("/api/migrate-library-downloads", migrate_library_downloads_post_598);
app.post("/api/migrate-notifications", migrate_notifications_post_599);
app.post("/api/migrate-owner-console", migrate_owner_console_post_600);
app.post("/api/migrate-owner-role", migrate_owner_role_post_601);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_602);
app.post("/api/migrate-photo-gps", migrate_photo_gps_post_603);
app.post("/api/migrate-plan-manager", migrate_plan_manager_post_604);
app.post("/api/migrate-plan-manager-v2", migrate_plan_manager_v2_post_605);
app.post("/api/migrate-plan-manager-v3", migrate_plan_manager_v3_post_606);
app.post("/api/migrate-safety", migrate_safety_post_607);
app.post("/api/migrate-safety-studio", migrate_safety_studio_post_608);
app.post("/api/migrate-site-prestart", migrate_site_prestart_post_609);
app.post("/api/migrate-sms-verified-at", migrate_sms_verified_at_post_610);
app.post("/api/migrate-starter-pack", migrate_starter_pack_post_611);
app.post("/api/migrate-studio-pdf", migrate_studio_pdf_post_612);
app.post("/api/migrate-studio-phase2", migrate_studio_phase2_post_613);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_614);
app.post("/api/migrate-support-mode", migrate_support_mode_post_615);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_616);
app.post("/api/migrate-team", migrate_team_post_617);
app.get("/api/notes", notes_get_618);
app.post("/api/notes", notes_post_619);
app.post("/api/notes/comments", notes_comments_post_620);
app.post("/api/notes/migrate", notes_migrate_post_621);
app.delete("/api/notes/:id", notes_id_delete_622);
app.get("/api/notifications/alerts", notifications_alerts_get_623);
app.get("/api/notifications/prefs", notifications_prefs_get_624);
app.put("/api/notifications/prefs", notifications_prefs_put_625);
app.post("/api/notifications/read", notifications_read_post_626);
app.get("/api/owner-console/activity", owner_console_activity_get_627);
app.get("/api/owner-console/cancellation-feedback", owner_console_cancellation_feedback_get_628);
app.get("/api/owner-console/companies", owner_console_companies_get_629);
app.post("/api/owner-console/companies", owner_console_companies_post_630);
app.get("/api/owner-console/companies/usage", owner_console_companies_usage_get_631);
app.put("/api/owner-console/companies/:id/limits", owner_console_companies_id_limits_put_632);
app.get("/api/owner-console/form-templates", owner_console_form_templates_get_633);
app.post("/api/owner-console/form-templates", owner_console_form_templates_post_634);
app.get("/api/owner-console/library/items", owner_console_library_items_get_635);
app.post("/api/owner-console/library/items", owner_console_library_items_post_636);
app.post("/api/owner-console/library/items/from-template", owner_console_library_items_from_template_post_637);
app.delete("/api/owner-console/library/items/:id", owner_console_library_items_id_delete_638);
app.patch("/api/owner-console/library/items/:id", owner_console_library_items_id_patch_639);
app.put("/api/owner-console/library/items/:id", owner_console_library_items_id_put_640);
app.post("/api/owner-console/library/items/:id/push-update", owner_console_library_items_id_push_update_post_641);
app.get("/api/owner-console/library/submissions", owner_console_library_submissions_get_642);
app.post("/api/owner-console/library/submissions/:id/review", owner_console_library_submissions_id_review_post_643);
app.get("/api/owner-console/starter-pack", owner_console_starter_pack_get_644);
app.post("/api/owner-console/starter-pack", owner_console_starter_pack_post_645);
app.get("/api/owner-console/stats", owner_console_stats_get_646);
app.get("/api/owner-console/storage", owner_console_storage_get_647);
app.get("/api/owner-console/swms/masters", owner_console_swms_masters_get_648);
app.post("/api/owner-console/swms/masters", owner_console_swms_masters_post_649);
app.post("/api/owner-console/swms/masters/publish-all", owner_console_swms_masters_publish_all_post_650);
app.delete("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_delete_651);
app.get("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_get_652);
app.put("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_put_653);
app.post("/api/owner-console/swms/masters/:id/publish", owner_console_swms_masters_id_publish_post_654);
app.post("/api/owner-console/swms/migrate-master-library", owner_console_swms_migrate_master_library_post_655);
app.post("/api/owner-console/swms/push", owner_console_swms_push_post_656);
app.post("/api/owner-console/swms/seed-bricklaying", owner_console_swms_seed_bricklaying_post_657);
app.post("/api/owner-console/swms/seed-building-inspection", owner_console_swms_seed_building_inspection_post_658);
app.post("/api/owner-console/swms/seed-cabinets", owner_console_swms_seed_cabinets_post_659);
app.post("/api/owner-console/swms/seed-carpenter-fixing", owner_console_swms_seed_carpenter_fixing_post_660);
app.post("/api/owner-console/swms/seed-carpenter-framing", owner_console_swms_seed_carpenter_framing_post_661);
app.post("/api/owner-console/swms/seed-carpenter-lockup", owner_console_swms_seed_carpenter_lockup_post_662);
app.post("/api/owner-console/swms/seed-ceramic-tiling", owner_console_swms_seed_ceramic_tiling_post_663);
app.post("/api/owner-console/swms/seed-concreting-slab", owner_console_swms_seed_concreting_slab_post_664);
app.post("/api/owner-console/swms/seed-delivery-loading", owner_console_swms_seed_delivery_loading_post_665);
app.post("/api/owner-console/swms/seed-environmental-spill", owner_console_swms_seed_environmental_spill_post_666);
app.post("/api/owner-console/swms/seed-ewp", owner_console_swms_seed_ewp_post_667);
app.post("/api/owner-console/swms/seed-excavations-substation", owner_console_swms_seed_excavations_substation_post_668);
app.post("/api/owner-console/swms/seed-fencing", owner_console_swms_seed_fencing_post_669);
app.post("/api/owner-console/swms/seed-heat-stress", owner_console_swms_seed_heat_stress_post_670);
app.post("/api/owner-console/swms/seed-landscaping", owner_console_swms_seed_landscaping_post_671);
app.post("/api/owner-console/swms/seed-live-parts", owner_console_swms_seed_live_parts_post_672);
app.post("/api/owner-console/swms/seed-manual-handling", owner_console_swms_seed_manual_handling_post_673);
app.post("/api/owner-console/swms/seed-moving-plant", owner_console_swms_seed_moving_plant_post_674);
app.post("/api/owner-console/swms/seed-painting", owner_console_swms_seed_painting_post_675);
app.post("/api/owner-console/swms/seed-power-tools", owner_console_swms_seed_power_tools_post_676);
app.post("/api/owner-console/swms/seed-silica-dust", owner_console_swms_seed_silica_dust_post_677);
app.post("/api/owner-console/swms/seed-traffic-management", owner_console_swms_seed_traffic_management_post_678);
app.post("/api/owner-console/swms/seed-underground-services", owner_console_swms_seed_underground_services_post_679);
app.post("/api/owner-console/swms/seed-vacuum-excavation", owner_console_swms_seed_vacuum_excavation_post_680);
...
app.get("/api/plan-manager/drawings/:id", plan_manager_drawings_id_get_687);
app.put("/api/plan-manager/drawings/:id/annotations", plan_manager_drawings_id_annotations_put_688);
app.post("/api/plan-manager/drawings/:id/archive", plan_manager_drawings_id_archive_post_689);
app.delete("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_delete_690);
app.post("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_post_691);
app.get("/api/plan-manager/drawings/:id/pages/:pageNo/annotations", plan_manager_drawings_id_pages_pageNo_annotations_get_692);
app.delete("/api/plan-manager/drawings/:id/permanent", plan_manager_drawings_id_permanent_delete_693);
app.patch("/api/plan-manager/drawings/:id/reorder", plan_manager_drawings_id_reorder_patch_694);
app.post("/api/plan-manager/drawings/:id/restore", plan_manager_drawings_id_restore_post_695);
app.post("/api/plan-manager/drawings/:id/revisions", plan_manager_drawings_id_revisions_post_696);
app.post("/api/plan-manager/drawings/:id/revisions/:revisionId/finalize", plan_manager_drawings_id_revisions_revisionId_finalize_post_697);
app.post("/api/plan-manager/drawings/:id/upload", plan_manager_drawings_id_upload_post_698);
app.get("/api/plan-manager/jobs/:jobId/drawings-zip", plan_manager_jobs_jobId_drawings_zip_get_699);
app.get("/api/plan-manager/jobs-with-drawings", plan_manager_jobs_with_drawings_get_700);
app.post("/api/plan-manager/share", plan_manager_share_post_701);
app.get("/api/plan-manager/share/validate", plan_manager_share_validate_get_702);
app.post("/api/plan-manager/upload", plan_manager_upload_post_703);
app.post("/api/portal/estimates/:id/approve", portal_estimates_id_approve_post_704);
app.post("/api/portal/invite", portal_invite_post_705);
app.post("/api/portal/invoices/:id/pay", portal_invoices_id_pay_post_706);
app.get("/api/portal/jobs", portal_jobs_get_707);
app.get("/api/portal/jobs/:id", portal_jobs_id_get_708);
app.post("/api/portal/migrate", portal_migrate_post_709);
app.post("/api/portal/validate", portal_validate_post_710);
app.get("/api/public/form/:token", public_form_token_get_711);
app.post("/api/public/form/:token/submit", public_form_token_submit_post_712);
app.get("/api/public/job-photos/:token", public_job_photos_token_get_713);
app.get("/api/public/job-photos/:token/photo/:photoId", public_job_photos_token_photo_photoId_get_714);
app.get("/api/public/swms/:token", public_swms_token_get_715);
app.post("/api/public/swms/:token/signoff", public_swms_token_signoff_post_716);
app.get("/api/purchase-orders/:poId/compose-defaults", purchase_orders_poId_compose_defaults_get_717);
app.post("/api/purchase-orders/:poId/send-email", purchase_orders_poId_send_email_post_718);
app.delete("/api/push/subscribe", push_subscribe_delete_719);
app.post("/api/push/subscribe", push_subscribe_post_720);
app.get("/api/push/vapid-key", push_vapid_key_get_721);
app.get("/api/quick-links/site-meta", quick_links_site_meta_get_722);
app.get("/api/recipes", recipes_get_723);
app.post("/api/recipes", recipes_post_724);
app.delete("/api/recipes/:id", recipes_id_delete_725);
app.put("/api/recipes/:id", recipes_id_put_726);
app.get("/api/risk-register", risk_register_get_727);
app.post("/api/risk-register", risk_register_post_728);
app.get("/api/risk-register/:id", risk_register_id_get_729);
app.put("/api/risk-register/:id", risk_register_id_put_730);
app.post("/api/risk-register/:id/archive", risk_register_id_archive_post_731);
app.post("/api/risk-register/:id/unarchive", risk_register_id_unarchive_post_732);
app.get("/api/rl-register", rl_register_get_733);
app.post("/api/rl-register", rl_register_post_734);
app.delete("/api/rl-register/points/:id", rl_register_points_id_delete_735);
app.put("/api/rl-register/points/:id", rl_register_points_id_put_736);
app.get("/api/rl-register/:benchmarkId/points", rl_register_benchmarkId_points_get_737);
app.post("/api/rl-register/:benchmarkId/points", rl_register_benchmarkId_points_post_738);
app.get("/api/rl-register/:jobId/export/csv", rl_register_jobId_export_csv_get_739);
app.get("/api/rl-register/:jobId/export/pdf", rl_register_jobId_export_pdf_get_740);
app.post("/api/safety/ai/draft", safety_ai_draft_post_741);
app.get("/api/safety/documents", safety_documents_get_742);
app.post("/api/safety/documents", safety_documents_post_743);
app.post("/api/safety/documents/new", safety_documents_new_post_744);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_745);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_746);
app.get("/api/safety/generated-posters", safety_generated_posters_get_747);
app.post("/api/safety/generated-posters", safety_generated_posters_post_748);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_749);
app.get("/api/safety/generated-posters/:id/pdf", safety_generated_posters_id_pdf_get_750);
app.get("/api/safety/job-safety-plans", safety_job_safety_plans_get_751);
app.post("/api/safety/job-safety-plans", safety_job_safety_plans_post_752);
app.delete("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_delete_753);
app.put("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_put_754);
app.get("/api/safety/job-swms", safety_job_swms_get_755);
app.post("/api/safety/job-swms", safety_job_swms_post_756);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_757);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_758);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_759);
app.post("/api/safety/job-swms/:id/share-token", safety_job_swms_id_share_token_post_760);
app.get("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_get_761);
app.post("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_post_762);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", safety_job_swms_id_signoffs_signoffId_delete_763);
app.get("/api/safety/plans", safety_plans_get_764);
app.post("/api/safety/plans", safety_plans_post_765);
app.post("/api/safety/plans/seed", safety_plans_seed_post_766);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_767);
app.put("/api/safety/plans/:id", safety_plans_id_put_768);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_769);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_770);
app.get("/api/safety/posters", safety_posters_get_771);
app.post("/api/safety/posters", safety_posters_post_772);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_773);
app.get("/api/safety/posters/:id/download", safety_posters_id_download_get_774);
app.get("/api/safety/swms", safety_swms_get_775);
app.post("/api/safety/swms", safety_swms_post_776);
app.post("/api/safety/swms/import-docx", safety_swms_import_docx_post_777);
app.post("/api/safety/swms/seed", safety_swms_seed_post_778);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_779);
app.get("/api/safety/swms/:id", safety_swms_id_get_780);
app.put("/api/safety/swms/:id", safety_swms_id_put_781);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_782);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_783);
app.post("/api/safety/swms/:id/publish-to-library", safety_swms_id_publish_to_library_post_784);
app.get("/api/safety/swms-submissions", safety_swms_submissions_get_785);
app.get("/api/scheduler/crew", scheduler_crew_get_786);
app.get("/api/scheduler/jobs", scheduler_jobs_get_787);
app.patch("/api/scheduler/jobs/:id/reschedule", scheduler_jobs_id_reschedule_patch_788);
app.get("/api/scheduler/tasks", scheduler_tasks_get_789);
app.get("/api/sds-register", sds_register_get_790);
app.post("/api/sds-register", sds_register_post_791);
app.delete("/api/sds-register/:id", sds_register_id_delete_792);
app.put("/api/sds-register/:id", sds_register_id_put_793);
app.get("/api/sds-register/:id/download", sds_register_id_download_get_794);
app.post("/api/sds-register/:id/replace", sds_register_id_replace_post_795);
app.get("/api/secure-share", secure_share_get_796);
app.post("/api/secure-share", secure_share_post_797);
app.get("/api/secure-share/active", secure_share_active_get_798);
app.delete("/api/secure-share/:id", secure_share_id_delete_799);
app.post("/api/secure-share/:id/revoke-and-rotate", secure_share_id_revoke_and_rotate_post_800);
app.get("/api/secure-share/:token", secure_share_token_get_801);
app.post("/api/secure-share/:token", secure_share_token_post_802);
app.get("/api/secure-share/:token/content", secure_share_token_content_get_803);
app.get("/api/settings/backup", settings_backup_get_804);
app.post("/api/settings/backup", settings_backup_post_805);
app.get("/api/settings/backup/company-data", settings_backup_company_data_get_806);
app.get("/api/settings/backup/csv-pack", settings_backup_csv_pack_get_807);
app.get("/api/settings/backup/export", settings_backup_export_get_808);
app.post("/api/settings/backup/run", settings_backup_run_post_809);
app.get("/api/settings/backup-destination", settings_backup_destination_get_810);
app.post("/api/settings/backup-destination", settings_backup_destination_post_811);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_812);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_813);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_814);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_815);
app.get("/api/settings/retention", settings_retention_get_816);
app.post("/api/settings/retention", settings_retention_post_817);
app.get("/api/settings/storage-provider", settings_storage_provider_get_818);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_819);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_820);
app.get("/api/settings/terminology", settings_terminology_get_821);
app.post("/api/settings/terminology", settings_terminology_post_822);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_823);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_824);
app.get("/api/share/:token", share_token_get_825);
app.get("/api/signin-history", signin_history_get_826);
app.post("/api/signup", signup_post_827);
app.get("/api/sos", sos_get_828);
app.post("/api/sos/acknowledge", sos_acknowledge_post_829);
app.post("/api/sos/trigger", sos_trigger_post_830);
app.post("/api/stakeholders/sms", stakeholders_sms_post_831);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_832);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_833);
app.post("/api/studio/generate-from-safety", studio_generate_from_safety_post_834);
app.post("/api/studio/upload-image", studio_upload_image_post_835);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_836);
app.get("/api/subscription/status", subscription_status_get_837);
app.post("/api/subscription/webhook", subscription_webhook_post_838);
app.get("/api/support-mode/audit", support_mode_audit_get_839);
app.get("/api/support-mode/checklist", support_mode_checklist_get_840);
app.put("/api/support-mode/checklist", support_mode_checklist_put_841);
app.post("/api/support-mode/enter", support_mode_enter_post_842);
app.post("/api/support-mode/exit", support_mode_exit_post_843);
app.get("/api/support-mode/status", support_mode_status_get_844);
app.get("/api/tag-tasks", tag_tasks_get_845);
app.patch("/api/tag-tasks/:id", tag_tasks_id_patch_846);
app.get("/api/takeoff-pad", takeoff_pad_get_847);
app.put("/api/takeoff-pad", takeoff_pad_put_848);
app.post("/api/tasks", tasks_post_849);
app.put("/api/tasks/:id", tasks_id_put_850);
app.get("/api/team", team_get_851);
app.post("/api/team/invite", team_invite_post_852);
app.get("/api/team/invites", team_invites_get_853);
app.post("/api/team/invites", team_invites_post_854);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_855);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_856);
app.get("/api/team/members", team_members_get_857);
app.get("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_get_858);
app.put("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_put_859);
app.post("/api/team/resend-verification", team_resend_verification_post_860);
app.post("/api/team/schedule/migrate", team_schedule_migrate_post_861);
app.get("/api/team/shifts", team_shifts_get_862);
app.post("/api/team/shifts", team_shifts_post_863);
app.delete("/api/team/shifts/:id", team_shifts_id_delete_864);
app.put("/api/team/shifts/:id", team_shifts_id_put_865);
app.get("/api/team/time-entries", team_time_entries_get_866);
app.post("/api/team/time-entries", team_time_entries_post_867);
app.get("/api/team/time-entries/export", team_time_entries_export_get_868);
app.put("/api/team/time-entries/:id", team_time_entries_id_put_869);
app.post("/api/team/verify-user", team_verify_user_post_870);
app.delete("/api/team/:id", team_id_delete_871);
app.put("/api/team/:id", team_id_put_872);
app.get("/api/usage", usage_get_873);
app.get("/api/user-logs", user_logs_get_874);
app.get("/api/user-logs/users", user_logs_users_get_875);
app.get("/api/work/attendance", work_attendance_get_876);
app.get("/api/work/delays", work_delays_get_877);
app.get("/api/work/notes", work_notes_get_878);
app.get("/api/work/progress", work_progress_get_879);
app.get("/api/work/tasks", work_tasks_get_880);
// </api-registrations>
