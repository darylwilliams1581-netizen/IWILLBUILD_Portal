...
import owner_console_companies_post from "./api/owner-console/companies/POST";
import owner_console_stats_get_104 from "./api/owner-console/stats/GET";
import owner_console_users_get_105 from "./api/owner-console/users/GET";
import recipes_get_106 from "./api/recipes/GET";
import recipes_post_107 from "./api/recipes/POST";
import recipes_id_delete_108 from "./api/recipes/[id]/DELETE";
import recipes_id_put_109 from "./api/recipes/[id]/PUT";
import signup_post_110 from "./api/signup/POST";
import stripe_create_checkout_session_post_111 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_112 from "./api/stripe/session/[sessionId]/GET";
import subscription_status_get_113 from "./api/subscription/status/GET";
import subscription_create_checkout_post from "./api/subscription/create-checkout/POST";
import subscription_webhook_post from "./api/subscription/webhook/POST";
import support_mode_audit_get_114 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_115 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_116 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_117 from "./api/support-mode/enter/POST";
import support_mode_exit_post_118 from "./api/support-mode/exit/POST";
import support_mode_status_get_119 from "./api/support-mode/status/GET";
import takeoff_pad_get_120 from "./api/takeoff-pad/GET";
import takeoff_pad_put_121 from "./api/takeoff-pad/PUT";
import team_get_122 from "./api/team/GET";
import team_invite_post_123 from "./api/team/invite/POST";
import team_id_delete_124 from "./api/team/[id]/DELETE";
import team_id_put_125 from "./api/team/[id]/PUT";
// </api-imports>
...
app.post("/api/owner-console/companies", owner_console_companies_post);
app.get("/api/owner-console/stats", owner_console_stats_get_104);
app.get("/api/owner-console/users", owner_console_users_get_105);
app.get("/api/recipes", recipes_get_106);
app.post("/api/recipes", recipes_post_107);
app.delete("/api/recipes/:id", recipes_id_delete_108);
app.put("/api/recipes/:id", recipes_id_put_109);
app.post("/api/signup", signup_post_110);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_111);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_112);
app.get("/api/subscription/status", subscription_status_get_113);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post);
// Webhook needs raw body — registered before json middleware applies
app.post("/api/subscription/webhook", express.raw({ type: 'application/json' }), subscription_webhook_post);
app.get("/api/support-mode/audit", support_mode_audit_get_114);
app.get("/api/support-mode/checklist", support_mode_checklist_get_115);
app.put("/api/support-mode/checklist", support_mode_checklist_put_116);
app.post("/api/support-mode/enter", support_mode_enter_post_117);
app.post("/api/support-mode/exit", support_mode_exit_post_118);
app.get("/api/support-mode/status", support_mode_status_get_119);
app.get("/api/takeoff-pad", takeoff_pad_get_120);
app.put("/api/takeoff-pad", takeoff_pad_put_121);
app.get("/api/team", team_get_122);
app.post("/api/team/invite", team_invite_post_123);
app.delete("/api/team/:id", team_id_delete_124);
app.put("/api/team/:id", team_id_put_125);
// </api-registrations>
