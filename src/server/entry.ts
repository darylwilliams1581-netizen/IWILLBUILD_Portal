...
import form_templates_seed_post_187 from "./api/form-templates/seed/POST";
...
import jobs_id_ledger_sync_post_264 from "./api/jobs/[id]/ledger/sync/POST";
...
import jobs_id_purchase_orders_get_277 from "./api/jobs/[id]/purchase-orders/GET";
import jobs_id_purchase_orders_post_278 from "./api/jobs/[id]/purchase-orders/POST";
import jobs_id_purchase_orders_poId_delete_279 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import jobs_id_purchase_orders_poId_get_280 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
import jobs_id_purchase_orders_poId_put_281 from "./api/jobs/[id]/purchase-orders/[poId]/PUT";
import jobs_id_purchase_orders_poId_pdf_get_282 from "./api/jobs/[id]/purchase-orders/[poId]/pdf/GET";
...
import migrate_account_recovery_post_313 from "./api/migrate-account-recovery/POST";
import migrate_asset_manager_post_314 from "./api/migrate-asset-manager/POST";
import migrate_attendance_post_315 from "./api/migrate-attendance/POST";
import migrate_company_settings_post_316 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_317 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_318 from "./api/migrate-dazza-knowledge/POST";
import migrate_emergency_alerts_post_319 from "./api/migrate-emergency-alerts/POST";
import migrate_estimates_post_320 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_321 from "./api/migrate-estimating-library/POST";
import migrate_files_post_322 from "./api/migrate-files/POST";
import migrate_fleet_post_323 from "./api/migrate-fleet/POST";
import migrate_fleet_analytics_post_324 from "./api/migrate-fleet-analytics/POST";
import migrate_fleet_driver_sessions_post_325 from "./api/migrate-fleet-driver-sessions/POST";
import migrate_fleet_usage_post_326 from "./api/migrate-fleet-usage/POST";
import migrate_form_fields_post_327 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_328 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_329 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_330 from "./api/migrate-job-forms/POST";
import migrate_job_photos_post_331 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_332 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_333 from "./api/migrate-jobs/POST";
import migrate_library_post_334 from "./api/migrate-library/POST";
import migrate_library_downloads_post_335 from "./api/migrate-library-downloads/POST";
import migrate_notifications_post_336 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_337 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_338 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_339 from "./api/migrate-pdf-settings/POST";
import migrate_plan_manager_post_340 from "./api/migrate-plan-manager/POST";
import migrate_plan_manager_v2_post_341 from "./api/migrate-plan-manager-v2/POST";
import migrate_plan_manager_v3_post_342 from "./api/migrate-plan-manager-v3/POST";
import migrate_safety_post_343 from "./api/migrate-safety/POST";
import migrate_starter_pack_post_344 from "./api/migrate-starter-pack/POST";
import migrate_studio_pdf_post_345 from "./api/migrate-studio-pdf/POST";
import migrate_subscriptions_post_346 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_347 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_348 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_349 from "./api/migrate-team/POST";
...
import notifications_alerts_get_354 from "./api/notifications/alerts/GET";
...
import owner_console_system_ai_builtin_checks_post_375 from "./api/owner-console/system-ai/builtin-checks/POST";
...
app.post("/api/form-templates/seed", form_templates_seed_post_187);
...
app.post("/api/jobs/:id/ledger/sync", jobs_id_ledger_sync_post_264);
...
app.get("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_get_277);
app.post("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_post_278);
app.delete("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_delete_279);
app.get("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_get_280);
app.put("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_put_281);
app.get("/api/jobs/:id/purchase-orders/:poId/pdf", jobs_id_purchase_orders_poId_pdf_get_282);
...
app.post("/api/migrate-account-recovery", migrate_account_recovery_post_313);
app.post("/api/migrate-asset-manager", migrate_asset_manager_post_314);
app.post("/api/migrate-attendance", migrate_attendance_post_315);
app.post("/api/migrate-company-settings", migrate_company_settings_post_316);
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_317);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_318);
app.post("/api/migrate-emergency-alerts", migrate_emergency_alerts_post_319);
app.post("/api/migrate-estimates", migrate_estimates_post_320);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_321);
app.post("/api/migrate-files", migrate_files_post_322);
app.post("/api/migrate-fleet", migrate_fleet_post_323);
app.post("/api/migrate-fleet-analytics", migrate_fleet_analytics_post_324);
app.post("/api/migrate-fleet-driver-sessions", migrate_fleet_driver_sessions_post_325);
app.post("/api/migrate-fleet-usage", migrate_fleet_usage_post_326);
app.post("/api/migrate-form-fields", migrate_form_fields_post_327);
app.post("/api/migrate-form-logic", migrate_form_logic_post_328);
app.post("/api/migrate-form-templates", migrate_form_templates_post_329);
app.post("/api/migrate-job-forms", migrate_job_forms_post_330);
app.post("/api/migrate-job-photos", migrate_job_photos_post_331);
app.post("/api/migrate-job-tabs", migrate_job_tabs_post_332);
app.post("/api/migrate-jobs", migrate_jobs_post_333);
app.post("/api/migrate-library", migrate_library_post_334);
app.post("/api/migrate-library-downloads", migrate_library_downloads_post_335);
app.post("/api/migrate-notifications", migrate_notifications_post_336);
app.post("/api/migrate-owner-console", migrate_owner_console_post_337);
app.post("/api/migrate-owner-role", migrate_owner_role_post_338);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_339);
app.post("/api/migrate-plan-manager", migrate_plan_manager_post_340);
app.post("/api/migrate-plan-manager-v2", migrate_plan_manager_v2_post_341);
app.post("/api/migrate-plan-manager-v3", migrate_plan_manager_v3_post_342);
app.post("/api/migrate-safety", migrate_safety_post_343);
app.post("/api/migrate-starter-pack", migrate_starter_pack_post_344);
app.post("/api/migrate-studio-pdf", migrate_studio_pdf_post_345);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_346);
app.post("/api/migrate-support-mode", migrate_support_mode_post_347);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_348);
app.post("/api/migrate-team", migrate_team_post_349);
...
app.get("/api/notifications/alerts", notifications_alerts_get_354);
...
app.post("/api/owner-console/system-ai/builtin-checks", owner_console_system_ai_builtin_checks_post_375);
