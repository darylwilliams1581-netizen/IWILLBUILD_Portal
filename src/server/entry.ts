...
import secure_share_token_get_592 from "./api/secure-share/[token]/GET";
import secure_share_token_post_593 from "./api/secure-share/[token]/POST";
import settings_backup_get_594 from "./api/settings/backup/GET";
import settings_backup_post_595 from "./api/settings/backup/POST";
import settings_backup_export_get_596 from "./api/settings/backup/export/GET";
import settings_backup_run_post_597 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_598 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_599 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_600 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_601 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_602 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_603 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_604 from "./api/settings/retention/GET";
import settings_retention_post_605 from "./api/settings/retention/POST";
import settings_storage_provider_get_606 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_607 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_608 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_609 from "./api/settings/terminology/GET";
import settings_terminology_post_610 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_611 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_612 from "./api/settings/xero-credentials/POST";
import share_token_get_613 from "./api/share/[token]/GET";
import signin_history_get_614 from "./api/signin-history/GET";
import signup_post_615 from "./api/signup/POST";
import sos_get_616 from "./api/sos/GET";
import sos_acknowledge_post_617 from "./api/sos/acknowledge/POST";
import sos_trigger_post_618 from "./api/sos/trigger/POST";
import stakeholders_sms_post_619 from "./api/stakeholders/sms/POST";
import stripe_create_checkout_session_post_620 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_621 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_622 from "./api/subscription/create-checkout/POST";
import subscription_status_get_623 from "./api/subscription/status/GET";
import subscription_webhook_post_624 from "./api/subscription/webhook/POST";
import support_mode_audit_get_625 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_626 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_627 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_628 from "./api/support-mode/enter/POST";
import support_mode_exit_post_629 from "./api/support-mode/exit/POST";
import support_mode_status_get_630 from "./api/support-mode/status/GET";
import tag_tasks_get_631 from "./api/tag-tasks/GET";
import tag_tasks_id_patch_632 from "./api/tag-tasks/[id]/PATCH";
import takeoff_pad_get_633 from "./api/takeoff-pad/GET";
import takeoff_pad_put_634 from "./api/takeoff-pad/PUT";
import team_get_635 from "./api/team/GET";
import team_invite_post_636 from "./api/team/invite/POST";
import team_invites_get_637 from "./api/team/invites/GET";
import team_invites_post_638 from "./api/team/invites/POST";
import team_invites_id_cancel_post_639 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_640 from "./api/team/invites/[id]/resend/POST";
import team_members_get_641 from "./api/team/members/GET";
import team_members_id_icon_permissions_get_642 from "./api/team/members/[id]/icon-permissions/GET";
import team_members_id_icon_permissions_put_643 from "./api/team/members/[id]/icon-permissions/PUT";
import team_resend_verification_post_644 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_645 from "./api/team/schedule/migrate/POST";
import team_shifts_get_646 from "./api/team/shifts/GET";
import team_shifts_post_647 from "./api/team/shifts/POST";
import team_shifts_id_delete_648 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_649 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_650 from "./api/team/time-entries/GET";
import team_time_entries_post_651 from "./api/team/time-entries/POST";
import team_time_entries_export_get_652 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_653 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_654 from "./api/team/verify-user/POST";
import team_id_delete_655 from "./api/team/[id]/DELETE";
import team_id_put_656 from "./api/team/[id]/PUT";
import usage_get_657 from "./api/usage/GET";
// </api-imports>
...
app.get("/api/secure-share/:token", secure_share_token_get_592);
app.post("/api/secure-share/:token", secure_share_token_post_593);
app.get("/api/settings/backup", settings_backup_get_594);
app.post("/api/settings/backup", settings_backup_post_595);
app.get("/api/settings/backup/export", settings_backup_export_get_596);
app.post("/api/settings/backup/run", settings_backup_run_post_597);
app.get("/api/settings/backup-destination", settings_backup_destination_get_598);
app.post("/api/settings/backup-destination", settings_backup_destination_post_599);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_600);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_601);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_602);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_603);
app.get("/api/settings/retention", settings_retention_get_604);
app.post("/api/settings/retention", settings_retention_post_605);
app.get("/api/settings/storage-provider", settings_storage_provider_get_606);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_607);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_608);
app.get("/api/settings/terminology", settings_terminology_get_609);
app.post("/api/settings/terminology", settings_terminology_post_610);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_611);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_612);
app.get("/api/share/:token", share_token_get_613);
app.get("/api/signin-history", signin_history_get_614);
app.post("/api/signup", signup_post_615);
app.get("/api/sos", sos_get_616);
app.post("/api/sos/acknowledge", sos_acknowledge_post_617);
app.post("/api/sos/trigger", sos_trigger_post_618);
app.post("/api/stakeholders/sms", stakeholders_sms_post_619);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_620);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_621);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_622);
app.get("/api/subscription/status", subscription_status_get_623);
app.post("/api/subscription/webhook", subscription_webhook_post_624);
app.get("/api/support-mode/audit", support_mode_audit_get_625);
app.get("/api/support-mode/checklist", support_mode_checklist_get_626);
app.put("/api/support-mode/checklist", support_mode_checklist_put_627);
app.post("/api/support-mode/enter", support_mode_enter_post_628);
app.post("/api/support-mode/exit", support_mode_exit_post_629);
app.get("/api/support-mode/status", support_mode_status_get_630);
app.get("/api/tag-tasks", tag_tasks_get_631);
app.patch("/api/tag-tasks/:id", tag_tasks_id_patch_632);
app.get("/api/takeoff-pad", takeoff_pad_get_633);
app.put("/api/takeoff-pad", takeoff_pad_put_634);
app.get("/api/team", team_get_635);
app.post("/api/team/invite", team_invite_post_636);
app.get("/api/team/invites", team_invites_get_637);
app.post("/api/team/invites", team_invites_post_638);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_639);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_640);
app.get("/api/team/members", team_members_get_641);
app.get("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_get_642);
app.put("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_put_643);
app.post("/api/team/resend-verification", team_resend_verification_post_644);
app.post("/api/team/schedule/migrate", team_schedule_migrate_post_645);
app.get("/api/team/shifts", team_shifts_get_646);
app.post("/api/team/shifts", team_shifts_post_647);
app.delete("/api/team/shifts/:id", team_shifts_id_delete_648);
app.put("/api/team/shifts/:id", team_shifts_id_put_649);
app.get("/api/team/time-entries", team_time_entries_get_650);
app.post("/api/team/time-entries", team_time_entries_post_651);
app.get("/api/team/time-entries/export", team_time_entries_export_get_652);
app.put("/api/team/time-entries/:id", team_time_entries_id_put_653);
app.post("/api/team/verify-user", team_verify_user_post_654);
app.delete("/api/team/:id", team_id_delete_655);
app.put("/api/team/:id", team_id_put_656);
app.get("/api/usage", usage_get_657);
// </api-registrations>
