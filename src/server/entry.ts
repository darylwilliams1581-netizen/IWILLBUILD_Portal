...
import owner_console_form_templates_get_227 from "./api/owner-console/form-templates/GET";
import owner_console_form_templates_post_228 from "./api/owner-console/form-templates/POST";
import owner_console_starter_pack_get_229 from "./api/owner-console/starter-pack/GET";
import owner_console_starter_pack_post_230 from "./api/owner-console/starter-pack/POST";
import owner_console_stats_get_231 from "./api/owner-console/stats/GET";
import owner_console_storage_get_232 from "./api/owner-console/storage/GET";
...
import recipes_id_put_239 from "./api/recipes/[id]/PUT";
import safety_ai_draft_post_240 from "./api/safety/ai/draft/POST";
import safety_documents_get_241 from "./api/safety/documents/GET";
import safety_documents_post_242 from "./api/safety/documents/POST";
import safety_documents_id_delete_243 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_244 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_245 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_246 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_247 from "./api/safety/generated-posters/[id]/DELETE";
import safety_job_safety_plans_get_248 from "./api/safety/job-safety-plans/GET";
import safety_job_safety_plans_post_249 from "./api/safety/job-safety-plans/POST";
import safety_job_safety_plans_id_delete_250 from "./api/safety/job-safety-plans/[id]/DELETE";
import safety_job_safety_plans_id_put_251 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_252 from "./api/safety/job-swms/GET";
import safety_job_swms_post_253 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_254 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_255 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_256 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_signoffs_get_257 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_258 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_259 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_260 from "./api/safety/plans/GET";
import safety_plans_post_261 from "./api/safety/plans/POST";
import safety_plans_seed_post_262 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_263 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_264 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_265 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_266 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_267 from "./api/safety/posters/GET";
import safety_posters_post_268 from "./api/safety/posters/POST";
import safety_posters_id_delete_269 from "./api/safety/posters/[id]/DELETE";
import safety_swms_get_270 from "./api/safety/swms/GET";
import safety_swms_post_271 from "./api/safety/swms/POST";
import safety_swms_seed_post_272 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_273 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_274 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_275 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_276 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_277 from "./api/safety/swms/[id]/export/GET";
import scheduler_jobs_get_278 from "./api/scheduler/jobs/GET";
import secure_share_get_279 from "./api/secure-share/GET";
import secure_share_post_280 from "./api/secure-share/POST";
import secure_share_id_delete_281 from "./api/secure-share/[id]/DELETE";
import secure_share_token_get_282 from "./api/secure-share/[token]/GET";
import secure_share_token_post_283 from "./api/secure-share/[token]/POST";
import settings_backup_get_284 from "./api/settings/backup/GET";
import settings_backup_post_285 from "./api/settings/backup/POST";
import settings_backup_export_get_286 from "./api/settings/backup/export/GET";
import settings_backup_run_post_287 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_288 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_289 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_290 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_291 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_292 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_293 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_294 from "./api/settings/retention/GET";
import settings_retention_post_295 from "./api/settings/retention/POST";
import settings_storage_provider_get_296 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_297 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_298 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_299 from "./api/settings/terminology/GET";
import settings_terminology_post_300 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_301 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_302 from "./api/settings/xero-credentials/POST";
import share_token_get_303 from "./api/share/[token]/GET";
import signup_post_304 from "./api/signup/POST";
import stripe_create_checkout_session_post_305 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_306 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_307 from "./api/subscription/create-checkout/POST";
import subscription_status_get_308 from "./api/subscription/status/GET";
import subscription_webhook_post_309 from "./api/subscription/webhook/POST";
import support_mode_audit_get_310 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_311 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_312 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_313 from "./api/support-mode/enter/POST";
import support_mode_exit_post_314 from "./api/support-mode/exit/POST";
import support_mode_status_get_315 from "./api/support-mode/status/GET";
import takeoff_pad_get_316 from "./api/takeoff-pad/GET";
import takeoff_pad_put_317 from "./api/takeoff-pad/PUT";
import team_get_318 from "./api/team/GET";
import team_invite_post_319 from "./api/team/invite/POST";
import team_members_get_320 from "./api/team/members/GET";
import team_resend_verification_post_321 from "./api/team/resend-verification/POST";
import team_verify_user_post_322 from "./api/team/verify-user/POST";
import team_id_delete_323 from "./api/team/[id]/DELETE";
import team_id_put_324 from "./api/team/[id]/PUT";
import usage_get_325 from "./api/usage/GET";
// </api-imports>
...
app.get("/api/owner-console/form-templates", owner_console_form_templates_get_227);
app.post("/api/owner-console/form-templates", owner_console_form_templates_post_228);
app.get("/api/owner-console/starter-pack", owner_console_starter_pack_get_229);
app.post("/api/owner-console/starter-pack", owner_console_starter_pack_post_230);
app.get("/api/owner-console/stats", owner_console_stats_get_231);
app.get("/api/owner-console/storage", owner_console_storage_get_232);
...
app.put("/api/recipes/:id", recipes_id_put_239);
app.post("/api/safety/ai/draft", safety_ai_draft_post_240);
app.get("/api/safety/documents", safety_documents_get_241);
app.post("/api/safety/documents", safety_documents_post_242);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_243);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_244);
app.get("/api/safety/generated-posters", safety_generated_posters_get_245);
app.post("/api/safety/generated-posters", safety_generated_posters_post_246);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_247);
app.get("/api/safety/job-safety-plans", safety_job_safety_plans_get_248);
app.post("/api/safety/job-safety-plans", safety_job_safety_plans_post_249);
app.delete("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_delete_250);
app.put("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_put_251);
app.get("/api/safety/job-swms", safety_job_swms_get_252);
app.post("/api/safety/job-swms", safety_job_swms_post_253);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_254);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_255);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_256);
app.get("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_get_257);
app.post("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_post_258);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", safety_job_swms_id_signoffs_signoffId_delete_259);
app.get("/api/safety/plans", safety_plans_get_260);
app.post("/api/safety/plans", safety_plans_post_261);
app.post("/api/safety/plans/seed", safety_plans_seed_post_262);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_263);
app.put("/api/safety/plans/:id", safety_plans_id_put_264);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_265);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_266);
app.get("/api/safety/posters", safety_posters_get_267);
app.post("/api/safety/posters", safety_posters_post_268);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_269);
app.get("/api/safety/swms", safety_swms_get_270);
app.post("/api/safety/swms", safety_swms_post_271);
app.post("/api/safety/swms/seed", safety_swms_seed_post_272);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_273);
app.get("/api/safety/swms/:id", safety_swms_id_get_274);
app.put("/api/safety/swms/:id", safety_swms_id_put_275);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_276);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_277);
app.get("/api/scheduler/jobs", scheduler_jobs_get_278);
app.get("/api/secure-share", secure_share_get_279);
app.post("/api/secure-share", secure_share_post_280);
app.delete("/api/secure-share/:id", secure_share_id_delete_281);
app.get("/api/secure-share/:token", secure_share_token_get_282);
app.post("/api/secure-share/:token", secure_share_token_post_283);
app.get("/api/settings/backup", settings_backup_get_284);
app.post("/api/settings/backup", settings_backup_post_285);
app.get("/api/settings/backup/export", settings_backup_export_get_286);
app.post("/api/settings/backup/run", settings_backup_run_post_287);
app.get("/api/settings/backup-destination", settings_backup_destination_get_288);
app.post("/api/settings/backup-destination", settings_backup_destination_post_289);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_290);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_291);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_292);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_293);
app.get("/api/settings/retention", settings_retention_get_294);
app.post("/api/settings/retention", settings_retention_post_295);
app.get("/api/settings/storage-provider", settings_storage_provider_get_296);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_297);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_298);
app.get("/api/settings/terminology", settings_terminology_get_299);
app.post("/api/settings/terminology", settings_terminology_post_300);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_301);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_302);
app.get("/api/share/:token", share_token_get_303);
app.post("/api/signup", signup_post_304);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_305);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_306);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_307);
app.get("/api/subscription/status", subscription_status_get_308);
app.post("/api/subscription/webhook", subscription_webhook_post_309);
app.get("/api/support-mode/audit", support_mode_audit_get_310);
app.get("/api/support-mode/checklist", support_mode_checklist_get_311);
app.put("/api/support-mode/checklist", support_mode_checklist_put_312);
app.post("/api/support-mode/enter", support_mode_enter_post_313);
app.post("/api/support-mode/exit", support_mode_exit_post_314);
app.get("/api/support-mode/status", support_mode_status_get_315);
app.get("/api/takeoff-pad", takeoff_pad_get_316);
app.put("/api/takeoff-pad", takeoff_pad_put_317);
app.get("/api/team", team_get_318);
app.post("/api/team/invite", team_invite_post_319);
app.get("/api/team/members", team_members_get_320);
app.post("/api/team/resend-verification", team_resend_verification_post_321);
app.post("/api/team/verify-user", team_verify_user_post_322);
app.delete("/api/team/:id", team_id_delete_323);
app.put("/api/team/:id", team_id_put_324);
app.get("/api/usage", usage_get_325);
// </api-registrations>
