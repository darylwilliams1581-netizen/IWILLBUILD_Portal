...
import jobs_id_ledger_sync_post_315 from "./api/jobs/[id]/ledger/sync/POST";
...
import jobs_id_purchase_orders_get_339 from "./api/jobs/[id]/purchase-orders/GET";
import jobs_id_purchase_orders_post_340 from "./api/jobs/[id]/purchase-orders/POST";
import jobs_id_purchase_orders_poId_delete_341 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import jobs_id_purchase_orders_poId_get_342 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
...
import migrate_account_recovery_post_395 from "./api/migrate-account-recovery/POST";
import migrate_asset_manager_post_396 from "./api/migrate-asset-manager/POST";
import migrate_attendance_post_397 from "./api/migrate-attendance/POST";
import migrate_company_settings_post_398 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_399 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_400 from "./api/migrate-dazza-knowledge/POST";
import migrate_emergency_alerts_post_401 from "./api/migrate-emergency-alerts/POST";
import migrate_estimates_post_402 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_403 from "./api/migrate-estimating-library/POST";
import migrate_files_post_404 from "./api/migrate-files/POST";
import migrate_fleet_post_405 from "./api/migrate-fleet/POST";
import migrate_fleet_analytics_post_406 from "./api/migrate-fleet-analytics/POST";
import migrate_fleet_driver_sessions_post_407 from "./api/migrate-fleet-driver-sessions/POST";
import migrate_fleet_usage_post_408 from "./api/migrate-fleet-usage/POST";
import migrate_form_fields_post_409 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_410 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_411 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_412 from "./api/migrate-job-forms/POST";
import migrate_job_photo_shares_post_413 from "./api/migrate-job-photo-shares/POST";
import migrate_job_photos_post_414 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_415 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_416 from "./api/migrate-jobs/POST";
import migrate_ledger_photo_post_417 from "./api/migrate-ledger-photo/POST";
import migrate_library_post_418 from "./api/migrate-library/POST";
import migrate_library_downloads_post_419 from "./api/migrate-library-downloads/POST";
import migrate_notifications_post_420 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_421 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_422 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_423 from "./api/migrate-pdf-settings/POST";
import migrate_plan_manager_post_424 from "./api/migrate-plan-manager/POST";
import migrate_plan_manager_v2_post_425 from "./api/migrate-plan-manager-v2/POST";
import migrate_plan_manager_v3_post_426 from "./api/migrate-plan-manager-v3/POST";
import migrate_safety_post_427 from "./api/migrate-safety/POST";
import migrate_site_prestart_post_428 from "./api/migrate-site-prestart/POST";
import migrate_starter_pack_post_429 from "./api/migrate-starter-pack/POST";
import migrate_studio_pdf_post_430 from "./api/migrate-studio-pdf/POST";
import migrate_subscriptions_post_431 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_432 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_433 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_434 from "./api/migrate-team/POST";
...
import notifications_alerts_get_439 from "./api/notifications/alerts/GET";
...
import owner_console_system_ai_builtin_checks_post_496 from "./api/owner-console/system-ai/builtin-checks/POST";
...
app.post("/api/jobs/:id/ledger/sync", jobs_id_ledger_sync_post_315);
...
app.get("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_get_339);
app.post("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_post_340);
app.delete("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_delete_341);
app.get("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_get_342);
...
app.post("/api/migrate-account-recovery", migrate_account_recovery_post_395);
app.post("/api/migrate-asset-manager", migrate_asset_manager_post_396);
app.post("/api/migrate-attendance", migrate_attendance_post_397);
app.post("/api/migrate-company-settings", migrate_company_settings_post_398);
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_399);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_400);
app.post("/api/migrate-emergency-alerts", migrate_emergency_alerts_post_401);
app.post("/api/migrate-estimates", migrate_estimates_post_402);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_403);
app.post("/api/migrate-files", migrate_files_post_404);
app.post("/api/migrate-fleet", migrate_fleet_post_405);
app.post("/api/migrate-fleet-analytics", migrate_fleet_analytics_post_406);
app.post("/api/migrate-fleet-driver-sessions", migrate_fleet_driver_sessions_post_407);
app.post("/api/migrate-fleet-usage", migrate_fleet_usage_post_408);
app.post("/api/migrate-form-fields", migrate_form_fields_post_409);
app.post("/api/migrate-form-logic", migrate_form_logic_post_410);
app.post("/api/migrate-form-templates", migrate_form_templates_post_411);
app.post("/api/migrate-job-forms", migrate_job_forms_post_412);
app.post("/api/migrate-job-photo-shares", migrate_job_photo_shares_post_413);
app.post("/api/migrate-job-photos", migrate_job_photos_post_414);
app.post("/api/migrate-job-tabs", migrate_job_tabs_post_415);
app.post("/api/migrate-jobs", migrate_jobs_post_416);
app.post("/api/migrate-ledger-photo", migrate_ledger_photo_post_417);
app.post("/api/migrate-library", migrate_library_post_418);
app.post("/api/migrate-library-downloads", migrate_library_downloads_post_419);
app.post("/api/migrate-notifications", migrate_notifications_post_420);
app.post("/api/migrate-owner-console", migrate_owner_console_post_421);
app.post("/api/migrate-owner-role", migrate_owner_role_post_422);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_423);
app.post("/api/migrate-plan-manager", migrate_plan_manager_post_424);
app.post("/api/migrate-plan-manager-v2", migrate_plan_manager_v2_post_425);
app.post("/api/migrate-plan-manager-v3", migrate_plan_manager_v3_post_426);
app.post("/api/migrate-safety", migrate_safety_post_427);
app.post("/api/migrate-site-prestart", migrate_site_prestart_post_428);
app.post("/api/migrate-starter-pack", migrate_starter_pack_post_429);
app.post("/api/migrate-studio-pdf", migrate_studio_pdf_post_430);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_431);
app.post("/api/migrate-support-mode", migrate_support_mode_post_432);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_433);
app.post("/api/migrate-team", migrate_team_post_434);
...
app.get("/api/notifications/alerts", notifications_alerts_get_439);
...
app.post("/api/owner-console/system-ai/builtin-checks", owner_console_system_ai_builtin_checks_post_496);
