...
import form_templates_get_164 from "./api/form-templates/GET";
import form_templates_post_165 from "./api/form-templates/POST";
import form_templates_seed_post_166 from "./api/form-templates/seed/POST";
import form_templates_id_delete_167 from "./api/form-templates/[id]/DELETE";
import form_templates_id_put_168 from "./api/form-templates/[id]/PUT";
import forms_submissions_get_169 from "./api/forms/submissions/GET";
import forms_templates_id_share_link_post_170 from "./api/forms/templates/[id]/share-link/POST";
import forms_id_fields_get_171 from "./api/forms/[id]/fields/GET";
import forms_id_fields_post_172 from "./api/forms/[id]/fields/POST";
import forms_id_fields_reorder_post_173 from "./api/forms/[id]/fields/reorder/POST";
import forms_id_fields_fieldId_delete_174 from "./api/forms/[id]/fields/[fieldId]/DELETE";
import forms_id_fields_fieldId_patch_175 from "./api/forms/[id]/fields/[fieldId]/PATCH";
import forms_id_fields_fieldId_thumbnail_post_176 from "./api/forms/[id]/fields/[fieldId]/thumbnail/POST";
import health_get_177 from "./api/health/GET";
import integrations_myob_auth_url_get_178 from "./api/integrations/myob/auth-url/GET";
import integrations_myob_callback_get_179 from "./api/integrations/myob/callback/GET";
import integrations_myob_disconnect_post_180 from "./api/integrations/myob/disconnect/POST";
import integrations_myob_status_get_181 from "./api/integrations/myob/status/GET";
import integrations_myob_sync_invoice_post_182 from "./api/integrations/myob/sync-invoice/POST";
import integrations_onedrive_auth_url_get_183 from "./api/integrations/onedrive/auth-url/GET";
import integrations_onedrive_callback_get_184 from "./api/integrations/onedrive/callback/GET";
import integrations_onedrive_disconnect_post_185 from "./api/integrations/onedrive/disconnect/POST";
import integrations_onedrive_status_get_186 from "./api/integrations/onedrive/status/GET";
import integrations_onedrive_upload_file_post_187 from "./api/integrations/onedrive/upload-file/POST";
import integrations_qbo_auth_url_get_188 from "./api/integrations/qbo/auth-url/GET";
import integrations_qbo_callback_get_189 from "./api/integrations/qbo/callback/GET";
import integrations_qbo_disconnect_post_190 from "./api/integrations/qbo/disconnect/POST";
import integrations_qbo_status_get_191 from "./api/integrations/qbo/status/GET";
import integrations_qbo_sync_invoice_post_192 from "./api/integrations/qbo/sync-invoice/POST";
import integrations_xero_auth_url_get_193 from "./api/integrations/xero/auth-url/GET";
import integrations_xero_callback_get_194 from "./api/integrations/xero/callback/GET";
import integrations_xero_disconnect_post_195 from "./api/integrations/xero/disconnect/POST";
import integrations_xero_status_get_196 from "./api/integrations/xero/status/GET";
import integrations_xero_sync_customer_post_197 from "./api/integrations/xero/sync-customer/POST";
import integrations_xero_sync_invoice_post_198 from "./api/integrations/xero/sync-invoice/POST";
import integrations_xero_webhook_post_199 from "./api/integrations/xero/webhook/POST";
import invoices_get_200 from "./api/invoices/GET";
import invoices_post_201 from "./api/invoices/POST";
import invoices_id_delete_202 from "./api/invoices/[id]/DELETE";
import invoices_id_get_203 from "./api/invoices/[id]/GET";
import invoices_id_put_204 from "./api/invoices/[id]/PUT";
import invoices_id_duplicate_post_205 from "./api/invoices/[id]/duplicate/POST";
import invoices_id_export_pdf_get_206 from "./api/invoices/[id]/export-pdf/GET";
import invoices_id_mark_sent_post_207 from "./api/invoices/[id]/mark-sent/POST";
import invoices_id_record_payment_post_208 from "./api/invoices/[id]/record-payment/POST";
import invoices_id_void_post_209 from "./api/invoices/[id]/void/POST";
import job_forms_id_delete_210 from "./api/job-forms/[id]/DELETE";
import job_forms_id_get_211 from "./api/job-forms/[id]/GET";
import job_forms_id_put_212 from "./api/job-forms/[id]/PUT";
import job_forms_id_reset_post_213 from "./api/job-forms/[id]/reset/POST";
import job_forms_id_share_delete_214 from "./api/job-forms/[id]/share/DELETE";
import job_forms_id_share_get_215 from "./api/job-forms/[id]/share/GET";
import job_forms_id_share_post_216 from "./api/job-forms/[id]/share/POST";
import jobs_get_217 from "./api/jobs/GET";
import jobs_post_218 from "./api/jobs/POST";
import jobs_id_get_219 from "./api/jobs/[id]/GET";
import jobs_id_put_220 from "./api/jobs/[id]/PUT";
import jobs_id_costs_get_221 from "./api/jobs/[id]/costs/GET";
import jobs_id_costs_post_222 from "./api/jobs/[id]/costs/POST";
import jobs_id_costs_export_get_223 from "./api/jobs/[id]/costs/export/GET";
import jobs_id_costs_costId_delete_224 from "./api/jobs/[id]/costs/[costId]/DELETE";
import jobs_id_costs_costId_put_225 from "./api/jobs/[id]/costs/[costId]/PUT";
import jobs_id_costs_costId_receipt_get_226 from "./api/jobs/[id]/costs/[costId]/receipt/GET";
import jobs_id_costs_costId_receipt_post_227 from "./api/jobs/[id]/costs/[costId]/receipt/POST";
import jobs_id_delays_get_228 from "./api/jobs/[id]/delays/GET";
import jobs_id_delays_post_229 from "./api/jobs/[id]/delays/POST";
import jobs_id_delays_delayId_delete_230 from "./api/jobs/[id]/delays/[delayId]/DELETE";
import jobs_id_delays_delayId_put_231 from "./api/jobs/[id]/delays/[delayId]/PUT";
...
import jobs_id_ledger_sync_post_238 from "./api/jobs/[id]/ledger/sync/POST";
import jobs_id_ledger_entryId_delete_239 from "./api/jobs/[id]/ledger/[entryId]/DELETE";
import jobs_id_ledger_entryId_put_240 from "./api/jobs/[id]/ledger/[entryId]/PUT";
import jobs_id_ledger_entryId_correct_post_241 from "./api/jobs/[id]/ledger/[entryId]/correct/POST";
import jobs_id_photos_get_242 from "./api/jobs/[id]/photos/GET";
import jobs_id_photos_post_243 from "./api/jobs/[id]/photos/POST";
import jobs_id_photos_photoId_delete_244 from "./api/jobs/[id]/photos/[photoId]/DELETE";
import jobs_id_photos_photoId_patch_245 from "./api/jobs/[id]/photos/[photoId]/PATCH";
import jobs_id_photos_photoId_download_get_246 from "./api/jobs/[id]/photos/[photoId]/download/GET";
import jobs_id_photos_photoId_replace_post_247 from "./api/jobs/[id]/photos/[photoId]/replace/POST";
import jobs_id_progress_get_248 from "./api/jobs/[id]/progress/GET";
import jobs_id_progress_put_249 from "./api/jobs/[id]/progress/PUT";
import jobs_id_progress_sync_post_250 from "./api/jobs/[id]/progress/sync/POST";
import jobs_id_purchase_orders_get_251 from "./api/jobs/[id]/purchase-orders/GET";
import jobs_id_purchase_orders_post_252 from "./api/jobs/[id]/purchase-orders/POST";
import jobs_id_purchase_orders_poId_delete_253 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import jobs_id_purchase_orders_poId_get_254 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
import jobs_id_purchase_orders_poId_put_255 from "./api/jobs/[id]/purchase-orders/[poId]/PUT";
import jobs_id_purchase_orders_poId_pdf_get_256 from "./api/jobs/[id]/purchase-orders/[poId]/pdf/GET";
import jobs_id_swms_get_257 from "./api/jobs/[id]/swms/GET";
import jobs_id_swms_post_258 from "./api/jobs/[id]/swms/POST";
import jobs_id_swms_swmsId_signoff_post_259 from "./api/jobs/[id]/swms/[swmsId]/signoff/POST";
import jobs_id_todos_get_260 from "./api/jobs/[id]/todos/GET";
import jobs_id_todos_post_261 from "./api/jobs/[id]/todos/POST";
import jobs_id_todos_todoId_delete_262 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import jobs_id_todos_todoId_put_263 from "./api/jobs/[id]/todos/[todoId]/PUT";
import me_get_264 from "./api/me/GET";
import me_put_265 from "./api/me/PUT";
import me_2fa_disable_post_266 from "./api/me/2fa/disable/POST";
import me_2fa_enable_post_267 from "./api/me/2fa/enable/POST";
import me_2fa_setup_get_268 from "./api/me/2fa/setup/GET";
import me_2fa_status_get_269 from "./api/me/2fa/status/GET";
import me_2fa_verify_post_270 from "./api/me/2fa/verify/POST";
import me_change_password_post_271 from "./api/me/change-password/POST";
import me_email_status_get_272 from "./api/me/email-status/GET";
import me_phone_get_273 from "./api/me/phone/GET";
import me_phone_put_274 from "./api/me/phone/PUT";
import migrate_account_recovery_post_275 from "./api/migrate-account-recovery/POST";
import migrate_asset_manager_post_276 from "./api/migrate-asset-manager/POST";
import migrate_company_settings_post_277 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_278 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_279 from "./api/migrate-dazza-knowledge/POST";
import migrate_estimates_post_280 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_281 from "./api/migrate-estimating-library/POST";
...
import migrate_job_forms_post_288 from "./api/migrate-job-forms/POST";
import migrate_job_photos_post_289 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_290 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_291 from "./api/migrate-jobs/POST";
import migrate_notifications_post_292 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_293 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_294 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_295 from "./api/migrate-pdf-settings/POST";
import migrate_plan_manager_post_296 from "./api/migrate-plan-manager/POST";
import migrate_plan_manager_v2_post_297 from "./api/migrate-plan-manager-v2/POST";
import migrate_plan_manager_v3_post_298 from "./api/migrate-plan-manager-v3/POST";
import migrate_safety_post_299 from "./api/migrate-safety/POST";
import migrate_starter_pack_post_300 from "./api/migrate-starter-pack/POST";
import migrate_studio_pdf_post_301 from "./api/migrate-studio-pdf/POST";
import migrate_subscriptions_post_302 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_303 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_304 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_305 from "./api/migrate-team/POST";
import migrate_library_post from "./api/migrate-library/POST";
import notifications_alerts_get_306 from "./api/notifications/alerts/GET";
import library_items_get from "./api/library/items/GET";
import library_items_id_get from "./api/library/items/[id]/GET";
import library_items_id_install_post from "./api/library/items/[id]/install/POST";
import library_items_id_patch from "./api/library/items/[id]/PATCH";
import library_my_installed_get from "./api/library/my-installed/GET";
import notifications_prefs_get_307 from "./api/notifications/prefs/GET";
import notifications_prefs_put_308 from "./api/notifications/prefs/PUT";
import notifications_read_post_309 from "./api/notifications/read/POST";
import owner_console_activity_get_310 from "./api/owner-console/activity/GET";
import owner_console_cancellation_feedback_get_311 from "./api/owner-console/cancellation-feedback/GET";
import owner_console_companies_get_312 from "./api/owner-console/companies/GET";
import owner_console_companies_post_313 from "./api/owner-console/companies/POST";
import owner_console_companies_usage_get_314 from "./api/owner-console/companies/usage/GET";
import owner_console_companies_id_limits_put_315 from "./api/owner-console/companies/[id]/limits/PUT";
import owner_console_form_templates_get_316 from "./api/owner-console/form-templates/GET";
import owner_console_form_templates_post_317 from "./api/owner-console/form-templates/POST";
import owner_console_starter_pack_get_318 from "./api/owner-console/starter-pack/GET";
import owner_console_starter_pack_post_319 from "./api/owner-console/starter-pack/POST";
import owner_console_stats_get_320 from "./api/owner-console/stats/GET";
import owner_console_storage_get_321 from "./api/owner-console/storage/GET";
import owner_console_system_ai_builtin_checks_post_322 from "./api/owner-console/system-ai/builtin-checks/POST";
import owner_console_users_get_323 from "./api/owner-console/users/GET";
import owner_console_users_verify_post_324 from "./api/owner-console/users/verify/POST";
import plan_manager_drawings_get_325 from "./api/plan-manager/drawings/GET";
import plan_manager_drawings_post_326 from "./api/plan-manager/drawings/POST";
import plan_manager_drawings_id_get_327 from "./api/plan-manager/drawings/[id]/GET";
import plan_manager_drawings_id_annotations_put_328 from "./api/plan-manager/drawings/[id]/annotations/PUT";
import plan_manager_drawings_id_archive_post_329 from "./api/plan-manager/drawings/[id]/archive/POST";
import plan_manager_drawings_id_job_links_delete_330 from "./api/plan-manager/drawings/[id]/job-links/DELETE";
import plan_manager_drawings_id_job_links_post_331 from "./api/plan-manager/drawings/[id]/job-links/POST";
import plan_manager_drawings_id_pages_pageNo_annotations_get_332 from "./api/plan-manager/drawings/[id]/pages/[pageNo]/annotations/GET";
import plan_manager_drawings_id_permanent_delete_333 from "./api/plan-manager/drawings/[id]/permanent/DELETE";
import plan_manager_drawings_id_reorder_patch_334 from "./api/plan-manager/drawings/[id]/reorder/PATCH";
import plan_manager_drawings_id_restore_post_335 from "./api/plan-manager/drawings/[id]/restore/POST";
import plan_manager_drawings_id_revisions_post_336 from "./api/plan-manager/drawings/[id]/revisions/POST";
import plan_manager_drawings_id_revisions_revisionId_finalize_post_337 from "./api/plan-manager/drawings/[id]/revisions/[revisionId]/finalize/POST";
import plan_manager_drawings_id_upload_post_338 from "./api/plan-manager/drawings/[id]/upload/POST";
import plan_manager_jobs_with_drawings_get_339 from "./api/plan-manager/jobs-with-drawings/GET";
import plan_manager_share_post_340 from "./api/plan-manager/share/POST";
import plan_manager_share_validate_get_341 from "./api/plan-manager/share/validate/GET";
import portal_estimates_id_approve_post_342 from "./api/portal/estimates/[id]/approve/POST";
import portal_invite_post_343 from "./api/portal/invite/POST";
import portal_invoices_id_pay_post_344 from "./api/portal/invoices/[id]/pay/POST";
import portal_jobs_get_345 from "./api/portal/jobs/GET";
import portal_jobs_id_get_346 from "./api/portal/jobs/[id]/GET";
import portal_migrate_post_347 from "./api/portal/migrate/POST";
import portal_validate_post_348 from "./api/portal/validate/POST";
import public_form_token_get_349 from "./api/public/form/[token]/GET";
import public_form_token_submit_post_350 from "./api/public/form/[token]/submit/POST";
import public_swms_token_get_351 from "./api/public/swms/[token]/GET";
import public_swms_token_signoff_post_352 from "./api/public/swms/[token]/signoff/POST";
import push_subscribe_delete_353 from "./api/push/subscribe/DELETE";
import push_subscribe_post_354 from "./api/push/subscribe/POST";
import push_vapid_key_get_355 from "./api/push/vapid-key/GET";
import recipes_get_356 from "./api/recipes/GET";
import recipes_post_357 from "./api/recipes/POST";
import recipes_id_delete_358 from "./api/recipes/[id]/DELETE";
import recipes_id_put_359 from "./api/recipes/[id]/PUT";
import safety_ai_draft_post_360 from "./api/safety/ai/draft/POST";
import safety_documents_get_361 from "./api/safety/documents/GET";
import safety_documents_post_362 from "./api/safety/documents/POST";
import safety_documents_id_delete_363 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_364 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_365 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_366 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_367 from "./api/safety/generated-posters/[id]/DELETE";
import safety_job_safety_plans_get_368 from "./api/safety/job-safety-plans/GET";
import safety_job_safety_plans_post_369 from "./api/safety/job-safety-plans/POST";
import safety_job_safety_plans_id_delete_370 from "./api/safety/job-safety-plans/[id]/DELETE";
import safety_job_safety_plans_id_put_371 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_372 from "./api/safety/job-swms/GET";
import safety_job_swms_post_373 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_374 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_375 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_376 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_share_token_post_377 from "./api/safety/job-swms/[id]/share-token/POST";
import safety_job_swms_id_signoffs_get_378 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_379 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_380 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_381 from "./api/safety/plans/GET";
import safety_plans_post_382 from "./api/safety/plans/POST";
import safety_plans_seed_post_383 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_384 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_385 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_386 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_387 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_388 from "./api/safety/posters/GET";
import safety_posters_post_389 from "./api/safety/posters/POST";
import safety_posters_id_delete_390 from "./api/safety/posters/[id]/DELETE";
import safety_swms_get_391 from "./api/safety/swms/GET";
import safety_swms_post_392 from "./api/safety/swms/POST";
import safety_swms_import_docx_post_393 from "./api/safety/swms/import-docx/POST";
import safety_swms_seed_post_394 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_395 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_396 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_397 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_398 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_399 from "./api/safety/swms/[id]/export/GET";
import scheduler_crew_get_400 from "./api/scheduler/crew/GET";
import scheduler_jobs_get_401 from "./api/scheduler/jobs/GET";
import scheduler_jobs_id_reschedule_patch_402 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
import secure_share_get_403 from "./api/secure-share/GET";
import secure_share_post_404 from "./api/secure-share/POST";
import secure_share_id_delete_405 from "./api/secure-share/[id]/DELETE";
import secure_share_token_get_406 from "./api/secure-share/[token]/GET";
import secure_share_token_post_407 from "./api/secure-share/[token]/POST";
import settings_backup_get_408 from "./api/settings/backup/GET";
import settings_backup_post_409 from "./api/settings/backup/POST";
import settings_backup_export_get_410 from "./api/settings/backup/export/GET";
import settings_backup_run_post_411 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_412 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_413 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_414 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_415 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_416 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_417 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_418 from "./api/settings/retention/GET";
import settings_retention_post_419 from "./api/settings/retention/POST";
import settings_storage_provider_get_420 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_421 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_422 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_423 from "./api/settings/terminology/GET";
import settings_terminology_post_424 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_425 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_426 from "./api/settings/xero-credentials/POST";
import share_token_get_427 from "./api/share/[token]/GET";
import signup_post_428 from "./api/signup/POST";
import stripe_create_checkout_session_post_429 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_430 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_431 from "./api/subscription/create-checkout/POST";
import subscription_status_get_432 from "./api/subscription/status/GET";
import subscription_webhook_post_433 from "./api/subscription/webhook/POST";
import support_mode_audit_get_434 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_435 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_436 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_437 from "./api/support-mode/enter/POST";
import support_mode_exit_post_438 from "./api/support-mode/exit/POST";
import support_mode_status_get_439 from "./api/support-mode/status/GET";
import takeoff_pad_get_440 from "./api/takeoff-pad/GET";
import takeoff_pad_put_441 from "./api/takeoff-pad/PUT";
import team_get_442 from "./api/team/GET";
import team_invite_post_443 from "./api/team/invite/POST";
import team_invites_get_444 from "./api/team/invites/GET";
import team_invites_post_445 from "./api/team/invites/POST";
import team_invites_id_cancel_post_446 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_447 from "./api/team/invites/[id]/resend/POST";
import team_members_get_448 from "./api/team/members/GET";
import team_resend_verification_post_449 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_450 from "./api/team/schedule/migrate/POST";
import team_shifts_get_451 from "./api/team/shifts/GET";
import team_shifts_post_452 from "./api/team/shifts/POST";
import team_shifts_id_delete_453 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_454 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_455 from "./api/team/time-entries/GET";
import team_time_entries_post_456 from "./api/team/time-entries/POST";
import team_time_entries_export_get_457 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_458 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_459 from "./api/team/verify-user/POST";
import team_id_delete_460 from "./api/team/[id]/DELETE";
import team_id_put_461 from "./api/team/[id]/PUT";
import usage_get_462 from "./api/usage/GET";
// </api-imports>
// Asset Manager
...
app.get("/api/form-templates", form_templates_get_164);
app.post("/api/form-templates", form_templates_post_165);
app.post("/api/form-templates/seed", form_templates_seed_post_166);
app.delete("/api/form-templates/:id", form_templates_id_delete_167);
app.put("/api/form-templates/:id", form_templates_id_put_168);
app.get("/api/forms/submissions", forms_submissions_get_169);
app.post("/api/forms/templates/:id/share-link", forms_templates_id_share_link_post_170);
app.get("/api/forms/:id/fields", forms_id_fields_get_171);
app.post("/api/forms/:id/fields", forms_id_fields_post_172);
app.post("/api/forms/:id/fields/reorder", forms_id_fields_reorder_post_173);
app.delete("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_delete_174);
app.patch("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_patch_175);
app.post("/api/forms/:id/fields/:fieldId/thumbnail", forms_id_fields_fieldId_thumbnail_post_176);
app.get("/api/health", health_get_177);
app.get("/api/integrations/myob/auth-url", integrations_myob_auth_url_get_178);
app.get("/api/integrations/myob/callback", integrations_myob_callback_get_179);
app.post("/api/integrations/myob/disconnect", integrations_myob_disconnect_post_180);
app.get("/api/integrations/myob/status", integrations_myob_status_get_181);
app.post("/api/integrations/myob/sync-invoice", integrations_myob_sync_invoice_post_182);
app.get("/api/integrations/onedrive/auth-url", integrations_onedrive_auth_url_get_183);
app.get("/api/integrations/onedrive/callback", integrations_onedrive_callback_get_184);
app.post("/api/integrations/onedrive/disconnect", integrations_onedrive_disconnect_post_185);
app.get("/api/integrations/onedrive/status", integrations_onedrive_status_get_186);
app.post("/api/integrations/onedrive/upload-file", integrations_onedrive_upload_file_post_187);
app.get("/api/integrations/qbo/auth-url", integrations_qbo_auth_url_get_188);
app.get("/api/integrations/qbo/callback", integrations_qbo_callback_get_189);
app.post("/api/integrations/qbo/disconnect", integrations_qbo_disconnect_post_190);
app.get("/api/integrations/qbo/status", integrations_qbo_status_get_191);
app.post("/api/integrations/qbo/sync-invoice", integrations_qbo_sync_invoice_post_192);
app.get("/api/integrations/xero/auth-url", integrations_xero_auth_url_get_193);
app.get("/api/integrations/xero/callback", integrations_xero_callback_get_194);
app.post("/api/integrations/xero/disconnect", integrations_xero_disconnect_post_195);
app.get("/api/integrations/xero/status", integrations_xero_status_get_196);
app.post("/api/integrations/xero/sync-customer", integrations_xero_sync_customer_post_197);
app.post("/api/integrations/xero/sync-invoice", integrations_xero_sync_invoice_post_198);
app.post("/api/integrations/xero/webhook", integrations_xero_webhook_post_199);
app.get("/api/invoices", invoices_get_200);
app.post("/api/invoices", invoices_post_201);
app.delete("/api/invoices/:id", invoices_id_delete_202);
app.get("/api/invoices/:id", invoices_id_get_203);
app.put("/api/invoices/:id", invoices_id_put_204);
app.post("/api/invoices/:id/duplicate", invoices_id_duplicate_post_205);
app.get("/api/invoices/:id/export-pdf", invoices_id_export_pdf_get_206);
app.post("/api/invoices/:id/mark-sent", invoices_id_mark_sent_post_207);
app.post("/api/invoices/:id/record-payment", invoices_id_record_payment_post_208);
app.post("/api/invoices/:id/void", invoices_id_void_post_209);
app.delete("/api/job-forms/:id", job_forms_id_delete_210);
app.get("/api/job-forms/:id", job_forms_id_get_211);
app.put("/api/job-forms/:id", job_forms_id_put_212);
app.post("/api/job-forms/:id/reset", job_forms_id_reset_post_213);
app.delete("/api/job-forms/:id/share", job_forms_id_share_delete_214);
app.get("/api/job-forms/:id/share", job_forms_id_share_get_215);
app.post("/api/job-forms/:id/share", job_forms_id_share_post_216);
app.get("/api/jobs", jobs_get_217);
app.post("/api/jobs", jobs_post_218);
app.get("/api/jobs/:id", jobs_id_get_219);
app.put("/api/jobs/:id", jobs_id_put_220);
app.get("/api/jobs/:id/costs", jobs_id_costs_get_221);
app.post("/api/jobs/:id/costs", jobs_id_costs_post_222);
app.get("/api/jobs/:id/costs/export", jobs_id_costs_export_get_223);
app.delete("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_delete_224);
app.put("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_put_225);
app.get("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_get_226);
app.post("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_post_227);
app.get("/api/jobs/:id/delays", jobs_id_delays_get_228);
app.post("/api/jobs/:id/delays", jobs_id_delays_post_229);
app.delete("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_delete_230);
app.put("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_put_231);
...
app.post("/api/jobs/:id/ledger/sync", jobs_id_ledger_sync_post_238);
app.delete("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_delete_239);
app.put("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_put_240);
app.post("/api/jobs/:id/ledger/:entryId/correct", jobs_id_ledger_entryId_correct_post_241);
app.get("/api/jobs/:id/photos", jobs_id_photos_get_242);
app.post("/api/jobs/:id/photos", jobs_id_photos_post_243);
app.delete("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_delete_244);
app.patch("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_patch_245);
app.get("/api/jobs/:id/photos/:photoId/download", jobs_id_photos_photoId_download_get_246);
app.post("/api/jobs/:id/photos/:photoId/replace", jobs_id_photos_photoId_replace_post_247);
app.get("/api/jobs/:id/progress", jobs_id_progress_get_248);
app.put("/api/jobs/:id/progress", jobs_id_progress_put_249);
app.post("/api/jobs/:id/progress/sync", jobs_id_progress_sync_post_250);
app.get("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_get_251);
app.post("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_post_252);
app.delete("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_delete_253);
app.get("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_get_254);
app.put("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_put_255);
app.get("/api/jobs/:id/purchase-orders/:poId/pdf", jobs_id_purchase_orders_poId_pdf_get_256);
app.get("/api/jobs/:id/swms", jobs_id_swms_get_257);
app.post("/api/jobs/:id/swms", jobs_id_swms_post_258);
app.post("/api/jobs/:id/swms/:swmsId/signoff", jobs_id_swms_swmsId_signoff_post_259);
app.get("/api/jobs/:id/todos", jobs_id_todos_get_260);
app.post("/api/jobs/:id/todos", jobs_id_todos_post_261);
app.delete("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_delete_262);
app.put("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_put_263);
app.get("/api/me", me_get_264);
app.put("/api/me", me_put_265);
app.post("/api/me/2fa/disable", me_2fa_disable_post_266);
app.post("/api/me/2fa/enable", me_2fa_enable_post_267);
app.get("/api/me/2fa/setup", me_2fa_setup_get_268);
app.get("/api/me/2fa/status", me_2fa_status_get_269);
app.post("/api/me/2fa/verify", me_2fa_verify_post_270);
app.post("/api/me/change-password", me_change_password_post_271);
app.get("/api/me/email-status", me_email_status_get_272);
app.get("/api/me/phone", me_phone_get_273);
app.put("/api/me/phone", me_phone_put_274);
app.post("/api/migrate-account-recovery", migrate_account_recovery_post_275);
app.post("/api/migrate-asset-manager", migrate_asset_manager_post_276);
app.post("/api/migrate-company-settings", migrate_company_settings_post_277);
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_278);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_279);
app.post("/api/migrate-estimates", migrate_estimates_post_280);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_281);
...
app.post("/api/migrate-job-forms", migrate_job_forms_post_288);
app.post("/api/migrate-job-photos", migrate_job_photos_post_289);
app.post("/api/migrate-job-tabs", migrate_job_tabs_post_290);
app.post("/api/migrate-jobs", migrate_jobs_post_291);
app.post("/api/migrate-notifications", migrate_notifications_post_292);
app.post("/api/migrate-owner-console", migrate_owner_console_post_293);
app.post("/api/migrate-owner-role", migrate_owner_role_post_294);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_295);
app.post("/api/migrate-plan-manager", migrate_plan_manager_post_296);
app.post("/api/migrate-plan-manager-v2", migrate_plan_manager_v2_post_297);
app.post("/api/migrate-plan-manager-v3", migrate_plan_manager_v3_post_298);
app.post("/api/migrate-safety", migrate_safety_post_299);
app.post("/api/migrate-starter-pack", migrate_starter_pack_post_300);
app.post("/api/migrate-studio-pdf", migrate_studio_pdf_post_301);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_302);
app.post("/api/migrate-support-mode", migrate_support_mode_post_303);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_304);
app.post("/api/migrate-team", migrate_team_post_305);
app.post("/api/migrate-library", migrate_library_post);
// ── Library routes ────────────────────────────────────────────────────────────
app.get("/api/library/my-installed", library_my_installed_get);
app.get("/api/library/items", library_items_get);
app.get("/api/library/items/:id", library_items_id_get);
app.post("/api/library/items/:id/install", library_items_id_install_post);
app.patch("/api/library/items/:id", library_items_id_patch);
app.get("/api/notifications/alerts", notifications_alerts_get_306);
app.get("/api/notifications/prefs", notifications_prefs_get_307);
app.put("/api/notifications/prefs", notifications_prefs_put_308);
app.post("/api/notifications/read", notifications_read_post_309);
app.get("/api/owner-console/activity", owner_console_activity_get_310);
app.get("/api/owner-console/cancellation-feedback", owner_console_cancellation_feedback_get_311);
app.get("/api/owner-console/companies", owner_console_companies_get_312);
app.post("/api/owner-console/companies", owner_console_companies_post_313);
app.get("/api/owner-console/companies/usage", owner_console_companies_usage_get_314);
app.put("/api/owner-console/companies/:id/limits", owner_console_companies_id_limits_put_315);
app.get("/api/owner-console/form-templates", owner_console_form_templates_get_316);
app.post("/api/owner-console/form-templates", owner_console_form_templates_post_317);
app.get("/api/owner-console/starter-pack", owner_console_starter_pack_get_318);
app.post("/api/owner-console/starter-pack", owner_console_starter_pack_post_319);
app.get("/api/owner-console/stats", owner_console_stats_get_320);
app.get("/api/owner-console/storage", owner_console_storage_get_321);
app.post("/api/owner-console/system-ai/builtin-checks", owner_console_system_ai_builtin_checks_post_322);
app.get("/api/owner-console/users", owner_console_users_get_323);
app.post("/api/owner-console/users/verify", owner_console_users_verify_post_324);
app.get("/api/plan-manager/drawings", plan_manager_drawings_get_325);
app.post("/api/plan-manager/drawings", plan_manager_drawings_post_326);
app.get("/api/plan-manager/drawings/:id", plan_manager_drawings_id_get_327);
app.put("/api/plan-manager/drawings/:id/annotations", plan_manager_drawings_id_annotations_put_328);
app.post("/api/plan-manager/drawings/:id/archive", plan_manager_drawings_id_archive_post_329);
app.delete("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_delete_330);
app.post("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_post_331);
app.get("/api/plan-manager/drawings/:id/pages/:pageNo/annotations", plan_manager_drawings_id_pages_pageNo_annotations_get_332);
app.delete("/api/plan-manager/drawings/:id/permanent", plan_manager_drawings_id_permanent_delete_333);
app.patch("/api/plan-manager/drawings/:id/reorder", plan_manager_drawings_id_reorder_patch_334);
app.post("/api/plan-manager/drawings/:id/restore", plan_manager_drawings_id_restore_post_335);
app.post("/api/plan-manager/drawings/:id/revisions", plan_manager_drawings_id_revisions_post_336);
app.post("/api/plan-manager/drawings/:id/revisions/:revisionId/finalize", plan_manager_drawings_id_revisions_revisionId_finalize_post_337);
app.post("/api/plan-manager/drawings/:id/upload", plan_manager_drawings_id_upload_post_338);
app.get("/api/plan-manager/jobs-with-drawings", plan_manager_jobs_with_drawings_get_339);
app.post("/api/plan-manager/share", plan_manager_share_post_340);
app.get("/api/plan-manager/share/validate", plan_manager_share_validate_get_341);
app.post("/api/portal/estimates/:id/approve", portal_estimates_id_approve_post_342);
app.post("/api/portal/invite", portal_invite_post_343);
app.post("/api/portal/invoices/:id/pay", portal_invoices_id_pay_post_344);
app.get("/api/portal/jobs", portal_jobs_get_345);
app.get("/api/portal/jobs/:id", portal_jobs_id_get_346);
app.post("/api/portal/migrate", portal_migrate_post_347);
app.post("/api/portal/validate", portal_validate_post_348);
app.get("/api/public/form/:token", public_form_token_get_349);
app.post("/api/public/form/:token/submit", public_form_token_submit_post_350);
app.get("/api/public/swms/:token", public_swms_token_get_351);
app.post("/api/public/swms/:token/signoff", public_swms_token_signoff_post_352);
app.delete("/api/push/subscribe", push_subscribe_delete_353);
app.post("/api/push/subscribe", push_subscribe_post_354);
app.get("/api/push/vapid-key", push_vapid_key_get_355);
app.get("/api/recipes", recipes_get_356);
app.post("/api/recipes", recipes_post_357);
app.delete("/api/recipes/:id", recipes_id_delete_358);
app.put("/api/recipes/:id", recipes_id_put_359);
app.post("/api/safety/ai/draft", safety_ai_draft_post_360);
app.get("/api/safety/documents", safety_documents_get_361);
app.post("/api/safety/documents", safety_documents_post_362);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_363);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_364);
app.get("/api/safety/generated-posters", safety_generated_posters_get_365);
app.post("/api/safety/generated-posters", safety_generated_posters_post_366);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_367);
app.get("/api/safety/job-safety-plans", safety_job_safety_plans_get_368);
app.post("/api/safety/job-safety-plans", safety_job_safety_plans_post_369);
app.delete("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_delete_370);
app.put("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_put_371);
app.get("/api/safety/job-swms", safety_job_swms_get_372);
app.post("/api/safety/job-swms", safety_job_swms_post_373);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_374);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_375);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_376);
app.post("/api/safety/job-swms/:id/share-token", safety_job_swms_id_share_token_post_377);
app.get("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_get_378);
app.post("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_post_379);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", safety_job_swms_id_signoffs_signoffId_delete_380);
app.get("/api/safety/plans", safety_plans_get_381);
app.post("/api/safety/plans", safety_plans_post_382);
app.post("/api/safety/plans/seed", safety_plans_seed_post_383);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_384);
app.put("/api/safety/plans/:id", safety_plans_id_put_385);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_386);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_387);
app.get("/api/safety/posters", safety_posters_get_388);
app.post("/api/safety/posters", safety_posters_post_389);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_390);
app.get("/api/safety/swms", safety_swms_get_391);
app.post("/api/safety/swms", safety_swms_post_392);
app.post("/api/safety/swms/import-docx", safety_swms_import_docx_post_393);
app.post("/api/safety/swms/seed", safety_swms_seed_post_394);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_395);
app.get("/api/safety/swms/:id", safety_swms_id_get_396);
app.put("/api/safety/swms/:id", safety_swms_id_put_397);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_398);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_399);
app.get("/api/scheduler/crew", scheduler_crew_get_400);
app.get("/api/scheduler/jobs", scheduler_jobs_get_401);
app.patch("/api/scheduler/jobs/:id/reschedule", scheduler_jobs_id_reschedule_patch_402);
app.get("/api/secure-share", secure_share_get_403);
app.post("/api/secure-share", secure_share_post_404);
app.delete("/api/secure-share/:id", secure_share_id_delete_405);
app.get("/api/secure-share/:token", secure_share_token_get_406);
app.post("/api/secure-share/:token", secure_share_token_post_407);
app.get("/api/settings/backup", settings_backup_get_408);
app.post("/api/settings/backup", settings_backup_post_409);
app.get("/api/settings/backup/export", settings_backup_export_get_410);
app.post("/api/settings/backup/run", settings_backup_run_post_411);
app.get("/api/settings/backup-destination", settings_backup_destination_get_412);
app.post("/api/settings/backup-destination", settings_backup_destination_post_413);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_414);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_415);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_416);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_417);
app.get("/api/settings/retention", settings_retention_get_418);
app.post("/api/settings/retention", settings_retention_post_419);
app.get("/api/settings/storage-provider", settings_storage_provider_get_420);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_421);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_422);
app.get("/api/settings/terminology", settings_terminology_get_423);
app.post("/api/settings/terminology", settings_terminology_post_424);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_425);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_426);
app.get("/api/share/:token", share_token_get_427);
app.post("/api/signup", signup_post_428);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_429);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_430);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_431);
app.get("/api/subscription/status", subscription_status_get_432);
app.post("/api/subscription/webhook", subscription_webhook_post_433);
app.get("/api/support-mode/audit", support_mode_audit_get_434);
app.get("/api/support-mode/checklist", support_mode_checklist_get_435);
app.put("/api/support-mode/checklist", support_mode_checklist_put_436);
app.post("/api/support-mode/enter", support_mode_enter_post_437);
app.post("/api/support-mode/exit", support_mode_exit_post_438);
app.get("/api/support-mode/status", support_mode_status_get_439);
app.get("/api/takeoff-pad", takeoff_pad_get_440);
app.put("/api/takeoff-pad", takeoff_pad_put_441);
app.get("/api/team", team_get_442);
app.post("/api/team/invite", team_invite_post_443);
app.get("/api/team/invites", team_invites_get_444);
app.post("/api/team/invites", team_invites_post_445);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_446);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_447);
app.get("/api/team/members", team_members_get_448);
app.post("/api/team/resend-verification", team_resend_verification_post_449);
app.post("/api/team/schedule/migrate", team_schedule_migrate_post_450);
app.get("/api/team/shifts", team_shifts_get_451);
app.post("/api/team/shifts", team_shifts_post_452);
app.delete("/api/team/shifts/:id", team_shifts_id_delete_453);
app.put("/api/team/shifts/:id", team_shifts_id_put_454);
app.get("/api/team/time-entries", team_time_entries_get_455);
app.post("/api/team/time-entries", team_time_entries_post_456);
app.get("/api/team/time-entries/export", team_time_entries_export_get_457);
app.put("/api/team/time-entries/:id", team_time_entries_id_put_458);
app.post("/api/team/verify-user", team_verify_user_post_459);
app.delete("/api/team/:id", team_id_delete_460);
app.put("/api/team/:id", team_id_put_461);
app.get("/api/usage", usage_get_462);
// </api-registrations>
