...
import developer_users_id_assign_company_post_132 from "./api/developer/users/[id]/assign-company/POST";
import developer_users_id_deactivate_post_133 from "./api/developer/users/[id]/deactivate/POST";
import developer_users_id_delete_orphan_post_134 from "./api/developer/users/[id]/delete-orphan/POST";
import developer_users_id_force_temp_password_post_135 from "./api/developer/users/[id]/force-temp-password/POST";
import developer_users_id_impersonate_delete_136 from "./api/developer/users/[id]/impersonate/DELETE";
import developer_users_id_impersonate_post_137 from "./api/developer/users/[id]/impersonate/POST";
import developer_users_id_reactivate_post_138 from "./api/developer/users/[id]/reactivate/POST";
import developer_users_id_resend_verification_post_139 from "./api/developer/users/[id]/resend-verification/POST";
import developer_users_id_role_put_140 from "./api/developer/users/[id]/role/PUT";
import developer_users_id_send_reset_email_post_141 from "./api/developer/users/[id]/send-reset-email/POST";
import developer_users_id_sessions_delete_142 from "./api/developer/users/[id]/sessions/DELETE";
import developer_users_id_sessions_get_143 from "./api/developer/users/[id]/sessions/GET";
import developer_users_id_unlock_account_post_144 from "./api/developer/users/[id]/unlock-account/POST";
import diag_recover_old_photos_post_145 from "./api/diag/recover-old-photos/POST";
import diag_self_test_get_146 from "./api/diag/self-test/GET";
import diag_upload_test_post_147 from "./api/diag/upload-test/POST";
import document_templates_get_148 from "./api/document-templates/GET";
import document_templates_post_149 from "./api/document-templates/POST";
import document_templates_id_delete_150 from "./api/document-templates/[id]/DELETE";
import document_templates_id_get_151 from "./api/document-templates/[id]/GET";
import document_templates_id_put_152 from "./api/document-templates/[id]/PUT";
import document_templates_id_duplicate_post_153 from "./api/document-templates/[id]/duplicate/POST";
import document_templates_id_export_docx_get_154 from "./api/document-templates/[id]/export/docx/GET";
import document_templates_id_export_pdf_get_155 from "./api/document-templates/[id]/export/pdf/GET";
import document_templates_id_import_blocks_post_156 from "./api/document-templates/[id]/import-blocks/POST";
import document_templates_id_import_docx_post_157 from "./api/document-templates/[id]/import-docx/POST";
import document_templates_id_import_pdf_post_158 from "./api/document-templates/[id]/import-pdf/POST";
import document_templates_id_publish_to_library_post_159 from "./api/document-templates/[id]/publish-to-library/POST";
import documents_get_160 from "./api/documents/GET";
import documents_share_token_get_161 from "./api/documents/share/[token]/GET";
import documents_share_token_post_162 from "./api/documents/share/[token]/POST";
import documents_id_get_163 from "./api/documents/[id]/GET";
import documents_id_put_164 from "./api/documents/[id]/PUT";
import documents_id_events_get_165 from "./api/documents/[id]/events/GET";
import documents_id_share_delete_166 from "./api/documents/[id]/share/DELETE";
import documents_id_share_post_167 from "./api/documents/[id]/share/POST";
import drawings_get_168 from "./api/drawings/GET";
import drawings_post_169 from "./api/drawings/POST";
import drawings_upload_post_170 from "./api/drawings/upload/POST";
import drawings_id_delete_171 from "./api/drawings/[id]/DELETE";
import drawings_id_patch_172 from "./api/drawings/[id]/PATCH";
import drawings_id_markup_post_173 from "./api/drawings/[id]/markup/POST";
import emergency_alerts_get_174 from "./api/emergency-alerts/GET";
import emergency_alerts_post_175 from "./api/emergency-alerts/POST";
import emergency_alerts_id_put_176 from "./api/emergency-alerts/[id]/PUT";
import estimates_get_177 from "./api/estimates/GET";
import estimates_post_178 from "./api/estimates/POST";
import estimates_id_delete_179 from "./api/estimates/[id]/DELETE";
import estimates_id_get_180 from "./api/estimates/[id]/GET";
import estimates_id_put_181 from "./api/estimates/[id]/PUT";
...
import estimates_id_send_email_post_184b from "./api/estimates/[id]/send-email/POST";
...
import external_form_token_post_188 from "./api/external/form/[token]/POST";
import files_get_189 from "./api/files/GET";
import files_post_190 from "./api/files/POST";
import files_id_delete_191 from "./api/files/[id]/DELETE";
import files_id_download_get_192 from "./api/files/[id]/download/GET";
import fleet_get_193 from "./api/fleet/GET";
import fleet_post_194 from "./api/fleet/POST";
import fleet_analytics_settings_get_195 from "./api/fleet/analytics-settings/GET";
import fleet_analytics_settings_put_196 from "./api/fleet/analytics-settings/PUT";
import fleet_asset_bookings_get_197 from "./api/fleet/asset-bookings/GET";
import fleet_asset_bookings_post_198 from "./api/fleet/asset-bookings/POST";
import fleet_asset_bookings_id_delete_199 from "./api/fleet/asset-bookings/[id]/DELETE";
import fleet_asset_bookings_id_patch_200 from "./api/fleet/asset-bookings/[id]/PATCH";
import fleet_driver_sessions_post_201 from "./api/fleet/driver-sessions/POST";
import fleet_driver_sessions_active_get_202 from "./api/fleet/driver-sessions/active/GET";
import fleet_driver_sessions_live_get_203 from "./api/fleet/driver-sessions/live/GET";
import fleet_driver_sessions_migrate_gps_status_post_204 from "./api/fleet/driver-sessions/migrate-gps-status/POST";
import fleet_driver_sessions_id_heartbeat_post_205 from "./api/fleet/driver-sessions/[id]/heartbeat/POST";
import fleet_driver_sessions_id_stop_post_206 from "./api/fleet/driver-sessions/[id]/stop/POST";
import fleet_driver_sessions_id_summary_get_207 from "./api/fleet/driver-sessions/[id]/summary/GET";
import fleet_driver_sessions_id_telemetry_post_208 from "./api/fleet/driver-sessions/[id]/telemetry/POST";
import fleet_driver_sessions_id_telemetry_latest_get_209 from "./api/fleet/driver-sessions/[id]/telemetry/latest/GET";
import fleet_flags_get_210 from "./api/fleet/flags/GET";
import fleet_last_known_positions_get_211 from "./api/fleet/last-known-positions/GET";
import fleet_service_logs_logId_delete_212 from "./api/fleet/service-logs/[logId]/DELETE";
import fleet_service_logs_logId_patch_213 from "./api/fleet/service-logs/[logId]/PATCH";
import fleet_vehicles_get_214 from "./api/fleet/vehicles/GET";
import fleet_id_delete_215 from "./api/fleet/[id]/DELETE";
import fleet_id_get_216 from "./api/fleet/[id]/GET";
import fleet_id_put_217 from "./api/fleet/[id]/PUT";
import fleet_id_driver_sessions_get_218 from "./api/fleet/[id]/driver-sessions/GET";
import fleet_id_driver_sessions_manual_post_219 from "./api/fleet/[id]/driver-sessions/manual/POST";
import fleet_id_files_get_220 from "./api/fleet/[id]/files/GET";
import fleet_id_prestarts_get_221 from "./api/fleet/[id]/prestarts/GET";
import fleet_id_prestarts_post_222 from "./api/fleet/[id]/prestarts/POST";
import fleet_id_service_logs_get_223 from "./api/fleet/[id]/service-logs/GET";
import fleet_id_service_logs_post_224 from "./api/fleet/[id]/service-logs/POST";
import fleet_id_signin_post_225 from "./api/fleet/[id]/signin/POST";
import fleet_id_signout_post_226 from "./api/fleet/[id]/signout/POST";
import fleet_id_usage_export_get_227 from "./api/fleet/[id]/usage-export/GET";
import fleet_id_usage_status_get_228 from "./api/fleet/[id]/usage-status/GET";
import fleet_id_usage_summary_get_229 from "./api/fleet/[id]/usage-summary/GET";
import form_attachments_post_230 from "./api/form-attachments/POST";
import form_global_lists_get_231 from "./api/form-global-lists/GET";
import form_global_lists_post_232 from "./api/form-global-lists/POST";
import form_global_lists_id_delete_233 from "./api/form-global-lists/[id]/DELETE";
import form_global_lists_id_put_234 from "./api/form-global-lists/[id]/PUT";
import form_templates_get_235 from "./api/form-templates/GET";
import form_templates_post_236 from "./api/form-templates/POST";
import form_templates_seed_post_237 from "./api/form-templates/seed/POST";
import form_templates_id_delete_238 from "./api/form-templates/[id]/DELETE";
import form_templates_id_put_239 from "./api/form-templates/[id]/PUT";
import form_templates_id_publish_to_library_post_240 from "./api/form-templates/[id]/publish-to-library/POST";
import forms_assets_list_get_241 from "./api/forms/assets-list/GET";
import forms_jobs_list_get_242 from "./api/forms/jobs-list/GET";
import forms_migrate_skip_logic_post_243 from "./api/forms/migrate-skip-logic/POST";
import forms_skip_audit_get_244 from "./api/forms/skip-audit/GET";
...
import forms_id_fields_fieldId_delete_252 from "./api/forms/[id]/fields/[fieldId]/DELETE";
import forms_id_fields_fieldId_patch_253 from "./api/forms/[id]/fields/[fieldId]/PATCH";
import forms_id_fields_fieldId_thumbnail_post_254 from "./api/forms/[id]/fields/[fieldId]/thumbnail/POST";
import health_get_255 from "./api/health/GET";
import incidents_get_256 from "./api/incidents/GET";
import incidents_post_257 from "./api/incidents/POST";
import incidents_id_archive_post_258 from "./api/incidents/[id]/archive/POST";
import incidents_id_unarchive_post_259 from "./api/incidents/[id]/unarchive/POST";
import incidents_incidentId_get_260 from "./api/incidents/[incidentId]/GET";
import incidents_incidentId_put_261 from "./api/incidents/[incidentId]/PUT";
import incidents_incidentId_attachments_get_262 from "./api/incidents/[incidentId]/attachments/GET";
import incidents_incidentId_attachments_post_263 from "./api/incidents/[incidentId]/attachments/POST";
import incidents_incidentId_attachments_attachId_delete_264 from "./api/incidents/[incidentId]/attachments/[attachId]/DELETE";
import incidents_incidentId_close_post_265 from "./api/incidents/[incidentId]/close/POST";
import incidents_incidentId_corrective_actions_post_266 from "./api/incidents/[incidentId]/corrective-actions/POST";
import incidents_incidentId_corrective_actions_actionId_put_267 from "./api/incidents/[incidentId]/corrective-actions/[actionId]/PUT";
import incidents_incidentId_pdf_get_268 from "./api/incidents/[incidentId]/pdf/GET";
import incidents_incidentId_third_parties_post_269 from "./api/incidents/[incidentId]/third-parties/POST";
import incidents_incidentId_third_parties_thirdPartyId_delete_270 from "./api/incidents/[incidentId]/third-parties/[thirdPartyId]/DELETE";
import integrations_myob_auth_url_get_271 from "./api/integrations/myob/auth-url/GET";
import integrations_myob_callback_get_272 from "./api/integrations/myob/callback/GET";
import integrations_myob_disconnect_post_273 from "./api/integrations/myob/disconnect/POST";
import integrations_myob_status_get_274 from "./api/integrations/myob/status/GET";
import integrations_myob_sync_invoice_post_275 from "./api/integrations/myob/sync-invoice/POST";
import integrations_onedrive_auth_url_get_276 from "./api/integrations/onedrive/auth-url/GET";
import integrations_onedrive_callback_get_277 from "./api/integrations/onedrive/callback/GET";
import integrations_onedrive_disconnect_post_278 from "./api/integrations/onedrive/disconnect/POST";
import integrations_onedrive_status_get_279 from "./api/integrations/onedrive/status/GET";
import integrations_onedrive_upload_file_post_280 from "./api/integrations/onedrive/upload-file/POST";
import integrations_qbo_auth_url_get_281 from "./api/integrations/qbo/auth-url/GET";
import integrations_qbo_callback_get_282 from "./api/integrations/qbo/callback/GET";
import integrations_qbo_disconnect_post_283 from "./api/integrations/qbo/disconnect/POST";
import integrations_qbo_status_get_284 from "./api/integrations/qbo/status/GET";
import integrations_qbo_sync_invoice_post_285 from "./api/integrations/qbo/sync-invoice/POST";
import integrations_xero_auth_url_get_286 from "./api/integrations/xero/auth-url/GET";
import integrations_xero_callback_get_287 from "./api/integrations/xero/callback/GET";
import integrations_xero_disconnect_post_288 from "./api/integrations/xero/disconnect/POST";
import integrations_xero_status_get_289 from "./api/integrations/xero/status/GET";
import integrations_xero_sync_customer_post_290 from "./api/integrations/xero/sync-customer/POST";
import integrations_xero_sync_invoice_post_291 from "./api/integrations/xero/sync-invoice/POST";
import integrations_xero_webhook_post_292 from "./api/integrations/xero/webhook/POST";
import invoices_get_293 from "./api/invoices/GET";
import invoices_post_294 from "./api/invoices/POST";
import invoices_id_delete_295 from "./api/invoices/[id]/DELETE";
import invoices_id_get_296 from "./api/invoices/[id]/GET";
...
import invoices_id_unlock_patch_303 from "./api/invoices/[id]/unlock/PATCH";
import invoices_id_void_post_304 from "./api/invoices/[id]/void/POST";
import job_cards_get_305 from "./api/job-cards/GET";
import job_cards_post_306 from "./api/job-cards/POST";
import job_cards_id_delete_307 from "./api/job-cards/[id]/DELETE";
import job_cards_id_get_308 from "./api/job-cards/[id]/GET";
import job_cards_id_put_309 from "./api/job-cards/[id]/PUT";
import job_cards_id_convert_post_310 from "./api/job-cards/[id]/convert/POST";
import job_cards_id_invoice_post_311 from "./api/job-cards/[id]/invoice/POST";
import job_cards_id_photos_post_312 from "./api/job-cards/[id]/photos/POST";
import job_cards_id_photos_photoId_delete_313 from "./api/job-cards/[id]/photos/[photoId]/DELETE";
import job_cards_id_photos_photoId_patch_314 from "./api/job-cards/[id]/photos/[photoId]/PATCH";
import job_cards_id_photos_photoId_download_get_315 from "./api/job-cards/[id]/photos/[photoId]/download/GET";
import job_cards_id_photos_photoId_save_and_lock_post_316 from "./api/job-cards/[id]/photos/[photoId]/save-and-lock/POST";
import job_costs_post_317 from "./api/job-costs/POST";
import job_forms_id_delete_318 from "./api/job-forms/[id]/DELETE";
...
import jobs_get_326 from "./api/jobs/GET";
import jobs_post_327 from "./api/jobs/POST";
import jobs_report_generate_post_328 from "./api/jobs/report/generate/POST";
import jobs_search_get_329 from "./api/jobs/search/GET";
import jobs_id_get_330 from "./api/jobs/[id]/GET";
import jobs_id_put_331 from "./api/jobs/[id]/PUT";
import jobs_id_attendance_attendanceId_close_post_332 from "./api/jobs/[id]/attendance/[attendanceId]/close/POST";
import jobs_id_costs_get_333 from "./api/jobs/[id]/costs/GET";
import jobs_id_costs_post_334 from "./api/jobs/[id]/costs/POST";
import jobs_id_costs_export_get_335 from "./api/jobs/[id]/costs/export/GET";
import jobs_id_costs_costId_delete_336 from "./api/jobs/[id]/costs/[costId]/DELETE";
import jobs_id_costs_costId_put_337 from "./api/jobs/[id]/costs/[costId]/PUT";
import jobs_id_costs_costId_receipt_get_338 from "./api/jobs/[id]/costs/[costId]/receipt/GET";
import jobs_id_costs_costId_receipt_post_339 from "./api/jobs/[id]/costs/[costId]/receipt/POST";
import jobs_id_delays_get_340 from "./api/jobs/[id]/delays/GET";
import jobs_id_delays_post_341 from "./api/jobs/[id]/delays/POST";
import jobs_id_delays_export_csv_get_342 from "./api/jobs/[id]/delays/export-csv/GET";
import jobs_id_delays_delayId_delete_343 from "./api/jobs/[id]/delays/[delayId]/DELETE";
...
import jobs_id_forms_get_350 from "./api/jobs/[id]/forms/GET";
import jobs_id_forms_post_351 from "./api/jobs/[id]/forms/POST";
import jobs_id_forms_export_csv_get_352 from "./api/jobs/[id]/forms/export-csv/GET";
import jobs_id_forms_submissionId_delete_353 from "./api/jobs/[id]/forms/[submissionId]/DELETE";
import jobs_id_forms_submissionId_reopen_post_354 from "./api/jobs/[id]/forms/[submissionId]/reopen/POST";
import jobs_id_generate_qr_post_355 from "./api/jobs/[id]/generate-qr/POST";
import jobs_id_ledger_get_356 from "./api/jobs/[id]/ledger/GET";
import jobs_id_ledger_post_357 from "./api/jobs/[id]/ledger/POST";
import jobs_id_ledger_export_get_358 from "./api/jobs/[id]/ledger/export/GET";
import jobs_id_ledger_sync_post_359 from "./api/jobs/[id]/ledger/sync/POST";
import jobs_id_ledger_entryId_delete_360 from "./api/jobs/[id]/ledger/[entryId]/DELETE";
import jobs_id_ledger_entryId_put_361 from "./api/jobs/[id]/ledger/[entryId]/PUT";
import jobs_id_ledger_entryId_correct_post_362 from "./api/jobs/[id]/ledger/[entryId]/correct/POST";
import jobs_id_milestones_get_363 from "./api/jobs/[id]/milestones/GET";
import jobs_id_milestones_post_364 from "./api/jobs/[id]/milestones/POST";
import jobs_id_milestones_milestoneId_delete_365 from "./api/jobs/[id]/milestones/[milestoneId]/DELETE";
import jobs_id_milestones_milestoneId_patch_366 from "./api/jobs/[id]/milestones/[milestoneId]/PATCH";
import jobs_id_notes_export_csv_get_367 from "./api/jobs/[id]/notes/export-csv/GET";
import jobs_id_photos_get_368 from "./api/jobs/[id]/photos/GET";
import jobs_id_photos_post_369 from "./api/jobs/[id]/photos/POST";
import jobs_id_photos_export_zip_post_370 from "./api/jobs/[id]/photos/export-zip/POST";
import jobs_id_photos_picker_get_371 from "./api/jobs/[id]/photos/picker/GET";
import jobs_id_photos_share_post_372 from "./api/jobs/[id]/photos/share/POST";
import jobs_id_photos_photoId_delete_373 from "./api/jobs/[id]/photos/[photoId]/DELETE";
import jobs_id_photos_photoId_patch_374 from "./api/jobs/[id]/photos/[photoId]/PATCH";
import jobs_id_photos_photoId_download_get_375 from "./api/jobs/[id]/photos/[photoId]/download/GET";
import jobs_id_photos_photoId_lock_post_376 from "./api/jobs/[id]/photos/[photoId]/lock/POST";
import jobs_id_photos_photoId_replace_post_377 from "./api/jobs/[id]/photos/[photoId]/replace/POST";
import jobs_id_photos_photoId_report_image_get_378 from "./api/jobs/[id]/photos/[photoId]/report-image/GET";
import jobs_id_progress_get_379 from "./api/jobs/[id]/progress/GET";
import jobs_id_progress_put_380 from "./api/jobs/[id]/progress/PUT";
import jobs_id_progress_export_csv_get_381 from "./api/jobs/[id]/progress/export-csv/GET";
import jobs_id_progress_report_get_382 from "./api/jobs/[id]/progress/report/GET";
import jobs_id_progress_report_put_383 from "./api/jobs/[id]/progress/report/PUT";
import jobs_id_progress_report_pdf_get_384 from "./api/jobs/[id]/progress/report/pdf/GET";
import jobs_id_progress_sync_post_385 from "./api/jobs/[id]/progress/sync/POST";
import jobs_id_purchase_orders_get_386 from "./api/jobs/[id]/purchase-orders/GET";
import jobs_id_purchase_orders_post_387 from "./api/jobs/[id]/purchase-orders/POST";
import jobs_id_purchase_orders_poId_delete_388 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import jobs_id_purchase_orders_poId_get_389 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
import jobs_id_purchase_orders_poId_put_390 from "./api/jobs/[id]/purchase-orders/[poId]/PUT";
import jobs_id_purchase_orders_poId_pdf_get_391 from "./api/jobs/[id]/purchase-orders/[poId]/pdf/GET";
import jobs_id_report_pdf_post_392 from "./api/jobs/[id]/report/pdf/POST";
import jobs_id_risky_get_393 from "./api/jobs/[id]/risky/GET";
import jobs_id_risky_post_394 from "./api/jobs/[id]/risky/POST";
import jobs_id_risky_riskyId_get_395 from "./api/jobs/[id]/risky/[riskyId]/GET";
import jobs_id_risky_riskyId_put_396 from "./api/jobs/[id]/risky/[riskyId]/PUT";
import jobs_id_risky_riskyId_finalise_post_397 from "./api/jobs/[id]/risky/[riskyId]/finalise/POST";
import jobs_id_risky_riskyId_signatures_post_398 from "./api/jobs/[id]/risky/[riskyId]/signatures/POST";
import jobs_id_risky_riskyId_supervisor_signoff_post_399 from "./api/jobs/[id]/risky/[riskyId]/supervisor-signoff/POST";
import jobs_id_signin_post_400 from "./api/jobs/[id]/signin/POST";
import jobs_id_signin_qr_post_401 from "./api/jobs/[id]/signin-qr/POST";
import jobs_id_signin_status_get_402 from "./api/jobs/[id]/signin-status/GET";
import jobs_id_signout_post_403 from "./api/jobs/[id]/signout/POST";
import jobs_id_signout_qr_post_404 from "./api/jobs/[id]/signout-qr/POST";
import jobs_id_signout_user_post_405 from "./api/jobs/[id]/signout-user/POST";
import jobs_id_site_prestarts_get_406 from "./api/jobs/[id]/site-prestarts/GET";
import jobs_id_site_prestarts_post_407 from "./api/jobs/[id]/site-prestarts/POST";
import jobs_id_site_prestarts_prestartId_get_408 from "./api/jobs/[id]/site-prestarts/[prestartId]/GET";
import jobs_id_site_prestarts_prestartId_put_409 from "./api/jobs/[id]/site-prestarts/[prestartId]/PUT";
import jobs_id_site_prestarts_prestartId_finalise_post_410 from "./api/jobs/[id]/site-prestarts/[prestartId]/finalise/POST";
import jobs_id_site_prestarts_prestartId_workers_post_411 from "./api/jobs/[id]/site-prestarts/[prestartId]/workers/POST";
import jobs_id_swms_get_412 from "./api/jobs/[id]/swms/GET";
import jobs_id_swms_post_413 from "./api/jobs/[id]/swms/POST";
import jobs_id_swms_swmsId_signoff_post_414 from "./api/jobs/[id]/swms/[swmsId]/signoff/POST";
import jobs_id_todos_get_415 from "./api/jobs/[id]/todos/GET";
import jobs_id_todos_post_416 from "./api/jobs/[id]/todos/POST";
import jobs_id_todos_todoId_delete_417 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import jobs_id_todos_todoId_put_418 from "./api/jobs/[id]/todos/[todoId]/PUT";
import library_items_get_419 from "./api/library/items/GET";
import library_items_id_get_420 from "./api/library/items/[id]/GET";
import library_items_id_patch_421 from "./api/library/items/[id]/PATCH";
import library_items_id_download_get_422 from "./api/library/items/[id]/download/GET";
import library_items_id_install_delete_423 from "./api/library/items/[id]/install/DELETE";
import library_items_id_install_post_424 from "./api/library/items/[id]/install/POST";
import library_my_installed_get_425 from "./api/library/my-installed/GET";
import library_my_submissions_get_426 from "./api/library/my-submissions/GET";
import lists_get_427 from "./api/lists/GET";
import me_get_428 from "./api/me/GET";
import me_put_429 from "./api/me/PUT";
import me_2fa_disable_post_430 from "./api/me/2fa/disable/POST";
import me_2fa_enable_post_431 from "./api/me/2fa/enable/POST";
import me_2fa_setup_get_432 from "./api/me/2fa/setup/GET";
import me_2fa_sms_disable_post_433 from "./api/me/2fa/sms/disable/POST";
import me_2fa_sms_enable_post_434 from "./api/me/2fa/sms/enable/POST";
import me_2fa_sms_send_post_435 from "./api/me/2fa/sms/send/POST";
import me_2fa_sms_send_setup_post_436 from "./api/me/2fa/sms/send-setup/POST";
import me_2fa_sms_verify_post_437 from "./api/me/2fa/sms/verify/POST";
import me_2fa_status_get_438 from "./api/me/2fa/status/GET";
import me_2fa_verify_post_439 from "./api/me/2fa/verify/POST";
import me_active_status_get_440 from "./api/me/active-status/GET";
import me_change_password_post_441 from "./api/me/change-password/POST";
import me_email_status_get_442 from "./api/me/email-status/GET";
import me_phone_get_443 from "./api/me/phone/GET";
import me_phone_put_444 from "./api/me/phone/PUT";
import me_profile_attachments_delete_445 from "./api/me/profile-attachments/DELETE";
import me_profile_attachments_post_446 from "./api/me/profile-attachments/POST";
import me_profile_attachments_download_get_447 from "./api/me/profile-attachments/download/GET";
import me_profile_attachments_thumbnail_get_448 from "./api/me/profile-attachments/thumbnail/GET";
import me_profile_extras_get_449 from "./api/me/profile-extras/GET";
import me_profile_extras_put_450 from "./api/me/profile-extras/PUT";
import migrate_account_recovery_post_451 from "./api/migrate-account-recovery/POST";
import migrate_asset_manager_post_452 from "./api/migrate-asset-manager/POST";
import migrate_attendance_post_453 from "./api/migrate-attendance/POST";
import migrate_photo_gps_post from "./api/migrate-photo-gps/POST";
import migrate_company_settings_post_454 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_455 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_456 from "./api/migrate-dazza-knowledge/POST";
import migrate_emergency_alerts_post_457 from "./api/migrate-emergency-alerts/POST";
import migrate_estimates_post_458 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_459 from "./api/migrate-estimating-library/POST";
import migrate_files_post_460 from "./api/migrate-files/POST";
import migrate_fleet_post_461 from "./api/migrate-fleet/POST";
import migrate_fleet_analytics_post_462 from "./api/migrate-fleet-analytics/POST";
import migrate_fleet_driver_sessions_post_463 from "./api/migrate-fleet-driver-sessions/POST";
import migrate_fleet_usage_post_464 from "./api/migrate-fleet-usage/POST";
import migrate_form_fields_post_465 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_466 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_467 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_468 from "./api/migrate-job-forms/POST";
import migrate_job_photo_shares_post_469 from "./api/migrate-job-photo-shares/POST";
import migrate_job_photos_post_470 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_471 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_472 from "./api/migrate-jobs/POST";
import migrate_ledger_photo_post_473 from "./api/migrate-ledger-photo/POST";
import migrate_library_post_474 from "./api/migrate-library/POST";
import migrate_library_downloads_post_475 from "./api/migrate-library-downloads/POST";
import migrate_notifications_post_476 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_477 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_478 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_479 from "./api/migrate-pdf-settings/POST";
import migrate_plan_manager_post_480 from "./api/migrate-plan-manager/POST";
import migrate_plan_manager_v2_post_481 from "./api/migrate-plan-manager-v2/POST";
import migrate_plan_manager_v3_post_482 from "./api/migrate-plan-manager-v3/POST";
import migrate_safety_post_483 from "./api/migrate-safety/POST";
import migrate_site_prestart_post_484 from "./api/migrate-site-prestart/POST";
import migrate_sms_verified_at_post_485 from "./api/migrate-sms-verified-at/POST";
import migrate_starter_pack_post_486 from "./api/migrate-starter-pack/POST";
import migrate_studio_pdf_post_487 from "./api/migrate-studio-pdf/POST";
import migrate_subscriptions_post_488 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_489 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_490 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_491 from "./api/migrate-team/POST";
import notes_get_492 from "./api/notes/GET";
import notes_post_493 from "./api/notes/POST";
import notes_comments_post_494 from "./api/notes/comments/POST";
import notes_migrate_post_495 from "./api/notes/migrate/POST";
import notes_id_delete_496 from "./api/notes/[id]/DELETE";
import notifications_alerts_get_497 from "./api/notifications/alerts/GET";
import notifications_prefs_get_498 from "./api/notifications/prefs/GET";
import notifications_prefs_put_499 from "./api/notifications/prefs/PUT";
import notifications_read_post_500 from "./api/notifications/read/POST";
import owner_console_activity_get_501 from "./api/owner-console/activity/GET";
import owner_console_cancellation_feedback_get_502 from "./api/owner-console/cancellation-feedback/GET";
import owner_console_companies_get_503 from "./api/owner-console/companies/GET";
import owner_console_companies_post_504 from "./api/owner-console/companies/POST";
import owner_console_companies_usage_get_505 from "./api/owner-console/companies/usage/GET";
import owner_console_companies_id_limits_put_506 from "./api/owner-console/companies/[id]/limits/PUT";
import owner_console_form_templates_get_507 from "./api/owner-console/form-templates/GET";
import owner_console_form_templates_post_508 from "./api/owner-console/form-templates/POST";
import owner_console_library_items_get_509 from "./api/owner-console/library/items/GET";
import owner_console_library_items_post_510 from "./api/owner-console/library/items/POST";
import owner_console_library_items_id_delete_511 from "./api/owner-console/library/items/[id]/DELETE";
import owner_console_library_items_id_patch_512 from "./api/owner-console/library/items/[id]/PATCH";
import owner_console_library_items_id_put_513 from "./api/owner-console/library/items/[id]/PUT";
import owner_console_library_items_id_push_update_post_514 from "./api/owner-console/library/items/[id]/push-update/POST";
import owner_console_library_submissions_get_515 from "./api/owner-console/library/submissions/GET";
import owner_console_library_submissions_id_review_post_516 from "./api/owner-console/library/submissions/[id]/review/POST";
import owner_console_starter_pack_get_517 from "./api/owner-console/starter-pack/GET";
import owner_console_starter_pack_post_518 from "./api/owner-console/starter-pack/POST";
import owner_console_stats_get_519 from "./api/owner-console/stats/GET";
import owner_console_storage_get_520 from "./api/owner-console/storage/GET";
import owner_console_swms_masters_get_521 from "./api/owner-console/swms/masters/GET";
import owner_console_swms_masters_post_522 from "./api/owner-console/swms/masters/POST";
import owner_console_swms_masters_publish_all_post_523 from "./api/owner-console/swms/masters/publish-all/POST";
import owner_console_swms_masters_id_delete_524 from "./api/owner-console/swms/masters/[id]/DELETE";
import owner_console_swms_masters_id_get_525 from "./api/owner-console/swms/masters/[id]/GET";
import owner_console_swms_masters_id_put_526 from "./api/owner-console/swms/masters/[id]/PUT";
import owner_console_swms_masters_id_publish_post_527 from "./api/owner-console/swms/masters/[id]/publish/POST";
import owner_console_swms_migrate_master_library_post_528 from "./api/owner-console/swms/migrate-master-library/POST";
import owner_console_swms_push_post_529 from "./api/owner-console/swms/push/POST";
import owner_console_swms_seed_bricklaying_post_530 from "./api/owner-console/swms/seed-bricklaying/POST";
import owner_console_swms_seed_building_inspection_post_531 from "./api/owner-console/swms/seed-building-inspection/POST";
import owner_console_swms_seed_cabinets_post_532 from "./api/owner-console/swms/seed-cabinets/POST";
import owner_console_swms_seed_carpenter_fixing_post_533 from "./api/owner-console/swms/seed-carpenter-fixing/POST";
import owner_console_swms_seed_carpenter_framing_post_534 from "./api/owner-console/swms/seed-carpenter-framing/POST";
import owner_console_swms_seed_carpenter_lockup_post_535 from "./api/owner-console/swms/seed-carpenter-lockup/POST";
import owner_console_swms_seed_ceramic_tiling_post_536 from "./api/owner-console/swms/seed-ceramic-tiling/POST";
import owner_console_swms_seed_concreting_slab_post_537 from "./api/owner-console/swms/seed-concreting-slab/POST";
import owner_console_swms_seed_delivery_loading_post_538 from "./api/owner-console/swms/seed-delivery-loading/POST";
import owner_console_swms_seed_environmental_spill_post_539 from "./api/owner-console/swms/seed-environmental-spill/POST";
import owner_console_swms_seed_ewp_post_540 from "./api/owner-console/swms/seed-ewp/POST";
import owner_console_swms_seed_excavations_substation_post_541 from "./api/owner-console/swms/seed-excavations-substation/POST";
import owner_console_swms_seed_fencing_post_542 from "./api/owner-console/swms/seed-fencing/POST";
import owner_console_swms_seed_heat_stress_post_543 from "./api/owner-console/swms/seed-heat-stress/POST";
import owner_console_swms_seed_landscaping_post_544 from "./api/owner-console/swms/seed-landscaping/POST";
import owner_console_swms_seed_live_parts_post_545 from "./api/owner-console/swms/seed-live-parts/POST";
import owner_console_swms_seed_manual_handling_post_546 from "./api/owner-console/swms/seed-manual-handling/POST";
import owner_console_swms_seed_moving_plant_post_547 from "./api/owner-console/swms/seed-moving-plant/POST";
import owner_console_swms_seed_painting_post_548 from "./api/owner-console/swms/seed-painting/POST";
import owner_console_swms_seed_power_tools_post_549 from "./api/owner-console/swms/seed-power-tools/POST";
import owner_console_swms_seed_silica_dust_post_550 from "./api/owner-console/swms/seed-silica-dust/POST";
import owner_console_swms_seed_traffic_management_post_551 from "./api/owner-console/swms/seed-traffic-management/POST";
import owner_console_swms_seed_underground_services_post_552 from "./api/owner-console/swms/seed-underground-services/POST";
import owner_console_swms_seed_vacuum_excavation_post_553 from "./api/owner-console/swms/seed-vacuum-excavation/POST";
import owner_console_system_ai_builtin_checks_post_554 from "./api/owner-console/system-ai/builtin-checks/POST";
import owner_console_users_get_555 from "./api/owner-console/users/GET";
import owner_console_users_verify_post_556 from "./api/owner-console/users/verify/POST";
import plan_manager_drawings_get_557 from "./api/plan-manager/drawings/GET";
import plan_manager_drawings_post_558 from "./api/plan-manager/drawings/POST";
import plan_manager_drawings_id_get_559 from "./api/plan-manager/drawings/[id]/GET";
import plan_manager_drawings_id_annotations_put_560 from "./api/plan-manager/drawings/[id]/annotations/PUT";
import plan_manager_drawings_id_archive_post_561 from "./api/plan-manager/drawings/[id]/archive/POST";
import plan_manager_drawings_id_job_links_delete_562 from "./api/plan-manager/drawings/[id]/job-links/DELETE";
import plan_manager_drawings_id_job_links_post_563 from "./api/plan-manager/drawings/[id]/job-links/POST";
import plan_manager_drawings_id_pages_pageNo_annotations_get_564 from "./api/plan-manager/drawings/[id]/pages/[pageNo]/annotations/GET";
import plan_manager_drawings_id_permanent_delete_565 from "./api/plan-manager/drawings/[id]/permanent/DELETE";
import plan_manager_drawings_id_reorder_patch_566 from "./api/plan-manager/drawings/[id]/reorder/PATCH";
import plan_manager_drawings_id_restore_post_567 from "./api/plan-manager/drawings/[id]/restore/POST";
import plan_manager_drawings_id_revisions_post_568 from "./api/plan-manager/drawings/[id]/revisions/POST";
import plan_manager_drawings_id_revisions_revisionId_finalize_post_569 from "./api/plan-manager/drawings/[id]/revisions/[revisionId]/finalize/POST";
...
import portal_invite_post_576 from "./api/portal/invite/POST";
import portal_invoices_id_pay_post_577 from "./api/portal/invoices/[id]/pay/POST";
import portal_jobs_get_578 from "./api/portal/jobs/GET";
import portal_jobs_id_get_579 from "./api/portal/jobs/[id]/GET";
import portal_migrate_post_580 from "./api/portal/migrate/POST";
import portal_validate_post_581 from "./api/portal/validate/POST";
import public_form_token_get_582 from "./api/public/form/[token]/GET";
import public_form_token_submit_post_583 from "./api/public/form/[token]/submit/POST";
import public_job_photos_token_get_584 from "./api/public/job-photos/[token]/GET";
import public_job_photos_token_photo_photoId_get_585 from "./api/public/job-photos/[token]/photo/[photoId]/GET";
import public_swms_token_get_586 from "./api/public/swms/[token]/GET";
import public_swms_token_signoff_post_587 from "./api/public/swms/[token]/signoff/POST";
import push_subscribe_delete_588 from "./api/push/subscribe/DELETE";
import push_subscribe_post_589 from "./api/push/subscribe/POST";
import push_vapid_key_get_590 from "./api/push/vapid-key/GET";
import quick_links_site_meta_get_591 from "./api/quick-links/site-meta/GET";
import recipes_get_592 from "./api/recipes/GET";
import recipes_post_593 from "./api/recipes/POST";
import recipes_id_delete_594 from "./api/recipes/[id]/DELETE";
import recipes_id_put_595 from "./api/recipes/[id]/PUT";
import risk_register_get_596 from "./api/risk-register/GET";
import risk_register_post_597 from "./api/risk-register/POST";
import risk_register_id_get_598 from "./api/risk-register/[id]/GET";
import risk_register_id_put_599 from "./api/risk-register/[id]/PUT";
import risk_register_id_archive_post_600 from "./api/risk-register/[id]/archive/POST";
import risk_register_id_unarchive_post_601 from "./api/risk-register/[id]/unarchive/POST";
import safety_ai_draft_post_602 from "./api/safety/ai/draft/POST";
import safety_documents_get_603 from "./api/safety/documents/GET";
import safety_documents_post_604 from "./api/safety/documents/POST";
import safety_documents_id_delete_605 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_606 from "./api/safety/documents/[id]/download/GET";
...
import safety_job_safety_plans_id_put_613 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_614 from "./api/safety/job-swms/GET";
import safety_job_swms_post_615 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_616 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_617 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_618 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_share_token_post_619 from "./api/safety/job-swms/[id]/share-token/POST";
import safety_job_swms_id_signoffs_get_620 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_621 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_622 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_623 from "./api/safety/plans/GET";
import safety_plans_post_624 from "./api/safety/plans/POST";
import safety_plans_seed_post_625 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_626 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_627 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_628 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_629 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_630 from "./api/safety/posters/GET";
import safety_posters_post_631 from "./api/safety/posters/POST";
import safety_posters_id_delete_632 from "./api/safety/posters/[id]/DELETE";
import safety_posters_id_download_get_633 from "./api/safety/posters/[id]/download/GET";
import safety_swms_get_634 from "./api/safety/swms/GET";
import safety_swms_post_635 from "./api/safety/swms/POST";
import safety_swms_import_docx_post_636 from "./api/safety/swms/import-docx/POST";
import safety_swms_seed_post_637 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_638 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_639 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_640 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_641 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_642 from "./api/safety/swms/[id]/export/GET";
import safety_swms_id_publish_to_library_post_643 from "./api/safety/swms/[id]/publish-to-library/POST";
import scheduler_crew_get_644 from "./api/scheduler/crew/GET";
import scheduler_jobs_get_645 from "./api/scheduler/jobs/GET";
import scheduler_jobs_id_reschedule_patch_646 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
...
import settings_backup_csv_pack_get_656 from "./api/settings/backup/csv-pack/GET";
import settings_backup_export_get_657 from "./api/settings/backup/export/GET";
import settings_backup_run_post_658 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_659 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_660 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_661 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_662 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_663 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_664 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_665 from "./api/settings/retention/GET";
import settings_retention_post_666 from "./api/settings/retention/POST";
import settings_storage_provider_get_667 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_668 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_669 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_670 from "./api/settings/terminology/GET";
import settings_terminology_post_671 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_672 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_673 from "./api/settings/xero-credentials/POST";
import share_token_get_674 from "./api/share/[token]/GET";
import signin_history_get_675 from "./api/signin-history/GET";
import signup_post_676 from "./api/signup/POST";
import sos_get_677 from "./api/sos/GET";
import sos_acknowledge_post_678 from "./api/sos/acknowledge/POST";
import sos_trigger_post_679 from "./api/sos/trigger/POST";
import stakeholders_sms_post_680 from "./api/stakeholders/sms/POST";
import stripe_create_checkout_session_post_681 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_682 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_683 from "./api/subscription/create-checkout/POST";
import subscription_status_get_684 from "./api/subscription/status/GET";
import subscription_webhook_post_685 from "./api/subscription/webhook/POST";
import support_mode_audit_get_686 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_687 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_688 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_689 from "./api/support-mode/enter/POST";
import support_mode_exit_post_690 from "./api/support-mode/exit/POST";
import support_mode_status_get_691 from "./api/support-mode/status/GET";
import tag_tasks_get_692 from "./api/tag-tasks/GET";
import tag_tasks_id_patch_693 from "./api/tag-tasks/[id]/PATCH";
import takeoff_pad_get_694 from "./api/takeoff-pad/GET";
import takeoff_pad_put_695 from "./api/takeoff-pad/PUT";
import tasks_post_696 from "./api/tasks/POST";
import tasks_id_put_697 from "./api/tasks/[id]/PUT";
import team_get_698 from "./api/team/GET";
import team_invite_post_699 from "./api/team/invite/POST";
import team_invites_get_700 from "./api/team/invites/GET";
import team_invites_post_701 from "./api/team/invites/POST";
import team_invites_id_cancel_post_702 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_703 from "./api/team/invites/[id]/resend/POST";
import team_members_get_704 from "./api/team/members/GET";
import team_members_id_icon_permissions_get_705 from "./api/team/members/[id]/icon-permissions/GET";
import team_members_id_icon_permissions_put_706 from "./api/team/members/[id]/icon-permissions/PUT";
import team_resend_verification_post_707 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_708 from "./api/team/schedule/migrate/POST";
import team_shifts_get_709 from "./api/team/shifts/GET";
import team_shifts_post_710 from "./api/team/shifts/POST";
import team_shifts_id_delete_711 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_712 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_713 from "./api/team/time-entries/GET";
import team_time_entries_post_714 from "./api/team/time-entries/POST";
import team_time_entries_export_get_715 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_716 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_717 from "./api/team/verify-user/POST";
import team_id_delete_718 from "./api/team/[id]/DELETE";
import team_id_put_719 from "./api/team/[id]/PUT";
import usage_get_720 from "./api/usage/GET";
import user_logs_get_721 from "./api/user-logs/GET";
import user_logs_users_get_722 from "./api/user-logs/users/GET";
// </api-imports>
// ── Job Cards ─────────────────────────────────────────────────────────────────
...
app.post("/api/developer/users/:id/assign-company", developer_users_id_assign_company_post_132);
app.post("/api/developer/users/:id/deactivate", developer_users_id_deactivate_post_133);
app.post("/api/developer/users/:id/delete-orphan", developer_users_id_delete_orphan_post_134);
app.post("/api/developer/users/:id/force-temp-password", developer_users_id_force_temp_password_post_135);
app.delete("/api/developer/users/:id/impersonate", developer_users_id_impersonate_delete_136);
app.post("/api/developer/users/:id/impersonate", developer_users_id_impersonate_post_137);
app.post("/api/developer/users/:id/reactivate", developer_users_id_reactivate_post_138);
app.post("/api/developer/users/:id/resend-verification", developer_users_id_resend_verification_post_139);
app.put("/api/developer/users/:id/role", developer_users_id_role_put_140);
app.post("/api/developer/users/:id/send-reset-email", developer_users_id_send_reset_email_post_141);
app.delete("/api/developer/users/:id/sessions", developer_users_id_sessions_delete_142);
app.get("/api/developer/users/:id/sessions", developer_users_id_sessions_get_143);
app.post("/api/developer/users/:id/unlock-account", developer_users_id_unlock_account_post_144);
app.post("/api/diag/recover-old-photos", diag_recover_old_photos_post_145);
app.get("/api/diag/self-test", diag_self_test_get_146);
app.post("/api/diag/upload-test", diag_upload_test_post_147);
app.get("/api/document-templates", document_templates_get_148);
app.post("/api/document-templates", document_templates_post_149);
app.delete("/api/document-templates/:id", document_templates_id_delete_150);
app.get("/api/document-templates/:id", document_templates_id_get_151);
app.put("/api/document-templates/:id", document_templates_id_put_152);
app.post("/api/document-templates/:id/duplicate", document_templates_id_duplicate_post_153);
app.get("/api/document-templates/:id/export/docx", document_templates_id_export_docx_get_154);
app.get("/api/document-templates/:id/export/pdf", document_templates_id_export_pdf_get_155);
app.post("/api/document-templates/:id/import-blocks", document_templates_id_import_blocks_post_156);
app.post("/api/document-templates/:id/import-docx", document_templates_id_import_docx_post_157);
app.post("/api/document-templates/:id/import-pdf", document_templates_id_import_pdf_post_158);
app.post("/api/document-templates/:id/publish-to-library", document_templates_id_publish_to_library_post_159);
app.get("/api/documents", documents_get_160);
app.get("/api/documents/share/:token", documents_share_token_get_161);
app.post("/api/documents/share/:token", documents_share_token_post_162);
app.get("/api/documents/:id", documents_id_get_163);
app.put("/api/documents/:id", documents_id_put_164);
app.get("/api/documents/:id/events", documents_id_events_get_165);
app.delete("/api/documents/:id/share", documents_id_share_delete_166);
app.post("/api/documents/:id/share", documents_id_share_post_167);
app.get("/api/drawings", drawings_get_168);
app.post("/api/drawings", drawings_post_169);
app.post("/api/drawings/upload", drawings_upload_post_170);
app.delete("/api/drawings/:id", drawings_id_delete_171);
app.patch("/api/drawings/:id", drawings_id_patch_172);
app.post("/api/drawings/:id/markup", drawings_id_markup_post_173);
app.get("/api/emergency-alerts", emergency_alerts_get_174);
app.post("/api/emergency-alerts", emergency_alerts_post_175);
app.put("/api/emergency-alerts/:id", emergency_alerts_id_put_176);
app.get("/api/estimates", estimates_get_177);
app.post("/api/estimates", estimates_post_178);
app.delete("/api/estimates/:id", estimates_id_delete_179);
app.get("/api/estimates/:id", estimates_id_get_180);
app.put("/api/estimates/:id", estimates_id_put_181);
...
app.post("/api/estimates/:id/send-email", estimates_id_send_email_post_184b);
...
app.post("/api/external/form/:token", external_form_token_post_188);
app.get("/api/files", files_get_189);
app.post("/api/files", files_post_190);
app.delete("/api/files/:id", files_id_delete_191);
app.get("/api/files/:id/download", files_id_download_get_192);
app.get("/api/fleet", fleet_get_193);
app.post("/api/fleet", fleet_post_194);
app.get("/api/fleet/analytics-settings", fleet_analytics_settings_get_195);
app.put("/api/fleet/analytics-settings", fleet_analytics_settings_put_196);
app.get("/api/fleet/asset-bookings", fleet_asset_bookings_get_197);
app.post("/api/fleet/asset-bookings", fleet_asset_bookings_post_198);
app.delete("/api/fleet/asset-bookings/:id", fleet_asset_bookings_id_delete_199);
app.patch("/api/fleet/asset-bookings/:id", fleet_asset_bookings_id_patch_200);
app.post("/api/fleet/driver-sessions", fleet_driver_sessions_post_201);
app.get("/api/fleet/driver-sessions/active", fleet_driver_sessions_active_get_202);
app.get("/api/fleet/driver-sessions/live", fleet_driver_sessions_live_get_203);
app.post("/api/fleet/driver-sessions/migrate-gps-status", fleet_driver_sessions_migrate_gps_status_post_204);
app.post("/api/fleet/driver-sessions/:id/heartbeat", fleet_driver_sessions_id_heartbeat_post_205);
app.post("/api/fleet/driver-sessions/:id/stop", fleet_driver_sessions_id_stop_post_206);
app.get("/api/fleet/driver-sessions/:id/summary", fleet_driver_sessions_id_summary_get_207);
app.post("/api/fleet/driver-sessions/:id/telemetry", fleet_driver_sessions_id_telemetry_post_208);
app.get("/api/fleet/driver-sessions/:id/telemetry/latest", fleet_driver_sessions_id_telemetry_latest_get_209);
app.get("/api/fleet/flags", fleet_flags_get_210);
app.get("/api/fleet/last-known-positions", fleet_last_known_positions_get_211);
app.delete("/api/fleet/service-logs/:logId", fleet_service_logs_logId_delete_212);
app.patch("/api/fleet/service-logs/:logId", fleet_service_logs_logId_patch_213);
app.get("/api/fleet/vehicles", fleet_vehicles_get_214);
app.delete("/api/fleet/:id", fleet_id_delete_215);
app.get("/api/fleet/:id", fleet_id_get_216);
app.put("/api/fleet/:id", fleet_id_put_217);
app.get("/api/fleet/:id/driver-sessions", fleet_id_driver_sessions_get_218);
app.post("/api/fleet/:id/driver-sessions/manual", fleet_id_driver_sessions_manual_post_219);
app.get("/api/fleet/:id/files", fleet_id_files_get_220);
app.get("/api/fleet/:id/prestarts", fleet_id_prestarts_get_221);
app.post("/api/fleet/:id/prestarts", fleet_id_prestarts_post_222);
app.get("/api/fleet/:id/service-logs", fleet_id_service_logs_get_223);
app.post("/api/fleet/:id/service-logs", fleet_id_service_logs_post_224);
app.post("/api/fleet/:id/signin", fleet_id_signin_post_225);
app.post("/api/fleet/:id/signout", fleet_id_signout_post_226);
app.get("/api/fleet/:id/usage-export", fleet_id_usage_export_get_227);
app.get("/api/fleet/:id/usage-status", fleet_id_usage_status_get_228);
app.get("/api/fleet/:id/usage-summary", fleet_id_usage_summary_get_229);
app.post("/api/form-attachments", form_attachments_post_230);
app.get("/api/form-global-lists", form_global_lists_get_231);
app.post("/api/form-global-lists", form_global_lists_post_232);
app.delete("/api/form-global-lists/:id", form_global_lists_id_delete_233);
app.put("/api/form-global-lists/:id", form_global_lists_id_put_234);
app.get("/api/form-templates", form_templates_get_235);
app.post("/api/form-templates", form_templates_post_236);
app.post("/api/form-templates/seed", form_templates_seed_post_237);
app.delete("/api/form-templates/:id", form_templates_id_delete_238);
app.put("/api/form-templates/:id", form_templates_id_put_239);
app.post("/api/form-templates/:id/publish-to-library", form_templates_id_publish_to_library_post_240);
app.get("/api/forms/assets-list", forms_assets_list_get_241);
app.get("/api/forms/jobs-list", forms_jobs_list_get_242);
app.post("/api/forms/migrate-skip-logic", forms_migrate_skip_logic_post_243);
app.get("/api/forms/skip-audit", forms_skip_audit_get_244);
...
app.delete("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_delete_252);
app.patch("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_patch_253);
app.post("/api/forms/:id/fields/:fieldId/thumbnail", forms_id_fields_fieldId_thumbnail_post_254);
app.get("/api/health", health_get_255);
app.get("/api/incidents", incidents_get_256);
app.post("/api/incidents", incidents_post_257);
app.post("/api/incidents/:id/archive", incidents_id_archive_post_258);
app.post("/api/incidents/:id/unarchive", incidents_id_unarchive_post_259);
app.get("/api/incidents/:incidentId", incidents_incidentId_get_260);
app.put("/api/incidents/:incidentId", incidents_incidentId_put_261);
app.get("/api/incidents/:incidentId/attachments", incidents_incidentId_attachments_get_262);
app.post("/api/incidents/:incidentId/attachments", incidents_incidentId_attachments_post_263);
app.delete("/api/incidents/:incidentId/attachments/:attachId", incidents_incidentId_attachments_attachId_delete_264);
app.post("/api/incidents/:incidentId/close", incidents_incidentId_close_post_265);
app.post("/api/incidents/:incidentId/corrective-actions", incidents_incidentId_corrective_actions_post_266);
app.put("/api/incidents/:incidentId/corrective-actions/:actionId", incidents_incidentId_corrective_actions_actionId_put_267);
app.get("/api/incidents/:incidentId/pdf", incidents_incidentId_pdf_get_268);
app.post("/api/incidents/:incidentId/third-parties", incidents_incidentId_third_parties_post_269);
app.delete("/api/incidents/:incidentId/third-parties/:thirdPartyId", incidents_incidentId_third_parties_thirdPartyId_delete_270);
app.get("/api/integrations/myob/auth-url", integrations_myob_auth_url_get_271);
app.get("/api/integrations/myob/callback", integrations_myob_callback_get_272);
app.post("/api/integrations/myob/disconnect", integrations_myob_disconnect_post_273);
app.get("/api/integrations/myob/status", integrations_myob_status_get_274);
app.post("/api/integrations/myob/sync-invoice", integrations_myob_sync_invoice_post_275);
app.get("/api/integrations/onedrive/auth-url", integrations_onedrive_auth_url_get_276);
app.get("/api/integrations/onedrive/callback", integrations_onedrive_callback_get_277);
app.post("/api/integrations/onedrive/disconnect", integrations_onedrive_disconnect_post_278);
app.get("/api/integrations/onedrive/status", integrations_onedrive_status_get_279);
app.post("/api/integrations/onedrive/upload-file", integrations_onedrive_upload_file_post_280);
app.get("/api/integrations/qbo/auth-url", integrations_qbo_auth_url_get_281);
app.get("/api/integrations/qbo/callback", integrations_qbo_callback_get_282);
app.post("/api/integrations/qbo/disconnect", integrations_qbo_disconnect_post_283);
app.get("/api/integrations/qbo/status", integrations_qbo_status_get_284);
app.post("/api/integrations/qbo/sync-invoice", integrations_qbo_sync_invoice_post_285);
app.get("/api/integrations/xero/auth-url", integrations_xero_auth_url_get_286);
app.get("/api/integrations/xero/callback", integrations_xero_callback_get_287);
app.post("/api/integrations/xero/disconnect", integrations_xero_disconnect_post_288);
app.get("/api/integrations/xero/status", integrations_xero_status_get_289);
app.post("/api/integrations/xero/sync-customer", integrations_xero_sync_customer_post_290);
app.post("/api/integrations/xero/sync-invoice", integrations_xero_sync_invoice_post_291);
app.post("/api/integrations/xero/webhook", integrations_xero_webhook_post_292);
app.get("/api/invoices", invoices_get_293);
app.post("/api/invoices", invoices_post_294);
app.delete("/api/invoices/:id", invoices_id_delete_295);
app.get("/api/invoices/:id", invoices_id_get_296);
...
app.patch("/api/invoices/:id/unlock", invoices_id_unlock_patch_303);
app.post("/api/invoices/:id/void", invoices_id_void_post_304);
app.get("/api/job-cards", job_cards_get_305);
app.post("/api/job-cards", job_cards_post_306);
app.delete("/api/job-cards/:id", job_cards_id_delete_307);
app.get("/api/job-cards/:id", job_cards_id_get_308);
app.put("/api/job-cards/:id", job_cards_id_put_309);
app.post("/api/job-cards/:id/convert", job_cards_id_convert_post_310);
app.post("/api/job-cards/:id/invoice", job_cards_id_invoice_post_311);
app.post("/api/job-cards/:id/photos", job_cards_id_photos_post_312);
app.delete("/api/job-cards/:id/photos/:photoId", job_cards_id_photos_photoId_delete_313);
app.patch("/api/job-cards/:id/photos/:photoId", job_cards_id_photos_photoId_patch_314);
app.get("/api/job-cards/:id/photos/:photoId/download", job_cards_id_photos_photoId_download_get_315);
app.post("/api/job-cards/:id/photos/:photoId/save-and-lock", job_cards_id_photos_photoId_save_and_lock_post_316);
app.post("/api/job-costs", job_costs_post_317);
app.delete("/api/job-forms/:id", job_forms_id_delete_318);
...
app.get("/api/jobs", jobs_get_326);
app.post("/api/jobs", jobs_post_327);
app.post("/api/jobs/report/generate", jobs_report_generate_post_328);
app.get("/api/jobs/search", jobs_search_get_329);
app.get("/api/jobs/:id", jobs_id_get_330);
app.put("/api/jobs/:id", jobs_id_put_331);
app.post("/api/jobs/:id/attendance/:attendanceId/close", jobs_id_attendance_attendanceId_close_post_332);
app.get("/api/jobs/:id/costs", jobs_id_costs_get_333);
app.post("/api/jobs/:id/costs", jobs_id_costs_post_334);
app.get("/api/jobs/:id/costs/export", jobs_id_costs_export_get_335);
app.delete("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_delete_336);
app.put("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_put_337);
app.get("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_get_338);
app.post("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_post_339);
app.get("/api/jobs/:id/delays", jobs_id_delays_get_340);
app.post("/api/jobs/:id/delays", jobs_id_delays_post_341);
app.get("/api/jobs/:id/delays/export-csv", jobs_id_delays_export_csv_get_342);
app.delete("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_delete_343);
...
app.get("/api/jobs/:id/forms", jobs_id_forms_get_350);
app.post("/api/jobs/:id/forms", jobs_id_forms_post_351);
app.get("/api/jobs/:id/forms/export-csv", jobs_id_forms_export_csv_get_352);
app.delete("/api/jobs/:id/forms/:submissionId", jobs_id_forms_submissionId_delete_353);
app.post("/api/jobs/:id/forms/:submissionId/reopen", jobs_id_forms_submissionId_reopen_post_354);
app.post("/api/jobs/:id/generate-qr", jobs_id_generate_qr_post_355);
app.get("/api/jobs/:id/ledger", jobs_id_ledger_get_356);
app.post("/api/jobs/:id/ledger", jobs_id_ledger_post_357);
app.get("/api/jobs/:id/ledger/export", jobs_id_ledger_export_get_358);
app.post("/api/jobs/:id/ledger/sync", jobs_id_ledger_sync_post_359);
app.delete("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_delete_360);
app.put("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_put_361);
app.post("/api/jobs/:id/ledger/:entryId/correct", jobs_id_ledger_entryId_correct_post_362);
app.get("/api/jobs/:id/milestones", jobs_id_milestones_get_363);
app.post("/api/jobs/:id/milestones", jobs_id_milestones_post_364);
app.delete("/api/jobs/:id/milestones/:milestoneId", jobs_id_milestones_milestoneId_delete_365);
app.patch("/api/jobs/:id/milestones/:milestoneId", jobs_id_milestones_milestoneId_patch_366);
app.get("/api/jobs/:id/notes/export-csv", jobs_id_notes_export_csv_get_367);
app.get("/api/jobs/:id/photos", jobs_id_photos_get_368);
app.post("/api/jobs/:id/photos", jobs_id_photos_post_369);
app.post("/api/jobs/:id/photos/export-zip", jobs_id_photos_export_zip_post_370);
app.get("/api/jobs/:id/photos/picker", jobs_id_photos_picker_get_371);
app.post("/api/jobs/:id/photos/share", jobs_id_photos_share_post_372);
app.delete("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_delete_373);
app.patch("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_patch_374);
app.get("/api/jobs/:id/photos/:photoId/download", jobs_id_photos_photoId_download_get_375);
app.post("/api/jobs/:id/photos/:photoId/lock", jobs_id_photos_photoId_lock_post_376);
app.post("/api/jobs/:id/photos/:photoId/replace", jobs_id_photos_photoId_replace_post_377);
app.get("/api/jobs/:id/photos/:photoId/report-image", jobs_id_photos_photoId_report_image_get_378);
app.get("/api/jobs/:id/progress", jobs_id_progress_get_379);
app.put("/api/jobs/:id/progress", jobs_id_progress_put_380);
app.get("/api/jobs/:id/progress/export-csv", jobs_id_progress_export_csv_get_381);
app.get("/api/jobs/:id/progress/report", jobs_id_progress_report_get_382);
app.put("/api/jobs/:id/progress/report", jobs_id_progress_report_put_383);
app.get("/api/jobs/:id/progress/report/pdf", jobs_id_progress_report_pdf_get_384);
app.post("/api/jobs/:id/progress/sync", jobs_id_progress_sync_post_385);
app.get("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_get_386);
app.post("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_post_387);
app.delete("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_delete_388);
app.get("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_get_389);
app.put("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_put_390);
app.get("/api/jobs/:id/purchase-orders/:poId/pdf", jobs_id_purchase_orders_poId_pdf_get_391);
app.post("/api/jobs/:id/report/pdf", jobs_id_report_pdf_post_392);
app.get("/api/jobs/:id/risky", jobs_id_risky_get_393);
app.post("/api/jobs/:id/risky", jobs_id_risky_post_394);
app.get("/api/jobs/:id/risky/:riskyId", jobs_id_risky_riskyId_get_395);
app.put("/api/jobs/:id/risky/:riskyId", jobs_id_risky_riskyId_put_396);
app.post("/api/jobs/:id/risky/:riskyId/finalise", jobs_id_risky_riskyId_finalise_post_397);
app.post("/api/jobs/:id/risky/:riskyId/signatures", jobs_id_risky_riskyId_signatures_post_398);
app.post("/api/jobs/:id/risky/:riskyId/supervisor-signoff", jobs_id_risky_riskyId_supervisor_signoff_post_399);
app.post("/api/jobs/:id/signin", jobs_id_signin_post_400);
app.post("/api/jobs/:id/signin-qr", jobs_id_signin_qr_post_401);
app.get("/api/jobs/:id/signin-status", jobs_id_signin_status_get_402);
app.post("/api/jobs/:id/signout", jobs_id_signout_post_403);
app.post("/api/jobs/:id/signout-qr", jobs_id_signout_qr_post_404);
app.post("/api/jobs/:id/signout-user", jobs_id_signout_user_post_405);
app.get("/api/jobs/:id/site-prestarts", jobs_id_site_prestarts_get_406);
app.post("/api/jobs/:id/site-prestarts", jobs_id_site_prestarts_post_407);
app.get("/api/jobs/:id/site-prestarts/:prestartId", jobs_id_site_prestarts_prestartId_get_408);
app.put("/api/jobs/:id/site-prestarts/:prestartId", jobs_id_site_prestarts_prestartId_put_409);
app.post("/api/jobs/:id/site-prestarts/:prestartId/finalise", jobs_id_site_prestarts_prestartId_finalise_post_410);
app.post("/api/jobs/:id/site-prestarts/:prestartId/workers", jobs_id_site_prestarts_prestartId_workers_post_411);
app.get("/api/jobs/:id/swms", jobs_id_swms_get_412);
app.post("/api/jobs/:id/swms", jobs_id_swms_post_413);
app.post("/api/jobs/:id/swms/:swmsId/signoff", jobs_id_swms_swmsId_signoff_post_414);
app.get("/api/jobs/:id/todos", jobs_id_todos_get_415);
app.post("/api/jobs/:id/todos", jobs_id_todos_post_416);
app.delete("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_delete_417);
app.put("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_put_418);
app.get("/api/library/items", library_items_get_419);
app.get("/api/library/items/:id", library_items_id_get_420);
app.patch("/api/library/items/:id", library_items_id_patch_421);
app.get("/api/library/items/:id/download", library_items_id_download_get_422);
app.delete("/api/library/items/:id/install", library_items_id_install_delete_423);
...
app.post("/api/me/2fa/enable", me_2fa_enable_post_431);
app.get("/api/me/2fa/setup", me_2fa_setup_get_432);
app.post("/api/me/2fa/sms/disable", me_2fa_sms_disable_post_433);
app.post("/api/me/2fa/sms/enable", me_2fa_sms_enable_post_434);
app.post("/api/me/2fa/sms/send", me_2fa_sms_send_post_435);
app.post("/api/me/2fa/sms/send-setup", me_2fa_sms_send_setup_post_436);
app.post("/api/me/2fa/sms/verify", me_2fa_sms_verify_post_437);
app.get("/api/me/2fa/status", me_2fa_status_get_438);
app.post("/api/me/2fa/verify", me_2fa_verify_post_439);
app.get("/api/me/active-status", me_active_status_get_440);
app.post("/api/me/change-password", me_change_password_post_441);
app.get("/api/me/email-status", me_email_status_get_442);
app.get("/api/me/phone", me_phone_get_443);
app.put("/api/me/phone", me_phone_put_444);
app.delete("/api/me/profile-attachments", me_profile_attachments_delete_445);
app.post("/api/me/profile-attachments", me_profile_attachments_post_446);
app.get("/api/me/profile-attachments/download", me_profile_attachments_download_get_447);
app.get("/api/me/profile-attachments/thumbnail", me_profile_attachments_thumbnail_get_448);
app.get("/api/me/profile-extras", me_profile_extras_get_449);
app.put("/api/me/profile-extras", me_profile_extras_put_450);
app.post("/api/migrate-account-recovery", migrate_account_recovery_post_451);
app.post("/api/migrate-asset-manager", migrate_asset_manager_post_452);
app.post("/api/migrate-attendance", migrate_attendance_post_453);
app.post("/api/migrate-photo-gps", migrate_photo_gps_post);
app.post("/api/migrate-company-settings", migrate_company_settings_post_454);
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_455);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_456);
app.post("/api/migrate-emergency-alerts", migrate_emergency_alerts_post_457);
app.post("/api/migrate-estimates", migrate_estimates_post_458);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_459);
app.post("/api/migrate-files", migrate_files_post_460);
app.post("/api/migrate-fleet", migrate_fleet_post_461);
app.post("/api/migrate-fleet-analytics", migrate_fleet_analytics_post_462);
app.post("/api/migrate-fleet-driver-sessions", migrate_fleet_driver_sessions_post_463);
app.post("/api/migrate-fleet-usage", migrate_fleet_usage_post_464);
app.post("/api/migrate-form-fields", migrate_form_fields_post_465);
app.post("/api/migrate-form-logic", migrate_form_logic_post_466);
app.post("/api/migrate-form-templates", migrate_form_templates_post_467);
app.post("/api/migrate-job-forms", migrate_job_forms_post_468);
app.post("/api/migrate-job-photo-shares", migrate_job_photo_shares_post_469);
app.post("/api/migrate-job-photos", migrate_job_photos_post_470);
app.post("/api/migrate-job-tabs", migrate_job_tabs_post_471);
app.post("/api/migrate-jobs", migrate_jobs_post_472);
app.post("/api/migrate-ledger-photo", migrate_ledger_photo_post_473);
app.post("/api/migrate-library", migrate_library_post_474);
app.post("/api/migrate-library-downloads", migrate_library_downloads_post_475);
app.post("/api/migrate-notifications", migrate_notifications_post_476);
app.post("/api/migrate-owner-console", migrate_owner_console_post_477);
app.post("/api/migrate-owner-role", migrate_owner_role_post_478);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_479);
app.post("/api/migrate-plan-manager", migrate_plan_manager_post_480);
app.post("/api/migrate-plan-manager-v2", migrate_plan_manager_v2_post_481);
app.post("/api/migrate-plan-manager-v3", migrate_plan_manager_v3_post_482);
app.post("/api/migrate-safety", migrate_safety_post_483);
app.post("/api/migrate-site-prestart", migrate_site_prestart_post_484);
app.post("/api/migrate-sms-verified-at", migrate_sms_verified_at_post_485);
app.post("/api/migrate-starter-pack", migrate_starter_pack_post_486);
app.post("/api/migrate-studio-pdf", migrate_studio_pdf_post_487);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_488);
app.post("/api/migrate-support-mode", migrate_support_mode_post_489);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_490);
app.post("/api/migrate-team", migrate_team_post_491);
app.get("/api/notes", notes_get_492);
app.post("/api/notes", notes_post_493);
app.post("/api/notes/comments", notes_comments_post_494);
app.post("/api/notes/migrate", notes_migrate_post_495);
app.delete("/api/notes/:id", notes_id_delete_496);
app.get("/api/notifications/alerts", notifications_alerts_get_497);
app.get("/api/notifications/prefs", notifications_prefs_get_498);
app.put("/api/notifications/prefs", notifications_prefs_put_499);
app.post("/api/notifications/read", notifications_read_post_500);
app.get("/api/owner-console/activity", owner_console_activity_get_501);
app.get("/api/owner-console/cancellation-feedback", owner_console_cancellation_feedback_get_502);
app.get("/api/owner-console/companies", owner_console_companies_get_503);
app.post("/api/owner-console/companies", owner_console_companies_post_504);
app.get("/api/owner-console/companies/usage", owner_console_companies_usage_get_505);
app.put("/api/owner-console/companies/:id/limits", owner_console_companies_id_limits_put_506);
app.get("/api/owner-console/form-templates", owner_console_form_templates_get_507);
app.post("/api/owner-console/form-templates", owner_console_form_templates_post_508);
app.get("/api/owner-console/library/items", owner_console_library_items_get_509);
app.post("/api/owner-console/library/items", owner_console_library_items_post_510);
app.delete("/api/owner-console/library/items/:id", owner_console_library_items_id_delete_511);
app.patch("/api/owner-console/library/items/:id", owner_console_library_items_id_patch_512);
app.put("/api/owner-console/library/items/:id", owner_console_library_items_id_put_513);
app.post("/api/owner-console/library/items/:id/push-update", owner_console_library_items_id_push_update_post_514);
app.get("/api/owner-console/library/submissions", owner_console_library_submissions_get_515);
app.post("/api/owner-console/library/submissions/:id/review", owner_console_library_submissions_id_review_post_516);
app.get("/api/owner-console/starter-pack", owner_console_starter_pack_get_517);
app.post("/api/owner-console/starter-pack", owner_console_starter_pack_post_518);
app.get("/api/owner-console/stats", owner_console_stats_get_519);
app.get("/api/owner-console/storage", owner_console_storage_get_520);
app.get("/api/owner-console/swms/masters", owner_console_swms_masters_get_521);
app.post("/api/owner-console/swms/masters", owner_console_swms_masters_post_522);
app.post("/api/owner-console/swms/masters/publish-all", owner_console_swms_masters_publish_all_post_523);
app.delete("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_delete_524);
app.get("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_get_525);
app.put("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_put_526);
app.post("/api/owner-console/swms/masters/:id/publish", owner_console_swms_masters_id_publish_post_527);
app.post("/api/owner-console/swms/migrate-master-library", owner_console_swms_migrate_master_library_post_528);
app.post("/api/owner-console/swms/push", owner_console_swms_push_post_529);
app.post("/api/owner-console/swms/seed-bricklaying", owner_console_swms_seed_bricklaying_post_530);
app.post("/api/owner-console/swms/seed-building-inspection", owner_console_swms_seed_building_inspection_post_531);
app.post("/api/owner-console/swms/seed-cabinets", owner_console_swms_seed_cabinets_post_532);
app.post("/api/owner-console/swms/seed-carpenter-fixing", owner_console_swms_seed_carpenter_fixing_post_533);
app.post("/api/owner-console/swms/seed-carpenter-framing", owner_console_swms_seed_carpenter_framing_post_534);
app.post("/api/owner-console/swms/seed-carpenter-lockup", owner_console_swms_seed_carpenter_lockup_post_535);
app.post("/api/owner-console/swms/seed-ceramic-tiling", owner_console_swms_seed_ceramic_tiling_post_536);
app.post("/api/owner-console/swms/seed-concreting-slab", owner_console_swms_seed_concreting_slab_post_537);
app.post("/api/owner-console/swms/seed-delivery-loading", owner_console_swms_seed_delivery_loading_post_538);
app.post("/api/owner-console/swms/seed-environmental-spill", owner_console_swms_seed_environmental_spill_post_539);
app.post("/api/owner-console/swms/seed-ewp", owner_console_swms_seed_ewp_post_540);
app.post("/api/owner-console/swms/seed-excavations-substation", owner_console_swms_seed_excavations_substation_post_541);
app.post("/api/owner-console/swms/seed-fencing", owner_console_swms_seed_fencing_post_542);
app.post("/api/owner-console/swms/seed-heat-stress", owner_console_swms_seed_heat_stress_post_543);
app.post("/api/owner-console/swms/seed-landscaping", owner_console_swms_seed_landscaping_post_544);
app.post("/api/owner-console/swms/seed-live-parts", owner_console_swms_seed_live_parts_post_545);
app.post("/api/owner-console/swms/seed-manual-handling", owner_console_swms_seed_manual_handling_post_546);
app.post("/api/owner-console/swms/seed-moving-plant", owner_console_swms_seed_moving_plant_post_547);
app.post("/api/owner-console/swms/seed-painting", owner_console_swms_seed_painting_post_548);
app.post("/api/owner-console/swms/seed-power-tools", owner_console_swms_seed_power_tools_post_549);
app.post("/api/owner-console/swms/seed-silica-dust", owner_console_swms_seed_silica_dust_post_550);
app.post("/api/owner-console/swms/seed-traffic-management", owner_console_swms_seed_traffic_management_post_551);
app.post("/api/owner-console/swms/seed-underground-services", owner_console_swms_seed_underground_services_post_552);
app.post("/api/owner-console/swms/seed-vacuum-excavation", owner_console_swms_seed_vacuum_excavation_post_553);
app.post("/api/owner-console/system-ai/builtin-checks", owner_console_system_ai_builtin_checks_post_554);
app.get("/api/owner-console/users", owner_console_users_get_555);
app.post("/api/owner-console/users/verify", owner_console_users_verify_post_556);
app.get("/api/plan-manager/drawings", plan_manager_drawings_get_557);
app.post("/api/plan-manager/drawings", plan_manager_drawings_post_558);
app.get("/api/plan-manager/drawings/:id", plan_manager_drawings_id_get_559);
app.put("/api/plan-manager/drawings/:id/annotations", plan_manager_drawings_id_annotations_put_560);
app.post("/api/plan-manager/drawings/:id/archive", plan_manager_drawings_id_archive_post_561);
app.delete("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_delete_562);
app.post("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_post_563);
app.get("/api/plan-manager/drawings/:id/pages/:pageNo/annotations", plan_manager_drawings_id_pages_pageNo_annotations_get_564);
app.delete("/api/plan-manager/drawings/:id/permanent", plan_manager_drawings_id_permanent_delete_565);
app.patch("/api/plan-manager/drawings/:id/reorder", plan_manager_drawings_id_reorder_patch_566);
app.post("/api/plan-manager/drawings/:id/restore", plan_manager_drawings_id_restore_post_567);
app.post("/api/plan-manager/drawings/:id/revisions", plan_manager_drawings_id_revisions_post_568);
app.post("/api/plan-manager/drawings/:id/revisions/:revisionId/finalize", plan_manager_drawings_id_revisions_revisionId_finalize_post_569);
...
app.post("/api/portal/invite", portal_invite_post_576);
app.post("/api/portal/invoices/:id/pay", portal_invoices_id_pay_post_577);
app.get("/api/portal/jobs", portal_jobs_get_578);
app.get("/api/portal/jobs/:id", portal_jobs_id_get_579);
app.post("/api/portal/migrate", portal_migrate_post_580);
app.post("/api/portal/validate", portal_validate_post_581);
app.get("/api/public/form/:token", public_form_token_get_582);
app.post("/api/public/form/:token/submit", public_form_token_submit_post_583);
app.get("/api/public/job-photos/:token", public_job_photos_token_get_584);
app.get("/api/public/job-photos/:token/photo/:photoId", public_job_photos_token_photo_photoId_get_585);
app.get("/api/public/swms/:token", public_swms_token_get_586);
app.post("/api/public/swms/:token/signoff", public_swms_token_signoff_post_587);
app.delete("/api/push/subscribe", push_subscribe_delete_588);
app.post("/api/push/subscribe", push_subscribe_post_589);
app.get("/api/push/vapid-key", push_vapid_key_get_590);
app.get("/api/quick-links/site-meta", quick_links_site_meta_get_591);
app.get("/api/recipes", recipes_get_592);
app.post("/api/recipes", recipes_post_593);
app.delete("/api/recipes/:id", recipes_id_delete_594);
app.put("/api/recipes/:id", recipes_id_put_595);
app.get("/api/risk-register", risk_register_get_596);
app.post("/api/risk-register", risk_register_post_597);
app.get("/api/risk-register/:id", risk_register_id_get_598);
app.put("/api/risk-register/:id", risk_register_id_put_599);
app.post("/api/risk-register/:id/archive", risk_register_id_archive_post_600);
app.post("/api/risk-register/:id/unarchive", risk_register_id_unarchive_post_601);
app.post("/api/safety/ai/draft", safety_ai_draft_post_602);
app.get("/api/safety/documents", safety_documents_get_603);
app.post("/api/safety/documents", safety_documents_post_604);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_605);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_606);
...
app.put("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_put_613);
app.get("/api/safety/job-swms", safety_job_swms_get_614);
app.post("/api/safety/job-swms", safety_job_swms_post_615);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_616);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_617);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_618);
app.post("/api/safety/job-swms/:id/share-token", safety_job_swms_id_share_token_post_619);
app.get("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_get_620);
app.post("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_post_621);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", safety_job_swms_id_signoffs_signoffId_delete_622);
app.get("/api/safety/plans", safety_plans_get_623);
app.post("/api/safety/plans", safety_plans_post_624);
app.post("/api/safety/plans/seed", safety_plans_seed_post_625);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_626);
app.put("/api/safety/plans/:id", safety_plans_id_put_627);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_628);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_629);
app.get("/api/safety/posters", safety_posters_get_630);
app.post("/api/safety/posters", safety_posters_post_631);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_632);
app.get("/api/safety/posters/:id/download", safety_posters_id_download_get_633);
app.get("/api/safety/swms", safety_swms_get_634);
app.post("/api/safety/swms", safety_swms_post_635);
app.post("/api/safety/swms/import-docx", safety_swms_import_docx_post_636);
app.post("/api/safety/swms/seed", safety_swms_seed_post_637);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_638);
app.get("/api/safety/swms/:id", safety_swms_id_get_639);
app.put("/api/safety/swms/:id", safety_swms_id_put_640);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_641);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_642);
app.post("/api/safety/swms/:id/publish-to-library", safety_swms_id_publish_to_library_post_643);
app.get("/api/scheduler/crew", scheduler_crew_get_644);
app.get("/api/scheduler/jobs", scheduler_jobs_get_645);
app.patch("/api/scheduler/jobs/:id/reschedule", scheduler_jobs_id_reschedule_patch_646);
...
app.get("/api/settings/backup/csv-pack", settings_backup_csv_pack_get_656);
app.get("/api/settings/backup/export", settings_backup_export_get_657);
app.post("/api/settings/backup/run", settings_backup_run_post_658);
app.get("/api/settings/backup-destination", settings_backup_destination_get_659);
app.post("/api/settings/backup-destination", settings_backup_destination_post_660);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_661);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_662);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_663);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_664);
app.get("/api/settings/retention", settings_retention_get_665);
app.post("/api/settings/retention", settings_retention_post_666);
app.get("/api/settings/storage-provider", settings_storage_provider_get_667);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_668);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_669);
app.get("/api/settings/terminology", settings_terminology_get_670);
app.post("/api/settings/terminology", settings_terminology_post_671);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_672);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_673);
app.get("/api/share/:token", share_token_get_674);
app.get("/api/signin-history", signin_history_get_675);
app.post("/api/signup", signup_post_676);
app.get("/api/sos", sos_get_677);
app.post("/api/sos/acknowledge", sos_acknowledge_post_678);
app.post("/api/sos/trigger", sos_trigger_post_679);
app.post("/api/stakeholders/sms", stakeholders_sms_post_680);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_681);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_682);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_683);
app.get("/api/subscription/status", subscription_status_get_684);
app.post("/api/subscription/webhook", subscription_webhook_post_685);
app.get("/api/support-mode/audit", support_mode_audit_get_686);
app.get("/api/support-mode/checklist", support_mode_checklist_get_687);
app.put("/api/support-mode/checklist", support_mode_checklist_put_688);
app.post("/api/support-mode/enter", support_mode_enter_post_689);
app.post("/api/support-mode/exit", support_mode_exit_post_690);
app.get("/api/support-mode/status", support_mode_status_get_691);
app.get("/api/tag-tasks", tag_tasks_get_692);
app.patch("/api/tag-tasks/:id", tag_tasks_id_patch_693);
app.get("/api/takeoff-pad", takeoff_pad_get_694);
app.put("/api/takeoff-pad", takeoff_pad_put_695);
app.post("/api/tasks", tasks_post_696);
app.put("/api/tasks/:id", tasks_id_put_697);
app.get("/api/team", team_get_698);
app.post("/api/team/invite", team_invite_post_699);
app.get("/api/team/invites", team_invites_get_700);
app.post("/api/team/invites", team_invites_post_701);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_702);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_703);
app.get("/api/team/members", team_members_get_704);
app.get("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_get_705);
app.put("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_put_706);
app.post("/api/team/resend-verification", team_resend_verification_post_707);
app.post("/api/team/schedule/migrate", team_schedule_migrate_post_708);
app.get("/api/team/shifts", team_shifts_get_709);
app.post("/api/team/shifts", team_shifts_post_710);
app.delete("/api/team/shifts/:id", team_shifts_id_delete_711);
app.put("/api/team/shifts/:id", team_shifts_id_put_712);
app.get("/api/team/time-entries", team_time_entries_get_713);
app.post("/api/team/time-entries", team_time_entries_post_714);
app.get("/api/team/time-entries/export", team_time_entries_export_get_715);
app.put("/api/team/time-entries/:id", team_time_entries_id_put_716);
app.post("/api/team/verify-user", team_verify_user_post_717);
app.delete("/api/team/:id", team_id_delete_718);
app.put("/api/team/:id", team_id_put_719);
app.get("/api/usage", usage_get_720);
app.get("/api/user-logs", user_logs_get_721);
app.get("/api/user-logs/users", user_logs_users_get_722);
// </api-registrations>
