...
import developer_delete_seeded_documents_post from "./api/developer/delete-seeded-documents/POST";
...
import owner_console_sources_documents_get_646 from "./api/owner-console/sources/documents/GET";
import owner_console_sources_documents_id_delete_647 from "./api/owner-console/sources/documents/[id]/DELETE";
import owner_console_sources_documents_id_patch_648 from "./api/owner-console/sources/documents/[id]/PATCH";
import owner_console_sources_forms_get_649 from "./api/owner-console/sources/forms/GET";
import owner_console_sources_forms_id_delete_650 from "./api/owner-console/sources/forms/[id]/DELETE";
import owner_console_sources_forms_id_patch_651 from "./api/owner-console/sources/forms/[id]/PATCH";
import owner_console_sources_swms_get_652 from "./api/owner-console/sources/swms/GET";
import owner_console_sources_swms_id_delete_653 from "./api/owner-console/sources/swms/[id]/DELETE";
import owner_console_sources_swms_id_patch_654 from "./api/owner-console/sources/swms/[id]/PATCH";
...
import secure_share_token_photos_get_815 from "./api/secure-share/[token]/photos/GET";
import settings_backup_get_816 from "./api/settings/backup/GET";
import settings_backup_post_817 from "./api/settings/backup/POST";
import settings_backup_company_data_get_818 from "./api/settings/backup/company-data/GET";
import settings_backup_csv_pack_get_819 from "./api/settings/backup/csv-pack/GET";
import settings_backup_export_get_820 from "./api/settings/backup/export/GET";
import settings_backup_run_post_821 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_822 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_823 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_824 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_825 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_826 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_827 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_828 from "./api/settings/retention/GET";
import settings_retention_post_829 from "./api/settings/retention/POST";
import settings_storage_provider_get_830 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_831 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_832 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_833 from "./api/settings/terminology/GET";
import settings_terminology_post_834 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_835 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_836 from "./api/settings/xero-credentials/POST";
import share_token_get_837 from "./api/share/[token]/GET";
import signin_history_get_838 from "./api/signin-history/GET";
import signup_post_839 from "./api/signup/POST";
import sos_get_840 from "./api/sos/GET";
import sos_acknowledge_post_841 from "./api/sos/acknowledge/POST";
import sos_trigger_post_842 from "./api/sos/trigger/POST";
import stakeholders_sms_post_843 from "./api/stakeholders/sms/POST";
import stripe_create_checkout_session_post_844 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_845 from "./api/stripe/session/[sessionId]/GET";
import studio_generate_from_safety_post_846 from "./api/studio/generate-from-safety/POST";
import studio_upload_image_post_847 from "./api/studio/upload-image/POST";
import subscription_create_checkout_post_848 from "./api/subscription/create-checkout/POST";
import subscription_status_get_849 from "./api/subscription/status/GET";
import subscription_webhook_post_850 from "./api/subscription/webhook/POST";
import support_mode_audit_get_851 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_852 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_853 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_854 from "./api/support-mode/enter/POST";
import support_mode_exit_post_855 from "./api/support-mode/exit/POST";
import support_mode_status_get_856 from "./api/support-mode/status/GET";
import tag_tasks_get_857 from "./api/tag-tasks/GET";
import tag_tasks_id_patch_858 from "./api/tag-tasks/[id]/PATCH";
import takeoff_pad_get_859 from "./api/takeoff-pad/GET";
import takeoff_pad_put_860 from "./api/takeoff-pad/PUT";
import tasks_post_861 from "./api/tasks/POST";
import tasks_id_put_862 from "./api/tasks/[id]/PUT";
import team_get_863 from "./api/team/GET";
import team_invite_post_864 from "./api/team/invite/POST";
import team_invites_get_865 from "./api/team/invites/GET";
import team_invites_post_866 from "./api/team/invites/POST";
import team_invites_id_cancel_post_867 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_868 from "./api/team/invites/[id]/resend/POST";
import team_members_get_869 from "./api/team/members/GET";
import team_members_id_icon_permissions_get_870 from "./api/team/members/[id]/icon-permissions/GET";
import team_members_id_icon_permissions_put_871 from "./api/team/members/[id]/icon-permissions/PUT";
import team_resend_verification_post_872 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_873 from "./api/team/schedule/migrate/POST";
import team_shifts_get_874 from "./api/team/shifts/GET";
...
import usage_get_885 from "./api/usage/GET";
import user_logs_get_886 from "./api/user-logs/GET";
import user_logs_users_get_887 from "./api/user-logs/users/GET";
import work_attendance_get_888 from "./api/work/attendance/GET";
import work_delays_get_889 from "./api/work/delays/GET";
import work_notes_get_890 from "./api/work/notes/GET";
import work_progress_get_891 from "./api/work/progress/GET";
import work_tasks_get_892 from "./api/work/tasks/GET";
// </api-imports>
// ── Job Cards ─────────────────────────────────────────────────────────────────
...
app.post("/api/developer/delete-seeded-documents", requirePlatformOwner, developer_delete_seeded_documents_post);
...
app.get("/api/owner-console/sources/documents", owner_console_sources_documents_get_646);
app.delete("/api/owner-console/sources/documents/:id", owner_console_sources_documents_id_delete_647);
app.patch("/api/owner-console/sources/documents/:id", owner_console_sources_documents_id_patch_648);
app.get("/api/owner-console/sources/forms", owner_console_sources_forms_get_649);
app.delete("/api/owner-console/sources/forms/:id", owner_console_sources_forms_id_delete_650);
app.patch("/api/owner-console/sources/forms/:id", owner_console_sources_forms_id_patch_651);
app.get("/api/owner-console/sources/swms", owner_console_sources_swms_get_652);
app.delete("/api/owner-console/sources/swms/:id", owner_console_sources_swms_id_delete_653);
app.patch("/api/owner-console/sources/swms/:id", owner_console_sources_swms_id_patch_654);
...
app.get("/api/secure-share/:token/photos", secure_share_token_photos_get_815);
app.get("/api/settings/backup", settings_backup_get_816);
app.post("/api/settings/backup", settings_backup_post_817);
app.get("/api/settings/backup/company-data", settings_backup_company_data_get_818);
app.get("/api/settings/backup/csv-pack", settings_backup_csv_pack_get_819);
app.get("/api/settings/backup/export", settings_backup_export_get_820);
app.post("/api/settings/backup/run", settings_backup_run_post_821);
app.get("/api/settings/backup-destination", settings_backup_destination_get_822);
app.post("/api/settings/backup-destination", settings_backup_destination_post_823);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_824);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_825);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_826);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_827);
app.get("/api/settings/retention", settings_retention_get_828);
app.post("/api/settings/retention", settings_retention_post_829);
app.get("/api/settings/storage-provider", settings_storage_provider_get_830);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_831);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_832);
app.get("/api/settings/terminology", settings_terminology_get_833);
app.post("/api/settings/terminology", settings_terminology_post_834);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_835);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_836);
app.get("/api/share/:token", share_token_get_837);
app.get("/api/signin-history", signin_history_get_838);
app.post("/api/signup", signup_post_839);
app.get("/api/sos", sos_get_840);
app.post("/api/sos/acknowledge", sos_acknowledge_post_841);
app.post("/api/sos/trigger", sos_trigger_post_842);
app.post("/api/stakeholders/sms", stakeholders_sms_post_843);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_844);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_845);
app.post("/api/studio/generate-from-safety", studio_generate_from_safety_post_846);
app.post("/api/studio/upload-image", studio_upload_image_post_847);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_848);
app.get("/api/subscription/status", subscription_status_get_849);
app.post("/api/subscription/webhook", subscription_webhook_post_850);
app.get("/api/support-mode/audit", support_mode_audit_get_851);
app.get("/api/support-mode/checklist", support_mode_checklist_get_852);
app.put("/api/support-mode/checklist", support_mode_checklist_put_853);
app.post("/api/support-mode/enter", support_mode_enter_post_854);
app.post("/api/support-mode/exit", support_mode_exit_post_855);
app.get("/api/support-mode/status", support_mode_status_get_856);
app.get("/api/tag-tasks", tag_tasks_get_857);
app.patch("/api/tag-tasks/:id", tag_tasks_id_patch_858);
app.get("/api/takeoff-pad", takeoff_pad_get_859);
app.put("/api/takeoff-pad", takeoff_pad_put_860);
app.post("/api/tasks", tasks_post_861);
app.put("/api/tasks/:id", tasks_id_put_862);
app.get("/api/team", team_get_863);
app.post("/api/team/invite", team_invite_post_864);
app.get("/api/team/invites", team_invites_get_865);
app.post("/api/team/invites", team_invites_post_866);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_867);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_868);
app.get("/api/team/members", team_members_get_869);
app.get("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_get_870);
app.put("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_put_871);
app.post("/api/team/resend-verification", team_resend_verification_post_872);
app.post("/api/team/schedule/migrate", team_schedule_migrate_post_873);
app.get("/api/team/shifts", team_shifts_get_874);
...
app.get("/api/usage", usage_get_885);
app.get("/api/user-logs", user_logs_get_886);
app.get("/api/user-logs/users", user_logs_users_get_887);
app.get("/api/work/attendance", work_attendance_get_888);
app.get("/api/work/delays", work_delays_get_889);
app.get("/api/work/notes", work_notes_get_890);
app.get("/api/work/progress", work_progress_get_891);
app.get("/api/work/tasks", work_tasks_get_892);
// </api-registrations>
