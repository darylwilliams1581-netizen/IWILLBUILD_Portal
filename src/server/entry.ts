...
import public_form_token_get_307 from "./api/public/form/[token]/GET";
import public_form_token_submit_post_308 from "./api/public/form/[token]/submit/POST";
import public_swms_token_get_309 from "./api/public/swms/[token]/GET";
import public_swms_token_signoff_post_310 from "./api/public/swms/[token]/signoff/POST";
import recipes_get_311 from "./api/recipes/GET";
import recipes_post_312 from "./api/recipes/POST";
import recipes_id_delete_313 from "./api/recipes/[id]/DELETE";
import recipes_id_put_314 from "./api/recipes/[id]/PUT";
...
import safety_plans_seed_post_338 from "./api/safety/plans/seed/POST";
...
import safety_swms_seed_post_348 from "./api/safety/swms/seed/POST";
...
import scheduler_crew_get_354 from "./api/scheduler/crew/GET";
import scheduler_jobs_get_355 from "./api/scheduler/jobs/GET";
import scheduler_jobs_id_reschedule_patch_356 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
import secure_share_get_357 from "./api/secure-share/GET";
import secure_share_post_358 from "./api/secure-share/POST";
import secure_share_id_delete_359 from "./api/secure-share/[id]/DELETE";
import secure_share_token_get_360 from "./api/secure-share/[token]/GET";
import secure_share_token_post_361 from "./api/secure-share/[token]/POST";
...
import share_token_get_381 from "./api/share/[token]/GET";
import signup_post_382 from "./api/signup/POST";
import stripe_create_checkout_session_post_383 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_384 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_385 from "./api/subscription/create-checkout/POST";
import subscription_status_get_386 from "./api/subscription/status/GET";
import subscription_webhook_post_387 from "./api/subscription/webhook/POST";
import support_mode_audit_get_388 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_389 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_390 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_391 from "./api/support-mode/enter/POST";
import support_mode_exit_post_392 from "./api/support-mode/exit/POST";
import support_mode_status_get_393 from "./api/support-mode/status/GET";
import takeoff_pad_get_394 from "./api/takeoff-pad/GET";
import takeoff_pad_put_395 from "./api/takeoff-pad/PUT";
import team_get_396 from "./api/team/GET";
import team_invite_post_397 from "./api/team/invite/POST";
import team_invites_get_398 from "./api/team/invites/GET";
import team_invites_post_399 from "./api/team/invites/POST";
import team_invites_id_cancel_post_400 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_401 from "./api/team/invites/[id]/resend/POST";
import team_members_get_402 from "./api/team/members/GET";
import team_resend_verification_post_403 from "./api/team/resend-verification/POST";
import team_verify_user_post_404 from "./api/team/verify-user/POST";
import team_id_delete_405 from "./api/team/[id]/DELETE";
import team_id_put_406 from "./api/team/[id]/PUT";
import usage_get_407 from "./api/usage/GET";
// </api-imports>
...
app.get("/api/public/form/:token", public_form_token_get_307);
app.post("/api/public/form/:token/submit", public_form_token_submit_post_308);
app.get("/api/public/swms/:token", public_swms_token_get_309);
app.post("/api/public/swms/:token/signoff", public_swms_token_signoff_post_310);
app.get("/api/recipes", recipes_get_311);
app.post("/api/recipes", recipes_post_312);
app.delete("/api/recipes/:id", recipes_id_delete_313);
app.put("/api/recipes/:id", recipes_id_put_314);
...
app.post("/api/safety/plans/seed", safety_plans_seed_post_338);
...
app.post("/api/safety/swms/seed", safety_swms_seed_post_348);
...
app.get("/api/scheduler/crew", scheduler_crew_get_354);
app.get("/api/scheduler/jobs", scheduler_jobs_get_355);
app.patch("/api/scheduler/jobs/:id/reschedule", scheduler_jobs_id_reschedule_patch_356);
app.get("/api/secure-share", secure_share_get_357);
app.post("/api/secure-share", secure_share_post_358);
app.delete("/api/secure-share/:id", secure_share_id_delete_359);
app.get("/api/secure-share/:token", secure_share_token_get_360);
app.post("/api/secure-share/:token", secure_share_token_post_361);
...
app.get("/api/share/:token", share_token_get_381);
app.post("/api/signup", signup_post_382);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_383);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_384);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_385);
app.get("/api/subscription/status", subscription_status_get_386);
app.post("/api/subscription/webhook", subscription_webhook_post_387);
app.get("/api/support-mode/audit", support_mode_audit_get_388);
app.get("/api/support-mode/checklist", support_mode_checklist_get_389);
app.put("/api/support-mode/checklist", support_mode_checklist_put_390);
app.post("/api/support-mode/enter", support_mode_enter_post_391);
app.post("/api/support-mode/exit", support_mode_exit_post_392);
app.get("/api/support-mode/status", support_mode_status_get_393);
app.get("/api/takeoff-pad", takeoff_pad_get_394);
app.put("/api/takeoff-pad", takeoff_pad_put_395);
app.get("/api/team", team_get_396);
app.post("/api/team/invite", team_invite_post_397);
app.get("/api/team/invites", team_invites_get_398);
app.post("/api/team/invites", team_invites_post_399);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_400);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_401);
app.get("/api/team/members", team_members_get_402);
app.post("/api/team/resend-verification", team_resend_verification_post_403);
app.post("/api/team/verify-user", team_verify_user_post_404);
app.delete("/api/team/:id", team_id_delete_405);
app.put("/api/team/:id", team_id_put_406);
app.get("/api/usage", usage_get_407);
// </api-registrations>
