...
import incidents_id_archive_post_249 from "./api/incidents/[id]/archive/POST";
import incidents_id_unarchive_post_250 from "./api/incidents/[id]/unarchive/POST";
import incidents_incidentId_get_251 from "./api/incidents/[incidentId]/GET";
import incidents_incidentId_put_252 from "./api/incidents/[incidentId]/PUT";
import incidents_incidentId_close_post_253 from "./api/incidents/[incidentId]/close/POST";
import incidents_incidentId_corrective_actions_post_254 from "./api/incidents/[incidentId]/corrective-actions/POST";
import incidents_incidentId_corrective_actions_actionId_put_255 from "./api/incidents/[incidentId]/corrective-actions/[actionId]/PUT";
import incidents_incidentId_third_parties_post_256 from "./api/incidents/[incidentId]/third-parties/POST";
import incidents_incidentId_third_parties_thirdPartyId_delete_257 from "./api/incidents/[incidentId]/third-parties/[thirdPartyId]/DELETE";
import integrations_myob_auth_url_get_258 from "./api/integrations/myob/auth-url/GET";
import integrations_myob_callback_get_259 from "./api/integrations/myob/callback/GET";
import integrations_myob_disconnect_post_260 from "./api/integrations/myob/disconnect/POST";
import integrations_myob_status_get_261 from "./api/integrations/myob/status/GET";
import integrations_myob_sync_invoice_post_262 from "./api/integrations/myob/sync-invoice/POST";
import integrations_onedrive_auth_url_get_263 from "./api/integrations/onedrive/auth-url/GET";
import integrations_onedrive_callback_get_264 from "./api/integrations/onedrive/callback/GET";
import integrations_onedrive_disconnect_post_265 from "./api/integrations/onedrive/disconnect/POST";
import integrations_onedrive_status_get_266 from "./api/integrations/onedrive/status/GET";
import integrations_onedrive_upload_file_post_267 from "./api/integrations/onedrive/upload-file/POST";
import integrations_qbo_auth_url_get_268 from "./api/integrations/qbo/auth-url/GET";
import integrations_qbo_callback_get_269 from "./api/integrations/qbo/callback/GET";
import integrations_qbo_disconnect_post_270 from "./api/integrations/qbo/disconnect/POST";
import integrations_qbo_status_get_271 from "./api/integrations/qbo/status/GET";
import integrations_qbo_sync_invoice_post_272 from "./api/integrations/qbo/sync-invoice/POST";
import integrations_xero_auth_url_get_273 from "./api/integrations/xero/auth-url/GET";
import integrations_xero_callback_get_274 from "./api/integrations/xero/callback/GET";
import integrations_xero_disconnect_post_275 from "./api/integrations/xero/disconnect/POST";
import integrations_xero_status_get_276 from "./api/integrations/xero/status/GET";
import integrations_xero_sync_customer_post_277 from "./api/integrations/xero/sync-customer/POST";
import integrations_xero_sync_invoice_post_278 from "./api/integrations/xero/sync-invoice/POST";
import integrations_xero_webhook_post_279 from "./api/integrations/xero/webhook/POST";
import invoices_get_280 from "./api/invoices/GET";
import invoices_post_281 from "./api/invoices/POST";
import invoices_id_delete_282 from "./api/invoices/[id]/DELETE";
import invoices_id_get_283 from "./api/invoices/[id]/GET";
import invoices_id_put_284 from "./api/invoices/[id]/PUT";
import invoices_id_duplicate_post_285 from "./api/invoices/[id]/duplicate/POST";
import invoices_id_export_pdf_get_286 from "./api/invoices/[id]/export-pdf/GET";
import invoices_id_mark_sent_post_287 from "./api/invoices/[id]/mark-sent/POST";
import invoices_id_record_payment_post_288 from "./api/invoices/[id]/record-payment/POST";
import invoices_id_send_email_post_289 from "./api/invoices/[id]/send-email/POST";
import invoices_id_unlock_patch_290 from "./api/invoices/[id]/unlock/PATCH";
import invoices_id_void_post_291 from "./api/invoices/[id]/void/POST";
import job_cards_get_292 from "./api/job-cards/GET";
import job_cards_post_293 from "./api/job-cards/POST";
import job_cards_id_delete_294 from "./api/job-cards/[id]/DELETE";
import job_cards_id_get_295 from "./api/job-cards/[id]/GET";
import job_cards_id_put_296 from "./api/job-cards/[id]/PUT";
import job_cards_id_convert_post_297 from "./api/job-cards/[id]/convert/POST";
import job_cards_id_invoice_post_298 from "./api/job-cards/[id]/invoice/POST";
import job_cards_id_photos_post_299 from "./api/job-cards/[id]/photos/POST";
import job_cards_id_photos_photoId_delete_300 from "./api/job-cards/[id]/photos/[photoId]/DELETE";
import job_costs_post_301 from "./api/job-costs/POST";
import job_forms_id_delete_302 from "./api/job-forms/[id]/DELETE";
import job_forms_id_get_303 from "./api/job-forms/[id]/GET";
import job_forms_id_put_304 from "./api/job-forms/[id]/PUT";
import job_forms_id_reset_post_305 from "./api/job-forms/[id]/reset/POST";
import job_forms_id_share_delete_306 from "./api/job-forms/[id]/share/DELETE";
import job_forms_id_share_get_307 from "./api/job-forms/[id]/share/GET";
import job_forms_id_share_post_308 from "./api/job-forms/[id]/share/POST";
import jobs_get_309 from "./api/jobs/GET";
import jobs_post_310 from "./api/jobs/POST";
import jobs_report_generate_post_311 from "./api/jobs/report/generate/POST";
import jobs_id_get_312 from "./api/jobs/[id]/GET";
import jobs_id_put_313 from "./api/jobs/[id]/PUT";
import jobs_id_attendance_attendanceId_close_post_314 from "./api/jobs/[id]/attendance/[attendanceId]/close/POST";
import jobs_id_costs_get_315 from "./api/jobs/[id]/costs/GET";
import jobs_id_costs_post_316 from "./api/jobs/[id]/costs/POST";
import jobs_id_costs_export_get_317 from "./api/jobs/[id]/costs/export/GET";
import jobs_id_costs_costId_delete_318 from "./api/jobs/[id]/costs/[costId]/DELETE";
import jobs_id_costs_costId_put_319 from "./api/jobs/[id]/costs/[costId]/PUT";
import jobs_id_costs_costId_receipt_get_320 from "./api/jobs/[id]/costs/[costId]/receipt/GET";
import jobs_id_costs_costId_receipt_post_321 from "./api/jobs/[id]/costs/[costId]/receipt/POST";
import jobs_id_delays_get_322 from "./api/jobs/[id]/delays/GET";
import jobs_id_delays_post_323 from "./api/jobs/[id]/delays/POST";
import jobs_id_delays_export_csv_get_324 from "./api/jobs/[id]/delays/export-csv/GET";
import jobs_id_delays_delayId_delete_325 from "./api/jobs/[id]/delays/[delayId]/DELETE";
import jobs_id_delays_delayId_put_326 from "./api/jobs/[id]/delays/[delayId]/PUT";
import jobs_id_documents_get_327 from "./api/jobs/[id]/documents/GET";
import jobs_id_documents_post_328 from "./api/jobs/[id]/documents/POST";
import jobs_id_export_zip_get_329 from "./api/jobs/[id]/export-zip/GET";
import jobs_id_field_docs_get_330 from "./api/jobs/[id]/field-docs/GET";
import jobs_id_files_get_331 from "./api/jobs/[id]/files/GET";
import jobs_id_forms_get_332 from "./api/jobs/[id]/forms/GET";
import jobs_id_forms_post_333 from "./api/jobs/[id]/forms/POST";
import jobs_id_forms_export_csv_get_334 from "./api/jobs/[id]/forms/export-csv/GET";
import jobs_id_forms_submissionId_delete_335 from "./api/jobs/[id]/forms/[submissionId]/DELETE";
import jobs_id_forms_submissionId_reopen_post_336 from "./api/jobs/[id]/forms/[submissionId]/reopen/POST";
import jobs_id_generate_qr_post_337 from "./api/jobs/[id]/generate-qr/POST";
import jobs_id_ledger_get_338 from "./api/jobs/[id]/ledger/GET";
import jobs_id_ledger_post_339 from "./api/jobs/[id]/ledger/POST";
import jobs_id_ledger_export_get_340 from "./api/jobs/[id]/ledger/export/GET";
import jobs_id_ledger_sync_post_341 from "./api/jobs/[id]/ledger/sync/POST";
import jobs_id_ledger_entryId_delete_342 from "./api/jobs/[id]/ledger/[entryId]/DELETE";
import jobs_id_ledger_entryId_put_343 from "./api/jobs/[id]/ledger/[entryId]/PUT";
import jobs_id_ledger_entryId_correct_post_344 from "./api/jobs/[id]/ledger/[entryId]/correct/POST";
import jobs_id_milestones_get_345 from "./api/jobs/[id]/milestones/GET";
import jobs_id_milestones_post_346 from "./api/jobs/[id]/milestones/POST";
import jobs_id_milestones_milestoneId_delete_347 from "./api/jobs/[id]/milestones/[milestoneId]/DELETE";
import jobs_id_milestones_milestoneId_patch_348 from "./api/jobs/[id]/milestones/[milestoneId]/PATCH";
import jobs_id_notes_export_csv_get_349 from "./api/jobs/[id]/notes/export-csv/GET";
import jobs_id_photos_get_350 from "./api/jobs/[id]/photos/GET";
import jobs_id_photos_post_351 from "./api/jobs/[id]/photos/POST";
import jobs_id_photos_export_zip_post_352 from "./api/jobs/[id]/photos/export-zip/POST";
import jobs_id_photos_picker_get_353 from "./api/jobs/[id]/photos/picker/GET";
import jobs_id_photos_share_post_354 from "./api/jobs/[id]/photos/share/POST";
import jobs_id_photos_photoId_delete_355 from "./api/jobs/[id]/photos/[photoId]/DELETE";
import jobs_id_photos_photoId_patch_356 from "./api/jobs/[id]/photos/[photoId]/PATCH";
import jobs_id_photos_photoId_download_get_357 from "./api/jobs/[id]/photos/[photoId]/download/GET";
import jobs_id_photos_photoId_replace_post_358 from "./api/jobs/[id]/photos/[photoId]/replace/POST";
import jobs_id_photos_photoId_report_image_get_359 from "./api/jobs/[id]/photos/[photoId]/report-image/GET";
import jobs_id_progress_get_360 from "./api/jobs/[id]/progress/GET";
import jobs_id_progress_put_361 from "./api/jobs/[id]/progress/PUT";
import jobs_id_progress_export_csv_get_362 from "./api/jobs/[id]/progress/export-csv/GET";
import jobs_id_progress_report_get_363 from "./api/jobs/[id]/progress/report/GET";
import jobs_id_progress_report_put_364 from "./api/jobs/[id]/progress/report/PUT";
import jobs_id_progress_report_pdf_get_365 from "./api/jobs/[id]/progress/report/pdf/GET";
import jobs_id_progress_sync_post_366 from "./api/jobs/[id]/progress/sync/POST";
import jobs_id_purchase_orders_get_367 from "./api/jobs/[id]/purchase-orders/GET";
import jobs_id_purchase_orders_post_368 from "./api/jobs/[id]/purchase-orders/POST";
import jobs_id_purchase_orders_poId_delete_369 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import jobs_id_purchase_orders_poId_get_370 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
import jobs_id_purchase_orders_poId_put_371 from "./api/jobs/[id]/purchase-orders/[poId]/PUT";
import jobs_id_purchase_orders_poId_pdf_get_372 from "./api/jobs/[id]/purchase-orders/[poId]/pdf/GET";
import jobs_id_report_pdf_post_373 from "./api/jobs/[id]/report/pdf/POST";
import jobs_id_risky_get_374 from "./api/jobs/[id]/risky/GET";
import jobs_id_risky_post_375 from "./api/jobs/[id]/risky/POST";
import jobs_id_risky_riskyId_get_376 from "./api/jobs/[id]/risky/[riskyId]/GET";
import jobs_id_risky_riskyId_put_377 from "./api/jobs/[id]/risky/[riskyId]/PUT";
import jobs_id_risky_riskyId_finalise_post_378 from "./api/jobs/[id]/risky/[riskyId]/finalise/POST";
import jobs_id_risky_riskyId_signatures_post_379 from "./api/jobs/[id]/risky/[riskyId]/signatures/POST";
import jobs_id_risky_riskyId_supervisor_signoff_post_380 from "./api/jobs/[id]/risky/[riskyId]/supervisor-signoff/POST";
import jobs_id_signin_post_381 from "./api/jobs/[id]/signin/POST";
import jobs_id_signin_qr_post_382 from "./api/jobs/[id]/signin-qr/POST";
import jobs_id_signin_status_get_383 from "./api/jobs/[id]/signin-status/GET";
import jobs_id_signout_post_384 from "./api/jobs/[id]/signout/POST";
import jobs_id_signout_qr_post_385 from "./api/jobs/[id]/signout-qr/POST";
import jobs_id_signout_user_post_386 from "./api/jobs/[id]/signout-user/POST";
import jobs_id_site_prestarts_get_387 from "./api/jobs/[id]/site-prestarts/GET";
import jobs_id_site_prestarts_post_388 from "./api/jobs/[id]/site-prestarts/POST";
import jobs_id_site_prestarts_prestartId_get_389 from "./api/jobs/[id]/site-prestarts/[prestartId]/GET";
import jobs_id_site_prestarts_prestartId_put_390 from "./api/jobs/[id]/site-prestarts/[prestartId]/PUT";
import jobs_id_site_prestarts_prestartId_finalise_post_391 from "./api/jobs/[id]/site-prestarts/[prestartId]/finalise/POST";
import jobs_id_site_prestarts_prestartId_workers_post_392 from "./api/jobs/[id]/site-prestarts/[prestartId]/workers/POST";
import jobs_id_swms_get_393 from "./api/jobs/[id]/swms/GET";
import jobs_id_swms_post_394 from "./api/jobs/[id]/swms/POST";
import jobs_id_swms_swmsId_signoff_post_395 from "./api/jobs/[id]/swms/[swmsId]/signoff/POST";
import jobs_id_todos_get_396 from "./api/jobs/[id]/todos/GET";
import jobs_id_todos_post_397 from "./api/jobs/[id]/todos/POST";
import jobs_id_todos_todoId_delete_398 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import jobs_id_todos_todoId_put_399 from "./api/jobs/[id]/todos/[todoId]/PUT";
import library_items_get_400 from "./api/library/items/GET";
import library_items_id_get_401 from "./api/library/items/[id]/GET";
import library_items_id_patch_402 from "./api/library/items/[id]/PATCH";
import library_items_id_download_get_403 from "./api/library/items/[id]/download/GET";
import library_items_id_install_delete_404 from "./api/library/items/[id]/install/DELETE";
import library_items_id_install_post_405 from "./api/library/items/[id]/install/POST";
import library_my_installed_get_406 from "./api/library/my-installed/GET";
import library_my_submissions_get_407 from "./api/library/my-submissions/GET";
import lists_get_408 from "./api/lists/GET";
import me_get_409 from "./api/me/GET";
import me_put_410 from "./api/me/PUT";
import me_2fa_disable_post_411 from "./api/me/2fa/disable/POST";
import me_2fa_enable_post_412 from "./api/me/2fa/enable/POST";
import me_2fa_setup_get_413 from "./api/me/2fa/setup/GET";
import me_2fa_status_get_414 from "./api/me/2fa/status/GET";
import me_2fa_verify_post_415 from "./api/me/2fa/verify/POST";
import me_active_status_get_416 from "./api/me/active-status/GET";
import me_change_password_post_417 from "./api/me/change-password/POST";
import me_email_status_get_418 from "./api/me/email-status/GET";
import me_phone_get_419 from "./api/me/phone/GET";
import me_phone_put_420 from "./api/me/phone/PUT";
import me_profile_attachments_delete_421 from "./api/me/profile-attachments/DELETE";
import me_profile_attachments_post_422 from "./api/me/profile-attachments/POST";
...
import migrate_dazza_audit_post_429 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_430 from "./api/migrate-dazza-knowledge/POST";
import migrate_emergency_alerts_post_431 from "./api/migrate-emergency-alerts/POST";
import migrate_estimates_post_432 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_433 from "./api/migrate-estimating-library/POST";
import migrate_files_post_434 from "./api/migrate-files/POST";
import migrate_fleet_post_435 from "./api/migrate-fleet/POST";
import migrate_fleet_analytics_post_436 from "./api/migrate-fleet-analytics/POST";
import migrate_fleet_driver_sessions_post_437 from "./api/migrate-fleet-driver-sessions/POST";
import migrate_fleet_usage_post_438 from "./api/migrate-fleet-usage/POST";
import migrate_form_fields_post_439 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_440 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_441 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_442 from "./api/migrate-job-forms/POST";
import migrate_job_photo_shares_post_443 from "./api/migrate-job-photo-shares/POST";
import migrate_job_photos_post_444 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_445 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_446 from "./api/migrate-jobs/POST";
import migrate_ledger_photo_post_447 from "./api/migrate-ledger-photo/POST";
import migrate_library_post_448 from "./api/migrate-library/POST";
import migrate_library_downloads_post_449 from "./api/migrate-library-downloads/POST";
import migrate_notifications_post_450 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_451 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_452 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_453 from "./api/migrate-pdf-settings/POST";
import migrate_plan_manager_post_454 from "./api/migrate-plan-manager/POST";
import migrate_plan_manager_v2_post_455 from "./api/migrate-plan-manager-v2/POST";
import migrate_plan_manager_v3_post_456 from "./api/migrate-plan-manager-v3/POST";
import migrate_safety_post_457 from "./api/migrate-safety/POST";
import migrate_site_prestart_post_458 from "./api/migrate-site-prestart/POST";
import migrate_starter_pack_post_459 from "./api/migrate-starter-pack/POST";
import migrate_studio_pdf_post_460 from "./api/migrate-studio-pdf/POST";
import migrate_subscriptions_post_461 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_462 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_463 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_464 from "./api/migrate-team/POST";
import notes_get_465 from "./api/notes/GET";
import notes_post_466 from "./api/notes/POST";
import notes_comments_post_467 from "./api/notes/comments/POST";
import notes_migrate_post_468 from "./api/notes/migrate/POST";
import notes_id_delete_469 from "./api/notes/[id]/DELETE";
import notifications_alerts_get_470 from "./api/notifications/alerts/GET";
import notifications_prefs_get_471 from "./api/notifications/prefs/GET";
import notifications_prefs_put_472 from "./api/notifications/prefs/PUT";
import notifications_read_post_473 from "./api/notifications/read/POST";
import owner_console_activity_get_474 from "./api/owner-console/activity/GET";
import owner_console_cancellation_feedback_get_475 from "./api/owner-console/cancellation-feedback/GET";
import owner_console_companies_get_476 from "./api/owner-console/companies/GET";
import owner_console_companies_post_477 from "./api/owner-console/companies/POST";
import owner_console_companies_usage_get_478 from "./api/owner-console/companies/usage/GET";
import owner_console_companies_id_limits_put_479 from "./api/owner-console/companies/[id]/limits/PUT";
import owner_console_form_templates_get_480 from "./api/owner-console/form-templates/GET";
import owner_console_form_templates_post_481 from "./api/owner-console/form-templates/POST";
import owner_console_library_items_get_482 from "./api/owner-console/library/items/GET";
import owner_console_library_items_post_483 from "./api/owner-console/library/items/POST";
import owner_console_library_items_id_delete_484 from "./api/owner-console/library/items/[id]/DELETE";
import owner_console_library_items_id_patch_485 from "./api/owner-console/library/items/[id]/PATCH";
import owner_console_library_items_id_put_486 from "./api/owner-console/library/items/[id]/PUT";
import owner_console_library_items_id_push_update_post_487 from "./api/owner-console/library/items/[id]/push-update/POST";
import owner_console_library_submissions_get_488 from "./api/owner-console/library/submissions/GET";
import owner_console_library_submissions_id_review_post_489 from "./api/owner-console/library/submissions/[id]/review/POST";
import owner_console_starter_pack_get_490 from "./api/owner-console/starter-pack/GET";
import owner_console_starter_pack_post_491 from "./api/owner-console/starter-pack/POST";
import owner_console_stats_get_492 from "./api/owner-console/stats/GET";
import owner_console_storage_get_493 from "./api/owner-console/storage/GET";
import owner_console_swms_masters_get_494 from "./api/owner-console/swms/masters/GET";
import owner_console_swms_masters_post_495 from "./api/owner-console/swms/masters/POST";
import owner_console_swms_masters_publish_all_post_496 from "./api/owner-console/swms/masters/publish-all/POST";
import owner_console_swms_masters_id_delete_497 from "./api/owner-console/swms/masters/[id]/DELETE";
import owner_console_swms_masters_id_get_498 from "./api/owner-console/swms/masters/[id]/GET";
import owner_console_swms_masters_id_put_499 from "./api/owner-console/swms/masters/[id]/PUT";
import owner_console_swms_masters_id_publish_post_500 from "./api/owner-console/swms/masters/[id]/publish/POST";
import owner_console_swms_migrate_master_library_post_501 from "./api/owner-console/swms/migrate-master-library/POST";
import owner_console_swms_push_post_502 from "./api/owner-console/swms/push/POST";
import owner_console_swms_seed_bricklaying_post_503 from "./api/owner-console/swms/seed-bricklaying/POST";
import owner_console_swms_seed_building_inspection_post_504 from "./api/owner-console/swms/seed-building-inspection/POST";
import owner_console_swms_seed_cabinets_post_505 from "./api/owner-console/swms/seed-cabinets/POST";
import owner_console_swms_seed_carpenter_fixing_post_506 from "./api/owner-console/swms/seed-carpenter-fixing/POST";
import owner_console_swms_seed_carpenter_framing_post_507 from "./api/owner-console/swms/seed-carpenter-framing/POST";
import owner_console_swms_seed_carpenter_lockup_post_508 from "./api/owner-console/swms/seed-carpenter-lockup/POST";
import owner_console_swms_seed_ceramic_tiling_post_509 from "./api/owner-console/swms/seed-ceramic-tiling/POST";
import owner_console_swms_seed_concreting_slab_post_510 from "./api/owner-console/swms/seed-concreting-slab/POST";
import owner_console_swms_seed_delivery_loading_post_511 from "./api/owner-console/swms/seed-delivery-loading/POST";
import owner_console_swms_seed_environmental_spill_post_512 from "./api/owner-console/swms/seed-environmental-spill/POST";
import owner_console_swms_seed_ewp_post_513 from "./api/owner-console/swms/seed-ewp/POST";
import owner_console_swms_seed_excavations_substation_post_514 from "./api/owner-console/swms/seed-excavations-substation/POST";
import owner_console_swms_seed_fencing_post_515 from "./api/owner-console/swms/seed-fencing/POST";
import owner_console_swms_seed_heat_stress_post_516 from "./api/owner-console/swms/seed-heat-stress/POST";
import owner_console_swms_seed_landscaping_post_517 from "./api/owner-console/swms/seed-landscaping/POST";
import owner_console_swms_seed_live_parts_post_518 from "./api/owner-console/swms/seed-live-parts/POST";
import owner_console_swms_seed_manual_handling_post_519 from "./api/owner-console/swms/seed-manual-handling/POST";
import owner_console_swms_seed_moving_plant_post_520 from "./api/owner-console/swms/seed-moving-plant/POST";
import owner_console_swms_seed_painting_post_521 from "./api/owner-console/swms/seed-painting/POST";
import owner_console_swms_seed_power_tools_post_522 from "./api/owner-console/swms/seed-power-tools/POST";
import owner_console_swms_seed_silica_dust_post_523 from "./api/owner-console/swms/seed-silica-dust/POST";
import owner_console_swms_seed_traffic_management_post_524 from "./api/owner-console/swms/seed-traffic-management/POST";
import owner_console_swms_seed_underground_services_post_525 from "./api/owner-console/swms/seed-underground-services/POST";
import owner_console_swms_seed_vacuum_excavation_post_526 from "./api/owner-console/swms/seed-vacuum-excavation/POST";
import owner_console_system_ai_builtin_checks_post_527 from "./api/owner-console/system-ai/builtin-checks/POST";
import owner_console_users_get_528 from "./api/owner-console/users/GET";
import owner_console_users_verify_post_529 from "./api/owner-console/users/verify/POST";
import plan_manager_drawings_get_530 from "./api/plan-manager/drawings/GET";
import plan_manager_drawings_post_531 from "./api/plan-manager/drawings/POST";
import plan_manager_drawings_id_get_532 from "./api/plan-manager/drawings/[id]/GET";
import plan_manager_drawings_id_annotations_put_533 from "./api/plan-manager/drawings/[id]/annotations/PUT";
import plan_manager_drawings_id_archive_post_534 from "./api/plan-manager/drawings/[id]/archive/POST";
import plan_manager_drawings_id_job_links_delete_535 from "./api/plan-manager/drawings/[id]/job-links/DELETE";
import plan_manager_drawings_id_job_links_post_536 from "./api/plan-manager/drawings/[id]/job-links/POST";
import plan_manager_drawings_id_pages_pageNo_annotations_get_537 from "./api/plan-manager/drawings/[id]/pages/[pageNo]/annotations/GET";
import plan_manager_drawings_id_permanent_delete_538 from "./api/plan-manager/drawings/[id]/permanent/DELETE";
import plan_manager_drawings_id_reorder_patch_539 from "./api/plan-manager/drawings/[id]/reorder/PATCH";
import plan_manager_drawings_id_restore_post_540 from "./api/plan-manager/drawings/[id]/restore/POST";
import plan_manager_drawings_id_revisions_post_541 from "./api/plan-manager/drawings/[id]/revisions/POST";
...
import portal_invite_post_548 from "./api/portal/invite/POST";
import portal_invoices_id_pay_post_549 from "./api/portal/invoices/[id]/pay/POST";
import portal_jobs_get_550 from "./api/portal/jobs/GET";
import portal_jobs_id_get_551 from "./api/portal/jobs/[id]/GET";
import portal_migrate_post_552 from "./api/portal/migrate/POST";
import portal_validate_post_553 from "./api/portal/validate/POST";
import public_form_token_get_554 from "./api/public/form/[token]/GET";
import public_form_token_submit_post_555 from "./api/public/form/[token]/submit/POST";
import public_job_photos_token_get_556 from "./api/public/job-photos/[token]/GET";
import public_job_photos_token_photo_photoId_get_557 from "./api/public/job-photos/[token]/photo/[photoId]/GET";
import public_swms_token_get_558 from "./api/public/swms/[token]/GET";
import public_swms_token_signoff_post_559 from "./api/public/swms/[token]/signoff/POST";
import push_subscribe_delete_560 from "./api/push/subscribe/DELETE";
import push_subscribe_post_561 from "./api/push/subscribe/POST";
import push_vapid_key_get_562 from "./api/push/vapid-key/GET";
import quick_links_site_meta_get_563 from "./api/quick-links/site-meta/GET";
import recipes_get_564 from "./api/recipes/GET";
import recipes_post_565 from "./api/recipes/POST";
import recipes_id_delete_566 from "./api/recipes/[id]/DELETE";
import recipes_id_put_567 from "./api/recipes/[id]/PUT";
import risk_register_get_568 from "./api/risk-register/GET";
import risk_register_post_569 from "./api/risk-register/POST";
import risk_register_id_get_570 from "./api/risk-register/[id]/GET";
import risk_register_id_put_571 from "./api/risk-register/[id]/PUT";
import risk_register_id_archive_post_572 from "./api/risk-register/[id]/archive/POST";
import risk_register_id_unarchive_post_573 from "./api/risk-register/[id]/unarchive/POST";
import safety_ai_draft_post_574 from "./api/safety/ai/draft/POST";
import safety_documents_get_575 from "./api/safety/documents/GET";
import safety_documents_post_576 from "./api/safety/documents/POST";
import safety_documents_id_delete_577 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_578 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_579 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_580 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_581 from "./api/safety/generated-posters/[id]/DELETE";
import safety_job_safety_plans_get_582 from "./api/safety/job-safety-plans/GET";
import safety_job_safety_plans_post_583 from "./api/safety/job-safety-plans/POST";
import safety_job_safety_plans_id_delete_584 from "./api/safety/job-safety-plans/[id]/DELETE";
import safety_job_safety_plans_id_put_585 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_586 from "./api/safety/job-swms/GET";
import safety_job_swms_post_587 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_588 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_589 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_590 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_share_token_post_591 from "./api/safety/job-swms/[id]/share-token/POST";
import safety_job_swms_id_signoffs_get_592 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_593 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_594 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_595 from "./api/safety/plans/GET";
import safety_plans_post_596 from "./api/safety/plans/POST";
import safety_plans_seed_post_597 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_598 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_599 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_600 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_601 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_602 from "./api/safety/posters/GET";
import safety_posters_post_603 from "./api/safety/posters/POST";
import safety_posters_id_delete_604 from "./api/safety/posters/[id]/DELETE";
import safety_swms_get_605 from "./api/safety/swms/GET";
import safety_swms_post_606 from "./api/safety/swms/POST";
import safety_swms_import_docx_post_607 from "./api/safety/swms/import-docx/POST";
import safety_swms_seed_post_608 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_609 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_610 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_611 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_612 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_613 from "./api/safety/swms/[id]/export/GET";
import safety_swms_id_publish_to_library_post_614 from "./api/safety/swms/[id]/publish-to-library/POST";
import scheduler_crew_get_615 from "./api/scheduler/crew/GET";
import scheduler_jobs_get_616 from "./api/scheduler/jobs/GET";
import scheduler_jobs_id_reschedule_patch_617 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
import scheduler_tasks_get_618 from "./api/scheduler/tasks/GET";
import secure_share_get_619 from "./api/secure-share/GET";
import secure_share_post_620 from "./api/secure-share/POST";
import secure_share_id_delete_621 from "./api/secure-share/[id]/DELETE";
import secure_share_token_get_622 from "./api/secure-share/[token]/GET";
import secure_share_token_post_623 from "./api/secure-share/[token]/POST";
import settings_backup_get_624 from "./api/settings/backup/GET";
import settings_backup_post_625 from "./api/settings/backup/POST";
import settings_backup_company_data_get_626 from "./api/settings/backup/company-data/GET";
import settings_backup_csv_pack_get_627 from "./api/settings/backup/csv-pack/GET";
import settings_backup_export_get_628 from "./api/settings/backup/export/GET";
import settings_backup_run_post_629 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_630 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_631 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_632 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_633 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_634 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_635 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_636 from "./api/settings/retention/GET";
import settings_retention_post_637 from "./api/settings/retention/POST";
import settings_storage_provider_get_638 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_639 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_640 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_641 from "./api/settings/terminology/GET";
import settings_terminology_post_642 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_643 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_644 from "./api/settings/xero-credentials/POST";
import share_token_get_645 from "./api/share/[token]/GET";
import signin_history_get_646 from "./api/signin-history/GET";
import signup_post_647 from "./api/signup/POST";
import sos_get_648 from "./api/sos/GET";
import sos_acknowledge_post_649 from "./api/sos/acknowledge/POST";
import sos_trigger_post_650 from "./api/sos/trigger/POST";
import stakeholders_sms_post_651 from "./api/stakeholders/sms/POST";
import stripe_create_checkout_session_post_652 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_653 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_654 from "./api/subscription/create-checkout/POST";
import subscription_status_get_655 from "./api/subscription/status/GET";
import subscription_webhook_post_656 from "./api/subscription/webhook/POST";
import support_mode_audit_get_657 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_658 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_659 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_660 from "./api/support-mode/enter/POST";
import support_mode_exit_post_661 from "./api/support-mode/exit/POST";
import support_mode_status_get_662 from "./api/support-mode/status/GET";
import tag_tasks_get_663 from "./api/tag-tasks/GET";
import tag_tasks_id_patch_664 from "./api/tag-tasks/[id]/PATCH";
import takeoff_pad_get_665 from "./api/takeoff-pad/GET";
import takeoff_pad_put_666 from "./api/takeoff-pad/PUT";
import tasks_post_667 from "./api/tasks/POST";
import tasks_id_put_668 from "./api/tasks/[id]/PUT";
import team_get_669 from "./api/team/GET";
import team_invite_post_670 from "./api/team/invite/POST";
import team_invites_get_671 from "./api/team/invites/GET";
import team_invites_post_672 from "./api/team/invites/POST";
import team_invites_id_cancel_post_673 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_674 from "./api/team/invites/[id]/resend/POST";
import team_members_get_675 from "./api/team/members/GET";
import team_members_id_icon_permissions_get_676 from "./api/team/members/[id]/icon-permissions/GET";
import team_members_id_icon_permissions_put_677 from "./api/team/members/[id]/icon-permissions/PUT";
import team_resend_verification_post_678 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_679 from "./api/team/schedule/migrate/POST";
import team_shifts_get_680 from "./api/team/shifts/GET";
import team_shifts_post_681 from "./api/team/shifts/POST";
import team_shifts_id_delete_682 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_683 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_684 from "./api/team/time-entries/GET";
import team_time_entries_post_685 from "./api/team/time-entries/POST";
import team_time_entries_export_get_686 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_687 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_688 from "./api/team/verify-user/POST";
import team_id_delete_689 from "./api/team/[id]/DELETE";
import team_id_put_690 from "./api/team/[id]/PUT";
import usage_get_691 from "./api/usage/GET";
import user_logs_get_692 from "./api/user-logs/GET";
import user_logs_users_get_693 from "./api/user-logs/users/GET";
// </api-imports>
// ── Job Cards ─────────────────────────────────────────────────────────────────
...
app.post("/api/incidents/:id/archive", incidents_id_archive_post_249);
app.post("/api/incidents/:id/unarchive", incidents_id_unarchive_post_250);
app.get("/api/incidents/:incidentId", incidents_incidentId_get_251);
app.put("/api/incidents/:incidentId", incidents_incidentId_put_252);
app.post("/api/incidents/:incidentId/close", incidents_incidentId_close_post_253);
app.post("/api/incidents/:incidentId/corrective-actions", incidents_incidentId_corrective_actions_post_254);
app.put("/api/incidents/:incidentId/corrective-actions/:actionId", incidents_incidentId_corrective_actions_actionId_put_255);
app.post("/api/incidents/:incidentId/third-parties", incidents_incidentId_third_parties_post_256);
app.delete("/api/incidents/:incidentId/third-parties/:thirdPartyId", incidents_incidentId_third_parties_thirdPartyId_delete_257);
app.get("/api/integrations/myob/auth-url", integrations_myob_auth_url_get_258);
app.get("/api/integrations/myob/callback", integrations_myob_callback_get_259);
app.post("/api/integrations/myob/disconnect", integrations_myob_disconnect_post_260);
app.get("/api/integrations/myob/status", integrations_myob_status_get_261);
app.post("/api/integrations/myob/sync-invoice", integrations_myob_sync_invoice_post_262);
app.get("/api/integrations/onedrive/auth-url", integrations_onedrive_auth_url_get_263);
app.get("/api/integrations/onedrive/callback", integrations_onedrive_callback_get_264);
app.post("/api/integrations/onedrive/disconnect", integrations_onedrive_disconnect_post_265);
app.get("/api/integrations/onedrive/status", integrations_onedrive_status_get_266);
app.post("/api/integrations/onedrive/upload-file", integrations_onedrive_upload_file_post_267);
app.get("/api/integrations/qbo/auth-url", integrations_qbo_auth_url_get_268);
app.get("/api/integrations/qbo/callback", integrations_qbo_callback_get_269);
app.post("/api/integrations/qbo/disconnect", integrations_qbo_disconnect_post_270);
app.get("/api/integrations/qbo/status", integrations_qbo_status_get_271);
app.post("/api/integrations/qbo/sync-invoice", integrations_qbo_sync_invoice_post_272);
app.get("/api/integrations/xero/auth-url", integrations_xero_auth_url_get_273);
app.get("/api/integrations/xero/callback", integrations_xero_callback_get_274);
app.post("/api/integrations/xero/disconnect", integrations_xero_disconnect_post_275);
app.get("/api/integrations/xero/status", integrations_xero_status_get_276);
app.post("/api/integrations/xero/sync-customer", integrations_xero_sync_customer_post_277);
app.post("/api/integrations/xero/sync-invoice", integrations_xero_sync_invoice_post_278);
app.post("/api/integrations/xero/webhook", integrations_xero_webhook_post_279);
app.get("/api/invoices", invoices_get_280);
app.post("/api/invoices", invoices_post_281);
app.delete("/api/invoices/:id", invoices_id_delete_282);
app.get("/api/invoices/:id", invoices_id_get_283);
app.put("/api/invoices/:id", invoices_id_put_284);
app.post("/api/invoices/:id/duplicate", invoices_id_duplicate_post_285);
app.get("/api/invoices/:id/export-pdf", invoices_id_export_pdf_get_286);
app.post("/api/invoices/:id/mark-sent", invoices_id_mark_sent_post_287);
app.post("/api/invoices/:id/record-payment", invoices_id_record_payment_post_288);
app.post("/api/invoices/:id/send-email", invoices_id_send_email_post_289);
app.patch("/api/invoices/:id/unlock", invoices_id_unlock_patch_290);
app.post("/api/invoices/:id/void", invoices_id_void_post_291);
app.get("/api/job-cards", job_cards_get_292);
app.post("/api/job-cards", job_cards_post_293);
app.delete("/api/job-cards/:id", job_cards_id_delete_294);
app.get("/api/job-cards/:id", job_cards_id_get_295);
app.put("/api/job-cards/:id", job_cards_id_put_296);
app.post("/api/job-cards/:id/convert", job_cards_id_convert_post_297);
app.post("/api/job-cards/:id/invoice", job_cards_id_invoice_post_298);
app.post("/api/job-cards/:id/photos", job_cards_id_photos_post_299);
app.delete("/api/job-cards/:id/photos/:photoId", job_cards_id_photos_photoId_delete_300);
app.post("/api/job-costs", job_costs_post_301);
app.delete("/api/job-forms/:id", job_forms_id_delete_302);
app.get("/api/job-forms/:id", job_forms_id_get_303);
app.put("/api/job-forms/:id", job_forms_id_put_304);
app.post("/api/job-forms/:id/reset", job_forms_id_reset_post_305);
app.delete("/api/job-forms/:id/share", job_forms_id_share_delete_306);
app.get("/api/job-forms/:id/share", job_forms_id_share_get_307);
app.post("/api/job-forms/:id/share", job_forms_id_share_post_308);
app.get("/api/jobs", jobs_get_309);
app.post("/api/jobs", jobs_post_310);
app.post("/api/jobs/report/generate", jobs_report_generate_post_311);
app.get("/api/jobs/:id", jobs_id_get_312);
app.put("/api/jobs/:id", jobs_id_put_313);
app.post("/api/jobs/:id/attendance/:attendanceId/close", jobs_id_attendance_attendanceId_close_post_314);
app.get("/api/jobs/:id/costs", jobs_id_costs_get_315);
app.post("/api/jobs/:id/costs", jobs_id_costs_post_316);
app.get("/api/jobs/:id/costs/export", jobs_id_costs_export_get_317);
app.delete("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_delete_318);
app.put("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_put_319);
app.get("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_get_320);
app.post("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_post_321);
app.get("/api/jobs/:id/delays", jobs_id_delays_get_322);
app.post("/api/jobs/:id/delays", jobs_id_delays_post_323);
app.get("/api/jobs/:id/delays/export-csv", jobs_id_delays_export_csv_get_324);
app.delete("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_delete_325);
app.put("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_put_326);
app.get("/api/jobs/:id/documents", jobs_id_documents_get_327);
app.post("/api/jobs/:id/documents", jobs_id_documents_post_328);
app.get("/api/jobs/:id/export-zip", jobs_id_export_zip_get_329);
app.get("/api/jobs/:id/field-docs", jobs_id_field_docs_get_330);
app.get("/api/jobs/:id/files", jobs_id_files_get_331);
app.get("/api/jobs/:id/forms", jobs_id_forms_get_332);
app.post("/api/jobs/:id/forms", jobs_id_forms_post_333);
app.get("/api/jobs/:id/forms/export-csv", jobs_id_forms_export_csv_get_334);
app.delete("/api/jobs/:id/forms/:submissionId", jobs_id_forms_submissionId_delete_335);
app.post("/api/jobs/:id/forms/:submissionId/reopen", jobs_id_forms_submissionId_reopen_post_336);
app.post("/api/jobs/:id/generate-qr", jobs_id_generate_qr_post_337);
app.get("/api/jobs/:id/ledger", jobs_id_ledger_get_338);
app.post("/api/jobs/:id/ledger", jobs_id_ledger_post_339);
app.get("/api/jobs/:id/ledger/export", jobs_id_ledger_export_get_340);
app.post("/api/jobs/:id/ledger/sync", jobs_id_ledger_sync_post_341);
app.delete("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_delete_342);
app.put("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_put_343);
app.post("/api/jobs/:id/ledger/:entryId/correct", jobs_id_ledger_entryId_correct_post_344);
app.get("/api/jobs/:id/milestones", jobs_id_milestones_get_345);
app.post("/api/jobs/:id/milestones", jobs_id_milestones_post_346);
app.delete("/api/jobs/:id/milestones/:milestoneId", jobs_id_milestones_milestoneId_delete_347);
app.patch("/api/jobs/:id/milestones/:milestoneId", jobs_id_milestones_milestoneId_patch_348);
app.get("/api/jobs/:id/notes/export-csv", jobs_id_notes_export_csv_get_349);
app.get("/api/jobs/:id/photos", jobs_id_photos_get_350);
app.post("/api/jobs/:id/photos", jobs_id_photos_post_351);
app.post("/api/jobs/:id/photos/export-zip", jobs_id_photos_export_zip_post_352);
app.get("/api/jobs/:id/photos/picker", jobs_id_photos_picker_get_353);
app.post("/api/jobs/:id/photos/share", jobs_id_photos_share_post_354);
app.delete("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_delete_355);
app.patch("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_patch_356);
app.get("/api/jobs/:id/photos/:photoId/download", jobs_id_photos_photoId_download_get_357);
app.post("/api/jobs/:id/photos/:photoId/replace", jobs_id_photos_photoId_replace_post_358);
app.get("/api/jobs/:id/photos/:photoId/report-image", jobs_id_photos_photoId_report_image_get_359);
app.get("/api/jobs/:id/progress", jobs_id_progress_get_360);
app.put("/api/jobs/:id/progress", jobs_id_progress_put_361);
app.get("/api/jobs/:id/progress/export-csv", jobs_id_progress_export_csv_get_362);
app.get("/api/jobs/:id/progress/report", jobs_id_progress_report_get_363);
app.put("/api/jobs/:id/progress/report", jobs_id_progress_report_put_364);
app.get("/api/jobs/:id/progress/report/pdf", jobs_id_progress_report_pdf_get_365);
app.post("/api/jobs/:id/progress/sync", jobs_id_progress_sync_post_366);
app.get("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_get_367);
app.post("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_post_368);
app.delete("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_delete_369);
app.get("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_get_370);
app.put("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_put_371);
app.get("/api/jobs/:id/purchase-orders/:poId/pdf", jobs_id_purchase_orders_poId_pdf_get_372);
app.post("/api/jobs/:id/report/pdf", jobs_id_report_pdf_post_373);
app.get("/api/jobs/:id/risky", jobs_id_risky_get_374);
app.post("/api/jobs/:id/risky", jobs_id_risky_post_375);
app.get("/api/jobs/:id/risky/:riskyId", jobs_id_risky_riskyId_get_376);
app.put("/api/jobs/:id/risky/:riskyId", jobs_id_risky_riskyId_put_377);
app.post("/api/jobs/:id/risky/:riskyId/finalise", jobs_id_risky_riskyId_finalise_post_378);
app.post("/api/jobs/:id/risky/:riskyId/signatures", jobs_id_risky_riskyId_signatures_post_379);
app.post("/api/jobs/:id/risky/:riskyId/supervisor-signoff", jobs_id_risky_riskyId_supervisor_signoff_post_380);
app.post("/api/jobs/:id/signin", jobs_id_signin_post_381);
app.post("/api/jobs/:id/signin-qr", jobs_id_signin_qr_post_382);
app.get("/api/jobs/:id/signin-status", jobs_id_signin_status_get_383);
app.post("/api/jobs/:id/signout", jobs_id_signout_post_384);
app.post("/api/jobs/:id/signout-qr", jobs_id_signout_qr_post_385);
app.post("/api/jobs/:id/signout-user", jobs_id_signout_user_post_386);
app.get("/api/jobs/:id/site-prestarts", jobs_id_site_prestarts_get_387);
app.post("/api/jobs/:id/site-prestarts", jobs_id_site_prestarts_post_388);
app.get("/api/jobs/:id/site-prestarts/:prestartId", jobs_id_site_prestarts_prestartId_get_389);
app.put("/api/jobs/:id/site-prestarts/:prestartId", jobs_id_site_prestarts_prestartId_put_390);
app.post("/api/jobs/:id/site-prestarts/:prestartId/finalise", jobs_id_site_prestarts_prestartId_finalise_post_391);
app.post("/api/jobs/:id/site-prestarts/:prestartId/workers", jobs_id_site_prestarts_prestartId_workers_post_392);
app.get("/api/jobs/:id/swms", jobs_id_swms_get_393);
app.post("/api/jobs/:id/swms", jobs_id_swms_post_394);
app.post("/api/jobs/:id/swms/:swmsId/signoff", jobs_id_swms_swmsId_signoff_post_395);
app.get("/api/jobs/:id/todos", jobs_id_todos_get_396);
app.post("/api/jobs/:id/todos", jobs_id_todos_post_397);
app.delete("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_delete_398);
app.put("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_put_399);
app.get("/api/library/items", library_items_get_400);
app.get("/api/library/items/:id", library_items_id_get_401);
app.patch("/api/library/items/:id", library_items_id_patch_402);
app.get("/api/library/items/:id/download", library_items_id_download_get_403);
app.delete("/api/library/items/:id/install", library_items_id_install_delete_404);
app.post("/api/library/items/:id/install", library_items_id_install_post_405);
app.get("/api/library/my-installed", library_my_installed_get_406);
app.get("/api/library/my-submissions", library_my_submissions_get_407);
app.get("/api/lists", lists_get_408);
app.get("/api/me", me_get_409);
app.put("/api/me", me_put_410);
app.post("/api/me/2fa/disable", me_2fa_disable_post_411);
app.post("/api/me/2fa/enable", me_2fa_enable_post_412);
app.get("/api/me/2fa/setup", me_2fa_setup_get_413);
app.get("/api/me/2fa/status", me_2fa_status_get_414);
app.post("/api/me/2fa/verify", me_2fa_verify_post_415);
app.get("/api/me/active-status", me_active_status_get_416);
app.post("/api/me/change-password", me_change_password_post_417);
app.get("/api/me/email-status", me_email_status_get_418);
app.get("/api/me/phone", me_phone_get_419);
app.put("/api/me/phone", me_phone_put_420);
app.delete("/api/me/profile-attachments", me_profile_attachments_delete_421);
app.post("/api/me/profile-attachments", me_profile_attachments_post_422);
...
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_429);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_430);
app.post("/api/migrate-emergency-alerts", migrate_emergency_alerts_post_431);
app.post("/api/migrate-estimates", migrate_estimates_post_432);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_433);
app.post("/api/migrate-files", migrate_files_post_434);
app.post("/api/migrate-fleet", migrate_fleet_post_435);
app.post("/api/migrate-fleet-analytics", migrate_fleet_analytics_post_436);
app.post("/api/migrate-fleet-driver-sessions", migrate_fleet_driver_sessions_post_437);
app.post("/api/migrate-fleet-usage", migrate_fleet_usage_post_438);
app.post("/api/migrate-form-fields", migrate_form_fields_post_439);
app.post("/api/migrate-form-logic", migrate_form_logic_post_440);
app.post("/api/migrate-form-templates", migrate_form_templates_post_441);
app.post("/api/migrate-job-forms", migrate_job_forms_post_442);
app.post("/api/migrate-job-photo-shares", migrate_job_photo_shares_post_443);
app.post("/api/migrate-job-photos", migrate_job_photos_post_444);
app.post("/api/migrate-job-tabs", migrate_job_tabs_post_445);
app.post("/api/migrate-jobs", migrate_jobs_post_446);
app.post("/api/migrate-ledger-photo", migrate_ledger_photo_post_447);
app.post("/api/migrate-library", migrate_library_post_448);
app.post("/api/migrate-library-downloads", migrate_library_downloads_post_449);
app.post("/api/migrate-notifications", migrate_notifications_post_450);
app.post("/api/migrate-owner-console", migrate_owner_console_post_451);
app.post("/api/migrate-owner-role", migrate_owner_role_post_452);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_453);
app.post("/api/migrate-plan-manager", migrate_plan_manager_post_454);
app.post("/api/migrate-plan-manager-v2", migrate_plan_manager_v2_post_455);
app.post("/api/migrate-plan-manager-v3", migrate_plan_manager_v3_post_456);
app.post("/api/migrate-safety", migrate_safety_post_457);
app.post("/api/migrate-site-prestart", migrate_site_prestart_post_458);
app.post("/api/migrate-starter-pack", migrate_starter_pack_post_459);
app.post("/api/migrate-studio-pdf", migrate_studio_pdf_post_460);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_461);
app.post("/api/migrate-support-mode", migrate_support_mode_post_462);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_463);
app.post("/api/migrate-team", migrate_team_post_464);
app.get("/api/notes", notes_get_465);
app.post("/api/notes", notes_post_466);
app.post("/api/notes/comments", notes_comments_post_467);
app.post("/api/notes/migrate", notes_migrate_post_468);
app.delete("/api/notes/:id", notes_id_delete_469);
app.get("/api/notifications/alerts", notifications_alerts_get_470);
app.get("/api/notifications/prefs", notifications_prefs_get_471);
app.put("/api/notifications/prefs", notifications_prefs_put_472);
app.post("/api/notifications/read", notifications_read_post_473);
app.get("/api/owner-console/activity", owner_console_activity_get_474);
app.get("/api/owner-console/cancellation-feedback", owner_console_cancellation_feedback_get_475);
app.get("/api/owner-console/companies", owner_console_companies_get_476);
app.post("/api/owner-console/companies", owner_console_companies_post_477);
app.get("/api/owner-console/companies/usage", owner_console_companies_usage_get_478);
app.put("/api/owner-console/companies/:id/limits", owner_console_companies_id_limits_put_479);
app.get("/api/owner-console/form-templates", owner_console_form_templates_get_480);
app.post("/api/owner-console/form-templates", owner_console_form_templates_post_481);
app.get("/api/owner-console/library/items", owner_console_library_items_get_482);
app.post("/api/owner-console/library/items", owner_console_library_items_post_483);
app.delete("/api/owner-console/library/items/:id", owner_console_library_items_id_delete_484);
app.patch("/api/owner-console/library/items/:id", owner_console_library_items_id_patch_485);
app.put("/api/owner-console/library/items/:id", owner_console_library_items_id_put_486);
app.post("/api/owner-console/library/items/:id/push-update", owner_console_library_items_id_push_update_post_487);
app.get("/api/owner-console/library/submissions", owner_console_library_submissions_get_488);
app.post("/api/owner-console/library/submissions/:id/review", owner_console_library_submissions_id_review_post_489);
app.get("/api/owner-console/starter-pack", owner_console_starter_pack_get_490);
app.post("/api/owner-console/starter-pack", owner_console_starter_pack_post_491);
app.get("/api/owner-console/stats", owner_console_stats_get_492);
app.get("/api/owner-console/storage", owner_console_storage_get_493);
app.get("/api/owner-console/swms/masters", owner_console_swms_masters_get_494);
app.post("/api/owner-console/swms/masters", owner_console_swms_masters_post_495);
app.post("/api/owner-console/swms/masters/publish-all", owner_console_swms_masters_publish_all_post_496);
app.delete("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_delete_497);
app.get("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_get_498);
app.put("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_put_499);
app.post("/api/owner-console/swms/masters/:id/publish", owner_console_swms_masters_id_publish_post_500);
app.post("/api/owner-console/swms/migrate-master-library", owner_console_swms_migrate_master_library_post_501);
app.post("/api/owner-console/swms/push", owner_console_swms_push_post_502);
app.post("/api/owner-console/swms/seed-bricklaying", owner_console_swms_seed_bricklaying_post_503);
app.post("/api/owner-console/swms/seed-building-inspection", owner_console_swms_seed_building_inspection_post_504);
app.post("/api/owner-console/swms/seed-cabinets", owner_console_swms_seed_cabinets_post_505);
app.post("/api/owner-console/swms/seed-carpenter-fixing", owner_console_swms_seed_carpenter_fixing_post_506);
app.post("/api/owner-console/swms/seed-carpenter-framing", owner_console_swms_seed_carpenter_framing_post_507);
app.post("/api/owner-console/swms/seed-carpenter-lockup", owner_console_swms_seed_carpenter_lockup_post_508);
app.post("/api/owner-console/swms/seed-ceramic-tiling", owner_console_swms_seed_ceramic_tiling_post_509);
app.post("/api/owner-console/swms/seed-concreting-slab", owner_console_swms_seed_concreting_slab_post_510);
app.post("/api/owner-console/swms/seed-delivery-loading", owner_console_swms_seed_delivery_loading_post_511);
app.post("/api/owner-console/swms/seed-environmental-spill", owner_console_swms_seed_environmental_spill_post_512);
app.post("/api/owner-console/swms/seed-ewp", owner_console_swms_seed_ewp_post_513);
app.post("/api/owner-console/swms/seed-excavations-substation", owner_console_swms_seed_excavations_substation_post_514);
app.post("/api/owner-console/swms/seed-fencing", owner_console_swms_seed_fencing_post_515);
app.post("/api/owner-console/swms/seed-heat-stress", owner_console_swms_seed_heat_stress_post_516);
app.post("/api/owner-console/swms/seed-landscaping", owner_console_swms_seed_landscaping_post_517);
app.post("/api/owner-console/swms/seed-live-parts", owner_console_swms_seed_live_parts_post_518);
app.post("/api/owner-console/swms/seed-manual-handling", owner_console_swms_seed_manual_handling_post_519);
app.post("/api/owner-console/swms/seed-moving-plant", owner_console_swms_seed_moving_plant_post_520);
app.post("/api/owner-console/swms/seed-painting", owner_console_swms_seed_painting_post_521);
app.post("/api/owner-console/swms/seed-power-tools", owner_console_swms_seed_power_tools_post_522);
app.post("/api/owner-console/swms/seed-silica-dust", owner_console_swms_seed_silica_dust_post_523);
app.post("/api/owner-console/swms/seed-traffic-management", owner_console_swms_seed_traffic_management_post_524);
app.post("/api/owner-console/swms/seed-underground-services", owner_console_swms_seed_underground_services_post_525);
app.post("/api/owner-console/swms/seed-vacuum-excavation", owner_console_swms_seed_vacuum_excavation_post_526);
app.post("/api/owner-console/system-ai/builtin-checks", owner_console_system_ai_builtin_checks_post_527);
app.get("/api/owner-console/users", owner_console_users_get_528);
app.post("/api/owner-console/users/verify", owner_console_users_verify_post_529);
app.get("/api/plan-manager/drawings", plan_manager_drawings_get_530);
app.post("/api/plan-manager/drawings", plan_manager_drawings_post_531);
app.get("/api/plan-manager/drawings/:id", plan_manager_drawings_id_get_532);
app.put("/api/plan-manager/drawings/:id/annotations", plan_manager_drawings_id_annotations_put_533);
app.post("/api/plan-manager/drawings/:id/archive", plan_manager_drawings_id_archive_post_534);
app.delete("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_delete_535);
app.post("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_post_536);
app.get("/api/plan-manager/drawings/:id/pages/:pageNo/annotations", plan_manager_drawings_id_pages_pageNo_annotations_get_537);
app.delete("/api/plan-manager/drawings/:id/permanent", plan_manager_drawings_id_permanent_delete_538);
app.patch("/api/plan-manager/drawings/:id/reorder", plan_manager_drawings_id_reorder_patch_539);
app.post("/api/plan-manager/drawings/:id/restore", plan_manager_drawings_id_restore_post_540);
app.post("/api/plan-manager/drawings/:id/revisions", plan_manager_drawings_id_revisions_post_541);
...
app.post("/api/portal/invite", portal_invite_post_548);
app.post("/api/portal/invoices/:id/pay", portal_invoices_id_pay_post_549);
app.get("/api/portal/jobs", portal_jobs_get_550);
app.get("/api/portal/jobs/:id", portal_jobs_id_get_551);
app.post("/api/portal/migrate", portal_migrate_post_552);
app.post("/api/portal/validate", portal_validate_post_553);
app.get("/api/public/form/:token", public_form_token_get_554);
app.post("/api/public/form/:token/submit", public_form_token_submit_post_555);
app.get("/api/public/job-photos/:token", public_job_photos_token_get_556);
app.get("/api/public/job-photos/:token/photo/:photoId", public_job_photos_token_photo_photoId_get_557);
app.get("/api/public/swms/:token", public_swms_token_get_558);
app.post("/api/public/swms/:token/signoff", public_swms_token_signoff_post_559);
app.delete("/api/push/subscribe", push_subscribe_delete_560);
app.post("/api/push/subscribe", push_subscribe_post_561);
app.get("/api/push/vapid-key", push_vapid_key_get_562);
app.get("/api/quick-links/site-meta", quick_links_site_meta_get_563);
app.get("/api/recipes", recipes_get_564);
app.post("/api/recipes", recipes_post_565);
app.delete("/api/recipes/:id", recipes_id_delete_566);
app.put("/api/recipes/:id", recipes_id_put_567);
app.get("/api/risk-register", risk_register_get_568);
app.post("/api/risk-register", risk_register_post_569);
app.get("/api/risk-register/:id", risk_register_id_get_570);
app.put("/api/risk-register/:id", risk_register_id_put_571);
app.post("/api/risk-register/:id/archive", risk_register_id_archive_post_572);
app.post("/api/risk-register/:id/unarchive", risk_register_id_unarchive_post_573);
app.post("/api/safety/ai/draft", safety_ai_draft_post_574);
app.get("/api/safety/documents", safety_documents_get_575);
app.post("/api/safety/documents", safety_documents_post_576);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_577);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_578);
app.get("/api/safety/generated-posters", safety_generated_posters_get_579);
app.post("/api/safety/generated-posters", safety_generated_posters_post_580);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_581);
app.get("/api/safety/job-safety-plans", safety_job_safety_plans_get_582);
app.post("/api/safety/job-safety-plans", safety_job_safety_plans_post_583);
app.delete("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_delete_584);
app.put("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_put_585);
app.get("/api/safety/job-swms", safety_job_swms_get_586);
app.post("/api/safety/job-swms", safety_job_swms_post_587);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_588);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_589);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_590);
app.post("/api/safety/job-swms/:id/share-token", safety_job_swms_id_share_token_post_591);
app.get("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_get_592);
app.post("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_post_593);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", safety_job_swms_id_signoffs_signoffId_delete_594);
app.get("/api/safety/plans", safety_plans_get_595);
app.post("/api/safety/plans", safety_plans_post_596);
app.post("/api/safety/plans/seed", safety_plans_seed_post_597);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_598);
app.put("/api/safety/plans/:id", safety_plans_id_put_599);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_600);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_601);
app.get("/api/safety/posters", safety_posters_get_602);
app.post("/api/safety/posters", safety_posters_post_603);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_604);
app.get("/api/safety/swms", safety_swms_get_605);
app.post("/api/safety/swms", safety_swms_post_606);
app.post("/api/safety/swms/import-docx", safety_swms_import_docx_post_607);
app.post("/api/safety/swms/seed", safety_swms_seed_post_608);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_609);
app.get("/api/safety/swms/:id", safety_swms_id_get_610);
app.put("/api/safety/swms/:id", safety_swms_id_put_611);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_612);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_613);
app.post("/api/safety/swms/:id/publish-to-library", safety_swms_id_publish_to_library_post_614);
app.get("/api/scheduler/crew", scheduler_crew_get_615);
app.get("/api/scheduler/jobs", scheduler_jobs_get_616);
app.patch("/api/scheduler/jobs/:id/reschedule", scheduler_jobs_id_reschedule_patch_617);
app.get("/api/scheduler/tasks", scheduler_tasks_get_618);
app.get("/api/secure-share", secure_share_get_619);
app.post("/api/secure-share", secure_share_post_620);
app.delete("/api/secure-share/:id", secure_share_id_delete_621);
app.get("/api/secure-share/:token", secure_share_token_get_622);
app.post("/api/secure-share/:token", secure_share_token_post_623);
app.get("/api/settings/backup", settings_backup_get_624);
app.post("/api/settings/backup", settings_backup_post_625);
app.get("/api/settings/backup/company-data", settings_backup_company_data_get_626);
app.get("/api/settings/backup/csv-pack", settings_backup_csv_pack_get_627);
app.get("/api/settings/backup/export", settings_backup_export_get_628);
app.post("/api/settings/backup/run", settings_backup_run_post_629);
app.get("/api/settings/backup-destination", settings_backup_destination_get_630);
app.post("/api/settings/backup-destination", settings_backup_destination_post_631);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_632);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_633);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_634);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_635);
app.get("/api/settings/retention", settings_retention_get_636);
app.post("/api/settings/retention", settings_retention_post_637);
app.get("/api/settings/storage-provider", settings_storage_provider_get_638);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_639);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_640);
app.get("/api/settings/terminology", settings_terminology_get_641);
app.post("/api/settings/terminology", settings_terminology_post_642);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_643);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_644);
app.get("/api/share/:token", share_token_get_645);
app.get("/api/signin-history", signin_history_get_646);
app.post("/api/signup", signup_post_647);
app.get("/api/sos", sos_get_648);
app.post("/api/sos/acknowledge", sos_acknowledge_post_649);
app.post("/api/sos/trigger", sos_trigger_post_650);
app.post("/api/stakeholders/sms", stakeholders_sms_post_651);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_652);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_653);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_654);
app.get("/api/subscription/status", subscription_status_get_655);
app.post("/api/subscription/webhook", subscription_webhook_post_656);
app.get("/api/support-mode/audit", support_mode_audit_get_657);
app.get("/api/support-mode/checklist", support_mode_checklist_get_658);
app.put("/api/support-mode/checklist", support_mode_checklist_put_659);
app.post("/api/support-mode/enter", support_mode_enter_post_660);
app.post("/api/support-mode/exit", support_mode_exit_post_661);
app.get("/api/support-mode/status", support_mode_status_get_662);
app.get("/api/tag-tasks", tag_tasks_get_663);
app.patch("/api/tag-tasks/:id", tag_tasks_id_patch_664);
app.get("/api/takeoff-pad", takeoff_pad_get_665);
app.put("/api/takeoff-pad", takeoff_pad_put_666);
app.post("/api/tasks", tasks_post_667);
app.put("/api/tasks/:id", tasks_id_put_668);
app.get("/api/team", team_get_669);
app.post("/api/team/invite", team_invite_post_670);
app.get("/api/team/invites", team_invites_get_671);
app.post("/api/team/invites", team_invites_post_672);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_673);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_674);
app.get("/api/team/members", team_members_get_675);
app.get("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_get_676);
app.put("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_put_677);
app.post("/api/team/resend-verification", team_resend_verification_post_678);
app.post("/api/team/schedule/migrate", team_schedule_migrate_post_679);
app.get("/api/team/shifts", team_shifts_get_680);
app.post("/api/team/shifts", team_shifts_post_681);
app.delete("/api/team/shifts/:id", team_shifts_id_delete_682);
app.put("/api/team/shifts/:id", team_shifts_id_put_683);
app.get("/api/team/time-entries", team_time_entries_get_684);
app.post("/api/team/time-entries", team_time_entries_post_685);
app.get("/api/team/time-entries/export", team_time_entries_export_get_686);
app.put("/api/team/time-entries/:id", team_time_entries_id_put_687);
app.post("/api/team/verify-user", team_verify_user_post_688);
app.delete("/api/team/:id", team_id_delete_689);
app.put("/api/team/:id", team_id_put_690);
app.get("/api/usage", usage_get_691);
app.get("/api/user-logs", user_logs_get_692);
app.get("/api/user-logs/users", user_logs_users_get_693);
// </api-registrations>
