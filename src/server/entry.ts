...
import asset_manager_inspections_id_patch_13 from "./api/asset-manager/inspections/[id]/PATCH";
import asset_manager_inspections_id_archive_post_14 from "./api/asset-manager/inspections/[id]/archive/POST";
import asset_manager_inspections_id_closeout_post_15 from "./api/asset-manager/inspections/[id]/closeout/POST";
import asset_manager_inspections_id_defects_post_16 from "./api/asset-manager/inspections/[id]/defects/POST";
import asset_manager_inspections_id_permanent_delete_17 from "./api/asset-manager/inspections/[id]/permanent/DELETE";
import asset_manager_inspections_id_photos_post_18 from "./api/asset-manager/inspections/[id]/photos/POST";
import asset_manager_inspections_id_report_share_post_19 from "./api/asset-manager/inspections/[id]/report/share/POST";
import asset_manager_inspections_id_restore_post_20 from "./api/asset-manager/inspections/[id]/restore/POST";
import asset_manager_inspections_id_tenders_post_21 from "./api/asset-manager/inspections/[id]/tenders/POST";
import asset_manager_monitoring_get_22 from "./api/asset-manager/monitoring/GET";
import asset_manager_reports_shareToken_get_23 from "./api/asset-manager/reports/[shareToken]/GET";
import asset_manager_tenders_id_patch_24 from "./api/asset-manager/tenders/[id]/PATCH";
import asset_manager_tenders_id_complete_post_25 from "./api/asset-manager/tenders/[id]/complete/POST";
import asset_manager_tenders_id_contracts_post_26 from "./api/asset-manager/tenders/[id]/contracts/POST";
import auth_change_email_post_27 from "./api/auth/change-email/POST";
import auth_change_password_post_28 from "./api/auth/change-password/POST";
import auth_check_signup_status_post_29 from "./api/auth/check-signup-status/POST";
import auth_forgot_password_post_30 from "./api/auth/forgot-password/POST";
import auth_pin_login_post_31 from "./api/auth/pin-login/POST";
import auth_resend_verification_post_32 from "./api/auth/resend-verification/POST";
import auth_reset_password_post_33 from "./api/auth/reset-password/POST";
import auth_resume_signup_post_34 from "./api/auth/resume-signup/POST";
import auth_self_verify_post_35 from "./api/auth/self-verify/POST";
import auth_send_sms_code_post_36 from "./api/auth/send-sms-code/POST";
import auth_sms_configured_get_37 from "./api/auth/sms-configured/GET";
import auth_sms_recovery_post_38 from "./api/auth/sms-recovery/POST";
import auth_trusted_devices_get_39 from "./api/auth/trusted-devices/GET";
import auth_trusted_devices_post_40 from "./api/auth/trusted-devices/POST";
import auth_trusted_devices_deviceId_delete_41 from "./api/auth/trusted-devices/[deviceId]/DELETE";
import auth_validate_reset_token_get_42 from "./api/auth/validate-reset-token/GET";
import auth_verify_email_post_43 from "./api/auth/verify-email/POST";
import auth_verify_sms_code_post_44 from "./api/auth/verify-sms-code/POST";
import auth_action_get_45 from "./api/auth/[action]/GET";
import auth_action_post_46 from "./api/auth/[action]/POST";
import auth_action_detail_get_47 from "./api/auth/[action]/[detail]/GET";
import auth_action_detail_post_48 from "./api/auth/[action]/[detail]/POST";
import billing_cancel_subscription_post_49 from "./api/billing/cancel-subscription/POST";
import billing_cancellation_feedback_post_50 from "./api/billing/cancellation-feedback/POST";
import billing_customer_portal_post_51 from "./api/billing/customer-portal/POST";
import billing_reactivate_subscription_post_52 from "./api/billing/reactivate-subscription/POST";
import billing_upgrade_subscription_post_53 from "./api/billing/upgrade-subscription/POST";
import company_get_54 from "./api/company/GET";
import company_put_55 from "./api/company/PUT";
import company_logo_post_56 from "./api/company/logo/POST";
import company_settings_get_57 from "./api/company-settings/GET";
import company_settings_put_58 from "./api/company-settings/PUT";
import contact_post_59 from "./api/contact/POST";
import cost_guide_get_60 from "./api/cost-guide/GET";
import cost_guide_post_61 from "./api/cost-guide/POST";
import cost_guide_export_csv_get_62 from "./api/cost-guide/export-csv/GET";
import cost_guide_import_csv_post_63 from "./api/cost-guide/import-csv/POST";
import cost_guide_id_delete_64 from "./api/cost-guide/[id]/DELETE";
import cost_guide_id_put_65 from "./api/cost-guide/[id]/PUT";
import customers_get_66 from "./api/customers/GET";
import customers_post_67 from "./api/customers/POST";
import customers_id_delete_68 from "./api/customers/[id]/DELETE";
import customers_id_get_69 from "./api/customers/[id]/GET";
import customers_id_put_70 from "./api/customers/[id]/PUT";
import dashboard_kpi_get_71 from "./api/dashboard/kpi/GET";
import dashboard_setup_check_get_72 from "./api/dashboard/setup-check/GET";
import dashboard_todos_get_73 from "./api/dashboard/todos/GET";
import dazza_annette_post_74 from "./api/dazza/annette/POST";
import dazza_brain_hive_approve_post_75 from "./api/dazza/brain/hive/approve/POST";
import dazza_brain_hive_reject_post_76 from "./api/dazza/brain/hive/reject/POST";
import dazza_brain_status_get_77 from "./api/dazza/brain/status/GET";
import dazza_chat_post_78 from "./api/dazza/chat/POST";
import dazza_chat_v2_post_79 from "./api/dazza/chat-v2/POST";
import dazza_chat_v2_stream_post_80 from "./api/dazza/chat-v2/stream/POST";
import dazza_context_get_81 from "./api/dazza/context/GET";
import dazza_key_status_get_82 from "./api/dazza/key-status/GET";
import dazza_knowledge_get_83 from "./api/dazza/knowledge/GET";
import dazza_knowledge_post_84 from "./api/dazza/knowledge/POST";
import dazza_knowledge_id_delete_85 from "./api/dazza/knowledge/[id]/DELETE";
import dazza_knowledge_id_put_86 from "./api/dazza/knowledge/[id]/PUT";
import developer_activity_log_get_87 from "./api/developer/activity-log/GET";
import developer_audit_log_get_88 from "./api/developer/audit-log/GET";
import developer_companies_id_archive_post_89 from "./api/developer/companies/[id]/archive/POST";
import developer_company_health_get_90 from "./api/developer/company-health/GET";
import developer_email_log_get_91 from "./api/developer/email-log/GET";
import developer_email_settings_get_92 from "./api/developer/email-settings/GET";
import developer_email_settings_put_93 from "./api/developer/email-settings/PUT";
import developer_email_settings_test_post_94 from "./api/developer/email-settings/test/POST";
import developer_support_notes_get_95 from "./api/developer/support-notes/GET";
import developer_support_notes_post_96 from "./api/developer/support-notes/POST";
import developer_support_notes_id_delete_97 from "./api/developer/support-notes/[id]/DELETE";
import developer_users_id_assign_company_post_98 from "./api/developer/users/[id]/assign-company/POST";
import developer_users_id_deactivate_post_99 from "./api/developer/users/[id]/deactivate/POST";
import developer_users_id_delete_orphan_post_100 from "./api/developer/users/[id]/delete-orphan/POST";
import developer_users_id_force_temp_password_post_101 from "./api/developer/users/[id]/force-temp-password/POST";
import developer_users_id_impersonate_delete_102 from "./api/developer/users/[id]/impersonate/DELETE";
import developer_users_id_impersonate_post_103 from "./api/developer/users/[id]/impersonate/POST";
import developer_users_id_reactivate_post_104 from "./api/developer/users/[id]/reactivate/POST";
import developer_users_id_resend_verification_post_105 from "./api/developer/users/[id]/resend-verification/POST";
import developer_users_id_role_put_106 from "./api/developer/users/[id]/role/PUT";
import developer_users_id_send_reset_email_post_107 from "./api/developer/users/[id]/send-reset-email/POST";
import developer_users_id_sessions_delete_108 from "./api/developer/users/[id]/sessions/DELETE";
import developer_users_id_sessions_get_109 from "./api/developer/users/[id]/sessions/GET";
import developer_users_id_unlock_account_post_110 from "./api/developer/users/[id]/unlock-account/POST";
import document_templates_get_111 from "./api/document-templates/GET";
import document_templates_post_112 from "./api/document-templates/POST";
import document_templates_id_delete_113 from "./api/document-templates/[id]/DELETE";
import document_templates_id_get_114 from "./api/document-templates/[id]/GET";
import document_templates_id_put_115 from "./api/document-templates/[id]/PUT";
import document_templates_id_duplicate_post_116 from "./api/document-templates/[id]/duplicate/POST";
import document_templates_id_export_docx_get_117 from "./api/document-templates/[id]/export/docx/GET";
import document_templates_id_export_pdf_get_118 from "./api/document-templates/[id]/export/pdf/GET";
import document_templates_id_import_docx_post_119 from "./api/document-templates/[id]/import-docx/POST";
import document_templates_id_import_pdf_post_120 from "./api/document-templates/[id]/import-pdf/POST";
import documents_get_121 from "./api/documents/GET";
import documents_share_token_get_122 from "./api/documents/share/[token]/GET";
import documents_share_token_post_123 from "./api/documents/share/[token]/POST";
import documents_id_get_124 from "./api/documents/[id]/GET";
import documents_id_put_125 from "./api/documents/[id]/PUT";
import documents_id_events_get_126 from "./api/documents/[id]/events/GET";
import documents_id_share_delete_127 from "./api/documents/[id]/share/DELETE";
import documents_id_share_post_128 from "./api/documents/[id]/share/POST";
import drawings_get_129 from "./api/drawings/GET";
import drawings_post_130 from "./api/drawings/POST";
import drawings_upload_post_131 from "./api/drawings/upload/POST";
import drawings_id_delete_132 from "./api/drawings/[id]/DELETE";
import drawings_id_patch_133 from "./api/drawings/[id]/PATCH";
import drawings_id_markup_post_134 from "./api/drawings/[id]/markup/POST";
import emergency_alerts_get_135 from "./api/emergency-alerts/GET";
import emergency_alerts_post_136 from "./api/emergency-alerts/POST";
import emergency_alerts_id_put_137 from "./api/emergency-alerts/[id]/PUT";
import estimates_get_138 from "./api/estimates/GET";
import estimates_post_139 from "./api/estimates/POST";
import estimates_id_delete_140 from "./api/estimates/[id]/DELETE";
import estimates_id_get_141 from "./api/estimates/[id]/GET";
import estimates_id_put_142 from "./api/estimates/[id]/PUT";
import estimates_id_export_csv_get_143 from "./api/estimates/[id]/export-csv/GET";
import estimates_id_export_pdf_get_144 from "./api/estimates/[id]/export-pdf/GET";
import estimates_id_import_csv_post_145 from "./api/estimates/[id]/import-csv/POST";
import external_form_token_get_146 from "./api/external/form/[token]/GET";
import external_form_token_post_147 from "./api/external/form/[token]/POST";
import files_get_148 from "./api/files/GET";
import files_post_149 from "./api/files/POST";
import files_id_delete_150 from "./api/files/[id]/DELETE";
import files_id_download_get_151 from "./api/files/[id]/download/GET";
import fleet_get_152 from "./api/fleet/GET";
import fleet_post_153 from "./api/fleet/POST";
import fleet_analytics_settings_get_154 from "./api/fleet/analytics-settings/GET";
import fleet_analytics_settings_put_155 from "./api/fleet/analytics-settings/PUT";
import fleet_driver_sessions_post_156 from "./api/fleet/driver-sessions/POST";
import fleet_driver_sessions_active_get_157 from "./api/fleet/driver-sessions/active/GET";
import fleet_driver_sessions_id_stop_post_158 from "./api/fleet/driver-sessions/[id]/stop/POST";
import fleet_driver_sessions_id_summary_get_159 from "./api/fleet/driver-sessions/[id]/summary/GET";
import fleet_driver_sessions_id_telemetry_post_160 from "./api/fleet/driver-sessions/[id]/telemetry/POST";
import fleet_flags_get_161 from "./api/fleet/flags/GET";
import fleet_service_logs_logId_delete_162 from "./api/fleet/service-logs/[logId]/DELETE";
import fleet_service_logs_logId_patch_163 from "./api/fleet/service-logs/[logId]/PATCH";
import fleet_vehicles_get_164 from "./api/fleet/vehicles/GET";
import fleet_id_delete_165 from "./api/fleet/[id]/DELETE";
import fleet_id_get_166 from "./api/fleet/[id]/GET";
import fleet_id_put_167 from "./api/fleet/[id]/PUT";
import fleet_id_driver_sessions_get_168 from "./api/fleet/[id]/driver-sessions/GET";
import fleet_id_files_get_169 from "./api/fleet/[id]/files/GET";
import fleet_id_prestarts_get_170 from "./api/fleet/[id]/prestarts/GET";
import fleet_id_prestarts_post_171 from "./api/fleet/[id]/prestarts/POST";
import fleet_id_service_logs_get_172 from "./api/fleet/[id]/service-logs/GET";
import fleet_id_service_logs_post_173 from "./api/fleet/[id]/service-logs/POST";
import fleet_id_signin_post_174 from "./api/fleet/[id]/signin/POST";
import fleet_id_signout_post_175 from "./api/fleet/[id]/signout/POST";
import fleet_id_usage_export_get_176 from "./api/fleet/[id]/usage-export/GET";
import fleet_id_usage_status_get_177 from "./api/fleet/[id]/usage-status/GET";
import fleet_id_usage_summary_get_178 from "./api/fleet/[id]/usage-summary/GET";
import form_templates_get_179 from "./api/form-templates/GET";
import form_templates_post_180 from "./api/form-templates/POST";
import form_templates_seed_post_181 from "./api/form-templates/seed/POST";
import form_templates_id_delete_182 from "./api/form-templates/[id]/DELETE";
import form_templates_id_put_183 from "./api/form-templates/[id]/PUT";
import forms_migrate_skip_logic_post_184 from "./api/forms/migrate-skip-logic/POST";
import forms_skip_audit_get_185 from "./api/forms/skip-audit/GET";
import forms_skip_audit_post_186 from "./api/forms/skip-audit/POST";
import forms_submissions_get_187 from "./api/forms/submissions/GET";
import forms_templates_id_share_link_post_188 from "./api/forms/templates/[id]/share-link/POST";
import forms_id_fields_get_189 from "./api/forms/[id]/fields/GET";
import forms_id_fields_post_190 from "./api/forms/[id]/fields/POST";
import forms_id_fields_reorder_post_191 from "./api/forms/[id]/fields/reorder/POST";
import forms_id_fields_fieldId_delete_192 from "./api/forms/[id]/fields/[fieldId]/DELETE";
import forms_id_fields_fieldId_patch_193 from "./api/forms/[id]/fields/[fieldId]/PATCH";
import forms_id_fields_fieldId_thumbnail_post_194 from "./api/forms/[id]/fields/[fieldId]/thumbnail/POST";
import health_get_195 from "./api/health/GET";
import integrations_myob_auth_url_get_196 from "./api/integrations/myob/auth-url/GET";
import integrations_myob_callback_get_197 from "./api/integrations/myob/callback/GET";
import integrations_myob_disconnect_post_198 from "./api/integrations/myob/disconnect/POST";
import integrations_myob_status_get_199 from "./api/integrations/myob/status/GET";
import integrations_myob_sync_invoice_post_200 from "./api/integrations/myob/sync-invoice/POST";
import integrations_onedrive_auth_url_get_201 from "./api/integrations/onedrive/auth-url/GET";
import integrations_onedrive_callback_get_202 from "./api/integrations/onedrive/callback/GET";
import integrations_onedrive_disconnect_post_203 from "./api/integrations/onedrive/disconnect/POST";
import integrations_onedrive_status_get_204 from "./api/integrations/onedrive/status/GET";
import integrations_onedrive_upload_file_post_205 from "./api/integrations/onedrive/upload-file/POST";
import integrations_qbo_auth_url_get_206 from "./api/integrations/qbo/auth-url/GET";
import integrations_qbo_callback_get_207 from "./api/integrations/qbo/callback/GET";
import integrations_qbo_disconnect_post_208 from "./api/integrations/qbo/disconnect/POST";
import integrations_qbo_status_get_209 from "./api/integrations/qbo/status/GET";
import integrations_qbo_sync_invoice_post_210 from "./api/integrations/qbo/sync-invoice/POST";
import integrations_xero_auth_url_get_211 from "./api/integrations/xero/auth-url/GET";
import integrations_xero_callback_get_212 from "./api/integrations/xero/callback/GET";
import integrations_xero_disconnect_post_213 from "./api/integrations/xero/disconnect/POST";
import integrations_xero_status_get_214 from "./api/integrations/xero/status/GET";
import integrations_xero_sync_customer_post_215 from "./api/integrations/xero/sync-customer/POST";
import integrations_xero_sync_invoice_post_216 from "./api/integrations/xero/sync-invoice/POST";
import integrations_xero_webhook_post_217 from "./api/integrations/xero/webhook/POST";
import invoices_get_218 from "./api/invoices/GET";
import invoices_post_219 from "./api/invoices/POST";
import invoices_id_delete_220 from "./api/invoices/[id]/DELETE";
import invoices_id_get_221 from "./api/invoices/[id]/GET";
import invoices_id_put_222 from "./api/invoices/[id]/PUT";
import invoices_id_duplicate_post_223 from "./api/invoices/[id]/duplicate/POST";
import invoices_id_export_pdf_get_224 from "./api/invoices/[id]/export-pdf/GET";
import invoices_id_mark_sent_post_225 from "./api/invoices/[id]/mark-sent/POST";
import invoices_id_record_payment_post_226 from "./api/invoices/[id]/record-payment/POST";
import invoices_id_void_post_227 from "./api/invoices/[id]/void/POST";
import job_forms_id_delete_228 from "./api/job-forms/[id]/DELETE";
import job_forms_id_get_229 from "./api/job-forms/[id]/GET";
import job_forms_id_put_230 from "./api/job-forms/[id]/PUT";
import job_forms_id_reset_post_231 from "./api/job-forms/[id]/reset/POST";
import job_forms_id_share_delete_232 from "./api/job-forms/[id]/share/DELETE";
import job_forms_id_share_get_233 from "./api/job-forms/[id]/share/GET";
import job_forms_id_share_post_234 from "./api/job-forms/[id]/share/POST";
import jobs_get_235 from "./api/jobs/GET";
import jobs_post_236 from "./api/jobs/POST";
import jobs_id_get_237 from "./api/jobs/[id]/GET";
import jobs_id_put_238 from "./api/jobs/[id]/PUT";
import jobs_id_attendance_attendanceId_close_post_239 from "./api/jobs/[id]/attendance/[attendanceId]/close/POST";
import jobs_id_costs_get_240 from "./api/jobs/[id]/costs/GET";
import jobs_id_costs_post_241 from "./api/jobs/[id]/costs/POST";
import jobs_id_costs_export_get_242 from "./api/jobs/[id]/costs/export/GET";
import jobs_id_costs_costId_delete_243 from "./api/jobs/[id]/costs/[costId]/DELETE";
import jobs_id_costs_costId_put_244 from "./api/jobs/[id]/costs/[costId]/PUT";
import jobs_id_costs_costId_receipt_get_245 from "./api/jobs/[id]/costs/[costId]/receipt/GET";
import jobs_id_costs_costId_receipt_post_246 from "./api/jobs/[id]/costs/[costId]/receipt/POST";
import jobs_id_delays_get_247 from "./api/jobs/[id]/delays/GET";
import jobs_id_delays_post_248 from "./api/jobs/[id]/delays/POST";
import jobs_id_delays_delayId_delete_249 from "./api/jobs/[id]/delays/[delayId]/DELETE";
import jobs_id_delays_delayId_put_250 from "./api/jobs/[id]/delays/[delayId]/PUT";
import jobs_id_files_get_251 from "./api/jobs/[id]/files/GET";
import jobs_id_forms_get_252 from "./api/jobs/[id]/forms/GET";
import jobs_id_forms_post_253 from "./api/jobs/[id]/forms/POST";
import jobs_id_generate_qr_post_254 from "./api/jobs/[id]/generate-qr/POST";
import jobs_id_ledger_get_255 from "./api/jobs/[id]/ledger/GET";
import jobs_id_ledger_post_256 from "./api/jobs/[id]/ledger/POST";
import jobs_id_ledger_export_get_257 from "./api/jobs/[id]/ledger/export/GET";
import jobs_id_ledger_sync_post_258 from "./api/jobs/[id]/ledger/sync/POST";
import jobs_id_ledger_entryId_delete_259 from "./api/jobs/[id]/ledger/[entryId]/DELETE";
import jobs_id_ledger_entryId_put_260 from "./api/jobs/[id]/ledger/[entryId]/PUT";
import jobs_id_ledger_entryId_correct_post_261 from "./api/jobs/[id]/ledger/[entryId]/correct/POST";
import jobs_id_photos_get_262 from "./api/jobs/[id]/photos/GET";
import jobs_id_photos_post_263 from "./api/jobs/[id]/photos/POST";
import jobs_id_photos_photoId_delete_264 from "./api/jobs/[id]/photos/[photoId]/DELETE";
import jobs_id_photos_photoId_patch_265 from "./api/jobs/[id]/photos/[photoId]/PATCH";
import jobs_id_photos_photoId_download_get_266 from "./api/jobs/[id]/photos/[photoId]/download/GET";
import jobs_id_photos_photoId_replace_post_267 from "./api/jobs/[id]/photos/[photoId]/replace/POST";
import jobs_id_progress_get_268 from "./api/jobs/[id]/progress/GET";
import jobs_id_progress_put_269 from "./api/jobs/[id]/progress/PUT";
import jobs_id_progress_sync_post_270 from "./api/jobs/[id]/progress/sync/POST";
import jobs_id_purchase_orders_get_271 from "./api/jobs/[id]/purchase-orders/GET";
import jobs_id_purchase_orders_post_272 from "./api/jobs/[id]/purchase-orders/POST";
import jobs_id_purchase_orders_poId_delete_273 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import jobs_id_purchase_orders_poId_get_274 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
import jobs_id_purchase_orders_poId_put_275 from "./api/jobs/[id]/purchase-orders/[poId]/PUT";
import jobs_id_purchase_orders_poId_pdf_get_276 from "./api/jobs/[id]/purchase-orders/[poId]/pdf/GET";
import jobs_id_signin_post_277 from "./api/jobs/[id]/signin/POST";
import jobs_id_signin_qr_post_278 from "./api/jobs/[id]/signin-qr/POST";
import jobs_id_signin_status_get_279 from "./api/jobs/[id]/signin-status/GET";
import jobs_id_signout_post_280 from "./api/jobs/[id]/signout/POST";
import jobs_id_signout_qr_post_281 from "./api/jobs/[id]/signout-qr/POST";
import jobs_id_swms_get_282 from "./api/jobs/[id]/swms/GET";
import jobs_id_swms_post_283 from "./api/jobs/[id]/swms/POST";
import jobs_id_swms_swmsId_signoff_post_284 from "./api/jobs/[id]/swms/[swmsId]/signoff/POST";
import jobs_id_todos_get_285 from "./api/jobs/[id]/todos/GET";
import jobs_id_todos_post_286 from "./api/jobs/[id]/todos/POST";
import jobs_id_todos_todoId_delete_287 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import jobs_id_todos_todoId_put_288 from "./api/jobs/[id]/todos/[todoId]/PUT";
import library_items_get_289 from "./api/library/items/GET";
import library_items_id_get_290 from "./api/library/items/[id]/GET";
import library_items_id_patch_291 from "./api/library/items/[id]/PATCH";
import library_items_id_install_post_292 from "./api/library/items/[id]/install/POST";
import library_my_installed_get_293 from "./api/library/my-installed/GET";
import me_get_294 from "./api/me/GET";
import me_put_295 from "./api/me/PUT";
import me_2fa_disable_post_296 from "./api/me/2fa/disable/POST";
import me_2fa_enable_post_297 from "./api/me/2fa/enable/POST";
import me_2fa_setup_get_298 from "./api/me/2fa/setup/GET";
import me_2fa_status_get_299 from "./api/me/2fa/status/GET";
import me_2fa_verify_post_300 from "./api/me/2fa/verify/POST";
import me_change_password_post_301 from "./api/me/change-password/POST";
import me_email_status_get_302 from "./api/me/email-status/GET";
import me_phone_get_303 from "./api/me/phone/GET";
import me_phone_put_304 from "./api/me/phone/PUT";
import migrate_account_recovery_post_305 from "./api/migrate-account-recovery/POST";
import migrate_asset_manager_post_306 from "./api/migrate-asset-manager/POST";
import migrate_attendance_post_307 from "./api/migrate-attendance/POST";
import migrate_company_settings_post_308 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_309 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_310 from "./api/migrate-dazza-knowledge/POST";
import migrate_emergency_alerts_post_311 from "./api/migrate-emergency-alerts/POST";
import migrate_estimates_post_312 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_313 from "./api/migrate-estimating-library/POST";
import migrate_files_post_314 from "./api/migrate-files/POST";
import migrate_fleet_post_315 from "./api/migrate-fleet/POST";
import migrate_fleet_analytics_post_316 from "./api/migrate-fleet-analytics/POST";
import migrate_fleet_driver_sessions_post_317 from "./api/migrate-fleet-driver-sessions/POST";
import migrate_fleet_usage_post_318 from "./api/migrate-fleet-usage/POST";
import migrate_form_fields_post_319 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_320 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_321 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_322 from "./api/migrate-job-forms/POST";
import migrate_job_photos_post_323 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_324 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_325 from "./api/migrate-jobs/POST";
import migrate_library_post_326 from "./api/migrate-library/POST";
import migrate_notifications_post_327 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_328 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_329 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_330 from "./api/migrate-pdf-settings/POST";
import migrate_plan_manager_post_331 from "./api/migrate-plan-manager/POST";
import migrate_plan_manager_v2_post_332 from "./api/migrate-plan-manager-v2/POST";
import migrate_plan_manager_v3_post_333 from "./api/migrate-plan-manager-v3/POST";
import migrate_safety_post_334 from "./api/migrate-safety/POST";
import migrate_starter_pack_post_335 from "./api/migrate-starter-pack/POST";
import migrate_studio_pdf_post_336 from "./api/migrate-studio-pdf/POST";
import migrate_subscriptions_post_337 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_338 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_339 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_340 from "./api/migrate-team/POST";
import notes_get_341 from "./api/notes/GET";
import notes_post_342 from "./api/notes/POST";
import notes_comments_post_343 from "./api/notes/comments/POST";
import notes_migrate_post_344 from "./api/notes/migrate/POST";
import notifications_alerts_get_345 from "./api/notifications/alerts/GET";
import notifications_prefs_get_346 from "./api/notifications/prefs/GET";
import notifications_prefs_put_347 from "./api/notifications/prefs/PUT";
import notifications_read_post_348 from "./api/notifications/read/POST";
import owner_console_activity_get_349 from "./api/owner-console/activity/GET";
import owner_console_cancellation_feedback_get_350 from "./api/owner-console/cancellation-feedback/GET";
import owner_console_companies_get_351 from "./api/owner-console/companies/GET";
import owner_console_companies_post_352 from "./api/owner-console/companies/POST";
import owner_console_companies_usage_get_353 from "./api/owner-console/companies/usage/GET";
import owner_console_companies_id_limits_put_354 from "./api/owner-console/companies/[id]/limits/PUT";
import owner_console_form_templates_get_355 from "./api/owner-console/form-templates/GET";
import owner_console_form_templates_post_356 from "./api/owner-console/form-templates/POST";
import owner_console_starter_pack_get_357 from "./api/owner-console/starter-pack/GET";
import owner_console_starter_pack_post_358 from "./api/owner-console/starter-pack/POST";
import owner_console_stats_get_359 from "./api/owner-console/stats/GET";
import owner_console_storage_get_360 from "./api/owner-console/storage/GET";
import owner_console_system_ai_builtin_checks_post_361 from "./api/owner-console/system-ai/builtin-checks/POST";
import owner_console_users_get_362 from "./api/owner-console/users/GET";
import owner_console_users_verify_post_363 from "./api/owner-console/users/verify/POST";
import plan_manager_drawings_get_364 from "./api/plan-manager/drawings/GET";
import plan_manager_drawings_post_365 from "./api/plan-manager/drawings/POST";
import plan_manager_drawings_id_get_366 from "./api/plan-manager/drawings/[id]/GET";
import plan_manager_drawings_id_annotations_put_367 from "./api/plan-manager/drawings/[id]/annotations/PUT";
import plan_manager_drawings_id_archive_post_368 from "./api/plan-manager/drawings/[id]/archive/POST";
import plan_manager_drawings_id_job_links_delete_369 from "./api/plan-manager/drawings/[id]/job-links/DELETE";
import plan_manager_drawings_id_job_links_post_370 from "./api/plan-manager/drawings/[id]/job-links/POST";
import plan_manager_drawings_id_pages_pageNo_annotations_get_371 from "./api/plan-manager/drawings/[id]/pages/[pageNo]/annotations/GET";
import plan_manager_drawings_id_permanent_delete_372 from "./api/plan-manager/drawings/[id]/permanent/DELETE";
import plan_manager_drawings_id_reorder_patch_373 from "./api/plan-manager/drawings/[id]/reorder/PATCH";
import plan_manager_drawings_id_restore_post_374 from "./api/plan-manager/drawings/[id]/restore/POST";
import plan_manager_drawings_id_revisions_post_375 from "./api/plan-manager/drawings/[id]/revisions/POST";
import plan_manager_drawings_id_revisions_revisionId_finalize_post_376 from "./api/plan-manager/drawings/[id]/revisions/[revisionId]/finalize/POST";
import plan_manager_drawings_id_upload_post_377 from "./api/plan-manager/drawings/[id]/upload/POST";
import plan_manager_jobs_with_drawings_get_378 from "./api/plan-manager/jobs-with-drawings/GET";
import plan_manager_share_post_379 from "./api/plan-manager/share/POST";
import plan_manager_share_validate_get_380 from "./api/plan-manager/share/validate/GET";
import portal_estimates_id_approve_post_381 from "./api/portal/estimates/[id]/approve/POST";
import portal_invite_post_382 from "./api/portal/invite/POST";
import portal_invoices_id_pay_post_383 from "./api/portal/invoices/[id]/pay/POST";
import portal_jobs_get_384 from "./api/portal/jobs/GET";
import portal_jobs_id_get_385 from "./api/portal/jobs/[id]/GET";
import portal_migrate_post_386 from "./api/portal/migrate/POST";
import portal_validate_post_387 from "./api/portal/validate/POST";
import public_form_token_get_388 from "./api/public/form/[token]/GET";
import public_form_token_submit_post_389 from "./api/public/form/[token]/submit/POST";
import public_swms_token_get_390 from "./api/public/swms/[token]/GET";
import public_swms_token_signoff_post_391 from "./api/public/swms/[token]/signoff/POST";
import push_subscribe_delete_392 from "./api/push/subscribe/DELETE";
import push_subscribe_post_393 from "./api/push/subscribe/POST";
import push_vapid_key_get_394 from "./api/push/vapid-key/GET";
import recipes_get_395 from "./api/recipes/GET";
import recipes_post_396 from "./api/recipes/POST";
import recipes_id_delete_397 from "./api/recipes/[id]/DELETE";
import recipes_id_put_398 from "./api/recipes/[id]/PUT";
import safety_ai_draft_post_399 from "./api/safety/ai/draft/POST";
import safety_documents_get_400 from "./api/safety/documents/GET";
import safety_documents_post_401 from "./api/safety/documents/POST";
import safety_documents_id_delete_402 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_403 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_404 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_405 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_406 from "./api/safety/generated-posters/[id]/DELETE";
import safety_job_safety_plans_get_407 from "./api/safety/job-safety-plans/GET";
import safety_job_safety_plans_post_408 from "./api/safety/job-safety-plans/POST";
import safety_job_safety_plans_id_delete_409 from "./api/safety/job-safety-plans/[id]/DELETE";
import safety_job_safety_plans_id_put_410 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_411 from "./api/safety/job-swms/GET";
import safety_job_swms_post_412 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_413 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_414 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_415 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_share_token_post_416 from "./api/safety/job-swms/[id]/share-token/POST";
import safety_job_swms_id_signoffs_get_417 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_418 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_419 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_420 from "./api/safety/plans/GET";
import safety_plans_post_421 from "./api/safety/plans/POST";
import safety_plans_seed_post_422 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_423 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_424 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_425 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_426 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_427 from "./api/safety/posters/GET";
import safety_posters_post_428 from "./api/safety/posters/POST";
import safety_posters_id_delete_429 from "./api/safety/posters/[id]/DELETE";
import safety_swms_get_430 from "./api/safety/swms/GET";
import safety_swms_post_431 from "./api/safety/swms/POST";
import safety_swms_import_docx_post_432 from "./api/safety/swms/import-docx/POST";
import safety_swms_seed_post_433 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_434 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_435 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_436 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_437 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_438 from "./api/safety/swms/[id]/export/GET";
import scheduler_crew_get_439 from "./api/scheduler/crew/GET";
import scheduler_jobs_get_440 from "./api/scheduler/jobs/GET";
import scheduler_jobs_id_reschedule_patch_441 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
import secure_share_get_442 from "./api/secure-share/GET";
import secure_share_post_443 from "./api/secure-share/POST";
import secure_share_id_delete_444 from "./api/secure-share/[id]/DELETE";
import secure_share_token_get_445 from "./api/secure-share/[token]/GET";
import secure_share_token_post_446 from "./api/secure-share/[token]/POST";
import settings_backup_get_447 from "./api/settings/backup/GET";
import settings_backup_post_448 from "./api/settings/backup/POST";
import settings_backup_export_get_449 from "./api/settings/backup/export/GET";
import settings_backup_run_post_450 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_451 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_452 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_453 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_454 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_455 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_456 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_457 from "./api/settings/retention/GET";
import settings_retention_post_458 from "./api/settings/retention/POST";
import settings_storage_provider_get_459 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_460 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_461 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_462 from "./api/settings/terminology/GET";
import settings_terminology_post_463 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_464 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_465 from "./api/settings/xero-credentials/POST";
import share_token_get_466 from "./api/share/[token]/GET";
import signin_history_get_467 from "./api/signin-history/GET";
import signup_post_468 from "./api/signup/POST";
import stripe_create_checkout_session_post_469 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_470 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_471 from "./api/subscription/create-checkout/POST";
import subscription_status_get_472 from "./api/subscription/status/GET";
import subscription_webhook_post_473 from "./api/subscription/webhook/POST";
import support_mode_audit_get_474 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_475 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_476 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_477 from "./api/support-mode/enter/POST";
import support_mode_exit_post_478 from "./api/support-mode/exit/POST";
import support_mode_status_get_479 from "./api/support-mode/status/GET";
import tag_tasks_get_480 from "./api/tag-tasks/GET";
import tag_tasks_id_patch_481 from "./api/tag-tasks/[id]/PATCH";
import takeoff_pad_get_482 from "./api/takeoff-pad/GET";
import takeoff_pad_put_483 from "./api/takeoff-pad/PUT";
import team_get_484 from "./api/team/GET";
import team_invite_post_485 from "./api/team/invite/POST";
import team_invites_get_486 from "./api/team/invites/GET";
import team_invites_post_487 from "./api/team/invites/POST";
import team_invites_id_cancel_post_488 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_489 from "./api/team/invites/[id]/resend/POST";
import team_members_get_490 from "./api/team/members/GET";
import team_resend_verification_post_491 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_492 from "./api/team/schedule/migrate/POST";
import team_shifts_get_493 from "./api/team/shifts/GET";
import team_shifts_post_494 from "./api/team/shifts/POST";
import team_shifts_id_delete_495 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_496 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_497 from "./api/team/time-entries/GET";
import team_time_entries_post_498 from "./api/team/time-entries/POST";
import team_time_entries_export_get_499 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_500 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_501 from "./api/team/verify-user/POST";
import team_id_delete_502 from "./api/team/[id]/DELETE";
import team_id_put_503 from "./api/team/[id]/PUT";
import usage_get_504 from "./api/usage/GET";
// </api-imports>
...
app.patch("/api/asset-manager/inspections/:id", asset_manager_inspections_id_patch_13);
app.post("/api/asset-manager/inspections/:id/archive", asset_manager_inspections_id_archive_post_14);
app.post("/api/asset-manager/inspections/:id/closeout", asset_manager_inspections_id_closeout_post_15);
app.post("/api/asset-manager/inspections/:id/defects", asset_manager_inspections_id_defects_post_16);
app.delete("/api/asset-manager/inspections/:id/permanent", asset_manager_inspections_id_permanent_delete_17);
app.post("/api/asset-manager/inspections/:id/photos", asset_manager_inspections_id_photos_post_18);
app.post("/api/asset-manager/inspections/:id/report/share", asset_manager_inspections_id_report_share_post_19);
app.post("/api/asset-manager/inspections/:id/restore", asset_manager_inspections_id_restore_post_20);
app.post("/api/asset-manager/inspections/:id/tenders", asset_manager_inspections_id_tenders_post_21);
app.get("/api/asset-manager/monitoring", asset_manager_monitoring_get_22);
app.get("/api/asset-manager/reports/:shareToken", asset_manager_reports_shareToken_get_23);
app.patch("/api/asset-manager/tenders/:id", asset_manager_tenders_id_patch_24);
app.post("/api/asset-manager/tenders/:id/complete", asset_manager_tenders_id_complete_post_25);
app.post("/api/asset-manager/tenders/:id/contracts", asset_manager_tenders_id_contracts_post_26);
app.post("/api/auth/change-email", auth_change_email_post_27);
app.post("/api/auth/change-password", auth_change_password_post_28);
app.post("/api/auth/check-signup-status", auth_check_signup_status_post_29);
app.post("/api/auth/forgot-password", auth_forgot_password_post_30);
app.post("/api/auth/pin-login", auth_pin_login_post_31);
app.post("/api/auth/resend-verification", auth_resend_verification_post_32);
app.post("/api/auth/reset-password", auth_reset_password_post_33);
app.post("/api/auth/resume-signup", auth_resume_signup_post_34);
app.post("/api/auth/self-verify", auth_self_verify_post_35);
app.post("/api/auth/send-sms-code", auth_send_sms_code_post_36);
app.get("/api/auth/sms-configured", auth_sms_configured_get_37);
app.post("/api/auth/sms-recovery", auth_sms_recovery_post_38);
app.get("/api/auth/trusted-devices", auth_trusted_devices_get_39);
app.post("/api/auth/trusted-devices", auth_trusted_devices_post_40);
app.delete("/api/auth/trusted-devices/:deviceId", auth_trusted_devices_deviceId_delete_41);
app.get("/api/auth/validate-reset-token", auth_validate_reset_token_get_42);
app.post("/api/auth/verify-email", auth_verify_email_post_43);
app.post("/api/auth/verify-sms-code", auth_verify_sms_code_post_44);
app.get("/api/auth/:action", auth_action_get_45);
app.post("/api/auth/:action", auth_action_post_46);
app.get("/api/auth/:action/:detail", auth_action_detail_get_47);
app.post("/api/auth/:action/:detail", auth_action_detail_post_48);
app.post("/api/billing/cancel-subscription", billing_cancel_subscription_post_49);
app.post("/api/billing/cancellation-feedback", billing_cancellation_feedback_post_50);
app.post("/api/billing/customer-portal", billing_customer_portal_post_51);
app.post("/api/billing/reactivate-subscription", billing_reactivate_subscription_post_52);
app.post("/api/billing/upgrade-subscription", billing_upgrade_subscription_post_53);
app.get("/api/company", company_get_54);
app.put("/api/company", company_put_55);
app.post("/api/company/logo", company_logo_post_56);
app.get("/api/company-settings", company_settings_get_57);
app.put("/api/company-settings", company_settings_put_58);
app.post("/api/contact", contact_post_59);
app.get("/api/cost-guide", cost_guide_get_60);
app.post("/api/cost-guide", cost_guide_post_61);
app.get("/api/cost-guide/export-csv", cost_guide_export_csv_get_62);
app.post("/api/cost-guide/import-csv", cost_guide_import_csv_post_63);
app.delete("/api/cost-guide/:id", cost_guide_id_delete_64);
app.put("/api/cost-guide/:id", cost_guide_id_put_65);
app.get("/api/customers", customers_get_66);
app.post("/api/customers", customers_post_67);
app.delete("/api/customers/:id", customers_id_delete_68);
app.get("/api/customers/:id", customers_id_get_69);
app.put("/api/customers/:id", customers_id_put_70);
app.get("/api/dashboard/kpi", dashboard_kpi_get_71);
app.get("/api/dashboard/setup-check", dashboard_setup_check_get_72);
app.get("/api/dashboard/todos", dashboard_todos_get_73);
app.post("/api/dazza/annette", dazza_annette_post_74);
app.post("/api/dazza/brain/hive/approve", dazza_brain_hive_approve_post_75);
app.post("/api/dazza/brain/hive/reject", dazza_brain_hive_reject_post_76);
app.get("/api/dazza/brain/status", dazza_brain_status_get_77);
app.post("/api/dazza/chat", dazza_chat_post_78);
app.post("/api/dazza/chat-v2", dazza_chat_v2_post_79);
app.post("/api/dazza/chat-v2/stream", dazza_chat_v2_stream_post_80);
app.get("/api/dazza/context", dazza_context_get_81);
app.get("/api/dazza/key-status", dazza_key_status_get_82);
app.get("/api/dazza/knowledge", dazza_knowledge_get_83);
app.post("/api/dazza/knowledge", dazza_knowledge_post_84);
app.delete("/api/dazza/knowledge/:id", dazza_knowledge_id_delete_85);
app.put("/api/dazza/knowledge/:id", dazza_knowledge_id_put_86);
app.get("/api/developer/activity-log", developer_activity_log_get_87);
app.get("/api/developer/audit-log", developer_audit_log_get_88);
app.post("/api/developer/companies/:id/archive", developer_companies_id_archive_post_89);
app.get("/api/developer/company-health", developer_company_health_get_90);
app.get("/api/developer/email-log", developer_email_log_get_91);
app.get("/api/developer/email-settings", developer_email_settings_get_92);
app.put("/api/developer/email-settings", developer_email_settings_put_93);
app.post("/api/developer/email-settings/test", developer_email_settings_test_post_94);
app.get("/api/developer/support-notes", developer_support_notes_get_95);
app.post("/api/developer/support-notes", developer_support_notes_post_96);
app.delete("/api/developer/support-notes/:id", developer_support_notes_id_delete_97);
app.post("/api/developer/users/:id/assign-company", developer_users_id_assign_company_post_98);
app.post("/api/developer/users/:id/deactivate", developer_users_id_deactivate_post_99);
app.post("/api/developer/users/:id/delete-orphan", developer_users_id_delete_orphan_post_100);
app.post("/api/developer/users/:id/force-temp-password", developer_users_id_force_temp_password_post_101);
app.delete("/api/developer/users/:id/impersonate", developer_users_id_impersonate_delete_102);
app.post("/api/developer/users/:id/impersonate", developer_users_id_impersonate_post_103);
app.post("/api/developer/users/:id/reactivate", developer_users_id_reactivate_post_104);
app.post("/api/developer/users/:id/resend-verification", developer_users_id_resend_verification_post_105);
app.put("/api/developer/users/:id/role", developer_users_id_role_put_106);
app.post("/api/developer/users/:id/send-reset-email", developer_users_id_send_reset_email_post_107);
app.delete("/api/developer/users/:id/sessions", developer_users_id_sessions_delete_108);
app.get("/api/developer/users/:id/sessions", developer_users_id_sessions_get_109);
app.post("/api/developer/users/:id/unlock-account", developer_users_id_unlock_account_post_110);
app.get("/api/document-templates", document_templates_get_111);
app.post("/api/document-templates", document_templates_post_112);
app.delete("/api/document-templates/:id", document_templates_id_delete_113);
app.get("/api/document-templates/:id", document_templates_id_get_114);
app.put("/api/document-templates/:id", document_templates_id_put_115);
app.post("/api/document-templates/:id/duplicate", document_templates_id_duplicate_post_116);
app.get("/api/document-templates/:id/export/docx", document_templates_id_export_docx_get_117);
app.get("/api/document-templates/:id/export/pdf", document_templates_id_export_pdf_get_118);
app.post("/api/document-templates/:id/import-docx", document_templates_id_import_docx_post_119);
app.post("/api/document-templates/:id/import-pdf", document_templates_id_import_pdf_post_120);
app.get("/api/documents", documents_get_121);
app.get("/api/documents/share/:token", documents_share_token_get_122);
app.post("/api/documents/share/:token", documents_share_token_post_123);
app.get("/api/documents/:id", documents_id_get_124);
app.put("/api/documents/:id", documents_id_put_125);
app.get("/api/documents/:id/events", documents_id_events_get_126);
app.delete("/api/documents/:id/share", documents_id_share_delete_127);
app.post("/api/documents/:id/share", documents_id_share_post_128);
app.get("/api/drawings", drawings_get_129);
app.post("/api/drawings", drawings_post_130);
app.post("/api/drawings/upload", drawings_upload_post_131);
app.delete("/api/drawings/:id", drawings_id_delete_132);
app.patch("/api/drawings/:id", drawings_id_patch_133);
app.post("/api/drawings/:id/markup", drawings_id_markup_post_134);
app.get("/api/emergency-alerts", emergency_alerts_get_135);
app.post("/api/emergency-alerts", emergency_alerts_post_136);
app.put("/api/emergency-alerts/:id", emergency_alerts_id_put_137);
app.get("/api/estimates", estimates_get_138);
app.post("/api/estimates", estimates_post_139);
app.delete("/api/estimates/:id", estimates_id_delete_140);
app.get("/api/estimates/:id", estimates_id_get_141);
app.put("/api/estimates/:id", estimates_id_put_142);
app.get("/api/estimates/:id/export-csv", estimates_id_export_csv_get_143);
app.get("/api/estimates/:id/export-pdf", estimates_id_export_pdf_get_144);
app.post("/api/estimates/:id/import-csv", estimates_id_import_csv_post_145);
app.get("/api/external/form/:token", external_form_token_get_146);
app.post("/api/external/form/:token", external_form_token_post_147);
app.get("/api/files", files_get_148);
app.post("/api/files", files_post_149);
app.delete("/api/files/:id", files_id_delete_150);
app.get("/api/files/:id/download", files_id_download_get_151);
app.get("/api/fleet", fleet_get_152);
app.post("/api/fleet", fleet_post_153);
app.get("/api/fleet/analytics-settings", fleet_analytics_settings_get_154);
app.put("/api/fleet/analytics-settings", fleet_analytics_settings_put_155);
app.post("/api/fleet/driver-sessions", fleet_driver_sessions_post_156);
app.get("/api/fleet/driver-sessions/active", fleet_driver_sessions_active_get_157);
app.post("/api/fleet/driver-sessions/:id/stop", fleet_driver_sessions_id_stop_post_158);
app.get("/api/fleet/driver-sessions/:id/summary", fleet_driver_sessions_id_summary_get_159);
app.post("/api/fleet/driver-sessions/:id/telemetry", fleet_driver_sessions_id_telemetry_post_160);
app.get("/api/fleet/flags", fleet_flags_get_161);
app.delete("/api/fleet/service-logs/:logId", fleet_service_logs_logId_delete_162);
app.patch("/api/fleet/service-logs/:logId", fleet_service_logs_logId_patch_163);
app.get("/api/fleet/vehicles", fleet_vehicles_get_164);
app.delete("/api/fleet/:id", fleet_id_delete_165);
app.get("/api/fleet/:id", fleet_id_get_166);
app.put("/api/fleet/:id", fleet_id_put_167);
app.get("/api/fleet/:id/driver-sessions", fleet_id_driver_sessions_get_168);
app.get("/api/fleet/:id/files", fleet_id_files_get_169);
app.get("/api/fleet/:id/prestarts", fleet_id_prestarts_get_170);
app.post("/api/fleet/:id/prestarts", fleet_id_prestarts_post_171);
app.get("/api/fleet/:id/service-logs", fleet_id_service_logs_get_172);
app.post("/api/fleet/:id/service-logs", fleet_id_service_logs_post_173);
app.post("/api/fleet/:id/signin", fleet_id_signin_post_174);
app.post("/api/fleet/:id/signout", fleet_id_signout_post_175);
app.get("/api/fleet/:id/usage-export", fleet_id_usage_export_get_176);
app.get("/api/fleet/:id/usage-status", fleet_id_usage_status_get_177);
app.get("/api/fleet/:id/usage-summary", fleet_id_usage_summary_get_178);
app.get("/api/form-templates", form_templates_get_179);
app.post("/api/form-templates", form_templates_post_180);
app.post("/api/form-templates/seed", form_templates_seed_post_181);
app.delete("/api/form-templates/:id", form_templates_id_delete_182);
app.put("/api/form-templates/:id", form_templates_id_put_183);
app.post("/api/forms/migrate-skip-logic", forms_migrate_skip_logic_post_184);
app.get("/api/forms/skip-audit", forms_skip_audit_get_185);
app.post("/api/forms/skip-audit", forms_skip_audit_post_186);
app.get("/api/forms/submissions", forms_submissions_get_187);
app.post("/api/forms/templates/:id/share-link", forms_templates_id_share_link_post_188);
app.get("/api/forms/:id/fields", forms_id_fields_get_189);
app.post("/api/forms/:id/fields", forms_id_fields_post_190);
app.post("/api/forms/:id/fields/reorder", forms_id_fields_reorder_post_191);
app.delete("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_delete_192);
app.patch("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_patch_193);
app.post("/api/forms/:id/fields/:fieldId/thumbnail", forms_id_fields_fieldId_thumbnail_post_194);
app.get("/api/health", health_get_195);
app.get("/api/integrations/myob/auth-url", integrations_myob_auth_url_get_196);
app.get("/api/integrations/myob/callback", integrations_myob_callback_get_197);
app.post("/api/integrations/myob/disconnect", integrations_myob_disconnect_post_198);
app.get("/api/integrations/myob/status", integrations_myob_status_get_199);
app.post("/api/integrations/myob/sync-invoice", integrations_myob_sync_invoice_post_200);
app.get("/api/integrations/onedrive/auth-url", integrations_onedrive_auth_url_get_201);
app.get("/api/integrations/onedrive/callback", integrations_onedrive_callback_get_202);
app.post("/api/integrations/onedrive/disconnect", integrations_onedrive_disconnect_post_203);
app.get("/api/integrations/onedrive/status", integrations_onedrive_status_get_204);
app.post("/api/integrations/onedrive/upload-file", integrations_onedrive_upload_file_post_205);
app.get("/api/integrations/qbo/auth-url", integrations_qbo_auth_url_get_206);
app.get("/api/integrations/qbo/callback", integrations_qbo_callback_get_207);
app.post("/api/integrations/qbo/disconnect", integrations_qbo_disconnect_post_208);
app.get("/api/integrations/qbo/status", integrations_qbo_status_get_209);
app.post("/api/integrations/qbo/sync-invoice", integrations_qbo_sync_invoice_post_210);
app.get("/api/integrations/xero/auth-url", integrations_xero_auth_url_get_211);
app.get("/api/integrations/xero/callback", integrations_xero_callback_get_212);
app.post("/api/integrations/xero/disconnect", integrations_xero_disconnect_post_213);
app.get("/api/integrations/xero/status", integrations_xero_status_get_214);
app.post("/api/integrations/xero/sync-customer", integrations_xero_sync_customer_post_215);
app.post("/api/integrations/xero/sync-invoice", integrations_xero_sync_invoice_post_216);
app.post("/api/integrations/xero/webhook", integrations_xero_webhook_post_217);
app.get("/api/invoices", invoices_get_218);
app.post("/api/invoices", invoices_post_219);
app.delete("/api/invoices/:id", invoices_id_delete_220);
app.get("/api/invoices/:id", invoices_id_get_221);
app.put("/api/invoices/:id", invoices_id_put_222);
app.post("/api/invoices/:id/duplicate", invoices_id_duplicate_post_223);
app.get("/api/invoices/:id/export-pdf", invoices_id_export_pdf_get_224);
app.post("/api/invoices/:id/mark-sent", invoices_id_mark_sent_post_225);
app.post("/api/invoices/:id/record-payment", invoices_id_record_payment_post_226);
app.post("/api/invoices/:id/void", invoices_id_void_post_227);
app.delete("/api/job-forms/:id", job_forms_id_delete_228);
app.get("/api/job-forms/:id", job_forms_id_get_229);
app.put("/api/job-forms/:id", job_forms_id_put_230);
app.post("/api/job-forms/:id/reset", job_forms_id_reset_post_231);
app.delete("/api/job-forms/:id/share", job_forms_id_share_delete_232);
app.get("/api/job-forms/:id/share", job_forms_id_share_get_233);
app.post("/api/job-forms/:id/share", job_forms_id_share_post_234);
app.get("/api/jobs", jobs_get_235);
app.post("/api/jobs", jobs_post_236);
app.get("/api/jobs/:id", jobs_id_get_237);
app.put("/api/jobs/:id", jobs_id_put_238);
app.post("/api/jobs/:id/attendance/:attendanceId/close", jobs_id_attendance_attendanceId_close_post_239);
app.get("/api/jobs/:id/costs", jobs_id_costs_get_240);
app.post("/api/jobs/:id/costs", jobs_id_costs_post_241);
app.get("/api/jobs/:id/costs/export", jobs_id_costs_export_get_242);
app.delete("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_delete_243);
app.put("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_put_244);
app.get("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_get_245);
app.post("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_post_246);
app.get("/api/jobs/:id/delays", jobs_id_delays_get_247);
app.post("/api/jobs/:id/delays", jobs_id_delays_post_248);
app.delete("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_delete_249);
app.put("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_put_250);
app.get("/api/jobs/:id/files", jobs_id_files_get_251);
app.get("/api/jobs/:id/forms", jobs_id_forms_get_252);
app.post("/api/jobs/:id/forms", jobs_id_forms_post_253);
app.post("/api/jobs/:id/generate-qr", jobs_id_generate_qr_post_254);
app.get("/api/jobs/:id/ledger", jobs_id_ledger_get_255);
app.post("/api/jobs/:id/ledger", jobs_id_ledger_post_256);
app.get("/api/jobs/:id/ledger/export", jobs_id_ledger_export_get_257);
app.post("/api/jobs/:id/ledger/sync", jobs_id_ledger_sync_post_258);
app.delete("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_delete_259);
app.put("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_put_260);
app.post("/api/jobs/:id/ledger/:entryId/correct", jobs_id_ledger_entryId_correct_post_261);
app.get("/api/jobs/:id/photos", jobs_id_photos_get_262);
app.post("/api/jobs/:id/photos", jobs_id_photos_post_263);
app.delete("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_delete_264);
app.patch("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_patch_265);
app.get("/api/jobs/:id/photos/:photoId/download", jobs_id_photos_photoId_download_get_266);
app.post("/api/jobs/:id/photos/:photoId/replace", jobs_id_photos_photoId_replace_post_267);
app.get("/api/jobs/:id/progress", jobs_id_progress_get_268);
app.put("/api/jobs/:id/progress", jobs_id_progress_put_269);
app.post("/api/jobs/:id/progress/sync", jobs_id_progress_sync_post_270);
app.get("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_get_271);
app.post("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_post_272);
app.delete("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_delete_273);
app.get("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_get_274);
app.put("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_put_275);
app.get("/api/jobs/:id/purchase-orders/:poId/pdf", jobs_id_purchase_orders_poId_pdf_get_276);
...
app.get("/api/jobs/:id/todos", jobs_id_todos_get_285);
app.post("/api/jobs/:id/todos", jobs_id_todos_post_286);
app.delete("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_delete_287);
app.put("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_put_288);
app.get("/api/library/items", library_items_get_289);
app.get("/api/library/items/:id", library_items_id_get_290);
app.patch("/api/library/items/:id", library_items_id_patch_291);
app.post("/api/library/items/:id/install", library_items_id_install_post_292);
app.get("/api/library/my-installed", library_my_installed_get_293);
app.get("/api/me", me_get_294);
app.put("/api/me", me_put_295);
app.post("/api/me/2fa/disable", me_2fa_disable_post_296);
app.post("/api/me/2fa/enable", me_2fa_enable_post_297);
app.get("/api/me/2fa/setup", me_2fa_setup_get_298);
app.get("/api/me/2fa/status", me_2fa_status_get_299);
app.post("/api/me/2fa/verify", me_2fa_verify_post_300);
app.post("/api/me/change-password", me_change_password_post_301);
app.get("/api/me/email-status", me_email_status_get_302);
app.get("/api/me/phone", me_phone_get_303);
app.put("/api/me/phone", me_phone_put_304);
app.post("/api/migrate-account-recovery", migrate_account_recovery_post_305);
app.post("/api/migrate-asset-manager", migrate_asset_manager_post_306);
app.post("/api/migrate-attendance", migrate_attendance_post_307);
app.post("/api/migrate-company-settings", migrate_company_settings_post_308);
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_309);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_310);
app.post("/api/migrate-emergency-alerts", migrate_emergency_alerts_post_311);
app.post("/api/migrate-estimates", migrate_estimates_post_312);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_313);
app.post("/api/migrate-files", migrate_files_post_314);
app.post("/api/migrate-fleet", migrate_fleet_post_315);
app.post("/api/migrate-fleet-analytics", migrate_fleet_analytics_post_316);
app.post("/api/migrate-fleet-driver-sessions", migrate_fleet_driver_sessions_post_317);
app.post("/api/migrate-fleet-usage", migrate_fleet_usage_post_318);
app.post("/api/migrate-form-fields", migrate_form_fields_post_319);
app.post("/api/migrate-form-logic", migrate_form_logic_post_320);
app.post("/api/migrate-form-templates", migrate_form_templates_post_321);
app.post("/api/migrate-job-forms", migrate_job_forms_post_322);
app.post("/api/migrate-job-photos", migrate_job_photos_post_323);
app.post("/api/migrate-job-tabs", migrate_job_tabs_post_324);
app.post("/api/migrate-jobs", migrate_jobs_post_325);
app.post("/api/migrate-library", migrate_library_post_326);
app.post("/api/migrate-notifications", migrate_notifications_post_327);
app.post("/api/migrate-owner-console", migrate_owner_console_post_328);
app.post("/api/migrate-owner-role", migrate_owner_role_post_329);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_330);
app.post("/api/migrate-plan-manager", migrate_plan_manager_post_331);
app.post("/api/migrate-plan-manager-v2", migrate_plan_manager_v2_post_332);
app.post("/api/migrate-plan-manager-v3", migrate_plan_manager_v3_post_333);
app.post("/api/migrate-safety", migrate_safety_post_334);
app.post("/api/migrate-starter-pack", migrate_starter_pack_post_335);
app.post("/api/migrate-studio-pdf", migrate_studio_pdf_post_336);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_337);
app.post("/api/migrate-support-mode", migrate_support_mode_post_338);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_339);
app.post("/api/migrate-team", migrate_team_post_340);
app.get("/api/notes", notes_get_341);
app.post("/api/notes", notes_post_342);
app.post("/api/notes/comments", notes_comments_post_343);
app.post("/api/notes/migrate", notes_migrate_post_344);
app.get("/api/notifications/alerts", notifications_alerts_get_345);
app.get("/api/notifications/prefs", notifications_prefs_get_346);
app.put("/api/notifications/prefs", notifications_prefs_put_347);
app.post("/api/notifications/read", notifications_read_post_348);
app.get("/api/owner-console/activity", owner_console_activity_get_349);
app.get("/api/owner-console/cancellation-feedback", owner_console_cancellation_feedback_get_350);
app.get("/api/owner-console/companies", owner_console_companies_get_351);
app.post("/api/owner-console/companies", owner_console_companies_post_352);
app.get("/api/owner-console/companies/usage", owner_console_companies_usage_get_353);
app.put("/api/owner-console/companies/:id/limits", owner_console_companies_id_limits_put_354);
app.get("/api/owner-console/form-templates", owner_console_form_templates_get_355);
app.post("/api/owner-console/form-templates", owner_console_form_templates_post_356);
app.get("/api/owner-console/starter-pack", owner_console_starter_pack_get_357);
app.post("/api/owner-console/starter-pack", owner_console_starter_pack_post_358);
app.get("/api/owner-console/stats", owner_console_stats_get_359);
app.get("/api/owner-console/storage", owner_console_storage_get_360);
app.post("/api/owner-console/system-ai/builtin-checks", owner_console_system_ai_builtin_checks_post_361);
app.get("/api/owner-console/users", owner_console_users_get_362);
app.post("/api/owner-console/users/verify", owner_console_users_verify_post_363);
app.get("/api/plan-manager/drawings", plan_manager_drawings_get_364);
app.post("/api/plan-manager/drawings", plan_manager_drawings_post_365);
app.get("/api/plan-manager/drawings/:id", plan_manager_drawings_id_get_366);
app.put("/api/plan-manager/drawings/:id/annotations", plan_manager_drawings_id_annotations_put_367);
app.post("/api/plan-manager/drawings/:id/archive", plan_manager_drawings_id_archive_post_368);
app.delete("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_delete_369);
app.post("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_post_370);
app.get("/api/plan-manager/drawings/:id/pages/:pageNo/annotations", plan_manager_drawings_id_pages_pageNo_annotations_get_371);
app.delete("/api/plan-manager/drawings/:id/permanent", plan_manager_drawings_id_permanent_delete_372);
app.patch("/api/plan-manager/drawings/:id/reorder", plan_manager_drawings_id_reorder_patch_373);
app.post("/api/plan-manager/drawings/:id/restore", plan_manager_drawings_id_restore_post_374);
app.post("/api/plan-manager/drawings/:id/revisions", plan_manager_drawings_id_revisions_post_375);
app.post("/api/plan-manager/drawings/:id/revisions/:revisionId/finalize", plan_manager_drawings_id_revisions_revisionId_finalize_post_376);
app.post("/api/plan-manager/drawings/:id/upload", plan_manager_drawings_id_upload_post_377);
app.get("/api/plan-manager/jobs-with-drawings", plan_manager_jobs_with_drawings_get_378);
app.post("/api/plan-manager/share", plan_manager_share_post_379);
app.get("/api/plan-manager/share/validate", plan_manager_share_validate_get_380);
app.post("/api/portal/estimates/:id/approve", portal_estimates_id_approve_post_381);
app.post("/api/portal/invite", portal_invite_post_382);
app.post("/api/portal/invoices/:id/pay", portal_invoices_id_pay_post_383);
app.get("/api/portal/jobs", portal_jobs_get_384);
app.get("/api/portal/jobs/:id", portal_jobs_id_get_385);
app.post("/api/portal/migrate", portal_migrate_post_386);
app.post("/api/portal/validate", portal_validate_post_387);
app.get("/api/public/form/:token", public_form_token_get_388);
app.post("/api/public/form/:token/submit", public_form_token_submit_post_389);
app.get("/api/public/swms/:token", public_swms_token_get_390);
app.post("/api/public/swms/:token/signoff", public_swms_token_signoff_post_391);
app.delete("/api/push/subscribe", push_subscribe_delete_392);
app.post("/api/push/subscribe", push_subscribe_post_393);
app.get("/api/push/vapid-key", push_vapid_key_get_394);
app.get("/api/recipes", recipes_get_395);
app.post("/api/recipes", recipes_post_396);
app.delete("/api/recipes/:id", recipes_id_delete_397);
app.put("/api/recipes/:id", recipes_id_put_398);
app.post("/api/safety/ai/draft", safety_ai_draft_post_399);
app.get("/api/safety/documents", safety_documents_get_400);
app.post("/api/safety/documents", safety_documents_post_401);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_402);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_403);
app.get("/api/safety/generated-posters", safety_generated_posters_get_404);
app.post("/api/safety/generated-posters", safety_generated_posters_post_405);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_406);
app.get("/api/safety/job-safety-plans", safety_job_safety_plans_get_407);
app.post("/api/safety/job-safety-plans", safety_job_safety_plans_post_408);
app.delete("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_delete_409);
app.put("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_put_410);
app.get("/api/safety/job-swms", safety_job_swms_get_411);
app.post("/api/safety/job-swms", safety_job_swms_post_412);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_413);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_414);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_415);
app.post("/api/safety/job-swms/:id/share-token", safety_job_swms_id_share_token_post_416);
app.get("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_get_417);
app.post("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_post_418);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", safety_job_swms_id_signoffs_signoffId_delete_419);
app.get("/api/safety/plans", safety_plans_get_420);
app.post("/api/safety/plans", safety_plans_post_421);
app.post("/api/safety/plans/seed", safety_plans_seed_post_422);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_423);
app.put("/api/safety/plans/:id", safety_plans_id_put_424);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_425);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_426);
app.get("/api/safety/posters", safety_posters_get_427);
app.post("/api/safety/posters", safety_posters_post_428);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_429);
app.get("/api/safety/swms", safety_swms_get_430);
app.post("/api/safety/swms", safety_swms_post_431);
app.post("/api/safety/swms/import-docx", safety_swms_import_docx_post_432);
app.post("/api/safety/swms/seed", safety_swms_seed_post_433);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_434);
app.get("/api/safety/swms/:id", safety_swms_id_get_435);
app.put("/api/safety/swms/:id", safety_swms_id_put_436);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_437);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_438);
app.get("/api/scheduler/crew", scheduler_crew_get_439);
app.get("/api/scheduler/jobs", scheduler_jobs_get_440);
app.patch("/api/scheduler/jobs/:id/reschedule", scheduler_jobs_id_reschedule_patch_441);
app.get("/api/secure-share", secure_share_get_442);
app.post("/api/secure-share", secure_share_post_443);
app.delete("/api/secure-share/:id", secure_share_id_delete_444);
app.get("/api/secure-share/:token", secure_share_token_get_445);
app.post("/api/secure-share/:token", secure_share_token_post_446);
app.get("/api/settings/backup", settings_backup_get_447);
app.post("/api/settings/backup", settings_backup_post_448);
app.get("/api/settings/backup/export", settings_backup_export_get_449);
app.post("/api/settings/backup/run", settings_backup_run_post_450);
app.get("/api/settings/backup-destination", settings_backup_destination_get_451);
app.post("/api/settings/backup-destination", settings_backup_destination_post_452);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_453);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_454);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_455);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_456);
app.get("/api/settings/retention", settings_retention_get_457);
app.post("/api/settings/retention", settings_retention_post_458);
app.get("/api/settings/storage-provider", settings_storage_provider_get_459);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_460);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_461);
app.get("/api/settings/terminology", settings_terminology_get_462);
app.post("/api/settings/terminology", settings_terminology_post_463);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_464);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_465);
app.get("/api/share/:token", share_token_get_466);
app.get("/api/signin-history", signin_history_get_467);
app.post("/api/signup", signup_post_468);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_469);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_470);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_471);
app.get("/api/subscription/status", subscription_status_get_472);
app.post("/api/subscription/webhook", subscription_webhook_post_473);
app.get("/api/support-mode/audit", support_mode_audit_get_474);
app.get("/api/support-mode/checklist", support_mode_checklist_get_475);
app.put("/api/support-mode/checklist", support_mode_checklist_put_476);
app.post("/api/support-mode/enter", support_mode_enter_post_477);
app.post("/api/support-mode/exit", support_mode_exit_post_478);
app.get("/api/support-mode/status", support_mode_status_get_479);
app.get("/api/tag-tasks", tag_tasks_get_480);
app.patch("/api/tag-tasks/:id", tag_tasks_id_patch_481);
app.get("/api/takeoff-pad", takeoff_pad_get_482);
app.put("/api/takeoff-pad", takeoff_pad_put_483);
app.get("/api/team", team_get_484);
app.post("/api/team/invite", team_invite_post_485);
app.get("/api/team/invites", team_invites_get_486);
app.post("/api/team/invites", team_invites_post_487);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_488);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_489);
app.get("/api/team/members", team_members_get_490);
app.post("/api/team/resend-verification", team_resend_verification_post_491);
app.post("/api/team/schedule/migrate", team_schedule_migrate_post_492);
app.get("/api/team/shifts", team_shifts_get_493);
app.post("/api/team/shifts", team_shifts_post_494);
app.delete("/api/team/shifts/:id", team_shifts_id_delete_495);
app.put("/api/team/shifts/:id", team_shifts_id_put_496);
app.get("/api/team/time-entries", team_time_entries_get_497);
app.post("/api/team/time-entries", team_time_entries_post_498);
app.get("/api/team/time-entries/export", team_time_entries_export_get_499);
app.put("/api/team/time-entries/:id", team_time_entries_id_put_500);
app.post("/api/team/verify-user", team_verify_user_post_501);
app.delete("/api/team/:id", team_id_delete_502);
app.put("/api/team/:id", team_id_put_503);
app.get("/api/usage", usage_get_504);
// </api-registrations>
