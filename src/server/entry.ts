...
import dashboard_kpi_get_45 from "./api/dashboard/kpi/GET";
import dashboard_setup_check_get_46 from "./api/dashboard/setup-check/GET";
import dashboard_todos_get_47 from "./api/dashboard/todos/GET";
import dazza_brain_hive_approve_post_49 from "./api/dazza/brain/hive/approve/POST";
import dazza_brain_hive_reject_post_50 from "./api/dazza/brain/hive/reject/POST";
import dazza_brain_status_get_51 from "./api/dazza/brain/status/GET";
import dazza_context_get_55 from "./api/dazza/context/GET";
import dazza_key_status_get_56 from "./api/dazza/key-status/GET";
import dazza_knowledge_get_57 from "./api/dazza/knowledge/GET";
import dazza_knowledge_post_58 from "./api/dazza/knowledge/POST";
import dazza_knowledge_id_delete_59 from "./api/dazza/knowledge/[id]/DELETE";
import dazza_knowledge_id_put_60 from "./api/dazza/knowledge/[id]/PUT";
...
import document_templates_get_85 from "./api/document-templates/GET";
import document_templates_post_86 from "./api/document-templates/POST";
import document_templates_id_delete_87 from "./api/document-templates/[id]/DELETE";
import document_templates_id_get_88 from "./api/document-templates/[id]/GET";
import document_templates_id_put_89 from "./api/document-templates/[id]/PUT";
import document_templates_id_import_docx_post_90 from "./api/document-templates/[id]/import-docx/POST";
import documents_get_91 from "./api/documents/GET";
import documents_share_token_get_92 from "./api/documents/share/[token]/GET";
import documents_share_token_post_93 from "./api/documents/share/[token]/POST";
import documents_id_get_94 from "./api/documents/[id]/GET";
import documents_id_put_95 from "./api/documents/[id]/PUT";
import documents_id_events_get_96 from "./api/documents/[id]/events/GET";
import documents_id_share_delete_97 from "./api/documents/[id]/share/DELETE";
import documents_id_share_post_98 from "./api/documents/[id]/share/POST";
import drawings_get_99 from "./api/drawings/GET";
import drawings_post_100 from "./api/drawings/POST";
import drawings_upload_post_101 from "./api/drawings/upload/POST";
import drawings_id_delete_102 from "./api/drawings/[id]/DELETE";
import drawings_id_patch_103 from "./api/drawings/[id]/PATCH";
import drawings_id_markup_post_104 from "./api/drawings/[id]/markup/POST";
import estimates_get_105 from "./api/estimates/GET";
import estimates_post_106 from "./api/estimates/POST";
import estimates_id_delete_107 from "./api/estimates/[id]/DELETE";
import estimates_id_get_108 from "./api/estimates/[id]/GET";
import estimates_id_put_109 from "./api/estimates/[id]/PUT";
import estimates_id_export_csv_get_110 from "./api/estimates/[id]/export-csv/GET";
import estimates_id_export_pdf_get_111 from "./api/estimates/[id]/export-pdf/GET";
import estimates_id_import_csv_post_112 from "./api/estimates/[id]/import-csv/POST";
import external_form_token_get_113 from "./api/external/form/[token]/GET";
import external_form_token_post_114 from "./api/external/form/[token]/POST";
import files_get_115 from "./api/files/GET";
import files_post_116 from "./api/files/POST";
import files_id_delete_117 from "./api/files/[id]/DELETE";
import files_id_download_get_118 from "./api/files/[id]/download/GET";
...
import form_templates_get_137 from "./api/form-templates/GET";
import form_templates_post_138 from "./api/form-templates/POST";
import form_templates_id_delete_140 from "./api/form-templates/[id]/DELETE";
import form_templates_id_put_141 from "./api/form-templates/[id]/PUT";
import forms_submissions_get_142 from "./api/forms/submissions/GET";
import forms_templates_id_share_link_post_143 from "./api/forms/templates/[id]/share-link/POST";
import forms_id_fields_get_144 from "./api/forms/[id]/fields/GET";
import forms_id_fields_post_145 from "./api/forms/[id]/fields/POST";
import forms_id_fields_reorder_post_146 from "./api/forms/[id]/fields/reorder/POST";
import forms_id_fields_fieldId_delete_147 from "./api/forms/[id]/fields/[fieldId]/DELETE";
import forms_id_fields_fieldId_patch_148 from "./api/forms/[id]/fields/[fieldId]/PATCH";
import forms_id_fields_fieldId_thumbnail_post_149 from "./api/forms/[id]/fields/[fieldId]/thumbnail/POST";
import health_get_150 from "./api/health/GET";
...
import invoices_get_173 from "./api/invoices/GET";
import invoices_post_174 from "./api/invoices/POST";
import invoices_id_delete_175 from "./api/invoices/[id]/DELETE";
import invoices_id_get_176 from "./api/invoices/[id]/GET";
import invoices_id_put_177 from "./api/invoices/[id]/PUT";
import invoices_id_duplicate_post_178 from "./api/invoices/[id]/duplicate/POST";
import invoices_id_export_pdf_get_179 from "./api/invoices/[id]/export-pdf/GET";
import invoices_id_mark_sent_post_180 from "./api/invoices/[id]/mark-sent/POST";
import invoices_id_record_payment_post_181 from "./api/invoices/[id]/record-payment/POST";
import invoices_id_void_post_182 from "./api/invoices/[id]/void/POST";
import job_forms_id_delete_183 from "./api/job-forms/[id]/DELETE";
import job_forms_id_get_184 from "./api/job-forms/[id]/GET";
import job_forms_id_put_185 from "./api/job-forms/[id]/PUT";
import job_forms_id_reset_post_186 from "./api/job-forms/[id]/reset/POST";
import job_forms_id_share_delete_187 from "./api/job-forms/[id]/share/DELETE";
import job_forms_id_share_get_188 from "./api/job-forms/[id]/share/GET";
import job_forms_id_share_post_189 from "./api/job-forms/[id]/share/POST";
...
import me_get_237 from "./api/me/GET";
import me_put_238 from "./api/me/PUT";
import me_2fa_disable_post_239 from "./api/me/2fa/disable/POST";
import me_2fa_enable_post_240 from "./api/me/2fa/enable/POST";
import me_2fa_setup_get_241 from "./api/me/2fa/setup/GET";
import me_2fa_status_get_242 from "./api/me/2fa/status/GET";
import me_2fa_verify_post_243 from "./api/me/2fa/verify/POST";
import me_change_password_post_244 from "./api/me/change-password/POST";
import me_email_status_get_245 from "./api/me/email-status/GET";
import me_phone_get_246 from "./api/me/phone/GET";
import me_phone_put_247 from "./api/me/phone/PUT";
import notifications_prefs_get_275 from "./api/notifications/prefs/GET";
import notifications_prefs_put_276 from "./api/notifications/prefs/PUT";
import notifications_read_post_277 from "./api/notifications/read/POST";
import owner_console_activity_get_278 from "./api/owner-console/activity/GET";
import owner_console_cancellation_feedback_get_279 from "./api/owner-console/cancellation-feedback/GET";
import owner_console_companies_get_280 from "./api/owner-console/companies/GET";
import owner_console_companies_post_281 from "./api/owner-console/companies/POST";
import owner_console_companies_usage_get_282 from "./api/owner-console/companies/usage/GET";
import owner_console_companies_id_limits_put_283 from "./api/owner-console/companies/[id]/limits/PUT";
import owner_console_form_templates_get_284 from "./api/owner-console/form-templates/GET";
import owner_console_form_templates_post_285 from "./api/owner-console/form-templates/POST";
import owner_console_starter_pack_get_286 from "./api/owner-console/starter-pack/GET";
import owner_console_starter_pack_post_287 from "./api/owner-console/starter-pack/POST";
import owner_console_stats_get_288 from "./api/owner-console/stats/GET";
import owner_console_storage_get_289 from "./api/owner-console/storage/GET";
import owner_console_users_get_291 from "./api/owner-console/users/GET";
import owner_console_users_verify_post_292 from "./api/owner-console/users/verify/POST";
import plan_manager_drawings_get_293 from "./api/plan-manager/drawings/GET";
import plan_manager_drawings_post_294 from "./api/plan-manager/drawings/POST";
import plan_manager_drawings_id_get_295 from "./api/plan-manager/drawings/[id]/GET";
import plan_manager_drawings_id_annotations_put_296 from "./api/plan-manager/drawings/[id]/annotations/PUT";
import plan_manager_drawings_id_archive_post_297 from "./api/plan-manager/drawings/[id]/archive/POST";
import plan_manager_drawings_id_job_links_post_298 from "./api/plan-manager/drawings/[id]/job-links/POST";
import plan_manager_drawings_id_pages_pageNo_annotations_get_299 from "./api/plan-manager/drawings/[id]/pages/[pageNo]/annotations/GET";
import plan_manager_drawings_id_permanent_delete_300 from "./api/plan-manager/drawings/[id]/permanent/DELETE";
import plan_manager_drawings_id_restore_post_301 from "./api/plan-manager/drawings/[id]/restore/POST";
import plan_manager_drawings_id_revisions_post_302 from "./api/plan-manager/drawings/[id]/revisions/POST";
import plan_manager_drawings_id_revisions_revisionId_finalize_post_303 from "./api/plan-manager/drawings/[id]/revisions/[revisionId]/finalize/POST";
import plan_manager_drawings_id_upload_post_304 from "./api/plan-manager/drawings/[id]/upload/POST";
import plan_manager_share_post_305 from "./api/plan-manager/share/POST";
import plan_manager_share_validate_get_306 from "./api/plan-manager/share/validate/GET";
import portal_estimates_id_approve_post_307 from "./api/portal/estimates/[id]/approve/POST";
import portal_invite_post_308 from "./api/portal/invite/POST";
import portal_invoices_id_pay_post_309 from "./api/portal/invoices/[id]/pay/POST";
import portal_jobs_get_310 from "./api/portal/jobs/GET";
import portal_jobs_id_get_311 from "./api/portal/jobs/[id]/GET";
import portal_migrate_post_312 from "./api/portal/migrate/POST";
import portal_validate_post_313 from "./api/portal/validate/POST";
import public_form_token_get_314 from "./api/public/form/[token]/GET";
import public_form_token_submit_post_315 from "./api/public/form/[token]/submit/POST";
import public_swms_token_get_316 from "./api/public/swms/[token]/GET";
import public_swms_token_signoff_post_317 from "./api/public/swms/[token]/signoff/POST";
import recipes_get_318 from "./api/recipes/GET";
import recipes_post_319 from "./api/recipes/POST";
import recipes_id_delete_320 from "./api/recipes/[id]/DELETE";
import recipes_id_put_321 from "./api/recipes/[id]/PUT";
import safety_ai_draft_post_322 from "./api/safety/ai/draft/POST";
import safety_documents_get_323 from "./api/safety/documents/GET";
import safety_documents_post_324 from "./api/safety/documents/POST";
import safety_documents_id_delete_325 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_326 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_327 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_328 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_329 from "./api/safety/generated-posters/[id]/DELETE";
import safety_job_safety_plans_get_330 from "./api/safety/job-safety-plans/GET";
import safety_job_safety_plans_post_331 from "./api/safety/job-safety-plans/POST";
import safety_job_safety_plans_id_delete_332 from "./api/safety/job-safety-plans/[id]/DELETE";
import safety_job_safety_plans_id_put_333 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_334 from "./api/safety/job-swms/GET";
import safety_job_swms_post_335 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_336 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_337 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_338 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_share_token_post_339 from "./api/safety/job-swms/[id]/share-token/POST";
import safety_job_swms_id_signoffs_get_340 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_341 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_342 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_343 from "./api/safety/plans/GET";
import safety_plans_post_344 from "./api/safety/plans/POST";
import safety_plans_seed_post_345 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_346 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_347 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_348 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_349 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_350 from "./api/safety/posters/GET";
import safety_posters_post_351 from "./api/safety/posters/POST";
import safety_posters_id_delete_352 from "./api/safety/posters/[id]/DELETE";
import safety_swms_get_353 from "./api/safety/swms/GET";
import safety_swms_post_354 from "./api/safety/swms/POST";
import safety_swms_seed_post_355 from "./api/safety/swms/seed/POST";
import safety_swms_import_docx_post from "./api/safety/swms/import-docx/POST";
import safety_swms_id_delete_356 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_357 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_358 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_359 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_360 from "./api/safety/swms/[id]/export/GET";
import scheduler_crew_get_361 from "./api/scheduler/crew/GET";
import scheduler_jobs_get_362 from "./api/scheduler/jobs/GET";
import scheduler_jobs_id_reschedule_patch_363 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
import secure_share_get_364 from "./api/secure-share/GET";
import secure_share_post_365 from "./api/secure-share/POST";
import secure_share_id_delete_366 from "./api/secure-share/[id]/DELETE";
import secure_share_token_get_367 from "./api/secure-share/[token]/GET";
import secure_share_token_post_368 from "./api/secure-share/[token]/POST";
import settings_backup_get_369 from "./api/settings/backup/GET";
import settings_backup_post_370 from "./api/settings/backup/POST";
import settings_backup_export_get_371 from "./api/settings/backup/export/GET";
import settings_backup_run_post_372 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_373 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_374 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_375 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_376 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_377 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_378 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_379 from "./api/settings/retention/GET";
import settings_retention_post_380 from "./api/settings/retention/POST";
import settings_storage_provider_get_381 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_382 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_383 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_384 from "./api/settings/terminology/GET";
import settings_terminology_post_385 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_386 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_387 from "./api/settings/xero-credentials/POST";
import share_token_get_388 from "./api/share/[token]/GET";
import signup_post_389 from "./api/signup/POST";
import stripe_create_checkout_session_post_390 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_391 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_392 from "./api/subscription/create-checkout/POST";
import subscription_status_get_393 from "./api/subscription/status/GET";
import subscription_webhook_post_394 from "./api/subscription/webhook/POST";
import support_mode_audit_get_395 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_396 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_397 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_398 from "./api/support-mode/enter/POST";
import support_mode_exit_post_399 from "./api/support-mode/exit/POST";
import support_mode_status_get_400 from "./api/support-mode/status/GET";
import takeoff_pad_get_401 from "./api/takeoff-pad/GET";
import takeoff_pad_put_402 from "./api/takeoff-pad/PUT";
import team_get_403 from "./api/team/GET";
import team_invite_post_404 from "./api/team/invite/POST";
import team_invites_get_405 from "./api/team/invites/GET";
import team_invites_post_406 from "./api/team/invites/POST";
import team_invites_id_cancel_post_407 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_408 from "./api/team/invites/[id]/resend/POST";
import team_members_get_409 from "./api/team/members/GET";
import team_resend_verification_post_410 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_411 from "./api/team/schedule/migrate/POST";
import team_shifts_get_412 from "./api/team/shifts/GET";
import team_shifts_post_413 from "./api/team/shifts/POST";
import team_shifts_id_delete_414 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_415 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_416 from "./api/team/time-entries/GET";
import team_time_entries_post_417 from "./api/team/time-entries/POST";
import team_time_entries_export_get_418 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_419 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_420 from "./api/team/verify-user/POST";
import team_id_delete_421 from "./api/team/[id]/DELETE";
...
app.get("/api/dashboard/kpi", dashboard_kpi_get_45);
app.get("/api/dashboard/setup-check", dashboard_setup_check_get_46);
app.get("/api/dashboard/todos", dashboard_todos_get_47);
app.post("/api/dazza/annette", _h_dazza_annette_post_0);
app.post("/api/dazza/brain/hive/approve", dazza_brain_hive_approve_post_49);
app.post("/api/dazza/brain/hive/reject", dazza_brain_hive_reject_post_50);
app.get("/api/dazza/brain/status", dazza_brain_status_get_51);
...
app.get("/api/dazza/context", dazza_context_get_55);
app.get("/api/dazza/key-status", dazza_key_status_get_56);
app.get("/api/dazza/knowledge", dazza_knowledge_get_57);
app.post("/api/dazza/knowledge", dazza_knowledge_post_58);
app.delete("/api/dazza/knowledge/:id", dazza_knowledge_id_delete_59);
app.put("/api/dazza/knowledge/:id", dazza_knowledge_id_put_60);
...
app.get("/api/document-templates", document_templates_get_85);
app.post("/api/document-templates", document_templates_post_86);
app.delete("/api/document-templates/:id", document_templates_id_delete_87);
app.get("/api/document-templates/:id", document_templates_id_get_88);
app.put("/api/document-templates/:id", document_templates_id_put_89);
app.post("/api/document-templates/:id/import-docx", document_templates_id_import_docx_post_90);
app.get("/api/documents", documents_get_91);
app.get("/api/documents/share/:token", documents_share_token_get_92);
app.post("/api/documents/share/:token", documents_share_token_post_93);
app.get("/api/documents/:id", documents_id_get_94);
app.put("/api/documents/:id", documents_id_put_95);
app.get("/api/documents/:id/events", documents_id_events_get_96);
app.delete("/api/documents/:id/share", documents_id_share_delete_97);
app.post("/api/documents/:id/share", documents_id_share_post_98);
app.get("/api/drawings", drawings_get_99);
app.post("/api/drawings", drawings_post_100);
app.post("/api/drawings/upload", drawings_upload_post_101);
app.delete("/api/drawings/:id", drawings_id_delete_102);
app.patch("/api/drawings/:id", drawings_id_patch_103);
app.post("/api/drawings/:id/markup", drawings_id_markup_post_104);
app.get("/api/estimates", estimates_get_105);
app.post("/api/estimates", estimates_post_106);
app.delete("/api/estimates/:id", estimates_id_delete_107);
app.get("/api/estimates/:id", estimates_id_get_108);
app.put("/api/estimates/:id", estimates_id_put_109);
app.get("/api/estimates/:id/export-csv", estimates_id_export_csv_get_110);
app.get("/api/estimates/:id/export-pdf", estimates_id_export_pdf_get_111);
app.post("/api/estimates/:id/import-csv", estimates_id_import_csv_post_112);
app.get("/api/external/form/:token", external_form_token_get_113);
app.post("/api/external/form/:token", external_form_token_post_114);
app.get("/api/files", files_get_115);
app.post("/api/files", files_post_116);
app.delete("/api/files/:id", files_id_delete_117);
app.get("/api/files/:id/download", files_id_download_get_118);
...
app.get("/api/form-templates", form_templates_get_137);
app.post("/api/form-templates", form_templates_post_138);
app.post("/api/form-templates/seed", _h_form_templates_seed_post_4);
app.delete("/api/form-templates/:id", form_templates_id_delete_140);
app.put("/api/form-templates/:id", form_templates_id_put_141);
app.get("/api/forms/submissions", forms_submissions_get_142);
app.post("/api/forms/templates/:id/share-link", forms_templates_id_share_link_post_143);
app.get("/api/forms/:id/fields", forms_id_fields_get_144);
app.post("/api/forms/:id/fields", forms_id_fields_post_145);
app.post("/api/forms/:id/fields/reorder", forms_id_fields_reorder_post_146);
app.delete("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_delete_147);
app.patch("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_patch_148);
app.post("/api/forms/:id/fields/:fieldId/thumbnail", forms_id_fields_fieldId_thumbnail_post_149);
app.get("/api/health", health_get_150);
...
app.get("/api/invoices", invoices_get_173);
app.post("/api/invoices", invoices_post_174);
app.delete("/api/invoices/:id", invoices_id_delete_175);
app.get("/api/invoices/:id", invoices_id_get_176);
app.put("/api/invoices/:id", invoices_id_put_177);
app.post("/api/invoices/:id/duplicate", invoices_id_duplicate_post_178);
app.get("/api/invoices/:id/export-pdf", invoices_id_export_pdf_get_179);
app.post("/api/invoices/:id/mark-sent", invoices_id_mark_sent_post_180);
app.post("/api/invoices/:id/record-payment", invoices_id_record_payment_post_181);
app.post("/api/invoices/:id/void", invoices_id_void_post_182);
app.delete("/api/job-forms/:id", job_forms_id_delete_183);
app.get("/api/job-forms/:id", job_forms_id_get_184);
app.put("/api/job-forms/:id", job_forms_id_put_185);
app.post("/api/job-forms/:id/reset", job_forms_id_reset_post_186);
app.delete("/api/job-forms/:id/share", job_forms_id_share_delete_187);
app.get("/api/job-forms/:id/share", job_forms_id_share_get_188);
app.post("/api/job-forms/:id/share", job_forms_id_share_post_189);
...
app.get("/api/me", me_get_237);
app.put("/api/me", me_put_238);
app.post("/api/me/2fa/disable", me_2fa_disable_post_239);
app.post("/api/me/2fa/enable", me_2fa_enable_post_240);
app.get("/api/me/2fa/setup", me_2fa_setup_get_241);
app.get("/api/me/2fa/status", me_2fa_status_get_242);
app.post("/api/me/2fa/verify", me_2fa_verify_post_243);
app.post("/api/me/change-password", me_change_password_post_244);
app.get("/api/me/email-status", me_email_status_get_245);
app.get("/api/me/phone", me_phone_get_246);
app.put("/api/me/phone", me_phone_put_247);
...
app.get("/api/notifications/prefs", notifications_prefs_get_275);
app.put("/api/notifications/prefs", notifications_prefs_put_276);
app.post("/api/notifications/read", notifications_read_post_277);
app.get("/api/owner-console/activity", owner_console_activity_get_278);
app.get("/api/owner-console/cancellation-feedback", owner_console_cancellation_feedback_get_279);
app.get("/api/owner-console/companies", owner_console_companies_get_280);
app.post("/api/owner-console/companies", owner_console_companies_post_281);
app.get("/api/owner-console/companies/usage", owner_console_companies_usage_get_282);
app.put("/api/owner-console/companies/:id/limits", owner_console_companies_id_limits_put_283);
app.get("/api/owner-console/form-templates", owner_console_form_templates_get_284);
app.post("/api/owner-console/form-templates", owner_console_form_templates_post_285);
app.get("/api/owner-console/starter-pack", owner_console_starter_pack_get_286);
app.post("/api/owner-console/starter-pack", owner_console_starter_pack_post_287);
app.get("/api/owner-console/stats", owner_console_stats_get_288);
app.get("/api/owner-console/storage", owner_console_storage_get_289);
app.post("/api/owner-console/system-ai/builtin-checks", _h_owner_console_system_ai_builtin_checks_post_39);
app.get("/api/owner-console/users", owner_console_users_get_291);
app.post("/api/owner-console/users/verify", owner_console_users_verify_post_292);
app.get("/api/plan-manager/drawings", plan_manager_drawings_get_293);
app.post("/api/plan-manager/drawings", plan_manager_drawings_post_294);
app.get("/api/plan-manager/drawings/:id", plan_manager_drawings_id_get_295);
app.put("/api/plan-manager/drawings/:id/annotations", plan_manager_drawings_id_annotations_put_296);
app.post("/api/plan-manager/drawings/:id/archive", plan_manager_drawings_id_archive_post_297);
app.post("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_post_298);
app.get("/api/plan-manager/drawings/:id/pages/:pageNo/annotations", plan_manager_drawings_id_pages_pageNo_annotations_get_299);
app.delete("/api/plan-manager/drawings/:id/permanent", plan_manager_drawings_id_permanent_delete_300);
app.post("/api/plan-manager/drawings/:id/restore", plan_manager_drawings_id_restore_post_301);
app.post("/api/plan-manager/drawings/:id/revisions", plan_manager_drawings_id_revisions_post_302);
app.post("/api/plan-manager/drawings/:id/revisions/:revisionId/finalize", plan_manager_drawings_id_revisions_revisionId_finalize_post_303);
app.post("/api/plan-manager/drawings/:id/upload", plan_manager_drawings_id_upload_post_304);
app.post("/api/plan-manager/share", plan_manager_share_post_305);
app.get("/api/plan-manager/share/validate", plan_manager_share_validate_get_306);
app.post("/api/portal/estimates/:id/approve", portal_estimates_id_approve_post_307);
app.post("/api/portal/invite", portal_invite_post_308);
app.post("/api/portal/invoices/:id/pay", portal_invoices_id_pay_post_309);
app.get("/api/portal/jobs", portal_jobs_get_310);
app.get("/api/portal/jobs/:id", portal_jobs_id_get_311);
app.post("/api/portal/migrate", portal_migrate_post_312);
app.post("/api/portal/validate", portal_validate_post_313);
app.get("/api/public/form/:token", public_form_token_get_314);
app.post("/api/public/form/:token/submit", public_form_token_submit_post_315);
app.get("/api/public/swms/:token", public_swms_token_get_316);
app.post("/api/public/swms/:token/signoff", public_swms_token_signoff_post_317);
app.get("/api/recipes", recipes_get_318);
app.post("/api/recipes", recipes_post_319);
app.delete("/api/recipes/:id", recipes_id_delete_320);
app.put("/api/recipes/:id", recipes_id_put_321);
app.post("/api/safety/ai/draft", safety_ai_draft_post_322);
app.get("/api/safety/documents", safety_documents_get_323);
app.post("/api/safety/documents", safety_documents_post_324);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_325);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_326);
app.get("/api/safety/generated-posters", safety_generated_posters_get_327);
app.post("/api/safety/generated-posters", safety_generated_posters_post_328);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_329);
app.get("/api/safety/job-safety-plans", safety_job_safety_plans_get_330);
app.post("/api/safety/job-safety-plans", safety_job_safety_plans_post_331);
app.delete("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_delete_332);
app.put("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_put_333);
app.get("/api/safety/job-swms", safety_job_swms_get_334);
app.post("/api/safety/job-swms", safety_job_swms_post_335);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_336);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_337);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_338);
app.post("/api/safety/job-swms/:id/share-token", safety_job_swms_id_share_token_post_339);
app.get("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_get_340);
app.post("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_post_341);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", safety_job_swms_id_signoffs_signoffId_delete_342);
app.get("/api/safety/plans", safety_plans_get_343);
app.post("/api/safety/plans", safety_plans_post_344);
app.post("/api/safety/plans/seed", safety_plans_seed_post_345);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_346);
app.put("/api/safety/plans/:id", safety_plans_id_put_347);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_348);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_349);
app.get("/api/safety/posters", safety_posters_get_350);
app.post("/api/safety/posters", safety_posters_post_351);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_352);
app.get("/api/safety/swms", safety_swms_get_353);
app.post("/api/safety/swms", safety_swms_post_354);
app.post("/api/safety/swms/seed", safety_swms_seed_post_355);
app.post("/api/safety/swms/import-docx", safety_swms_import_docx_post);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_356);
app.get("/api/safety/swms/:id", safety_swms_id_get_357);
app.put("/api/safety/swms/:id", safety_swms_id_put_358);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_359);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_360);
app.get("/api/scheduler/crew", scheduler_crew_get_361);
app.get("/api/scheduler/jobs", scheduler_jobs_get_362);
app.patch("/api/scheduler/jobs/:id/reschedule", scheduler_jobs_id_reschedule_patch_363);
app.get("/api/secure-share", secure_share_get_364);
app.post("/api/secure-share", secure_share_post_365);
app.delete("/api/secure-share/:id", secure_share_id_delete_366);
app.get("/api/secure-share/:token", secure_share_token_get_367);
app.post("/api/secure-share/:token", secure_share_token_post_368);
app.get("/api/settings/backup", settings_backup_get_369);
app.post("/api/settings/backup", settings_backup_post_370);
app.get("/api/settings/backup/export", settings_backup_export_get_371);
app.post("/api/settings/backup/run", settings_backup_run_post_372);
app.get("/api/settings/backup-destination", settings_backup_destination_get_373);
app.post("/api/settings/backup-destination", settings_backup_destination_post_374);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_375);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_376);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_377);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_378);
app.get("/api/settings/retention", settings_retention_get_379);
app.post("/api/settings/retention", settings_retention_post_380);
app.get("/api/settings/storage-provider", settings_storage_provider_get_381);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_382);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_383);
app.get("/api/settings/terminology", settings_terminology_get_384);
app.post("/api/settings/terminology", settings_terminology_post_385);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_386);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_387);
app.get("/api/share/:token", share_token_get_388);
app.post("/api/signup", signup_post_389);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_390);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_391);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_392);
app.get("/api/subscription/status", subscription_status_get_393);
app.post("/api/subscription/webhook", subscription_webhook_post_394);
app.get("/api/support-mode/audit", support_mode_audit_get_395);
app.get("/api/support-mode/checklist", support_mode_checklist_get_396);
app.put("/api/support-mode/checklist", support_mode_checklist_put_397);
app.post("/api/support-mode/enter", support_mode_enter_post_398);
app.post("/api/support-mode/exit", support_mode_exit_post_399);
app.get("/api/support-mode/status", support_mode_status_get_400);
app.get("/api/takeoff-pad", takeoff_pad_get_401);
app.put("/api/takeoff-pad", takeoff_pad_put_402);
app.get("/api/team", team_get_403);
app.post("/api/team/invite", team_invite_post_404);
app.get("/api/team/invites", team_invites_get_405);
app.post("/api/team/invites", team_invites_post_406);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_407);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_408);
app.get("/api/team/members", team_members_get_409);
app.post("/api/team/resend-verification", team_resend_verification_post_410);
app.post("/api/team/schedule/migrate", team_schedule_migrate_post_411);
app.get("/api/team/shifts", team_shifts_get_412);
app.post("/api/team/shifts", team_shifts_post_413);
app.delete("/api/team/shifts/:id", team_shifts_id_delete_414);
app.put("/api/team/shifts/:id", team_shifts_id_put_415);
app.get("/api/team/time-entries", team_time_entries_get_416);
app.post("/api/team/time-entries", team_time_entries_post_417);
app.get("/api/team/time-entries/export", team_time_entries_export_get_418);
app.put("/api/team/time-entries/:id", team_time_entries_id_put_419);
app.post("/api/team/verify-user", team_verify_user_post_420);
