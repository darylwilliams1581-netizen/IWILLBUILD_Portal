...
import estimates_id_unlock_post from "./api/estimates/[id]/unlock/POST";
...
import fleet_id_driver_sessions_manual_post from "./api/fleet/[id]/driver-sessions/manual/POST";
...
import forms_assets_list_get_218 from "./api/forms/assets-list/GET";
import forms_jobs_list_get_219 from "./api/forms/jobs-list/GET";
import forms_migrate_skip_logic_post_220 from "./api/forms/migrate-skip-logic/POST";
import forms_skip_audit_get_221 from "./api/forms/skip-audit/GET";
import forms_skip_audit_post_222 from "./api/forms/skip-audit/POST";
import forms_start_post_223 from "./api/forms/start/POST";
import forms_submissions_get_224 from "./api/forms/submissions/GET";
import forms_templates_id_share_link_post_225 from "./api/forms/templates/[id]/share-link/POST";
import forms_id_fields_get_226 from "./api/forms/[id]/fields/GET";
import forms_id_fields_post_227 from "./api/forms/[id]/fields/POST";
import forms_id_fields_reorder_post_228 from "./api/forms/[id]/fields/reorder/POST";
import forms_id_fields_fieldId_delete_229 from "./api/forms/[id]/fields/[fieldId]/DELETE";
import forms_id_fields_fieldId_patch_230 from "./api/forms/[id]/fields/[fieldId]/PATCH";
import forms_id_fields_fieldId_thumbnail_post_231 from "./api/forms/[id]/fields/[fieldId]/thumbnail/POST";
import health_get_232 from "./api/health/GET";
import integrations_myob_auth_url_get_233 from "./api/integrations/myob/auth-url/GET";
import integrations_myob_callback_get_234 from "./api/integrations/myob/callback/GET";
import integrations_myob_disconnect_post_235 from "./api/integrations/myob/disconnect/POST";
import integrations_myob_status_get_236 from "./api/integrations/myob/status/GET";
import integrations_myob_sync_invoice_post_237 from "./api/integrations/myob/sync-invoice/POST";
import integrations_onedrive_auth_url_get_238 from "./api/integrations/onedrive/auth-url/GET";
import integrations_onedrive_callback_get_239 from "./api/integrations/onedrive/callback/GET";
import integrations_onedrive_disconnect_post_240 from "./api/integrations/onedrive/disconnect/POST";
import integrations_onedrive_status_get_241 from "./api/integrations/onedrive/status/GET";
import integrations_onedrive_upload_file_post_242 from "./api/integrations/onedrive/upload-file/POST";
import integrations_qbo_auth_url_get_243 from "./api/integrations/qbo/auth-url/GET";
import integrations_qbo_callback_get_244 from "./api/integrations/qbo/callback/GET";
import integrations_qbo_disconnect_post_245 from "./api/integrations/qbo/disconnect/POST";
import integrations_qbo_status_get_246 from "./api/integrations/qbo/status/GET";
import integrations_qbo_sync_invoice_post_247 from "./api/integrations/qbo/sync-invoice/POST";
import integrations_xero_auth_url_get_248 from "./api/integrations/xero/auth-url/GET";
import integrations_xero_callback_get_249 from "./api/integrations/xero/callback/GET";
import integrations_xero_disconnect_post_250 from "./api/integrations/xero/disconnect/POST";
import integrations_xero_status_get_251 from "./api/integrations/xero/status/GET";
import integrations_xero_sync_customer_post_252 from "./api/integrations/xero/sync-customer/POST";
import integrations_xero_sync_invoice_post_253 from "./api/integrations/xero/sync-invoice/POST";
import integrations_xero_webhook_post_254 from "./api/integrations/xero/webhook/POST";
import invoices_get_255 from "./api/invoices/GET";
import invoices_post_256 from "./api/invoices/POST";
import invoices_id_delete_257 from "./api/invoices/[id]/DELETE";
import invoices_id_get_258 from "./api/invoices/[id]/GET";
import invoices_id_put_259 from "./api/invoices/[id]/PUT";
import invoices_id_duplicate_post_260 from "./api/invoices/[id]/duplicate/POST";
import invoices_id_export_pdf_get_261 from "./api/invoices/[id]/export-pdf/GET";
import invoices_id_mark_sent_post_262 from "./api/invoices/[id]/mark-sent/POST";
import invoices_id_record_payment_post_263 from "./api/invoices/[id]/record-payment/POST";
import invoices_id_unlock_patch_264 from "./api/invoices/[id]/unlock/PATCH";
import invoices_id_void_post_265 from "./api/invoices/[id]/void/POST";
import job_costs_post_266 from "./api/job-costs/POST";
import job_forms_id_delete_267 from "./api/job-forms/[id]/DELETE";
import job_forms_id_get_268 from "./api/job-forms/[id]/GET";
import job_forms_id_put_269 from "./api/job-forms/[id]/PUT";
import job_forms_id_reset_post_270 from "./api/job-forms/[id]/reset/POST";
import job_forms_id_share_delete_271 from "./api/job-forms/[id]/share/DELETE";
import job_forms_id_share_get_272 from "./api/job-forms/[id]/share/GET";
import job_forms_id_share_post_273 from "./api/job-forms/[id]/share/POST";
import jobs_get_274 from "./api/jobs/GET";
import jobs_post_275 from "./api/jobs/POST";
import jobs_id_get_276 from "./api/jobs/[id]/GET";
import jobs_id_put_277 from "./api/jobs/[id]/PUT";
import jobs_id_attendance_attendanceId_close_post_278 from "./api/jobs/[id]/attendance/[attendanceId]/close/POST";
import jobs_id_costs_get_279 from "./api/jobs/[id]/costs/GET";
import jobs_id_costs_post_280 from "./api/jobs/[id]/costs/POST";
import jobs_id_costs_export_get_281 from "./api/jobs/[id]/costs/export/GET";
import jobs_id_costs_costId_delete_282 from "./api/jobs/[id]/costs/[costId]/DELETE";
import jobs_id_costs_costId_put_283 from "./api/jobs/[id]/costs/[costId]/PUT";
import jobs_id_costs_costId_receipt_get_284 from "./api/jobs/[id]/costs/[costId]/receipt/GET";
import jobs_id_costs_costId_receipt_post_285 from "./api/jobs/[id]/costs/[costId]/receipt/POST";
import jobs_id_delays_get_286 from "./api/jobs/[id]/delays/GET";
import jobs_id_delays_post_287 from "./api/jobs/[id]/delays/POST";
import jobs_id_delays_delayId_delete_288 from "./api/jobs/[id]/delays/[delayId]/DELETE";
import jobs_id_delays_delayId_put_289 from "./api/jobs/[id]/delays/[delayId]/PUT";
import jobs_id_files_get_290 from "./api/jobs/[id]/files/GET";
import jobs_id_forms_get_291 from "./api/jobs/[id]/forms/GET";
import jobs_id_forms_post_292 from "./api/jobs/[id]/forms/POST";
import jobs_id_generate_qr_post_293 from "./api/jobs/[id]/generate-qr/POST";
import jobs_id_ledger_get_294 from "./api/jobs/[id]/ledger/GET";
import jobs_id_ledger_post_295 from "./api/jobs/[id]/ledger/POST";
import jobs_id_ledger_export_get_296 from "./api/jobs/[id]/ledger/export/GET";
import jobs_id_ledger_sync_post_297 from "./api/jobs/[id]/ledger/sync/POST";
import jobs_id_ledger_entryId_delete_298 from "./api/jobs/[id]/ledger/[entryId]/DELETE";
import jobs_id_ledger_entryId_put_299 from "./api/jobs/[id]/ledger/[entryId]/PUT";
...
import jobs_id_notes_export_csv_get from "./api/jobs/[id]/notes/export-csv/GET";
import jobs_id_delays_export_csv_get from "./api/jobs/[id]/delays/export-csv/GET";
...
import jobs_id_photos_photoId_replace_post_306 from "./api/jobs/[id]/photos/[photoId]/replace/POST";
import jobs_id_progress_get_307 from "./api/jobs/[id]/progress/GET";
import jobs_id_progress_put_308 from "./api/jobs/[id]/progress/PUT";
import jobs_id_progress_sync_post_309 from "./api/jobs/[id]/progress/sync/POST";
import jobs_id_purchase_orders_get_310 from "./api/jobs/[id]/purchase-orders/GET";
import jobs_id_purchase_orders_post_311 from "./api/jobs/[id]/purchase-orders/POST";
import jobs_id_purchase_orders_poId_delete_312 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import jobs_id_purchase_orders_poId_get_313 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
import jobs_id_purchase_orders_poId_put_314 from "./api/jobs/[id]/purchase-orders/[poId]/PUT";
import jobs_id_purchase_orders_poId_pdf_get_315 from "./api/jobs/[id]/purchase-orders/[poId]/pdf/GET";
import jobs_id_signin_post_316 from "./api/jobs/[id]/signin/POST";
import jobs_id_signin_qr_post_317 from "./api/jobs/[id]/signin-qr/POST";
import jobs_id_signin_status_get_318 from "./api/jobs/[id]/signin-status/GET";
...
import jobs_id_todos_post_325 from "./api/jobs/[id]/todos/POST";
import jobs_id_todos_todoId_delete_326 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import jobs_id_todos_todoId_put_327 from "./api/jobs/[id]/todos/[todoId]/PUT";
import library_items_get_328 from "./api/library/items/GET";
import library_items_id_get_329 from "./api/library/items/[id]/GET";
import library_items_id_patch_330 from "./api/library/items/[id]/PATCH";
import library_items_id_download_get_331 from "./api/library/items/[id]/download/GET";
import library_items_id_install_post_332 from "./api/library/items/[id]/install/POST";
import library_my_installed_get_333 from "./api/library/my-installed/GET";
import library_my_submissions_get_334 from "./api/library/my-submissions/GET";
import me_get_335 from "./api/me/GET";
import me_put_336 from "./api/me/PUT";
import me_2fa_disable_post_337 from "./api/me/2fa/disable/POST";
import me_2fa_enable_post_338 from "./api/me/2fa/enable/POST";
import me_2fa_setup_get_339 from "./api/me/2fa/setup/GET";
import me_2fa_status_get_340 from "./api/me/2fa/status/GET";
import me_2fa_verify_post_341 from "./api/me/2fa/verify/POST";
import me_change_password_post_342 from "./api/me/change-password/POST";
...
import migrate_account_recovery_post_346 from "./api/migrate-account-recovery/POST";
import migrate_asset_manager_post_347 from "./api/migrate-asset-manager/POST";
import migrate_attendance_post_348 from "./api/migrate-attendance/POST";
import migrate_company_settings_post_349 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_350 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_351 from "./api/migrate-dazza-knowledge/POST";
import migrate_emergency_alerts_post_352 from "./api/migrate-emergency-alerts/POST";
import migrate_estimates_post_353 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_354 from "./api/migrate-estimating-library/POST";
import migrate_files_post_355 from "./api/migrate-files/POST";
import migrate_fleet_post_356 from "./api/migrate-fleet/POST";
import migrate_fleet_analytics_post_357 from "./api/migrate-fleet-analytics/POST";
import migrate_fleet_driver_sessions_post_358 from "./api/migrate-fleet-driver-sessions/POST";
import migrate_fleet_usage_post_359 from "./api/migrate-fleet-usage/POST";
import migrate_form_fields_post_360 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_361 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_362 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_363 from "./api/migrate-job-forms/POST";
import migrate_job_photos_post_364 from "./api/migrate-job-photos/POST";
...
import migrate_owner_console_post_370 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_371 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_372 from "./api/migrate-pdf-settings/POST";
import migrate_plan_manager_post_373 from "./api/migrate-plan-manager/POST";
import migrate_plan_manager_v2_post_374 from "./api/migrate-plan-manager-v2/POST";
import migrate_plan_manager_v3_post_375 from "./api/migrate-plan-manager-v3/POST";
import migrate_safety_post_376 from "./api/migrate-safety/POST";
import migrate_starter_pack_post_377 from "./api/migrate-starter-pack/POST";
import migrate_studio_pdf_post_378 from "./api/migrate-studio-pdf/POST";
import migrate_subscriptions_post_379 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_380 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_381 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_382 from "./api/migrate-team/POST";
...
import notes_migrate_post_386 from "./api/notes/migrate/POST";
import notifications_alerts_get_387 from "./api/notifications/alerts/GET";
import notifications_prefs_get_388 from "./api/notifications/prefs/GET";
import notifications_prefs_put_389 from "./api/notifications/prefs/PUT";
import notifications_read_post_390 from "./api/notifications/read/POST";
import owner_console_activity_get_391 from "./api/owner-console/activity/GET";
import owner_console_cancellation_feedback_get_392 from "./api/owner-console/cancellation-feedback/GET";
import owner_console_companies_get_393 from "./api/owner-console/companies/GET";
import owner_console_companies_post_394 from "./api/owner-console/companies/POST";
import owner_console_companies_usage_get_395 from "./api/owner-console/companies/usage/GET";
import owner_console_companies_id_limits_put_396 from "./api/owner-console/companies/[id]/limits/PUT";
import owner_console_form_templates_get_397 from "./api/owner-console/form-templates/GET";
import owner_console_form_templates_post_398 from "./api/owner-console/form-templates/POST";
import owner_console_library_items_get_399 from "./api/owner-console/library/items/GET";
import owner_console_library_items_post_400 from "./api/owner-console/library/items/POST";
import owner_console_library_items_id_delete_401 from "./api/owner-console/library/items/[id]/DELETE";
import owner_console_library_items_id_patch_402 from "./api/owner-console/library/items/[id]/PATCH";
import owner_console_library_items_id_put_403 from "./api/owner-console/library/items/[id]/PUT";
import owner_console_library_items_id_push_update_post_404 from "./api/owner-console/library/items/[id]/push-update/POST";
import owner_console_library_submissions_get_405 from "./api/owner-console/library/submissions/GET";
import owner_console_library_submissions_id_review_post_406 from "./api/owner-console/library/submissions/[id]/review/POST";
import owner_console_starter_pack_get_407 from "./api/owner-console/starter-pack/GET";
import owner_console_starter_pack_post_408 from "./api/owner-console/starter-pack/POST";
import owner_console_stats_get_409 from "./api/owner-console/stats/GET";
import owner_console_storage_get_410 from "./api/owner-console/storage/GET";
import owner_console_swms_masters_get_411 from "./api/owner-console/swms/masters/GET";
import owner_console_swms_masters_post_412 from "./api/owner-console/swms/masters/POST";
import owner_console_swms_masters_publish_all_post_413 from "./api/owner-console/swms/masters/publish-all/POST";
import owner_console_swms_masters_id_delete_414 from "./api/owner-console/swms/masters/[id]/DELETE";
import owner_console_swms_masters_id_get_415 from "./api/owner-console/swms/masters/[id]/GET";
import owner_console_swms_masters_id_put_416 from "./api/owner-console/swms/masters/[id]/PUT";
import owner_console_swms_masters_id_publish_post_417 from "./api/owner-console/swms/masters/[id]/publish/POST";
import owner_console_swms_migrate_master_library_post_418 from "./api/owner-console/swms/migrate-master-library/POST";
import owner_console_swms_push_post_419 from "./api/owner-console/swms/push/POST";
import owner_console_swms_seed_bricklaying_post_420 from "./api/owner-console/swms/seed-bricklaying/POST";
import owner_console_swms_seed_building_inspection_post_421 from "./api/owner-console/swms/seed-building-inspection/POST";
import owner_console_swms_seed_cabinets_post_422 from "./api/owner-console/swms/seed-cabinets/POST";
import owner_console_swms_seed_carpenter_fixing_post_423 from "./api/owner-console/swms/seed-carpenter-fixing/POST";
import owner_console_swms_seed_carpenter_framing_post_424 from "./api/owner-console/swms/seed-carpenter-framing/POST";
import owner_console_swms_seed_carpenter_lockup_post_425 from "./api/owner-console/swms/seed-carpenter-lockup/POST";
import owner_console_swms_seed_ceramic_tiling_post_426 from "./api/owner-console/swms/seed-ceramic-tiling/POST";
import owner_console_swms_seed_concreting_slab_post_427 from "./api/owner-console/swms/seed-concreting-slab/POST";
import owner_console_swms_seed_delivery_loading_post_428 from "./api/owner-console/swms/seed-delivery-loading/POST";
import owner_console_swms_seed_environmental_spill_post_429 from "./api/owner-console/swms/seed-environmental-spill/POST";
import owner_console_swms_seed_ewp_post_430 from "./api/owner-console/swms/seed-ewp/POST";
import owner_console_swms_seed_excavations_substation_post_431 from "./api/owner-console/swms/seed-excavations-substation/POST";
import owner_console_swms_seed_fencing_post_432 from "./api/owner-console/swms/seed-fencing/POST";
import owner_console_swms_seed_heat_stress_post_433 from "./api/owner-console/swms/seed-heat-stress/POST";
import owner_console_swms_seed_landscaping_post_434 from "./api/owner-console/swms/seed-landscaping/POST";
import owner_console_swms_seed_live_parts_post_435 from "./api/owner-console/swms/seed-live-parts/POST";
import owner_console_swms_seed_manual_handling_post_436 from "./api/owner-console/swms/seed-manual-handling/POST";
import owner_console_swms_seed_moving_plant_post_437 from "./api/owner-console/swms/seed-moving-plant/POST";
import owner_console_swms_seed_painting_post_438 from "./api/owner-console/swms/seed-painting/POST";
import owner_console_swms_seed_power_tools_post_439 from "./api/owner-console/swms/seed-power-tools/POST";
import owner_console_swms_seed_silica_dust_post_440 from "./api/owner-console/swms/seed-silica-dust/POST";
import owner_console_swms_seed_traffic_management_post_441 from "./api/owner-console/swms/seed-traffic-management/POST";
import owner_console_swms_seed_underground_services_post_442 from "./api/owner-console/swms/seed-underground-services/POST";
import owner_console_swms_seed_vacuum_excavation_post_443 from "./api/owner-console/swms/seed-vacuum-excavation/POST";
import owner_console_system_ai_builtin_checks_post_444 from "./api/owner-console/system-ai/builtin-checks/POST";
import owner_console_users_get_445 from "./api/owner-console/users/GET";
import owner_console_users_verify_post_446 from "./api/owner-console/users/verify/POST";
import plan_manager_drawings_get_447 from "./api/plan-manager/drawings/GET";
import plan_manager_drawings_post_448 from "./api/plan-manager/drawings/POST";
import plan_manager_drawings_id_get_449 from "./api/plan-manager/drawings/[id]/GET";
import plan_manager_drawings_id_annotations_put_450 from "./api/plan-manager/drawings/[id]/annotations/PUT";
import plan_manager_drawings_id_archive_post_451 from "./api/plan-manager/drawings/[id]/archive/POST";
import plan_manager_drawings_id_job_links_delete_452 from "./api/plan-manager/drawings/[id]/job-links/DELETE";
import plan_manager_drawings_id_job_links_post_453 from "./api/plan-manager/drawings/[id]/job-links/POST";
import plan_manager_drawings_id_pages_pageNo_annotations_get_454 from "./api/plan-manager/drawings/[id]/pages/[pageNo]/annotations/GET";
import plan_manager_drawings_id_permanent_delete_455 from "./api/plan-manager/drawings/[id]/permanent/DELETE";
import plan_manager_drawings_id_reorder_patch_456 from "./api/plan-manager/drawings/[id]/reorder/PATCH";
import plan_manager_drawings_id_restore_post_457 from "./api/plan-manager/drawings/[id]/restore/POST";
import plan_manager_drawings_id_revisions_post_458 from "./api/plan-manager/drawings/[id]/revisions/POST";
import plan_manager_drawings_id_revisions_revisionId_finalize_post_459 from "./api/plan-manager/drawings/[id]/revisions/[revisionId]/finalize/POST";
import plan_manager_drawings_id_upload_post_460 from "./api/plan-manager/drawings/[id]/upload/POST";
import plan_manager_jobs_with_drawings_get_461 from "./api/plan-manager/jobs-with-drawings/GET";
import plan_manager_share_post_462 from "./api/plan-manager/share/POST";
import plan_manager_share_validate_get_463 from "./api/plan-manager/share/validate/GET";
import portal_estimates_id_approve_post_464 from "./api/portal/estimates/[id]/approve/POST";
import portal_invite_post_465 from "./api/portal/invite/POST";
import portal_invoices_id_pay_post_466 from "./api/portal/invoices/[id]/pay/POST";
import portal_jobs_get_467 from "./api/portal/jobs/GET";
import portal_jobs_id_get_468 from "./api/portal/jobs/[id]/GET";
import portal_migrate_post_469 from "./api/portal/migrate/POST";
import portal_validate_post_470 from "./api/portal/validate/POST";
import public_form_token_get_471 from "./api/public/form/[token]/GET";
...
import recipes_get_478 from "./api/recipes/GET";
import recipes_post_479 from "./api/recipes/POST";
import recipes_id_delete_480 from "./api/recipes/[id]/DELETE";
import recipes_id_put_481 from "./api/recipes/[id]/PUT";
import safety_ai_draft_post_482 from "./api/safety/ai/draft/POST";
import safety_documents_get_483 from "./api/safety/documents/GET";
import safety_documents_post_484 from "./api/safety/documents/POST";
import safety_documents_id_delete_485 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_486 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_487 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_488 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_489 from "./api/safety/generated-posters/[id]/DELETE";
import safety_job_safety_plans_get_490 from "./api/safety/job-safety-plans/GET";
import safety_job_safety_plans_post_491 from "./api/safety/job-safety-plans/POST";
import safety_job_safety_plans_id_delete_492 from "./api/safety/job-safety-plans/[id]/DELETE";
import safety_job_safety_plans_id_put_493 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_494 from "./api/safety/job-swms/GET";
import safety_job_swms_post_495 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_496 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_497 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_498 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_share_token_post_499 from "./api/safety/job-swms/[id]/share-token/POST";
import safety_job_swms_id_signoffs_get_500 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_501 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_502 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_503 from "./api/safety/plans/GET";
import safety_plans_post_504 from "./api/safety/plans/POST";
import safety_plans_seed_post_505 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_506 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_507 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_508 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_509 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_510 from "./api/safety/posters/GET";
import safety_posters_post_511 from "./api/safety/posters/POST";
import safety_posters_id_delete_512 from "./api/safety/posters/[id]/DELETE";
import safety_swms_get_513 from "./api/safety/swms/GET";
import safety_swms_post_514 from "./api/safety/swms/POST";
import safety_swms_import_docx_post_515 from "./api/safety/swms/import-docx/POST";
import safety_swms_seed_post_516 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_517 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_518 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_519 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_520 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_521 from "./api/safety/swms/[id]/export/GET";
import safety_swms_id_publish_to_library_post_522 from "./api/safety/swms/[id]/publish-to-library/POST";
import scheduler_crew_get_523 from "./api/scheduler/crew/GET";
import scheduler_jobs_get_524 from "./api/scheduler/jobs/GET";
import scheduler_jobs_id_reschedule_patch_525 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
import secure_share_get_526 from "./api/secure-share/GET";
import secure_share_post_527 from "./api/secure-share/POST";
import secure_share_id_delete_528 from "./api/secure-share/[id]/DELETE";
import secure_share_token_get_529 from "./api/secure-share/[token]/GET";
import secure_share_token_post_530 from "./api/secure-share/[token]/POST";
import settings_backup_get_531 from "./api/settings/backup/GET";
import settings_backup_post_532 from "./api/settings/backup/POST";
import settings_backup_export_get_533 from "./api/settings/backup/export/GET";
import settings_backup_run_post_534 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_535 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_536 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_537 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_538 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_539 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_540 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_541 from "./api/settings/retention/GET";
import settings_retention_post_542 from "./api/settings/retention/POST";
import settings_storage_provider_get_543 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_544 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_545 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_546 from "./api/settings/terminology/GET";
import settings_terminology_post_547 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_548 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_549 from "./api/settings/xero-credentials/POST";
import share_token_get_550 from "./api/share/[token]/GET";
import signin_history_get_551 from "./api/signin-history/GET";
import signup_post_552 from "./api/signup/POST";
import sos_get_553 from "./api/sos/GET";
import sos_acknowledge_post_554 from "./api/sos/acknowledge/POST";
import sos_trigger_post_555 from "./api/sos/trigger/POST";
import stripe_create_checkout_session_post_556 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_557 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_558 from "./api/subscription/create-checkout/POST";
import subscription_status_get_559 from "./api/subscription/status/GET";
import subscription_webhook_post_560 from "./api/subscription/webhook/POST";
import support_mode_audit_get_561 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_562 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_563 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_564 from "./api/support-mode/enter/POST";
import support_mode_exit_post_565 from "./api/support-mode/exit/POST";
import support_mode_status_get_566 from "./api/support-mode/status/GET";
import tag_tasks_get_567 from "./api/tag-tasks/GET";
import tag_tasks_id_patch_568 from "./api/tag-tasks/[id]/PATCH";
import takeoff_pad_get_569 from "./api/takeoff-pad/GET";
import takeoff_pad_put_570 from "./api/takeoff-pad/PUT";
import team_get_571 from "./api/team/GET";
import team_invite_post_572 from "./api/team/invite/POST";
import team_invites_get_573 from "./api/team/invites/GET";
import team_invites_post_574 from "./api/team/invites/POST";
...
import team_shifts_post_581 from "./api/team/shifts/POST";
import team_shifts_id_delete_582 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_583 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_584 from "./api/team/time-entries/GET";
import team_time_entries_post_585 from "./api/team/time-entries/POST";
import team_time_entries_export_get_586 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_587 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_588 from "./api/team/verify-user/POST";
import team_id_delete_589 from "./api/team/[id]/DELETE";
import team_id_put_590 from "./api/team/[id]/PUT";
import usage_get_591 from "./api/usage/GET";
// </api-imports>
...
import stakeholders_sms_post from './api/stakeholders/sms/POST.js';
app.post("/api/customers", customers_post_88);
app.post("/api/stakeholders/sms", stakeholders_sms_post);
...
app.post("/api/estimates/:id/unlock", estimates_id_unlock_post);
...
app.post("/api/fleet/:id/driver-sessions/manual", fleet_id_driver_sessions_manual_post);
...
app.get("/api/forms/assets-list", forms_assets_list_get_218);
app.get("/api/forms/jobs-list", forms_jobs_list_get_219);
app.post("/api/forms/migrate-skip-logic", forms_migrate_skip_logic_post_220);
app.get("/api/forms/skip-audit", forms_skip_audit_get_221);
app.post("/api/forms/skip-audit", forms_skip_audit_post_222);
app.post("/api/forms/start", forms_start_post_223);
app.get("/api/forms/submissions", forms_submissions_get_224);
app.post("/api/forms/templates/:id/share-link", forms_templates_id_share_link_post_225);
app.get("/api/forms/:id/fields", forms_id_fields_get_226);
app.post("/api/forms/:id/fields", forms_id_fields_post_227);
app.post("/api/forms/:id/fields/reorder", forms_id_fields_reorder_post_228);
app.delete("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_delete_229);
app.patch("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_patch_230);
app.post("/api/forms/:id/fields/:fieldId/thumbnail", forms_id_fields_fieldId_thumbnail_post_231);
app.get("/api/health", health_get_232);
app.get("/api/integrations/myob/auth-url", integrations_myob_auth_url_get_233);
app.get("/api/integrations/myob/callback", integrations_myob_callback_get_234);
app.post("/api/integrations/myob/disconnect", integrations_myob_disconnect_post_235);
app.get("/api/integrations/myob/status", integrations_myob_status_get_236);
app.post("/api/integrations/myob/sync-invoice", integrations_myob_sync_invoice_post_237);
app.get("/api/integrations/onedrive/auth-url", integrations_onedrive_auth_url_get_238);
app.get("/api/integrations/onedrive/callback", integrations_onedrive_callback_get_239);
app.post("/api/integrations/onedrive/disconnect", integrations_onedrive_disconnect_post_240);
app.get("/api/integrations/onedrive/status", integrations_onedrive_status_get_241);
app.post("/api/integrations/onedrive/upload-file", integrations_onedrive_upload_file_post_242);
app.get("/api/integrations/qbo/auth-url", integrations_qbo_auth_url_get_243);
app.get("/api/integrations/qbo/callback", integrations_qbo_callback_get_244);
app.post("/api/integrations/qbo/disconnect", integrations_qbo_disconnect_post_245);
app.get("/api/integrations/qbo/status", integrations_qbo_status_get_246);
app.post("/api/integrations/qbo/sync-invoice", integrations_qbo_sync_invoice_post_247);
app.get("/api/integrations/xero/auth-url", integrations_xero_auth_url_get_248);
app.get("/api/integrations/xero/callback", integrations_xero_callback_get_249);
app.post("/api/integrations/xero/disconnect", integrations_xero_disconnect_post_250);
app.get("/api/integrations/xero/status", integrations_xero_status_get_251);
app.post("/api/integrations/xero/sync-customer", integrations_xero_sync_customer_post_252);
app.post("/api/integrations/xero/sync-invoice", integrations_xero_sync_invoice_post_253);
app.post("/api/integrations/xero/webhook", integrations_xero_webhook_post_254);
app.get("/api/invoices", invoices_get_255);
app.post("/api/invoices", invoices_post_256);
app.delete("/api/invoices/:id", invoices_id_delete_257);
app.get("/api/invoices/:id", invoices_id_get_258);
app.put("/api/invoices/:id", invoices_id_put_259);
app.post("/api/invoices/:id/duplicate", invoices_id_duplicate_post_260);
app.get("/api/invoices/:id/export-pdf", invoices_id_export_pdf_get_261);
app.post("/api/invoices/:id/mark-sent", invoices_id_mark_sent_post_262);
app.post("/api/invoices/:id/record-payment", invoices_id_record_payment_post_263);
app.patch("/api/invoices/:id/unlock", invoices_id_unlock_patch_264);
app.post("/api/invoices/:id/void", invoices_id_void_post_265);
app.post("/api/job-costs", job_costs_post_266);
app.delete("/api/job-forms/:id", job_forms_id_delete_267);
app.get("/api/job-forms/:id", job_forms_id_get_268);
app.put("/api/job-forms/:id", job_forms_id_put_269);
app.post("/api/job-forms/:id/reset", job_forms_id_reset_post_270);
app.delete("/api/job-forms/:id/share", job_forms_id_share_delete_271);
app.get("/api/job-forms/:id/share", job_forms_id_share_get_272);
app.post("/api/job-forms/:id/share", job_forms_id_share_post_273);
app.get("/api/jobs", jobs_get_274);
app.post("/api/jobs", jobs_post_275);
app.get("/api/jobs/:id", jobs_id_get_276);
app.put("/api/jobs/:id", jobs_id_put_277);
app.post("/api/jobs/:id/attendance/:attendanceId/close", jobs_id_attendance_attendanceId_close_post_278);
app.get("/api/jobs/:id/costs", jobs_id_costs_get_279);
app.post("/api/jobs/:id/costs", jobs_id_costs_post_280);
app.get("/api/jobs/:id/costs/export", jobs_id_costs_export_get_281);
app.delete("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_delete_282);
app.put("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_put_283);
app.get("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_get_284);
app.post("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_post_285);
app.get("/api/jobs/:id/delays", jobs_id_delays_get_286);
app.post("/api/jobs/:id/delays", jobs_id_delays_post_287);
app.delete("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_delete_288);
...
app.delete("/api/jobs/:id/forms/:submissionId", jobsIdFormsSubmissionDelete);
app.post("/api/jobs/:id/forms/:submissionId/reopen", jobsIdFormsSubmissionReopen);
app.post("/api/jobs/:id/generate-qr", jobs_id_generate_qr_post_293);
app.get("/api/jobs/:id/ledger", jobs_id_ledger_get_294);
app.post("/api/jobs/:id/ledger", jobs_id_ledger_post_295);
app.get("/api/jobs/:id/ledger/export", jobs_id_ledger_export_get_296);
app.post("/api/jobs/:id/ledger/sync", jobs_id_ledger_sync_post_297);
app.delete("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_delete_298);
app.put("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_put_299);
...
app.get("/api/jobs/:id/notes/export-csv", jobs_id_notes_export_csv_get);
app.get("/api/jobs/:id/delays/export-csv", jobs_id_delays_export_csv_get);
...
app.post("/api/jobs/:id/photos/:photoId/replace", jobs_id_photos_photoId_replace_post_306);
...
app.get("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_get_313);
app.put("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_put_314);
app.get("/api/jobs/:id/purchase-orders/:poId/pdf", jobs_id_purchase_orders_poId_pdf_get_315);
app.post("/api/jobs/:id/signin", jobs_id_signin_post_316);
app.post("/api/jobs/:id/signin-qr", jobs_id_signin_qr_post_317);
app.get("/api/jobs/:id/signin-status", jobs_id_signin_status_get_318);
app.post("/api/jobs/:id/signout", jobs_id_signout_post_319);
app.post("/api/jobs/:id/signout-qr", jobs_id_signout_qr_post_320);
...
app.post("/api/jobs/:id/todos", jobs_id_todos_post_325);
app.delete("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_delete_326);
app.put("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_put_327);
app.get("/api/library/items", library_items_get_328);
app.get("/api/library/items/:id", library_items_id_get_329);
app.patch("/api/library/items/:id", library_items_id_patch_330);
app.get("/api/library/items/:id/download", library_items_id_download_get_331);
app.post("/api/library/items/:id/install", library_items_id_install_post_332);
app.get("/api/library/my-installed", library_my_installed_get_333);
app.get("/api/library/my-submissions", library_my_submissions_get_334);
app.get("/api/me", me_get_335);
app.put("/api/me", me_put_336);
app.post("/api/me/2fa/disable", me_2fa_disable_post_337);
app.post("/api/me/2fa/enable", me_2fa_enable_post_338);
app.get("/api/me/2fa/setup", me_2fa_setup_get_339);
app.get("/api/me/2fa/status", me_2fa_status_get_340);
app.post("/api/me/2fa/verify", me_2fa_verify_post_341);
app.post("/api/me/change-password", me_change_password_post_342);
...
app.post("/api/migrate-account-recovery", migrate_account_recovery_post_346);
app.post("/api/migrate-asset-manager", migrate_asset_manager_post_347);
app.post("/api/migrate-attendance", migrate_attendance_post_348);
app.post("/api/migrate-company-settings", migrate_company_settings_post_349);
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_350);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_351);
app.post("/api/migrate-emergency-alerts", migrate_emergency_alerts_post_352);
app.post("/api/migrate-estimates", migrate_estimates_post_353);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_354);
app.post("/api/migrate-files", migrate_files_post_355);
app.post("/api/migrate-fleet", migrate_fleet_post_356);
app.post("/api/migrate-fleet-analytics", migrate_fleet_analytics_post_357);
app.post("/api/migrate-fleet-driver-sessions", migrate_fleet_driver_sessions_post_358);
app.post("/api/migrate-fleet-usage", migrate_fleet_usage_post_359);
app.post("/api/migrate-form-fields", migrate_form_fields_post_360);
app.post("/api/migrate-form-logic", migrate_form_logic_post_361);
app.post("/api/migrate-form-templates", migrate_form_templates_post_362);
app.post("/api/migrate-job-forms", migrate_job_forms_post_363);
app.post("/api/migrate-job-photos", migrate_job_photos_post_364);
...
app.post("/api/migrate-owner-console", migrate_owner_console_post_370);
app.post("/api/migrate-owner-role", migrate_owner_role_post_371);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_372);
app.post("/api/migrate-plan-manager", migrate_plan_manager_post_373);
app.post("/api/migrate-plan-manager-v2", migrate_plan_manager_v2_post_374);
app.post("/api/migrate-plan-manager-v3", migrate_plan_manager_v3_post_375);
app.post("/api/migrate-safety", migrate_safety_post_376);
app.post("/api/migrate-starter-pack", migrate_starter_pack_post_377);
app.post("/api/migrate-studio-pdf", migrate_studio_pdf_post_378);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_379);
app.post("/api/migrate-support-mode", migrate_support_mode_post_380);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_381);
app.post("/api/migrate-team", migrate_team_post_382);
app.get("/api/notes", notes_get_383);
app.post("/api/notes", notes_post_384);
app.post("/api/notes/comments", notes_comments_post_385);
app.post("/api/notes/migrate", notes_migrate_post_386);
app.get("/api/notifications/alerts", notifications_alerts_get_387);
app.get("/api/notifications/prefs", notifications_prefs_get_388);
app.put("/api/notifications/prefs", notifications_prefs_put_389);
app.post("/api/notifications/read", notifications_read_post_390);
app.get("/api/owner-console/activity", owner_console_activity_get_391);
app.get("/api/owner-console/cancellation-feedback", owner_console_cancellation_feedback_get_392);
app.get("/api/owner-console/companies", owner_console_companies_get_393);
app.post("/api/owner-console/companies", owner_console_companies_post_394);
app.get("/api/owner-console/companies/usage", owner_console_companies_usage_get_395);
app.put("/api/owner-console/companies/:id/limits", owner_console_companies_id_limits_put_396);
app.get("/api/owner-console/form-templates", owner_console_form_templates_get_397);
app.post("/api/owner-console/form-templates", owner_console_form_templates_post_398);
app.get("/api/owner-console/library/items", owner_console_library_items_get_399);
app.post("/api/owner-console/library/items", owner_console_library_items_post_400);
app.delete("/api/owner-console/library/items/:id", owner_console_library_items_id_delete_401);
app.patch("/api/owner-console/library/items/:id", owner_console_library_items_id_patch_402);
app.put("/api/owner-console/library/items/:id", owner_console_library_items_id_put_403);
app.post("/api/owner-console/library/items/:id/push-update", owner_console_library_items_id_push_update_post_404);
app.get("/api/owner-console/library/submissions", owner_console_library_submissions_get_405);
app.post("/api/owner-console/library/submissions/:id/review", owner_console_library_submissions_id_review_post_406);
app.get("/api/owner-console/starter-pack", owner_console_starter_pack_get_407);
app.post("/api/owner-console/starter-pack", owner_console_starter_pack_post_408);
app.get("/api/owner-console/stats", owner_console_stats_get_409);
app.get("/api/owner-console/storage", owner_console_storage_get_410);
app.get("/api/owner-console/swms/masters", owner_console_swms_masters_get_411);
app.post("/api/owner-console/swms/masters", owner_console_swms_masters_post_412);
app.post("/api/owner-console/swms/masters/publish-all", owner_console_swms_masters_publish_all_post_413);
app.delete("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_delete_414);
app.get("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_get_415);
app.put("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_put_416);
app.post("/api/owner-console/swms/masters/:id/publish", owner_console_swms_masters_id_publish_post_417);
app.post("/api/owner-console/swms/migrate-master-library", owner_console_swms_migrate_master_library_post_418);
app.post("/api/owner-console/swms/push", owner_console_swms_push_post_419);
app.post("/api/owner-console/swms/seed-bricklaying", owner_console_swms_seed_bricklaying_post_420);
app.post("/api/owner-console/swms/seed-building-inspection", owner_console_swms_seed_building_inspection_post_421);
app.post("/api/owner-console/swms/seed-cabinets", owner_console_swms_seed_cabinets_post_422);
app.post("/api/owner-console/swms/seed-carpenter-fixing", owner_console_swms_seed_carpenter_fixing_post_423);
app.post("/api/owner-console/swms/seed-carpenter-framing", owner_console_swms_seed_carpenter_framing_post_424);
app.post("/api/owner-console/swms/seed-carpenter-lockup", owner_console_swms_seed_carpenter_lockup_post_425);
app.post("/api/owner-console/swms/seed-ceramic-tiling", owner_console_swms_seed_ceramic_tiling_post_426);
app.post("/api/owner-console/swms/seed-concreting-slab", owner_console_swms_seed_concreting_slab_post_427);
app.post("/api/owner-console/swms/seed-delivery-loading", owner_console_swms_seed_delivery_loading_post_428);
app.post("/api/owner-console/swms/seed-environmental-spill", owner_console_swms_seed_environmental_spill_post_429);
app.post("/api/owner-console/swms/seed-ewp", owner_console_swms_seed_ewp_post_430);
app.post("/api/owner-console/swms/seed-excavations-substation", owner_console_swms_seed_excavations_substation_post_431);
app.post("/api/owner-console/swms/seed-fencing", owner_console_swms_seed_fencing_post_432);
app.post("/api/owner-console/swms/seed-heat-stress", owner_console_swms_seed_heat_stress_post_433);
app.post("/api/owner-console/swms/seed-landscaping", owner_console_swms_seed_landscaping_post_434);
app.post("/api/owner-console/swms/seed-live-parts", owner_console_swms_seed_live_parts_post_435);
app.post("/api/owner-console/swms/seed-manual-handling", owner_console_swms_seed_manual_handling_post_436);
app.post("/api/owner-console/swms/seed-moving-plant", owner_console_swms_seed_moving_plant_post_437);
app.post("/api/owner-console/swms/seed-painting", owner_console_swms_seed_painting_post_438);
app.post("/api/owner-console/swms/seed-power-tools", owner_console_swms_seed_power_tools_post_439);
app.post("/api/owner-console/swms/seed-silica-dust", owner_console_swms_seed_silica_dust_post_440);
app.post("/api/owner-console/swms/seed-traffic-management", owner_console_swms_seed_traffic_management_post_441);
app.post("/api/owner-console/swms/seed-underground-services", owner_console_swms_seed_underground_services_post_442);
app.post("/api/owner-console/swms/seed-vacuum-excavation", owner_console_swms_seed_vacuum_excavation_post_443);
app.post("/api/owner-console/system-ai/builtin-checks", owner_console_system_ai_builtin_checks_post_444);
app.get("/api/owner-console/users", owner_console_users_get_445);
app.post("/api/owner-console/users/verify", owner_console_users_verify_post_446);
app.get("/api/plan-manager/drawings", plan_manager_drawings_get_447);
app.post("/api/plan-manager/drawings", plan_manager_drawings_post_448);
app.get("/api/plan-manager/drawings/:id", plan_manager_drawings_id_get_449);
app.put("/api/plan-manager/drawings/:id/annotations", plan_manager_drawings_id_annotations_put_450);
app.post("/api/plan-manager/drawings/:id/archive", plan_manager_drawings_id_archive_post_451);
app.delete("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_delete_452);
app.post("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_post_453);
app.get("/api/plan-manager/drawings/:id/pages/:pageNo/annotations", plan_manager_drawings_id_pages_pageNo_annotations_get_454);
app.delete("/api/plan-manager/drawings/:id/permanent", plan_manager_drawings_id_permanent_delete_455);
app.patch("/api/plan-manager/drawings/:id/reorder", plan_manager_drawings_id_reorder_patch_456);
app.post("/api/plan-manager/drawings/:id/restore", plan_manager_drawings_id_restore_post_457);
app.post("/api/plan-manager/drawings/:id/revisions", plan_manager_drawings_id_revisions_post_458);
app.post("/api/plan-manager/drawings/:id/revisions/:revisionId/finalize", plan_manager_drawings_id_revisions_revisionId_finalize_post_459);
app.post("/api/plan-manager/drawings/:id/upload", plan_manager_drawings_id_upload_post_460);
app.get("/api/plan-manager/jobs-with-drawings", plan_manager_jobs_with_drawings_get_461);
app.post("/api/plan-manager/share", plan_manager_share_post_462);
app.get("/api/plan-manager/share/validate", plan_manager_share_validate_get_463);
app.post("/api/portal/estimates/:id/approve", portal_estimates_id_approve_post_464);
app.post("/api/portal/invite", portal_invite_post_465);
app.post("/api/portal/invoices/:id/pay", portal_invoices_id_pay_post_466);
app.get("/api/portal/jobs", portal_jobs_get_467);
app.get("/api/portal/jobs/:id", portal_jobs_id_get_468);
app.post("/api/portal/migrate", portal_migrate_post_469);
app.post("/api/portal/validate", portal_validate_post_470);
app.get("/api/public/form/:token", public_form_token_get_471);
...
app.get("/api/recipes", recipes_get_478);
app.post("/api/recipes", recipes_post_479);
app.delete("/api/recipes/:id", recipes_id_delete_480);
app.put("/api/recipes/:id", recipes_id_put_481);
app.post("/api/safety/ai/draft", safety_ai_draft_post_482);
app.get("/api/safety/documents", safety_documents_get_483);
app.post("/api/safety/documents", safety_documents_post_484);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_485);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_486);
app.get("/api/safety/generated-posters", safety_generated_posters_get_487);
app.post("/api/safety/generated-posters", safety_generated_posters_post_488);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_489);
app.get("/api/safety/job-safety-plans", safety_job_safety_plans_get_490);
app.post("/api/safety/job-safety-plans", safety_job_safety_plans_post_491);
app.delete("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_delete_492);
app.put("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_put_493);
app.get("/api/safety/job-swms", safety_job_swms_get_494);
app.post("/api/safety/job-swms", safety_job_swms_post_495);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_496);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_497);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_498);
app.post("/api/safety/job-swms/:id/share-token", safety_job_swms_id_share_token_post_499);
app.get("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_get_500);
app.post("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_post_501);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", safety_job_swms_id_signoffs_signoffId_delete_502);
app.get("/api/safety/plans", safety_plans_get_503);
app.post("/api/safety/plans", safety_plans_post_504);
app.post("/api/safety/plans/seed", safety_plans_seed_post_505);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_506);
app.put("/api/safety/plans/:id", safety_plans_id_put_507);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_508);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_509);
app.get("/api/safety/posters", safety_posters_get_510);
app.post("/api/safety/posters", safety_posters_post_511);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_512);
app.get("/api/safety/swms", safety_swms_get_513);
app.post("/api/safety/swms", safety_swms_post_514);
app.post("/api/safety/swms/import-docx", safety_swms_import_docx_post_515);
app.post("/api/safety/swms/seed", safety_swms_seed_post_516);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_517);
app.get("/api/safety/swms/:id", safety_swms_id_get_518);
app.put("/api/safety/swms/:id", safety_swms_id_put_519);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_520);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_521);
app.post("/api/safety/swms/:id/publish-to-library", safety_swms_id_publish_to_library_post_522);
app.get("/api/scheduler/crew", scheduler_crew_get_523);
app.get("/api/scheduler/jobs", scheduler_jobs_get_524);
app.patch("/api/scheduler/jobs/:id/reschedule", scheduler_jobs_id_reschedule_patch_525);
app.get("/api/secure-share", secure_share_get_526);
app.post("/api/secure-share", secure_share_post_527);
app.delete("/api/secure-share/:id", secure_share_id_delete_528);
app.get("/api/secure-share/:token", secure_share_token_get_529);
app.post("/api/secure-share/:token", secure_share_token_post_530);
app.get("/api/settings/backup", settings_backup_get_531);
app.post("/api/settings/backup", settings_backup_post_532);
app.get("/api/settings/backup/export", settings_backup_export_get_533);
app.post("/api/settings/backup/run", settings_backup_run_post_534);
app.get("/api/settings/backup-destination", settings_backup_destination_get_535);
app.post("/api/settings/backup-destination", settings_backup_destination_post_536);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_537);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_538);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_539);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_540);
app.get("/api/settings/retention", settings_retention_get_541);
app.post("/api/settings/retention", settings_retention_post_542);
app.get("/api/settings/storage-provider", settings_storage_provider_get_543);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_544);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_545);
app.get("/api/settings/terminology", settings_terminology_get_546);
app.post("/api/settings/terminology", settings_terminology_post_547);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_548);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_549);
app.get("/api/share/:token", share_token_get_550);
app.get("/api/signin-history", signin_history_get_551);
app.post("/api/signup", signup_post_552);
...
app.get("/api/subscription/status", subscription_status_get_559);
app.post("/api/subscription/webhook", subscription_webhook_post_560);
app.get("/api/support-mode/audit", support_mode_audit_get_561);
app.get("/api/support-mode/checklist", support_mode_checklist_get_562);
app.put("/api/support-mode/checklist", support_mode_checklist_put_563);
app.post("/api/support-mode/enter", support_mode_enter_post_564);
app.post("/api/support-mode/exit", support_mode_exit_post_565);
app.get("/api/support-mode/status", support_mode_status_get_566);
app.get("/api/tag-tasks", tag_tasks_get_567);
app.patch("/api/tag-tasks/:id", tag_tasks_id_patch_568);
app.get("/api/takeoff-pad", takeoff_pad_get_569);
app.put("/api/takeoff-pad", takeoff_pad_put_570);
app.get("/api/team", team_get_571);
app.post("/api/team/invite", team_invite_post_572);
app.get("/api/team/invites", team_invites_get_573);
app.post("/api/team/invites", team_invites_post_574);
...
app.post("/api/team/shifts", team_shifts_post_581);
app.delete("/api/team/shifts/:id", team_shifts_id_delete_582);
app.put("/api/team/shifts/:id", team_shifts_id_put_583);
app.get("/api/team/time-entries", team_time_entries_get_584);
app.post("/api/team/time-entries", team_time_entries_post_585);
app.get("/api/team/time-entries/export", team_time_entries_export_get_586);
app.put("/api/team/time-entries/:id", team_time_entries_id_put_587);
app.post("/api/team/verify-user", team_verify_user_post_588);
app.delete("/api/team/:id", team_id_delete_589);
app.put("/api/team/:id", team_id_put_590);
app.get("/api/usage", usage_get_591);
// </api-registrations>
