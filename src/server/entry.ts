...
import owner_console_library_items_id_delete_642 from "./api/owner-console/library/items/[id]/DELETE";
import owner_console_library_items_id_patch_643 from "./api/owner-console/library/items/[id]/PATCH";
import owner_console_library_items_id_put_644 from "./api/owner-console/library/items/[id]/PUT";
import owner_console_library_items_id_push_update_post_645 from "./api/owner-console/library/items/[id]/push-update/POST";
import owner_console_library_submissions_get_646 from "./api/owner-console/library/submissions/GET";
import owner_console_library_submissions_id_review_post_647 from "./api/owner-console/library/submissions/[id]/review/POST";
import owner_console_starter_pack_get_648 from "./api/owner-console/starter-pack/GET";
import owner_console_starter_pack_post_649 from "./api/owner-console/starter-pack/POST";
import owner_console_stats_get_650 from "./api/owner-console/stats/GET";
import owner_console_storage_get_651 from "./api/owner-console/storage/GET";
import owner_console_swms_masters_get_652 from "./api/owner-console/swms/masters/GET";
import owner_console_swms_masters_post_653 from "./api/owner-console/swms/masters/POST";
import owner_console_swms_masters_publish_all_post_654 from "./api/owner-console/swms/masters/publish-all/POST";
import owner_console_swms_masters_id_delete_655 from "./api/owner-console/swms/masters/[id]/DELETE";
import owner_console_swms_masters_id_get_656 from "./api/owner-console/swms/masters/[id]/GET";
import owner_console_swms_masters_id_put_657 from "./api/owner-console/swms/masters/[id]/PUT";
import owner_console_swms_masters_id_publish_post_658 from "./api/owner-console/swms/masters/[id]/publish/POST";
import owner_console_swms_migrate_master_library_post_659 from "./api/owner-console/swms/migrate-master-library/POST";
import owner_console_swms_push_post_660 from "./api/owner-console/swms/push/POST";
import owner_console_swms_seed_bricklaying_post_661 from "./api/owner-console/swms/seed-bricklaying/POST";
import owner_console_swms_seed_building_inspection_post_662 from "./api/owner-console/swms/seed-building-inspection/POST";
import owner_console_swms_seed_cabinets_post_663 from "./api/owner-console/swms/seed-cabinets/POST";
import owner_console_swms_seed_carpenter_fixing_post_664 from "./api/owner-console/swms/seed-carpenter-fixing/POST";
import owner_console_swms_seed_carpenter_framing_post_665 from "./api/owner-console/swms/seed-carpenter-framing/POST";
import owner_console_swms_seed_carpenter_lockup_post_666 from "./api/owner-console/swms/seed-carpenter-lockup/POST";
import owner_console_swms_seed_ceramic_tiling_post_667 from "./api/owner-console/swms/seed-ceramic-tiling/POST";
import owner_console_swms_seed_concreting_slab_post_668 from "./api/owner-console/swms/seed-concreting-slab/POST";
import owner_console_swms_seed_delivery_loading_post_669 from "./api/owner-console/swms/seed-delivery-loading/POST";
import owner_console_swms_seed_environmental_spill_post_670 from "./api/owner-console/swms/seed-environmental-spill/POST";
import owner_console_swms_seed_ewp_post_671 from "./api/owner-console/swms/seed-ewp/POST";
import owner_console_swms_seed_excavations_substation_post_672 from "./api/owner-console/swms/seed-excavations-substation/POST";
import owner_console_swms_seed_fencing_post_673 from "./api/owner-console/swms/seed-fencing/POST";
import owner_console_swms_seed_heat_stress_post_674 from "./api/owner-console/swms/seed-heat-stress/POST";
import owner_console_swms_seed_landscaping_post_675 from "./api/owner-console/swms/seed-landscaping/POST";
import owner_console_swms_seed_live_parts_post_676 from "./api/owner-console/swms/seed-live-parts/POST";
import owner_console_swms_seed_manual_handling_post_677 from "./api/owner-console/swms/seed-manual-handling/POST";
import owner_console_swms_seed_moving_plant_post_678 from "./api/owner-console/swms/seed-moving-plant/POST";
import owner_console_swms_seed_painting_post_679 from "./api/owner-console/swms/seed-painting/POST";
import owner_console_swms_seed_power_tools_post_680 from "./api/owner-console/swms/seed-power-tools/POST";
import owner_console_swms_seed_silica_dust_post_681 from "./api/owner-console/swms/seed-silica-dust/POST";
import owner_console_swms_seed_traffic_management_post_682 from "./api/owner-console/swms/seed-traffic-management/POST";
import owner_console_swms_seed_underground_services_post_683 from "./api/owner-console/swms/seed-underground-services/POST";
import owner_console_swms_seed_vacuum_excavation_post_684 from "./api/owner-console/swms/seed-vacuum-excavation/POST";
import owner_console_system_ai_builtin_checks_post_685 from "./api/owner-console/system-ai/builtin-checks/POST";
import owner_console_twilio_info_get_686 from "./api/owner-console/twilio-info/GET";
import owner_console_users_get_687 from "./api/owner-console/users/GET";
import owner_console_users_verify_post_688 from "./api/owner-console/users/verify/POST";
import plan_manager_drawings_get_689 from "./api/plan-manager/drawings/GET";
import plan_manager_drawings_post_690 from "./api/plan-manager/drawings/POST";
import plan_manager_drawings_id_get_691 from "./api/plan-manager/drawings/[id]/GET";
import plan_manager_drawings_id_annotations_put_692 from "./api/plan-manager/drawings/[id]/annotations/PUT";
import plan_manager_drawings_id_archive_post_693 from "./api/plan-manager/drawings/[id]/archive/POST";
import plan_manager_drawings_id_job_links_delete_694 from "./api/plan-manager/drawings/[id]/job-links/DELETE";
import plan_manager_drawings_id_job_links_post_695 from "./api/plan-manager/drawings/[id]/job-links/POST";
import plan_manager_drawings_id_pages_pageNo_annotations_get_696 from "./api/plan-manager/drawings/[id]/pages/[pageNo]/annotations/GET";
import plan_manager_drawings_id_permanent_delete_697 from "./api/plan-manager/drawings/[id]/permanent/DELETE";
import plan_manager_drawings_id_reorder_patch_698 from "./api/plan-manager/drawings/[id]/reorder/PATCH";
import plan_manager_drawings_id_restore_post_699 from "./api/plan-manager/drawings/[id]/restore/POST";
import plan_manager_drawings_id_revisions_post_700 from "./api/plan-manager/drawings/[id]/revisions/POST";
import plan_manager_drawings_id_revisions_revisionId_finalize_post_701 from "./api/plan-manager/drawings/[id]/revisions/[revisionId]/finalize/POST";
import plan_manager_drawings_id_upload_post_702 from "./api/plan-manager/drawings/[id]/upload/POST";
import plan_manager_jobs_jobId_drawings_zip_get_703 from "./api/plan-manager/jobs/[jobId]/drawings-zip/GET";
import plan_manager_jobs_with_drawings_get_704 from "./api/plan-manager/jobs-with-drawings/GET";
import plan_manager_share_post_705 from "./api/plan-manager/share/POST";
import plan_manager_share_validate_get_706 from "./api/plan-manager/share/validate/GET";
import plan_manager_upload_post_707 from "./api/plan-manager/upload/POST";
import portal_estimates_id_approve_post_708 from "./api/portal/estimates/[id]/approve/POST";
import portal_invite_post_709 from "./api/portal/invite/POST";
import portal_invoices_id_pay_post_710 from "./api/portal/invoices/[id]/pay/POST";
import portal_jobs_get_711 from "./api/portal/jobs/GET";
import portal_jobs_id_get_712 from "./api/portal/jobs/[id]/GET";
import portal_migrate_post_713 from "./api/portal/migrate/POST";
import portal_validate_post_714 from "./api/portal/validate/POST";
import public_form_token_get_715 from "./api/public/form/[token]/GET";
import public_form_token_submit_post_716 from "./api/public/form/[token]/submit/POST";
import public_job_photos_token_get_717 from "./api/public/job-photos/[token]/GET";
import public_job_photos_token_photo_photoId_get_718 from "./api/public/job-photos/[token]/photo/[photoId]/GET";
import public_swms_token_get_719 from "./api/public/swms/[token]/GET";
import public_swms_token_signoff_post_720 from "./api/public/swms/[token]/signoff/POST";
import purchase_orders_poId_compose_defaults_get_721 from "./api/purchase-orders/[poId]/compose-defaults/GET";
import purchase_orders_poId_send_email_post_722 from "./api/purchase-orders/[poId]/send-email/POST";
import push_subscribe_delete_723 from "./api/push/subscribe/DELETE";
import push_subscribe_post_724 from "./api/push/subscribe/POST";
import push_vapid_key_get_725 from "./api/push/vapid-key/GET";
import quick_links_site_meta_get_726 from "./api/quick-links/site-meta/GET";
import recipes_get_727 from "./api/recipes/GET";
import recipes_post_728 from "./api/recipes/POST";
import recipes_id_delete_729 from "./api/recipes/[id]/DELETE";
import recipes_id_put_730 from "./api/recipes/[id]/PUT";
import risk_register_get_731 from "./api/risk-register/GET";
import risk_register_post_732 from "./api/risk-register/POST";
import risk_register_id_get_733 from "./api/risk-register/[id]/GET";
import risk_register_id_put_734 from "./api/risk-register/[id]/PUT";
import risk_register_id_archive_post_735 from "./api/risk-register/[id]/archive/POST";
import risk_register_id_unarchive_post_736 from "./api/risk-register/[id]/unarchive/POST";
import rl_register_get_737 from "./api/rl-register/GET";
import rl_register_post_738 from "./api/rl-register/POST";
import rl_register_points_id_delete_739 from "./api/rl-register/points/[id]/DELETE";
import rl_register_points_id_put_740 from "./api/rl-register/points/[id]/PUT";
import rl_register_benchmarkId_points_get_741 from "./api/rl-register/[benchmarkId]/points/GET";
import rl_register_benchmarkId_points_post_742 from "./api/rl-register/[benchmarkId]/points/POST";
import rl_register_jobId_export_csv_get_743 from "./api/rl-register/[jobId]/export/csv/GET";
import rl_register_jobId_export_pdf_get_744 from "./api/rl-register/[jobId]/export/pdf/GET";
import safety_ai_draft_post_745 from "./api/safety/ai/draft/POST";
import safety_documents_get_746 from "./api/safety/documents/GET";
import safety_documents_post_747 from "./api/safety/documents/POST";
import safety_documents_new_post_748 from "./api/safety/documents/new/POST";
import safety_documents_id_delete_749 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_750 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_751 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_752 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_753 from "./api/safety/generated-posters/[id]/DELETE";
import safety_generated_posters_id_pdf_get_754 from "./api/safety/generated-posters/[id]/pdf/GET";
import safety_job_safety_plans_get_755 from "./api/safety/job-safety-plans/GET";
import safety_job_safety_plans_post_756 from "./api/safety/job-safety-plans/POST";
import safety_job_safety_plans_id_delete_757 from "./api/safety/job-safety-plans/[id]/DELETE";
import safety_job_safety_plans_id_put_758 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_759 from "./api/safety/job-swms/GET";
import safety_job_swms_post_760 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_761 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_762 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_763 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_share_token_post_764 from "./api/safety/job-swms/[id]/share-token/POST";
import safety_job_swms_id_signoffs_get_765 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_766 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_767 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_768 from "./api/safety/plans/GET";
import safety_plans_post_769 from "./api/safety/plans/POST";
import safety_plans_seed_post_770 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_771 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_772 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_773 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_774 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_775 from "./api/safety/posters/GET";
import safety_posters_post_776 from "./api/safety/posters/POST";
import safety_posters_id_delete_777 from "./api/safety/posters/[id]/DELETE";
import safety_posters_id_download_get_778 from "./api/safety/posters/[id]/download/GET";
import safety_swms_get_779 from "./api/safety/swms/GET";
import safety_swms_post_780 from "./api/safety/swms/POST";
import safety_swms_import_docx_post_781 from "./api/safety/swms/import-docx/POST";
import safety_swms_seed_post_782 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_783 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_784 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_785 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_786 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_787 from "./api/safety/swms/[id]/export/GET";
import safety_swms_id_publish_to_library_post_788 from "./api/safety/swms/[id]/publish-to-library/POST";
import safety_swms_submissions_get_789 from "./api/safety/swms-submissions/GET";
import scheduler_crew_get_790 from "./api/scheduler/crew/GET";
import scheduler_jobs_get_791 from "./api/scheduler/jobs/GET";
import scheduler_jobs_id_reschedule_patch_792 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
import scheduler_tasks_get_793 from "./api/scheduler/tasks/GET";
import sds_register_get_794 from "./api/sds-register/GET";
import sds_register_post_795 from "./api/sds-register/POST";
import sds_register_id_delete_796 from "./api/sds-register/[id]/DELETE";
import sds_register_id_put_797 from "./api/sds-register/[id]/PUT";
import sds_register_id_download_get_798 from "./api/sds-register/[id]/download/GET";
import sds_register_id_replace_post_799 from "./api/sds-register/[id]/replace/POST";
import secure_share_get_800 from "./api/secure-share/GET";
import secure_share_post_801 from "./api/secure-share/POST";
import secure_share_active_get_802 from "./api/secure-share/active/GET";
import secure_share_id_delete_803 from "./api/secure-share/[id]/DELETE";
import secure_share_id_revoke_and_rotate_post_804 from "./api/secure-share/[id]/revoke-and-rotate/POST";
import secure_share_token_get_805 from "./api/secure-share/[token]/GET";
import secure_share_token_post_806 from "./api/secure-share/[token]/POST";
import secure_share_token_content_get_807 from "./api/secure-share/[token]/content/GET";
import settings_backup_get_808 from "./api/settings/backup/GET";
import settings_backup_post_809 from "./api/settings/backup/POST";
import settings_backup_company_data_get_810 from "./api/settings/backup/company-data/GET";
import settings_backup_csv_pack_get_811 from "./api/settings/backup/csv-pack/GET";
import settings_backup_export_get_812 from "./api/settings/backup/export/GET";
import settings_backup_run_post_813 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_814 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_815 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_816 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_817 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_818 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_819 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_820 from "./api/settings/retention/GET";
import settings_retention_post_821 from "./api/settings/retention/POST";
import settings_storage_provider_get_822 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_823 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_824 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_825 from "./api/settings/terminology/GET";
import settings_terminology_post_826 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_827 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_828 from "./api/settings/xero-credentials/POST";
import share_token_get_829 from "./api/share/[token]/GET";
import signin_history_get_830 from "./api/signin-history/GET";
import signup_post_831 from "./api/signup/POST";
import sos_get_832 from "./api/sos/GET";
import sos_acknowledge_post_833 from "./api/sos/acknowledge/POST";
import sos_trigger_post_834 from "./api/sos/trigger/POST";
import stakeholders_sms_post_835 from "./api/stakeholders/sms/POST";
import stripe_create_checkout_session_post_836 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_837 from "./api/stripe/session/[sessionId]/GET";
import studio_generate_from_safety_post_838 from "./api/studio/generate-from-safety/POST";
import studio_upload_image_post_839 from "./api/studio/upload-image/POST";
import subscription_create_checkout_post_840 from "./api/subscription/create-checkout/POST";
import subscription_status_get_841 from "./api/subscription/status/GET";
import subscription_webhook_post_842 from "./api/subscription/webhook/POST";
import support_mode_audit_get_843 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_844 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_845 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_846 from "./api/support-mode/enter/POST";
import support_mode_exit_post_847 from "./api/support-mode/exit/POST";
import support_mode_status_get_848 from "./api/support-mode/status/GET";
import tag_tasks_get_849 from "./api/tag-tasks/GET";
import tag_tasks_id_patch_850 from "./api/tag-tasks/[id]/PATCH";
import takeoff_pad_get_851 from "./api/takeoff-pad/GET";
import takeoff_pad_put_852 from "./api/takeoff-pad/PUT";
import tasks_post_853 from "./api/tasks/POST";
import tasks_id_put_854 from "./api/tasks/[id]/PUT";
import team_get_855 from "./api/team/GET";
import team_invite_post_856 from "./api/team/invite/POST";
import team_invites_get_857 from "./api/team/invites/GET";
import team_invites_post_858 from "./api/team/invites/POST";
import team_invites_id_cancel_post_859 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_860 from "./api/team/invites/[id]/resend/POST";
import team_members_get_861 from "./api/team/members/GET";
import team_members_id_icon_permissions_get_862 from "./api/team/members/[id]/icon-permissions/GET";
import team_members_id_icon_permissions_put_863 from "./api/team/members/[id]/icon-permissions/PUT";
import team_resend_verification_post_864 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_865 from "./api/team/schedule/migrate/POST";
import team_shifts_get_866 from "./api/team/shifts/GET";
import team_shifts_post_867 from "./api/team/shifts/POST";
import team_shifts_id_delete_868 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_869 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_870 from "./api/team/time-entries/GET";
import team_time_entries_post_871 from "./api/team/time-entries/POST";
import team_time_entries_export_get_872 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_873 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_874 from "./api/team/verify-user/POST";
import team_id_delete_875 from "./api/team/[id]/DELETE";
import team_id_put_876 from "./api/team/[id]/PUT";
import usage_get_877 from "./api/usage/GET";
import user_logs_get_878 from "./api/user-logs/GET";
import user_logs_users_get_879 from "./api/user-logs/users/GET";
import work_attendance_get_880 from "./api/work/attendance/GET";
import work_delays_get_881 from "./api/work/delays/GET";
import work_notes_get_882 from "./api/work/notes/GET";
import work_progress_get_883 from "./api/work/progress/GET";
import work_tasks_get_884 from "./api/work/tasks/GET";
// </api-imports>
// ── Job Cards ─────────────────────────────────────────────────────────────────
...
app.delete("/api/owner-console/library/items/:id", owner_console_library_items_id_delete_642);
app.patch("/api/owner-console/library/items/:id", owner_console_library_items_id_patch_643);
app.put("/api/owner-console/library/items/:id", owner_console_library_items_id_put_644);
app.post("/api/owner-console/library/items/:id/push-update", owner_console_library_items_id_push_update_post_645);
app.get("/api/owner-console/library/submissions", owner_console_library_submissions_get_646);
app.post("/api/owner-console/library/submissions/:id/review", owner_console_library_submissions_id_review_post_647);
app.get("/api/owner-console/starter-pack", owner_console_starter_pack_get_648);
app.post("/api/owner-console/starter-pack", owner_console_starter_pack_post_649);
app.get("/api/owner-console/stats", owner_console_stats_get_650);
app.get("/api/owner-console/storage", owner_console_storage_get_651);
app.get("/api/owner-console/swms/masters", owner_console_swms_masters_get_652);
app.post("/api/owner-console/swms/masters", owner_console_swms_masters_post_653);
app.post("/api/owner-console/swms/masters/publish-all", owner_console_swms_masters_publish_all_post_654);
app.delete("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_delete_655);
app.get("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_get_656);
app.put("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_put_657);
app.post("/api/owner-console/swms/masters/:id/publish", owner_console_swms_masters_id_publish_post_658);
app.post("/api/owner-console/swms/migrate-master-library", owner_console_swms_migrate_master_library_post_659);
app.post("/api/owner-console/swms/push", owner_console_swms_push_post_660);
app.post("/api/owner-console/swms/seed-bricklaying", owner_console_swms_seed_bricklaying_post_661);
app.post("/api/owner-console/swms/seed-building-inspection", owner_console_swms_seed_building_inspection_post_662);
app.post("/api/owner-console/swms/seed-cabinets", owner_console_swms_seed_cabinets_post_663);
app.post("/api/owner-console/swms/seed-carpenter-fixing", owner_console_swms_seed_carpenter_fixing_post_664);
app.post("/api/owner-console/swms/seed-carpenter-framing", owner_console_swms_seed_carpenter_framing_post_665);
app.post("/api/owner-console/swms/seed-carpenter-lockup", owner_console_swms_seed_carpenter_lockup_post_666);
app.post("/api/owner-console/swms/seed-ceramic-tiling", owner_console_swms_seed_ceramic_tiling_post_667);
app.post("/api/owner-console/swms/seed-concreting-slab", owner_console_swms_seed_concreting_slab_post_668);
app.post("/api/owner-console/swms/seed-delivery-loading", owner_console_swms_seed_delivery_loading_post_669);
app.post("/api/owner-console/swms/seed-environmental-spill", owner_console_swms_seed_environmental_spill_post_670);
app.post("/api/owner-console/swms/seed-ewp", owner_console_swms_seed_ewp_post_671);
app.post("/api/owner-console/swms/seed-excavations-substation", owner_console_swms_seed_excavations_substation_post_672);
app.post("/api/owner-console/swms/seed-fencing", owner_console_swms_seed_fencing_post_673);
app.post("/api/owner-console/swms/seed-heat-stress", owner_console_swms_seed_heat_stress_post_674);
app.post("/api/owner-console/swms/seed-landscaping", owner_console_swms_seed_landscaping_post_675);
app.post("/api/owner-console/swms/seed-live-parts", owner_console_swms_seed_live_parts_post_676);
app.post("/api/owner-console/swms/seed-manual-handling", owner_console_swms_seed_manual_handling_post_677);
app.post("/api/owner-console/swms/seed-moving-plant", owner_console_swms_seed_moving_plant_post_678);
app.post("/api/owner-console/swms/seed-painting", owner_console_swms_seed_painting_post_679);
app.post("/api/owner-console/swms/seed-power-tools", owner_console_swms_seed_power_tools_post_680);
app.post("/api/owner-console/swms/seed-silica-dust", owner_console_swms_seed_silica_dust_post_681);
app.post("/api/owner-console/swms/seed-traffic-management", owner_console_swms_seed_traffic_management_post_682);
app.post("/api/owner-console/swms/seed-underground-services", owner_console_swms_seed_underground_services_post_683);
app.post("/api/owner-console/swms/seed-vacuum-excavation", owner_console_swms_seed_vacuum_excavation_post_684);
app.post("/api/owner-console/system-ai/builtin-checks", owner_console_system_ai_builtin_checks_post_685);
app.get("/api/owner-console/twilio-info", owner_console_twilio_info_get_686);
app.get("/api/owner-console/users", owner_console_users_get_687);
app.post("/api/owner-console/users/verify", owner_console_users_verify_post_688);
app.get("/api/plan-manager/drawings", plan_manager_drawings_get_689);
app.post("/api/plan-manager/drawings", plan_manager_drawings_post_690);
app.get("/api/plan-manager/drawings/:id", plan_manager_drawings_id_get_691);
app.put("/api/plan-manager/drawings/:id/annotations", plan_manager_drawings_id_annotations_put_692);
app.post("/api/plan-manager/drawings/:id/archive", plan_manager_drawings_id_archive_post_693);
app.delete("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_delete_694);
app.post("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_post_695);
app.get("/api/plan-manager/drawings/:id/pages/:pageNo/annotations", plan_manager_drawings_id_pages_pageNo_annotations_get_696);
app.delete("/api/plan-manager/drawings/:id/permanent", plan_manager_drawings_id_permanent_delete_697);
app.patch("/api/plan-manager/drawings/:id/reorder", plan_manager_drawings_id_reorder_patch_698);
app.post("/api/plan-manager/drawings/:id/restore", plan_manager_drawings_id_restore_post_699);
app.post("/api/plan-manager/drawings/:id/revisions", plan_manager_drawings_id_revisions_post_700);
app.post("/api/plan-manager/drawings/:id/revisions/:revisionId/finalize", plan_manager_drawings_id_revisions_revisionId_finalize_post_701);
app.post("/api/plan-manager/drawings/:id/upload", plan_manager_drawings_id_upload_post_702);
app.get("/api/plan-manager/jobs/:jobId/drawings-zip", plan_manager_jobs_jobId_drawings_zip_get_703);
app.get("/api/plan-manager/jobs-with-drawings", plan_manager_jobs_with_drawings_get_704);
app.post("/api/plan-manager/share", plan_manager_share_post_705);
app.get("/api/plan-manager/share/validate", plan_manager_share_validate_get_706);
app.post("/api/plan-manager/upload", plan_manager_upload_post_707);
app.post("/api/portal/estimates/:id/approve", portal_estimates_id_approve_post_708);
app.post("/api/portal/invite", portal_invite_post_709);
app.post("/api/portal/invoices/:id/pay", portal_invoices_id_pay_post_710);
app.get("/api/portal/jobs", portal_jobs_get_711);
app.get("/api/portal/jobs/:id", portal_jobs_id_get_712);
app.post("/api/portal/migrate", portal_migrate_post_713);
app.post("/api/portal/validate", portal_validate_post_714);
app.get("/api/public/form/:token", public_form_token_get_715);
app.post("/api/public/form/:token/submit", public_form_token_submit_post_716);
app.get("/api/public/job-photos/:token", public_job_photos_token_get_717);
app.get("/api/public/job-photos/:token/photo/:photoId", public_job_photos_token_photo_photoId_get_718);
app.get("/api/public/swms/:token", public_swms_token_get_719);
app.post("/api/public/swms/:token/signoff", public_swms_token_signoff_post_720);
app.get("/api/purchase-orders/:poId/compose-defaults", purchase_orders_poId_compose_defaults_get_721);
app.post("/api/purchase-orders/:poId/send-email", purchase_orders_poId_send_email_post_722);
app.delete("/api/push/subscribe", push_subscribe_delete_723);
app.post("/api/push/subscribe", push_subscribe_post_724);
app.get("/api/push/vapid-key", push_vapid_key_get_725);
app.get("/api/quick-links/site-meta", quick_links_site_meta_get_726);
app.get("/api/recipes", recipes_get_727);
app.post("/api/recipes", recipes_post_728);
app.delete("/api/recipes/:id", recipes_id_delete_729);
app.put("/api/recipes/:id", recipes_id_put_730);
app.get("/api/risk-register", risk_register_get_731);
app.post("/api/risk-register", risk_register_post_732);
app.get("/api/risk-register/:id", risk_register_id_get_733);
app.put("/api/risk-register/:id", risk_register_id_put_734);
app.post("/api/risk-register/:id/archive", risk_register_id_archive_post_735);
app.post("/api/risk-register/:id/unarchive", risk_register_id_unarchive_post_736);
app.get("/api/rl-register", rl_register_get_737);
app.post("/api/rl-register", rl_register_post_738);
app.delete("/api/rl-register/points/:id", rl_register_points_id_delete_739);
app.put("/api/rl-register/points/:id", rl_register_points_id_put_740);
app.get("/api/rl-register/:benchmarkId/points", rl_register_benchmarkId_points_get_741);
app.post("/api/rl-register/:benchmarkId/points", rl_register_benchmarkId_points_post_742);
app.get("/api/rl-register/:jobId/export/csv", rl_register_jobId_export_csv_get_743);
app.get("/api/rl-register/:jobId/export/pdf", rl_register_jobId_export_pdf_get_744);
app.post("/api/safety/ai/draft", safety_ai_draft_post_745);
app.get("/api/safety/documents", safety_documents_get_746);
app.post("/api/safety/documents", safety_documents_post_747);
app.post("/api/safety/documents/new", safety_documents_new_post_748);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_749);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_750);
app.get("/api/safety/generated-posters", safety_generated_posters_get_751);
app.post("/api/safety/generated-posters", safety_generated_posters_post_752);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_753);
app.get("/api/safety/generated-posters/:id/pdf", safety_generated_posters_id_pdf_get_754);
app.get("/api/safety/job-safety-plans", safety_job_safety_plans_get_755);
app.post("/api/safety/job-safety-plans", safety_job_safety_plans_post_756);
app.delete("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_delete_757);
app.put("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_put_758);
app.get("/api/safety/job-swms", safety_job_swms_get_759);
app.post("/api/safety/job-swms", safety_job_swms_post_760);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_761);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_762);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_763);
app.post("/api/safety/job-swms/:id/share-token", safety_job_swms_id_share_token_post_764);
app.get("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_get_765);
app.post("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_post_766);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", safety_job_swms_id_signoffs_signoffId_delete_767);
app.get("/api/safety/plans", safety_plans_get_768);
app.post("/api/safety/plans", safety_plans_post_769);
app.post("/api/safety/plans/seed", safety_plans_seed_post_770);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_771);
app.put("/api/safety/plans/:id", safety_plans_id_put_772);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_773);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_774);
app.get("/api/safety/posters", safety_posters_get_775);
app.post("/api/safety/posters", safety_posters_post_776);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_777);
app.get("/api/safety/posters/:id/download", safety_posters_id_download_get_778);
app.get("/api/safety/swms", safety_swms_get_779);
app.post("/api/safety/swms", safety_swms_post_780);
app.post("/api/safety/swms/import-docx", safety_swms_import_docx_post_781);
app.post("/api/safety/swms/seed", safety_swms_seed_post_782);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_783);
app.get("/api/safety/swms/:id", safety_swms_id_get_784);
app.put("/api/safety/swms/:id", safety_swms_id_put_785);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_786);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_787);
app.post("/api/safety/swms/:id/publish-to-library", safety_swms_id_publish_to_library_post_788);
app.get("/api/safety/swms-submissions", safety_swms_submissions_get_789);
app.get("/api/scheduler/crew", scheduler_crew_get_790);
app.get("/api/scheduler/jobs", scheduler_jobs_get_791);
app.patch("/api/scheduler/jobs/:id/reschedule", scheduler_jobs_id_reschedule_patch_792);
app.get("/api/scheduler/tasks", scheduler_tasks_get_793);
app.get("/api/sds-register", sds_register_get_794);
app.post("/api/sds-register", sds_register_post_795);
app.delete("/api/sds-register/:id", sds_register_id_delete_796);
app.put("/api/sds-register/:id", sds_register_id_put_797);
app.get("/api/sds-register/:id/download", sds_register_id_download_get_798);
app.post("/api/sds-register/:id/replace", sds_register_id_replace_post_799);
app.get("/api/secure-share", secure_share_get_800);
app.post("/api/secure-share", secure_share_post_801);
app.get("/api/secure-share/active", secure_share_active_get_802);
app.delete("/api/secure-share/:id", secure_share_id_delete_803);
app.post("/api/secure-share/:id/revoke-and-rotate", secure_share_id_revoke_and_rotate_post_804);
app.get("/api/secure-share/:token", secure_share_token_get_805);
app.post("/api/secure-share/:token", secure_share_token_post_806);
app.get("/api/secure-share/:token/content", secure_share_token_content_get_807);
app.get("/api/settings/backup", settings_backup_get_808);
app.post("/api/settings/backup", settings_backup_post_809);
app.get("/api/settings/backup/company-data", settings_backup_company_data_get_810);
app.get("/api/settings/backup/csv-pack", settings_backup_csv_pack_get_811);
app.get("/api/settings/backup/export", settings_backup_export_get_812);
app.post("/api/settings/backup/run", settings_backup_run_post_813);
app.get("/api/settings/backup-destination", settings_backup_destination_get_814);
app.post("/api/settings/backup-destination", settings_backup_destination_post_815);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_816);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_817);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_818);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_819);
app.get("/api/settings/retention", settings_retention_get_820);
app.post("/api/settings/retention", settings_retention_post_821);
app.get("/api/settings/storage-provider", settings_storage_provider_get_822);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_823);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_824);
app.get("/api/settings/terminology", settings_terminology_get_825);
app.post("/api/settings/terminology", settings_terminology_post_826);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_827);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_828);
app.get("/api/share/:token", share_token_get_829);
app.get("/api/signin-history", signin_history_get_830);
app.post("/api/signup", signup_post_831);
app.get("/api/sos", sos_get_832);
app.post("/api/sos/acknowledge", sos_acknowledge_post_833);
app.post("/api/sos/trigger", sos_trigger_post_834);
app.post("/api/stakeholders/sms", stakeholders_sms_post_835);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_836);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_837);
app.post("/api/studio/generate-from-safety", studio_generate_from_safety_post_838);
app.post("/api/studio/upload-image", studio_upload_image_post_839);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_840);
app.get("/api/subscription/status", subscription_status_get_841);
app.post("/api/subscription/webhook", subscription_webhook_post_842);
app.get("/api/support-mode/audit", support_mode_audit_get_843);
app.get("/api/support-mode/checklist", support_mode_checklist_get_844);
app.put("/api/support-mode/checklist", support_mode_checklist_put_845);
app.post("/api/support-mode/enter", support_mode_enter_post_846);
app.post("/api/support-mode/exit", support_mode_exit_post_847);
app.get("/api/support-mode/status", support_mode_status_get_848);
app.get("/api/tag-tasks", tag_tasks_get_849);
app.patch("/api/tag-tasks/:id", tag_tasks_id_patch_850);
app.get("/api/takeoff-pad", takeoff_pad_get_851);
app.put("/api/takeoff-pad", takeoff_pad_put_852);
app.post("/api/tasks", tasks_post_853);
app.put("/api/tasks/:id", tasks_id_put_854);
app.get("/api/team", team_get_855);
app.post("/api/team/invite", team_invite_post_856);
app.get("/api/team/invites", team_invites_get_857);
app.post("/api/team/invites", team_invites_post_858);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_859);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_860);
app.get("/api/team/members", team_members_get_861);
app.get("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_get_862);
app.put("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_put_863);
app.post("/api/team/resend-verification", team_resend_verification_post_864);
app.post("/api/team/schedule/migrate", team_schedule_migrate_post_865);
app.get("/api/team/shifts", team_shifts_get_866);
app.post("/api/team/shifts", team_shifts_post_867);
app.delete("/api/team/shifts/:id", team_shifts_id_delete_868);
app.put("/api/team/shifts/:id", team_shifts_id_put_869);
app.get("/api/team/time-entries", team_time_entries_get_870);
app.post("/api/team/time-entries", team_time_entries_post_871);
app.get("/api/team/time-entries/export", team_time_entries_export_get_872);
app.put("/api/team/time-entries/:id", team_time_entries_id_put_873);
app.post("/api/team/verify-user", team_verify_user_post_874);
app.delete("/api/team/:id", team_id_delete_875);
app.put("/api/team/:id", team_id_put_876);
app.get("/api/usage", usage_get_877);
app.get("/api/user-logs", user_logs_get_878);
app.get("/api/user-logs/users", user_logs_users_get_879);
app.get("/api/work/attendance", work_attendance_get_880);
app.get("/api/work/delays", work_delays_get_881);
app.get("/api/work/notes", work_notes_get_882);
app.get("/api/work/progress", work_progress_get_883);
app.get("/api/work/tasks", work_tasks_get_884);
// </api-registrations>
