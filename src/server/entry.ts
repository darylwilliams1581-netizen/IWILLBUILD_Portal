...
import owner_console_library_items_get from "./api/owner-console/library/items/GET";
...
import owner_console_library_items_id_put from "./api/owner-console/library/items/[id]/PUT";
import owner_console_library_items_id_push_update_post from "./api/owner-console/library/items/[id]/push-update/POST";
import owner_console_swms_push_post from "./api/owner-console/swms/push/POST";
import owner_console_swms_migrate_master_library_post from "./api/owner-console/swms/migrate-master-library/POST";
import owner_console_swms_masters_get from "./api/owner-console/swms/masters/GET";
import owner_console_swms_masters_post from "./api/owner-console/swms/masters/POST";
import owner_console_swms_masters_id_get from "./api/owner-console/swms/masters/[id]/GET";
import owner_console_swms_masters_id_put from "./api/owner-console/swms/masters/[id]/PUT";
import owner_console_swms_masters_id_delete from "./api/owner-console/swms/masters/[id]/DELETE";
import owner_console_swms_masters_id_publish_post from "./api/owner-console/swms/masters/[id]/publish/POST";
import owner_console_swms_masters_publish_all_post from "./api/owner-console/swms/masters/publish-all/POST";
...
import owner_console_swms_seed_bricklaying_post from "./api/owner-console/swms/seed-bricklaying/POST";
import owner_console_swms_seed_concreting_slab_post from "./api/owner-console/swms/seed-concreting-slab/POST";
...
import owner_console_swms_seed_underground_services_post from "./api/owner-console/swms/seed-underground-services/POST";
import owner_console_swms_seed_live_parts_post from "./api/owner-console/swms/seed-live-parts/POST";
import owner_console_swms_seed_moving_plant_post from "./api/owner-console/swms/seed-moving-plant/POST";
...
import safety_swms_id_publish_to_library_post from "./api/safety/swms/[id]/publish-to-library/POST";
...
app.get("/api/owner-console/library/items", owner_console_library_items_get);
...
app.put("/api/owner-console/library/items/:id", owner_console_library_items_id_put);
app.post("/api/owner-console/library/items/:id/push-update", owner_console_library_items_id_push_update_post);
app.post("/api/owner-console/swms/push", owner_console_swms_push_post);
app.post("/api/owner-console/swms/migrate-master-library", owner_console_swms_migrate_master_library_post);
app.get("/api/owner-console/swms/masters", owner_console_swms_masters_get);
app.post("/api/owner-console/swms/masters", owner_console_swms_masters_post);
app.post("/api/owner-console/swms/masters/publish-all", owner_console_swms_masters_publish_all_post);
app.get("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_get);
app.put("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_put);
app.delete("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_delete);
app.post("/api/owner-console/swms/masters/:id/publish", owner_console_swms_masters_id_publish_post);
...
app.post("/api/owner-console/swms/seed-bricklaying", owner_console_swms_seed_bricklaying_post);
app.post("/api/owner-console/swms/seed-concreting-slab", owner_console_swms_seed_concreting_slab_post);
...
app.post("/api/owner-console/swms/seed-underground-services", owner_console_swms_seed_underground_services_post);
app.post("/api/owner-console/swms/seed-live-parts", owner_console_swms_seed_live_parts_post);
app.post("/api/owner-console/swms/seed-moving-plant", owner_console_swms_seed_moving_plant_post);
...
app.post("/api/safety/swms/:id/publish-to-library", safety_swms_id_publish_to_library_post);
