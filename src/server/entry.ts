...
import dazza_brain_status_get from "./api/dazza/brain/status/GET";
import dazza_brain_hive_approve_post from "./api/dazza/brain/hive/approve/POST";
import dazza_brain_hive_reject_post from "./api/dazza/brain/hive/reject/POST";
...
import form_templates_seed_post from "./api/form-templates/seed/POST";
...
import owner_console_users_verify_post from "./api/owner-console/users/verify/POST";
...
import settings_terminology_get from "./api/settings/terminology/GET";
import settings_terminology_post from "./api/settings/terminology/POST";
...
import safety_swms_id_export_get from "./api/safety/swms/[id]/export/GET";
import safety_swms_id_duplicate_post from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_delete from "./api/safety/swms/[id]/DELETE";
import safety_swms_seed_post from "./api/safety/swms/seed/POST";
import safety_job_swms_get from "./api/safety/job-swms/GET";
import safety_job_swms_post from "./api/safety/job-swms/POST";
...
import safety_plans_id_delete from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_export_get from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get from "./api/safety/plans/[id]/pack/GET";
import safety_ai_draft_post from "./api/safety/ai/draft/POST";
...
// ── Dazza Brain routes ────────────────────────────────────────────────────────
app.get("/api/dazza/brain/status", dazza_brain_status_get);
app.post("/api/dazza/brain/hive/approve", dazza_brain_hive_approve_post);
app.post("/api/dazza/brain/hive/reject", dazza_brain_hive_reject_post);
...
app.post("/api/form-templates/seed", form_templates_seed_post);
...
app.get("/api/settings/terminology", settings_terminology_get);
app.post("/api/settings/terminology", settings_terminology_post);
...
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get);
app.put("/api/safety/swms/:id", safety_swms_id_put);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post);
app.delete("/api/safety/swms/:id", safety_swms_id_delete);
app.get("/api/safety/job-swms", safety_job_swms_get);
app.post("/api/safety/job-swms", safety_job_swms_post);
...
app.delete("/api/safety/plans/:id", safety_plans_id_delete);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get);
app.post("/api/safety/ai/draft", safety_ai_draft_post);
