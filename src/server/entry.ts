...
import company_settings_get_87 from "./api/company-settings/GET";
import company_settings_put_88 from "./api/company-settings/PUT";
import config_maps_key_get_89 from "./api/config/maps-key/GET";
import contact_post_90 from "./api/contact/POST";
import cost_guide_get_91 from "./api/cost-guide/GET";
import cost_guide_post_92 from "./api/cost-guide/POST";
import cost_guide_export_csv_get_93 from "./api/cost-guide/export-csv/GET";
import cost_guide_import_csv_post_94 from "./api/cost-guide/import-csv/POST";
import cost_guide_id_delete_95 from "./api/cost-guide/[id]/DELETE";
import cost_guide_id_put_96 from "./api/cost-guide/[id]/PUT";
import customers_get_97 from "./api/customers/GET";
import customers_post_98 from "./api/customers/POST";
import customers_id_delete_99 from "./api/customers/[id]/DELETE";
import customers_id_get_100 from "./api/customers/[id]/GET";
import customers_id_put_101 from "./api/customers/[id]/PUT";
import dashboard_kpi_get_102 from "./api/dashboard/kpi/GET";
import dashboard_setup_check_get_103 from "./api/dashboard/setup-check/GET";
import dashboard_todos_get_104 from "./api/dashboard/todos/GET";
import dazza_annette_post_105 from "./api/dazza/annette/POST";
...
import dazza_context_get_112 from "./api/dazza/context/GET";
import dazza_key_status_get_113 from "./api/dazza/key-status/GET";
import dazza_knowledge_get_114 from "./api/dazza/knowledge/GET";
import dazza_knowledge_post_115 from "./api/dazza/knowledge/POST";
import dazza_knowledge_id_delete_116 from "./api/dazza/knowledge/[id]/DELETE";
import dazza_knowledge_id_put_117 from "./api/dazza/knowledge/[id]/PUT";
import developer_activity_log_get_118 from "./api/developer/activity-log/GET";
import developer_audit_log_get_119 from "./api/developer/audit-log/GET";
import developer_companies_id_archive_post_120 from "./api/developer/companies/[id]/archive/POST";
import developer_company_health_get_121 from "./api/developer/company-health/GET";
import developer_email_log_get_122 from "./api/developer/email-log/GET";
import developer_email_settings_get_123 from "./api/developer/email-settings/GET";
import developer_email_settings_put_124 from "./api/developer/email-settings/PUT";
import developer_email_settings_test_post_125 from "./api/developer/email-settings/test/POST";
...
// REMOVED: developer_swms_cleanup_post_132 — hardcoded company-specific data, deleted (audit fix)
...
import developer_users_id_force_temp_password_post_136 from "./api/developer/users/[id]/force-temp-password/POST";
import developer_users_id_impersonate_delete_137 from "./api/developer/users/[id]/impersonate/DELETE";
import developer_users_id_impersonate_post_138 from "./api/developer/users/[id]/impersonate/POST";
import developer_users_id_reactivate_post_139 from "./api/developer/users/[id]/reactivate/POST";
import developer_users_id_resend_verification_post_140 from "./api/developer/users/[id]/resend-verification/POST";
import developer_users_id_role_put_141 from "./api/developer/users/[id]/role/PUT";
import developer_users_id_send_reset_email_post_142 from "./api/developer/users/[id]/send-reset-email/POST";
...
// REMOVED: diag_route_check_get_147 — leaks route structure, deleted (audit fix)
// REMOVED: diag_run_recovery_post_148 — no-auth bulk rewrite route deleted (audit fix)
...
import document_templates_id_get_154 from "./api/document-templates/[id]/GET";
import document_templates_id_put_155 from "./api/document-templates/[id]/PUT";
import document_templates_id_duplicate_post_156 from "./api/document-templates/[id]/duplicate/POST";
import document_templates_id_export_docx_get_157 from "./api/document-templates/[id]/export/docx/GET";
import document_templates_id_export_pdf_get_158 from "./api/document-templates/[id]/export/pdf/GET";
import document_templates_id_import_blocks_post_159 from "./api/document-templates/[id]/import-blocks/POST";
import document_templates_id_import_docx_post_160 from "./api/document-templates/[id]/import-docx/POST";
import document_templates_id_import_pdf_post_161 from "./api/document-templates/[id]/import-pdf/POST";
import document_templates_id_publish_to_library_post_162 from "./api/document-templates/[id]/publish-to-library/POST";
import documents_get_163 from "./api/documents/GET";
import documents_share_token_get_164 from "./api/documents/share/[token]/GET";
import documents_share_token_post_165 from "./api/documents/share/[token]/POST";
import documents_id_get_166 from "./api/documents/[id]/GET";
import documents_id_put_167 from "./api/documents/[id]/PUT";
import documents_id_events_get_168 from "./api/documents/[id]/events/GET";
import documents_id_share_delete_169 from "./api/documents/[id]/share/DELETE";
import documents_id_share_post_170 from "./api/documents/[id]/share/POST";
import drawings_get_171 from "./api/drawings/GET";
import drawings_post_172 from "./api/drawings/POST";
import drawings_upload_post_173 from "./api/drawings/upload/POST";
import drawings_id_delete_174 from "./api/drawings/[id]/DELETE";
import drawings_id_patch_175 from "./api/drawings/[id]/PATCH";
import drawings_id_markup_post_176 from "./api/drawings/[id]/markup/POST";
import emergency_alerts_get_177 from "./api/emergency-alerts/GET";
import emergency_alerts_post_178 from "./api/emergency-alerts/POST";
import emergency_alerts_id_put_179 from "./api/emergency-alerts/[id]/PUT";
import estimates_get_180 from "./api/estimates/GET";
import estimates_post_181 from "./api/estimates/POST";
import estimates_id_delete_182 from "./api/estimates/[id]/DELETE";
import estimates_id_get_183 from "./api/estimates/[id]/GET";
import estimates_id_put_184 from "./api/estimates/[id]/PUT";
import estimates_id_convert_to_invoice_post_185 from "./api/estimates/[id]/convert-to-invoice/POST";
import estimates_id_export_csv_get_186 from "./api/estimates/[id]/export-csv/GET";
import estimates_id_export_pdf_get_187 from "./api/estimates/[id]/export-pdf/GET";
import estimates_id_import_csv_post_188 from "./api/estimates/[id]/import-csv/POST";
import estimates_id_unlock_post_189 from "./api/estimates/[id]/unlock/POST";
import external_form_token_get_190 from "./api/external/form/[token]/GET";
import external_form_token_post_191 from "./api/external/form/[token]/POST";
import files_get_192 from "./api/files/GET";
import files_post_193 from "./api/files/POST";
import files_id_delete_194 from "./api/files/[id]/DELETE";
import files_id_download_get_195 from "./api/files/[id]/download/GET";
import fleet_get_196 from "./api/fleet/GET";
import fleet_post_197 from "./api/fleet/POST";
import fleet_analytics_settings_get_198 from "./api/fleet/analytics-settings/GET";
import fleet_analytics_settings_put_199 from "./api/fleet/analytics-settings/PUT";
import fleet_asset_bookings_get_200 from "./api/fleet/asset-bookings/GET";
import fleet_asset_bookings_post_201 from "./api/fleet/asset-bookings/POST";
import fleet_asset_bookings_id_delete_202 from "./api/fleet/asset-bookings/[id]/DELETE";
import fleet_asset_bookings_id_patch_203 from "./api/fleet/asset-bookings/[id]/PATCH";
import fleet_driver_sessions_post_204 from "./api/fleet/driver-sessions/POST";
import fleet_driver_sessions_active_get_205 from "./api/fleet/driver-sessions/active/GET";
import fleet_driver_sessions_live_get_206 from "./api/fleet/driver-sessions/live/GET";
import fleet_driver_sessions_migrate_gps_status_post_207 from "./api/fleet/driver-sessions/migrate-gps-status/POST";
import fleet_driver_sessions_id_heartbeat_post_208 from "./api/fleet/driver-sessions/[id]/heartbeat/POST";
import fleet_driver_sessions_id_stop_post_209 from "./api/fleet/driver-sessions/[id]/stop/POST";
import fleet_driver_sessions_id_summary_get_210 from "./api/fleet/driver-sessions/[id]/summary/GET";
import fleet_driver_sessions_id_telemetry_post_211 from "./api/fleet/driver-sessions/[id]/telemetry/POST";
import fleet_driver_sessions_id_telemetry_latest_get_212 from "./api/fleet/driver-sessions/[id]/telemetry/latest/GET";
import fleet_flags_get_213 from "./api/fleet/flags/GET";
import fleet_last_known_positions_get_214 from "./api/fleet/last-known-positions/GET";
import fleet_service_logs_logId_delete_215 from "./api/fleet/service-logs/[logId]/DELETE";
import fleet_service_logs_logId_patch_216 from "./api/fleet/service-logs/[logId]/PATCH";
import fleet_vehicles_get_217 from "./api/fleet/vehicles/GET";
import fleet_id_delete_218 from "./api/fleet/[id]/DELETE";
import fleet_id_get_219 from "./api/fleet/[id]/GET";
import fleet_id_put_220 from "./api/fleet/[id]/PUT";
import fleet_id_driver_sessions_get_221 from "./api/fleet/[id]/driver-sessions/GET";
import fleet_id_driver_sessions_manual_post_222 from "./api/fleet/[id]/driver-sessions/manual/POST";
import fleet_id_files_get_223 from "./api/fleet/[id]/files/GET";
import fleet_id_prestarts_get_224 from "./api/fleet/[id]/prestarts/GET";
import fleet_id_prestarts_post_225 from "./api/fleet/[id]/prestarts/POST";
import fleet_id_service_logs_get_226 from "./api/fleet/[id]/service-logs/GET";
import fleet_id_service_logs_post_227 from "./api/fleet/[id]/service-logs/POST";
import fleet_id_signin_post_228 from "./api/fleet/[id]/signin/POST";
import fleet_id_signout_post_229 from "./api/fleet/[id]/signout/POST";
import fleet_id_usage_export_get_230 from "./api/fleet/[id]/usage-export/GET";
import fleet_id_usage_status_get_231 from "./api/fleet/[id]/usage-status/GET";
import fleet_id_usage_summary_get_232 from "./api/fleet/[id]/usage-summary/GET";
import form_attachments_post_233 from "./api/form-attachments/POST";
import form_global_lists_get_234 from "./api/form-global-lists/GET";
import form_global_lists_post_235 from "./api/form-global-lists/POST";
import form_global_lists_id_delete_236 from "./api/form-global-lists/[id]/DELETE";
import form_global_lists_id_put_237 from "./api/form-global-lists/[id]/PUT";
import form_templates_get_238 from "./api/form-templates/GET";
import form_templates_post_239 from "./api/form-templates/POST";
import form_templates_seed_post_240 from "./api/form-templates/seed/POST";
import form_templates_id_delete_241 from "./api/form-templates/[id]/DELETE";
import form_templates_id_put_242 from "./api/form-templates/[id]/PUT";
import form_templates_id_publish_to_library_post_243 from "./api/form-templates/[id]/publish-to-library/POST";
import forms_assets_list_get_244 from "./api/forms/assets-list/GET";
import forms_jobs_list_get_245 from "./api/forms/jobs-list/GET";
import forms_migrate_skip_logic_post_246 from "./api/forms/migrate-skip-logic/POST";
import forms_skip_audit_get_247 from "./api/forms/skip-audit/GET";
import forms_skip_audit_post_248 from "./api/forms/skip-audit/POST";
import forms_start_post_249 from "./api/forms/start/POST";
import forms_submissions_get_250 from "./api/forms/submissions/GET";
import forms_templates_id_share_link_post_251 from "./api/forms/templates/[id]/share-link/POST";
import forms_id_fields_get_252 from "./api/forms/[id]/fields/GET";
import forms_id_fields_post_253 from "./api/forms/[id]/fields/POST";
import forms_id_fields_reorder_post_254 from "./api/forms/[id]/fields/reorder/POST";
import forms_id_fields_fieldId_delete_255 from "./api/forms/[id]/fields/[fieldId]/DELETE";
import forms_id_fields_fieldId_patch_256 from "./api/forms/[id]/fields/[fieldId]/PATCH";
import forms_id_fields_fieldId_thumbnail_post_257 from "./api/forms/[id]/fields/[fieldId]/thumbnail/POST";
import health_get_258 from "./api/health/GET";
import incidents_get_259 from "./api/incidents/GET";
import incidents_post_260 from "./api/incidents/POST";
import incidents_id_archive_post_261 from "./api/incidents/[id]/archive/POST";
import incidents_id_unarchive_post_262 from "./api/incidents/[id]/unarchive/POST";
import incidents_incidentId_get_263 from "./api/incidents/[incidentId]/GET";
import incidents_incidentId_put_264 from "./api/incidents/[incidentId]/PUT";
import incidents_incidentId_attachments_get_265 from "./api/incidents/[incidentId]/attachments/GET";
import incidents_incidentId_attachments_post_266 from "./api/incidents/[incidentId]/attachments/POST";
import incidents_incidentId_attachments_attachId_delete_267 from "./api/incidents/[incidentId]/attachments/[attachId]/DELETE";
import incidents_incidentId_close_post_268 from "./api/incidents/[incidentId]/close/POST";
import incidents_incidentId_corrective_actions_post_269 from "./api/incidents/[incidentId]/corrective-actions/POST";
import incidents_incidentId_corrective_actions_actionId_put_270 from "./api/incidents/[incidentId]/corrective-actions/[actionId]/PUT";
import incidents_incidentId_pdf_get_271 from "./api/incidents/[incidentId]/pdf/GET";
import incidents_incidentId_third_parties_post_272 from "./api/incidents/[incidentId]/third-parties/POST";
import incidents_incidentId_third_parties_thirdPartyId_delete_273 from "./api/incidents/[incidentId]/third-parties/[thirdPartyId]/DELETE";
import integrations_myob_auth_url_get_274 from "./api/integrations/myob/auth-url/GET";
import integrations_myob_callback_get_275 from "./api/integrations/myob/callback/GET";
import integrations_myob_disconnect_post_276 from "./api/integrations/myob/disconnect/POST";
import integrations_myob_status_get_277 from "./api/integrations/myob/status/GET";
import integrations_myob_sync_invoice_post_278 from "./api/integrations/myob/sync-invoice/POST";
import integrations_onedrive_auth_url_get_279 from "./api/integrations/onedrive/auth-url/GET";
import integrations_onedrive_callback_get_280 from "./api/integrations/onedrive/callback/GET";
import integrations_onedrive_disconnect_post_281 from "./api/integrations/onedrive/disconnect/POST";
import integrations_onedrive_status_get_282 from "./api/integrations/onedrive/status/GET";
import integrations_onedrive_upload_file_post_283 from "./api/integrations/onedrive/upload-file/POST";
import integrations_qbo_auth_url_get_284 from "./api/integrations/qbo/auth-url/GET";
import integrations_qbo_callback_get_285 from "./api/integrations/qbo/callback/GET";
import integrations_qbo_disconnect_post_286 from "./api/integrations/qbo/disconnect/POST";
import integrations_qbo_status_get_287 from "./api/integrations/qbo/status/GET";
import integrations_qbo_sync_invoice_post_288 from "./api/integrations/qbo/sync-invoice/POST";
import integrations_xero_auth_url_get_289 from "./api/integrations/xero/auth-url/GET";
import integrations_xero_callback_get_290 from "./api/integrations/xero/callback/GET";
import integrations_xero_disconnect_post_291 from "./api/integrations/xero/disconnect/POST";
import integrations_xero_status_get_292 from "./api/integrations/xero/status/GET";
import integrations_xero_sync_customer_post_293 from "./api/integrations/xero/sync-customer/POST";
import integrations_xero_sync_invoice_post_294 from "./api/integrations/xero/sync-invoice/POST";
import integrations_xero_webhook_post_295 from "./api/integrations/xero/webhook/POST";
import invoices_get_296 from "./api/invoices/GET";
import invoices_post_297 from "./api/invoices/POST";
import invoices_id_delete_298 from "./api/invoices/[id]/DELETE";
import invoices_id_get_299 from "./api/invoices/[id]/GET";
import invoices_id_put_300 from "./api/invoices/[id]/PUT";
import invoices_id_duplicate_post_301 from "./api/invoices/[id]/duplicate/POST";
import invoices_id_export_pdf_get_302 from "./api/invoices/[id]/export-pdf/GET";
import invoices_id_mark_sent_post_303 from "./api/invoices/[id]/mark-sent/POST";
import invoices_id_record_payment_post_304 from "./api/invoices/[id]/record-payment/POST";
import invoices_id_send_email_post_305 from "./api/invoices/[id]/send-email/POST";
import invoices_id_unlock_patch_306 from "./api/invoices/[id]/unlock/PATCH";
import invoices_id_void_post_307 from "./api/invoices/[id]/void/POST";
import job_cards_get_308 from "./api/job-cards/GET";
import job_cards_post_309 from "./api/job-cards/POST";
import job_cards_id_delete_310 from "./api/job-cards/[id]/DELETE";
import job_cards_id_get_311 from "./api/job-cards/[id]/GET";
import job_cards_id_put_312 from "./api/job-cards/[id]/PUT";
import job_cards_id_convert_post_313 from "./api/job-cards/[id]/convert/POST";
import job_cards_id_invoice_post_314 from "./api/job-cards/[id]/invoice/POST";
import job_cards_id_photos_post_315 from "./api/job-cards/[id]/photos/POST";
import job_cards_id_photos_photoId_delete_316 from "./api/job-cards/[id]/photos/[photoId]/DELETE";
import job_cards_id_photos_photoId_patch_317 from "./api/job-cards/[id]/photos/[photoId]/PATCH";
import job_cards_id_photos_photoId_download_get_318 from "./api/job-cards/[id]/photos/[photoId]/download/GET";
import job_cards_id_photos_photoId_save_and_lock_post_319 from "./api/job-cards/[id]/photos/[photoId]/save-and-lock/POST";
import job_costs_post_320 from "./api/job-costs/POST";
import job_forms_id_delete_321 from "./api/job-forms/[id]/DELETE";
import job_forms_id_get_322 from "./api/job-forms/[id]/GET";
import job_forms_id_put_323 from "./api/job-forms/[id]/PUT";
import job_forms_id_reset_post_324 from "./api/job-forms/[id]/reset/POST";
import job_forms_id_send_email_post_325 from "./api/job-forms/[id]/send-email/POST";
import job_forms_id_share_delete_326 from "./api/job-forms/[id]/share/DELETE";
import job_forms_id_share_get_327 from "./api/job-forms/[id]/share/GET";
import job_forms_id_share_post_328 from "./api/job-forms/[id]/share/POST";
import jobs_get_329 from "./api/jobs/GET";
import jobs_post_330 from "./api/jobs/POST";
import jobs_report_generate_post_331 from "./api/jobs/report/generate/POST";
import jobs_search_get_332 from "./api/jobs/search/GET";
import jobs_id_get_333 from "./api/jobs/[id]/GET";
import jobs_id_put_334 from "./api/jobs/[id]/PUT";
import jobs_id_attendance_attendanceId_close_post_335 from "./api/jobs/[id]/attendance/[attendanceId]/close/POST";
import jobs_id_costs_get_336 from "./api/jobs/[id]/costs/GET";
import jobs_id_costs_post_337 from "./api/jobs/[id]/costs/POST";
import jobs_id_costs_export_get_338 from "./api/jobs/[id]/costs/export/GET";
import jobs_id_costs_costId_delete_339 from "./api/jobs/[id]/costs/[costId]/DELETE";
import jobs_id_costs_costId_put_340 from "./api/jobs/[id]/costs/[costId]/PUT";
import jobs_id_costs_costId_receipt_get_341 from "./api/jobs/[id]/costs/[costId]/receipt/GET";
import jobs_id_costs_costId_receipt_post_342 from "./api/jobs/[id]/costs/[costId]/receipt/POST";
import jobs_id_delays_get_343 from "./api/jobs/[id]/delays/GET";
import jobs_id_delays_post_344 from "./api/jobs/[id]/delays/POST";
import jobs_id_delays_export_csv_get_345 from "./api/jobs/[id]/delays/export-csv/GET";
import jobs_id_delays_delayId_delete_346 from "./api/jobs/[id]/delays/[delayId]/DELETE";
import jobs_id_delays_delayId_put_347 from "./api/jobs/[id]/delays/[delayId]/PUT";
import jobs_id_documents_get_348 from "./api/jobs/[id]/documents/GET";
import jobs_id_documents_post_349 from "./api/jobs/[id]/documents/POST";
import jobs_id_export_zip_get_350 from "./api/jobs/[id]/export-zip/GET";
import jobs_id_field_docs_get_351 from "./api/jobs/[id]/field-docs/GET";
import jobs_id_files_get_352 from "./api/jobs/[id]/files/GET";
import jobs_id_forms_get_353 from "./api/jobs/[id]/forms/GET";
import jobs_id_forms_post_354 from "./api/jobs/[id]/forms/POST";
import jobs_id_forms_export_csv_get_355 from "./api/jobs/[id]/forms/export-csv/GET";
import jobs_id_forms_submissionId_delete_356 from "./api/jobs/[id]/forms/[submissionId]/DELETE";
import jobs_id_forms_submissionId_reopen_post_357 from "./api/jobs/[id]/forms/[submissionId]/reopen/POST";
import jobs_id_generate_qr_post_358 from "./api/jobs/[id]/generate-qr/POST";
import jobs_id_ledger_get_359 from "./api/jobs/[id]/ledger/GET";
import jobs_id_ledger_post_360 from "./api/jobs/[id]/ledger/POST";
import jobs_id_ledger_export_get_361 from "./api/jobs/[id]/ledger/export/GET";
import jobs_id_ledger_sync_post_362 from "./api/jobs/[id]/ledger/sync/POST";
import jobs_id_ledger_entryId_delete_363 from "./api/jobs/[id]/ledger/[entryId]/DELETE";
import jobs_id_ledger_entryId_put_364 from "./api/jobs/[id]/ledger/[entryId]/PUT";
import jobs_id_ledger_entryId_correct_post_365 from "./api/jobs/[id]/ledger/[entryId]/correct/POST";
import jobs_id_milestones_get_366 from "./api/jobs/[id]/milestones/GET";
import jobs_id_milestones_post_367 from "./api/jobs/[id]/milestones/POST";
import jobs_id_milestones_milestoneId_delete_368 from "./api/jobs/[id]/milestones/[milestoneId]/DELETE";
import jobs_id_milestones_milestoneId_patch_369 from "./api/jobs/[id]/milestones/[milestoneId]/PATCH";
import jobs_id_notes_export_csv_get_370 from "./api/jobs/[id]/notes/export-csv/GET";
import jobs_id_photos_get_371 from "./api/jobs/[id]/photos/GET";
import jobs_id_photos_post_372 from "./api/jobs/[id]/photos/POST";
import jobs_id_photos_export_zip_post_373 from "./api/jobs/[id]/photos/export-zip/POST";
import jobs_id_photos_picker_get_374 from "./api/jobs/[id]/photos/picker/GET";
import jobs_id_photos_share_post_375 from "./api/jobs/[id]/photos/share/POST";
import jobs_id_photos_photoId_delete_376 from "./api/jobs/[id]/photos/[photoId]/DELETE";
import jobs_id_photos_photoId_patch_377 from "./api/jobs/[id]/photos/[photoId]/PATCH";
import jobs_id_photos_photoId_download_get_378 from "./api/jobs/[id]/photos/[photoId]/download/GET";
import jobs_id_photos_photoId_lock_post_379 from "./api/jobs/[id]/photos/[photoId]/lock/POST";
import jobs_id_photos_photoId_replace_post_380 from "./api/jobs/[id]/photos/[photoId]/replace/POST";
import jobs_id_photos_photoId_report_image_get_381 from "./api/jobs/[id]/photos/[photoId]/report-image/GET";
import jobs_id_progress_get_382 from "./api/jobs/[id]/progress/GET";
import jobs_id_progress_put_383 from "./api/jobs/[id]/progress/PUT";
import jobs_id_progress_export_csv_get_384 from "./api/jobs/[id]/progress/export-csv/GET";
import jobs_id_progress_report_get_385 from "./api/jobs/[id]/progress/report/GET";
import jobs_id_progress_report_put_386 from "./api/jobs/[id]/progress/report/PUT";
import jobs_id_progress_report_pdf_get_387 from "./api/jobs/[id]/progress/report/pdf/GET";
import jobs_id_progress_sync_post_388 from "./api/jobs/[id]/progress/sync/POST";
import jobs_id_purchase_orders_get_389 from "./api/jobs/[id]/purchase-orders/GET";
import jobs_id_purchase_orders_post_390 from "./api/jobs/[id]/purchase-orders/POST";
import jobs_id_purchase_orders_poId_delete_391 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import jobs_id_purchase_orders_poId_get_392 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
import jobs_id_purchase_orders_poId_put_393 from "./api/jobs/[id]/purchase-orders/[poId]/PUT";
import jobs_id_purchase_orders_poId_pdf_get_394 from "./api/jobs/[id]/purchase-orders/[poId]/pdf/GET";
import jobs_id_report_pdf_post_395 from "./api/jobs/[id]/report/pdf/POST";
import jobs_id_risky_get_396 from "./api/jobs/[id]/risky/GET";
import jobs_id_risky_post_397 from "./api/jobs/[id]/risky/POST";
import jobs_id_risky_riskyId_get_398 from "./api/jobs/[id]/risky/[riskyId]/GET";
import jobs_id_risky_riskyId_put_399 from "./api/jobs/[id]/risky/[riskyId]/PUT";
import jobs_id_risky_riskyId_finalise_post_400 from "./api/jobs/[id]/risky/[riskyId]/finalise/POST";
import jobs_id_risky_riskyId_signatures_post_401 from "./api/jobs/[id]/risky/[riskyId]/signatures/POST";
import jobs_id_risky_riskyId_supervisor_signoff_post_402 from "./api/jobs/[id]/risky/[riskyId]/supervisor-signoff/POST";
import jobs_id_signin_post_403 from "./api/jobs/[id]/signin/POST";
import jobs_id_signin_qr_post_404 from "./api/jobs/[id]/signin-qr/POST";
import jobs_id_signin_status_get_405 from "./api/jobs/[id]/signin-status/GET";
import jobs_id_signout_post_406 from "./api/jobs/[id]/signout/POST";
import jobs_id_signout_qr_post_407 from "./api/jobs/[id]/signout-qr/POST";
import jobs_id_signout_user_post_408 from "./api/jobs/[id]/signout-user/POST";
import jobs_id_site_prestarts_get_409 from "./api/jobs/[id]/site-prestarts/GET";
import jobs_id_site_prestarts_post_410 from "./api/jobs/[id]/site-prestarts/POST";
import jobs_id_site_prestarts_prestartId_get_411 from "./api/jobs/[id]/site-prestarts/[prestartId]/GET";
import jobs_id_site_prestarts_prestartId_put_412 from "./api/jobs/[id]/site-prestarts/[prestartId]/PUT";
import jobs_id_site_prestarts_prestartId_finalise_post_413 from "./api/jobs/[id]/site-prestarts/[prestartId]/finalise/POST";
import jobs_id_site_prestarts_prestartId_workers_post_414 from "./api/jobs/[id]/site-prestarts/[prestartId]/workers/POST";
import jobs_id_swms_get_415 from "./api/jobs/[id]/swms/GET";
import jobs_id_swms_post_416 from "./api/jobs/[id]/swms/POST";
import jobs_id_swms_swmsId_signoff_post_417 from "./api/jobs/[id]/swms/[swmsId]/signoff/POST";
import jobs_id_todos_get_418 from "./api/jobs/[id]/todos/GET";
import jobs_id_todos_post_419 from "./api/jobs/[id]/todos/POST";
import jobs_id_todos_todoId_delete_420 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import jobs_id_todos_todoId_put_421 from "./api/jobs/[id]/todos/[todoId]/PUT";
import library_items_get_422 from "./api/library/items/GET";
import library_items_id_get_423 from "./api/library/items/[id]/GET";
import library_items_id_patch_424 from "./api/library/items/[id]/PATCH";
import library_items_id_download_get_425 from "./api/library/items/[id]/download/GET";
import library_items_id_install_delete_426 from "./api/library/items/[id]/install/DELETE";
import library_items_id_install_post_427 from "./api/library/items/[id]/install/POST";
import library_my_installed_get_428 from "./api/library/my-installed/GET";
import library_my_submissions_get_429 from "./api/library/my-submissions/GET";
import lists_get_430 from "./api/lists/GET";
import me_get_431 from "./api/me/GET";
import me_put_432 from "./api/me/PUT";
import me_2fa_disable_post_433 from "./api/me/2fa/disable/POST";
import me_2fa_enable_post_434 from "./api/me/2fa/enable/POST";
import me_2fa_setup_get_435 from "./api/me/2fa/setup/GET";
import me_2fa_sms_disable_post_436 from "./api/me/2fa/sms/disable/POST";
import me_2fa_sms_enable_post_437 from "./api/me/2fa/sms/enable/POST";
import me_2fa_sms_send_post_438 from "./api/me/2fa/sms/send/POST";
import me_2fa_sms_send_setup_post_439 from "./api/me/2fa/sms/send-setup/POST";
import me_2fa_sms_verify_post_440 from "./api/me/2fa/sms/verify/POST";
import me_2fa_status_get_441 from "./api/me/2fa/status/GET";
import me_2fa_verify_post_442 from "./api/me/2fa/verify/POST";
import me_active_status_get_443 from "./api/me/active-status/GET";
import me_change_password_post_444 from "./api/me/change-password/POST";
import me_email_status_get_445 from "./api/me/email-status/GET";
import me_phone_get_446 from "./api/me/phone/GET";
import me_phone_put_447 from "./api/me/phone/PUT";
import me_profile_attachments_delete_448 from "./api/me/profile-attachments/DELETE";
import me_profile_attachments_post_449 from "./api/me/profile-attachments/POST";
import me_profile_attachments_download_get_450 from "./api/me/profile-attachments/download/GET";
import me_profile_attachments_thumbnail_get_451 from "./api/me/profile-attachments/thumbnail/GET";
import me_profile_extras_get_452 from "./api/me/profile-extras/GET";
import me_profile_extras_put_453 from "./api/me/profile-extras/PUT";
import migrate_account_recovery_post_454 from "./api/migrate-account-recovery/POST";
import migrate_asset_manager_post_455 from "./api/migrate-asset-manager/POST";
import migrate_attendance_post_456 from "./api/migrate-attendance/POST";
import migrate_company_settings_post_457 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_458 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_459 from "./api/migrate-dazza-knowledge/POST";
import migrate_emergency_alerts_post_460 from "./api/migrate-emergency-alerts/POST";
import migrate_estimates_post_461 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_462 from "./api/migrate-estimating-library/POST";
import migrate_files_post_463 from "./api/migrate-files/POST";
import migrate_fleet_post_464 from "./api/migrate-fleet/POST";
import migrate_fleet_analytics_post_465 from "./api/migrate-fleet-analytics/POST";
import migrate_fleet_driver_sessions_post_466 from "./api/migrate-fleet-driver-sessions/POST";
import migrate_fleet_usage_post_467 from "./api/migrate-fleet-usage/POST";
import migrate_form_fields_post_468 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_469 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_470 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_471 from "./api/migrate-job-forms/POST";
import migrate_job_photo_shares_post_472 from "./api/migrate-job-photo-shares/POST";
import migrate_job_photos_post_473 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_474 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_475 from "./api/migrate-jobs/POST";
import migrate_ledger_photo_post_476 from "./api/migrate-ledger-photo/POST";
import migrate_library_post_477 from "./api/migrate-library/POST";
import migrate_library_downloads_post_478 from "./api/migrate-library-downloads/POST";
import migrate_notifications_post_479 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_480 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_481 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_482 from "./api/migrate-pdf-settings/POST";
import migrate_plan_manager_post_483 from "./api/migrate-plan-manager/POST";
import migrate_plan_manager_v2_post_484 from "./api/migrate-plan-manager-v2/POST";
import migrate_plan_manager_v3_post_485 from "./api/migrate-plan-manager-v3/POST";
import migrate_safety_post_486 from "./api/migrate-safety/POST";
import migrate_site_prestart_post_487 from "./api/migrate-site-prestart/POST";
import migrate_sms_verified_at_post_488 from "./api/migrate-sms-verified-at/POST";
import migrate_starter_pack_post_489 from "./api/migrate-starter-pack/POST";
import migrate_studio_pdf_post_490 from "./api/migrate-studio-pdf/POST";
import migrate_subscriptions_post_491 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_492 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_493 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_494 from "./api/migrate-team/POST";
import notes_get_495 from "./api/notes/GET";
import notes_post_496 from "./api/notes/POST";
import notes_comments_post_497 from "./api/notes/comments/POST";
import notes_migrate_post_498 from "./api/notes/migrate/POST";
import notes_id_delete_499 from "./api/notes/[id]/DELETE";
import notifications_alerts_get_500 from "./api/notifications/alerts/GET";
import notifications_prefs_get_501 from "./api/notifications/prefs/GET";
import notifications_prefs_put_502 from "./api/notifications/prefs/PUT";
import notifications_read_post_503 from "./api/notifications/read/POST";
import owner_console_activity_get_504 from "./api/owner-console/activity/GET";
import owner_console_cancellation_feedback_get_505 from "./api/owner-console/cancellation-feedback/GET";
import owner_console_companies_get_506 from "./api/owner-console/companies/GET";
import owner_console_companies_post_507 from "./api/owner-console/companies/POST";
import owner_console_companies_usage_get_508 from "./api/owner-console/companies/usage/GET";
import owner_console_companies_id_limits_put_509 from "./api/owner-console/companies/[id]/limits/PUT";
import owner_console_form_templates_get_510 from "./api/owner-console/form-templates/GET";
import owner_console_form_templates_post_511 from "./api/owner-console/form-templates/POST";
import owner_console_library_items_get_512 from "./api/owner-console/library/items/GET";
import owner_console_library_items_post_513 from "./api/owner-console/library/items/POST";
import owner_console_library_items_id_delete_514 from "./api/owner-console/library/items/[id]/DELETE";
import owner_console_library_items_id_patch_515 from "./api/owner-console/library/items/[id]/PATCH";
import owner_console_library_items_id_put_516 from "./api/owner-console/library/items/[id]/PUT";
import owner_console_library_items_id_push_update_post_517 from "./api/owner-console/library/items/[id]/push-update/POST";
import owner_console_library_submissions_get_518 from "./api/owner-console/library/submissions/GET";
import owner_console_library_submissions_id_review_post_519 from "./api/owner-console/library/submissions/[id]/review/POST";
import owner_console_starter_pack_get_520 from "./api/owner-console/starter-pack/GET";
import owner_console_starter_pack_post_521 from "./api/owner-console/starter-pack/POST";
import owner_console_stats_get_522 from "./api/owner-console/stats/GET";
import owner_console_storage_get_523 from "./api/owner-console/storage/GET";
import owner_console_swms_masters_get_524 from "./api/owner-console/swms/masters/GET";
import owner_console_swms_masters_post_525 from "./api/owner-console/swms/masters/POST";
import owner_console_swms_masters_publish_all_post_526 from "./api/owner-console/swms/masters/publish-all/POST";
import owner_console_swms_masters_id_delete_527 from "./api/owner-console/swms/masters/[id]/DELETE";
import owner_console_swms_masters_id_get_528 from "./api/owner-console/swms/masters/[id]/GET";
import owner_console_swms_masters_id_put_529 from "./api/owner-console/swms/masters/[id]/PUT";
import owner_console_swms_masters_id_publish_post_530 from "./api/owner-console/swms/masters/[id]/publish/POST";
import owner_console_swms_migrate_master_library_post_531 from "./api/owner-console/swms/migrate-master-library/POST";
import owner_console_swms_push_post_532 from "./api/owner-console/swms/push/POST";
import owner_console_swms_seed_bricklaying_post_533 from "./api/owner-console/swms/seed-bricklaying/POST";
import owner_console_swms_seed_building_inspection_post_534 from "./api/owner-console/swms/seed-building-inspection/POST";
import owner_console_swms_seed_cabinets_post_535 from "./api/owner-console/swms/seed-cabinets/POST";
import owner_console_swms_seed_carpenter_fixing_post_536 from "./api/owner-console/swms/seed-carpenter-fixing/POST";
import owner_console_swms_seed_carpenter_framing_post_537 from "./api/owner-console/swms/seed-carpenter-framing/POST";
import owner_console_swms_seed_carpenter_lockup_post_538 from "./api/owner-console/swms/seed-carpenter-lockup/POST";
import owner_console_swms_seed_ceramic_tiling_post_539 from "./api/owner-console/swms/seed-ceramic-tiling/POST";
import owner_console_swms_seed_concreting_slab_post_540 from "./api/owner-console/swms/seed-concreting-slab/POST";
import owner_console_swms_seed_delivery_loading_post_541 from "./api/owner-console/swms/seed-delivery-loading/POST";
import owner_console_swms_seed_environmental_spill_post_542 from "./api/owner-console/swms/seed-environmental-spill/POST";
import owner_console_swms_seed_ewp_post_543 from "./api/owner-console/swms/seed-ewp/POST";
import owner_console_swms_seed_excavations_substation_post_544 from "./api/owner-console/swms/seed-excavations-substation/POST";
import owner_console_swms_seed_fencing_post_545 from "./api/owner-console/swms/seed-fencing/POST";
import owner_console_swms_seed_heat_stress_post_546 from "./api/owner-console/swms/seed-heat-stress/POST";
import owner_console_swms_seed_landscaping_post_547 from "./api/owner-console/swms/seed-landscaping/POST";
import owner_console_swms_seed_live_parts_post_548 from "./api/owner-console/swms/seed-live-parts/POST";
import owner_console_swms_seed_manual_handling_post_549 from "./api/owner-console/swms/seed-manual-handling/POST";
import owner_console_swms_seed_moving_plant_post_550 from "./api/owner-console/swms/seed-moving-plant/POST";
import owner_console_swms_seed_painting_post_551 from "./api/owner-console/swms/seed-painting/POST";
import owner_console_swms_seed_power_tools_post_552 from "./api/owner-console/swms/seed-power-tools/POST";
import owner_console_swms_seed_silica_dust_post_553 from "./api/owner-console/swms/seed-silica-dust/POST";
import owner_console_swms_seed_traffic_management_post_554 from "./api/owner-console/swms/seed-traffic-management/POST";
import owner_console_swms_seed_underground_services_post_555 from "./api/owner-console/swms/seed-underground-services/POST";
import owner_console_swms_seed_vacuum_excavation_post_556 from "./api/owner-console/swms/seed-vacuum-excavation/POST";
import owner_console_system_ai_builtin_checks_post_557 from "./api/owner-console/system-ai/builtin-checks/POST";
import owner_console_users_get_558 from "./api/owner-console/users/GET";
import owner_console_users_verify_post_559 from "./api/owner-console/users/verify/POST";
import plan_manager_drawings_get_560 from "./api/plan-manager/drawings/GET";
import plan_manager_drawings_post_561 from "./api/plan-manager/drawings/POST";
import plan_manager_drawings_id_get_562 from "./api/plan-manager/drawings/[id]/GET";
import plan_manager_drawings_id_annotations_put_563 from "./api/plan-manager/drawings/[id]/annotations/PUT";
import plan_manager_drawings_id_archive_post_564 from "./api/plan-manager/drawings/[id]/archive/POST";
import plan_manager_drawings_id_job_links_delete_565 from "./api/plan-manager/drawings/[id]/job-links/DELETE";
import plan_manager_drawings_id_job_links_post_566 from "./api/plan-manager/drawings/[id]/job-links/POST";
import plan_manager_drawings_id_pages_pageNo_annotations_get_567 from "./api/plan-manager/drawings/[id]/pages/[pageNo]/annotations/GET";
import plan_manager_drawings_id_permanent_delete_568 from "./api/plan-manager/drawings/[id]/permanent/DELETE";
import plan_manager_drawings_id_reorder_patch_569 from "./api/plan-manager/drawings/[id]/reorder/PATCH";
import plan_manager_drawings_id_restore_post_570 from "./api/plan-manager/drawings/[id]/restore/POST";
import plan_manager_drawings_id_revisions_post_571 from "./api/plan-manager/drawings/[id]/revisions/POST";
import plan_manager_drawings_id_revisions_revisionId_finalize_post_572 from "./api/plan-manager/drawings/[id]/revisions/[revisionId]/finalize/POST";
import plan_manager_drawings_id_upload_post_573 from "./api/plan-manager/drawings/[id]/upload/POST";
import plan_manager_jobs_jobId_drawings_zip_get_574 from "./api/plan-manager/jobs/[jobId]/drawings-zip/GET";
import plan_manager_jobs_with_drawings_get_575 from "./api/plan-manager/jobs-with-drawings/GET";
import plan_manager_share_post_576 from "./api/plan-manager/share/POST";
import plan_manager_share_validate_get_577 from "./api/plan-manager/share/validate/GET";
import portal_estimates_id_approve_post_578 from "./api/portal/estimates/[id]/approve/POST";
import portal_invite_post_579 from "./api/portal/invite/POST";
import portal_invoices_id_pay_post_580 from "./api/portal/invoices/[id]/pay/POST";
import portal_jobs_get_581 from "./api/portal/jobs/GET";
import portal_jobs_id_get_582 from "./api/portal/jobs/[id]/GET";
import portal_migrate_post_583 from "./api/portal/migrate/POST";
import portal_validate_post_584 from "./api/portal/validate/POST";
import public_form_token_get_585 from "./api/public/form/[token]/GET";
import public_form_token_submit_post_586 from "./api/public/form/[token]/submit/POST";
import public_job_photos_token_get_587 from "./api/public/job-photos/[token]/GET";
import public_job_photos_token_photo_photoId_get_588 from "./api/public/job-photos/[token]/photo/[photoId]/GET";
import public_swms_token_get_589 from "./api/public/swms/[token]/GET";
import public_swms_token_signoff_post_590 from "./api/public/swms/[token]/signoff/POST";
import push_subscribe_delete_591 from "./api/push/subscribe/DELETE";
import push_subscribe_post_592 from "./api/push/subscribe/POST";
import push_vapid_key_get_593 from "./api/push/vapid-key/GET";
import quick_links_site_meta_get_594 from "./api/quick-links/site-meta/GET";
import recipes_get_595 from "./api/recipes/GET";
import recipes_post_596 from "./api/recipes/POST";
import recipes_id_delete_597 from "./api/recipes/[id]/DELETE";
import recipes_id_put_598 from "./api/recipes/[id]/PUT";
import risk_register_get_599 from "./api/risk-register/GET";
import risk_register_post_600 from "./api/risk-register/POST";
import risk_register_id_get_601 from "./api/risk-register/[id]/GET";
import risk_register_id_put_602 from "./api/risk-register/[id]/PUT";
import risk_register_id_archive_post_603 from "./api/risk-register/[id]/archive/POST";
import risk_register_id_unarchive_post_604 from "./api/risk-register/[id]/unarchive/POST";
import safety_ai_draft_post_605 from "./api/safety/ai/draft/POST";
import safety_documents_get_606 from "./api/safety/documents/GET";
import safety_documents_post_607 from "./api/safety/documents/POST";
import safety_documents_id_delete_608 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_609 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_610 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_611 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_612 from "./api/safety/generated-posters/[id]/DELETE";
import safety_job_safety_plans_get_613 from "./api/safety/job-safety-plans/GET";
import safety_job_safety_plans_post_614 from "./api/safety/job-safety-plans/POST";
import safety_job_safety_plans_id_delete_615 from "./api/safety/job-safety-plans/[id]/DELETE";
import safety_job_safety_plans_id_put_616 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_617 from "./api/safety/job-swms/GET";
import safety_job_swms_post_618 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_619 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_620 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_621 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_share_token_post_622 from "./api/safety/job-swms/[id]/share-token/POST";
import safety_job_swms_id_signoffs_get_623 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_624 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_625 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_626 from "./api/safety/plans/GET";
import safety_plans_post_627 from "./api/safety/plans/POST";
import safety_plans_seed_post_628 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_629 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_630 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_631 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_632 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_633 from "./api/safety/posters/GET";
import safety_posters_post_634 from "./api/safety/posters/POST";
import safety_posters_id_delete_635 from "./api/safety/posters/[id]/DELETE";
import safety_posters_id_download_get_636 from "./api/safety/posters/[id]/download/GET";
import safety_swms_get_637 from "./api/safety/swms/GET";
import safety_swms_post_638 from "./api/safety/swms/POST";
import safety_swms_import_docx_post_639 from "./api/safety/swms/import-docx/POST";
import safety_swms_seed_post_640 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_641 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_642 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_643 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_644 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_645 from "./api/safety/swms/[id]/export/GET";
import safety_swms_id_publish_to_library_post_646 from "./api/safety/swms/[id]/publish-to-library/POST";
import scheduler_crew_get_647 from "./api/scheduler/crew/GET";
import scheduler_jobs_get_648 from "./api/scheduler/jobs/GET";
import scheduler_jobs_id_reschedule_patch_649 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
import scheduler_tasks_get_650 from "./api/scheduler/tasks/GET";
import secure_share_get_651 from "./api/secure-share/GET";
import secure_share_post_652 from "./api/secure-share/POST";
import secure_share_id_delete_653 from "./api/secure-share/[id]/DELETE";
import secure_share_token_get_654 from "./api/secure-share/[token]/GET";
import secure_share_token_post_655 from "./api/secure-share/[token]/POST";
import settings_backup_get_656 from "./api/settings/backup/GET";
import settings_backup_post_657 from "./api/settings/backup/POST";
import settings_backup_company_data_get_658 from "./api/settings/backup/company-data/GET";
import settings_backup_csv_pack_get_659 from "./api/settings/backup/csv-pack/GET";
import settings_backup_export_get_660 from "./api/settings/backup/export/GET";
import settings_backup_run_post_661 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_662 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_663 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_664 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_665 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_666 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_667 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_668 from "./api/settings/retention/GET";
import settings_retention_post_669 from "./api/settings/retention/POST";
import settings_storage_provider_get_670 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_671 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_672 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_673 from "./api/settings/terminology/GET";
import settings_terminology_post_674 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_675 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_676 from "./api/settings/xero-credentials/POST";
import share_token_get_677 from "./api/share/[token]/GET";
import signin_history_get_678 from "./api/signin-history/GET";
import signup_post_679 from "./api/signup/POST";
import sos_get_680 from "./api/sos/GET";
import sos_acknowledge_post_681 from "./api/sos/acknowledge/POST";
import sos_trigger_post_682 from "./api/sos/trigger/POST";
import stakeholders_sms_post_683 from "./api/stakeholders/sms/POST";
import stripe_create_checkout_session_post_684 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_685 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_686 from "./api/subscription/create-checkout/POST";
import subscription_status_get_687 from "./api/subscription/status/GET";
import subscription_webhook_post_688 from "./api/subscription/webhook/POST";
import support_mode_audit_get_689 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_690 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_691 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_692 from "./api/support-mode/enter/POST";
import support_mode_exit_post_693 from "./api/support-mode/exit/POST";
import support_mode_status_get_694 from "./api/support-mode/status/GET";
import tag_tasks_get_695 from "./api/tag-tasks/GET";
import tag_tasks_id_patch_696 from "./api/tag-tasks/[id]/PATCH";
import takeoff_pad_get_697 from "./api/takeoff-pad/GET";
import takeoff_pad_put_698 from "./api/takeoff-pad/PUT";
import tasks_post_699 from "./api/tasks/POST";
import tasks_id_put_700 from "./api/tasks/[id]/PUT";
import team_get_701 from "./api/team/GET";
import team_invite_post_702 from "./api/team/invite/POST";
import team_invites_get_703 from "./api/team/invites/GET";
import team_invites_post_704 from "./api/team/invites/POST";
import team_invites_id_cancel_post_705 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_706 from "./api/team/invites/[id]/resend/POST";
import team_members_get_707 from "./api/team/members/GET";
import team_members_id_icon_permissions_get_708 from "./api/team/members/[id]/icon-permissions/GET";
import team_members_id_icon_permissions_put_709 from "./api/team/members/[id]/icon-permissions/PUT";
import team_resend_verification_post_710 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_711 from "./api/team/schedule/migrate/POST";
import team_shifts_get_712 from "./api/team/shifts/GET";
import team_shifts_post_713 from "./api/team/shifts/POST";
import team_shifts_id_delete_714 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_715 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_716 from "./api/team/time-entries/GET";
import team_time_entries_post_717 from "./api/team/time-entries/POST";
import team_time_entries_export_get_718 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_719 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_720 from "./api/team/verify-user/POST";
import team_id_delete_721 from "./api/team/[id]/DELETE";
import team_id_put_722 from "./api/team/[id]/PUT";
import usage_get_723 from "./api/usage/GET";
import user_logs_get_724 from "./api/user-logs/GET";
import user_logs_users_get_725 from "./api/user-logs/users/GET";
// </api-imports>
// ── Job Cards ─────────────────────────────────────────────────────────────────
...
app.get("/api/company-settings", company_settings_get_87);
app.put("/api/company-settings", company_settings_put_88);
app.get("/api/config/maps-key", config_maps_key_get_89);
app.post("/api/contact", contact_post_90);
app.get("/api/cost-guide", cost_guide_get_91);
app.post("/api/cost-guide", cost_guide_post_92);
app.get("/api/cost-guide/export-csv", cost_guide_export_csv_get_93);
app.post("/api/cost-guide/import-csv", cost_guide_import_csv_post_94);
app.delete("/api/cost-guide/:id", cost_guide_id_delete_95);
app.put("/api/cost-guide/:id", cost_guide_id_put_96);
app.get("/api/customers", customers_get_97);
app.post("/api/customers", customers_post_98);
app.delete("/api/customers/:id", customers_id_delete_99);
app.get("/api/customers/:id", customers_id_get_100);
app.put("/api/customers/:id", customers_id_put_101);
app.get("/api/dashboard/kpi", dashboard_kpi_get_102);
app.get("/api/dashboard/setup-check", dashboard_setup_check_get_103);
app.get("/api/dashboard/todos", dashboard_todos_get_104);
app.post("/api/dazza/annette", dazza_annette_post_105);
...
app.get("/api/dazza/context", dazza_context_get_112);
app.get("/api/dazza/key-status", dazza_key_status_get_113);
app.get("/api/dazza/knowledge", dazza_knowledge_get_114);
app.post("/api/dazza/knowledge", dazza_knowledge_post_115);
app.delete("/api/dazza/knowledge/:id", dazza_knowledge_id_delete_116);
app.put("/api/dazza/knowledge/:id", dazza_knowledge_id_put_117);
app.get("/api/developer/activity-log", developer_activity_log_get_118);
app.get("/api/developer/audit-log", developer_audit_log_get_119);
app.post("/api/developer/companies/:id/archive", developer_companies_id_archive_post_120);
app.get("/api/developer/company-health", developer_company_health_get_121);
app.get("/api/developer/email-log", developer_email_log_get_122);
app.get("/api/developer/email-settings", developer_email_settings_get_123);
app.put("/api/developer/email-settings", developer_email_settings_put_124);
app.post("/api/developer/email-settings/test", developer_email_settings_test_post_125);
...
// REMOVED: app.post("/api/developer/swms-cleanup") — hardcoded company data, deleted (audit fix)
...
app.post("/api/developer/users/:id/force-temp-password", developer_users_id_force_temp_password_post_136);
app.delete("/api/developer/users/:id/impersonate", developer_users_id_impersonate_delete_137);
app.post("/api/developer/users/:id/impersonate", developer_users_id_impersonate_post_138);
app.post("/api/developer/users/:id/reactivate", developer_users_id_reactivate_post_139);
app.post("/api/developer/users/:id/resend-verification", developer_users_id_resend_verification_post_140);
app.put("/api/developer/users/:id/role", developer_users_id_role_put_141);
app.post("/api/developer/users/:id/send-reset-email", developer_users_id_send_reset_email_post_142);
...
// REMOVED: app.get("/api/diag/route-check") — leaked route structure, deleted (audit fix)
// REMOVED: app.post("/api/diag/run-recovery") — no-auth route deleted (audit fix)
...
app.get("/api/document-templates/:id", document_templates_id_get_154);
app.put("/api/document-templates/:id", document_templates_id_put_155);
app.post("/api/document-templates/:id/duplicate", document_templates_id_duplicate_post_156);
app.get("/api/document-templates/:id/export/docx", document_templates_id_export_docx_get_157);
app.get("/api/document-templates/:id/export/pdf", document_templates_id_export_pdf_get_158);
app.post("/api/document-templates/:id/import-blocks", document_templates_id_import_blocks_post_159);
app.post("/api/document-templates/:id/import-docx", document_templates_id_import_docx_post_160);
app.post("/api/document-templates/:id/import-pdf", document_templates_id_import_pdf_post_161);
app.post("/api/document-templates/:id/publish-to-library", document_templates_id_publish_to_library_post_162);
app.get("/api/documents", documents_get_163);
app.get("/api/documents/share/:token", documents_share_token_get_164);
app.post("/api/documents/share/:token", documents_share_token_post_165);
app.get("/api/documents/:id", documents_id_get_166);
app.put("/api/documents/:id", documents_id_put_167);
app.get("/api/documents/:id/events", documents_id_events_get_168);
app.delete("/api/documents/:id/share", documents_id_share_delete_169);
app.post("/api/documents/:id/share", documents_id_share_post_170);
app.get("/api/drawings", drawings_get_171);
app.post("/api/drawings", drawings_post_172);
app.post("/api/drawings/upload", drawings_upload_post_173);
app.delete("/api/drawings/:id", drawings_id_delete_174);
app.patch("/api/drawings/:id", drawings_id_patch_175);
app.post("/api/drawings/:id/markup", drawings_id_markup_post_176);
app.get("/api/emergency-alerts", emergency_alerts_get_177);
app.post("/api/emergency-alerts", emergency_alerts_post_178);
app.put("/api/emergency-alerts/:id", emergency_alerts_id_put_179);
app.get("/api/estimates", estimates_get_180);
app.post("/api/estimates", estimates_post_181);
app.delete("/api/estimates/:id", estimates_id_delete_182);
app.get("/api/estimates/:id", estimates_id_get_183);
app.put("/api/estimates/:id", estimates_id_put_184);
app.post("/api/estimates/:id/convert-to-invoice", estimates_id_convert_to_invoice_post_185);
app.get("/api/estimates/:id/export-csv", estimates_id_export_csv_get_186);
app.get("/api/estimates/:id/export-pdf", estimates_id_export_pdf_get_187);
app.post("/api/estimates/:id/import-csv", estimates_id_import_csv_post_188);
app.post("/api/estimates/:id/unlock", estimates_id_unlock_post_189);
app.get("/api/external/form/:token", external_form_token_get_190);
app.post("/api/external/form/:token", external_form_token_post_191);
app.get("/api/files", files_get_192);
app.post("/api/files", files_post_193);
app.delete("/api/files/:id", files_id_delete_194);
app.get("/api/files/:id/download", files_id_download_get_195);
app.get("/api/fleet", fleet_get_196);
app.post("/api/fleet", fleet_post_197);
app.get("/api/fleet/analytics-settings", fleet_analytics_settings_get_198);
app.put("/api/fleet/analytics-settings", fleet_analytics_settings_put_199);
app.get("/api/fleet/asset-bookings", fleet_asset_bookings_get_200);
app.post("/api/fleet/asset-bookings", fleet_asset_bookings_post_201);
app.delete("/api/fleet/asset-bookings/:id", fleet_asset_bookings_id_delete_202);
app.patch("/api/fleet/asset-bookings/:id", fleet_asset_bookings_id_patch_203);
app.post("/api/fleet/driver-sessions", fleet_driver_sessions_post_204);
app.get("/api/fleet/driver-sessions/active", fleet_driver_sessions_active_get_205);
app.get("/api/fleet/driver-sessions/live", fleet_driver_sessions_live_get_206);
app.post("/api/fleet/driver-sessions/migrate-gps-status", fleet_driver_sessions_migrate_gps_status_post_207);
app.post("/api/fleet/driver-sessions/:id/heartbeat", fleet_driver_sessions_id_heartbeat_post_208);
app.post("/api/fleet/driver-sessions/:id/stop", fleet_driver_sessions_id_stop_post_209);
app.get("/api/fleet/driver-sessions/:id/summary", fleet_driver_sessions_id_summary_get_210);
app.post("/api/fleet/driver-sessions/:id/telemetry", fleet_driver_sessions_id_telemetry_post_211);
app.get("/api/fleet/driver-sessions/:id/telemetry/latest", fleet_driver_sessions_id_telemetry_latest_get_212);
app.get("/api/fleet/flags", fleet_flags_get_213);
app.get("/api/fleet/last-known-positions", fleet_last_known_positions_get_214);
app.delete("/api/fleet/service-logs/:logId", fleet_service_logs_logId_delete_215);
app.patch("/api/fleet/service-logs/:logId", fleet_service_logs_logId_patch_216);
app.get("/api/fleet/vehicles", fleet_vehicles_get_217);
app.delete("/api/fleet/:id", fleet_id_delete_218);
app.get("/api/fleet/:id", fleet_id_get_219);
app.put("/api/fleet/:id", fleet_id_put_220);
app.get("/api/fleet/:id/driver-sessions", fleet_id_driver_sessions_get_221);
app.post("/api/fleet/:id/driver-sessions/manual", fleet_id_driver_sessions_manual_post_222);
app.get("/api/fleet/:id/files", fleet_id_files_get_223);
app.get("/api/fleet/:id/prestarts", fleet_id_prestarts_get_224);
app.post("/api/fleet/:id/prestarts", fleet_id_prestarts_post_225);
app.get("/api/fleet/:id/service-logs", fleet_id_service_logs_get_226);
app.post("/api/fleet/:id/service-logs", fleet_id_service_logs_post_227);
app.post("/api/fleet/:id/signin", fleet_id_signin_post_228);
app.post("/api/fleet/:id/signout", fleet_id_signout_post_229);
app.get("/api/fleet/:id/usage-export", fleet_id_usage_export_get_230);
app.get("/api/fleet/:id/usage-status", fleet_id_usage_status_get_231);
app.get("/api/fleet/:id/usage-summary", fleet_id_usage_summary_get_232);
app.post("/api/form-attachments", form_attachments_post_233);
app.get("/api/form-global-lists", form_global_lists_get_234);
app.post("/api/form-global-lists", form_global_lists_post_235);
app.delete("/api/form-global-lists/:id", form_global_lists_id_delete_236);
app.put("/api/form-global-lists/:id", form_global_lists_id_put_237);
app.get("/api/form-templates", form_templates_get_238);
app.post("/api/form-templates", form_templates_post_239);
app.post("/api/form-templates/seed", form_templates_seed_post_240);
app.delete("/api/form-templates/:id", form_templates_id_delete_241);
app.put("/api/form-templates/:id", form_templates_id_put_242);
app.post("/api/form-templates/:id/publish-to-library", form_templates_id_publish_to_library_post_243);
app.get("/api/forms/assets-list", forms_assets_list_get_244);
app.get("/api/forms/jobs-list", forms_jobs_list_get_245);
app.post("/api/forms/migrate-skip-logic", forms_migrate_skip_logic_post_246);
app.get("/api/forms/skip-audit", forms_skip_audit_get_247);
app.post("/api/forms/skip-audit", forms_skip_audit_post_248);
app.post("/api/forms/start", forms_start_post_249);
app.get("/api/forms/submissions", forms_submissions_get_250);
app.post("/api/forms/templates/:id/share-link", forms_templates_id_share_link_post_251);
app.get("/api/forms/:id/fields", forms_id_fields_get_252);
app.post("/api/forms/:id/fields", forms_id_fields_post_253);
app.post("/api/forms/:id/fields/reorder", forms_id_fields_reorder_post_254);
app.delete("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_delete_255);
app.patch("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_patch_256);
app.post("/api/forms/:id/fields/:fieldId/thumbnail", forms_id_fields_fieldId_thumbnail_post_257);
app.get("/api/health", health_get_258);
app.get("/api/incidents", incidents_get_259);
app.post("/api/incidents", incidents_post_260);
app.post("/api/incidents/:id/archive", incidents_id_archive_post_261);
app.post("/api/incidents/:id/unarchive", incidents_id_unarchive_post_262);
app.get("/api/incidents/:incidentId", incidents_incidentId_get_263);
app.put("/api/incidents/:incidentId", incidents_incidentId_put_264);
app.get("/api/incidents/:incidentId/attachments", incidents_incidentId_attachments_get_265);
app.post("/api/incidents/:incidentId/attachments", incidents_incidentId_attachments_post_266);
app.delete("/api/incidents/:incidentId/attachments/:attachId", incidents_incidentId_attachments_attachId_delete_267);
app.post("/api/incidents/:incidentId/close", incidents_incidentId_close_post_268);
app.post("/api/incidents/:incidentId/corrective-actions", incidents_incidentId_corrective_actions_post_269);
app.put("/api/incidents/:incidentId/corrective-actions/:actionId", incidents_incidentId_corrective_actions_actionId_put_270);
app.get("/api/incidents/:incidentId/pdf", incidents_incidentId_pdf_get_271);
app.post("/api/incidents/:incidentId/third-parties", incidents_incidentId_third_parties_post_272);
app.delete("/api/incidents/:incidentId/third-parties/:thirdPartyId", incidents_incidentId_third_parties_thirdPartyId_delete_273);
app.get("/api/integrations/myob/auth-url", integrations_myob_auth_url_get_274);
app.get("/api/integrations/myob/callback", integrations_myob_callback_get_275);
app.post("/api/integrations/myob/disconnect", integrations_myob_disconnect_post_276);
app.get("/api/integrations/myob/status", integrations_myob_status_get_277);
app.post("/api/integrations/myob/sync-invoice", integrations_myob_sync_invoice_post_278);
app.get("/api/integrations/onedrive/auth-url", integrations_onedrive_auth_url_get_279);
app.get("/api/integrations/onedrive/callback", integrations_onedrive_callback_get_280);
app.post("/api/integrations/onedrive/disconnect", integrations_onedrive_disconnect_post_281);
app.get("/api/integrations/onedrive/status", integrations_onedrive_status_get_282);
app.post("/api/integrations/onedrive/upload-file", integrations_onedrive_upload_file_post_283);
app.get("/api/integrations/qbo/auth-url", integrations_qbo_auth_url_get_284);
app.get("/api/integrations/qbo/callback", integrations_qbo_callback_get_285);
app.post("/api/integrations/qbo/disconnect", integrations_qbo_disconnect_post_286);
app.get("/api/integrations/qbo/status", integrations_qbo_status_get_287);
app.post("/api/integrations/qbo/sync-invoice", integrations_qbo_sync_invoice_post_288);
app.get("/api/integrations/xero/auth-url", integrations_xero_auth_url_get_289);
app.get("/api/integrations/xero/callback", integrations_xero_callback_get_290);
app.post("/api/integrations/xero/disconnect", integrations_xero_disconnect_post_291);
app.get("/api/integrations/xero/status", integrations_xero_status_get_292);
app.post("/api/integrations/xero/sync-customer", integrations_xero_sync_customer_post_293);
app.post("/api/integrations/xero/sync-invoice", integrations_xero_sync_invoice_post_294);
app.post("/api/integrations/xero/webhook", integrations_xero_webhook_post_295);
app.get("/api/invoices", invoices_get_296);
app.post("/api/invoices", invoices_post_297);
app.delete("/api/invoices/:id", invoices_id_delete_298);
app.get("/api/invoices/:id", invoices_id_get_299);
app.put("/api/invoices/:id", invoices_id_put_300);
app.post("/api/invoices/:id/duplicate", invoices_id_duplicate_post_301);
app.get("/api/invoices/:id/export-pdf", invoices_id_export_pdf_get_302);
app.post("/api/invoices/:id/mark-sent", invoices_id_mark_sent_post_303);
app.post("/api/invoices/:id/record-payment", invoices_id_record_payment_post_304);
app.post("/api/invoices/:id/send-email", invoices_id_send_email_post_305);
app.patch("/api/invoices/:id/unlock", invoices_id_unlock_patch_306);
app.post("/api/invoices/:id/void", invoices_id_void_post_307);
app.get("/api/job-cards", job_cards_get_308);
app.post("/api/job-cards", job_cards_post_309);
app.delete("/api/job-cards/:id", job_cards_id_delete_310);
app.get("/api/job-cards/:id", job_cards_id_get_311);
app.put("/api/job-cards/:id", job_cards_id_put_312);
app.post("/api/job-cards/:id/convert", job_cards_id_convert_post_313);
app.post("/api/job-cards/:id/invoice", job_cards_id_invoice_post_314);
app.post("/api/job-cards/:id/photos", job_cards_id_photos_post_315);
app.delete("/api/job-cards/:id/photos/:photoId", job_cards_id_photos_photoId_delete_316);
app.patch("/api/job-cards/:id/photos/:photoId", job_cards_id_photos_photoId_patch_317);
app.get("/api/job-cards/:id/photos/:photoId/download", job_cards_id_photos_photoId_download_get_318);
app.post("/api/job-cards/:id/photos/:photoId/save-and-lock", job_cards_id_photos_photoId_save_and_lock_post_319);
app.post("/api/job-costs", job_costs_post_320);
app.delete("/api/job-forms/:id", job_forms_id_delete_321);
app.get("/api/job-forms/:id", job_forms_id_get_322);
app.put("/api/job-forms/:id", job_forms_id_put_323);
app.post("/api/job-forms/:id/reset", job_forms_id_reset_post_324);
app.post("/api/job-forms/:id/send-email", job_forms_id_send_email_post_325);
app.delete("/api/job-forms/:id/share", job_forms_id_share_delete_326);
app.get("/api/job-forms/:id/share", job_forms_id_share_get_327);
app.post("/api/job-forms/:id/share", job_forms_id_share_post_328);
app.get("/api/jobs", jobs_get_329);
app.post("/api/jobs", jobs_post_330);
app.post("/api/jobs/report/generate", jobs_report_generate_post_331);
app.get("/api/jobs/search", jobs_search_get_332);
app.get("/api/jobs/:id", jobs_id_get_333);
app.put("/api/jobs/:id", jobs_id_put_334);
app.post("/api/jobs/:id/attendance/:attendanceId/close", jobs_id_attendance_attendanceId_close_post_335);
app.get("/api/jobs/:id/costs", jobs_id_costs_get_336);
app.post("/api/jobs/:id/costs", jobs_id_costs_post_337);
app.get("/api/jobs/:id/costs/export", jobs_id_costs_export_get_338);
app.delete("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_delete_339);
app.put("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_put_340);
app.get("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_get_341);
app.post("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_post_342);
app.get("/api/jobs/:id/delays", jobs_id_delays_get_343);
app.post("/api/jobs/:id/delays", jobs_id_delays_post_344);
app.get("/api/jobs/:id/delays/export-csv", jobs_id_delays_export_csv_get_345);
app.delete("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_delete_346);
app.put("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_put_347);
app.get("/api/jobs/:id/documents", jobs_id_documents_get_348);
app.post("/api/jobs/:id/documents", jobs_id_documents_post_349);
app.get("/api/jobs/:id/export-zip", jobs_id_export_zip_get_350);
app.get("/api/jobs/:id/field-docs", jobs_id_field_docs_get_351);
app.get("/api/jobs/:id/files", jobs_id_files_get_352);
app.get("/api/jobs/:id/forms", jobs_id_forms_get_353);
app.post("/api/jobs/:id/forms", jobs_id_forms_post_354);
app.get("/api/jobs/:id/forms/export-csv", jobs_id_forms_export_csv_get_355);
app.delete("/api/jobs/:id/forms/:submissionId", jobs_id_forms_submissionId_delete_356);
app.post("/api/jobs/:id/forms/:submissionId/reopen", jobs_id_forms_submissionId_reopen_post_357);
app.post("/api/jobs/:id/generate-qr", jobs_id_generate_qr_post_358);
app.get("/api/jobs/:id/ledger", jobs_id_ledger_get_359);
app.post("/api/jobs/:id/ledger", jobs_id_ledger_post_360);
app.get("/api/jobs/:id/ledger/export", jobs_id_ledger_export_get_361);
app.post("/api/jobs/:id/ledger/sync", jobs_id_ledger_sync_post_362);
app.delete("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_delete_363);
app.put("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_put_364);
app.post("/api/jobs/:id/ledger/:entryId/correct", jobs_id_ledger_entryId_correct_post_365);
app.get("/api/jobs/:id/milestones", jobs_id_milestones_get_366);
app.post("/api/jobs/:id/milestones", jobs_id_milestones_post_367);
app.delete("/api/jobs/:id/milestones/:milestoneId", jobs_id_milestones_milestoneId_delete_368);
app.patch("/api/jobs/:id/milestones/:milestoneId", jobs_id_milestones_milestoneId_patch_369);
app.get("/api/jobs/:id/notes/export-csv", jobs_id_notes_export_csv_get_370);
app.get("/api/jobs/:id/photos", jobs_id_photos_get_371);
app.post("/api/jobs/:id/photos", jobs_id_photos_post_372);
app.post("/api/jobs/:id/photos/export-zip", jobs_id_photos_export_zip_post_373);
app.get("/api/jobs/:id/photos/picker", jobs_id_photos_picker_get_374);
app.post("/api/jobs/:id/photos/share", jobs_id_photos_share_post_375);
app.delete("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_delete_376);
app.patch("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_patch_377);
app.get("/api/jobs/:id/photos/:photoId/download", jobs_id_photos_photoId_download_get_378);
app.post("/api/jobs/:id/photos/:photoId/lock", jobs_id_photos_photoId_lock_post_379);
app.post("/api/jobs/:id/photos/:photoId/replace", jobs_id_photos_photoId_replace_post_380);
app.get("/api/jobs/:id/photos/:photoId/report-image", jobs_id_photos_photoId_report_image_get_381);
app.get("/api/jobs/:id/progress", jobs_id_progress_get_382);
app.put("/api/jobs/:id/progress", jobs_id_progress_put_383);
app.get("/api/jobs/:id/progress/export-csv", jobs_id_progress_export_csv_get_384);
app.get("/api/jobs/:id/progress/report", jobs_id_progress_report_get_385);
app.put("/api/jobs/:id/progress/report", jobs_id_progress_report_put_386);
app.get("/api/jobs/:id/progress/report/pdf", jobs_id_progress_report_pdf_get_387);
app.post("/api/jobs/:id/progress/sync", jobs_id_progress_sync_post_388);
app.get("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_get_389);
app.post("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_post_390);
app.delete("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_delete_391);
app.get("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_get_392);
app.put("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_put_393);
app.get("/api/jobs/:id/purchase-orders/:poId/pdf", jobs_id_purchase_orders_poId_pdf_get_394);
app.post("/api/jobs/:id/report/pdf", jobs_id_report_pdf_post_395);
app.get("/api/jobs/:id/risky", jobs_id_risky_get_396);
app.post("/api/jobs/:id/risky", jobs_id_risky_post_397);
app.get("/api/jobs/:id/risky/:riskyId", jobs_id_risky_riskyId_get_398);
app.put("/api/jobs/:id/risky/:riskyId", jobs_id_risky_riskyId_put_399);
app.post("/api/jobs/:id/risky/:riskyId/finalise", jobs_id_risky_riskyId_finalise_post_400);
app.post("/api/jobs/:id/risky/:riskyId/signatures", jobs_id_risky_riskyId_signatures_post_401);
app.post("/api/jobs/:id/risky/:riskyId/supervisor-signoff", jobs_id_risky_riskyId_supervisor_signoff_post_402);
app.post("/api/jobs/:id/signin", jobs_id_signin_post_403);
app.post("/api/jobs/:id/signin-qr", jobs_id_signin_qr_post_404);
app.get("/api/jobs/:id/signin-status", jobs_id_signin_status_get_405);
app.post("/api/jobs/:id/signout", jobs_id_signout_post_406);
app.post("/api/jobs/:id/signout-qr", jobs_id_signout_qr_post_407);
app.post("/api/jobs/:id/signout-user", jobs_id_signout_user_post_408);
app.get("/api/jobs/:id/site-prestarts", jobs_id_site_prestarts_get_409);
app.post("/api/jobs/:id/site-prestarts", jobs_id_site_prestarts_post_410);
app.get("/api/jobs/:id/site-prestarts/:prestartId", jobs_id_site_prestarts_prestartId_get_411);
app.put("/api/jobs/:id/site-prestarts/:prestartId", jobs_id_site_prestarts_prestartId_put_412);
app.post("/api/jobs/:id/site-prestarts/:prestartId/finalise", jobs_id_site_prestarts_prestartId_finalise_post_413);
app.post("/api/jobs/:id/site-prestarts/:prestartId/workers", jobs_id_site_prestarts_prestartId_workers_post_414);
app.get("/api/jobs/:id/swms", jobs_id_swms_get_415);
app.post("/api/jobs/:id/swms", jobs_id_swms_post_416);
app.post("/api/jobs/:id/swms/:swmsId/signoff", jobs_id_swms_swmsId_signoff_post_417);
app.get("/api/jobs/:id/todos", jobs_id_todos_get_418);
app.post("/api/jobs/:id/todos", jobs_id_todos_post_419);
app.delete("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_delete_420);
app.put("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_put_421);
app.get("/api/library/items", library_items_get_422);
app.get("/api/library/items/:id", library_items_id_get_423);
app.patch("/api/library/items/:id", library_items_id_patch_424);
app.get("/api/library/items/:id/download", library_items_id_download_get_425);
app.delete("/api/library/items/:id/install", library_items_id_install_delete_426);
app.post("/api/library/items/:id/install", library_items_id_install_post_427);
app.get("/api/library/my-installed", library_my_installed_get_428);
app.get("/api/library/my-submissions", library_my_submissions_get_429);
app.get("/api/lists", lists_get_430);
app.get("/api/me", me_get_431);
app.put("/api/me", me_put_432);
app.post("/api/me/2fa/disable", me_2fa_disable_post_433);
app.post("/api/me/2fa/enable", me_2fa_enable_post_434);
app.get("/api/me/2fa/setup", me_2fa_setup_get_435);
app.post("/api/me/2fa/sms/disable", me_2fa_sms_disable_post_436);
app.post("/api/me/2fa/sms/enable", me_2fa_sms_enable_post_437);
app.post("/api/me/2fa/sms/send", me_2fa_sms_send_post_438);
app.post("/api/me/2fa/sms/send-setup", me_2fa_sms_send_setup_post_439);
app.post("/api/me/2fa/sms/verify", me_2fa_sms_verify_post_440);
app.get("/api/me/2fa/status", me_2fa_status_get_441);
app.post("/api/me/2fa/verify", me_2fa_verify_post_442);
app.get("/api/me/active-status", me_active_status_get_443);
app.post("/api/me/change-password", me_change_password_post_444);
app.get("/api/me/email-status", me_email_status_get_445);
app.get("/api/me/phone", me_phone_get_446);
app.put("/api/me/phone", me_phone_put_447);
app.delete("/api/me/profile-attachments", me_profile_attachments_delete_448);
app.post("/api/me/profile-attachments", me_profile_attachments_post_449);
app.get("/api/me/profile-attachments/download", me_profile_attachments_download_get_450);
app.get("/api/me/profile-attachments/thumbnail", me_profile_attachments_thumbnail_get_451);
app.get("/api/me/profile-extras", me_profile_extras_get_452);
app.put("/api/me/profile-extras", me_profile_extras_put_453);
app.post("/api/migrate-account-recovery", migrate_account_recovery_post_454);
app.post("/api/migrate-asset-manager", migrate_asset_manager_post_455);
app.post("/api/migrate-attendance", migrate_attendance_post_456);
app.post("/api/migrate-company-settings", migrate_company_settings_post_457);
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_458);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_459);
app.post("/api/migrate-emergency-alerts", migrate_emergency_alerts_post_460);
app.post("/api/migrate-estimates", migrate_estimates_post_461);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_462);
app.post("/api/migrate-files", migrate_files_post_463);
app.post("/api/migrate-fleet", migrate_fleet_post_464);
app.post("/api/migrate-fleet-analytics", migrate_fleet_analytics_post_465);
app.post("/api/migrate-fleet-driver-sessions", migrate_fleet_driver_sessions_post_466);
app.post("/api/migrate-fleet-usage", migrate_fleet_usage_post_467);
app.post("/api/migrate-form-fields", migrate_form_fields_post_468);
app.post("/api/migrate-form-logic", migrate_form_logic_post_469);
app.post("/api/migrate-form-templates", migrate_form_templates_post_470);
app.post("/api/migrate-job-forms", migrate_job_forms_post_471);
app.post("/api/migrate-job-photo-shares", migrate_job_photo_shares_post_472);
app.post("/api/migrate-job-photos", migrate_job_photos_post_473);
app.post("/api/migrate-job-tabs", migrate_job_tabs_post_474);
app.post("/api/migrate-jobs", migrate_jobs_post_475);
app.post("/api/migrate-ledger-photo", migrate_ledger_photo_post_476);
app.post("/api/migrate-library", migrate_library_post_477);
app.post("/api/migrate-library-downloads", migrate_library_downloads_post_478);
app.post("/api/migrate-notifications", migrate_notifications_post_479);
app.post("/api/migrate-owner-console", migrate_owner_console_post_480);
app.post("/api/migrate-owner-role", migrate_owner_role_post_481);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_482);
app.post("/api/migrate-plan-manager", migrate_plan_manager_post_483);
app.post("/api/migrate-plan-manager-v2", migrate_plan_manager_v2_post_484);
app.post("/api/migrate-plan-manager-v3", migrate_plan_manager_v3_post_485);
app.post("/api/migrate-safety", migrate_safety_post_486);
app.post("/api/migrate-site-prestart", migrate_site_prestart_post_487);
app.post("/api/migrate-sms-verified-at", migrate_sms_verified_at_post_488);
app.post("/api/migrate-starter-pack", migrate_starter_pack_post_489);
app.post("/api/migrate-studio-pdf", migrate_studio_pdf_post_490);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_491);
app.post("/api/migrate-support-mode", migrate_support_mode_post_492);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_493);
app.post("/api/migrate-team", migrate_team_post_494);
app.get("/api/notes", notes_get_495);
app.post("/api/notes", notes_post_496);
app.post("/api/notes/comments", notes_comments_post_497);
app.post("/api/notes/migrate", notes_migrate_post_498);
app.delete("/api/notes/:id", notes_id_delete_499);
app.get("/api/notifications/alerts", notifications_alerts_get_500);
app.get("/api/notifications/prefs", notifications_prefs_get_501);
app.put("/api/notifications/prefs", notifications_prefs_put_502);
app.post("/api/notifications/read", notifications_read_post_503);
app.get("/api/owner-console/activity", owner_console_activity_get_504);
app.get("/api/owner-console/cancellation-feedback", owner_console_cancellation_feedback_get_505);
app.get("/api/owner-console/companies", owner_console_companies_get_506);
app.post("/api/owner-console/companies", owner_console_companies_post_507);
app.get("/api/owner-console/companies/usage", owner_console_companies_usage_get_508);
app.put("/api/owner-console/companies/:id/limits", owner_console_companies_id_limits_put_509);
app.get("/api/owner-console/form-templates", owner_console_form_templates_get_510);
app.post("/api/owner-console/form-templates", owner_console_form_templates_post_511);
app.get("/api/owner-console/library/items", owner_console_library_items_get_512);
app.post("/api/owner-console/library/items", owner_console_library_items_post_513);
app.delete("/api/owner-console/library/items/:id", owner_console_library_items_id_delete_514);
app.patch("/api/owner-console/library/items/:id", owner_console_library_items_id_patch_515);
app.put("/api/owner-console/library/items/:id", owner_console_library_items_id_put_516);
app.post("/api/owner-console/library/items/:id/push-update", owner_console_library_items_id_push_update_post_517);
app.get("/api/owner-console/library/submissions", owner_console_library_submissions_get_518);
app.post("/api/owner-console/library/submissions/:id/review", owner_console_library_submissions_id_review_post_519);
app.get("/api/owner-console/starter-pack", owner_console_starter_pack_get_520);
app.post("/api/owner-console/starter-pack", owner_console_starter_pack_post_521);
app.get("/api/owner-console/stats", owner_console_stats_get_522);
app.get("/api/owner-console/storage", owner_console_storage_get_523);
app.get("/api/owner-console/swms/masters", owner_console_swms_masters_get_524);
app.post("/api/owner-console/swms/masters", owner_console_swms_masters_post_525);
app.post("/api/owner-console/swms/masters/publish-all", owner_console_swms_masters_publish_all_post_526);
app.delete("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_delete_527);
app.get("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_get_528);
app.put("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_put_529);
app.post("/api/owner-console/swms/masters/:id/publish", owner_console_swms_masters_id_publish_post_530);
app.post("/api/owner-console/swms/migrate-master-library", owner_console_swms_migrate_master_library_post_531);
app.post("/api/owner-console/swms/push", owner_console_swms_push_post_532);
app.post("/api/owner-console/swms/seed-bricklaying", owner_console_swms_seed_bricklaying_post_533);
app.post("/api/owner-console/swms/seed-building-inspection", owner_console_swms_seed_building_inspection_post_534);
app.post("/api/owner-console/swms/seed-cabinets", owner_console_swms_seed_cabinets_post_535);
app.post("/api/owner-console/swms/seed-carpenter-fixing", owner_console_swms_seed_carpenter_fixing_post_536);
app.post("/api/owner-console/swms/seed-carpenter-framing", owner_console_swms_seed_carpenter_framing_post_537);
app.post("/api/owner-console/swms/seed-carpenter-lockup", owner_console_swms_seed_carpenter_lockup_post_538);
app.post("/api/owner-console/swms/seed-ceramic-tiling", owner_console_swms_seed_ceramic_tiling_post_539);
app.post("/api/owner-console/swms/seed-concreting-slab", owner_console_swms_seed_concreting_slab_post_540);
app.post("/api/owner-console/swms/seed-delivery-loading", owner_console_swms_seed_delivery_loading_post_541);
app.post("/api/owner-console/swms/seed-environmental-spill", owner_console_swms_seed_environmental_spill_post_542);
app.post("/api/owner-console/swms/seed-ewp", owner_console_swms_seed_ewp_post_543);
app.post("/api/owner-console/swms/seed-excavations-substation", owner_console_swms_seed_excavations_substation_post_544);
app.post("/api/owner-console/swms/seed-fencing", owner_console_swms_seed_fencing_post_545);
app.post("/api/owner-console/swms/seed-heat-stress", owner_console_swms_seed_heat_stress_post_546);
app.post("/api/owner-console/swms/seed-landscaping", owner_console_swms_seed_landscaping_post_547);
app.post("/api/owner-console/swms/seed-live-parts", owner_console_swms_seed_live_parts_post_548);
app.post("/api/owner-console/swms/seed-manual-handling", owner_console_swms_seed_manual_handling_post_549);
app.post("/api/owner-console/swms/seed-moving-plant", owner_console_swms_seed_moving_plant_post_550);
app.post("/api/owner-console/swms/seed-painting", owner_console_swms_seed_painting_post_551);
app.post("/api/owner-console/swms/seed-power-tools", owner_console_swms_seed_power_tools_post_552);
app.post("/api/owner-console/swms/seed-silica-dust", owner_console_swms_seed_silica_dust_post_553);
app.post("/api/owner-console/swms/seed-traffic-management", owner_console_swms_seed_traffic_management_post_554);
app.post("/api/owner-console/swms/seed-underground-services", owner_console_swms_seed_underground_services_post_555);
app.post("/api/owner-console/swms/seed-vacuum-excavation", owner_console_swms_seed_vacuum_excavation_post_556);
app.post("/api/owner-console/system-ai/builtin-checks", owner_console_system_ai_builtin_checks_post_557);
app.get("/api/owner-console/users", owner_console_users_get_558);
app.post("/api/owner-console/users/verify", owner_console_users_verify_post_559);
app.get("/api/plan-manager/drawings", plan_manager_drawings_get_560);
app.post("/api/plan-manager/drawings", plan_manager_drawings_post_561);
app.get("/api/plan-manager/drawings/:id", plan_manager_drawings_id_get_562);
app.put("/api/plan-manager/drawings/:id/annotations", plan_manager_drawings_id_annotations_put_563);
app.post("/api/plan-manager/drawings/:id/archive", plan_manager_drawings_id_archive_post_564);
app.delete("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_delete_565);
app.post("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_post_566);
app.get("/api/plan-manager/drawings/:id/pages/:pageNo/annotations", plan_manager_drawings_id_pages_pageNo_annotations_get_567);
app.delete("/api/plan-manager/drawings/:id/permanent", plan_manager_drawings_id_permanent_delete_568);
app.patch("/api/plan-manager/drawings/:id/reorder", plan_manager_drawings_id_reorder_patch_569);
app.post("/api/plan-manager/drawings/:id/restore", plan_manager_drawings_id_restore_post_570);
app.post("/api/plan-manager/drawings/:id/revisions", plan_manager_drawings_id_revisions_post_571);
app.post("/api/plan-manager/drawings/:id/revisions/:revisionId/finalize", plan_manager_drawings_id_revisions_revisionId_finalize_post_572);
app.post("/api/plan-manager/drawings/:id/upload", plan_manager_drawings_id_upload_post_573);
app.get("/api/plan-manager/jobs/:jobId/drawings-zip", plan_manager_jobs_jobId_drawings_zip_get_574);
app.get("/api/plan-manager/jobs-with-drawings", plan_manager_jobs_with_drawings_get_575);
app.post("/api/plan-manager/share", plan_manager_share_post_576);
app.get("/api/plan-manager/share/validate", plan_manager_share_validate_get_577);
app.post("/api/portal/estimates/:id/approve", portal_estimates_id_approve_post_578);
app.post("/api/portal/invite", portal_invite_post_579);
app.post("/api/portal/invoices/:id/pay", portal_invoices_id_pay_post_580);
app.get("/api/portal/jobs", portal_jobs_get_581);
app.get("/api/portal/jobs/:id", portal_jobs_id_get_582);
app.post("/api/portal/migrate", portal_migrate_post_583);
app.post("/api/portal/validate", portal_validate_post_584);
app.get("/api/public/form/:token", public_form_token_get_585);
app.post("/api/public/form/:token/submit", public_form_token_submit_post_586);
app.get("/api/public/job-photos/:token", public_job_photos_token_get_587);
app.get("/api/public/job-photos/:token/photo/:photoId", public_job_photos_token_photo_photoId_get_588);
app.get("/api/public/swms/:token", public_swms_token_get_589);
app.post("/api/public/swms/:token/signoff", public_swms_token_signoff_post_590);
app.delete("/api/push/subscribe", push_subscribe_delete_591);
app.post("/api/push/subscribe", push_subscribe_post_592);
app.get("/api/push/vapid-key", push_vapid_key_get_593);
app.get("/api/quick-links/site-meta", quick_links_site_meta_get_594);
app.get("/api/recipes", recipes_get_595);
app.post("/api/recipes", recipes_post_596);
app.delete("/api/recipes/:id", recipes_id_delete_597);
app.put("/api/recipes/:id", recipes_id_put_598);
app.get("/api/risk-register", risk_register_get_599);
app.post("/api/risk-register", risk_register_post_600);
app.get("/api/risk-register/:id", risk_register_id_get_601);
app.put("/api/risk-register/:id", risk_register_id_put_602);
app.post("/api/risk-register/:id/archive", risk_register_id_archive_post_603);
app.post("/api/risk-register/:id/unarchive", risk_register_id_unarchive_post_604);
app.post("/api/safety/ai/draft", safety_ai_draft_post_605);
app.get("/api/safety/documents", safety_documents_get_606);
app.post("/api/safety/documents", safety_documents_post_607);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_608);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_609);
app.get("/api/safety/generated-posters", safety_generated_posters_get_610);
app.post("/api/safety/generated-posters", safety_generated_posters_post_611);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_612);
app.get("/api/safety/job-safety-plans", safety_job_safety_plans_get_613);
app.post("/api/safety/job-safety-plans", safety_job_safety_plans_post_614);
app.delete("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_delete_615);
app.put("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_put_616);
app.get("/api/safety/job-swms", safety_job_swms_get_617);
app.post("/api/safety/job-swms", safety_job_swms_post_618);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_619);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_620);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_621);
app.post("/api/safety/job-swms/:id/share-token", safety_job_swms_id_share_token_post_622);
app.get("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_get_623);
app.post("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_post_624);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", safety_job_swms_id_signoffs_signoffId_delete_625);
app.get("/api/safety/plans", safety_plans_get_626);
app.post("/api/safety/plans", safety_plans_post_627);
app.post("/api/safety/plans/seed", safety_plans_seed_post_628);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_629);
app.put("/api/safety/plans/:id", safety_plans_id_put_630);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_631);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_632);
app.get("/api/safety/posters", safety_posters_get_633);
app.post("/api/safety/posters", safety_posters_post_634);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_635);
app.get("/api/safety/posters/:id/download", safety_posters_id_download_get_636);
app.get("/api/safety/swms", safety_swms_get_637);
app.post("/api/safety/swms", safety_swms_post_638);
app.post("/api/safety/swms/import-docx", safety_swms_import_docx_post_639);
app.post("/api/safety/swms/seed", safety_swms_seed_post_640);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_641);
app.get("/api/safety/swms/:id", safety_swms_id_get_642);
app.put("/api/safety/swms/:id", safety_swms_id_put_643);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_644);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_645);
app.post("/api/safety/swms/:id/publish-to-library", safety_swms_id_publish_to_library_post_646);
app.get("/api/scheduler/crew", scheduler_crew_get_647);
app.get("/api/scheduler/jobs", scheduler_jobs_get_648);
app.patch("/api/scheduler/jobs/:id/reschedule", scheduler_jobs_id_reschedule_patch_649);
app.get("/api/scheduler/tasks", scheduler_tasks_get_650);
app.get("/api/secure-share", secure_share_get_651);
app.post("/api/secure-share", secure_share_post_652);
app.delete("/api/secure-share/:id", secure_share_id_delete_653);
app.get("/api/secure-share/:token", secure_share_token_get_654);
app.post("/api/secure-share/:token", secure_share_token_post_655);
app.get("/api/settings/backup", settings_backup_get_656);
app.post("/api/settings/backup", settings_backup_post_657);
app.get("/api/settings/backup/company-data", settings_backup_company_data_get_658);
app.get("/api/settings/backup/csv-pack", settings_backup_csv_pack_get_659);
app.get("/api/settings/backup/export", settings_backup_export_get_660);
app.post("/api/settings/backup/run", settings_backup_run_post_661);
app.get("/api/settings/backup-destination", settings_backup_destination_get_662);
app.post("/api/settings/backup-destination", settings_backup_destination_post_663);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_664);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_665);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_666);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_667);
app.get("/api/settings/retention", settings_retention_get_668);
app.post("/api/settings/retention", settings_retention_post_669);
app.get("/api/settings/storage-provider", settings_storage_provider_get_670);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_671);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_672);
app.get("/api/settings/terminology", settings_terminology_get_673);
app.post("/api/settings/terminology", settings_terminology_post_674);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_675);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_676);
app.get("/api/share/:token", share_token_get_677);
app.get("/api/signin-history", signin_history_get_678);
app.post("/api/signup", signup_post_679);
app.get("/api/sos", sos_get_680);
app.post("/api/sos/acknowledge", sos_acknowledge_post_681);
app.post("/api/sos/trigger", sos_trigger_post_682);
app.post("/api/stakeholders/sms", stakeholders_sms_post_683);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_684);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_685);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_686);
app.get("/api/subscription/status", subscription_status_get_687);
app.post("/api/subscription/webhook", subscription_webhook_post_688);
app.get("/api/support-mode/audit", support_mode_audit_get_689);
app.get("/api/support-mode/checklist", support_mode_checklist_get_690);
app.put("/api/support-mode/checklist", support_mode_checklist_put_691);
app.post("/api/support-mode/enter", support_mode_enter_post_692);
app.post("/api/support-mode/exit", support_mode_exit_post_693);
app.get("/api/support-mode/status", support_mode_status_get_694);
app.get("/api/tag-tasks", tag_tasks_get_695);
app.patch("/api/tag-tasks/:id", tag_tasks_id_patch_696);
app.get("/api/takeoff-pad", takeoff_pad_get_697);
app.put("/api/takeoff-pad", takeoff_pad_put_698);
app.post("/api/tasks", tasks_post_699);
app.put("/api/tasks/:id", tasks_id_put_700);
app.get("/api/team", team_get_701);
app.post("/api/team/invite", team_invite_post_702);
app.get("/api/team/invites", team_invites_get_703);
app.post("/api/team/invites", team_invites_post_704);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_705);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_706);
app.get("/api/team/members", team_members_get_707);
app.get("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_get_708);
app.put("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_put_709);
app.post("/api/team/resend-verification", team_resend_verification_post_710);
app.post("/api/team/schedule/migrate", team_schedule_migrate_post_711);
app.get("/api/team/shifts", team_shifts_get_712);
app.post("/api/team/shifts", team_shifts_post_713);
app.delete("/api/team/shifts/:id", team_shifts_id_delete_714);
app.put("/api/team/shifts/:id", team_shifts_id_put_715);
app.get("/api/team/time-entries", team_time_entries_get_716);
app.post("/api/team/time-entries", team_time_entries_post_717);
app.get("/api/team/time-entries/export", team_time_entries_export_get_718);
app.put("/api/team/time-entries/:id", team_time_entries_id_put_719);
app.post("/api/team/verify-user", team_verify_user_post_720);
app.delete("/api/team/:id", team_id_delete_721);
app.put("/api/team/:id", team_id_put_722);
app.get("/api/usage", usage_get_723);
app.get("/api/user-logs", user_logs_get_724);
app.get("/api/user-logs/users", user_logs_users_get_725);
// </api-registrations>
