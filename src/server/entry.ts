...
import _h_form_templates_seed_post_4 from "./api/form-templates/seed/POST";
import _h_jobs_id_ledger_sync_post_5 from "./api/jobs/[id]/ledger/sync/POST";
import _h_jobs_id_purchase_orders_get_6 from "./api/jobs/[id]/purchase-orders/GET";
import _h_jobs_id_purchase_orders_post_7 from "./api/jobs/[id]/purchase-orders/POST";
import _h_jobs_id_purchase_orders_poid_delete_8 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import _h_jobs_id_purchase_orders_poid_get_9 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
import _h_jobs_id_purchase_orders_poid_put_10 from "./api/jobs/[id]/purchase-orders/[poId]/PUT";
import _h_jobs_id_purchase_orders_poid_pdf_get_11 from "./api/jobs/[id]/purchase-orders/[poId]/pdf/GET";
import _h_migrate_account_recovery_post_12 from "./api/migrate-account-recovery/POST";
import _h_migrate_company_settings_post_13 from "./api/migrate-company-settings/POST";
import _h_migrate_dazza_audit_post_14 from "./api/migrate-dazza-audit/POST";
import _h_migrate_dazza_knowledge_post_15 from "./api/migrate-dazza-knowledge/POST";
import _h_migrate_estimates_post_16 from "./api/migrate-estimates/POST";
import _h_migrate_estimating_library_post_17 from "./api/migrate-estimating-library/POST";
import _h_migrate_files_post_18 from "./api/migrate-files/POST";
import _h_migrate_fleet_post_19 from "./api/migrate-fleet/POST";
import _h_migrate_fleet_driver_sessions_post_20 from "./api/migrate-fleet-driver-sessions/POST";
import _h_migrate_form_fields_post_21 from "./api/migrate-form-fields/POST";
import _h_migrate_form_logic_post_22 from "./api/migrate-form-logic/POST";
import _h_migrate_form_templates_post_23 from "./api/migrate-form-templates/POST";
import _h_migrate_job_forms_post_24 from "./api/migrate-job-forms/POST";
import _h_migrate_job_photos_post_25 from "./api/migrate-job-photos/POST";
import _h_migrate_job_tabs_post_26 from "./api/migrate-job-tabs/POST";
import _h_migrate_jobs_post_27 from "./api/migrate-jobs/POST";
import _h_migrate_notifications_post_28 from "./api/migrate-notifications/POST";
import _h_migrate_owner_console_post_29 from "./api/migrate-owner-console/POST";
import _h_migrate_owner_role_post_30 from "./api/migrate-owner-role/POST";
import _h_migrate_pdf_settings_post_31 from "./api/migrate-pdf-settings/POST";
import _h_migrate_safety_post_32 from "./api/migrate-safety/POST";
import _h_migrate_starter_pack_post_33 from "./api/migrate-starter-pack/POST";
import _h_migrate_subscriptions_post_34 from "./api/migrate-subscriptions/POST";
import _h_migrate_support_mode_post_35 from "./api/migrate-support-mode/POST";
import _h_migrate_takeoff_pad_post_36 from "./api/migrate-takeoff-pad/POST";
import _h_migrate_team_post_37 from "./api/migrate-team/POST";
import _h_notifications_alerts_get_38 from "./api/notifications/alerts/GET";
import _h_owner_console_system_ai_builtin_checks_post_39 from "./api/owner-console/system-ai/builtin-checks/POST";
import _h_active_ping_post_0 from "./api/active-ping/POST";
import _h_asset_manager_assets_get_1 from "./api/asset-manager/assets/GET";
import _h_asset_manager_assets_post_2 from "./api/asset-manager/assets/POST";
import _h_asset_manager_assets_id_get_3 from "./api/asset-manager/assets/[id]/GET";
import _h_asset_manager_assets_id_patch_4 from "./api/asset-manager/assets/[id]/PATCH";
import _h_asset_manager_assets_id_archive_post_5 from "./api/asset-manager/assets/[id]/archive/POST";
import _h_asset_manager_assets_id_permanent_delete_6 from "./api/asset-manager/assets/[id]/permanent/DELETE";
import _h_asset_manager_assets_id_restore_post_7 from "./api/asset-manager/assets/[id]/restore/POST";
import _h_asset_manager_defects_id_patch_8 from "./api/asset-manager/defects/[id]/PATCH";
import _h_asset_manager_defects_id_archive_post_9 from "./api/asset-manager/defects/[id]/archive/POST";
import _h_asset_manager_inspections_get_10 from "./api/asset-manager/inspections/GET";
import _h_asset_manager_inspections_post_11 from "./api/asset-manager/inspections/POST";
import _h_asset_manager_inspections_id_get_12 from "./api/asset-manager/inspections/[id]/GET";
import _h_asset_manager_inspections_id_patch_13 from "./api/asset-manager/inspections/[id]/PATCH";
import _h_asset_manager_inspections_id_archive_post_14 from "./api/asset-manager/inspections/[id]/archive/POST";
import _h_asset_manager_inspections_id_closeout_post_15 from "./api/asset-manager/inspections/[id]/closeout/POST";
import _h_asset_manager_inspections_id_defects_post_16 from "./api/asset-manager/inspections/[id]/defects/POST";
import _h_asset_manager_inspections_id_permanent_delete_17 from "./api/asset-manager/inspections/[id]/permanent/DELETE";
import _h_asset_manager_inspections_id_photos_post_18 from "./api/asset-manager/inspections/[id]/photos/POST";
import _h_asset_manager_inspections_id_report_share_post_19 from "./api/asset-manager/inspections/[id]/report/share/POST";
import _h_asset_manager_inspections_id_restore_post_20 from "./api/asset-manager/inspections/[id]/restore/POST";
import _h_asset_manager_inspections_id_tenders_post_21 from "./api/asset-manager/inspections/[id]/tenders/POST";
import _h_asset_manager_monitoring_get_22 from "./api/asset-manager/monitoring/GET";
import _h_asset_manager_reports_sharetoken_get_23 from "./api/asset-manager/reports/[shareToken]/GET";
import _h_asset_manager_tenders_id_patch_24 from "./api/asset-manager/tenders/[id]/PATCH";
import _h_asset_manager_tenders_id_complete_post_25 from "./api/asset-manager/tenders/[id]/complete/POST";
import _h_asset_manager_tenders_id_contracts_post_26 from "./api/asset-manager/tenders/[id]/contracts/POST";
import _h_auth_change_email_post_27 from "./api/auth/change-email/POST";
import _h_auth_change_password_post_28 from "./api/auth/change-password/POST";
import _h_auth_check_signup_status_post_29 from "./api/auth/check-signup-status/POST";
import _h_auth_forgot_password_post_30 from "./api/auth/forgot-password/POST";
import _h_auth_pin_login_post_31 from "./api/auth/pin-login/POST";
import _h_auth_resend_verification_post_32 from "./api/auth/resend-verification/POST";
import _h_auth_reset_password_post_33 from "./api/auth/reset-password/POST";
import _h_auth_resume_signup_post_34 from "./api/auth/resume-signup/POST";
import _h_auth_self_verify_post_35 from "./api/auth/self-verify/POST";
import _h_auth_send_sms_code_post_36 from "./api/auth/send-sms-code/POST";
import _h_auth_sms_configured_get_37 from "./api/auth/sms-configured/GET";
import _h_auth_sms_recovery_post_38 from "./api/auth/sms-recovery/POST";
import _h_auth_trusted_devices_get_39 from "./api/auth/trusted-devices/GET";
import _h_auth_trusted_devices_post_40 from "./api/auth/trusted-devices/POST";
import _h_auth_trusted_devices_deviceid_delete_41 from "./api/auth/trusted-devices/[deviceId]/DELETE";
import _h_auth_validate_reset_token_get_42 from "./api/auth/validate-reset-token/GET";
import _h_auth_verify_email_post_43 from "./api/auth/verify-email/POST";
import _h_auth_verify_sms_code_post_44 from "./api/auth/verify-sms-code/POST";
import _h_auth_action_get_45 from "./api/auth/[action]/GET";
import _h_auth_action_post_46 from "./api/auth/[action]/POST";
import _h_auth_action_detail_get_47 from "./api/auth/[action]/[detail]/GET";
import _h_auth_action_detail_post_48 from "./api/auth/[action]/[detail]/POST";
import _h_billing_cancel_subscription_post_49 from "./api/billing/cancel-subscription/POST";
import _h_billing_cancellation_feedback_post_50 from "./api/billing/cancellation-feedback/POST";
import _h_billing_customer_portal_post_51 from "./api/billing/customer-portal/POST";
import _h_billing_reactivate_subscription_post_52 from "./api/billing/reactivate-subscription/POST";
import _h_billing_upgrade_subscription_post_53 from "./api/billing/upgrade-subscription/POST";
import _h_company_get_54 from "./api/company/GET";
import _h_company_put_55 from "./api/company/PUT";
import _h_company_logo_post_56 from "./api/company/logo/POST";
import _h_company_settings_get_57 from "./api/company-settings/GET";
import _h_company_settings_put_58 from "./api/company-settings/PUT";
import _h_contact_post_59 from "./api/contact/POST";
import _h_cost_guide_get_60 from "./api/cost-guide/GET";
import _h_cost_guide_post_61 from "./api/cost-guide/POST";
import _h_cost_guide_export_csv_get_62 from "./api/cost-guide/export-csv/GET";
import _h_cost_guide_import_csv_post_63 from "./api/cost-guide/import-csv/POST";
import _h_cost_guide_id_delete_64 from "./api/cost-guide/[id]/DELETE";
import _h_cost_guide_id_put_65 from "./api/cost-guide/[id]/PUT";
import _h_customers_get_66 from "./api/customers/GET";
import _h_customers_post_67 from "./api/customers/POST";
import _h_customers_id_delete_68 from "./api/customers/[id]/DELETE";
import _h_customers_id_get_69 from "./api/customers/[id]/GET";
import _h_customers_id_put_70 from "./api/customers/[id]/PUT";
import _h_dashboard_kpi_get_71 from "./api/dashboard/kpi/GET";
import _h_dashboard_setup_check_get_72 from "./api/dashboard/setup-check/GET";
import _h_dashboard_todos_get_73 from "./api/dashboard/todos/GET";
import _h_dazza_brain_hive_approve_post_75 from "./api/dazza/brain/hive/approve/POST";
import _h_dazza_brain_hive_reject_post_76 from "./api/dazza/brain/hive/reject/POST";
import _h_dazza_brain_status_get_77 from "./api/dazza/brain/status/GET";
import _h_dazza_context_get_81 from "./api/dazza/context/GET";
import _h_dazza_key_status_get_82 from "./api/dazza/key-status/GET";
import _h_dazza_knowledge_get_83 from "./api/dazza/knowledge/GET";
import _h_dazza_knowledge_post_84 from "./api/dazza/knowledge/POST";
import _h_dazza_knowledge_id_delete_85 from "./api/dazza/knowledge/[id]/DELETE";
import _h_dazza_knowledge_id_put_86 from "./api/dazza/knowledge/[id]/PUT";
import _h_developer_activity_log_get_87 from "./api/developer/activity-log/GET";
import _h_developer_audit_log_get_88 from "./api/developer/audit-log/GET";
import _h_developer_companies_id_archive_post_89 from "./api/developer/companies/[id]/archive/POST";
import _h_developer_company_health_get_90 from "./api/developer/company-health/GET";
import _h_developer_email_log_get_91 from "./api/developer/email-log/GET";
import _h_developer_email_settings_get_92 from "./api/developer/email-settings/GET";
import _h_developer_email_settings_put_93 from "./api/developer/email-settings/PUT";
import _h_developer_email_settings_test_post_94 from "./api/developer/email-settings/test/POST";
import _h_developer_support_notes_get_95 from "./api/developer/support-notes/GET";
import _h_developer_support_notes_post_96 from "./api/developer/support-notes/POST";
import _h_developer_support_notes_id_delete_97 from "./api/developer/support-notes/[id]/DELETE";
import _h_developer_users_id_assign_company_post_98 from "./api/developer/users/[id]/assign-company/POST";
import _h_developer_users_id_deactivate_post_99 from "./api/developer/users/[id]/deactivate/POST";
import _h_developer_users_id_delete_orphan_post_100 from "./api/developer/users/[id]/delete-orphan/POST";
import _h_developer_users_id_force_temp_password_post_101 from "./api/developer/users/[id]/force-temp-password/POST";
import _h_developer_users_id_impersonate_delete_102 from "./api/developer/users/[id]/impersonate/DELETE";
import _h_developer_users_id_impersonate_post_103 from "./api/developer/users/[id]/impersonate/POST";
import _h_developer_users_id_reactivate_post_104 from "./api/developer/users/[id]/reactivate/POST";
import _h_developer_users_id_resend_verification_post_105 from "./api/developer/users/[id]/resend-verification/POST";
import _h_developer_users_id_role_put_106 from "./api/developer/users/[id]/role/PUT";
import _h_developer_users_id_send_reset_email_post_107 from "./api/developer/users/[id]/send-reset-email/POST";
import _h_developer_users_id_sessions_delete_108 from "./api/developer/users/[id]/sessions/DELETE";
import _h_developer_users_id_sessions_get_109 from "./api/developer/users/[id]/sessions/GET";
import _h_developer_users_id_unlock_account_post_110 from "./api/developer/users/[id]/unlock-account/POST";
import _h_document_templates_get_111 from "./api/document-templates/GET";
import _h_document_templates_post_112 from "./api/document-templates/POST";
import _h_document_templates_id_delete_113 from "./api/document-templates/[id]/DELETE";
import _h_document_templates_id_get_114 from "./api/document-templates/[id]/GET";
import _h_document_templates_id_put_115 from "./api/document-templates/[id]/PUT";
import _h_document_templates_id_import_docx_post_116 from "./api/document-templates/[id]/import-docx/POST";
import _h_documents_get_117 from "./api/documents/GET";
import _h_documents_share_token_get_118 from "./api/documents/share/[token]/GET";
import _h_documents_share_token_post_119 from "./api/documents/share/[token]/POST";
import _h_documents_id_get_120 from "./api/documents/[id]/GET";
import _h_documents_id_put_121 from "./api/documents/[id]/PUT";
import _h_documents_id_events_get_122 from "./api/documents/[id]/events/GET";
import _h_documents_id_share_delete_123 from "./api/documents/[id]/share/DELETE";
import _h_documents_id_share_post_124 from "./api/documents/[id]/share/POST";
import _h_drawings_get_125 from "./api/drawings/GET";
import _h_drawings_post_126 from "./api/drawings/POST";
import _h_drawings_upload_post_127 from "./api/drawings/upload/POST";
import _h_drawings_id_delete_128 from "./api/drawings/[id]/DELETE";
import _h_drawings_id_patch_129 from "./api/drawings/[id]/PATCH";
import _h_drawings_id_markup_post_130 from "./api/drawings/[id]/markup/POST";
import _h_estimates_get_131 from "./api/estimates/GET";
import _h_estimates_post_132 from "./api/estimates/POST";
import _h_estimates_id_delete_133 from "./api/estimates/[id]/DELETE";
import _h_estimates_id_get_134 from "./api/estimates/[id]/GET";
import _h_estimates_id_put_135 from "./api/estimates/[id]/PUT";
import _h_estimates_id_export_csv_get_136 from "./api/estimates/[id]/export-csv/GET";
import _h_estimates_id_export_pdf_get_137 from "./api/estimates/[id]/export-pdf/GET";
import _h_estimates_id_import_csv_post_138 from "./api/estimates/[id]/import-csv/POST";
import _h_external_form_token_get_139 from "./api/external/form/[token]/GET";
import _h_external_form_token_post_140 from "./api/external/form/[token]/POST";
import _h_files_get_141 from "./api/files/GET";
import _h_files_post_142 from "./api/files/POST";
import _h_files_id_delete_143 from "./api/files/[id]/DELETE";
import _h_files_id_download_get_144 from "./api/files/[id]/download/GET";
import _h_fleet_get_145 from "./api/fleet/GET";
import _h_fleet_post_146 from "./api/fleet/POST";
import _h_fleet_driver_sessions_post_147 from "./api/fleet/driver-sessions/POST";
import _h_fleet_driver_sessions_active_get_148 from "./api/fleet/driver-sessions/active/GET";
import _h_fleet_driver_sessions_id_stop_post_149 from "./api/fleet/driver-sessions/[id]/stop/POST";
import _h_fleet_flags_get_150 from "./api/fleet/flags/GET";
import _h_fleet_service_logs_logid_delete_151 from "./api/fleet/service-logs/[logId]/DELETE";
import _h_fleet_service_logs_logid_patch_152 from "./api/fleet/service-logs/[logId]/PATCH";
import _h_fleet_vehicles_get_153 from "./api/fleet/vehicles/GET";
import _h_fleet_id_delete_154 from "./api/fleet/[id]/DELETE";
import _h_fleet_id_get_155 from "./api/fleet/[id]/GET";
import _h_fleet_id_put_156 from "./api/fleet/[id]/PUT";
import _h_fleet_id_driver_sessions_get_157 from "./api/fleet/[id]/driver-sessions/GET";
import _h_fleet_id_files_get_158 from "./api/fleet/[id]/files/GET";
import _h_fleet_id_prestarts_get_159 from "./api/fleet/[id]/prestarts/GET";
import _h_fleet_id_prestarts_post_160 from "./api/fleet/[id]/prestarts/POST";
import _h_fleet_id_service_logs_get_161 from "./api/fleet/[id]/service-logs/GET";
import _h_fleet_id_service_logs_post_162 from "./api/fleet/[id]/service-logs/POST";
import _h_form_templates_get_163 from "./api/form-templates/GET";
import _h_form_templates_post_164 from "./api/form-templates/POST";
import _h_form_templates_id_delete_166 from "./api/form-templates/[id]/DELETE";
import _h_form_templates_id_put_167 from "./api/form-templates/[id]/PUT";
import _h_forms_submissions_get_168 from "./api/forms/submissions/GET";
import _h_forms_templates_id_share_link_post_169 from "./api/forms/templates/[id]/share-link/POST";
import _h_forms_id_fields_get_170 from "./api/forms/[id]/fields/GET";
import _h_forms_id_fields_post_171 from "./api/forms/[id]/fields/POST";
import _h_forms_id_fields_reorder_post_172 from "./api/forms/[id]/fields/reorder/POST";
import _h_forms_id_fields_fieldid_delete_173 from "./api/forms/[id]/fields/[fieldId]/DELETE";
import _h_forms_id_fields_fieldid_patch_174 from "./api/forms/[id]/fields/[fieldId]/PATCH";
import _h_forms_id_fields_fieldid_thumbnail_post_175 from "./api/forms/[id]/fields/[fieldId]/thumbnail/POST";
import _h_health_get_176 from "./api/health/GET";
import _h_integrations_myob_auth_url_get_177 from "./api/integrations/myob/auth-url/GET";
import _h_integrations_myob_callback_get_178 from "./api/integrations/myob/callback/GET";
import _h_integrations_myob_disconnect_post_179 from "./api/integrations/myob/disconnect/POST";
import _h_integrations_myob_status_get_180 from "./api/integrations/myob/status/GET";
import _h_integrations_myob_sync_invoice_post_181 from "./api/integrations/myob/sync-invoice/POST";
import _h_integrations_onedrive_auth_url_get_182 from "./api/integrations/onedrive/auth-url/GET";
import _h_integrations_onedrive_callback_get_183 from "./api/integrations/onedrive/callback/GET";
import _h_integrations_onedrive_disconnect_post_184 from "./api/integrations/onedrive/disconnect/POST";
import _h_integrations_onedrive_status_get_185 from "./api/integrations/onedrive/status/GET";
import _h_integrations_onedrive_upload_file_post_186 from "./api/integrations/onedrive/upload-file/POST";
import _h_integrations_qbo_auth_url_get_187 from "./api/integrations/qbo/auth-url/GET";
import _h_integrations_qbo_callback_get_188 from "./api/integrations/qbo/callback/GET";
import _h_integrations_qbo_disconnect_post_189 from "./api/integrations/qbo/disconnect/POST";
import _h_integrations_qbo_status_get_190 from "./api/integrations/qbo/status/GET";
import _h_integrations_qbo_sync_invoice_post_191 from "./api/integrations/qbo/sync-invoice/POST";
import _h_integrations_xero_auth_url_get_192 from "./api/integrations/xero/auth-url/GET";
import _h_integrations_xero_callback_get_193 from "./api/integrations/xero/callback/GET";
import _h_integrations_xero_disconnect_post_194 from "./api/integrations/xero/disconnect/POST";
import _h_integrations_xero_status_get_195 from "./api/integrations/xero/status/GET";
import _h_integrations_xero_sync_customer_post_196 from "./api/integrations/xero/sync-customer/POST";
import _h_integrations_xero_sync_invoice_post_197 from "./api/integrations/xero/sync-invoice/POST";
import _h_integrations_xero_webhook_post_198 from "./api/integrations/xero/webhook/POST";
import _h_invoices_get_199 from "./api/invoices/GET";
import _h_invoices_post_200 from "./api/invoices/POST";
import _h_invoices_id_delete_201 from "./api/invoices/[id]/DELETE";
import _h_invoices_id_get_202 from "./api/invoices/[id]/GET";
import _h_invoices_id_put_203 from "./api/invoices/[id]/PUT";
import _h_invoices_id_duplicate_post_204 from "./api/invoices/[id]/duplicate/POST";
import _h_invoices_id_export_pdf_get_205 from "./api/invoices/[id]/export-pdf/GET";
import _h_invoices_id_mark_sent_post_206 from "./api/invoices/[id]/mark-sent/POST";
import _h_invoices_id_record_payment_post_207 from "./api/invoices/[id]/record-payment/POST";
import _h_invoices_id_void_post_208 from "./api/invoices/[id]/void/POST";
import _h_job_forms_id_delete_209 from "./api/job-forms/[id]/DELETE";
import _h_job_forms_id_get_210 from "./api/job-forms/[id]/GET";
import _h_job_forms_id_put_211 from "./api/job-forms/[id]/PUT";
import _h_job_forms_id_reset_post_212 from "./api/job-forms/[id]/reset/POST";
import _h_job_forms_id_share_delete_213 from "./api/job-forms/[id]/share/DELETE";
import _h_job_forms_id_share_get_214 from "./api/job-forms/[id]/share/GET";
import _h_job_forms_id_share_post_215 from "./api/job-forms/[id]/share/POST";
import _h_jobs_get_216 from "./api/jobs/GET";
import _h_jobs_post_217 from "./api/jobs/POST";
import _h_jobs_id_get_218 from "./api/jobs/[id]/GET";
import _h_jobs_id_put_219 from "./api/jobs/[id]/PUT";
import _h_jobs_id_costs_get_220 from "./api/jobs/[id]/costs/GET";
import _h_jobs_id_costs_post_221 from "./api/jobs/[id]/costs/POST";
import _h_jobs_id_costs_export_get_222 from "./api/jobs/[id]/costs/export/GET";
import _h_jobs_id_costs_costid_delete_223 from "./api/jobs/[id]/costs/[costId]/DELETE";
import _h_jobs_id_costs_costid_put_224 from "./api/jobs/[id]/costs/[costId]/PUT";
import _h_jobs_id_costs_costid_receipt_get_225 from "./api/jobs/[id]/costs/[costId]/receipt/GET";
import _h_jobs_id_costs_costid_receipt_post_226 from "./api/jobs/[id]/costs/[costId]/receipt/POST";
import _h_jobs_id_delays_get_227 from "./api/jobs/[id]/delays/GET";
import _h_jobs_id_delays_post_228 from "./api/jobs/[id]/delays/POST";
import _h_jobs_id_delays_delayid_delete_229 from "./api/jobs/[id]/delays/[delayId]/DELETE";
import _h_jobs_id_delays_delayid_put_230 from "./api/jobs/[id]/delays/[delayId]/PUT";
import _h_jobs_id_files_get_231 from "./api/jobs/[id]/files/GET";
import _h_jobs_id_forms_get_232 from "./api/jobs/[id]/forms/GET";
import _h_jobs_id_forms_post_233 from "./api/jobs/[id]/forms/POST";
import _h_jobs_id_ledger_get_234 from "./api/jobs/[id]/ledger/GET";
import _h_jobs_id_ledger_post_235 from "./api/jobs/[id]/ledger/POST";
import _h_jobs_id_ledger_export_get_236 from "./api/jobs/[id]/ledger/export/GET";
import _h_jobs_id_ledger_entryid_delete_238 from "./api/jobs/[id]/ledger/[entryId]/DELETE";
import _h_jobs_id_ledger_entryid_put_239 from "./api/jobs/[id]/ledger/[entryId]/PUT";
import _h_jobs_id_ledger_entryid_correct_post_240 from "./api/jobs/[id]/ledger/[entryId]/correct/POST";
import _h_jobs_id_photos_get_241 from "./api/jobs/[id]/photos/GET";
import _h_jobs_id_photos_post_242 from "./api/jobs/[id]/photos/POST";
import _h_jobs_id_photos_photoid_delete_243 from "./api/jobs/[id]/photos/[photoId]/DELETE";
import _h_jobs_id_photos_photoid_patch_244 from "./api/jobs/[id]/photos/[photoId]/PATCH";
import _h_jobs_id_photos_photoid_download_get_245 from "./api/jobs/[id]/photos/[photoId]/download/GET";
import _h_jobs_id_photos_photoid_replace_post_246 from "./api/jobs/[id]/photos/[photoId]/replace/POST";
import _h_jobs_id_progress_get_247 from "./api/jobs/[id]/progress/GET";
import _h_jobs_id_progress_put_248 from "./api/jobs/[id]/progress/PUT";
import _h_jobs_id_progress_sync_post_249 from "./api/jobs/[id]/progress/sync/POST";
import _h_jobs_id_swms_get_256 from "./api/jobs/[id]/swms/GET";
import _h_jobs_id_swms_post_257 from "./api/jobs/[id]/swms/POST";
import _h_jobs_id_swms_swmsid_signoff_post_258 from "./api/jobs/[id]/swms/[swmsId]/signoff/POST";
import _h_jobs_id_todos_get_259 from "./api/jobs/[id]/todos/GET";
import _h_jobs_id_todos_post_260 from "./api/jobs/[id]/todos/POST";
import _h_jobs_id_todos_todoid_delete_261 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import _h_jobs_id_todos_todoid_put_262 from "./api/jobs/[id]/todos/[todoId]/PUT";
import _h_me_get_263 from "./api/me/GET";
import _h_me_put_264 from "./api/me/PUT";
import _h_me_2fa_disable_post_265 from "./api/me/2fa/disable/POST";
import _h_me_2fa_enable_post_266 from "./api/me/2fa/enable/POST";
import _h_me_2fa_setup_get_267 from "./api/me/2fa/setup/GET";
import _h_me_2fa_status_get_268 from "./api/me/2fa/status/GET";
import _h_me_2fa_verify_post_269 from "./api/me/2fa/verify/POST";
import _h_me_change_password_post_270 from "./api/me/change-password/POST";
import _h_me_email_status_get_271 from "./api/me/email-status/GET";
import _h_me_phone_get_272 from "./api/me/phone/GET";
import _h_me_phone_put_273 from "./api/me/phone/PUT";
import _h_notifications_prefs_get_301 from "./api/notifications/prefs/GET";
import _h_notifications_prefs_put_302 from "./api/notifications/prefs/PUT";
import _h_notifications_read_post_303 from "./api/notifications/read/POST";
import _h_owner_console_activity_get_304 from "./api/owner-console/activity/GET";
import _h_owner_console_cancellation_feedback_get_305 from "./api/owner-console/cancellation-feedback/GET";
import _h_owner_console_companies_get_306 from "./api/owner-console/companies/GET";
import _h_owner_console_companies_post_307 from "./api/owner-console/companies/POST";
import _h_owner_console_companies_usage_get_308 from "./api/owner-console/companies/usage/GET";
import _h_owner_console_companies_id_limits_put_309 from "./api/owner-console/companies/[id]/limits/PUT";
import _h_owner_console_form_templates_get_310 from "./api/owner-console/form-templates/GET";
import _h_owner_console_form_templates_post_311 from "./api/owner-console/form-templates/POST";
import _h_owner_console_starter_pack_get_312 from "./api/owner-console/starter-pack/GET";
import _h_owner_console_starter_pack_post_313 from "./api/owner-console/starter-pack/POST";
import _h_owner_console_stats_get_314 from "./api/owner-console/stats/GET";
import _h_owner_console_storage_get_315 from "./api/owner-console/storage/GET";
import _h_owner_console_users_get_317 from "./api/owner-console/users/GET";
import _h_owner_console_users_verify_post_318 from "./api/owner-console/users/verify/POST";
import _h_plan_manager_drawings_get_319 from "./api/plan-manager/drawings/GET";
import _h_plan_manager_drawings_post_320 from "./api/plan-manager/drawings/POST";
import _h_plan_manager_drawings_id_get_321 from "./api/plan-manager/drawings/[id]/GET";
import _h_plan_manager_drawings_id_annotations_put_322 from "./api/plan-manager/drawings/[id]/annotations/PUT";
import _h_plan_manager_drawings_id_archive_post_323 from "./api/plan-manager/drawings/[id]/archive/POST";
import _h_plan_manager_drawings_id_job_links_post_324 from "./api/plan-manager/drawings/[id]/job-links/POST";
import _h_plan_manager_drawings_id_pages_pageno_annotations_get_325 from "./api/plan-manager/drawings/[id]/pages/[pageNo]/annotations/GET";
import _h_plan_manager_drawings_id_permanent_delete_326 from "./api/plan-manager/drawings/[id]/permanent/DELETE";
import _h_plan_manager_drawings_id_restore_post_327 from "./api/plan-manager/drawings/[id]/restore/POST";
import _h_plan_manager_drawings_id_revisions_post_328 from "./api/plan-manager/drawings/[id]/revisions/POST";
import _h_plan_manager_drawings_id_revisions_revisionid_finalize_post_329 from "./api/plan-manager/drawings/[id]/revisions/[revisionId]/finalize/POST";
import _h_plan_manager_drawings_id_upload_post_330 from "./api/plan-manager/drawings/[id]/upload/POST";
import _h_plan_manager_share_post_331 from "./api/plan-manager/share/POST";
import _h_plan_manager_share_validate_get_332 from "./api/plan-manager/share/validate/GET";
import _h_portal_estimates_id_approve_post_333 from "./api/portal/estimates/[id]/approve/POST";
import _h_portal_invite_post_334 from "./api/portal/invite/POST";
import _h_portal_invoices_id_pay_post_335 from "./api/portal/invoices/[id]/pay/POST";
import _h_portal_jobs_get_336 from "./api/portal/jobs/GET";
import _h_portal_jobs_id_get_337 from "./api/portal/jobs/[id]/GET";
import _h_portal_migrate_post_338 from "./api/portal/migrate/POST";
import _h_portal_validate_post_339 from "./api/portal/validate/POST";
import _h_public_form_token_get_340 from "./api/public/form/[token]/GET";
import _h_public_form_token_submit_post_341 from "./api/public/form/[token]/submit/POST";
import _h_public_swms_token_get_342 from "./api/public/swms/[token]/GET";
import _h_public_swms_token_signoff_post_343 from "./api/public/swms/[token]/signoff/POST";
import _h_push_subscribe_delete_344 from "./api/push/subscribe/DELETE";
import _h_push_subscribe_post_345 from "./api/push/subscribe/POST";
import _h_push_vapid_key_get_346 from "./api/push/vapid-key/GET";
import _h_recipes_get_347 from "./api/recipes/GET";
import _h_recipes_post_348 from "./api/recipes/POST";
import _h_recipes_id_delete_349 from "./api/recipes/[id]/DELETE";
import _h_recipes_id_put_350 from "./api/recipes/[id]/PUT";
import _h_safety_ai_draft_post_351 from "./api/safety/ai/draft/POST";
import _h_safety_documents_get_352 from "./api/safety/documents/GET";
import _h_safety_documents_post_353 from "./api/safety/documents/POST";
import _h_safety_documents_id_delete_354 from "./api/safety/documents/[id]/DELETE";
import _h_safety_documents_id_download_get_355 from "./api/safety/documents/[id]/download/GET";
import _h_safety_generated_posters_get_356 from "./api/safety/generated-posters/GET";
import _h_safety_generated_posters_post_357 from "./api/safety/generated-posters/POST";
import _h_safety_generated_posters_id_delete_358 from "./api/safety/generated-posters/[id]/DELETE";
import _h_safety_job_safety_plans_get_359 from "./api/safety/job-safety-plans/GET";
import _h_safety_job_safety_plans_post_360 from "./api/safety/job-safety-plans/POST";
import _h_safety_job_safety_plans_id_delete_361 from "./api/safety/job-safety-plans/[id]/DELETE";
import _h_safety_job_safety_plans_id_put_362 from "./api/safety/job-safety-plans/[id]/PUT";
import _h_safety_job_swms_get_363 from "./api/safety/job-swms/GET";
import _h_safety_job_swms_post_364 from "./api/safety/job-swms/POST";
import _h_safety_job_swms_id_delete_365 from "./api/safety/job-swms/[id]/DELETE";
import _h_safety_job_swms_id_get_366 from "./api/safety/job-swms/[id]/GET";
import _h_safety_job_swms_id_put_367 from "./api/safety/job-swms/[id]/PUT";
import _h_safety_job_swms_id_share_token_post_368 from "./api/safety/job-swms/[id]/share-token/POST";
import _h_safety_job_swms_id_signoffs_get_369 from "./api/safety/job-swms/[id]/signoffs/GET";
import _h_safety_job_swms_id_signoffs_post_370 from "./api/safety/job-swms/[id]/signoffs/POST";
import _h_safety_job_swms_id_signoffs_signoffid_delete_371 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import _h_safety_plans_get_372 from "./api/safety/plans/GET";
import _h_safety_plans_post_373 from "./api/safety/plans/POST";
import _h_safety_plans_seed_post_374 from "./api/safety/plans/seed/POST";
import _h_safety_plans_id_delete_375 from "./api/safety/plans/[id]/DELETE";
import _h_safety_plans_id_put_376 from "./api/safety/plans/[id]/PUT";
import _h_safety_plans_id_export_get_377 from "./api/safety/plans/[id]/export/GET";
import _h_safety_plans_id_pack_get_378 from "./api/safety/plans/[id]/pack/GET";
import _h_safety_posters_get_379 from "./api/safety/posters/GET";
import _h_safety_posters_post_380 from "./api/safety/posters/POST";
import _h_safety_posters_id_delete_381 from "./api/safety/posters/[id]/DELETE";
import _h_safety_swms_get_382 from "./api/safety/swms/GET";
import _h_safety_swms_post_383 from "./api/safety/swms/POST";
import _h_safety_swms_import_docx_post_384 from "./api/safety/swms/import-docx/POST";
import _h_safety_swms_seed_post_385 from "./api/safety/swms/seed/POST";
import _h_safety_swms_id_delete_386 from "./api/safety/swms/[id]/DELETE";
import _h_safety_swms_id_get_387 from "./api/safety/swms/[id]/GET";
import _h_safety_swms_id_put_388 from "./api/safety/swms/[id]/PUT";
import _h_safety_swms_id_duplicate_post_389 from "./api/safety/swms/[id]/duplicate/POST";
import _h_safety_swms_id_export_get_390 from "./api/safety/swms/[id]/export/GET";
import _h_scheduler_crew_get_391 from "./api/scheduler/crew/GET";
import _h_scheduler_jobs_get_392 from "./api/scheduler/jobs/GET";
import _h_scheduler_jobs_id_reschedule_patch_393 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
import _h_secure_share_get_394 from "./api/secure-share/GET";
import _h_secure_share_post_395 from "./api/secure-share/POST";
import _h_secure_share_id_delete_396 from "./api/secure-share/[id]/DELETE";
import _h_secure_share_token_get_397 from "./api/secure-share/[token]/GET";
import _h_secure_share_token_post_398 from "./api/secure-share/[token]/POST";
import _h_settings_backup_get_399 from "./api/settings/backup/GET";
import _h_settings_backup_post_400 from "./api/settings/backup/POST";
import _h_settings_backup_export_get_401 from "./api/settings/backup/export/GET";
import _h_settings_backup_run_post_402 from "./api/settings/backup/run/POST";
import _h_settings_backup_destination_get_403 from "./api/settings/backup-destination/GET";
import _h_settings_backup_destination_post_404 from "./api/settings/backup-destination/POST";
import _h_settings_dazza_ai_key_get_405 from "./api/settings/dazza-ai-key/GET";
import _h_settings_dazza_ai_key_post_406 from "./api/settings/dazza-ai-key/POST";
import _h_settings_file_transfer_backup_get_407 from "./api/settings/file-transfer-backup/GET";
import _h_settings_file_transfer_backup_post_408 from "./api/settings/file-transfer-backup/POST";
import _h_settings_retention_get_409 from "./api/settings/retention/GET";
import _h_settings_retention_post_410 from "./api/settings/retention/POST";
import _h_settings_storage_provider_get_411 from "./api/settings/storage-provider/GET";
import _h_settings_storage_provider_debug_get_412 from "./api/settings/storage-provider/debug/GET";
import _h_settings_storage_provider_test_post_413 from "./api/settings/storage-provider/test/POST";
import _h_settings_terminology_get_414 from "./api/settings/terminology/GET";
import _h_settings_terminology_post_415 from "./api/settings/terminology/POST";
import _h_settings_xero_credentials_get_416 from "./api/settings/xero-credentials/GET";
import _h_settings_xero_credentials_post_417 from "./api/settings/xero-credentials/POST";
import _h_share_token_get_418 from "./api/share/[token]/GET";
import _h_signup_post_419 from "./api/signup/POST";
import _h_stripe_create_checkout_session_post_420 from "./api/stripe/create-checkout-session/POST";
import _h_stripe_session_sessionid_get_421 from "./api/stripe/session/[sessionId]/GET";
import _h_subscription_create_checkout_post_422 from "./api/subscription/create-checkout/POST";
import _h_subscription_status_get_423 from "./api/subscription/status/GET";
import _h_subscription_webhook_post_424 from "./api/subscription/webhook/POST";
import _h_support_mode_audit_get_425 from "./api/support-mode/audit/GET";
import _h_support_mode_checklist_get_426 from "./api/support-mode/checklist/GET";
import _h_support_mode_checklist_put_427 from "./api/support-mode/checklist/PUT";
import _h_support_mode_enter_post_428 from "./api/support-mode/enter/POST";
import _h_support_mode_exit_post_429 from "./api/support-mode/exit/POST";
import _h_support_mode_status_get_430 from "./api/support-mode/status/GET";
import _h_takeoff_pad_get_431 from "./api/takeoff-pad/GET";
import _h_takeoff_pad_put_432 from "./api/takeoff-pad/PUT";
import _h_team_get_433 from "./api/team/GET";
import _h_team_invite_post_434 from "./api/team/invite/POST";
import _h_team_invites_get_435 from "./api/team/invites/GET";
import _h_team_invites_post_436 from "./api/team/invites/POST";
import _h_team_invites_id_cancel_post_437 from "./api/team/invites/[id]/cancel/POST";
import _h_team_invites_id_resend_post_438 from "./api/team/invites/[id]/resend/POST";
import _h_team_members_get_439 from "./api/team/members/GET";
import _h_team_resend_verification_post_440 from "./api/team/resend-verification/POST";
import _h_team_schedule_migrate_post_441 from "./api/team/schedule/migrate/POST";
import _h_team_shifts_get_442 from "./api/team/shifts/GET";
import _h_team_shifts_post_443 from "./api/team/shifts/POST";
import _h_team_shifts_id_delete_444 from "./api/team/shifts/[id]/DELETE";
import _h_team_shifts_id_put_445 from "./api/team/shifts/[id]/PUT";
import _h_team_time_entries_get_446 from "./api/team/time-entries/GET";
import _h_team_time_entries_post_447 from "./api/team/time-entries/POST";
import _h_team_time_entries_export_get_448 from "./api/team/time-entries/export/GET";
import _h_team_time_entries_id_put_449 from "./api/team/time-entries/[id]/PUT";
import _h_team_verify_user_post_450 from "./api/team/verify-user/POST";
import _h_team_id_delete_451 from "./api/team/[id]/DELETE";
import _h_team_id_put_452 from "./api/team/[id]/PUT";
import _h_usage_get_453 from "./api/usage/GET";
...
app.get("/api/asset-manager/assets", _h_asset_manager_assets_get_1);
app.post("/api/asset-manager/assets", _h_asset_manager_assets_post_2);
app.get("/api/asset-manager/assets/:id", _h_asset_manager_assets_id_get_3);
app.patch("/api/asset-manager/assets/:id", _h_asset_manager_assets_id_patch_4);
app.post("/api/asset-manager/assets/:id/archive", _h_asset_manager_assets_id_archive_post_5);
app.delete("/api/asset-manager/assets/:id/permanent", _h_asset_manager_assets_id_permanent_delete_6);
app.post("/api/asset-manager/assets/:id/restore", _h_asset_manager_assets_id_restore_post_7);
app.patch("/api/asset-manager/defects/:id", _h_asset_manager_defects_id_patch_8);
app.post("/api/asset-manager/defects/:id/archive", _h_asset_manager_defects_id_archive_post_9);
app.get("/api/asset-manager/inspections", _h_asset_manager_inspections_get_10);
app.post("/api/asset-manager/inspections", _h_asset_manager_inspections_post_11);
app.get("/api/asset-manager/inspections/:id", _h_asset_manager_inspections_id_get_12);
app.patch("/api/asset-manager/inspections/:id", _h_asset_manager_inspections_id_patch_13);
app.post("/api/asset-manager/inspections/:id/archive", _h_asset_manager_inspections_id_archive_post_14);
app.post("/api/asset-manager/inspections/:id/closeout", _h_asset_manager_inspections_id_closeout_post_15);
app.post("/api/asset-manager/inspections/:id/defects", _h_asset_manager_inspections_id_defects_post_16);
app.delete("/api/asset-manager/inspections/:id/permanent", _h_asset_manager_inspections_id_permanent_delete_17);
app.post("/api/asset-manager/inspections/:id/photos", _h_asset_manager_inspections_id_photos_post_18);
app.post("/api/asset-manager/inspections/:id/report/share", _h_asset_manager_inspections_id_report_share_post_19);
app.post("/api/asset-manager/inspections/:id/restore", _h_asset_manager_inspections_id_restore_post_20);
app.post("/api/asset-manager/inspections/:id/tenders", _h_asset_manager_inspections_id_tenders_post_21);
app.get("/api/asset-manager/monitoring", _h_asset_manager_monitoring_get_22);
app.get("/api/asset-manager/reports/:shareToken", _h_asset_manager_reports_sharetoken_get_23);
app.patch("/api/asset-manager/tenders/:id", _h_asset_manager_tenders_id_patch_24);
app.post("/api/asset-manager/tenders/:id/complete", _h_asset_manager_tenders_id_complete_post_25);
app.post("/api/asset-manager/tenders/:id/contracts", _h_asset_manager_tenders_id_contracts_post_26);
app.post("/api/auth/change-email", _h_auth_change_email_post_27);
app.post("/api/auth/change-password", _h_auth_change_password_post_28);
app.post("/api/auth/check-signup-status", _h_auth_check_signup_status_post_29);
app.post("/api/auth/forgot-password", _h_auth_forgot_password_post_30);
app.post("/api/auth/pin-login", _h_auth_pin_login_post_31);
app.post("/api/auth/resend-verification", _h_auth_resend_verification_post_32);
app.post("/api/auth/reset-password", _h_auth_reset_password_post_33);
app.post("/api/auth/resume-signup", _h_auth_resume_signup_post_34);
app.post("/api/auth/self-verify", _h_auth_self_verify_post_35);
app.post("/api/auth/send-sms-code", _h_auth_send_sms_code_post_36);
app.get("/api/auth/sms-configured", _h_auth_sms_configured_get_37);
app.post("/api/auth/sms-recovery", _h_auth_sms_recovery_post_38);
app.get("/api/auth/trusted-devices", _h_auth_trusted_devices_get_39);
app.post("/api/auth/trusted-devices", _h_auth_trusted_devices_post_40);
app.delete("/api/auth/trusted-devices/:deviceId", _h_auth_trusted_devices_deviceid_delete_41);
app.get("/api/auth/validate-reset-token", _h_auth_validate_reset_token_get_42);
app.post("/api/auth/verify-email", _h_auth_verify_email_post_43);
app.post("/api/auth/verify-sms-code", _h_auth_verify_sms_code_post_44);
app.get("/api/auth/:action", _h_auth_action_get_45);
app.post("/api/auth/:action", _h_auth_action_post_46);
app.get("/api/auth/:action/:detail", _h_auth_action_detail_get_47);
app.post("/api/auth/:action/:detail", _h_auth_action_detail_post_48);
app.post("/api/billing/cancel-subscription", _h_billing_cancel_subscription_post_49);
app.post("/api/billing/cancellation-feedback", _h_billing_cancellation_feedback_post_50);
app.post("/api/billing/customer-portal", _h_billing_customer_portal_post_51);
app.post("/api/billing/reactivate-subscription", _h_billing_reactivate_subscription_post_52);
app.post("/api/billing/upgrade-subscription", _h_billing_upgrade_subscription_post_53);
app.get("/api/company", _h_company_get_54);
app.put("/api/company", _h_company_put_55);
app.post("/api/company/logo", _h_company_logo_post_56);
app.get("/api/company-settings", _h_company_settings_get_57);
app.put("/api/company-settings", _h_company_settings_put_58);
app.post("/api/contact", _h_contact_post_59);
app.get("/api/cost-guide", _h_cost_guide_get_60);
app.post("/api/cost-guide", _h_cost_guide_post_61);
app.get("/api/cost-guide/export-csv", _h_cost_guide_export_csv_get_62);
app.post("/api/cost-guide/import-csv", _h_cost_guide_import_csv_post_63);
app.delete("/api/cost-guide/:id", _h_cost_guide_id_delete_64);
app.put("/api/cost-guide/:id", _h_cost_guide_id_put_65);
app.get("/api/customers", _h_customers_get_66);
app.post("/api/customers", _h_customers_post_67);
app.delete("/api/customers/:id", _h_customers_id_delete_68);
app.get("/api/customers/:id", _h_customers_id_get_69);
app.put("/api/customers/:id", _h_customers_id_put_70);
app.get("/api/dashboard/kpi", _h_dashboard_kpi_get_71);
app.get("/api/dashboard/setup-check", _h_dashboard_setup_check_get_72);
app.get("/api/dashboard/todos", _h_dashboard_todos_get_73);
app.post("/api/dazza/annette", _h_dazza_annette_post_0);
app.post("/api/dazza/brain/hive/approve", _h_dazza_brain_hive_approve_post_75);
app.post("/api/dazza/brain/hive/reject", _h_dazza_brain_hive_reject_post_76);
app.get("/api/dazza/brain/status", _h_dazza_brain_status_get_77);
...
app.get("/api/dazza/context", _h_dazza_context_get_81);
app.get("/api/dazza/key-status", _h_dazza_key_status_get_82);
app.get("/api/dazza/knowledge", _h_dazza_knowledge_get_83);
app.post("/api/dazza/knowledge", _h_dazza_knowledge_post_84);
app.delete("/api/dazza/knowledge/:id", _h_dazza_knowledge_id_delete_85);
app.put("/api/dazza/knowledge/:id", _h_dazza_knowledge_id_put_86);
app.get("/api/developer/activity-log", _h_developer_activity_log_get_87);
app.get("/api/developer/audit-log", _h_developer_audit_log_get_88);
app.post("/api/developer/companies/:id/archive", _h_developer_companies_id_archive_post_89);
app.get("/api/developer/company-health", _h_developer_company_health_get_90);
app.get("/api/developer/email-log", _h_developer_email_log_get_91);
app.get("/api/developer/email-settings", _h_developer_email_settings_get_92);
app.put("/api/developer/email-settings", _h_developer_email_settings_put_93);
app.post("/api/developer/email-settings/test", _h_developer_email_settings_test_post_94);
app.get("/api/developer/support-notes", _h_developer_support_notes_get_95);
app.post("/api/developer/support-notes", _h_developer_support_notes_post_96);
app.delete("/api/developer/support-notes/:id", _h_developer_support_notes_id_delete_97);
app.post("/api/developer/users/:id/assign-company", _h_developer_users_id_assign_company_post_98);
app.post("/api/developer/users/:id/deactivate", _h_developer_users_id_deactivate_post_99);
app.post("/api/developer/users/:id/delete-orphan", _h_developer_users_id_delete_orphan_post_100);
app.post("/api/developer/users/:id/force-temp-password", _h_developer_users_id_force_temp_password_post_101);
app.delete("/api/developer/users/:id/impersonate", _h_developer_users_id_impersonate_delete_102);
app.post("/api/developer/users/:id/impersonate", _h_developer_users_id_impersonate_post_103);
app.post("/api/developer/users/:id/reactivate", _h_developer_users_id_reactivate_post_104);
app.post("/api/developer/users/:id/resend-verification", _h_developer_users_id_resend_verification_post_105);
app.put("/api/developer/users/:id/role", _h_developer_users_id_role_put_106);
app.post("/api/developer/users/:id/send-reset-email", _h_developer_users_id_send_reset_email_post_107);
app.delete("/api/developer/users/:id/sessions", _h_developer_users_id_sessions_delete_108);
app.get("/api/developer/users/:id/sessions", _h_developer_users_id_sessions_get_109);
app.post("/api/developer/users/:id/unlock-account", _h_developer_users_id_unlock_account_post_110);
app.get("/api/document-templates", _h_document_templates_get_111);
app.post("/api/document-templates", _h_document_templates_post_112);
app.delete("/api/document-templates/:id", _h_document_templates_id_delete_113);
app.get("/api/document-templates/:id", _h_document_templates_id_get_114);
app.put("/api/document-templates/:id", _h_document_templates_id_put_115);
app.post("/api/document-templates/:id/import-docx", _h_document_templates_id_import_docx_post_116);
app.get("/api/documents", _h_documents_get_117);
app.get("/api/documents/share/:token", _h_documents_share_token_get_118);
app.post("/api/documents/share/:token", _h_documents_share_token_post_119);
app.get("/api/documents/:id", _h_documents_id_get_120);
app.put("/api/documents/:id", _h_documents_id_put_121);
app.get("/api/documents/:id/events", _h_documents_id_events_get_122);
app.delete("/api/documents/:id/share", _h_documents_id_share_delete_123);
app.post("/api/documents/:id/share", _h_documents_id_share_post_124);
app.get("/api/drawings", _h_drawings_get_125);
app.post("/api/drawings", _h_drawings_post_126);
app.post("/api/drawings/upload", _h_drawings_upload_post_127);
app.delete("/api/drawings/:id", _h_drawings_id_delete_128);
app.patch("/api/drawings/:id", _h_drawings_id_patch_129);
app.post("/api/drawings/:id/markup", _h_drawings_id_markup_post_130);
app.get("/api/estimates", _h_estimates_get_131);
app.post("/api/estimates", _h_estimates_post_132);
app.delete("/api/estimates/:id", _h_estimates_id_delete_133);
app.get("/api/estimates/:id", _h_estimates_id_get_134);
app.put("/api/estimates/:id", _h_estimates_id_put_135);
app.get("/api/estimates/:id/export-csv", _h_estimates_id_export_csv_get_136);
app.get("/api/estimates/:id/export-pdf", _h_estimates_id_export_pdf_get_137);
app.post("/api/estimates/:id/import-csv", _h_estimates_id_import_csv_post_138);
app.get("/api/external/form/:token", _h_external_form_token_get_139);
app.post("/api/external/form/:token", _h_external_form_token_post_140);
app.get("/api/files", _h_files_get_141);
app.post("/api/files", _h_files_post_142);
app.delete("/api/files/:id", _h_files_id_delete_143);
app.get("/api/files/:id/download", _h_files_id_download_get_144);
app.get("/api/fleet", _h_fleet_get_145);
app.post("/api/fleet", _h_fleet_post_146);
app.post("/api/fleet/driver-sessions", _h_fleet_driver_sessions_post_147);
app.get("/api/fleet/driver-sessions/active", _h_fleet_driver_sessions_active_get_148);
app.post("/api/fleet/driver-sessions/:id/stop", _h_fleet_driver_sessions_id_stop_post_149);
app.get("/api/fleet/flags", _h_fleet_flags_get_150);
app.delete("/api/fleet/service-logs/:logId", _h_fleet_service_logs_logid_delete_151);
app.patch("/api/fleet/service-logs/:logId", _h_fleet_service_logs_logid_patch_152);
app.get("/api/fleet/vehicles", _h_fleet_vehicles_get_153);
app.delete("/api/fleet/:id", _h_fleet_id_delete_154);
app.get("/api/fleet/:id", _h_fleet_id_get_155);
app.put("/api/fleet/:id", _h_fleet_id_put_156);
app.get("/api/fleet/:id/driver-sessions", _h_fleet_id_driver_sessions_get_157);
app.get("/api/fleet/:id/files", _h_fleet_id_files_get_158);
app.get("/api/fleet/:id/prestarts", _h_fleet_id_prestarts_get_159);
app.post("/api/fleet/:id/prestarts", _h_fleet_id_prestarts_post_160);
app.get("/api/fleet/:id/service-logs", _h_fleet_id_service_logs_get_161);
app.post("/api/fleet/:id/service-logs", _h_fleet_id_service_logs_post_162);
app.get("/api/form-templates", _h_form_templates_get_163);
app.post("/api/form-templates", _h_form_templates_post_164);
app.post("/api/form-templates/seed", _h_form_templates_seed_post_4);
app.delete("/api/form-templates/:id", _h_form_templates_id_delete_166);
app.put("/api/form-templates/:id", _h_form_templates_id_put_167);
app.get("/api/forms/submissions", _h_forms_submissions_get_168);
app.post("/api/forms/templates/:id/share-link", _h_forms_templates_id_share_link_post_169);
app.get("/api/forms/:id/fields", _h_forms_id_fields_get_170);
app.post("/api/forms/:id/fields", _h_forms_id_fields_post_171);
app.post("/api/forms/:id/fields/reorder", _h_forms_id_fields_reorder_post_172);
app.delete("/api/forms/:id/fields/:fieldId", _h_forms_id_fields_fieldid_delete_173);
app.patch("/api/forms/:id/fields/:fieldId", _h_forms_id_fields_fieldid_patch_174);
app.post("/api/forms/:id/fields/:fieldId/thumbnail", _h_forms_id_fields_fieldid_thumbnail_post_175);
app.get("/api/health", _h_health_get_176);
app.get("/api/integrations/myob/auth-url", _h_integrations_myob_auth_url_get_177);
app.get("/api/integrations/myob/callback", _h_integrations_myob_callback_get_178);
app.post("/api/integrations/myob/disconnect", _h_integrations_myob_disconnect_post_179);
app.get("/api/integrations/myob/status", _h_integrations_myob_status_get_180);
app.post("/api/integrations/myob/sync-invoice", _h_integrations_myob_sync_invoice_post_181);
app.get("/api/integrations/onedrive/auth-url", _h_integrations_onedrive_auth_url_get_182);
app.get("/api/integrations/onedrive/callback", _h_integrations_onedrive_callback_get_183);
app.post("/api/integrations/onedrive/disconnect", _h_integrations_onedrive_disconnect_post_184);
app.get("/api/integrations/onedrive/status", _h_integrations_onedrive_status_get_185);
app.post("/api/integrations/onedrive/upload-file", _h_integrations_onedrive_upload_file_post_186);
app.get("/api/integrations/qbo/auth-url", _h_integrations_qbo_auth_url_get_187);
app.get("/api/integrations/qbo/callback", _h_integrations_qbo_callback_get_188);
app.post("/api/integrations/qbo/disconnect", _h_integrations_qbo_disconnect_post_189);
app.get("/api/integrations/qbo/status", _h_integrations_qbo_status_get_190);
app.post("/api/integrations/qbo/sync-invoice", _h_integrations_qbo_sync_invoice_post_191);
app.get("/api/integrations/xero/auth-url", _h_integrations_xero_auth_url_get_192);
app.get("/api/integrations/xero/callback", _h_integrations_xero_callback_get_193);
app.post("/api/integrations/xero/disconnect", _h_integrations_xero_disconnect_post_194);
app.get("/api/integrations/xero/status", _h_integrations_xero_status_get_195);
app.post("/api/integrations/xero/sync-customer", _h_integrations_xero_sync_customer_post_196);
app.post("/api/integrations/xero/sync-invoice", _h_integrations_xero_sync_invoice_post_197);
app.post("/api/integrations/xero/webhook", _h_integrations_xero_webhook_post_198);
app.get("/api/invoices", _h_invoices_get_199);
app.post("/api/invoices", _h_invoices_post_200);
app.delete("/api/invoices/:id", _h_invoices_id_delete_201);
app.get("/api/invoices/:id", _h_invoices_id_get_202);
app.put("/api/invoices/:id", _h_invoices_id_put_203);
app.post("/api/invoices/:id/duplicate", _h_invoices_id_duplicate_post_204);
app.get("/api/invoices/:id/export-pdf", _h_invoices_id_export_pdf_get_205);
app.post("/api/invoices/:id/mark-sent", _h_invoices_id_mark_sent_post_206);
app.post("/api/invoices/:id/record-payment", _h_invoices_id_record_payment_post_207);
app.post("/api/invoices/:id/void", _h_invoices_id_void_post_208);
app.delete("/api/job-forms/:id", _h_job_forms_id_delete_209);
app.get("/api/job-forms/:id", _h_job_forms_id_get_210);
app.put("/api/job-forms/:id", _h_job_forms_id_put_211);
app.post("/api/job-forms/:id/reset", _h_job_forms_id_reset_post_212);
app.delete("/api/job-forms/:id/share", _h_job_forms_id_share_delete_213);
app.get("/api/job-forms/:id/share", _h_job_forms_id_share_get_214);
app.post("/api/job-forms/:id/share", _h_job_forms_id_share_post_215);
app.get("/api/jobs", _h_jobs_get_216);
app.post("/api/jobs", _h_jobs_post_217);
app.get("/api/jobs/:id", _h_jobs_id_get_218);
app.put("/api/jobs/:id", _h_jobs_id_put_219);
app.get("/api/jobs/:id/costs", _h_jobs_id_costs_get_220);
app.post("/api/jobs/:id/costs", _h_jobs_id_costs_post_221);
app.get("/api/jobs/:id/costs/export", _h_jobs_id_costs_export_get_222);
app.delete("/api/jobs/:id/costs/:costId", _h_jobs_id_costs_costid_delete_223);
app.put("/api/jobs/:id/costs/:costId", _h_jobs_id_costs_costid_put_224);
app.get("/api/jobs/:id/costs/:costId/receipt", _h_jobs_id_costs_costid_receipt_get_225);
app.post("/api/jobs/:id/costs/:costId/receipt", _h_jobs_id_costs_costid_receipt_post_226);
app.get("/api/jobs/:id/delays", _h_jobs_id_delays_get_227);
app.post("/api/jobs/:id/delays", _h_jobs_id_delays_post_228);
app.delete("/api/jobs/:id/delays/:delayId", _h_jobs_id_delays_delayid_delete_229);
app.put("/api/jobs/:id/delays/:delayId", _h_jobs_id_delays_delayid_put_230);
app.get("/api/jobs/:id/files", _h_jobs_id_files_get_231);
app.get("/api/jobs/:id/forms", _h_jobs_id_forms_get_232);
app.post("/api/jobs/:id/forms", _h_jobs_id_forms_post_233);
app.get("/api/jobs/:id/ledger", _h_jobs_id_ledger_get_234);
app.post("/api/jobs/:id/ledger", _h_jobs_id_ledger_post_235);
app.get("/api/jobs/:id/ledger/export", _h_jobs_id_ledger_export_get_236);
app.post("/api/jobs/:id/ledger/sync", _h_jobs_id_ledger_sync_post_5);
app.delete("/api/jobs/:id/ledger/:entryId", _h_jobs_id_ledger_entryid_delete_238);
app.put("/api/jobs/:id/ledger/:entryId", _h_jobs_id_ledger_entryid_put_239);
app.post("/api/jobs/:id/ledger/:entryId/correct", _h_jobs_id_ledger_entryid_correct_post_240);
app.get("/api/jobs/:id/photos", _h_jobs_id_photos_get_241);
app.post("/api/jobs/:id/photos", _h_jobs_id_photos_post_242);
app.delete("/api/jobs/:id/photos/:photoId", _h_jobs_id_photos_photoid_delete_243);
app.patch("/api/jobs/:id/photos/:photoId", _h_jobs_id_photos_photoid_patch_244);
app.get("/api/jobs/:id/photos/:photoId/download", _h_jobs_id_photos_photoid_download_get_245);
app.post("/api/jobs/:id/photos/:photoId/replace", _h_jobs_id_photos_photoid_replace_post_246);
app.get("/api/jobs/:id/progress", _h_jobs_id_progress_get_247);
app.put("/api/jobs/:id/progress", _h_jobs_id_progress_put_248);
app.post("/api/jobs/:id/progress/sync", _h_jobs_id_progress_sync_post_249);
app.get("/api/jobs/:id/purchase-orders", _h_jobs_id_purchase_orders_get_6);
app.post("/api/jobs/:id/purchase-orders", _h_jobs_id_purchase_orders_post_7);
app.delete("/api/jobs/:id/purchase-orders/:poId", _h_jobs_id_purchase_orders_poid_delete_8);
app.get("/api/jobs/:id/purchase-orders/:poId", _h_jobs_id_purchase_orders_poid_get_9);
app.put("/api/jobs/:id/purchase-orders/:poId", _h_jobs_id_purchase_orders_poid_put_10);
app.get("/api/jobs/:id/purchase-orders/:poId/pdf", _h_jobs_id_purchase_orders_poid_pdf_get_11);
app.get("/api/jobs/:id/swms", _h_jobs_id_swms_get_256);
app.post("/api/jobs/:id/swms", _h_jobs_id_swms_post_257);
app.post("/api/jobs/:id/swms/:swmsId/signoff", _h_jobs_id_swms_swmsid_signoff_post_258);
app.get("/api/jobs/:id/todos", _h_jobs_id_todos_get_259);
app.post("/api/jobs/:id/todos", _h_jobs_id_todos_post_260);
app.delete("/api/jobs/:id/todos/:todoId", _h_jobs_id_todos_todoid_delete_261);
app.put("/api/jobs/:id/todos/:todoId", _h_jobs_id_todos_todoid_put_262);
app.get("/api/me", _h_me_get_263);
app.put("/api/me", _h_me_put_264);
app.post("/api/me/2fa/disable", _h_me_2fa_disable_post_265);
app.post("/api/me/2fa/enable", _h_me_2fa_enable_post_266);
app.get("/api/me/2fa/setup", _h_me_2fa_setup_get_267);
app.get("/api/me/2fa/status", _h_me_2fa_status_get_268);
app.post("/api/me/2fa/verify", _h_me_2fa_verify_post_269);
app.post("/api/me/change-password", _h_me_change_password_post_270);
app.get("/api/me/email-status", _h_me_email_status_get_271);
app.get("/api/me/phone", _h_me_phone_get_272);
app.put("/api/me/phone", _h_me_phone_put_273);
app.post("/api/migrate-account-recovery", _h_migrate_account_recovery_post_12);
app.post("/api/migrate-company-settings", _h_migrate_company_settings_post_13);
app.post("/api/migrate-dazza-audit", _h_migrate_dazza_audit_post_14);
app.post("/api/migrate-dazza-knowledge", _h_migrate_dazza_knowledge_post_15);
app.post("/api/migrate-estimates", _h_migrate_estimates_post_16);
app.post("/api/migrate-estimating-library", _h_migrate_estimating_library_post_17);
app.post("/api/migrate-files", _h_migrate_files_post_18);
app.post("/api/migrate-fleet", _h_migrate_fleet_post_19);
app.post("/api/migrate-fleet-driver-sessions", _h_migrate_fleet_driver_sessions_post_20);
app.post("/api/migrate-form-fields", _h_migrate_form_fields_post_21);
app.post("/api/migrate-form-logic", _h_migrate_form_logic_post_22);
app.post("/api/migrate-form-templates", _h_migrate_form_templates_post_23);
app.post("/api/migrate-job-forms", _h_migrate_job_forms_post_24);
app.post("/api/migrate-job-photos", _h_migrate_job_photos_post_25);
app.post("/api/migrate-job-tabs", _h_migrate_job_tabs_post_26);
app.post("/api/migrate-jobs", _h_migrate_jobs_post_27);
app.post("/api/migrate-notifications", _h_migrate_notifications_post_28);
app.post("/api/migrate-owner-console", _h_migrate_owner_console_post_29);
app.post("/api/migrate-owner-role", _h_migrate_owner_role_post_30);
app.post("/api/migrate-pdf-settings", _h_migrate_pdf_settings_post_31);
app.post("/api/migrate-safety", _h_migrate_safety_post_32);
app.post("/api/migrate-starter-pack", _h_migrate_starter_pack_post_33);
app.post("/api/migrate-subscriptions", _h_migrate_subscriptions_post_34);
app.post("/api/migrate-support-mode", _h_migrate_support_mode_post_35);
app.post("/api/migrate-takeoff-pad", _h_migrate_takeoff_pad_post_36);
app.post("/api/migrate-team", _h_migrate_team_post_37);
app.get("/api/notifications/alerts", _h_notifications_alerts_get_38);
app.get("/api/notifications/prefs", _h_notifications_prefs_get_301);
app.put("/api/notifications/prefs", _h_notifications_prefs_put_302);
app.post("/api/notifications/read", _h_notifications_read_post_303);
app.get("/api/owner-console/activity", _h_owner_console_activity_get_304);
app.get("/api/owner-console/cancellation-feedback", _h_owner_console_cancellation_feedback_get_305);
app.get("/api/owner-console/companies", _h_owner_console_companies_get_306);
app.post("/api/owner-console/companies", _h_owner_console_companies_post_307);
app.get("/api/owner-console/companies/usage", _h_owner_console_companies_usage_get_308);
app.put("/api/owner-console/companies/:id/limits", _h_owner_console_companies_id_limits_put_309);
app.get("/api/owner-console/form-templates", _h_owner_console_form_templates_get_310);
app.post("/api/owner-console/form-templates", _h_owner_console_form_templates_post_311);
app.get("/api/owner-console/starter-pack", _h_owner_console_starter_pack_get_312);
app.post("/api/owner-console/starter-pack", _h_owner_console_starter_pack_post_313);
app.get("/api/owner-console/stats", _h_owner_console_stats_get_314);
app.get("/api/owner-console/storage", _h_owner_console_storage_get_315);
app.post("/api/owner-console/system-ai/builtin-checks", _h_owner_console_system_ai_builtin_checks_post_39);
app.get("/api/owner-console/users", _h_owner_console_users_get_317);
app.post("/api/owner-console/users/verify", _h_owner_console_users_verify_post_318);
app.get("/api/plan-manager/drawings", _h_plan_manager_drawings_get_319);
app.post("/api/plan-manager/drawings", _h_plan_manager_drawings_post_320);
app.get("/api/plan-manager/drawings/:id", _h_plan_manager_drawings_id_get_321);
app.put("/api/plan-manager/drawings/:id/annotations", _h_plan_manager_drawings_id_annotations_put_322);
app.post("/api/plan-manager/drawings/:id/archive", _h_plan_manager_drawings_id_archive_post_323);
app.post("/api/plan-manager/drawings/:id/job-links", _h_plan_manager_drawings_id_job_links_post_324);
app.get("/api/plan-manager/drawings/:id/pages/:pageNo/annotations", _h_plan_manager_drawings_id_pages_pageno_annotations_get_325);
app.delete("/api/plan-manager/drawings/:id/permanent", _h_plan_manager_drawings_id_permanent_delete_326);
app.post("/api/plan-manager/drawings/:id/restore", _h_plan_manager_drawings_id_restore_post_327);
app.post("/api/plan-manager/drawings/:id/revisions", _h_plan_manager_drawings_id_revisions_post_328);
app.post("/api/plan-manager/drawings/:id/revisions/:revisionId/finalize", _h_plan_manager_drawings_id_revisions_revisionid_finalize_post_329);
app.post("/api/plan-manager/drawings/:id/upload", _h_plan_manager_drawings_id_upload_post_330);
app.post("/api/plan-manager/share", _h_plan_manager_share_post_331);
app.get("/api/plan-manager/share/validate", _h_plan_manager_share_validate_get_332);
app.post("/api/portal/estimates/:id/approve", _h_portal_estimates_id_approve_post_333);
app.post("/api/portal/invite", _h_portal_invite_post_334);
app.post("/api/portal/invoices/:id/pay", _h_portal_invoices_id_pay_post_335);
app.get("/api/portal/jobs", _h_portal_jobs_get_336);
app.get("/api/portal/jobs/:id", _h_portal_jobs_id_get_337);
app.post("/api/portal/migrate", _h_portal_migrate_post_338);
app.post("/api/portal/validate", _h_portal_validate_post_339);
app.get("/api/public/form/:token", _h_public_form_token_get_340);
app.post("/api/public/form/:token/submit", _h_public_form_token_submit_post_341);
app.get("/api/public/swms/:token", _h_public_swms_token_get_342);
app.post("/api/public/swms/:token/signoff", _h_public_swms_token_signoff_post_343);
app.delete("/api/push/subscribe", _h_push_subscribe_delete_344);
app.post("/api/push/subscribe", _h_push_subscribe_post_345);
app.get("/api/push/vapid-key", _h_push_vapid_key_get_346);
app.get("/api/recipes", _h_recipes_get_347);
app.post("/api/recipes", _h_recipes_post_348);
app.delete("/api/recipes/:id", _h_recipes_id_delete_349);
app.put("/api/recipes/:id", _h_recipes_id_put_350);
app.post("/api/safety/ai/draft", _h_safety_ai_draft_post_351);
app.get("/api/safety/documents", _h_safety_documents_get_352);
app.post("/api/safety/documents", _h_safety_documents_post_353);
app.delete("/api/safety/documents/:id", _h_safety_documents_id_delete_354);
app.get("/api/safety/documents/:id/download", _h_safety_documents_id_download_get_355);
app.get("/api/safety/generated-posters", _h_safety_generated_posters_get_356);
app.post("/api/safety/generated-posters", _h_safety_generated_posters_post_357);
app.delete("/api/safety/generated-posters/:id", _h_safety_generated_posters_id_delete_358);
app.get("/api/safety/job-safety-plans", _h_safety_job_safety_plans_get_359);
app.post("/api/safety/job-safety-plans", _h_safety_job_safety_plans_post_360);
app.delete("/api/safety/job-safety-plans/:id", _h_safety_job_safety_plans_id_delete_361);
app.put("/api/safety/job-safety-plans/:id", _h_safety_job_safety_plans_id_put_362);
app.get("/api/safety/job-swms", _h_safety_job_swms_get_363);
app.post("/api/safety/job-swms", _h_safety_job_swms_post_364);
app.delete("/api/safety/job-swms/:id", _h_safety_job_swms_id_delete_365);
app.get("/api/safety/job-swms/:id", _h_safety_job_swms_id_get_366);
app.put("/api/safety/job-swms/:id", _h_safety_job_swms_id_put_367);
app.post("/api/safety/job-swms/:id/share-token", _h_safety_job_swms_id_share_token_post_368);
app.get("/api/safety/job-swms/:id/signoffs", _h_safety_job_swms_id_signoffs_get_369);
app.post("/api/safety/job-swms/:id/signoffs", _h_safety_job_swms_id_signoffs_post_370);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", _h_safety_job_swms_id_signoffs_signoffid_delete_371);
app.get("/api/safety/plans", _h_safety_plans_get_372);
app.post("/api/safety/plans", _h_safety_plans_post_373);
app.post("/api/safety/plans/seed", _h_safety_plans_seed_post_374);
app.delete("/api/safety/plans/:id", _h_safety_plans_id_delete_375);
app.put("/api/safety/plans/:id", _h_safety_plans_id_put_376);
app.get("/api/safety/plans/:id/export", _h_safety_plans_id_export_get_377);
app.get("/api/safety/plans/:id/pack", _h_safety_plans_id_pack_get_378);
app.get("/api/safety/posters", _h_safety_posters_get_379);
app.post("/api/safety/posters", _h_safety_posters_post_380);
app.delete("/api/safety/posters/:id", _h_safety_posters_id_delete_381);
app.get("/api/safety/swms", _h_safety_swms_get_382);
app.post("/api/safety/swms", _h_safety_swms_post_383);
app.post("/api/safety/swms/import-docx", _h_safety_swms_import_docx_post_384);
app.post("/api/safety/swms/seed", _h_safety_swms_seed_post_385);
app.delete("/api/safety/swms/:id", _h_safety_swms_id_delete_386);
app.get("/api/safety/swms/:id", _h_safety_swms_id_get_387);
app.put("/api/safety/swms/:id", _h_safety_swms_id_put_388);
app.post("/api/safety/swms/:id/duplicate", _h_safety_swms_id_duplicate_post_389);
app.get("/api/safety/swms/:id/export", _h_safety_swms_id_export_get_390);
app.get("/api/scheduler/crew", _h_scheduler_crew_get_391);
app.get("/api/scheduler/jobs", _h_scheduler_jobs_get_392);
app.patch("/api/scheduler/jobs/:id/reschedule", _h_scheduler_jobs_id_reschedule_patch_393);
app.get("/api/secure-share", _h_secure_share_get_394);
app.post("/api/secure-share", _h_secure_share_post_395);
app.delete("/api/secure-share/:id", _h_secure_share_id_delete_396);
app.get("/api/secure-share/:token", _h_secure_share_token_get_397);
app.post("/api/secure-share/:token", _h_secure_share_token_post_398);
app.get("/api/settings/backup", _h_settings_backup_get_399);
app.post("/api/settings/backup", _h_settings_backup_post_400);
app.get("/api/settings/backup/export", _h_settings_backup_export_get_401);
app.post("/api/settings/backup/run", _h_settings_backup_run_post_402);
app.get("/api/settings/backup-destination", _h_settings_backup_destination_get_403);
app.post("/api/settings/backup-destination", _h_settings_backup_destination_post_404);
app.get("/api/settings/dazza-ai-key", _h_settings_dazza_ai_key_get_405);
app.post("/api/settings/dazza-ai-key", _h_settings_dazza_ai_key_post_406);
app.get("/api/settings/file-transfer-backup", _h_settings_file_transfer_backup_get_407);
app.post("/api/settings/file-transfer-backup", _h_settings_file_transfer_backup_post_408);
app.get("/api/settings/retention", _h_settings_retention_get_409);
app.post("/api/settings/retention", _h_settings_retention_post_410);
app.get("/api/settings/storage-provider", _h_settings_storage_provider_get_411);
app.get("/api/settings/storage-provider/debug", _h_settings_storage_provider_debug_get_412);
app.post("/api/settings/storage-provider/test", _h_settings_storage_provider_test_post_413);
app.get("/api/settings/terminology", _h_settings_terminology_get_414);
app.post("/api/settings/terminology", _h_settings_terminology_post_415);
app.get("/api/settings/xero-credentials", _h_settings_xero_credentials_get_416);
app.post("/api/settings/xero-credentials", _h_settings_xero_credentials_post_417);
app.get("/api/share/:token", _h_share_token_get_418);
app.post("/api/signup", _h_signup_post_419);
app.post("/api/stripe/create-checkout-session", _h_stripe_create_checkout_session_post_420);
app.get("/api/stripe/session/:sessionId", _h_stripe_session_sessionid_get_421);
app.post("/api/subscription/create-checkout", _h_subscription_create_checkout_post_422);
app.get("/api/subscription/status", _h_subscription_status_get_423);
app.post("/api/subscription/webhook", _h_subscription_webhook_post_424);
app.get("/api/support-mode/audit", _h_support_mode_audit_get_425);
app.get("/api/support-mode/checklist", _h_support_mode_checklist_get_426);
app.put("/api/support-mode/checklist", _h_support_mode_checklist_put_427);
app.post("/api/support-mode/enter", _h_support_mode_enter_post_428);
app.post("/api/support-mode/exit", _h_support_mode_exit_post_429);
app.get("/api/support-mode/status", _h_support_mode_status_get_430);
app.get("/api/takeoff-pad", _h_takeoff_pad_get_431);
app.put("/api/takeoff-pad", _h_takeoff_pad_put_432);
app.get("/api/team", _h_team_get_433);
app.post("/api/team/invite", _h_team_invite_post_434);
app.get("/api/team/invites", _h_team_invites_get_435);
app.post("/api/team/invites", _h_team_invites_post_436);
app.post("/api/team/invites/:id/cancel", _h_team_invites_id_cancel_post_437);
app.post("/api/team/invites/:id/resend", _h_team_invites_id_resend_post_438);
app.get("/api/team/members", _h_team_members_get_439);
app.post("/api/team/resend-verification", _h_team_resend_verification_post_440);
app.post("/api/team/schedule/migrate", _h_team_schedule_migrate_post_441);
app.get("/api/team/shifts", _h_team_shifts_get_442);
app.post("/api/team/shifts", _h_team_shifts_post_443);
app.delete("/api/team/shifts/:id", _h_team_shifts_id_delete_444);
app.put("/api/team/shifts/:id", _h_team_shifts_id_put_445);
app.get("/api/team/time-entries", _h_team_time_entries_get_446);
app.post("/api/team/time-entries", _h_team_time_entries_post_447);
app.get("/api/team/time-entries/export", _h_team_time_entries_export_get_448);
app.put("/api/team/time-entries/:id", _h_team_time_entries_id_put_449);
app.post("/api/team/verify-user", _h_team_verify_user_post_450);
app.delete("/api/team/:id", _h_team_id_delete_451);
app.put("/api/team/:id", _h_team_id_put_452);
app.get("/api/usage", _h_usage_get_453);
// </api-registrations>
