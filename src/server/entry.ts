...
import developer_support_notes_get_116 from "./api/developer/support-notes/GET";
import developer_support_notes_post_117 from "./api/developer/support-notes/POST";
import developer_support_notes_id_delete_118 from "./api/developer/support-notes/[id]/DELETE";
import developer_users_id_assign_company_post_119 from "./api/developer/users/[id]/assign-company/POST";
import developer_users_id_deactivate_post_120 from "./api/developer/users/[id]/deactivate/POST";
import developer_users_id_delete_orphan_post_121 from "./api/developer/users/[id]/delete-orphan/POST";
import developer_users_id_force_temp_password_post_122 from "./api/developer/users/[id]/force-temp-password/POST";
import developer_users_id_impersonate_delete_123 from "./api/developer/users/[id]/impersonate/DELETE";
import developer_users_id_impersonate_post_124 from "./api/developer/users/[id]/impersonate/POST";
import developer_users_id_reactivate_post_125 from "./api/developer/users/[id]/reactivate/POST";
import developer_users_id_resend_verification_post_126 from "./api/developer/users/[id]/resend-verification/POST";
import developer_users_id_role_put_127 from "./api/developer/users/[id]/role/PUT";
import developer_users_id_send_reset_email_post_128 from "./api/developer/users/[id]/send-reset-email/POST";
import developer_users_id_sessions_delete_129 from "./api/developer/users/[id]/sessions/DELETE";
import developer_users_id_sessions_get_130 from "./api/developer/users/[id]/sessions/GET";
import developer_users_id_unlock_account_post_131 from "./api/developer/users/[id]/unlock-account/POST";
import document_templates_get_132 from "./api/document-templates/GET";
import document_templates_post_133 from "./api/document-templates/POST";
import document_templates_id_delete_134 from "./api/document-templates/[id]/DELETE";
import document_templates_id_get_135 from "./api/document-templates/[id]/GET";
import document_templates_id_put_136 from "./api/document-templates/[id]/PUT";
import document_templates_id_duplicate_post_137 from "./api/document-templates/[id]/duplicate/POST";
import document_templates_id_export_docx_get_138 from "./api/document-templates/[id]/export/docx/GET";
import document_templates_id_export_pdf_get_139 from "./api/document-templates/[id]/export/pdf/GET";
import document_templates_id_import_blocks_post_140 from "./api/document-templates/[id]/import-blocks/POST";
import document_templates_id_import_docx_post_141 from "./api/document-templates/[id]/import-docx/POST";
import document_templates_id_import_pdf_post_142 from "./api/document-templates/[id]/import-pdf/POST";
import document_templates_id_publish_to_library_post_143 from "./api/document-templates/[id]/publish-to-library/POST";
import documents_get_144 from "./api/documents/GET";
import documents_share_token_get_145 from "./api/documents/share/[token]/GET";
import documents_share_token_post_146 from "./api/documents/share/[token]/POST";
import documents_id_get_147 from "./api/documents/[id]/GET";
import documents_id_put_148 from "./api/documents/[id]/PUT";
import documents_id_events_get_149 from "./api/documents/[id]/events/GET";
import documents_id_share_delete_150 from "./api/documents/[id]/share/DELETE";
import documents_id_share_post_151 from "./api/documents/[id]/share/POST";
import drawings_get_152 from "./api/drawings/GET";
import drawings_post_153 from "./api/drawings/POST";
import drawings_upload_post_154 from "./api/drawings/upload/POST";
import drawings_id_delete_155 from "./api/drawings/[id]/DELETE";
import drawings_id_patch_156 from "./api/drawings/[id]/PATCH";
import drawings_id_markup_post_157 from "./api/drawings/[id]/markup/POST";
import emergency_alerts_get_158 from "./api/emergency-alerts/GET";
import emergency_alerts_post_159 from "./api/emergency-alerts/POST";
import emergency_alerts_id_put_160 from "./api/emergency-alerts/[id]/PUT";
import estimates_get_161 from "./api/estimates/GET";
import estimates_post_162 from "./api/estimates/POST";
import estimates_id_delete_163 from "./api/estimates/[id]/DELETE";
import estimates_id_get_164 from "./api/estimates/[id]/GET";
import estimates_id_put_165 from "./api/estimates/[id]/PUT";
import estimates_id_export_csv_get_166 from "./api/estimates/[id]/export-csv/GET";
import estimates_id_export_pdf_get_167 from "./api/estimates/[id]/export-pdf/GET";
import estimates_id_import_csv_post_168 from "./api/estimates/[id]/import-csv/POST";
import external_form_token_get_169 from "./api/external/form/[token]/GET";
import external_form_token_post_170 from "./api/external/form/[token]/POST";
import files_get_171 from "./api/files/GET";
import files_post_172 from "./api/files/POST";
import files_id_delete_173 from "./api/files/[id]/DELETE";
import files_id_download_get_174 from "./api/files/[id]/download/GET";
import fleet_get_175 from "./api/fleet/GET";
import fleet_post_176 from "./api/fleet/POST";
import fleet_analytics_settings_get_177 from "./api/fleet/analytics-settings/GET";
import fleet_analytics_settings_put_178 from "./api/fleet/analytics-settings/PUT";
import fleet_driver_sessions_post_179 from "./api/fleet/driver-sessions/POST";
import fleet_driver_sessions_active_get_180 from "./api/fleet/driver-sessions/active/GET";
import fleet_driver_sessions_live_get_181 from "./api/fleet/driver-sessions/live/GET";
import fleet_driver_sessions_id_stop_post_182 from "./api/fleet/driver-sessions/[id]/stop/POST";
import fleet_driver_sessions_id_summary_get_183 from "./api/fleet/driver-sessions/[id]/summary/GET";
import fleet_driver_sessions_id_telemetry_post_184 from "./api/fleet/driver-sessions/[id]/telemetry/POST";
import fleet_driver_sessions_id_telemetry_latest_get_185 from "./api/fleet/driver-sessions/[id]/telemetry/latest/GET";
import fleet_flags_get_186 from "./api/fleet/flags/GET";
import fleet_service_logs_logId_delete_187 from "./api/fleet/service-logs/[logId]/DELETE";
import fleet_service_logs_logId_patch_188 from "./api/fleet/service-logs/[logId]/PATCH";
import fleet_vehicles_get_189 from "./api/fleet/vehicles/GET";
import fleet_id_delete_190 from "./api/fleet/[id]/DELETE";
import fleet_id_get_191 from "./api/fleet/[id]/GET";
import fleet_id_put_192 from "./api/fleet/[id]/PUT";
import fleet_id_driver_sessions_get_193 from "./api/fleet/[id]/driver-sessions/GET";
import fleet_id_files_get_194 from "./api/fleet/[id]/files/GET";
import fleet_id_prestarts_get_195 from "./api/fleet/[id]/prestarts/GET";
import fleet_id_prestarts_post_196 from "./api/fleet/[id]/prestarts/POST";
import fleet_id_service_logs_get_197 from "./api/fleet/[id]/service-logs/GET";
import fleet_id_service_logs_post_198 from "./api/fleet/[id]/service-logs/POST";
import fleet_id_signin_post_199 from "./api/fleet/[id]/signin/POST";
import fleet_id_signout_post_200 from "./api/fleet/[id]/signout/POST";
import fleet_id_usage_export_get_201 from "./api/fleet/[id]/usage-export/GET";
import fleet_id_usage_status_get_202 from "./api/fleet/[id]/usage-status/GET";
import fleet_id_usage_summary_get_203 from "./api/fleet/[id]/usage-summary/GET";
import form_templates_get_204 from "./api/form-templates/GET";
import form_templates_post_205 from "./api/form-templates/POST";
import form_templates_seed_post_206 from "./api/form-templates/seed/POST";
import form_templates_id_delete_207 from "./api/form-templates/[id]/DELETE";
import form_templates_id_put_208 from "./api/form-templates/[id]/PUT";
import forms_migrate_skip_logic_post_209 from "./api/forms/migrate-skip-logic/POST";
import forms_skip_audit_get_210 from "./api/forms/skip-audit/GET";
import forms_skip_audit_post_211 from "./api/forms/skip-audit/POST";
import forms_submissions_get_212 from "./api/forms/submissions/GET";
import forms_templates_id_share_link_post_213 from "./api/forms/templates/[id]/share-link/POST";
import forms_id_fields_get_214 from "./api/forms/[id]/fields/GET";
import forms_id_fields_post_215 from "./api/forms/[id]/fields/POST";
import forms_id_fields_reorder_post_216 from "./api/forms/[id]/fields/reorder/POST";
import forms_id_fields_fieldId_delete_217 from "./api/forms/[id]/fields/[fieldId]/DELETE";
import forms_id_fields_fieldId_patch_218 from "./api/forms/[id]/fields/[fieldId]/PATCH";
import forms_id_fields_fieldId_thumbnail_post_219 from "./api/forms/[id]/fields/[fieldId]/thumbnail/POST";
import health_get_220 from "./api/health/GET";
import integrations_myob_auth_url_get_221 from "./api/integrations/myob/auth-url/GET";
import integrations_myob_callback_get_222 from "./api/integrations/myob/callback/GET";
import integrations_myob_disconnect_post_223 from "./api/integrations/myob/disconnect/POST";
import integrations_myob_status_get_224 from "./api/integrations/myob/status/GET";
import integrations_myob_sync_invoice_post_225 from "./api/integrations/myob/sync-invoice/POST";
import integrations_onedrive_auth_url_get_226 from "./api/integrations/onedrive/auth-url/GET";
import integrations_onedrive_callback_get_227 from "./api/integrations/onedrive/callback/GET";
import integrations_onedrive_disconnect_post_228 from "./api/integrations/onedrive/disconnect/POST";
import integrations_onedrive_status_get_229 from "./api/integrations/onedrive/status/GET";
import integrations_onedrive_upload_file_post_230 from "./api/integrations/onedrive/upload-file/POST";
import integrations_qbo_auth_url_get_231 from "./api/integrations/qbo/auth-url/GET";
import integrations_qbo_callback_get_232 from "./api/integrations/qbo/callback/GET";
import integrations_qbo_disconnect_post_233 from "./api/integrations/qbo/disconnect/POST";
import integrations_qbo_status_get_234 from "./api/integrations/qbo/status/GET";
import integrations_qbo_sync_invoice_post_235 from "./api/integrations/qbo/sync-invoice/POST";
import integrations_xero_auth_url_get_236 from "./api/integrations/xero/auth-url/GET";
import integrations_xero_callback_get_237 from "./api/integrations/xero/callback/GET";
import integrations_xero_disconnect_post_238 from "./api/integrations/xero/disconnect/POST";
import integrations_xero_status_get_239 from "./api/integrations/xero/status/GET";
import integrations_xero_sync_customer_post_240 from "./api/integrations/xero/sync-customer/POST";
import integrations_xero_sync_invoice_post_241 from "./api/integrations/xero/sync-invoice/POST";
import integrations_xero_webhook_post_242 from "./api/integrations/xero/webhook/POST";
import invoices_get_243 from "./api/invoices/GET";
import invoices_post_244 from "./api/invoices/POST";
import invoices_id_delete_245 from "./api/invoices/[id]/DELETE";
import invoices_id_get_246 from "./api/invoices/[id]/GET";
import invoices_id_put_247 from "./api/invoices/[id]/PUT";
import invoices_id_duplicate_post_248 from "./api/invoices/[id]/duplicate/POST";
import invoices_id_export_pdf_get_249 from "./api/invoices/[id]/export-pdf/GET";
import invoices_id_mark_sent_post_250 from "./api/invoices/[id]/mark-sent/POST";
import invoices_id_record_payment_post_251 from "./api/invoices/[id]/record-payment/POST";
import invoices_id_void_post_252 from "./api/invoices/[id]/void/POST";
import job_forms_id_delete_253 from "./api/job-forms/[id]/DELETE";
import job_forms_id_get_254 from "./api/job-forms/[id]/GET";
import job_forms_id_put_255 from "./api/job-forms/[id]/PUT";
import job_forms_id_reset_post_256 from "./api/job-forms/[id]/reset/POST";
import job_forms_id_share_delete_257 from "./api/job-forms/[id]/share/DELETE";
import job_forms_id_share_get_258 from "./api/job-forms/[id]/share/GET";
import job_forms_id_share_post_259 from "./api/job-forms/[id]/share/POST";
import jobs_get_260 from "./api/jobs/GET";
import jobs_post_261 from "./api/jobs/POST";
import jobs_id_get_262 from "./api/jobs/[id]/GET";
import jobs_id_put_263 from "./api/jobs/[id]/PUT";
import jobs_id_attendance_attendanceId_close_post_264 from "./api/jobs/[id]/attendance/[attendanceId]/close/POST";
import jobs_id_costs_get_265 from "./api/jobs/[id]/costs/GET";
import jobs_id_costs_post_266 from "./api/jobs/[id]/costs/POST";
import jobs_id_costs_export_get_267 from "./api/jobs/[id]/costs/export/GET";
import jobs_id_costs_costId_delete_268 from "./api/jobs/[id]/costs/[costId]/DELETE";
import jobs_id_costs_costId_put_269 from "./api/jobs/[id]/costs/[costId]/PUT";
import jobs_id_costs_costId_receipt_get_270 from "./api/jobs/[id]/costs/[costId]/receipt/GET";
import jobs_id_costs_costId_receipt_post_271 from "./api/jobs/[id]/costs/[costId]/receipt/POST";
import jobs_id_delays_get_272 from "./api/jobs/[id]/delays/GET";
import jobs_id_delays_post_273 from "./api/jobs/[id]/delays/POST";
import jobs_id_delays_delayId_delete_274 from "./api/jobs/[id]/delays/[delayId]/DELETE";
import jobs_id_delays_delayId_put_275 from "./api/jobs/[id]/delays/[delayId]/PUT";
import jobs_id_files_get_276 from "./api/jobs/[id]/files/GET";
...
import jobs_id_ledger_sync_post_283 from "./api/jobs/[id]/ledger/sync/POST";
import jobs_id_ledger_entryId_delete_284 from "./api/jobs/[id]/ledger/[entryId]/DELETE";
import jobs_id_ledger_entryId_put_285 from "./api/jobs/[id]/ledger/[entryId]/PUT";
import jobs_id_ledger_entryId_correct_post_286 from "./api/jobs/[id]/ledger/[entryId]/correct/POST";
import jobs_id_photos_get_287 from "./api/jobs/[id]/photos/GET";
import jobs_id_photos_post_288 from "./api/jobs/[id]/photos/POST";
import jobs_id_photos_photoId_delete_289 from "./api/jobs/[id]/photos/[photoId]/DELETE";
import jobs_id_photos_photoId_patch_290 from "./api/jobs/[id]/photos/[photoId]/PATCH";
import jobs_id_photos_photoId_download_get_291 from "./api/jobs/[id]/photos/[photoId]/download/GET";
import jobs_id_photos_photoId_replace_post_292 from "./api/jobs/[id]/photos/[photoId]/replace/POST";
import jobs_id_progress_get_293 from "./api/jobs/[id]/progress/GET";
import jobs_id_progress_put_294 from "./api/jobs/[id]/progress/PUT";
import jobs_id_progress_sync_post_295 from "./api/jobs/[id]/progress/sync/POST";
import jobs_id_purchase_orders_get_296 from "./api/jobs/[id]/purchase-orders/GET";
import jobs_id_purchase_orders_post_297 from "./api/jobs/[id]/purchase-orders/POST";
import jobs_id_purchase_orders_poId_delete_298 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import jobs_id_purchase_orders_poId_get_299 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
...
import jobs_id_swms_get_307 from "./api/jobs/[id]/swms/GET";
import jobs_id_swms_post_308 from "./api/jobs/[id]/swms/POST";
import jobs_id_swms_swmsId_signoff_post_309 from "./api/jobs/[id]/swms/[swmsId]/signoff/POST";
import jobs_id_todos_get_310 from "./api/jobs/[id]/todos/GET";
import jobs_id_todos_post_311 from "./api/jobs/[id]/todos/POST";
import jobs_id_todos_todoId_delete_312 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import jobs_id_todos_todoId_put_313 from "./api/jobs/[id]/todos/[todoId]/PUT";
import library_items_get_314 from "./api/library/items/GET";
import library_items_id_get_315 from "./api/library/items/[id]/GET";
import library_items_id_patch_316 from "./api/library/items/[id]/PATCH";
import library_items_id_download_get_317 from "./api/library/items/[id]/download/GET";
import library_items_id_install_post_318 from "./api/library/items/[id]/install/POST";
import library_my_installed_get_319 from "./api/library/my-installed/GET";
import library_my_submissions_get_320 from "./api/library/my-submissions/GET";
import me_get_321 from "./api/me/GET";
import me_put_322 from "./api/me/PUT";
import me_2fa_disable_post_323 from "./api/me/2fa/disable/POST";
import me_2fa_enable_post_324 from "./api/me/2fa/enable/POST";
import me_2fa_setup_get_325 from "./api/me/2fa/setup/GET";
import me_2fa_status_get_326 from "./api/me/2fa/status/GET";
import me_2fa_verify_post_327 from "./api/me/2fa/verify/POST";
import me_change_password_post_328 from "./api/me/change-password/POST";
import me_email_status_get_329 from "./api/me/email-status/GET";
import me_phone_get_330 from "./api/me/phone/GET";
import me_phone_put_331 from "./api/me/phone/PUT";
import migrate_account_recovery_post_332 from "./api/migrate-account-recovery/POST";
import migrate_asset_manager_post_333 from "./api/migrate-asset-manager/POST";
import migrate_attendance_post_334 from "./api/migrate-attendance/POST";
import migrate_company_settings_post_335 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_336 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_337 from "./api/migrate-dazza-knowledge/POST";
import migrate_emergency_alerts_post_338 from "./api/migrate-emergency-alerts/POST";
import migrate_estimates_post_339 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_340 from "./api/migrate-estimating-library/POST";
import migrate_files_post_341 from "./api/migrate-files/POST";
import migrate_fleet_post_342 from "./api/migrate-fleet/POST";
import migrate_fleet_analytics_post_343 from "./api/migrate-fleet-analytics/POST";
import migrate_fleet_driver_sessions_post_344 from "./api/migrate-fleet-driver-sessions/POST";
import migrate_fleet_usage_post_345 from "./api/migrate-fleet-usage/POST";
import migrate_form_fields_post_346 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_347 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_348 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_349 from "./api/migrate-job-forms/POST";
import migrate_job_photos_post_350 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_351 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_352 from "./api/migrate-jobs/POST";
import migrate_library_post_353 from "./api/migrate-library/POST";
import migrate_library_downloads_post_354 from "./api/migrate-library-downloads/POST";
import migrate_notifications_post_355 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_356 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_357 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_358 from "./api/migrate-pdf-settings/POST";
import migrate_plan_manager_post_359 from "./api/migrate-plan-manager/POST";
import migrate_plan_manager_v2_post_360 from "./api/migrate-plan-manager-v2/POST";
import migrate_plan_manager_v3_post_361 from "./api/migrate-plan-manager-v3/POST";
import migrate_safety_post_362 from "./api/migrate-safety/POST";
import migrate_starter_pack_post_363 from "./api/migrate-starter-pack/POST";
import migrate_studio_pdf_post_364 from "./api/migrate-studio-pdf/POST";
import migrate_subscriptions_post_365 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_366 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_367 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_368 from "./api/migrate-team/POST";
import notes_get_369 from "./api/notes/GET";
import notes_post_370 from "./api/notes/POST";
import notes_comments_post_371 from "./api/notes/comments/POST";
import notes_migrate_post_372 from "./api/notes/migrate/POST";
import notifications_alerts_get_373 from "./api/notifications/alerts/GET";
import notifications_prefs_get_374 from "./api/notifications/prefs/GET";
import notifications_prefs_put_375 from "./api/notifications/prefs/PUT";
import notifications_read_post_376 from "./api/notifications/read/POST";
import owner_console_activity_get_377 from "./api/owner-console/activity/GET";
import owner_console_cancellation_feedback_get_378 from "./api/owner-console/cancellation-feedback/GET";
import owner_console_companies_get_379 from "./api/owner-console/companies/GET";
import owner_console_companies_post_380 from "./api/owner-console/companies/POST";
import owner_console_companies_usage_get_381 from "./api/owner-console/companies/usage/GET";
import owner_console_companies_id_limits_put_382 from "./api/owner-console/companies/[id]/limits/PUT";
import owner_console_form_templates_get_383 from "./api/owner-console/form-templates/GET";
import owner_console_form_templates_post_384 from "./api/owner-console/form-templates/POST";
import owner_console_library_items_post_385 from "./api/owner-console/library/items/POST";
import owner_console_library_items_id_delete_386 from "./api/owner-console/library/items/[id]/DELETE";
import owner_console_library_items_id_patch_387 from "./api/owner-console/library/items/[id]/PATCH";
...
import owner_console_starter_pack_post_391 from "./api/owner-console/starter-pack/POST";
import owner_console_stats_get_392 from "./api/owner-console/stats/GET";
import owner_console_storage_get_393 from "./api/owner-console/storage/GET";
import owner_console_system_ai_builtin_checks_post_394 from "./api/owner-console/system-ai/builtin-checks/POST";
import owner_console_users_get_395 from "./api/owner-console/users/GET";
import owner_console_users_verify_post_396 from "./api/owner-console/users/verify/POST";
import plan_manager_drawings_get_397 from "./api/plan-manager/drawings/GET";
import plan_manager_drawings_post_398 from "./api/plan-manager/drawings/POST";
import plan_manager_drawings_id_get_399 from "./api/plan-manager/drawings/[id]/GET";
import plan_manager_drawings_id_annotations_put_400 from "./api/plan-manager/drawings/[id]/annotations/PUT";
import plan_manager_drawings_id_archive_post_401 from "./api/plan-manager/drawings/[id]/archive/POST";
import plan_manager_drawings_id_job_links_delete_402 from "./api/plan-manager/drawings/[id]/job-links/DELETE";
import plan_manager_drawings_id_job_links_post_403 from "./api/plan-manager/drawings/[id]/job-links/POST";
import plan_manager_drawings_id_pages_pageNo_annotations_get_404 from "./api/plan-manager/drawings/[id]/pages/[pageNo]/annotations/GET";
import plan_manager_drawings_id_permanent_delete_405 from "./api/plan-manager/drawings/[id]/permanent/DELETE";
import plan_manager_drawings_id_reorder_patch_406 from "./api/plan-manager/drawings/[id]/reorder/PATCH";
import plan_manager_drawings_id_restore_post_407 from "./api/plan-manager/drawings/[id]/restore/POST";
import plan_manager_drawings_id_revisions_post_408 from "./api/plan-manager/drawings/[id]/revisions/POST";
import plan_manager_drawings_id_revisions_revisionId_finalize_post_409 from "./api/plan-manager/drawings/[id]/revisions/[revisionId]/finalize/POST";
import plan_manager_drawings_id_upload_post_410 from "./api/plan-manager/drawings/[id]/upload/POST";
import plan_manager_jobs_with_drawings_get_411 from "./api/plan-manager/jobs-with-drawings/GET";
import plan_manager_share_post_412 from "./api/plan-manager/share/POST";
import plan_manager_share_validate_get_413 from "./api/plan-manager/share/validate/GET";
import portal_estimates_id_approve_post_414 from "./api/portal/estimates/[id]/approve/POST";
import portal_invite_post_415 from "./api/portal/invite/POST";
import portal_invoices_id_pay_post_416 from "./api/portal/invoices/[id]/pay/POST";
import portal_jobs_get_417 from "./api/portal/jobs/GET";
import portal_jobs_id_get_418 from "./api/portal/jobs/[id]/GET";
import portal_migrate_post_419 from "./api/portal/migrate/POST";
import portal_validate_post_420 from "./api/portal/validate/POST";
import public_form_token_get_421 from "./api/public/form/[token]/GET";
import public_form_token_submit_post_422 from "./api/public/form/[token]/submit/POST";
import public_swms_token_get_423 from "./api/public/swms/[token]/GET";
import public_swms_token_signoff_post_424 from "./api/public/swms/[token]/signoff/POST";
import push_subscribe_delete_425 from "./api/push/subscribe/DELETE";
import push_subscribe_post_426 from "./api/push/subscribe/POST";
import push_vapid_key_get_427 from "./api/push/vapid-key/GET";
import recipes_get_428 from "./api/recipes/GET";
import recipes_post_429 from "./api/recipes/POST";
import recipes_id_delete_430 from "./api/recipes/[id]/DELETE";
import recipes_id_put_431 from "./api/recipes/[id]/PUT";
import safety_ai_draft_post_432 from "./api/safety/ai/draft/POST";
import safety_documents_get_433 from "./api/safety/documents/GET";
import safety_documents_post_434 from "./api/safety/documents/POST";
import safety_documents_id_delete_435 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_436 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_437 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_438 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_439 from "./api/safety/generated-posters/[id]/DELETE";
import safety_job_safety_plans_get_440 from "./api/safety/job-safety-plans/GET";
import safety_job_safety_plans_post_441 from "./api/safety/job-safety-plans/POST";
import safety_job_safety_plans_id_delete_442 from "./api/safety/job-safety-plans/[id]/DELETE";
import safety_job_safety_plans_id_put_443 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_444 from "./api/safety/job-swms/GET";
import safety_job_swms_post_445 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_446 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_447 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_448 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_share_token_post_449 from "./api/safety/job-swms/[id]/share-token/POST";
import safety_job_swms_id_signoffs_get_450 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_451 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_452 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_453 from "./api/safety/plans/GET";
import safety_plans_post_454 from "./api/safety/plans/POST";
import safety_plans_seed_post_455 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_456 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_457 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_458 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_459 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_460 from "./api/safety/posters/GET";
import safety_posters_post_461 from "./api/safety/posters/POST";
import safety_posters_id_delete_462 from "./api/safety/posters/[id]/DELETE";
import safety_swms_get_463 from "./api/safety/swms/GET";
import safety_swms_post_464 from "./api/safety/swms/POST";
import safety_swms_import_docx_post_465 from "./api/safety/swms/import-docx/POST";
import safety_swms_seed_post_466 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_467 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_468 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_469 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_470 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_471 from "./api/safety/swms/[id]/export/GET";
import scheduler_crew_get_472 from "./api/scheduler/crew/GET";
import scheduler_jobs_get_473 from "./api/scheduler/jobs/GET";
import scheduler_jobs_id_reschedule_patch_474 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
import secure_share_get_475 from "./api/secure-share/GET";
import secure_share_post_476 from "./api/secure-share/POST";
import secure_share_id_delete_477 from "./api/secure-share/[id]/DELETE";
import secure_share_token_get_478 from "./api/secure-share/[token]/GET";
import secure_share_token_post_479 from "./api/secure-share/[token]/POST";
import settings_backup_get_480 from "./api/settings/backup/GET";
import settings_backup_post_481 from "./api/settings/backup/POST";
import settings_backup_export_get_482 from "./api/settings/backup/export/GET";
import settings_backup_run_post_483 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_484 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_485 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_486 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_487 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_488 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_489 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_490 from "./api/settings/retention/GET";
import settings_retention_post_491 from "./api/settings/retention/POST";
import settings_storage_provider_get_492 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_493 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_494 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_495 from "./api/settings/terminology/GET";
import settings_terminology_post_496 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_497 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_498 from "./api/settings/xero-credentials/POST";
import share_token_get_499 from "./api/share/[token]/GET";
import signin_history_get_500 from "./api/signin-history/GET";
import signup_post_501 from "./api/signup/POST";
import stripe_create_checkout_session_post_502 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_503 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_504 from "./api/subscription/create-checkout/POST";
import subscription_status_get_505 from "./api/subscription/status/GET";
import subscription_webhook_post_506 from "./api/subscription/webhook/POST";
import support_mode_audit_get_507 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_508 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_509 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_510 from "./api/support-mode/enter/POST";
import support_mode_exit_post_511 from "./api/support-mode/exit/POST";
import support_mode_status_get_512 from "./api/support-mode/status/GET";
import tag_tasks_get_513 from "./api/tag-tasks/GET";
import tag_tasks_id_patch_514 from "./api/tag-tasks/[id]/PATCH";
import takeoff_pad_get_515 from "./api/takeoff-pad/GET";
import takeoff_pad_put_516 from "./api/takeoff-pad/PUT";
import team_get_517 from "./api/team/GET";
import team_invite_post_518 from "./api/team/invite/POST";
import team_invites_get_519 from "./api/team/invites/GET";
import team_invites_post_520 from "./api/team/invites/POST";
import team_invites_id_cancel_post_521 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_522 from "./api/team/invites/[id]/resend/POST";
import team_members_get_523 from "./api/team/members/GET";
import team_resend_verification_post_524 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_525 from "./api/team/schedule/migrate/POST";
import team_shifts_get_526 from "./api/team/shifts/GET";
import team_shifts_post_527 from "./api/team/shifts/POST";
import team_shifts_id_delete_528 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_529 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_530 from "./api/team/time-entries/GET";
import team_time_entries_post_531 from "./api/team/time-entries/POST";
import team_time_entries_export_get_532 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_533 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_534 from "./api/team/verify-user/POST";
import team_id_delete_535 from "./api/team/[id]/DELETE";
import team_id_put_536 from "./api/team/[id]/PUT";
import usage_get_537 from "./api/usage/GET";
// </api-imports>
...
app.get("/api/developer/support-notes", developer_support_notes_get_116);
app.post("/api/developer/support-notes", developer_support_notes_post_117);
app.delete("/api/developer/support-notes/:id", developer_support_notes_id_delete_118);
app.post("/api/developer/users/:id/assign-company", developer_users_id_assign_company_post_119);
app.post("/api/developer/users/:id/deactivate", developer_users_id_deactivate_post_120);
app.post("/api/developer/users/:id/delete-orphan", developer_users_id_delete_orphan_post_121);
app.post("/api/developer/users/:id/force-temp-password", developer_users_id_force_temp_password_post_122);
app.delete("/api/developer/users/:id/impersonate", developer_users_id_impersonate_delete_123);
app.post("/api/developer/users/:id/impersonate", developer_users_id_impersonate_post_124);
app.post("/api/developer/users/:id/reactivate", developer_users_id_reactivate_post_125);
app.post("/api/developer/users/:id/resend-verification", developer_users_id_resend_verification_post_126);
app.put("/api/developer/users/:id/role", developer_users_id_role_put_127);
app.post("/api/developer/users/:id/send-reset-email", developer_users_id_send_reset_email_post_128);
app.delete("/api/developer/users/:id/sessions", developer_users_id_sessions_delete_129);
app.get("/api/developer/users/:id/sessions", developer_users_id_sessions_get_130);
app.post("/api/developer/users/:id/unlock-account", developer_users_id_unlock_account_post_131);
app.get("/api/document-templates", document_templates_get_132);
app.post("/api/document-templates", document_templates_post_133);
app.delete("/api/document-templates/:id", document_templates_id_delete_134);
app.get("/api/document-templates/:id", document_templates_id_get_135);
app.put("/api/document-templates/:id", document_templates_id_put_136);
app.post("/api/document-templates/:id/duplicate", document_templates_id_duplicate_post_137);
app.get("/api/document-templates/:id/export/docx", document_templates_id_export_docx_get_138);
app.get("/api/document-templates/:id/export/pdf", document_templates_id_export_pdf_get_139);
app.post("/api/document-templates/:id/import-blocks", document_templates_id_import_blocks_post_140);
app.post("/api/document-templates/:id/import-docx", document_templates_id_import_docx_post_141);
app.post("/api/document-templates/:id/import-pdf", document_templates_id_import_pdf_post_142);
app.post("/api/document-templates/:id/publish-to-library", document_templates_id_publish_to_library_post_143);
app.get("/api/documents", documents_get_144);
app.get("/api/documents/share/:token", documents_share_token_get_145);
app.post("/api/documents/share/:token", documents_share_token_post_146);
app.get("/api/documents/:id", documents_id_get_147);
app.put("/api/documents/:id", documents_id_put_148);
app.get("/api/documents/:id/events", documents_id_events_get_149);
app.delete("/api/documents/:id/share", documents_id_share_delete_150);
app.post("/api/documents/:id/share", documents_id_share_post_151);
app.get("/api/drawings", drawings_get_152);
app.post("/api/drawings", drawings_post_153);
app.post("/api/drawings/upload", drawings_upload_post_154);
app.delete("/api/drawings/:id", drawings_id_delete_155);
app.patch("/api/drawings/:id", drawings_id_patch_156);
app.post("/api/drawings/:id/markup", drawings_id_markup_post_157);
app.get("/api/emergency-alerts", emergency_alerts_get_158);
app.post("/api/emergency-alerts", emergency_alerts_post_159);
app.put("/api/emergency-alerts/:id", emergency_alerts_id_put_160);
app.get("/api/estimates", estimates_get_161);
app.post("/api/estimates", estimates_post_162);
app.delete("/api/estimates/:id", estimates_id_delete_163);
app.get("/api/estimates/:id", estimates_id_get_164);
app.put("/api/estimates/:id", estimates_id_put_165);
app.get("/api/estimates/:id/export-csv", estimates_id_export_csv_get_166);
app.get("/api/estimates/:id/export-pdf", estimates_id_export_pdf_get_167);
app.post("/api/estimates/:id/import-csv", estimates_id_import_csv_post_168);
app.get("/api/external/form/:token", external_form_token_get_169);
app.post("/api/external/form/:token", external_form_token_post_170);
app.get("/api/files", files_get_171);
app.post("/api/files", files_post_172);
app.delete("/api/files/:id", files_id_delete_173);
app.get("/api/files/:id/download", files_id_download_get_174);
app.get("/api/fleet", fleet_get_175);
app.post("/api/fleet", fleet_post_176);
app.get("/api/fleet/analytics-settings", fleet_analytics_settings_get_177);
app.put("/api/fleet/analytics-settings", fleet_analytics_settings_put_178);
app.post("/api/fleet/driver-sessions", fleet_driver_sessions_post_179);
app.get("/api/fleet/driver-sessions/active", fleet_driver_sessions_active_get_180);
app.get("/api/fleet/driver-sessions/live", fleet_driver_sessions_live_get_181);
app.post("/api/fleet/driver-sessions/:id/stop", fleet_driver_sessions_id_stop_post_182);
app.get("/api/fleet/driver-sessions/:id/summary", fleet_driver_sessions_id_summary_get_183);
app.post("/api/fleet/driver-sessions/:id/telemetry", fleet_driver_sessions_id_telemetry_post_184);
app.get("/api/fleet/driver-sessions/:id/telemetry/latest", fleet_driver_sessions_id_telemetry_latest_get_185);
app.get("/api/fleet/flags", fleet_flags_get_186);
app.delete("/api/fleet/service-logs/:logId", fleet_service_logs_logId_delete_187);
app.patch("/api/fleet/service-logs/:logId", fleet_service_logs_logId_patch_188);
app.get("/api/fleet/vehicles", fleet_vehicles_get_189);
app.delete("/api/fleet/:id", fleet_id_delete_190);
app.get("/api/fleet/:id", fleet_id_get_191);
app.put("/api/fleet/:id", fleet_id_put_192);
app.get("/api/fleet/:id/driver-sessions", fleet_id_driver_sessions_get_193);
app.get("/api/fleet/:id/files", fleet_id_files_get_194);
app.get("/api/fleet/:id/prestarts", fleet_id_prestarts_get_195);
app.post("/api/fleet/:id/prestarts", fleet_id_prestarts_post_196);
app.get("/api/fleet/:id/service-logs", fleet_id_service_logs_get_197);
app.post("/api/fleet/:id/service-logs", fleet_id_service_logs_post_198);
app.post("/api/fleet/:id/signin", fleet_id_signin_post_199);
app.post("/api/fleet/:id/signout", fleet_id_signout_post_200);
app.get("/api/fleet/:id/usage-export", fleet_id_usage_export_get_201);
app.get("/api/fleet/:id/usage-status", fleet_id_usage_status_get_202);
app.get("/api/fleet/:id/usage-summary", fleet_id_usage_summary_get_203);
app.get("/api/form-templates", form_templates_get_204);
app.post("/api/form-templates", form_templates_post_205);
app.post("/api/form-templates/seed", form_templates_seed_post_206);
app.delete("/api/form-templates/:id", form_templates_id_delete_207);
app.put("/api/form-templates/:id", form_templates_id_put_208);
app.post("/api/forms/migrate-skip-logic", forms_migrate_skip_logic_post_209);
app.get("/api/forms/skip-audit", forms_skip_audit_get_210);
app.post("/api/forms/skip-audit", forms_skip_audit_post_211);
app.get("/api/forms/submissions", forms_submissions_get_212);
app.post("/api/forms/templates/:id/share-link", forms_templates_id_share_link_post_213);
app.get("/api/forms/:id/fields", forms_id_fields_get_214);
app.post("/api/forms/:id/fields", forms_id_fields_post_215);
app.post("/api/forms/:id/fields/reorder", forms_id_fields_reorder_post_216);
app.delete("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_delete_217);
app.patch("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_patch_218);
app.post("/api/forms/:id/fields/:fieldId/thumbnail", forms_id_fields_fieldId_thumbnail_post_219);
app.get("/api/health", health_get_220);
app.get("/api/integrations/myob/auth-url", integrations_myob_auth_url_get_221);
app.get("/api/integrations/myob/callback", integrations_myob_callback_get_222);
app.post("/api/integrations/myob/disconnect", integrations_myob_disconnect_post_223);
app.get("/api/integrations/myob/status", integrations_myob_status_get_224);
app.post("/api/integrations/myob/sync-invoice", integrations_myob_sync_invoice_post_225);
app.get("/api/integrations/onedrive/auth-url", integrations_onedrive_auth_url_get_226);
app.get("/api/integrations/onedrive/callback", integrations_onedrive_callback_get_227);
app.post("/api/integrations/onedrive/disconnect", integrations_onedrive_disconnect_post_228);
app.get("/api/integrations/onedrive/status", integrations_onedrive_status_get_229);
app.post("/api/integrations/onedrive/upload-file", integrations_onedrive_upload_file_post_230);
app.get("/api/integrations/qbo/auth-url", integrations_qbo_auth_url_get_231);
app.get("/api/integrations/qbo/callback", integrations_qbo_callback_get_232);
app.post("/api/integrations/qbo/disconnect", integrations_qbo_disconnect_post_233);
app.get("/api/integrations/qbo/status", integrations_qbo_status_get_234);
app.post("/api/integrations/qbo/sync-invoice", integrations_qbo_sync_invoice_post_235);
app.get("/api/integrations/xero/auth-url", integrations_xero_auth_url_get_236);
app.get("/api/integrations/xero/callback", integrations_xero_callback_get_237);
app.post("/api/integrations/xero/disconnect", integrations_xero_disconnect_post_238);
app.get("/api/integrations/xero/status", integrations_xero_status_get_239);
app.post("/api/integrations/xero/sync-customer", integrations_xero_sync_customer_post_240);
app.post("/api/integrations/xero/sync-invoice", integrations_xero_sync_invoice_post_241);
app.post("/api/integrations/xero/webhook", integrations_xero_webhook_post_242);
app.get("/api/invoices", invoices_get_243);
app.post("/api/invoices", invoices_post_244);
app.delete("/api/invoices/:id", invoices_id_delete_245);
app.get("/api/invoices/:id", invoices_id_get_246);
app.put("/api/invoices/:id", invoices_id_put_247);
app.post("/api/invoices/:id/duplicate", invoices_id_duplicate_post_248);
app.get("/api/invoices/:id/export-pdf", invoices_id_export_pdf_get_249);
app.post("/api/invoices/:id/mark-sent", invoices_id_mark_sent_post_250);
app.post("/api/invoices/:id/record-payment", invoices_id_record_payment_post_251);
app.post("/api/invoices/:id/void", invoices_id_void_post_252);
app.delete("/api/job-forms/:id", job_forms_id_delete_253);
app.get("/api/job-forms/:id", job_forms_id_get_254);
app.put("/api/job-forms/:id", job_forms_id_put_255);
app.post("/api/job-forms/:id/reset", job_forms_id_reset_post_256);
app.delete("/api/job-forms/:id/share", job_forms_id_share_delete_257);
app.get("/api/job-forms/:id/share", job_forms_id_share_get_258);
app.post("/api/job-forms/:id/share", job_forms_id_share_post_259);
app.get("/api/jobs", jobs_get_260);
app.post("/api/jobs", jobs_post_261);
app.get("/api/jobs/:id", jobs_id_get_262);
app.put("/api/jobs/:id", jobs_id_put_263);
app.post("/api/jobs/:id/attendance/:attendanceId/close", jobs_id_attendance_attendanceId_close_post_264);
app.get("/api/jobs/:id/costs", jobs_id_costs_get_265);
app.post("/api/jobs/:id/costs", jobs_id_costs_post_266);
app.get("/api/jobs/:id/costs/export", jobs_id_costs_export_get_267);
app.delete("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_delete_268);
app.put("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_put_269);
app.get("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_get_270);
app.post("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_post_271);
app.get("/api/jobs/:id/delays", jobs_id_delays_get_272);
app.post("/api/jobs/:id/delays", jobs_id_delays_post_273);
app.delete("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_delete_274);
app.put("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_put_275);
app.get("/api/jobs/:id/files", jobs_id_files_get_276);
app.get("/api/jobs/:id/forms", jobs_id_forms_get_277);
app.post("/api/jobs/:id/forms", jobs_id_forms_post_278);
app.post("/api/jobs/:id/generate-qr", jobs_id_generate_qr_post_279);
app.get("/api/jobs/:id/ledger", jobs_id_ledger_get_280);
app.post("/api/jobs/:id/ledger", jobs_id_ledger_post_281);
app.get("/api/jobs/:id/ledger/export", jobs_id_ledger_export_get_282);
app.post("/api/jobs/:id/ledger/sync", jobs_id_ledger_sync_post_283);
app.delete("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_delete_284);
app.put("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_put_285);
app.post("/api/jobs/:id/ledger/:entryId/correct", jobs_id_ledger_entryId_correct_post_286);
app.get("/api/jobs/:id/photos", jobs_id_photos_get_287);
app.post("/api/jobs/:id/photos", jobs_id_photos_post_288);
app.delete("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_delete_289);
app.patch("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_patch_290);
app.get("/api/jobs/:id/photos/:photoId/download", jobs_id_photos_photoId_download_get_291);
app.post("/api/jobs/:id/photos/:photoId/replace", jobs_id_photos_photoId_replace_post_292);
app.get("/api/jobs/:id/progress", jobs_id_progress_get_293);
app.put("/api/jobs/:id/progress", jobs_id_progress_put_294);
app.post("/api/jobs/:id/progress/sync", jobs_id_progress_sync_post_295);
app.get("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_get_296);
app.post("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_post_297);
app.delete("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_delete_298);
app.get("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_get_299);
...
app.get("/api/jobs/:id/todos", jobs_id_todos_get_310);
app.post("/api/jobs/:id/todos", jobs_id_todos_post_311);
app.delete("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_delete_312);
app.put("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_put_313);
app.get("/api/library/items", library_items_get_314);
app.get("/api/library/items/:id", library_items_id_get_315);
app.patch("/api/library/items/:id", library_items_id_patch_316);
app.get("/api/library/items/:id/download", library_items_id_download_get_317);
app.post("/api/library/items/:id/install", library_items_id_install_post_318);
app.get("/api/library/my-installed", library_my_installed_get_319);
app.get("/api/library/my-submissions", library_my_submissions_get_320);
app.get("/api/me", me_get_321);
app.put("/api/me", me_put_322);
app.post("/api/me/2fa/disable", me_2fa_disable_post_323);
app.post("/api/me/2fa/enable", me_2fa_enable_post_324);
app.get("/api/me/2fa/setup", me_2fa_setup_get_325);
app.get("/api/me/2fa/status", me_2fa_status_get_326);
app.post("/api/me/2fa/verify", me_2fa_verify_post_327);
app.post("/api/me/change-password", me_change_password_post_328);
app.get("/api/me/email-status", me_email_status_get_329);
app.get("/api/me/phone", me_phone_get_330);
app.put("/api/me/phone", me_phone_put_331);
app.post("/api/migrate-account-recovery", migrate_account_recovery_post_332);
app.post("/api/migrate-asset-manager", migrate_asset_manager_post_333);
app.post("/api/migrate-attendance", migrate_attendance_post_334);
app.post("/api/migrate-company-settings", migrate_company_settings_post_335);
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_336);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_337);
app.post("/api/migrate-emergency-alerts", migrate_emergency_alerts_post_338);
app.post("/api/migrate-estimates", migrate_estimates_post_339);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_340);
app.post("/api/migrate-files", migrate_files_post_341);
app.post("/api/migrate-fleet", migrate_fleet_post_342);
app.post("/api/migrate-fleet-analytics", migrate_fleet_analytics_post_343);
app.post("/api/migrate-fleet-driver-sessions", migrate_fleet_driver_sessions_post_344);
app.post("/api/migrate-fleet-usage", migrate_fleet_usage_post_345);
app.post("/api/migrate-form-fields", migrate_form_fields_post_346);
app.post("/api/migrate-form-logic", migrate_form_logic_post_347);
app.post("/api/migrate-form-templates", migrate_form_templates_post_348);
app.post("/api/migrate-job-forms", migrate_job_forms_post_349);
app.post("/api/migrate-job-photos", migrate_job_photos_post_350);
app.post("/api/migrate-job-tabs", migrate_job_tabs_post_351);
app.post("/api/migrate-jobs", migrate_jobs_post_352);
app.post("/api/migrate-library", migrate_library_post_353);
app.post("/api/migrate-library-downloads", migrate_library_downloads_post_354);
app.post("/api/migrate-notifications", migrate_notifications_post_355);
app.post("/api/migrate-owner-console", migrate_owner_console_post_356);
app.post("/api/migrate-owner-role", migrate_owner_role_post_357);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_358);
app.post("/api/migrate-plan-manager", migrate_plan_manager_post_359);
app.post("/api/migrate-plan-manager-v2", migrate_plan_manager_v2_post_360);
app.post("/api/migrate-plan-manager-v3", migrate_plan_manager_v3_post_361);
app.post("/api/migrate-safety", migrate_safety_post_362);
app.post("/api/migrate-starter-pack", migrate_starter_pack_post_363);
app.post("/api/migrate-studio-pdf", migrate_studio_pdf_post_364);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_365);
app.post("/api/migrate-support-mode", migrate_support_mode_post_366);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_367);
app.post("/api/migrate-team", migrate_team_post_368);
app.get("/api/notes", notes_get_369);
app.post("/api/notes", notes_post_370);
app.post("/api/notes/comments", notes_comments_post_371);
app.post("/api/notes/migrate", notes_migrate_post_372);
app.get("/api/notifications/alerts", notifications_alerts_get_373);
app.get("/api/notifications/prefs", notifications_prefs_get_374);
app.put("/api/notifications/prefs", notifications_prefs_put_375);
app.post("/api/notifications/read", notifications_read_post_376);
app.get("/api/owner-console/activity", owner_console_activity_get_377);
app.get("/api/owner-console/cancellation-feedback", owner_console_cancellation_feedback_get_378);
app.get("/api/owner-console/companies", owner_console_companies_get_379);
app.post("/api/owner-console/companies", owner_console_companies_post_380);
app.get("/api/owner-console/companies/usage", owner_console_companies_usage_get_381);
app.put("/api/owner-console/companies/:id/limits", owner_console_companies_id_limits_put_382);
app.get("/api/owner-console/form-templates", owner_console_form_templates_get_383);
app.post("/api/owner-console/form-templates", owner_console_form_templates_post_384);
app.post("/api/owner-console/library/items", owner_console_library_items_post_385);
app.delete("/api/owner-console/library/items/:id", owner_console_library_items_id_delete_386);
app.patch("/api/owner-console/library/items/:id", owner_console_library_items_id_patch_387);
...
app.post("/api/owner-console/starter-pack", owner_console_starter_pack_post_391);
app.get("/api/owner-console/stats", owner_console_stats_get_392);
app.get("/api/owner-console/storage", owner_console_storage_get_393);
app.post("/api/owner-console/system-ai/builtin-checks", owner_console_system_ai_builtin_checks_post_394);
app.get("/api/owner-console/users", owner_console_users_get_395);
app.post("/api/owner-console/users/verify", owner_console_users_verify_post_396);
app.get("/api/plan-manager/drawings", plan_manager_drawings_get_397);
app.post("/api/plan-manager/drawings", plan_manager_drawings_post_398);
app.get("/api/plan-manager/drawings/:id", plan_manager_drawings_id_get_399);
app.put("/api/plan-manager/drawings/:id/annotations", plan_manager_drawings_id_annotations_put_400);
app.post("/api/plan-manager/drawings/:id/archive", plan_manager_drawings_id_archive_post_401);
app.delete("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_delete_402);
app.post("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_post_403);
app.get("/api/plan-manager/drawings/:id/pages/:pageNo/annotations", plan_manager_drawings_id_pages_pageNo_annotations_get_404);
app.delete("/api/plan-manager/drawings/:id/permanent", plan_manager_drawings_id_permanent_delete_405);
app.patch("/api/plan-manager/drawings/:id/reorder", plan_manager_drawings_id_reorder_patch_406);
app.post("/api/plan-manager/drawings/:id/restore", plan_manager_drawings_id_restore_post_407);
app.post("/api/plan-manager/drawings/:id/revisions", plan_manager_drawings_id_revisions_post_408);
app.post("/api/plan-manager/drawings/:id/revisions/:revisionId/finalize", plan_manager_drawings_id_revisions_revisionId_finalize_post_409);
app.post("/api/plan-manager/drawings/:id/upload", plan_manager_drawings_id_upload_post_410);
app.get("/api/plan-manager/jobs-with-drawings", plan_manager_jobs_with_drawings_get_411);
app.post("/api/plan-manager/share", plan_manager_share_post_412);
app.get("/api/plan-manager/share/validate", plan_manager_share_validate_get_413);
app.post("/api/portal/estimates/:id/approve", portal_estimates_id_approve_post_414);
app.post("/api/portal/invite", portal_invite_post_415);
app.post("/api/portal/invoices/:id/pay", portal_invoices_id_pay_post_416);
app.get("/api/portal/jobs", portal_jobs_get_417);
app.get("/api/portal/jobs/:id", portal_jobs_id_get_418);
app.post("/api/portal/migrate", portal_migrate_post_419);
app.post("/api/portal/validate", portal_validate_post_420);
app.get("/api/public/form/:token", public_form_token_get_421);
app.post("/api/public/form/:token/submit", public_form_token_submit_post_422);
app.get("/api/public/swms/:token", public_swms_token_get_423);
app.post("/api/public/swms/:token/signoff", public_swms_token_signoff_post_424);
app.delete("/api/push/subscribe", push_subscribe_delete_425);
app.post("/api/push/subscribe", push_subscribe_post_426);
app.get("/api/push/vapid-key", push_vapid_key_get_427);
app.get("/api/recipes", recipes_get_428);
app.post("/api/recipes", recipes_post_429);
app.delete("/api/recipes/:id", recipes_id_delete_430);
app.put("/api/recipes/:id", recipes_id_put_431);
app.post("/api/safety/ai/draft", safety_ai_draft_post_432);
app.get("/api/safety/documents", safety_documents_get_433);
app.post("/api/safety/documents", safety_documents_post_434);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_435);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_436);
app.get("/api/safety/generated-posters", safety_generated_posters_get_437);
app.post("/api/safety/generated-posters", safety_generated_posters_post_438);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_439);
app.get("/api/safety/job-safety-plans", safety_job_safety_plans_get_440);
app.post("/api/safety/job-safety-plans", safety_job_safety_plans_post_441);
app.delete("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_delete_442);
app.put("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_put_443);
app.get("/api/safety/job-swms", safety_job_swms_get_444);
app.post("/api/safety/job-swms", safety_job_swms_post_445);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_446);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_447);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_448);
app.post("/api/safety/job-swms/:id/share-token", safety_job_swms_id_share_token_post_449);
app.get("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_get_450);
app.post("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_post_451);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", safety_job_swms_id_signoffs_signoffId_delete_452);
app.get("/api/safety/plans", safety_plans_get_453);
app.post("/api/safety/plans", safety_plans_post_454);
app.post("/api/safety/plans/seed", safety_plans_seed_post_455);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_456);
app.put("/api/safety/plans/:id", safety_plans_id_put_457);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_458);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_459);
app.get("/api/safety/posters", safety_posters_get_460);
app.post("/api/safety/posters", safety_posters_post_461);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_462);
app.get("/api/safety/swms", safety_swms_get_463);
app.post("/api/safety/swms", safety_swms_post_464);
app.post("/api/safety/swms/import-docx", safety_swms_import_docx_post_465);
app.post("/api/safety/swms/seed", safety_swms_seed_post_466);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_467);
app.get("/api/safety/swms/:id", safety_swms_id_get_468);
app.put("/api/safety/swms/:id", safety_swms_id_put_469);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_470);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_471);
app.get("/api/scheduler/crew", scheduler_crew_get_472);
app.get("/api/scheduler/jobs", scheduler_jobs_get_473);
app.patch("/api/scheduler/jobs/:id/reschedule", scheduler_jobs_id_reschedule_patch_474);
app.get("/api/secure-share", secure_share_get_475);
app.post("/api/secure-share", secure_share_post_476);
app.delete("/api/secure-share/:id", secure_share_id_delete_477);
app.get("/api/secure-share/:token", secure_share_token_get_478);
app.post("/api/secure-share/:token", secure_share_token_post_479);
app.get("/api/settings/backup", settings_backup_get_480);
app.post("/api/settings/backup", settings_backup_post_481);
app.get("/api/settings/backup/export", settings_backup_export_get_482);
app.post("/api/settings/backup/run", settings_backup_run_post_483);
app.get("/api/settings/backup-destination", settings_backup_destination_get_484);
app.post("/api/settings/backup-destination", settings_backup_destination_post_485);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_486);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_487);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_488);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_489);
app.get("/api/settings/retention", settings_retention_get_490);
app.post("/api/settings/retention", settings_retention_post_491);
app.get("/api/settings/storage-provider", settings_storage_provider_get_492);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_493);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_494);
app.get("/api/settings/terminology", settings_terminology_get_495);
app.post("/api/settings/terminology", settings_terminology_post_496);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_497);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_498);
app.get("/api/share/:token", share_token_get_499);
app.get("/api/signin-history", signin_history_get_500);
app.post("/api/signup", signup_post_501);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_502);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_503);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_504);
app.get("/api/subscription/status", subscription_status_get_505);
app.post("/api/subscription/webhook", subscription_webhook_post_506);
app.get("/api/support-mode/audit", support_mode_audit_get_507);
app.get("/api/support-mode/checklist", support_mode_checklist_get_508);
app.put("/api/support-mode/checklist", support_mode_checklist_put_509);
app.post("/api/support-mode/enter", support_mode_enter_post_510);
app.post("/api/support-mode/exit", support_mode_exit_post_511);
app.get("/api/support-mode/status", support_mode_status_get_512);
app.get("/api/tag-tasks", tag_tasks_get_513);
app.patch("/api/tag-tasks/:id", tag_tasks_id_patch_514);
app.get("/api/takeoff-pad", takeoff_pad_get_515);
app.put("/api/takeoff-pad", takeoff_pad_put_516);
app.get("/api/team", team_get_517);
app.post("/api/team/invite", team_invite_post_518);
app.get("/api/team/invites", team_invites_get_519);
app.post("/api/team/invites", team_invites_post_520);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_521);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_522);
app.get("/api/team/members", team_members_get_523);
app.post("/api/team/resend-verification", team_resend_verification_post_524);
app.post("/api/team/schedule/migrate", team_schedule_migrate_post_525);
app.get("/api/team/shifts", team_shifts_get_526);
app.post("/api/team/shifts", team_shifts_post_527);
app.delete("/api/team/shifts/:id", team_shifts_id_delete_528);
app.put("/api/team/shifts/:id", team_shifts_id_put_529);
app.get("/api/team/time-entries", team_time_entries_get_530);
app.post("/api/team/time-entries", team_time_entries_post_531);
app.get("/api/team/time-entries/export", team_time_entries_export_get_532);
app.put("/api/team/time-entries/:id", team_time_entries_id_put_533);
app.post("/api/team/verify-user", team_verify_user_post_534);
