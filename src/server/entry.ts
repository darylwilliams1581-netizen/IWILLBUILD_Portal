...
import migrate_form_logic_post from "./api/migrate-form-logic/POST";
...
import forms_id_fields_fieldId_thumbnail_post from "./api/forms/[id]/fields/[fieldId]/thumbnail/POST";
...
app.post("/api/forms/:id/fields/:fieldId/thumbnail", forms_id_fields_fieldId_thumbnail_post);
app.post("/api/migrate-form-fields", migrate_form_fields_post);
app.post("/api/migrate-form-logic", migrate_form_logic_post);
