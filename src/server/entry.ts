...
import incidents_incidentId_attachments_get_257 from "./api/incidents/[incidentId]/attachments/GET";
import incidents_incidentId_attachments_post_258 from "./api/incidents/[incidentId]/attachments/POST";
import incidents_incidentId_attachments_attachId_delete_259 from "./api/incidents/[incidentId]/attachments/[attachId]/DELETE";
import incidents_incidentId_close_post_260 from "./api/incidents/[incidentId]/close/POST";
import incidents_incidentId_corrective_actions_post_261 from "./api/incidents/[incidentId]/corrective-actions/POST";
import incidents_incidentId_corrective_actions_actionId_put_262 from "./api/incidents/[incidentId]/corrective-actions/[actionId]/PUT";
import incidents_incidentId_pdf_get_263 from "./api/incidents/[incidentId]/pdf/GET";
import incidents_incidentId_third_parties_post_264 from "./api/incidents/[incidentId]/third-parties/POST";
import incidents_incidentId_third_parties_thirdPartyId_delete_265 from "./api/incidents/[incidentId]/third-parties/[thirdPartyId]/DELETE";
import integrations_myob_auth_url_get_266 from "./api/integrations/myob/auth-url/GET";
import integrations_myob_callback_get_267 from "./api/integrations/myob/callback/GET";
import integrations_myob_disconnect_post_268 from "./api/integrations/myob/disconnect/POST";
import integrations_myob_status_get_269 from "./api/integrations/myob/status/GET";
import integrations_myob_sync_invoice_post_270 from "./api/integrations/myob/sync-invoice/POST";
import integrations_onedrive_auth_url_get_271 from "./api/integrations/onedrive/auth-url/GET";
import integrations_onedrive_callback_get_272 from "./api/integrations/onedrive/callback/GET";
import integrations_onedrive_disconnect_post_273 from "./api/integrations/onedrive/disconnect/POST";
import integrations_onedrive_status_get_274 from "./api/integrations/onedrive/status/GET";
import integrations_onedrive_upload_file_post_275 from "./api/integrations/onedrive/upload-file/POST";
import integrations_qbo_auth_url_get_276 from "./api/integrations/qbo/auth-url/GET";
import integrations_qbo_callback_get_277 from "./api/integrations/qbo/callback/GET";
import integrations_qbo_disconnect_post_278 from "./api/integrations/qbo/disconnect/POST";
import integrations_qbo_status_get_279 from "./api/integrations/qbo/status/GET";
import integrations_qbo_sync_invoice_post_280 from "./api/integrations/qbo/sync-invoice/POST";
import integrations_xero_auth_url_get_281 from "./api/integrations/xero/auth-url/GET";
import integrations_xero_callback_get_282 from "./api/integrations/xero/callback/GET";
import integrations_xero_disconnect_post_283 from "./api/integrations/xero/disconnect/POST";
import integrations_xero_status_get_284 from "./api/integrations/xero/status/GET";
import integrations_xero_sync_customer_post_285 from "./api/integrations/xero/sync-customer/POST";
import integrations_xero_sync_invoice_post_286 from "./api/integrations/xero/sync-invoice/POST";
import integrations_xero_webhook_post_287 from "./api/integrations/xero/webhook/POST";
import invoices_get_288 from "./api/invoices/GET";
import invoices_post_289 from "./api/invoices/POST";
import invoices_id_delete_290 from "./api/invoices/[id]/DELETE";
import invoices_id_get_291 from "./api/invoices/[id]/GET";
import invoices_id_put_292 from "./api/invoices/[id]/PUT";
import invoices_id_duplicate_post_293 from "./api/invoices/[id]/duplicate/POST";
import invoices_id_export_pdf_get_294 from "./api/invoices/[id]/export-pdf/GET";
import invoices_id_mark_sent_post_295 from "./api/invoices/[id]/mark-sent/POST";
import invoices_id_record_payment_post_296 from "./api/invoices/[id]/record-payment/POST";
import invoices_id_send_email_post_297 from "./api/invoices/[id]/send-email/POST";
import invoices_id_unlock_patch_298 from "./api/invoices/[id]/unlock/PATCH";
import invoices_id_void_post_299 from "./api/invoices/[id]/void/POST";
import job_cards_get_300 from "./api/job-cards/GET";
import job_cards_post_301 from "./api/job-cards/POST";
import job_cards_id_delete_302 from "./api/job-cards/[id]/DELETE";
import job_cards_id_get_303 from "./api/job-cards/[id]/GET";
import job_cards_id_put_304 from "./api/job-cards/[id]/PUT";
import job_cards_id_convert_post_305 from "./api/job-cards/[id]/convert/POST";
import job_cards_id_invoice_post_306 from "./api/job-cards/[id]/invoice/POST";
import job_cards_id_photos_post_307 from "./api/job-cards/[id]/photos/POST";
import job_cards_id_photos_photoId_delete_308 from "./api/job-cards/[id]/photos/[photoId]/DELETE";
import job_costs_post_309 from "./api/job-costs/POST";
import job_forms_id_delete_310 from "./api/job-forms/[id]/DELETE";
import job_forms_id_get_311 from "./api/job-forms/[id]/GET";
import job_forms_id_put_312 from "./api/job-forms/[id]/PUT";
import job_forms_id_reset_post_313 from "./api/job-forms/[id]/reset/POST";
import job_forms_id_share_delete_314 from "./api/job-forms/[id]/share/DELETE";
import job_forms_id_share_get_315 from "./api/job-forms/[id]/share/GET";
...
import jobs_id_put_321 from "./api/jobs/[id]/PUT";
import jobs_id_attendance_attendanceId_close_post_322 from "./api/jobs/[id]/attendance/[attendanceId]/close/POST";
import jobs_id_costs_get_323 from "./api/jobs/[id]/costs/GET";
import jobs_id_costs_post_324 from "./api/jobs/[id]/costs/POST";
import jobs_id_costs_export_get_325 from "./api/jobs/[id]/costs/export/GET";
import jobs_id_costs_costId_delete_326 from "./api/jobs/[id]/costs/[costId]/DELETE";
import jobs_id_costs_costId_put_327 from "./api/jobs/[id]/costs/[costId]/PUT";
import jobs_id_costs_costId_receipt_get_328 from "./api/jobs/[id]/costs/[costId]/receipt/GET";
import jobs_id_costs_costId_receipt_post_329 from "./api/jobs/[id]/costs/[costId]/receipt/POST";
import jobs_id_delays_get_330 from "./api/jobs/[id]/delays/GET";
import jobs_id_delays_post_331 from "./api/jobs/[id]/delays/POST";
import jobs_id_delays_export_csv_get_332 from "./api/jobs/[id]/delays/export-csv/GET";
import jobs_id_delays_delayId_delete_333 from "./api/jobs/[id]/delays/[delayId]/DELETE";
import jobs_id_delays_delayId_put_334 from "./api/jobs/[id]/delays/[delayId]/PUT";
import jobs_id_documents_get_335 from "./api/jobs/[id]/documents/GET";
import jobs_id_documents_post_336 from "./api/jobs/[id]/documents/POST";
import jobs_id_export_zip_get_337 from "./api/jobs/[id]/export-zip/GET";
import jobs_id_field_docs_get_338 from "./api/jobs/[id]/field-docs/GET";
import jobs_id_files_get_339 from "./api/jobs/[id]/files/GET";
import jobs_id_forms_get_340 from "./api/jobs/[id]/forms/GET";
import jobs_id_forms_post_341 from "./api/jobs/[id]/forms/POST";
import jobs_id_forms_export_csv_get_342 from "./api/jobs/[id]/forms/export-csv/GET";
import jobs_id_forms_submissionId_delete_343 from "./api/jobs/[id]/forms/[submissionId]/DELETE";
import jobs_id_forms_submissionId_reopen_post_344 from "./api/jobs/[id]/forms/[submissionId]/reopen/POST";
import jobs_id_generate_qr_post_345 from "./api/jobs/[id]/generate-qr/POST";
import jobs_id_ledger_get_346 from "./api/jobs/[id]/ledger/GET";
import jobs_id_ledger_post_347 from "./api/jobs/[id]/ledger/POST";
import jobs_id_ledger_export_get_348 from "./api/jobs/[id]/ledger/export/GET";
import jobs_id_ledger_sync_post_349 from "./api/jobs/[id]/ledger/sync/POST";
import jobs_id_ledger_entryId_delete_350 from "./api/jobs/[id]/ledger/[entryId]/DELETE";
import jobs_id_ledger_entryId_put_351 from "./api/jobs/[id]/ledger/[entryId]/PUT";
import jobs_id_ledger_entryId_correct_post_352 from "./api/jobs/[id]/ledger/[entryId]/correct/POST";
import jobs_id_milestones_get_353 from "./api/jobs/[id]/milestones/GET";
import jobs_id_milestones_post_354 from "./api/jobs/[id]/milestones/POST";
import jobs_id_milestones_milestoneId_delete_355 from "./api/jobs/[id]/milestones/[milestoneId]/DELETE";
import jobs_id_milestones_milestoneId_patch_356 from "./api/jobs/[id]/milestones/[milestoneId]/PATCH";
import jobs_id_notes_export_csv_get_357 from "./api/jobs/[id]/notes/export-csv/GET";
import jobs_id_photos_get_358 from "./api/jobs/[id]/photos/GET";
import jobs_id_photos_post_359 from "./api/jobs/[id]/photos/POST";
import jobs_id_photos_export_zip_post_360 from "./api/jobs/[id]/photos/export-zip/POST";
import jobs_id_photos_picker_get_361 from "./api/jobs/[id]/photos/picker/GET";
import jobs_id_photos_share_post_362 from "./api/jobs/[id]/photos/share/POST";
import jobs_id_photos_photoId_delete_363 from "./api/jobs/[id]/photos/[photoId]/DELETE";
...
import jobs_id_progress_export_csv_get_370 from "./api/jobs/[id]/progress/export-csv/GET";
import jobs_id_progress_report_get_371 from "./api/jobs/[id]/progress/report/GET";
import jobs_id_progress_report_put_372 from "./api/jobs/[id]/progress/report/PUT";
import jobs_id_progress_report_pdf_get_373 from "./api/jobs/[id]/progress/report/pdf/GET";
import jobs_id_progress_sync_post_374 from "./api/jobs/[id]/progress/sync/POST";
import jobs_id_purchase_orders_get_375 from "./api/jobs/[id]/purchase-orders/GET";
import jobs_id_purchase_orders_post_376 from "./api/jobs/[id]/purchase-orders/POST";
import jobs_id_purchase_orders_poId_delete_377 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import jobs_id_purchase_orders_poId_get_378 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
import jobs_id_purchase_orders_poId_put_379 from "./api/jobs/[id]/purchase-orders/[poId]/PUT";
import jobs_id_purchase_orders_poId_pdf_get_380 from "./api/jobs/[id]/purchase-orders/[poId]/pdf/GET";
import jobs_id_report_pdf_post_381 from "./api/jobs/[id]/report/pdf/POST";
import jobs_id_risky_get_382 from "./api/jobs/[id]/risky/GET";
import jobs_id_risky_post_383 from "./api/jobs/[id]/risky/POST";
import jobs_id_risky_riskyId_get_384 from "./api/jobs/[id]/risky/[riskyId]/GET";
import jobs_id_risky_riskyId_put_385 from "./api/jobs/[id]/risky/[riskyId]/PUT";
import jobs_id_risky_riskyId_finalise_post_386 from "./api/jobs/[id]/risky/[riskyId]/finalise/POST";
import jobs_id_risky_riskyId_signatures_post_387 from "./api/jobs/[id]/risky/[riskyId]/signatures/POST";
import jobs_id_risky_riskyId_supervisor_signoff_post_388 from "./api/jobs/[id]/risky/[riskyId]/supervisor-signoff/POST";
import jobs_id_signin_post_389 from "./api/jobs/[id]/signin/POST";
import jobs_id_signin_qr_post_390 from "./api/jobs/[id]/signin-qr/POST";
import jobs_id_signin_status_get_391 from "./api/jobs/[id]/signin-status/GET";
import jobs_id_signout_post_392 from "./api/jobs/[id]/signout/POST";
import jobs_id_signout_qr_post_393 from "./api/jobs/[id]/signout-qr/POST";
import jobs_id_signout_user_post_394 from "./api/jobs/[id]/signout-user/POST";
import jobs_id_site_prestarts_get_395 from "./api/jobs/[id]/site-prestarts/GET";
import jobs_id_site_prestarts_post_396 from "./api/jobs/[id]/site-prestarts/POST";
import jobs_id_site_prestarts_prestartId_get_397 from "./api/jobs/[id]/site-prestarts/[prestartId]/GET";
import jobs_id_site_prestarts_prestartId_put_398 from "./api/jobs/[id]/site-prestarts/[prestartId]/PUT";
import jobs_id_site_prestarts_prestartId_finalise_post_399 from "./api/jobs/[id]/site-prestarts/[prestartId]/finalise/POST";
import jobs_id_site_prestarts_prestartId_workers_post_400 from "./api/jobs/[id]/site-prestarts/[prestartId]/workers/POST";
import jobs_id_swms_get_401 from "./api/jobs/[id]/swms/GET";
import jobs_id_swms_post_402 from "./api/jobs/[id]/swms/POST";
import jobs_id_swms_swmsId_signoff_post_403 from "./api/jobs/[id]/swms/[swmsId]/signoff/POST";
import jobs_id_todos_get_404 from "./api/jobs/[id]/todos/GET";
import jobs_id_todos_post_405 from "./api/jobs/[id]/todos/POST";
import jobs_id_todos_todoId_delete_406 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import jobs_id_todos_todoId_put_407 from "./api/jobs/[id]/todos/[todoId]/PUT";
import library_items_get_408 from "./api/library/items/GET";
import library_items_id_get_409 from "./api/library/items/[id]/GET";
import library_items_id_patch_410 from "./api/library/items/[id]/PATCH";
import library_items_id_download_get_411 from "./api/library/items/[id]/download/GET";
import library_items_id_install_delete_412 from "./api/library/items/[id]/install/DELETE";
import library_items_id_install_post_413 from "./api/library/items/[id]/install/POST";
import library_my_installed_get_414 from "./api/library/my-installed/GET";
import library_my_submissions_get_415 from "./api/library/my-submissions/GET";
import lists_get_416 from "./api/lists/GET";
import me_get_417 from "./api/me/GET";
import me_put_418 from "./api/me/PUT";
import me_2fa_disable_post_419 from "./api/me/2fa/disable/POST";
import me_2fa_enable_post_420 from "./api/me/2fa/enable/POST";
import me_2fa_setup_get_421 from "./api/me/2fa/setup/GET";
import me_2fa_status_get_422 from "./api/me/2fa/status/GET";
import me_2fa_verify_post_423 from "./api/me/2fa/verify/POST";
import me_active_status_get_424 from "./api/me/active-status/GET";
import me_change_password_post_425 from "./api/me/change-password/POST";
import me_email_status_get_426 from "./api/me/email-status/GET";
import me_phone_get_427 from "./api/me/phone/GET";
import me_phone_put_428 from "./api/me/phone/PUT";
import me_profile_attachments_delete_429 from "./api/me/profile-attachments/DELETE";
import me_profile_attachments_post_430 from "./api/me/profile-attachments/POST";
import me_profile_extras_get_431 from "./api/me/profile-extras/GET";
import me_profile_extras_put_432 from "./api/me/profile-extras/PUT";
import migrate_account_recovery_post_433 from "./api/migrate-account-recovery/POST";
import migrate_asset_manager_post_434 from "./api/migrate-asset-manager/POST";
import migrate_attendance_post_435 from "./api/migrate-attendance/POST";
import migrate_company_settings_post_436 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_437 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_438 from "./api/migrate-dazza-knowledge/POST";
import migrate_emergency_alerts_post_439 from "./api/migrate-emergency-alerts/POST";
import migrate_estimates_post_440 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_441 from "./api/migrate-estimating-library/POST";
import migrate_files_post_442 from "./api/migrate-files/POST";
import migrate_fleet_post_443 from "./api/migrate-fleet/POST";
import migrate_fleet_analytics_post_444 from "./api/migrate-fleet-analytics/POST";
import migrate_fleet_driver_sessions_post_445 from "./api/migrate-fleet-driver-sessions/POST";
import migrate_fleet_usage_post_446 from "./api/migrate-fleet-usage/POST";
import migrate_form_fields_post_447 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_448 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_449 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_450 from "./api/migrate-job-forms/POST";
import migrate_job_photo_shares_post_451 from "./api/migrate-job-photo-shares/POST";
import migrate_job_photos_post_452 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_453 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_454 from "./api/migrate-jobs/POST";
import migrate_ledger_photo_post_455 from "./api/migrate-ledger-photo/POST";
import migrate_library_post_456 from "./api/migrate-library/POST";
import migrate_library_downloads_post_457 from "./api/migrate-library-downloads/POST";
import migrate_notifications_post_458 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_459 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_460 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_461 from "./api/migrate-pdf-settings/POST";
import migrate_plan_manager_post_462 from "./api/migrate-plan-manager/POST";
import migrate_plan_manager_v2_post_463 from "./api/migrate-plan-manager-v2/POST";
import migrate_plan_manager_v3_post_464 from "./api/migrate-plan-manager-v3/POST";
import migrate_safety_post_465 from "./api/migrate-safety/POST";
import migrate_site_prestart_post_466 from "./api/migrate-site-prestart/POST";
import migrate_sms_verified_at_post_467 from "./api/migrate-sms-verified-at/POST";
import migrate_starter_pack_post_468 from "./api/migrate-starter-pack/POST";
import migrate_studio_pdf_post_469 from "./api/migrate-studio-pdf/POST";
import migrate_subscriptions_post_470 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_471 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_472 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_473 from "./api/migrate-team/POST";
import notes_get_474 from "./api/notes/GET";
import notes_post_475 from "./api/notes/POST";
import notes_comments_post_476 from "./api/notes/comments/POST";
import notes_migrate_post_477 from "./api/notes/migrate/POST";
import notes_id_delete_478 from "./api/notes/[id]/DELETE";
import notifications_alerts_get_479 from "./api/notifications/alerts/GET";
import notifications_prefs_get_480 from "./api/notifications/prefs/GET";
import notifications_prefs_put_481 from "./api/notifications/prefs/PUT";
import notifications_read_post_482 from "./api/notifications/read/POST";
import owner_console_activity_get_483 from "./api/owner-console/activity/GET";
import owner_console_cancellation_feedback_get_484 from "./api/owner-console/cancellation-feedback/GET";
import owner_console_companies_get_485 from "./api/owner-console/companies/GET";
import owner_console_companies_post_486 from "./api/owner-console/companies/POST";
import owner_console_companies_usage_get_487 from "./api/owner-console/companies/usage/GET";
import owner_console_companies_id_limits_put_488 from "./api/owner-console/companies/[id]/limits/PUT";
import owner_console_form_templates_get_489 from "./api/owner-console/form-templates/GET";
import owner_console_form_templates_post_490 from "./api/owner-console/form-templates/POST";
import owner_console_library_items_get_491 from "./api/owner-console/library/items/GET";
import owner_console_library_items_post_492 from "./api/owner-console/library/items/POST";
import owner_console_library_items_id_delete_493 from "./api/owner-console/library/items/[id]/DELETE";
import owner_console_library_items_id_patch_494 from "./api/owner-console/library/items/[id]/PATCH";
import owner_console_library_items_id_put_495 from "./api/owner-console/library/items/[id]/PUT";
import owner_console_library_items_id_push_update_post_496 from "./api/owner-console/library/items/[id]/push-update/POST";
import owner_console_library_submissions_get_497 from "./api/owner-console/library/submissions/GET";
import owner_console_library_submissions_id_review_post_498 from "./api/owner-console/library/submissions/[id]/review/POST";
import owner_console_starter_pack_get_499 from "./api/owner-console/starter-pack/GET";
import owner_console_starter_pack_post_500 from "./api/owner-console/starter-pack/POST";
import owner_console_stats_get_501 from "./api/owner-console/stats/GET";
import owner_console_storage_get_502 from "./api/owner-console/storage/GET";
import owner_console_swms_masters_get_503 from "./api/owner-console/swms/masters/GET";
import owner_console_swms_masters_post_504 from "./api/owner-console/swms/masters/POST";
import owner_console_swms_masters_publish_all_post_505 from "./api/owner-console/swms/masters/publish-all/POST";
import owner_console_swms_masters_id_delete_506 from "./api/owner-console/swms/masters/[id]/DELETE";
import owner_console_swms_masters_id_get_507 from "./api/owner-console/swms/masters/[id]/GET";
import owner_console_swms_masters_id_put_508 from "./api/owner-console/swms/masters/[id]/PUT";
import owner_console_swms_masters_id_publish_post_509 from "./api/owner-console/swms/masters/[id]/publish/POST";
import owner_console_swms_migrate_master_library_post_510 from "./api/owner-console/swms/migrate-master-library/POST";
import owner_console_swms_push_post_511 from "./api/owner-console/swms/push/POST";
import owner_console_swms_seed_bricklaying_post_512 from "./api/owner-console/swms/seed-bricklaying/POST";
import owner_console_swms_seed_building_inspection_post_513 from "./api/owner-console/swms/seed-building-inspection/POST";
import owner_console_swms_seed_cabinets_post_514 from "./api/owner-console/swms/seed-cabinets/POST";
import owner_console_swms_seed_carpenter_fixing_post_515 from "./api/owner-console/swms/seed-carpenter-fixing/POST";
import owner_console_swms_seed_carpenter_framing_post_516 from "./api/owner-console/swms/seed-carpenter-framing/POST";
import owner_console_swms_seed_carpenter_lockup_post_517 from "./api/owner-console/swms/seed-carpenter-lockup/POST";
import owner_console_swms_seed_ceramic_tiling_post_518 from "./api/owner-console/swms/seed-ceramic-tiling/POST";
import owner_console_swms_seed_concreting_slab_post_519 from "./api/owner-console/swms/seed-concreting-slab/POST";
import owner_console_swms_seed_delivery_loading_post_520 from "./api/owner-console/swms/seed-delivery-loading/POST";
import owner_console_swms_seed_environmental_spill_post_521 from "./api/owner-console/swms/seed-environmental-spill/POST";
import owner_console_swms_seed_ewp_post_522 from "./api/owner-console/swms/seed-ewp/POST";
import owner_console_swms_seed_excavations_substation_post_523 from "./api/owner-console/swms/seed-excavations-substation/POST";
import owner_console_swms_seed_fencing_post_524 from "./api/owner-console/swms/seed-fencing/POST";
import owner_console_swms_seed_heat_stress_post_525 from "./api/owner-console/swms/seed-heat-stress/POST";
import owner_console_swms_seed_landscaping_post_526 from "./api/owner-console/swms/seed-landscaping/POST";
import owner_console_swms_seed_live_parts_post_527 from "./api/owner-console/swms/seed-live-parts/POST";
import owner_console_swms_seed_manual_handling_post_528 from "./api/owner-console/swms/seed-manual-handling/POST";
import owner_console_swms_seed_moving_plant_post_529 from "./api/owner-console/swms/seed-moving-plant/POST";
import owner_console_swms_seed_painting_post_530 from "./api/owner-console/swms/seed-painting/POST";
import owner_console_swms_seed_power_tools_post_531 from "./api/owner-console/swms/seed-power-tools/POST";
import owner_console_swms_seed_silica_dust_post_532 from "./api/owner-console/swms/seed-silica-dust/POST";
import owner_console_swms_seed_traffic_management_post_533 from "./api/owner-console/swms/seed-traffic-management/POST";
import owner_console_swms_seed_underground_services_post_534 from "./api/owner-console/swms/seed-underground-services/POST";
import owner_console_swms_seed_vacuum_excavation_post_535 from "./api/owner-console/swms/seed-vacuum-excavation/POST";
import owner_console_system_ai_builtin_checks_post_536 from "./api/owner-console/system-ai/builtin-checks/POST";
import owner_console_users_get_537 from "./api/owner-console/users/GET";
import owner_console_users_verify_post_538 from "./api/owner-console/users/verify/POST";
import plan_manager_drawings_get_539 from "./api/plan-manager/drawings/GET";
import plan_manager_drawings_post_540 from "./api/plan-manager/drawings/POST";
import plan_manager_drawings_id_get_541 from "./api/plan-manager/drawings/[id]/GET";
import plan_manager_drawings_id_annotations_put_542 from "./api/plan-manager/drawings/[id]/annotations/PUT";
import plan_manager_drawings_id_archive_post_543 from "./api/plan-manager/drawings/[id]/archive/POST";
import plan_manager_drawings_id_job_links_delete_544 from "./api/plan-manager/drawings/[id]/job-links/DELETE";
import plan_manager_drawings_id_job_links_post_545 from "./api/plan-manager/drawings/[id]/job-links/POST";
import plan_manager_drawings_id_pages_pageNo_annotations_get_546 from "./api/plan-manager/drawings/[id]/pages/[pageNo]/annotations/GET";
import plan_manager_drawings_id_permanent_delete_547 from "./api/plan-manager/drawings/[id]/permanent/DELETE";
import plan_manager_drawings_id_reorder_patch_548 from "./api/plan-manager/drawings/[id]/reorder/PATCH";
import plan_manager_drawings_id_restore_post_549 from "./api/plan-manager/drawings/[id]/restore/POST";
import plan_manager_drawings_id_revisions_post_550 from "./api/plan-manager/drawings/[id]/revisions/POST";
import plan_manager_drawings_id_revisions_revisionId_finalize_post_551 from "./api/plan-manager/drawings/[id]/revisions/[revisionId]/finalize/POST";
import plan_manager_drawings_id_upload_post_552 from "./api/plan-manager/drawings/[id]/upload/POST";
import plan_manager_jobs_jobId_drawings_zip_get_553 from "./api/plan-manager/jobs/[jobId]/drawings-zip/GET";
import plan_manager_jobs_with_drawings_get_554 from "./api/plan-manager/jobs-with-drawings/GET";
import plan_manager_share_post_555 from "./api/plan-manager/share/POST";
import plan_manager_share_validate_get_556 from "./api/plan-manager/share/validate/GET";
import portal_estimates_id_approve_post_557 from "./api/portal/estimates/[id]/approve/POST";
import portal_invite_post_558 from "./api/portal/invite/POST";
import portal_invoices_id_pay_post_559 from "./api/portal/invoices/[id]/pay/POST";
import portal_jobs_get_560 from "./api/portal/jobs/GET";
import portal_jobs_id_get_561 from "./api/portal/jobs/[id]/GET";
import portal_migrate_post_562 from "./api/portal/migrate/POST";
import portal_validate_post_563 from "./api/portal/validate/POST";
import public_form_token_get_564 from "./api/public/form/[token]/GET";
import public_form_token_submit_post_565 from "./api/public/form/[token]/submit/POST";
import public_job_photos_token_get_566 from "./api/public/job-photos/[token]/GET";
import public_job_photos_token_photo_photoId_get_567 from "./api/public/job-photos/[token]/photo/[photoId]/GET";
import public_swms_token_get_568 from "./api/public/swms/[token]/GET";
import public_swms_token_signoff_post_569 from "./api/public/swms/[token]/signoff/POST";
import push_subscribe_delete_570 from "./api/push/subscribe/DELETE";
import push_subscribe_post_571 from "./api/push/subscribe/POST";
import push_vapid_key_get_572 from "./api/push/vapid-key/GET";
import quick_links_site_meta_get_573 from "./api/quick-links/site-meta/GET";
import recipes_get_574 from "./api/recipes/GET";
import recipes_post_575 from "./api/recipes/POST";
import recipes_id_delete_576 from "./api/recipes/[id]/DELETE";
import recipes_id_put_577 from "./api/recipes/[id]/PUT";
import risk_register_get_578 from "./api/risk-register/GET";
import risk_register_post_579 from "./api/risk-register/POST";
import risk_register_id_get_580 from "./api/risk-register/[id]/GET";
import risk_register_id_put_581 from "./api/risk-register/[id]/PUT";
import risk_register_id_archive_post_582 from "./api/risk-register/[id]/archive/POST";
import risk_register_id_unarchive_post_583 from "./api/risk-register/[id]/unarchive/POST";
import safety_ai_draft_post_584 from "./api/safety/ai/draft/POST";
import safety_documents_get_585 from "./api/safety/documents/GET";
import safety_documents_post_586 from "./api/safety/documents/POST";
import safety_documents_id_delete_587 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_588 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_589 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_590 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_591 from "./api/safety/generated-posters/[id]/DELETE";
import safety_job_safety_plans_get_592 from "./api/safety/job-safety-plans/GET";
import safety_job_safety_plans_post_593 from "./api/safety/job-safety-plans/POST";
import safety_job_safety_plans_id_delete_594 from "./api/safety/job-safety-plans/[id]/DELETE";
import safety_job_safety_plans_id_put_595 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_596 from "./api/safety/job-swms/GET";
import safety_job_swms_post_597 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_598 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_599 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_600 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_share_token_post_601 from "./api/safety/job-swms/[id]/share-token/POST";
import safety_job_swms_id_signoffs_get_602 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_603 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_604 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_605 from "./api/safety/plans/GET";
import safety_plans_post_606 from "./api/safety/plans/POST";
import safety_plans_seed_post_607 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_608 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_609 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_610 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_611 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_612 from "./api/safety/posters/GET";
import safety_posters_post_613 from "./api/safety/posters/POST";
import safety_posters_id_delete_614 from "./api/safety/posters/[id]/DELETE";
import safety_posters_id_download_get_615 from "./api/safety/posters/[id]/download/GET";
import safety_swms_get_615 from "./api/safety/swms/GET";
import safety_swms_post_616 from "./api/safety/swms/POST";
import safety_swms_import_docx_post_617 from "./api/safety/swms/import-docx/POST";
import safety_swms_seed_post_618 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_619 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_620 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_621 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_622 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_623 from "./api/safety/swms/[id]/export/GET";
import safety_swms_id_publish_to_library_post_624 from "./api/safety/swms/[id]/publish-to-library/POST";
import scheduler_crew_get_625 from "./api/scheduler/crew/GET";
import scheduler_jobs_get_626 from "./api/scheduler/jobs/GET";
import scheduler_jobs_id_reschedule_patch_627 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
import scheduler_tasks_get_628 from "./api/scheduler/tasks/GET";
import secure_share_get_629 from "./api/secure-share/GET";
import secure_share_post_630 from "./api/secure-share/POST";
import secure_share_id_delete_631 from "./api/secure-share/[id]/DELETE";
import secure_share_token_get_632 from "./api/secure-share/[token]/GET";
import secure_share_token_post_633 from "./api/secure-share/[token]/POST";
import settings_backup_get_634 from "./api/settings/backup/GET";
import settings_backup_post_635 from "./api/settings/backup/POST";
import settings_backup_company_data_get_636 from "./api/settings/backup/company-data/GET";
import settings_backup_csv_pack_get_637 from "./api/settings/backup/csv-pack/GET";
import settings_backup_export_get_638 from "./api/settings/backup/export/GET";
import settings_backup_run_post_639 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_640 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_641 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_642 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_643 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_644 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_645 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_646 from "./api/settings/retention/GET";
import settings_retention_post_647 from "./api/settings/retention/POST";
import settings_storage_provider_get_648 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_649 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_650 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_651 from "./api/settings/terminology/GET";
import settings_terminology_post_652 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_653 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_654 from "./api/settings/xero-credentials/POST";
import share_token_get_655 from "./api/share/[token]/GET";
import signin_history_get_656 from "./api/signin-history/GET";
import signup_post_657 from "./api/signup/POST";
import sos_get_658 from "./api/sos/GET";
import sos_acknowledge_post_659 from "./api/sos/acknowledge/POST";
import sos_trigger_post_660 from "./api/sos/trigger/POST";
import stakeholders_sms_post_661 from "./api/stakeholders/sms/POST";
import stripe_create_checkout_session_post_662 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_663 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_664 from "./api/subscription/create-checkout/POST";
import subscription_status_get_665 from "./api/subscription/status/GET";
import subscription_webhook_post_666 from "./api/subscription/webhook/POST";
import support_mode_audit_get_667 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_668 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_669 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_670 from "./api/support-mode/enter/POST";
import support_mode_exit_post_671 from "./api/support-mode/exit/POST";
import support_mode_status_get_672 from "./api/support-mode/status/GET";
import tag_tasks_get_673 from "./api/tag-tasks/GET";
import tag_tasks_id_patch_674 from "./api/tag-tasks/[id]/PATCH";
import takeoff_pad_get_675 from "./api/takeoff-pad/GET";
import takeoff_pad_put_676 from "./api/takeoff-pad/PUT";
import tasks_post_677 from "./api/tasks/POST";
import tasks_id_put_678 from "./api/tasks/[id]/PUT";
import team_get_679 from "./api/team/GET";
import team_invite_post_680 from "./api/team/invite/POST";
import team_invites_get_681 from "./api/team/invites/GET";
import team_invites_post_682 from "./api/team/invites/POST";
import team_invites_id_cancel_post_683 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_684 from "./api/team/invites/[id]/resend/POST";
import team_members_get_685 from "./api/team/members/GET";
import team_members_id_icon_permissions_get_686 from "./api/team/members/[id]/icon-permissions/GET";
import team_members_id_icon_permissions_put_687 from "./api/team/members/[id]/icon-permissions/PUT";
import team_resend_verification_post_688 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_689 from "./api/team/schedule/migrate/POST";
import team_shifts_get_690 from "./api/team/shifts/GET";
import team_shifts_post_691 from "./api/team/shifts/POST";
import team_shifts_id_delete_692 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_693 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_694 from "./api/team/time-entries/GET";
import team_time_entries_post_695 from "./api/team/time-entries/POST";
import team_time_entries_export_get_696 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_697 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_698 from "./api/team/verify-user/POST";
import team_id_delete_699 from "./api/team/[id]/DELETE";
import team_id_put_700 from "./api/team/[id]/PUT";
import usage_get_701 from "./api/usage/GET";
import user_logs_get_702 from "./api/user-logs/GET";
import user_logs_users_get_703 from "./api/user-logs/users/GET";
// </api-imports>
// ── Job Cards ─────────────────────────────────────────────────────────────────
...
app.delete("/api/me/profile-attachments", me_profile_attachments_delete_429);
...
app.get("/api/safety/swms", safety_swms_get_615);
app.post("/api/safety/swms", safety_swms_post_616);
app.post("/api/safety/swms/import-docx", safety_swms_import_docx_post_617);
app.post("/api/safety/swms/seed", safety_swms_seed_post_618);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_619);
app.get("/api/safety/swms/:id", safety_swms_id_get_620);
app.put("/api/safety/swms/:id", safety_swms_id_put_621);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_622);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_623);
app.post("/api/safety/swms/:id/publish-to-library", safety_swms_id_publish_to_library_post_624);
app.get("/api/scheduler/crew", scheduler_crew_get_625);
app.get("/api/scheduler/jobs", scheduler_jobs_get_626);
app.patch("/api/scheduler/jobs/:id/reschedule", scheduler_jobs_id_reschedule_patch_627);
app.get("/api/scheduler/tasks", scheduler_tasks_get_628);
app.get("/api/secure-share", secure_share_get_629);
app.post("/api/secure-share", secure_share_post_630);
app.delete("/api/secure-share/:id", secure_share_id_delete_631);
app.get("/api/secure-share/:token", secure_share_token_get_632);
app.post("/api/secure-share/:token", secure_share_token_post_633);
app.get("/api/settings/backup", settings_backup_get_634);
app.post("/api/settings/backup", settings_backup_post_635);
app.get("/api/settings/backup/company-data", settings_backup_company_data_get_636);
app.get("/api/settings/backup/csv-pack", settings_backup_csv_pack_get_637);
app.get("/api/settings/backup/export", settings_backup_export_get_638);
app.post("/api/settings/backup/run", settings_backup_run_post_639);
app.get("/api/settings/backup-destination", settings_backup_destination_get_640);
app.post("/api/settings/backup-destination", settings_backup_destination_post_641);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_642);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_643);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_644);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_645);
app.get("/api/settings/retention", settings_retention_get_646);
app.post("/api/settings/retention", settings_retention_post_647);
app.get("/api/settings/storage-provider", settings_storage_provider_get_648);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_649);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_650);
app.get("/api/settings/terminology", settings_terminology_get_651);
app.post("/api/settings/terminology", settings_terminology_post_652);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_653);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_654);
app.get("/api/share/:token", share_token_get_655);
app.get("/api/signin-history", signin_history_get_656);
app.post("/api/signup", signup_post_657);
app.get("/api/sos", sos_get_658);
app.post("/api/sos/acknowledge", sos_acknowledge_post_659);
app.post("/api/sos/trigger", sos_trigger_post_660);
app.post("/api/stakeholders/sms", stakeholders_sms_post_661);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_662);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_663);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_664);
app.get("/api/subscription/status", subscription_status_get_665);
app.post("/api/subscription/webhook", subscription_webhook_post_666);
app.get("/api/support-mode/audit", support_mode_audit_get_667);
app.get("/api/support-mode/checklist", support_mode_checklist_get_668);
app.put("/api/support-mode/checklist", support_mode_checklist_put_669);
app.post("/api/support-mode/enter", support_mode_enter_post_670);
app.post("/api/support-mode/exit", support_mode_exit_post_671);
app.get("/api/support-mode/status", support_mode_status_get_672);
app.get("/api/tag-tasks", tag_tasks_get_673);
app.patch("/api/tag-tasks/:id", tag_tasks_id_patch_674);
app.get("/api/takeoff-pad", takeoff_pad_get_675);
app.put("/api/takeoff-pad", takeoff_pad_put_676);
app.post("/api/tasks", tasks_post_677);
app.put("/api/tasks/:id", tasks_id_put_678);
app.get("/api/team", team_get_679);
app.post("/api/team/invite", team_invite_post_680);
app.get("/api/team/invites", team_invites_get_681);
app.post("/api/team/invites", team_invites_post_682);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_683);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_684);
app.get("/api/team/members", team_members_get_685);
app.get("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_get_686);
app.put("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_put_687);
app.post("/api/team/resend-verification", team_resend_verification_post_688);
app.post("/api/team/schedule/migrate", team_schedule_migrate_post_689);
app.get("/api/team/shifts", team_shifts_get_690);
app.post("/api/team/shifts", team_shifts_post_691);
app.delete("/api/team/shifts/:id", team_shifts_id_delete_692);
app.put("/api/team/shifts/:id", team_shifts_id_put_693);
app.get("/api/team/time-entries", team_time_entries_get_694);
app.post("/api/team/time-entries", team_time_entries_post_695);
app.get("/api/team/time-entries/export", team_time_entries_export_get_696);
app.put("/api/team/time-entries/:id", team_time_entries_id_put_697);
app.post("/api/team/verify-user", team_verify_user_post_698);
app.delete("/api/team/:id", team_id_delete_699);
app.put("/api/team/:id", team_id_put_700);
app.get("/api/usage", usage_get_701);
app.get("/api/user-logs", user_logs_get_702);
app.get("/api/user-logs/users", user_logs_users_get_703);
// </api-registrations>
