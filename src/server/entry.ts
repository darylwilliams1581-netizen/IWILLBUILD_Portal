...
import jobs_id_todos_get_137 from "./api/jobs/[id]/todos/GET";
import jobs_id_todos_post_138 from "./api/jobs/[id]/todos/POST";
import jobs_id_todos_todoId_delete_139 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import jobs_id_todos_todoId_put_140 from "./api/jobs/[id]/todos/[todoId]/PUT";
import me_get_141 from "./api/me/GET";
import me_put_142 from "./api/me/PUT";
import me_2fa_disable_post_143 from "./api/me/2fa/disable/POST";
import me_2fa_enable_post_144 from "./api/me/2fa/enable/POST";
import me_2fa_setup_get_145 from "./api/me/2fa/setup/GET";
import me_2fa_status_get_146 from "./api/me/2fa/status/GET";
import me_2fa_verify_post_147 from "./api/me/2fa/verify/POST";
import me_change_password_post_148 from "./api/me/change-password/POST";
import me_email_status_get_149 from "./api/me/email-status/GET";
import migrate_account_recovery_post_150 from "./api/migrate-account-recovery/POST";
import migrate_company_settings_post_151 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_152 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_153 from "./api/migrate-dazza-knowledge/POST";
import migrate_estimates_post_154 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_155 from "./api/migrate-estimating-library/POST";
import migrate_files_post_156 from "./api/migrate-files/POST";
import migrate_fleet_post_157 from "./api/migrate-fleet/POST";
import migrate_form_fields_post_158 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_159 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_160 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_161 from "./api/migrate-job-forms/POST";
import migrate_job_photos_post_162 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_163 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_164 from "./api/migrate-jobs/POST";
import migrate_notifications_post_165 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_166 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_167 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_168 from "./api/migrate-pdf-settings/POST";
import migrate_safety_post_169 from "./api/migrate-safety/POST";
import migrate_subscriptions_post_170 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_171 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_172 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_173 from "./api/migrate-team/POST";
import notifications_alerts_get_174 from "./api/notifications/alerts/GET";
import notifications_prefs_get_175 from "./api/notifications/prefs/GET";
import notifications_prefs_put_176 from "./api/notifications/prefs/PUT";
import notifications_read_post_177 from "./api/notifications/read/POST";
import owner_console_activity_get_178 from "./api/owner-console/activity/GET";
import owner_console_cancellation_feedback_get_179 from "./api/owner-console/cancellation-feedback/GET";
import owner_console_companies_get_180 from "./api/owner-console/companies/GET";
import owner_console_companies_post_181 from "./api/owner-console/companies/POST";
import owner_console_companies_usage_get_182 from "./api/owner-console/companies/usage/GET";
import owner_console_companies_id_limits_put_183 from "./api/owner-console/companies/[id]/limits/PUT";
import owner_console_stats_get_184 from "./api/owner-console/stats/GET";
import owner_console_storage_get_185 from "./api/owner-console/storage/GET";
import owner_console_users_get_186 from "./api/owner-console/users/GET";
import owner_console_users_verify_post_187 from "./api/owner-console/users/verify/POST";
import recipes_get_188 from "./api/recipes/GET";
import recipes_post_189 from "./api/recipes/POST";
import recipes_id_delete_190 from "./api/recipes/[id]/DELETE";
import recipes_id_put_191 from "./api/recipes/[id]/PUT";
import safety_ai_draft_post_192 from "./api/safety/ai/draft/POST";
import safety_documents_get_193 from "./api/safety/documents/GET";
import safety_documents_post_194 from "./api/safety/documents/POST";
import safety_documents_id_delete_195 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_196 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_197 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_198 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_199 from "./api/safety/generated-posters/[id]/DELETE";
import safety_job_swms_get_200 from "./api/safety/job-swms/GET";
import safety_job_swms_post_201 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_202 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_203 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_204 from "./api/safety/job-swms/[id]/PUT";
import safety_plans_get_205 from "./api/safety/plans/GET";
import safety_plans_post_206 from "./api/safety/plans/POST";
import safety_plans_seed_post_207 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_208 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_209 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_210 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_211 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_212 from "./api/safety/posters/GET";
import safety_posters_post_213 from "./api/safety/posters/POST";
import safety_posters_id_delete_214 from "./api/safety/posters/[id]/DELETE";
import safety_swms_get_215 from "./api/safety/swms/GET";
import safety_swms_post_216 from "./api/safety/swms/POST";
import safety_swms_seed_post_217 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_218 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_219 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_220 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_221 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_222 from "./api/safety/swms/[id]/export/GET";
import scheduler_jobs_get_223 from "./api/scheduler/jobs/GET";
import settings_backup_get_224 from "./api/settings/backup/GET";
import settings_backup_post_225 from "./api/settings/backup/POST";
import settings_backup_export_get_226 from "./api/settings/backup/export/GET";
import settings_backup_run_post_227 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_228 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_229 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_230 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_231 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_232 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_233 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_234 from "./api/settings/retention/GET";
import settings_retention_post_235 from "./api/settings/retention/POST";
import settings_storage_provider_get_236 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_237 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_238 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_239 from "./api/settings/terminology/GET";
import settings_terminology_post_240 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_241 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_242 from "./api/settings/xero-credentials/POST";
import signup_post_243 from "./api/signup/POST";
import stripe_create_checkout_session_post_244 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_245 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_246 from "./api/subscription/create-checkout/POST";
import subscription_status_get_247 from "./api/subscription/status/GET";
import subscription_webhook_post_248 from "./api/subscription/webhook/POST";
import support_mode_audit_get_249 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_250 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_251 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_252 from "./api/support-mode/enter/POST";
import support_mode_exit_post_253 from "./api/support-mode/exit/POST";
import support_mode_status_get_254 from "./api/support-mode/status/GET";
import takeoff_pad_get_255 from "./api/takeoff-pad/GET";
import takeoff_pad_put_256 from "./api/takeoff-pad/PUT";
import team_get_257 from "./api/team/GET";
import team_invite_post_258 from "./api/team/invite/POST";
import team_members_get_259 from "./api/team/members/GET";
import team_resend_verification_post_260 from "./api/team/resend-verification/POST";
import team_verify_user_post_261 from "./api/team/verify-user/POST";
import team_id_delete_262 from "./api/team/[id]/DELETE";
import team_id_put_263 from "./api/team/[id]/PUT";
import usage_get_264 from "./api/usage/GET";
// </api-imports>
...
app.get("/api/jobs/:id/todos", jobs_id_todos_get_137);
app.post("/api/jobs/:id/todos", jobs_id_todos_post_138);
app.delete("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_delete_139);
app.put("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_put_140);
app.get("/api/me", me_get_141);
app.put("/api/me", me_put_142);
app.post("/api/me/2fa/disable", me_2fa_disable_post_143);
app.post("/api/me/2fa/enable", me_2fa_enable_post_144);
app.get("/api/me/2fa/setup", me_2fa_setup_get_145);
app.get("/api/me/2fa/status", me_2fa_status_get_146);
app.post("/api/me/2fa/verify", me_2fa_verify_post_147);
app.post("/api/me/change-password", me_change_password_post_148);
app.get("/api/me/email-status", me_email_status_get_149);
app.post("/api/migrate-account-recovery", migrate_account_recovery_post_150);
app.post("/api/migrate-company-settings", migrate_company_settings_post_151);
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_152);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_153);
app.post("/api/migrate-estimates", migrate_estimates_post_154);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_155);
app.post("/api/migrate-files", migrate_files_post_156);
app.post("/api/migrate-fleet", migrate_fleet_post_157);
app.post("/api/migrate-form-fields", migrate_form_fields_post_158);
app.post("/api/migrate-form-logic", migrate_form_logic_post_159);
app.post("/api/migrate-form-templates", migrate_form_templates_post_160);
app.post("/api/migrate-job-forms", migrate_job_forms_post_161);
app.post("/api/migrate-job-photos", migrate_job_photos_post_162);
app.post("/api/migrate-job-tabs", migrate_job_tabs_post_163);
app.post("/api/migrate-jobs", migrate_jobs_post_164);
app.post("/api/migrate-notifications", migrate_notifications_post_165);
app.post("/api/migrate-owner-console", migrate_owner_console_post_166);
app.post("/api/migrate-owner-role", migrate_owner_role_post_167);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_168);
app.post("/api/migrate-safety", migrate_safety_post_169);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_170);
app.post("/api/migrate-support-mode", migrate_support_mode_post_171);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_172);
app.post("/api/migrate-team", migrate_team_post_173);
app.get("/api/notifications/alerts", notifications_alerts_get_174);
app.get("/api/notifications/prefs", notifications_prefs_get_175);
app.put("/api/notifications/prefs", notifications_prefs_put_176);
app.post("/api/notifications/read", notifications_read_post_177);
app.get("/api/owner-console/activity", owner_console_activity_get_178);
app.get("/api/owner-console/cancellation-feedback", owner_console_cancellation_feedback_get_179);
app.get("/api/owner-console/companies", owner_console_companies_get_180);
app.post("/api/owner-console/companies", owner_console_companies_post_181);
app.get("/api/owner-console/companies/usage", owner_console_companies_usage_get_182);
app.put("/api/owner-console/companies/:id/limits", owner_console_companies_id_limits_put_183);
app.get("/api/owner-console/stats", owner_console_stats_get_184);
app.get("/api/owner-console/storage", owner_console_storage_get_185);
app.get("/api/owner-console/users", owner_console_users_get_186);
app.post("/api/owner-console/users/verify", owner_console_users_verify_post_187);
app.get("/api/recipes", recipes_get_188);
app.post("/api/recipes", recipes_post_189);
app.delete("/api/recipes/:id", recipes_id_delete_190);
app.put("/api/recipes/:id", recipes_id_put_191);
app.post("/api/safety/ai/draft", safety_ai_draft_post_192);
app.get("/api/safety/documents", safety_documents_get_193);
app.post("/api/safety/documents", safety_documents_post_194);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_195);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_196);
app.get("/api/safety/generated-posters", safety_generated_posters_get_197);
app.post("/api/safety/generated-posters", safety_generated_posters_post_198);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_199);
app.get("/api/safety/job-swms", safety_job_swms_get_200);
app.post("/api/safety/job-swms", safety_job_swms_post_201);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_202);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_203);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_204);
app.get("/api/safety/plans", safety_plans_get_205);
app.post("/api/safety/plans", safety_plans_post_206);
app.post("/api/safety/plans/seed", safety_plans_seed_post_207);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_208);
app.put("/api/safety/plans/:id", safety_plans_id_put_209);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_210);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_211);
app.get("/api/safety/posters", safety_posters_get_212);
app.post("/api/safety/posters", safety_posters_post_213);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_214);
app.get("/api/safety/swms", safety_swms_get_215);
app.post("/api/safety/swms", safety_swms_post_216);
app.post("/api/safety/swms/seed", safety_swms_seed_post_217);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_218);
app.get("/api/safety/swms/:id", safety_swms_id_get_219);
app.put("/api/safety/swms/:id", safety_swms_id_put_220);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_221);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_222);
app.get("/api/scheduler/jobs", scheduler_jobs_get_223);
app.get("/api/settings/backup", settings_backup_get_224);
app.post("/api/settings/backup", settings_backup_post_225);
app.get("/api/settings/backup/export", settings_backup_export_get_226);
app.post("/api/settings/backup/run", settings_backup_run_post_227);
app.get("/api/settings/backup-destination", settings_backup_destination_get_228);
app.post("/api/settings/backup-destination", settings_backup_destination_post_229);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_230);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_231);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_232);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_233);
app.get("/api/settings/retention", settings_retention_get_234);
app.post("/api/settings/retention", settings_retention_post_235);
app.get("/api/settings/storage-provider", settings_storage_provider_get_236);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_237);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_238);
app.get("/api/settings/terminology", settings_terminology_get_239);
app.post("/api/settings/terminology", settings_terminology_post_240);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_241);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_242);
app.post("/api/signup", signup_post_243);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_244);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_245);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_246);
app.get("/api/subscription/status", subscription_status_get_247);
app.post("/api/subscription/webhook", subscription_webhook_post_248);
app.get("/api/support-mode/audit", support_mode_audit_get_249);
app.get("/api/support-mode/checklist", support_mode_checklist_get_250);
app.put("/api/support-mode/checklist", support_mode_checklist_put_251);
app.post("/api/support-mode/enter", support_mode_enter_post_252);
app.post("/api/support-mode/exit", support_mode_exit_post_253);
app.get("/api/support-mode/status", support_mode_status_get_254);
app.get("/api/takeoff-pad", takeoff_pad_get_255);
app.put("/api/takeoff-pad", takeoff_pad_put_256);
app.get("/api/team", team_get_257);
app.post("/api/team/invite", team_invite_post_258);
app.get("/api/team/members", team_members_get_259);
app.post("/api/team/resend-verification", team_resend_verification_post_260);
app.post("/api/team/verify-user", team_verify_user_post_261);
app.delete("/api/team/:id", team_id_delete_262);
app.put("/api/team/:id", team_id_put_263);
app.get("/api/usage", usage_get_264);
// </api-registrations>
