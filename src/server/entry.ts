...
import _h_migrate_sms_verified_at_post_48 from "./api/migrate-sms-verified-at/POST";
...
app.post("/api/migrate-sms-verified-at", _h_migrate_sms_verified_at_post_48);
