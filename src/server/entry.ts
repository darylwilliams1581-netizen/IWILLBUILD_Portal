...
import document_templates_id_import_docx_post_116 from "./api/document-templates/[id]/import-docx/POST";
import document_templates_id_import_pdf_post_117 from "./api/document-templates/[id]/import-pdf/POST";
import documents_get_118 from "./api/documents/GET";
import documents_share_token_get_119 from "./api/documents/share/[token]/GET";
import documents_share_token_post_120 from "./api/documents/share/[token]/POST";
import documents_id_get_121 from "./api/documents/[id]/GET";
import documents_id_put_122 from "./api/documents/[id]/PUT";
import documents_id_events_get_123 from "./api/documents/[id]/events/GET";
import documents_id_share_delete_124 from "./api/documents/[id]/share/DELETE";
import documents_id_share_post_125 from "./api/documents/[id]/share/POST";
import drawings_get_126 from "./api/drawings/GET";
import drawings_post_127 from "./api/drawings/POST";
import drawings_upload_post_128 from "./api/drawings/upload/POST";
import drawings_id_delete_129 from "./api/drawings/[id]/DELETE";
import drawings_id_patch_130 from "./api/drawings/[id]/PATCH";
import drawings_id_markup_post_131 from "./api/drawings/[id]/markup/POST";
import estimates_get_132 from "./api/estimates/GET";
import estimates_post_133 from "./api/estimates/POST";
import estimates_id_delete_134 from "./api/estimates/[id]/DELETE";
import estimates_id_get_135 from "./api/estimates/[id]/GET";
import estimates_id_put_136 from "./api/estimates/[id]/PUT";
import estimates_id_export_csv_get_137 from "./api/estimates/[id]/export-csv/GET";
import estimates_id_export_pdf_get_138 from "./api/estimates/[id]/export-pdf/GET";
import estimates_id_import_csv_post_139 from "./api/estimates/[id]/import-csv/POST";
import external_form_token_get_140 from "./api/external/form/[token]/GET";
import external_form_token_post_141 from "./api/external/form/[token]/POST";
import files_get_142 from "./api/files/GET";
import files_post_143 from "./api/files/POST";
import files_id_delete_144 from "./api/files/[id]/DELETE";
import files_id_download_get_145 from "./api/files/[id]/download/GET";
import fleet_get_146 from "./api/fleet/GET";
import fleet_post_147 from "./api/fleet/POST";
...
import forms_migrate_skip_logic_post from "./api/forms/migrate-skip-logic/POST.js";
import forms_skip_audit_post from "./api/forms/skip-audit/POST.js";
import forms_skip_audit_get from "./api/forms/skip-audit/GET.js";
import notes_migrate_post from "./api/notes/migrate/POST.js";
import notes_get from "./api/notes/GET.js";
import notes_post from "./api/notes/POST.js";
import notes_comments_post from "./api/notes/comments/POST.js";
import tag_tasks_get from "./api/tag-tasks/GET.js";
import tag_tasks_id_patch from "./api/tag-tasks/[id]/PATCH.js";
...
import fleet_vehicles_get_154 from "./api/fleet/vehicles/GET";
import fleet_id_delete_155 from "./api/fleet/[id]/DELETE";
import fleet_id_get_156 from "./api/fleet/[id]/GET";
import fleet_id_put_157 from "./api/fleet/[id]/PUT";
import fleet_id_driver_sessions_get_158 from "./api/fleet/[id]/driver-sessions/GET";
import fleet_id_files_get_159 from "./api/fleet/[id]/files/GET";
import fleet_id_prestarts_get_160 from "./api/fleet/[id]/prestarts/GET";
import fleet_id_prestarts_post_161 from "./api/fleet/[id]/prestarts/POST";
import fleet_id_service_logs_get_162 from "./api/fleet/[id]/service-logs/GET";
import fleet_id_service_logs_post_163 from "./api/fleet/[id]/service-logs/POST";
import fleet_id_signin_post_164 from "./api/fleet/[id]/signin/POST";
import fleet_id_signout_post_165 from "./api/fleet/[id]/signout/POST";
import fleet_id_usage_status_get_166 from "./api/fleet/[id]/usage-status/GET";
import fleet_id_usage_summary_get_167 from "./api/fleet/[id]/usage-summary/GET";
import form_templates_get_168 from "./api/form-templates/GET";
import form_templates_post_169 from "./api/form-templates/POST";
import form_templates_seed_post_170 from "./api/form-templates/seed/POST";
import form_templates_id_delete_171 from "./api/form-templates/[id]/DELETE";
import form_templates_id_put_172 from "./api/form-templates/[id]/PUT";
import forms_submissions_get_173 from "./api/forms/submissions/GET";
import forms_templates_id_share_link_post_174 from "./api/forms/templates/[id]/share-link/POST";
import forms_id_fields_get_175 from "./api/forms/[id]/fields/GET";
import forms_id_fields_post_176 from "./api/forms/[id]/fields/POST";
import forms_id_fields_reorder_post_177 from "./api/forms/[id]/fields/reorder/POST";
import forms_id_fields_fieldId_delete_178 from "./api/forms/[id]/fields/[fieldId]/DELETE";
import forms_id_fields_fieldId_patch_179 from "./api/forms/[id]/fields/[fieldId]/PATCH";
import forms_id_fields_fieldId_thumbnail_post_180 from "./api/forms/[id]/fields/[fieldId]/thumbnail/POST";
import health_get_181 from "./api/health/GET";
import integrations_myob_auth_url_get_182 from "./api/integrations/myob/auth-url/GET";
import integrations_myob_callback_get_183 from "./api/integrations/myob/callback/GET";
import integrations_myob_disconnect_post_184 from "./api/integrations/myob/disconnect/POST";
import integrations_myob_status_get_185 from "./api/integrations/myob/status/GET";
import integrations_myob_sync_invoice_post_186 from "./api/integrations/myob/sync-invoice/POST";
import integrations_onedrive_auth_url_get_187 from "./api/integrations/onedrive/auth-url/GET";
import integrations_onedrive_callback_get_188 from "./api/integrations/onedrive/callback/GET";
import integrations_onedrive_disconnect_post_189 from "./api/integrations/onedrive/disconnect/POST";
import integrations_onedrive_status_get_190 from "./api/integrations/onedrive/status/GET";
import integrations_onedrive_upload_file_post_191 from "./api/integrations/onedrive/upload-file/POST";
import integrations_qbo_auth_url_get_192 from "./api/integrations/qbo/auth-url/GET";
import integrations_qbo_callback_get_193 from "./api/integrations/qbo/callback/GET";
import integrations_qbo_disconnect_post_194 from "./api/integrations/qbo/disconnect/POST";
import integrations_qbo_status_get_195 from "./api/integrations/qbo/status/GET";
import integrations_qbo_sync_invoice_post_196 from "./api/integrations/qbo/sync-invoice/POST";
import integrations_xero_auth_url_get_197 from "./api/integrations/xero/auth-url/GET";
import integrations_xero_callback_get_198 from "./api/integrations/xero/callback/GET";
import integrations_xero_disconnect_post_199 from "./api/integrations/xero/disconnect/POST";
import integrations_xero_status_get_200 from "./api/integrations/xero/status/GET";
import integrations_xero_sync_customer_post_201 from "./api/integrations/xero/sync-customer/POST";
import integrations_xero_sync_invoice_post_202 from "./api/integrations/xero/sync-invoice/POST";
import integrations_xero_webhook_post_203 from "./api/integrations/xero/webhook/POST";
import invoices_get_204 from "./api/invoices/GET";
import invoices_post_205 from "./api/invoices/POST";
import invoices_id_delete_206 from "./api/invoices/[id]/DELETE";
import invoices_id_get_207 from "./api/invoices/[id]/GET";
import invoices_id_put_208 from "./api/invoices/[id]/PUT";
import invoices_id_duplicate_post_209 from "./api/invoices/[id]/duplicate/POST";
import invoices_id_export_pdf_get_210 from "./api/invoices/[id]/export-pdf/GET";
import invoices_id_mark_sent_post_211 from "./api/invoices/[id]/mark-sent/POST";
import invoices_id_record_payment_post_212 from "./api/invoices/[id]/record-payment/POST";
import invoices_id_void_post_213 from "./api/invoices/[id]/void/POST";
import job_forms_id_delete_214 from "./api/job-forms/[id]/DELETE";
import job_forms_id_get_215 from "./api/job-forms/[id]/GET";
import job_forms_id_put_216 from "./api/job-forms/[id]/PUT";
import job_forms_id_reset_post_217 from "./api/job-forms/[id]/reset/POST";
import job_forms_id_share_delete_218 from "./api/job-forms/[id]/share/DELETE";
import job_forms_id_share_get_219 from "./api/job-forms/[id]/share/GET";
import job_forms_id_share_post_220 from "./api/job-forms/[id]/share/POST";
import jobs_get_221 from "./api/jobs/GET";
import jobs_post_222 from "./api/jobs/POST";
import jobs_id_get_223 from "./api/jobs/[id]/GET";
import jobs_id_put_224 from "./api/jobs/[id]/PUT";
import jobs_id_costs_get_225 from "./api/jobs/[id]/costs/GET";
import jobs_id_costs_post_226 from "./api/jobs/[id]/costs/POST";
import jobs_id_costs_export_get_227 from "./api/jobs/[id]/costs/export/GET";
import jobs_id_costs_costId_delete_228 from "./api/jobs/[id]/costs/[costId]/DELETE";
import jobs_id_costs_costId_put_229 from "./api/jobs/[id]/costs/[costId]/PUT";
import jobs_id_costs_costId_receipt_get_230 from "./api/jobs/[id]/costs/[costId]/receipt/GET";
import jobs_id_costs_costId_receipt_post_231 from "./api/jobs/[id]/costs/[costId]/receipt/POST";
import jobs_id_delays_get_232 from "./api/jobs/[id]/delays/GET";
import jobs_id_delays_post_233 from "./api/jobs/[id]/delays/POST";
import jobs_id_delays_delayId_delete_234 from "./api/jobs/[id]/delays/[delayId]/DELETE";
import jobs_id_delays_delayId_put_235 from "./api/jobs/[id]/delays/[delayId]/PUT";
import jobs_id_files_get_236 from "./api/jobs/[id]/files/GET";
import jobs_id_forms_get_237 from "./api/jobs/[id]/forms/GET";
import jobs_id_forms_post_238 from "./api/jobs/[id]/forms/POST";
import jobs_id_generate_qr_post_239 from "./api/jobs/[id]/generate-qr/POST";
import jobs_id_ledger_get_240 from "./api/jobs/[id]/ledger/GET";
import jobs_id_ledger_post_241 from "./api/jobs/[id]/ledger/POST";
import jobs_id_ledger_export_get_242 from "./api/jobs/[id]/ledger/export/GET";
import jobs_id_ledger_sync_post_243 from "./api/jobs/[id]/ledger/sync/POST";
import jobs_id_ledger_entryId_delete_244 from "./api/jobs/[id]/ledger/[entryId]/DELETE";
import jobs_id_ledger_entryId_put_245 from "./api/jobs/[id]/ledger/[entryId]/PUT";
import jobs_id_ledger_entryId_correct_post_246 from "./api/jobs/[id]/ledger/[entryId]/correct/POST";
import jobs_id_photos_get_247 from "./api/jobs/[id]/photos/GET";
import jobs_id_photos_post_248 from "./api/jobs/[id]/photos/POST";
import jobs_id_photos_photoId_delete_249 from "./api/jobs/[id]/photos/[photoId]/DELETE";
import jobs_id_photos_photoId_patch_250 from "./api/jobs/[id]/photos/[photoId]/PATCH";
import jobs_id_photos_photoId_download_get_251 from "./api/jobs/[id]/photos/[photoId]/download/GET";
import jobs_id_photos_photoId_replace_post_252 from "./api/jobs/[id]/photos/[photoId]/replace/POST";
import jobs_id_progress_get_253 from "./api/jobs/[id]/progress/GET";
import jobs_id_progress_put_254 from "./api/jobs/[id]/progress/PUT";
import jobs_id_progress_sync_post_255 from "./api/jobs/[id]/progress/sync/POST";
import jobs_id_purchase_orders_get_256 from "./api/jobs/[id]/purchase-orders/GET";
import jobs_id_purchase_orders_post_257 from "./api/jobs/[id]/purchase-orders/POST";
import jobs_id_purchase_orders_poId_delete_258 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import jobs_id_purchase_orders_poId_get_259 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
import jobs_id_purchase_orders_poId_put_260 from "./api/jobs/[id]/purchase-orders/[poId]/PUT";
import jobs_id_purchase_orders_poId_pdf_get_261 from "./api/jobs/[id]/purchase-orders/[poId]/pdf/GET";
import jobs_id_signin_post_262 from "./api/jobs/[id]/signin/POST";
import jobs_id_signin_qr_post_263 from "./api/jobs/[id]/signin-qr/POST";
import jobs_id_signin_status_get_264 from "./api/jobs/[id]/signin-status/GET";
import jobs_id_signout_post_265 from "./api/jobs/[id]/signout/POST";
import jobs_id_signout_qr_post_266 from "./api/jobs/[id]/signout-qr/POST";
import jobs_id_swms_get_267 from "./api/jobs/[id]/swms/GET";
import jobs_id_swms_post_268 from "./api/jobs/[id]/swms/POST";
import jobs_id_swms_swmsId_signoff_post_269 from "./api/jobs/[id]/swms/[swmsId]/signoff/POST";
import jobs_id_todos_get_270 from "./api/jobs/[id]/todos/GET";
import jobs_id_todos_post_271 from "./api/jobs/[id]/todos/POST";
import jobs_id_todos_todoId_delete_272 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import jobs_id_todos_todoId_put_273 from "./api/jobs/[id]/todos/[todoId]/PUT";
import library_items_get_274 from "./api/library/items/GET";
import library_items_id_get_275 from "./api/library/items/[id]/GET";
import library_items_id_patch_276 from "./api/library/items/[id]/PATCH";
import library_items_id_install_post_277 from "./api/library/items/[id]/install/POST";
import library_my_installed_get_278 from "./api/library/my-installed/GET";
import me_get_279 from "./api/me/GET";
import me_put_280 from "./api/me/PUT";
import me_2fa_disable_post_281 from "./api/me/2fa/disable/POST";
import me_2fa_enable_post_282 from "./api/me/2fa/enable/POST";
import me_2fa_setup_get_283 from "./api/me/2fa/setup/GET";
import me_2fa_status_get_284 from "./api/me/2fa/status/GET";
import me_2fa_verify_post_285 from "./api/me/2fa/verify/POST";
import me_change_password_post_286 from "./api/me/change-password/POST";
import me_email_status_get_287 from "./api/me/email-status/GET";
import me_phone_get_288 from "./api/me/phone/GET";
import me_phone_put_289 from "./api/me/phone/PUT";
import migrate_account_recovery_post_290 from "./api/migrate-account-recovery/POST";
import migrate_asset_manager_post_291 from "./api/migrate-asset-manager/POST";
import migrate_attendance_post_292 from "./api/migrate-attendance/POST";
import migrate_company_settings_post_293 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_294 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_295 from "./api/migrate-dazza-knowledge/POST";
import migrate_estimates_post_296 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_297 from "./api/migrate-estimating-library/POST";
import migrate_files_post_298 from "./api/migrate-files/POST";
import migrate_fleet_post_299 from "./api/migrate-fleet/POST";
import migrate_fleet_driver_sessions_post_300 from "./api/migrate-fleet-driver-sessions/POST";
import migrate_fleet_usage_post_301 from "./api/migrate-fleet-usage/POST";
import migrate_form_fields_post_302 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_303 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_304 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_305 from "./api/migrate-job-forms/POST";
import migrate_job_photos_post_306 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_307 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_308 from "./api/migrate-jobs/POST";
import migrate_library_post_309 from "./api/migrate-library/POST";
import migrate_notifications_post_310 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_311 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_312 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_313 from "./api/migrate-pdf-settings/POST";
import migrate_plan_manager_post_314 from "./api/migrate-plan-manager/POST";
import migrate_plan_manager_v2_post_315 from "./api/migrate-plan-manager-v2/POST";
import migrate_plan_manager_v3_post_316 from "./api/migrate-plan-manager-v3/POST";
import migrate_safety_post_317 from "./api/migrate-safety/POST";
import migrate_starter_pack_post_318 from "./api/migrate-starter-pack/POST";
import migrate_studio_pdf_post_319 from "./api/migrate-studio-pdf/POST";
import migrate_subscriptions_post_320 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_321 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_322 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_323 from "./api/migrate-team/POST";
import notifications_alerts_get_324 from "./api/notifications/alerts/GET";
import notifications_prefs_get_325 from "./api/notifications/prefs/GET";
import notifications_prefs_put_326 from "./api/notifications/prefs/PUT";
import notifications_read_post_327 from "./api/notifications/read/POST";
import owner_console_activity_get_328 from "./api/owner-console/activity/GET";
import owner_console_cancellation_feedback_get_329 from "./api/owner-console/cancellation-feedback/GET";
import owner_console_companies_get_330 from "./api/owner-console/companies/GET";
import owner_console_companies_post_331 from "./api/owner-console/companies/POST";
import owner_console_companies_usage_get_332 from "./api/owner-console/companies/usage/GET";
import owner_console_companies_id_limits_put_333 from "./api/owner-console/companies/[id]/limits/PUT";
import owner_console_form_templates_get_334 from "./api/owner-console/form-templates/GET";
import owner_console_form_templates_post_335 from "./api/owner-console/form-templates/POST";
import owner_console_starter_pack_get_336 from "./api/owner-console/starter-pack/GET";
import owner_console_starter_pack_post_337 from "./api/owner-console/starter-pack/POST";
import owner_console_stats_get_338 from "./api/owner-console/stats/GET";
import owner_console_storage_get_339 from "./api/owner-console/storage/GET";
import owner_console_system_ai_builtin_checks_post_340 from "./api/owner-console/system-ai/builtin-checks/POST";
import owner_console_users_get_341 from "./api/owner-console/users/GET";
import owner_console_users_verify_post_342 from "./api/owner-console/users/verify/POST";
import plan_manager_drawings_get_343 from "./api/plan-manager/drawings/GET";
import plan_manager_drawings_post_344 from "./api/plan-manager/drawings/POST";
import plan_manager_drawings_id_get_345 from "./api/plan-manager/drawings/[id]/GET";
import plan_manager_drawings_id_annotations_put_346 from "./api/plan-manager/drawings/[id]/annotations/PUT";
import plan_manager_drawings_id_archive_post_347 from "./api/plan-manager/drawings/[id]/archive/POST";
import plan_manager_drawings_id_job_links_delete_348 from "./api/plan-manager/drawings/[id]/job-links/DELETE";
import plan_manager_drawings_id_job_links_post_349 from "./api/plan-manager/drawings/[id]/job-links/POST";
import plan_manager_drawings_id_pages_pageNo_annotations_get_350 from "./api/plan-manager/drawings/[id]/pages/[pageNo]/annotations/GET";
import plan_manager_drawings_id_permanent_delete_351 from "./api/plan-manager/drawings/[id]/permanent/DELETE";
import plan_manager_drawings_id_reorder_patch_352 from "./api/plan-manager/drawings/[id]/reorder/PATCH";
import plan_manager_drawings_id_restore_post_353 from "./api/plan-manager/drawings/[id]/restore/POST";
import plan_manager_drawings_id_revisions_post_354 from "./api/plan-manager/drawings/[id]/revisions/POST";
import plan_manager_drawings_id_revisions_revisionId_finalize_post_355 from "./api/plan-manager/drawings/[id]/revisions/[revisionId]/finalize/POST";
import plan_manager_drawings_id_upload_post_356 from "./api/plan-manager/drawings/[id]/upload/POST";
import plan_manager_jobs_with_drawings_get_357 from "./api/plan-manager/jobs-with-drawings/GET";
import plan_manager_share_post_358 from "./api/plan-manager/share/POST";
import plan_manager_share_validate_get_359 from "./api/plan-manager/share/validate/GET";
import portal_estimates_id_approve_post_360 from "./api/portal/estimates/[id]/approve/POST";
import portal_invite_post_361 from "./api/portal/invite/POST";
import portal_invoices_id_pay_post_362 from "./api/portal/invoices/[id]/pay/POST";
import portal_jobs_get_363 from "./api/portal/jobs/GET";
import portal_jobs_id_get_364 from "./api/portal/jobs/[id]/GET";
import portal_migrate_post_365 from "./api/portal/migrate/POST";
import portal_validate_post_366 from "./api/portal/validate/POST";
import public_form_token_get_367 from "./api/public/form/[token]/GET";
import public_form_token_submit_post_368 from "./api/public/form/[token]/submit/POST";
import public_swms_token_get_369 from "./api/public/swms/[token]/GET";
import public_swms_token_signoff_post_370 from "./api/public/swms/[token]/signoff/POST";
import push_subscribe_delete_371 from "./api/push/subscribe/DELETE";
import push_subscribe_post_372 from "./api/push/subscribe/POST";
import push_vapid_key_get_373 from "./api/push/vapid-key/GET";
import recipes_get_374 from "./api/recipes/GET";
import recipes_post_375 from "./api/recipes/POST";
import recipes_id_delete_376 from "./api/recipes/[id]/DELETE";
import recipes_id_put_377 from "./api/recipes/[id]/PUT";
import safety_ai_draft_post_378 from "./api/safety/ai/draft/POST";
import safety_documents_get_379 from "./api/safety/documents/GET";
import safety_documents_post_380 from "./api/safety/documents/POST";
import safety_documents_id_delete_381 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_382 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_383 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_384 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_385 from "./api/safety/generated-posters/[id]/DELETE";
import safety_job_safety_plans_get_386 from "./api/safety/job-safety-plans/GET";
import safety_job_safety_plans_post_387 from "./api/safety/job-safety-plans/POST";
import safety_job_safety_plans_id_delete_388 from "./api/safety/job-safety-plans/[id]/DELETE";
import safety_job_safety_plans_id_put_389 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_390 from "./api/safety/job-swms/GET";
import safety_job_swms_post_391 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_392 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_393 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_394 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_share_token_post_395 from "./api/safety/job-swms/[id]/share-token/POST";
import safety_job_swms_id_signoffs_get_396 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_397 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_398 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_399 from "./api/safety/plans/GET";
import safety_plans_post_400 from "./api/safety/plans/POST";
import safety_plans_seed_post_401 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_402 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_403 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_404 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_405 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_406 from "./api/safety/posters/GET";
import safety_posters_post_407 from "./api/safety/posters/POST";
import safety_posters_id_delete_408 from "./api/safety/posters/[id]/DELETE";
import safety_swms_get_409 from "./api/safety/swms/GET";
import safety_swms_post_410 from "./api/safety/swms/POST";
import safety_swms_import_docx_post_411 from "./api/safety/swms/import-docx/POST";
import safety_swms_seed_post_412 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_413 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_414 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_415 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_416 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_417 from "./api/safety/swms/[id]/export/GET";
import scheduler_crew_get_418 from "./api/scheduler/crew/GET";
import scheduler_jobs_get_419 from "./api/scheduler/jobs/GET";
import scheduler_jobs_id_reschedule_patch_420 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
import secure_share_get_421 from "./api/secure-share/GET";
import secure_share_post_422 from "./api/secure-share/POST";
import secure_share_id_delete_423 from "./api/secure-share/[id]/DELETE";
import secure_share_token_get_424 from "./api/secure-share/[token]/GET";
import secure_share_token_post_425 from "./api/secure-share/[token]/POST";
import settings_backup_get_426 from "./api/settings/backup/GET";
import settings_backup_post_427 from "./api/settings/backup/POST";
import settings_backup_export_get_428 from "./api/settings/backup/export/GET";
import settings_backup_run_post_429 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_430 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_431 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_432 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_433 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_434 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_435 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_436 from "./api/settings/retention/GET";
import settings_retention_post_437 from "./api/settings/retention/POST";
import settings_storage_provider_get_438 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_439 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_440 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_441 from "./api/settings/terminology/GET";
import settings_terminology_post_442 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_443 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_444 from "./api/settings/xero-credentials/POST";
import share_token_get_445 from "./api/share/[token]/GET";
import signup_post_446 from "./api/signup/POST";
import stripe_create_checkout_session_post_447 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_448 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_449 from "./api/subscription/create-checkout/POST";
import subscription_status_get_450 from "./api/subscription/status/GET";
import subscription_webhook_post_451 from "./api/subscription/webhook/POST";
import support_mode_audit_get_452 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_453 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_454 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_455 from "./api/support-mode/enter/POST";
import support_mode_exit_post_456 from "./api/support-mode/exit/POST";
import support_mode_status_get_457 from "./api/support-mode/status/GET";
import takeoff_pad_get_458 from "./api/takeoff-pad/GET";
import takeoff_pad_put_459 from "./api/takeoff-pad/PUT";
import team_get_460 from "./api/team/GET";
import team_invite_post_461 from "./api/team/invite/POST";
import team_invites_get_462 from "./api/team/invites/GET";
import team_invites_post_463 from "./api/team/invites/POST";
import team_invites_id_cancel_post_464 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_465 from "./api/team/invites/[id]/resend/POST";
import team_members_get_466 from "./api/team/members/GET";
import team_resend_verification_post_467 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_468 from "./api/team/schedule/migrate/POST";
import team_shifts_get_469 from "./api/team/shifts/GET";
import team_shifts_post_470 from "./api/team/shifts/POST";
import team_shifts_id_delete_471 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_472 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_473 from "./api/team/time-entries/GET";
import team_time_entries_post_474 from "./api/team/time-entries/POST";
import team_time_entries_export_get_475 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_476 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_477 from "./api/team/verify-user/POST";
import team_id_delete_478 from "./api/team/[id]/DELETE";
...
app.post("/api/document-templates/:id/import-docx", document_templates_id_import_docx_post_116);
app.post("/api/document-templates/:id/import-pdf", document_templates_id_import_pdf_post_117);
app.get("/api/documents", documents_get_118);
app.get("/api/documents/share/:token", documents_share_token_get_119);
app.post("/api/documents/share/:token", documents_share_token_post_120);
...
app.get("/api/estimates/:id", estimates_id_get_135);
app.put("/api/estimates/:id", estimates_id_put_136);
app.get("/api/estimates/:id/export-csv", estimates_id_export_csv_get_137);
app.get("/api/estimates/:id/export-pdf", estimates_id_export_pdf_get_138);
app.post("/api/estimates/:id/import-csv", estimates_id_import_csv_post_139);
app.get("/api/external/form/:token", external_form_token_get_140);
app.post("/api/external/form/:token", external_form_token_post_141);
app.get("/api/files", files_get_142);
app.post("/api/files", files_post_143);
app.delete("/api/files/:id", files_id_delete_144);
app.get("/api/files/:id/download", files_id_download_get_145);
app.get("/api/fleet", fleet_get_146);
app.post("/api/fleet", fleet_post_147);
...
app.post("/api/forms/migrate-skip-logic", forms_migrate_skip_logic_post);
app.post("/api/forms/skip-audit", forms_skip_audit_post);
app.get("/api/forms/skip-audit", forms_skip_audit_get);
app.post("/api/notes/migrate", notes_migrate_post);
app.get("/api/notes", notes_get);
app.post("/api/notes", notes_post);
app.post("/api/notes/comments", notes_comments_post);
app.get("/api/tag-tasks", tag_tasks_get);
app.patch("/api/tag-tasks/:id", tag_tasks_id_patch);
...
app.get("/api/fleet/vehicles", fleet_vehicles_get_154);
app.delete("/api/fleet/:id", fleet_id_delete_155);
app.get("/api/fleet/:id", fleet_id_get_156);
app.put("/api/fleet/:id", fleet_id_put_157);
app.get("/api/fleet/:id/driver-sessions", fleet_id_driver_sessions_get_158);
app.get("/api/fleet/:id/files", fleet_id_files_get_159);
app.get("/api/fleet/:id/prestarts", fleet_id_prestarts_get_160);
app.post("/api/fleet/:id/prestarts", fleet_id_prestarts_post_161);
app.get("/api/fleet/:id/service-logs", fleet_id_service_logs_get_162);
app.post("/api/fleet/:id/service-logs", fleet_id_service_logs_post_163);
app.post("/api/fleet/:id/signin", fleet_id_signin_post_164);
...
app.delete("/api/form-templates/:id", form_templates_id_delete_171);
app.put("/api/form-templates/:id", form_templates_id_put_172);
app.get("/api/forms/submissions", forms_submissions_get_173);
app.post("/api/forms/templates/:id/share-link", forms_templates_id_share_link_post_174);
app.get("/api/forms/:id/fields", forms_id_fields_get_175);
app.post("/api/forms/:id/fields", forms_id_fields_post_176);
app.post("/api/forms/:id/fields/reorder", forms_id_fields_reorder_post_177);
app.delete("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_delete_178);
app.patch("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_patch_179);
app.post("/api/forms/:id/fields/:fieldId/thumbnail", forms_id_fields_fieldId_thumbnail_post_180);
app.get("/api/health", health_get_181);
app.get("/api/integrations/myob/auth-url", integrations_myob_auth_url_get_182);
app.get("/api/integrations/myob/callback", integrations_myob_callback_get_183);
app.post("/api/integrations/myob/disconnect", integrations_myob_disconnect_post_184);
app.get("/api/integrations/myob/status", integrations_myob_status_get_185);
app.post("/api/integrations/myob/sync-invoice", integrations_myob_sync_invoice_post_186);
app.get("/api/integrations/onedrive/auth-url", integrations_onedrive_auth_url_get_187);
app.get("/api/integrations/onedrive/callback", integrations_onedrive_callback_get_188);
app.post("/api/integrations/onedrive/disconnect", integrations_onedrive_disconnect_post_189);
app.get("/api/integrations/onedrive/status", integrations_onedrive_status_get_190);
app.post("/api/integrations/onedrive/upload-file", integrations_onedrive_upload_file_post_191);
app.get("/api/integrations/qbo/auth-url", integrations_qbo_auth_url_get_192);
app.get("/api/integrations/qbo/callback", integrations_qbo_callback_get_193);
app.post("/api/integrations/qbo/disconnect", integrations_qbo_disconnect_post_194);
app.get("/api/integrations/qbo/status", integrations_qbo_status_get_195);
app.post("/api/integrations/qbo/sync-invoice", integrations_qbo_sync_invoice_post_196);
app.get("/api/integrations/xero/auth-url", integrations_xero_auth_url_get_197);
app.get("/api/integrations/xero/callback", integrations_xero_callback_get_198);
app.post("/api/integrations/xero/disconnect", integrations_xero_disconnect_post_199);
app.get("/api/integrations/xero/status", integrations_xero_status_get_200);
app.post("/api/integrations/xero/sync-customer", integrations_xero_sync_customer_post_201);
app.post("/api/integrations/xero/sync-invoice", integrations_xero_sync_invoice_post_202);
app.post("/api/integrations/xero/webhook", integrations_xero_webhook_post_203);
app.get("/api/invoices", invoices_get_204);
app.post("/api/invoices", invoices_post_205);
app.delete("/api/invoices/:id", invoices_id_delete_206);
app.get("/api/invoices/:id", invoices_id_get_207);
app.put("/api/invoices/:id", invoices_id_put_208);
app.post("/api/invoices/:id/duplicate", invoices_id_duplicate_post_209);
app.get("/api/invoices/:id/export-pdf", invoices_id_export_pdf_get_210);
app.post("/api/invoices/:id/mark-sent", invoices_id_mark_sent_post_211);
app.post("/api/invoices/:id/record-payment", invoices_id_record_payment_post_212);
app.post("/api/invoices/:id/void", invoices_id_void_post_213);
app.delete("/api/job-forms/:id", job_forms_id_delete_214);
app.get("/api/job-forms/:id", job_forms_id_get_215);
app.put("/api/job-forms/:id", job_forms_id_put_216);
app.post("/api/job-forms/:id/reset", job_forms_id_reset_post_217);
app.delete("/api/job-forms/:id/share", job_forms_id_share_delete_218);
app.get("/api/job-forms/:id/share", job_forms_id_share_get_219);
app.post("/api/job-forms/:id/share", job_forms_id_share_post_220);
app.get("/api/jobs", jobs_get_221);
app.post("/api/jobs", jobs_post_222);
app.get("/api/jobs/:id", jobs_id_get_223);
app.put("/api/jobs/:id", jobs_id_put_224);
app.get("/api/jobs/:id/costs", jobs_id_costs_get_225);
app.post("/api/jobs/:id/costs", jobs_id_costs_post_226);
app.get("/api/jobs/:id/costs/export", jobs_id_costs_export_get_227);
app.delete("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_delete_228);
app.put("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_put_229);
app.get("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_get_230);
app.post("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_post_231);
app.get("/api/jobs/:id/delays", jobs_id_delays_get_232);
app.post("/api/jobs/:id/delays", jobs_id_delays_post_233);
app.delete("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_delete_234);
app.put("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_put_235);
app.get("/api/jobs/:id/files", jobs_id_files_get_236);
app.get("/api/jobs/:id/forms", jobs_id_forms_get_237);
app.post("/api/jobs/:id/forms", jobs_id_forms_post_238);
app.post("/api/jobs/:id/generate-qr", jobs_id_generate_qr_post_239);
app.get("/api/jobs/:id/ledger", jobs_id_ledger_get_240);
app.post("/api/jobs/:id/ledger", jobs_id_ledger_post_241);
app.get("/api/jobs/:id/ledger/export", jobs_id_ledger_export_get_242);
app.post("/api/jobs/:id/ledger/sync", jobs_id_ledger_sync_post_243);
app.delete("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_delete_244);
app.put("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_put_245);
app.post("/api/jobs/:id/ledger/:entryId/correct", jobs_id_ledger_entryId_correct_post_246);
app.get("/api/jobs/:id/photos", jobs_id_photos_get_247);
app.post("/api/jobs/:id/photos", jobs_id_photos_post_248);
app.delete("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_delete_249);
app.patch("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_patch_250);
app.get("/api/jobs/:id/photos/:photoId/download", jobs_id_photos_photoId_download_get_251);
app.post("/api/jobs/:id/photos/:photoId/replace", jobs_id_photos_photoId_replace_post_252);
app.get("/api/jobs/:id/progress", jobs_id_progress_get_253);
app.put("/api/jobs/:id/progress", jobs_id_progress_put_254);
app.post("/api/jobs/:id/progress/sync", jobs_id_progress_sync_post_255);
app.get("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_get_256);
app.post("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_post_257);
app.delete("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_delete_258);
app.get("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_get_259);
app.put("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_put_260);
app.get("/api/jobs/:id/purchase-orders/:poId/pdf", jobs_id_purchase_orders_poId_pdf_get_261);
app.post("/api/jobs/:id/signin", jobs_id_signin_post_262);
app.post("/api/jobs/:id/signin-qr", jobs_id_signin_qr_post_263);
app.get("/api/jobs/:id/signin-status", jobs_id_signin_status_get_264);
app.post("/api/jobs/:id/signout", jobs_id_signout_post_265);
app.post("/api/jobs/:id/signout-qr", jobs_id_signout_qr_post_266);
app.get("/api/jobs/:id/swms", jobs_id_swms_get_267);
app.post("/api/jobs/:id/swms", jobs_id_swms_post_268);
app.post("/api/jobs/:id/swms/:swmsId/signoff", jobs_id_swms_swmsId_signoff_post_269);
app.get("/api/jobs/:id/todos", jobs_id_todos_get_270);
app.post("/api/jobs/:id/todos", jobs_id_todos_post_271);
app.delete("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_delete_272);
app.put("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_put_273);
app.get("/api/library/items", library_items_get_274);
app.get("/api/library/items/:id", library_items_id_get_275);
app.patch("/api/library/items/:id", library_items_id_patch_276);
app.post("/api/library/items/:id/install", library_items_id_install_post_277);
app.get("/api/library/my-installed", library_my_installed_get_278);
app.get("/api/me", me_get_279);
app.put("/api/me", me_put_280);
app.post("/api/me/2fa/disable", me_2fa_disable_post_281);
app.post("/api/me/2fa/enable", me_2fa_enable_post_282);
app.get("/api/me/2fa/setup", me_2fa_setup_get_283);
app.get("/api/me/2fa/status", me_2fa_status_get_284);
app.post("/api/me/2fa/verify", me_2fa_verify_post_285);
app.post("/api/me/change-password", me_change_password_post_286);
app.get("/api/me/email-status", me_email_status_get_287);
app.get("/api/me/phone", me_phone_get_288);
app.put("/api/me/phone", me_phone_put_289);
app.post("/api/migrate-account-recovery", migrate_account_recovery_post_290);
app.post("/api/migrate-asset-manager", migrate_asset_manager_post_291);
app.post("/api/migrate-attendance", migrate_attendance_post_292);
app.post("/api/migrate-company-settings", migrate_company_settings_post_293);
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_294);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_295);
app.post("/api/migrate-estimates", migrate_estimates_post_296);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_297);
app.post("/api/migrate-files", migrate_files_post_298);
app.post("/api/migrate-fleet", migrate_fleet_post_299);
app.post("/api/migrate-fleet-driver-sessions", migrate_fleet_driver_sessions_post_300);
app.post("/api/migrate-fleet-usage", migrate_fleet_usage_post_301);
app.post("/api/migrate-form-fields", migrate_form_fields_post_302);
app.post("/api/migrate-form-logic", migrate_form_logic_post_303);
app.post("/api/migrate-form-templates", migrate_form_templates_post_304);
app.post("/api/migrate-job-forms", migrate_job_forms_post_305);
app.post("/api/migrate-job-photos", migrate_job_photos_post_306);
app.post("/api/migrate-job-tabs", migrate_job_tabs_post_307);
app.post("/api/migrate-jobs", migrate_jobs_post_308);
app.post("/api/migrate-library", migrate_library_post_309);
app.post("/api/migrate-notifications", migrate_notifications_post_310);
app.post("/api/migrate-owner-console", migrate_owner_console_post_311);
app.post("/api/migrate-owner-role", migrate_owner_role_post_312);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_313);
app.post("/api/migrate-plan-manager", migrate_plan_manager_post_314);
app.post("/api/migrate-plan-manager-v2", migrate_plan_manager_v2_post_315);
app.post("/api/migrate-plan-manager-v3", migrate_plan_manager_v3_post_316);
app.post("/api/migrate-safety", migrate_safety_post_317);
app.post("/api/migrate-starter-pack", migrate_starter_pack_post_318);
app.post("/api/migrate-studio-pdf", migrate_studio_pdf_post_319);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_320);
app.post("/api/migrate-support-mode", migrate_support_mode_post_321);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_322);
app.post("/api/migrate-team", migrate_team_post_323);
app.get("/api/notifications/alerts", notifications_alerts_get_324);
app.get("/api/notifications/prefs", notifications_prefs_get_325);
app.put("/api/notifications/prefs", notifications_prefs_put_326);
app.post("/api/notifications/read", notifications_read_post_327);
app.get("/api/owner-console/activity", owner_console_activity_get_328);
app.get("/api/owner-console/cancellation-feedback", owner_console_cancellation_feedback_get_329);
app.get("/api/owner-console/companies", owner_console_companies_get_330);
app.post("/api/owner-console/companies", owner_console_companies_post_331);
app.get("/api/owner-console/companies/usage", owner_console_companies_usage_get_332);
app.put("/api/owner-console/companies/:id/limits", owner_console_companies_id_limits_put_333);
app.get("/api/owner-console/form-templates", owner_console_form_templates_get_334);
app.post("/api/owner-console/form-templates", owner_console_form_templates_post_335);
app.get("/api/owner-console/starter-pack", owner_console_starter_pack_get_336);
app.post("/api/owner-console/starter-pack", owner_console_starter_pack_post_337);
app.get("/api/owner-console/stats", owner_console_stats_get_338);
app.get("/api/owner-console/storage", owner_console_storage_get_339);
app.post("/api/owner-console/system-ai/builtin-checks", owner_console_system_ai_builtin_checks_post_340);
app.get("/api/owner-console/users", owner_console_users_get_341);
app.post("/api/owner-console/users/verify", owner_console_users_verify_post_342);
app.get("/api/plan-manager/drawings", plan_manager_drawings_get_343);
app.post("/api/plan-manager/drawings", plan_manager_drawings_post_344);
app.get("/api/plan-manager/drawings/:id", plan_manager_drawings_id_get_345);
app.put("/api/plan-manager/drawings/:id/annotations", plan_manager_drawings_id_annotations_put_346);
app.post("/api/plan-manager/drawings/:id/archive", plan_manager_drawings_id_archive_post_347);
app.delete("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_delete_348);
app.post("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_post_349);
app.get("/api/plan-manager/drawings/:id/pages/:pageNo/annotations", plan_manager_drawings_id_pages_pageNo_annotations_get_350);
app.delete("/api/plan-manager/drawings/:id/permanent", plan_manager_drawings_id_permanent_delete_351);
app.patch("/api/plan-manager/drawings/:id/reorder", plan_manager_drawings_id_reorder_patch_352);
app.post("/api/plan-manager/drawings/:id/restore", plan_manager_drawings_id_restore_post_353);
app.post("/api/plan-manager/drawings/:id/revisions", plan_manager_drawings_id_revisions_post_354);
app.post("/api/plan-manager/drawings/:id/revisions/:revisionId/finalize", plan_manager_drawings_id_revisions_revisionId_finalize_post_355);
app.post("/api/plan-manager/drawings/:id/upload", plan_manager_drawings_id_upload_post_356);
app.get("/api/plan-manager/jobs-with-drawings", plan_manager_jobs_with_drawings_get_357);
app.post("/api/plan-manager/share", plan_manager_share_post_358);
app.get("/api/plan-manager/share/validate", plan_manager_share_validate_get_359);
app.post("/api/portal/estimates/:id/approve", portal_estimates_id_approve_post_360);
app.post("/api/portal/invite", portal_invite_post_361);
app.post("/api/portal/invoices/:id/pay", portal_invoices_id_pay_post_362);
app.get("/api/portal/jobs", portal_jobs_get_363);
app.get("/api/portal/jobs/:id", portal_jobs_id_get_364);
app.post("/api/portal/migrate", portal_migrate_post_365);
app.post("/api/portal/validate", portal_validate_post_366);
app.get("/api/public/form/:token", public_form_token_get_367);
app.post("/api/public/form/:token/submit", public_form_token_submit_post_368);
app.get("/api/public/swms/:token", public_swms_token_get_369);
app.post("/api/public/swms/:token/signoff", public_swms_token_signoff_post_370);
app.delete("/api/push/subscribe", push_subscribe_delete_371);
app.post("/api/push/subscribe", push_subscribe_post_372);
app.get("/api/push/vapid-key", push_vapid_key_get_373);
app.get("/api/recipes", recipes_get_374);
app.post("/api/recipes", recipes_post_375);
app.delete("/api/recipes/:id", recipes_id_delete_376);
app.put("/api/recipes/:id", recipes_id_put_377);
app.post("/api/safety/ai/draft", safety_ai_draft_post_378);
app.get("/api/safety/documents", safety_documents_get_379);
app.post("/api/safety/documents", safety_documents_post_380);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_381);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_382);
app.get("/api/safety/generated-posters", safety_generated_posters_get_383);
app.post("/api/safety/generated-posters", safety_generated_posters_post_384);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_385);
app.get("/api/safety/job-safety-plans", safety_job_safety_plans_get_386);
app.post("/api/safety/job-safety-plans", safety_job_safety_plans_post_387);
app.delete("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_delete_388);
app.put("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_put_389);
app.get("/api/safety/job-swms", safety_job_swms_get_390);
app.post("/api/safety/job-swms", safety_job_swms_post_391);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_392);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_393);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_394);
app.post("/api/safety/job-swms/:id/share-token", safety_job_swms_id_share_token_post_395);
app.get("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_get_396);
app.post("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_post_397);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", safety_job_swms_id_signoffs_signoffId_delete_398);
app.get("/api/safety/plans", safety_plans_get_399);
app.post("/api/safety/plans", safety_plans_post_400);
app.post("/api/safety/plans/seed", safety_plans_seed_post_401);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_402);
app.put("/api/safety/plans/:id", safety_plans_id_put_403);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_404);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_405);
app.get("/api/safety/posters", safety_posters_get_406);
app.post("/api/safety/posters", safety_posters_post_407);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_408);
app.get("/api/safety/swms", safety_swms_get_409);
app.post("/api/safety/swms", safety_swms_post_410);
app.post("/api/safety/swms/import-docx", safety_swms_import_docx_post_411);
app.post("/api/safety/swms/seed", safety_swms_seed_post_412);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_413);
app.get("/api/safety/swms/:id", safety_swms_id_get_414);
app.put("/api/safety/swms/:id", safety_swms_id_put_415);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_416);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_417);
app.get("/api/scheduler/crew", scheduler_crew_get_418);
app.get("/api/scheduler/jobs", scheduler_jobs_get_419);
app.patch("/api/scheduler/jobs/:id/reschedule", scheduler_jobs_id_reschedule_patch_420);
app.get("/api/secure-share", secure_share_get_421);
app.post("/api/secure-share", secure_share_post_422);
app.delete("/api/secure-share/:id", secure_share_id_delete_423);
app.get("/api/secure-share/:token", secure_share_token_get_424);
app.post("/api/secure-share/:token", secure_share_token_post_425);
app.get("/api/settings/backup", settings_backup_get_426);
app.post("/api/settings/backup", settings_backup_post_427);
app.get("/api/settings/backup/export", settings_backup_export_get_428);
app.post("/api/settings/backup/run", settings_backup_run_post_429);
app.get("/api/settings/backup-destination", settings_backup_destination_get_430);
app.post("/api/settings/backup-destination", settings_backup_destination_post_431);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_432);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_433);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_434);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_435);
app.get("/api/settings/retention", settings_retention_get_436);
app.post("/api/settings/retention", settings_retention_post_437);
app.get("/api/settings/storage-provider", settings_storage_provider_get_438);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_439);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_440);
app.get("/api/settings/terminology", settings_terminology_get_441);
app.post("/api/settings/terminology", settings_terminology_post_442);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_443);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_444);
app.get("/api/share/:token", share_token_get_445);
app.post("/api/signup", signup_post_446);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_447);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_448);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_449);
app.get("/api/subscription/status", subscription_status_get_450);
app.post("/api/subscription/webhook", subscription_webhook_post_451);
app.get("/api/support-mode/audit", support_mode_audit_get_452);
app.get("/api/support-mode/checklist", support_mode_checklist_get_453);
app.put("/api/support-mode/checklist", support_mode_checklist_put_454);
app.post("/api/support-mode/enter", support_mode_enter_post_455);
app.post("/api/support-mode/exit", support_mode_exit_post_456);
app.get("/api/support-mode/status", support_mode_status_get_457);
app.get("/api/takeoff-pad", takeoff_pad_get_458);
app.put("/api/takeoff-pad", takeoff_pad_put_459);
app.get("/api/team", team_get_460);
app.post("/api/team/invite", team_invite_post_461);
app.get("/api/team/invites", team_invites_get_462);
app.post("/api/team/invites", team_invites_post_463);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_464);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_465);
app.get("/api/team/members", team_members_get_466);
app.post("/api/team/resend-verification", team_resend_verification_post_467);
app.post("/api/team/schedule/migrate", team_schedule_migrate_post_468);
app.get("/api/team/shifts", team_shifts_get_469);
app.post("/api/team/shifts", team_shifts_post_470);
app.delete("/api/team/shifts/:id", team_shifts_id_delete_471);
app.put("/api/team/shifts/:id", team_shifts_id_put_472);
app.get("/api/team/time-entries", team_time_entries_get_473);
app.post("/api/team/time-entries", team_time_entries_post_474);
app.get("/api/team/time-entries/export", team_time_entries_export_get_475);
app.put("/api/team/time-entries/:id", team_time_entries_id_put_476);
app.post("/api/team/verify-user", team_verify_user_post_477);
app.delete("/api/team/:id", team_id_delete_478);
app.put("/api/team/:id", team_id_put_479);
app.get("/api/usage", usage_get_480);
// </api-registrations>
