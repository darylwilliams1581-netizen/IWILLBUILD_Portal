...
import company_settings_put_26 from "./api/company-settings/PUT";
import contact_post_27 from "./api/contact/POST";
import cost_guide_get_28 from "./api/cost-guide/GET";
import cost_guide_post_29 from "./api/cost-guide/POST";
import cost_guide_export_csv_get_30 from "./api/cost-guide/export-csv/GET";
import cost_guide_import_csv_post_31 from "./api/cost-guide/import-csv/POST";
import cost_guide_id_delete_32 from "./api/cost-guide/[id]/DELETE";
import cost_guide_id_put_33 from "./api/cost-guide/[id]/PUT";
import customers_get_34 from "./api/customers/GET";
import customers_post_35 from "./api/customers/POST";
import customers_id_delete_36 from "./api/customers/[id]/DELETE";
import customers_id_get_37 from "./api/customers/[id]/GET";
import customers_id_put_38 from "./api/customers/[id]/PUT";
import dashboard_setup_check_get_39 from "./api/dashboard/setup-check/GET";
import dashboard_todos_get_40 from "./api/dashboard/todos/GET";
import dazza_annette_post_41 from "./api/dazza/annette/POST";
import dazza_brain_hive_approve_post_42 from "./api/dazza/brain/hive/approve/POST";
import dazza_brain_hive_reject_post_43 from "./api/dazza/brain/hive/reject/POST";
import dazza_brain_status_get_44 from "./api/dazza/brain/status/GET";
import dazza_chat_post_45 from "./api/dazza/chat/POST";
import dazza_context_get_46 from "./api/dazza/context/GET";
import dazza_key_status_get_47 from "./api/dazza/key-status/GET";
import dazza_knowledge_get_48 from "./api/dazza/knowledge/GET";
import dazza_knowledge_post_49 from "./api/dazza/knowledge/POST";
import dazza_knowledge_id_delete_50 from "./api/dazza/knowledge/[id]/DELETE";
import dazza_knowledge_id_put_51 from "./api/dazza/knowledge/[id]/PUT";
import estimates_get_52 from "./api/estimates/GET";
import estimates_post_53 from "./api/estimates/POST";
import estimates_id_delete_54 from "./api/estimates/[id]/DELETE";
import estimates_id_get_55 from "./api/estimates/[id]/GET";
import estimates_id_put_56 from "./api/estimates/[id]/PUT";
import estimates_id_export_csv_get_57 from "./api/estimates/[id]/export-csv/GET";
import estimates_id_import_csv_post_58 from "./api/estimates/[id]/import-csv/POST";
import files_get_59 from "./api/files/GET";
import files_post_60 from "./api/files/POST";
import files_id_delete_61 from "./api/files/[id]/DELETE";
import files_id_download_get_62 from "./api/files/[id]/download/GET";
import fleet_get_63 from "./api/fleet/GET";
import fleet_post_64 from "./api/fleet/POST";
import fleet_flags_get_65 from "./api/fleet/flags/GET";
import fleet_id_get_66 from "./api/fleet/[id]/GET";
import fleet_id_put_67 from "./api/fleet/[id]/PUT";
import fleet_id_files_get_68 from "./api/fleet/[id]/files/GET";
import fleet_id_prestarts_get_69 from "./api/fleet/[id]/prestarts/GET";
import fleet_id_prestarts_post_70 from "./api/fleet/[id]/prestarts/POST";
import form_templates_get_71 from "./api/form-templates/GET";
import form_templates_post_72 from "./api/form-templates/POST";
import form_templates_seed_post_73 from "./api/form-templates/seed/POST";
import form_templates_id_delete_74 from "./api/form-templates/[id]/DELETE";
import form_templates_id_put_75 from "./api/form-templates/[id]/PUT";
import forms_id_fields_get_76 from "./api/forms/[id]/fields/GET";
import forms_id_fields_post_77 from "./api/forms/[id]/fields/POST";
import forms_id_fields_reorder_post_78 from "./api/forms/[id]/fields/reorder/POST";
import forms_id_fields_fieldId_delete_79 from "./api/forms/[id]/fields/[fieldId]/DELETE";
import forms_id_fields_fieldId_patch_80 from "./api/forms/[id]/fields/[fieldId]/PATCH";
import forms_id_fields_fieldId_thumbnail_post_81 from "./api/forms/[id]/fields/[fieldId]/thumbnail/POST";
import health_get_82 from "./api/health/GET";
import integrations_onedrive_auth_url_get_83 from "./api/integrations/onedrive/auth-url/GET";
import integrations_onedrive_callback_get_84 from "./api/integrations/onedrive/callback/GET";
import integrations_onedrive_disconnect_post_85 from "./api/integrations/onedrive/disconnect/POST";
import integrations_onedrive_status_get_86 from "./api/integrations/onedrive/status/GET";
import integrations_onedrive_upload_file_post_87 from "./api/integrations/onedrive/upload-file/POST";
import integrations_xero_auth_url_get_88 from "./api/integrations/xero/auth-url/GET";
import integrations_xero_callback_get_89 from "./api/integrations/xero/callback/GET";
import integrations_xero_disconnect_post_90 from "./api/integrations/xero/disconnect/POST";
import integrations_xero_status_get_91 from "./api/integrations/xero/status/GET";
import integrations_xero_sync_customer_post_92 from "./api/integrations/xero/sync-customer/POST";
import integrations_xero_sync_invoice_post_93 from "./api/integrations/xero/sync-invoice/POST";
import integrations_xero_webhook_post_94 from "./api/integrations/xero/webhook/POST";
import invoices_get_95 from "./api/invoices/GET";
import invoices_post_96 from "./api/invoices/POST";
import invoices_id_delete_97 from "./api/invoices/[id]/DELETE";
import invoices_id_get_98 from "./api/invoices/[id]/GET";
import invoices_id_put_99 from "./api/invoices/[id]/PUT";
import invoices_id_duplicate_post_100 from "./api/invoices/[id]/duplicate/POST";
import invoices_id_mark_sent_post_101 from "./api/invoices/[id]/mark-sent/POST";
import invoices_id_record_payment_post_102 from "./api/invoices/[id]/record-payment/POST";
import invoices_id_void_post_103 from "./api/invoices/[id]/void/POST";
import job_forms_id_delete_104 from "./api/job-forms/[id]/DELETE";
import job_forms_id_get_105 from "./api/job-forms/[id]/GET";
import job_forms_id_put_106 from "./api/job-forms/[id]/PUT";
import jobs_get_107 from "./api/jobs/GET";
import jobs_post_108 from "./api/jobs/POST";
import jobs_id_get_109 from "./api/jobs/[id]/GET";
import jobs_id_put_110 from "./api/jobs/[id]/PUT";
import jobs_id_costs_get_111 from "./api/jobs/[id]/costs/GET";
import jobs_id_costs_post_112 from "./api/jobs/[id]/costs/POST";
import jobs_id_costs_export_get_113 from "./api/jobs/[id]/costs/export/GET";
import jobs_id_costs_costId_delete_114 from "./api/jobs/[id]/costs/[costId]/DELETE";
import jobs_id_costs_costId_put_115 from "./api/jobs/[id]/costs/[costId]/PUT";
import jobs_id_costs_costId_receipt_get_116 from "./api/jobs/[id]/costs/[costId]/receipt/GET";
import jobs_id_costs_costId_receipt_post_117 from "./api/jobs/[id]/costs/[costId]/receipt/POST";
import jobs_id_delays_get_118 from "./api/jobs/[id]/delays/GET";
import jobs_id_delays_post_119 from "./api/jobs/[id]/delays/POST";
import jobs_id_delays_delayId_delete_120 from "./api/jobs/[id]/delays/[delayId]/DELETE";
import jobs_id_delays_delayId_put_121 from "./api/jobs/[id]/delays/[delayId]/PUT";
import jobs_id_files_get_122 from "./api/jobs/[id]/files/GET";
import jobs_id_forms_get_123 from "./api/jobs/[id]/forms/GET";
import jobs_id_forms_post_124 from "./api/jobs/[id]/forms/POST";
import jobs_id_photos_get_125 from "./api/jobs/[id]/photos/GET";
import jobs_id_photos_post_126 from "./api/jobs/[id]/photos/POST";
import jobs_id_photos_photoId_delete_127 from "./api/jobs/[id]/photos/[photoId]/DELETE";
import jobs_id_photos_photoId_patch_128 from "./api/jobs/[id]/photos/[photoId]/PATCH";
import jobs_id_photos_photoId_download_get_129 from "./api/jobs/[id]/photos/[photoId]/download/GET";
import jobs_id_photos_photoId_replace_post_130 from "./api/jobs/[id]/photos/[photoId]/replace/POST";
...
import jobs_id_purchase_orders_get_134 from "./api/jobs/[id]/purchase-orders/GET";
import jobs_id_purchase_orders_post_135 from "./api/jobs/[id]/purchase-orders/POST";
import jobs_id_purchase_orders_poId_delete_136 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
...
import jobs_id_todos_get_143 from "./api/jobs/[id]/todos/GET";
import jobs_id_todos_post_144 from "./api/jobs/[id]/todos/POST";
import jobs_id_todos_todoId_delete_145 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import jobs_id_todos_todoId_put_146 from "./api/jobs/[id]/todos/[todoId]/PUT";
import me_get_147 from "./api/me/GET";
import me_put_148 from "./api/me/PUT";
import me_2fa_disable_post_149 from "./api/me/2fa/disable/POST";
import me_2fa_enable_post_150 from "./api/me/2fa/enable/POST";
import me_2fa_setup_get_151 from "./api/me/2fa/setup/GET";
import me_2fa_status_get_152 from "./api/me/2fa/status/GET";
import me_2fa_verify_post_153 from "./api/me/2fa/verify/POST";
import me_change_password_post_154 from "./api/me/change-password/POST";
import me_email_status_get_155 from "./api/me/email-status/GET";
import migrate_account_recovery_post_156 from "./api/migrate-account-recovery/POST";
import migrate_company_settings_post_157 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_158 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_159 from "./api/migrate-dazza-knowledge/POST";
import migrate_estimates_post_160 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_161 from "./api/migrate-estimating-library/POST";
import migrate_files_post_162 from "./api/migrate-files/POST";
import migrate_fleet_post_163 from "./api/migrate-fleet/POST";
import migrate_form_fields_post_164 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_165 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_166 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_167 from "./api/migrate-job-forms/POST";
import migrate_job_photos_post_168 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_169 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_170 from "./api/migrate-jobs/POST";
import migrate_notifications_post_171 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_172 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_173 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_174 from "./api/migrate-pdf-settings/POST";
import migrate_safety_post_175 from "./api/migrate-safety/POST";
import migrate_subscriptions_post_176 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_177 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_178 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_179 from "./api/migrate-team/POST";
import notifications_alerts_get_180 from "./api/notifications/alerts/GET";
import notifications_prefs_get_181 from "./api/notifications/prefs/GET";
import notifications_prefs_put_182 from "./api/notifications/prefs/PUT";
import notifications_read_post_183 from "./api/notifications/read/POST";
import owner_console_activity_get_184 from "./api/owner-console/activity/GET";
import owner_console_cancellation_feedback_get_185 from "./api/owner-console/cancellation-feedback/GET";
import owner_console_companies_get_186 from "./api/owner-console/companies/GET";
import owner_console_companies_post_187 from "./api/owner-console/companies/POST";
import owner_console_companies_usage_get_188 from "./api/owner-console/companies/usage/GET";
import owner_console_companies_id_limits_put_189 from "./api/owner-console/companies/[id]/limits/PUT";
import owner_console_stats_get_190 from "./api/owner-console/stats/GET";
import owner_console_storage_get_191 from "./api/owner-console/storage/GET";
import owner_console_users_get_192 from "./api/owner-console/users/GET";
import owner_console_users_verify_post_193 from "./api/owner-console/users/verify/POST";
import recipes_get_194 from "./api/recipes/GET";
import recipes_post_195 from "./api/recipes/POST";
import recipes_id_delete_196 from "./api/recipes/[id]/DELETE";
import recipes_id_put_197 from "./api/recipes/[id]/PUT";
import safety_ai_draft_post_198 from "./api/safety/ai/draft/POST";
import safety_documents_get_199 from "./api/safety/documents/GET";
import safety_documents_post_200 from "./api/safety/documents/POST";
import safety_documents_id_delete_201 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_202 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_203 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_204 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_205 from "./api/safety/generated-posters/[id]/DELETE";
import safety_job_swms_get_206 from "./api/safety/job-swms/GET";
import safety_job_swms_post_207 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_208 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_209 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_210 from "./api/safety/job-swms/[id]/PUT";
import safety_plans_get_211 from "./api/safety/plans/GET";
import safety_plans_post_212 from "./api/safety/plans/POST";
import safety_plans_seed_post_213 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_214 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_215 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_216 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_217 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_218 from "./api/safety/posters/GET";
import safety_posters_post_219 from "./api/safety/posters/POST";
import safety_posters_id_delete_220 from "./api/safety/posters/[id]/DELETE";
import safety_swms_get_221 from "./api/safety/swms/GET";
import safety_swms_post_222 from "./api/safety/swms/POST";
import safety_swms_seed_post_223 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_224 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_225 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_226 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_227 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_228 from "./api/safety/swms/[id]/export/GET";
import scheduler_jobs_get_229 from "./api/scheduler/jobs/GET";
import settings_backup_get_230 from "./api/settings/backup/GET";
import settings_backup_post_231 from "./api/settings/backup/POST";
import settings_backup_export_get_232 from "./api/settings/backup/export/GET";
import settings_backup_run_post_233 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_234 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_235 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_236 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_237 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_238 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_239 from "./api/settings/file-transfer-backup/POST";
...
import settings_xero_credentials_get_247 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_248 from "./api/settings/xero-credentials/POST";
import signup_post_249 from "./api/signup/POST";
import stripe_create_checkout_session_post_250 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_251 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_252 from "./api/subscription/create-checkout/POST";
import subscription_status_get_253 from "./api/subscription/status/GET";
import subscription_webhook_post_254 from "./api/subscription/webhook/POST";
import support_mode_audit_get_255 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_256 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_257 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_258 from "./api/support-mode/enter/POST";
import support_mode_exit_post_259 from "./api/support-mode/exit/POST";
import support_mode_status_get_260 from "./api/support-mode/status/GET";
import takeoff_pad_get_261 from "./api/takeoff-pad/GET";
import takeoff_pad_put_262 from "./api/takeoff-pad/PUT";
import team_get_263 from "./api/team/GET";
import team_invite_post_264 from "./api/team/invite/POST";
import team_members_get_265 from "./api/team/members/GET";
import team_resend_verification_post_266 from "./api/team/resend-verification/POST";
import team_verify_user_post_267 from "./api/team/verify-user/POST";
...
// Document Engine
import documents_get from "./api/documents/GET";
import documents_id_get from "./api/documents/[id]/GET";
import documents_id_put from "./api/documents/[id]/PUT";
import documents_id_share_post from "./api/documents/[id]/share/POST";
import documents_id_share_delete from "./api/documents/[id]/share/DELETE";
import documents_id_events_get from "./api/documents/[id]/events/GET";
import documents_share_token_get from "./api/documents/share/[token]/GET";
import documents_share_token_post from "./api/documents/share/[token]/POST";
// </api-imports>
...
app.put("/api/company-settings", company_settings_put_26);
app.post("/api/contact", contact_post_27);
app.get("/api/cost-guide", cost_guide_get_28);
app.post("/api/cost-guide", cost_guide_post_29);
app.get("/api/cost-guide/export-csv", cost_guide_export_csv_get_30);
app.post("/api/cost-guide/import-csv", cost_guide_import_csv_post_31);
app.delete("/api/cost-guide/:id", cost_guide_id_delete_32);
app.put("/api/cost-guide/:id", cost_guide_id_put_33);
app.get("/api/customers", customers_get_34);
app.post("/api/customers", customers_post_35);
app.delete("/api/customers/:id", customers_id_delete_36);
app.get("/api/customers/:id", customers_id_get_37);
app.put("/api/customers/:id", customers_id_put_38);
app.get("/api/dashboard/setup-check", dashboard_setup_check_get_39);
app.get("/api/dashboard/todos", dashboard_todos_get_40);
app.post("/api/dazza/annette", dazza_annette_post_41);
app.post("/api/dazza/brain/hive/approve", dazza_brain_hive_approve_post_42);
app.post("/api/dazza/brain/hive/reject", dazza_brain_hive_reject_post_43);
app.get("/api/dazza/brain/status", dazza_brain_status_get_44);
app.post("/api/dazza/chat", dazza_chat_post_45);
app.get("/api/dazza/context", dazza_context_get_46);
app.get("/api/dazza/key-status", dazza_key_status_get_47);
app.get("/api/dazza/knowledge", dazza_knowledge_get_48);
app.post("/api/dazza/knowledge", dazza_knowledge_post_49);
app.delete("/api/dazza/knowledge/:id", dazza_knowledge_id_delete_50);
app.put("/api/dazza/knowledge/:id", dazza_knowledge_id_put_51);
app.get("/api/estimates", estimates_get_52);
app.post("/api/estimates", estimates_post_53);
app.delete("/api/estimates/:id", estimates_id_delete_54);
app.get("/api/estimates/:id", estimates_id_get_55);
app.put("/api/estimates/:id", estimates_id_put_56);
app.get("/api/estimates/:id/export-csv", estimates_id_export_csv_get_57);
app.post("/api/estimates/:id/import-csv", estimates_id_import_csv_post_58);
app.get("/api/files", files_get_59);
app.post("/api/files", files_post_60);
app.delete("/api/files/:id", files_id_delete_61);
app.get("/api/files/:id/download", files_id_download_get_62);
app.get("/api/fleet", fleet_get_63);
app.post("/api/fleet", fleet_post_64);
app.get("/api/fleet/flags", fleet_flags_get_65);
app.get("/api/fleet/:id", fleet_id_get_66);
app.put("/api/fleet/:id", fleet_id_put_67);
app.get("/api/fleet/:id/files", fleet_id_files_get_68);
app.get("/api/fleet/:id/prestarts", fleet_id_prestarts_get_69);
app.post("/api/fleet/:id/prestarts", fleet_id_prestarts_post_70);
app.get("/api/form-templates", form_templates_get_71);
app.post("/api/form-templates", form_templates_post_72);
app.post("/api/form-templates/seed", form_templates_seed_post_73);
app.delete("/api/form-templates/:id", form_templates_id_delete_74);
app.put("/api/form-templates/:id", form_templates_id_put_75);
app.get("/api/forms/:id/fields", forms_id_fields_get_76);
app.post("/api/forms/:id/fields", forms_id_fields_post_77);
app.post("/api/forms/:id/fields/reorder", forms_id_fields_reorder_post_78);
app.delete("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_delete_79);
app.patch("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_patch_80);
app.post("/api/forms/:id/fields/:fieldId/thumbnail", forms_id_fields_fieldId_thumbnail_post_81);
app.get("/api/health", health_get_82);
app.get("/api/integrations/onedrive/auth-url", integrations_onedrive_auth_url_get_83);
app.get("/api/integrations/onedrive/callback", integrations_onedrive_callback_get_84);
app.post("/api/integrations/onedrive/disconnect", integrations_onedrive_disconnect_post_85);
app.get("/api/integrations/onedrive/status", integrations_onedrive_status_get_86);
app.post("/api/integrations/onedrive/upload-file", integrations_onedrive_upload_file_post_87);
app.get("/api/integrations/xero/auth-url", integrations_xero_auth_url_get_88);
app.get("/api/integrations/xero/callback", integrations_xero_callback_get_89);
app.post("/api/integrations/xero/disconnect", integrations_xero_disconnect_post_90);
app.get("/api/integrations/xero/status", integrations_xero_status_get_91);
app.post("/api/integrations/xero/sync-customer", integrations_xero_sync_customer_post_92);
app.post("/api/integrations/xero/sync-invoice", integrations_xero_sync_invoice_post_93);
app.post("/api/integrations/xero/webhook", integrations_xero_webhook_post_94);
app.get("/api/invoices", invoices_get_95);
app.post("/api/invoices", invoices_post_96);
app.delete("/api/invoices/:id", invoices_id_delete_97);
app.get("/api/invoices/:id", invoices_id_get_98);
app.put("/api/invoices/:id", invoices_id_put_99);
app.post("/api/invoices/:id/duplicate", invoices_id_duplicate_post_100);
app.post("/api/invoices/:id/mark-sent", invoices_id_mark_sent_post_101);
app.post("/api/invoices/:id/record-payment", invoices_id_record_payment_post_102);
app.post("/api/invoices/:id/void", invoices_id_void_post_103);
...
// Document Engine — internal (auth required) — specific routes BEFORE :id wildcard
app.get("/api/documents", documents_get);
app.get("/api/documents/share/:token", documents_share_token_get);
app.post("/api/documents/share/:token", documents_share_token_post);
app.get("/api/documents/:id", documents_id_get);
app.put("/api/documents/:id", documents_id_put);
app.post("/api/documents/:id/share", documents_id_share_post);
app.delete("/api/documents/:id/share", documents_id_share_delete);
app.get("/api/documents/:id/events", documents_id_events_get);
app.get("/api/jobs", jobs_get_107);
app.post("/api/jobs", jobs_post_108);
app.get("/api/jobs/:id", jobs_id_get_109);
app.put("/api/jobs/:id", jobs_id_put_110);
app.get("/api/jobs/:id/costs", jobs_id_costs_get_111);
app.post("/api/jobs/:id/costs", jobs_id_costs_post_112);
app.get("/api/jobs/:id/costs/export", jobs_id_costs_export_get_113);
app.delete("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_delete_114);
app.put("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_put_115);
app.get("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_get_116);
app.post("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_post_117);
app.get("/api/jobs/:id/delays", jobs_id_delays_get_118);
app.post("/api/jobs/:id/delays", jobs_id_delays_post_119);
app.delete("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_delete_120);
app.put("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_put_121);
app.get("/api/jobs/:id/files", jobs_id_files_get_122);
app.get("/api/jobs/:id/forms", jobs_id_forms_get_123);
app.post("/api/jobs/:id/forms", jobs_id_forms_post_124);
app.get("/api/jobs/:id/photos", jobs_id_photos_get_125);
app.post("/api/jobs/:id/photos", jobs_id_photos_post_126);
app.delete("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_delete_127);
app.patch("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_patch_128);
app.get("/api/jobs/:id/photos/:photoId/download", jobs_id_photos_photoId_download_get_129);
app.post("/api/jobs/:id/photos/:photoId/replace", jobs_id_photos_photoId_replace_post_130);
...
app.get("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_get_134);
app.post("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_post_135);
app.delete("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_delete_136);
app.get("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_get_137);
...
app.post("/api/jobs/:id/todos", jobs_id_todos_post_144);
app.delete("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_delete_145);
app.put("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_put_146);
app.get("/api/me", me_get_147);
app.put("/api/me", me_put_148);
app.post("/api/me/2fa/disable", me_2fa_disable_post_149);
app.post("/api/me/2fa/enable", me_2fa_enable_post_150);
app.get("/api/me/2fa/setup", me_2fa_setup_get_151);
app.get("/api/me/2fa/status", me_2fa_status_get_152);
app.post("/api/me/2fa/verify", me_2fa_verify_post_153);
app.post("/api/me/change-password", me_change_password_post_154);
app.get("/api/me/email-status", me_email_status_get_155);
app.post("/api/migrate-account-recovery", migrate_account_recovery_post_156);
app.post("/api/migrate-company-settings", migrate_company_settings_post_157);
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_158);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_159);
app.post("/api/migrate-estimates", migrate_estimates_post_160);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_161);
app.post("/api/migrate-files", migrate_files_post_162);
app.post("/api/migrate-fleet", migrate_fleet_post_163);
app.post("/api/migrate-form-fields", migrate_form_fields_post_164);
app.post("/api/migrate-form-logic", migrate_form_logic_post_165);
app.post("/api/migrate-form-templates", migrate_form_templates_post_166);
app.post("/api/migrate-job-forms", migrate_job_forms_post_167);
app.post("/api/migrate-job-photos", migrate_job_photos_post_168);
app.post("/api/migrate-job-tabs", migrate_job_tabs_post_169);
app.post("/api/migrate-jobs", migrate_jobs_post_170);
app.post("/api/migrate-notifications", migrate_notifications_post_171);
app.post("/api/migrate-owner-console", migrate_owner_console_post_172);
app.post("/api/migrate-owner-role", migrate_owner_role_post_173);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_174);
app.post("/api/migrate-safety", migrate_safety_post_175);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_176);
app.post("/api/migrate-support-mode", migrate_support_mode_post_177);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_178);
app.post("/api/migrate-team", migrate_team_post_179);
app.get("/api/notifications/alerts", notifications_alerts_get_180);
app.get("/api/notifications/prefs", notifications_prefs_get_181);
app.put("/api/notifications/prefs", notifications_prefs_put_182);
app.post("/api/notifications/read", notifications_read_post_183);
app.get("/api/owner-console/activity", owner_console_activity_get_184);
app.get("/api/owner-console/cancellation-feedback", owner_console_cancellation_feedback_get_185);
app.get("/api/owner-console/companies", owner_console_companies_get_186);
app.post("/api/owner-console/companies", owner_console_companies_post_187);
app.get("/api/owner-console/companies/usage", owner_console_companies_usage_get_188);
app.put("/api/owner-console/companies/:id/limits", owner_console_companies_id_limits_put_189);
app.get("/api/owner-console/stats", owner_console_stats_get_190);
app.get("/api/owner-console/storage", owner_console_storage_get_191);
app.get("/api/owner-console/users", owner_console_users_get_192);
app.post("/api/owner-console/users/verify", owner_console_users_verify_post_193);
app.get("/api/recipes", recipes_get_194);
app.post("/api/recipes", recipes_post_195);
app.delete("/api/recipes/:id", recipes_id_delete_196);
app.put("/api/recipes/:id", recipes_id_put_197);
app.post("/api/safety/ai/draft", safety_ai_draft_post_198);
app.get("/api/safety/documents", safety_documents_get_199);
app.post("/api/safety/documents", safety_documents_post_200);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_201);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_202);
app.get("/api/safety/generated-posters", safety_generated_posters_get_203);
app.post("/api/safety/generated-posters", safety_generated_posters_post_204);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_205);
app.get("/api/safety/job-swms", safety_job_swms_get_206);
app.post("/api/safety/job-swms", safety_job_swms_post_207);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_208);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_209);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_210);
app.get("/api/safety/plans", safety_plans_get_211);
app.post("/api/safety/plans", safety_plans_post_212);
app.post("/api/safety/plans/seed", safety_plans_seed_post_213);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_214);
app.put("/api/safety/plans/:id", safety_plans_id_put_215);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_216);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_217);
app.get("/api/safety/posters", safety_posters_get_218);
app.post("/api/safety/posters", safety_posters_post_219);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_220);
app.get("/api/safety/swms", safety_swms_get_221);
app.post("/api/safety/swms", safety_swms_post_222);
app.post("/api/safety/swms/seed", safety_swms_seed_post_223);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_224);
app.get("/api/safety/swms/:id", safety_swms_id_get_225);
app.put("/api/safety/swms/:id", safety_swms_id_put_226);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_227);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_228);
app.get("/api/scheduler/jobs", scheduler_jobs_get_229);
app.get("/api/settings/backup", settings_backup_get_230);
app.post("/api/settings/backup", settings_backup_post_231);
app.get("/api/settings/backup/export", settings_backup_export_get_232);
app.post("/api/settings/backup/run", settings_backup_run_post_233);
app.get("/api/settings/backup-destination", settings_backup_destination_get_234);
app.post("/api/settings/backup-destination", settings_backup_destination_post_235);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_236);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_237);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_238);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_239);
...
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_247);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_248);
app.post("/api/signup", signup_post_249);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_250);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_251);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_252);
app.get("/api/subscription/status", subscription_status_get_253);
app.post("/api/subscription/webhook", subscription_webhook_post_254);
app.get("/api/support-mode/audit", support_mode_audit_get_255);
app.get("/api/support-mode/checklist", support_mode_checklist_get_256);
app.put("/api/support-mode/checklist", support_mode_checklist_put_257);
app.post("/api/support-mode/enter", support_mode_enter_post_258);
app.post("/api/support-mode/exit", support_mode_exit_post_259);
app.get("/api/support-mode/status", support_mode_status_get_260);
app.get("/api/takeoff-pad", takeoff_pad_get_261);
app.put("/api/takeoff-pad", takeoff_pad_put_262);
app.get("/api/team", team_get_263);
app.post("/api/team/invite", team_invite_post_264);
app.get("/api/team/members", team_members_get_265);
app.post("/api/team/resend-verification", team_resend_verification_post_266);
app.post("/api/team/verify-user", team_verify_user_post_267);
app.delete("/api/team/:id", team_id_delete_268);
app.put("/api/team/:id", team_id_put_269);
app.get("/api/usage", usage_get_270);
// </api-registrations>
