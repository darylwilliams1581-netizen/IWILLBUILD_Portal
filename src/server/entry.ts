...
import safety_ai_draft_post_558 from "./api/safety/ai/draft/POST";
import safety_documents_get_559 from "./api/safety/documents/GET";
import safety_documents_post_560 from "./api/safety/documents/POST";
import safety_documents_id_delete_561 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_562 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_563 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_564 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_565 from "./api/safety/generated-posters/[id]/DELETE";
import safety_job_safety_plans_get_566 from "./api/safety/job-safety-plans/GET";
import safety_job_safety_plans_post_567 from "./api/safety/job-safety-plans/POST";
import safety_job_safety_plans_id_delete_568 from "./api/safety/job-safety-plans/[id]/DELETE";
import safety_job_safety_plans_id_put_569 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_570 from "./api/safety/job-swms/GET";
import safety_job_swms_post_571 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_572 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_573 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_574 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_share_token_post_575 from "./api/safety/job-swms/[id]/share-token/POST";
import safety_job_swms_id_signoffs_get_576 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_577 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_578 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_579 from "./api/safety/plans/GET";
import safety_plans_post_580 from "./api/safety/plans/POST";
import safety_plans_seed_post_581 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_582 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_583 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_584 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_585 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_586 from "./api/safety/posters/GET";
import safety_posters_post_587 from "./api/safety/posters/POST";
import safety_posters_id_delete_588 from "./api/safety/posters/[id]/DELETE";
import safety_swms_get_589 from "./api/safety/swms/GET";
import safety_swms_post_590 from "./api/safety/swms/POST";
import safety_swms_import_docx_post_591 from "./api/safety/swms/import-docx/POST";
import safety_swms_seed_post_592 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_593 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_594 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_595 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_596 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_597 from "./api/safety/swms/[id]/export/GET";
import safety_swms_id_publish_to_library_post_598 from "./api/safety/swms/[id]/publish-to-library/POST";
import scheduler_crew_get_599 from "./api/scheduler/crew/GET";
import scheduler_jobs_get_600 from "./api/scheduler/jobs/GET";
import scheduler_jobs_id_reschedule_patch_601 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
import scheduler_tasks_get_602 from "./api/scheduler/tasks/GET";
import secure_share_get_603 from "./api/secure-share/GET";
import secure_share_post_604 from "./api/secure-share/POST";
import secure_share_id_delete_605 from "./api/secure-share/[id]/DELETE";
import secure_share_token_get_606 from "./api/secure-share/[token]/GET";
import secure_share_token_post_607 from "./api/secure-share/[token]/POST";
import settings_backup_get_608 from "./api/settings/backup/GET";
import settings_backup_post_609 from "./api/settings/backup/POST";
import settings_backup_export_get_610 from "./api/settings/backup/export/GET";
import settings_backup_run_post_611 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_612 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_613 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_614 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_615 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_616 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_617 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_618 from "./api/settings/retention/GET";
import settings_retention_post_619 from "./api/settings/retention/POST";
import settings_storage_provider_get_620 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_621 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_622 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_623 from "./api/settings/terminology/GET";
import settings_terminology_post_624 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_625 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_626 from "./api/settings/xero-credentials/POST";
import share_token_get_627 from "./api/share/[token]/GET";
import signin_history_get_628 from "./api/signin-history/GET";
import signup_post_629 from "./api/signup/POST";
import sos_get_630 from "./api/sos/GET";
import sos_acknowledge_post_631 from "./api/sos/acknowledge/POST";
import sos_trigger_post_632 from "./api/sos/trigger/POST";
import stakeholders_sms_post_633 from "./api/stakeholders/sms/POST";
import stripe_create_checkout_session_post_634 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_635 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_636 from "./api/subscription/create-checkout/POST";
import subscription_status_get_637 from "./api/subscription/status/GET";
import subscription_webhook_post_638 from "./api/subscription/webhook/POST";
import support_mode_audit_get_639 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_640 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_641 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_642 from "./api/support-mode/enter/POST";
import support_mode_exit_post_643 from "./api/support-mode/exit/POST";
import support_mode_status_get_644 from "./api/support-mode/status/GET";
import tag_tasks_get_645 from "./api/tag-tasks/GET";
import tag_tasks_id_patch_646 from "./api/tag-tasks/[id]/PATCH";
import takeoff_pad_get_647 from "./api/takeoff-pad/GET";
import takeoff_pad_put_648 from "./api/takeoff-pad/PUT";
import tasks_post_649 from "./api/tasks/POST";
import tasks_id_put_650 from "./api/tasks/[id]/PUT";
import team_get_651 from "./api/team/GET";
import team_invite_post_652 from "./api/team/invite/POST";
import team_invites_get_653 from "./api/team/invites/GET";
import team_invites_post_654 from "./api/team/invites/POST";
import team_invites_id_cancel_post_655 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_656 from "./api/team/invites/[id]/resend/POST";
import team_members_get_657 from "./api/team/members/GET";
import team_members_id_icon_permissions_get_658 from "./api/team/members/[id]/icon-permissions/GET";
import team_members_id_icon_permissions_put_659 from "./api/team/members/[id]/icon-permissions/PUT";
import team_resend_verification_post_660 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_661 from "./api/team/schedule/migrate/POST";
import team_shifts_get_662 from "./api/team/shifts/GET";
import team_shifts_post_663 from "./api/team/shifts/POST";
import team_shifts_id_delete_664 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_665 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_666 from "./api/team/time-entries/GET";
import team_time_entries_post_667 from "./api/team/time-entries/POST";
import team_time_entries_export_get_668 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_669 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_670 from "./api/team/verify-user/POST";
import team_id_delete_671 from "./api/team/[id]/DELETE";
import team_id_put_672 from "./api/team/[id]/PUT";
...
app.post("/api/safety/ai/draft", safety_ai_draft_post_558);
app.get("/api/safety/documents", safety_documents_get_559);
app.post("/api/safety/documents", safety_documents_post_560);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_561);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_562);
app.get("/api/safety/generated-posters", safety_generated_posters_get_563);
app.post("/api/safety/generated-posters", safety_generated_posters_post_564);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_565);
app.get("/api/safety/job-safety-plans", safety_job_safety_plans_get_566);
app.post("/api/safety/job-safety-plans", safety_job_safety_plans_post_567);
app.delete("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_delete_568);
app.put("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_put_569);
app.get("/api/safety/job-swms", safety_job_swms_get_570);
app.post("/api/safety/job-swms", safety_job_swms_post_571);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_572);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_573);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_574);
app.post("/api/safety/job-swms/:id/share-token", safety_job_swms_id_share_token_post_575);
app.get("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_get_576);
app.post("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_post_577);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", safety_job_swms_id_signoffs_signoffId_delete_578);
app.get("/api/safety/plans", safety_plans_get_579);
app.post("/api/safety/plans", safety_plans_post_580);
app.post("/api/safety/plans/seed", safety_plans_seed_post_581);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_582);
app.put("/api/safety/plans/:id", safety_plans_id_put_583);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_584);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_585);
app.get("/api/safety/posters", safety_posters_get_586);
app.post("/api/safety/posters", safety_posters_post_587);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_588);
app.get("/api/safety/swms", safety_swms_get_589);
app.post("/api/safety/swms", safety_swms_post_590);
app.post("/api/safety/swms/import-docx", safety_swms_import_docx_post_591);
app.post("/api/safety/swms/seed", safety_swms_seed_post_592);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_593);
app.get("/api/safety/swms/:id", safety_swms_id_get_594);
app.put("/api/safety/swms/:id", safety_swms_id_put_595);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_596);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_597);
app.post("/api/safety/swms/:id/publish-to-library", safety_swms_id_publish_to_library_post_598);
app.get("/api/scheduler/crew", scheduler_crew_get_599);
app.get("/api/scheduler/jobs", scheduler_jobs_get_600);
app.patch("/api/scheduler/jobs/:id/reschedule", scheduler_jobs_id_reschedule_patch_601);
app.get("/api/scheduler/tasks", scheduler_tasks_get_602);
app.get("/api/secure-share", secure_share_get_603);
app.post("/api/secure-share", secure_share_post_604);
app.delete("/api/secure-share/:id", secure_share_id_delete_605);
app.get("/api/secure-share/:token", secure_share_token_get_606);
app.post("/api/secure-share/:token", secure_share_token_post_607);
app.get("/api/settings/backup", settings_backup_get_608);
app.post("/api/settings/backup", settings_backup_post_609);
app.get("/api/settings/backup/export", settings_backup_export_get_610);
app.post("/api/settings/backup/run", settings_backup_run_post_611);
app.get("/api/settings/backup-destination", settings_backup_destination_get_612);
app.post("/api/settings/backup-destination", settings_backup_destination_post_613);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_614);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_615);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_616);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_617);
app.get("/api/settings/retention", settings_retention_get_618);
app.post("/api/settings/retention", settings_retention_post_619);
app.get("/api/settings/storage-provider", settings_storage_provider_get_620);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_621);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_622);
app.get("/api/settings/terminology", settings_terminology_get_623);
app.post("/api/settings/terminology", settings_terminology_post_624);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_625);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_626);
app.get("/api/share/:token", share_token_get_627);
app.get("/api/signin-history", signin_history_get_628);
app.post("/api/signup", signup_post_629);
app.get("/api/sos", sos_get_630);
app.post("/api/sos/acknowledge", sos_acknowledge_post_631);
app.post("/api/sos/trigger", sos_trigger_post_632);
app.post("/api/stakeholders/sms", stakeholders_sms_post_633);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_634);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_635);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_636);
app.get("/api/subscription/status", subscription_status_get_637);
app.post("/api/subscription/webhook", subscription_webhook_post_638);
app.get("/api/support-mode/audit", support_mode_audit_get_639);
app.get("/api/support-mode/checklist", support_mode_checklist_get_640);
app.put("/api/support-mode/checklist", support_mode_checklist_put_641);
app.post("/api/support-mode/enter", support_mode_enter_post_642);
app.post("/api/support-mode/exit", support_mode_exit_post_643);
app.get("/api/support-mode/status", support_mode_status_get_644);
app.get("/api/tag-tasks", tag_tasks_get_645);
app.patch("/api/tag-tasks/:id", tag_tasks_id_patch_646);
app.get("/api/takeoff-pad", takeoff_pad_get_647);
app.put("/api/takeoff-pad", takeoff_pad_put_648);
app.post("/api/tasks", tasks_post_649);
app.put("/api/tasks/:id", tasks_id_put_650);
app.get("/api/team", team_get_651);
app.post("/api/team/invite", team_invite_post_652);
app.get("/api/team/invites", team_invites_get_653);
app.post("/api/team/invites", team_invites_post_654);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_655);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_656);
app.get("/api/team/members", team_members_get_657);
app.get("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_get_658);
app.put("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_put_659);
app.post("/api/team/resend-verification", team_resend_verification_post_660);
app.post("/api/team/schedule/migrate", team_schedule_migrate_post_661);
app.get("/api/team/shifts", team_shifts_get_662);
app.post("/api/team/shifts", team_shifts_post_663);
app.delete("/api/team/shifts/:id", team_shifts_id_delete_664);
app.put("/api/team/shifts/:id", team_shifts_id_put_665);
app.get("/api/team/time-entries", team_time_entries_get_666);
app.post("/api/team/time-entries", team_time_entries_post_667);
app.get("/api/team/time-entries/export", team_time_entries_export_get_668);
app.put("/api/team/time-entries/:id", team_time_entries_id_put_669);
app.post("/api/team/verify-user", team_verify_user_post_670);
app.delete("/api/team/:id", team_id_delete_671);
app.put("/api/team/:id", team_id_put_672);
app.get("/api/usage", usage_get_673);
app.get("/api/user-logs", user_logs_get_674);
app.get("/api/user-logs/users", user_logs_users_get_675);
// </api-registrations>
