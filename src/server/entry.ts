...
// Route group modules (split out to reduce entry chunk size)
import { register as register_jobs } from './routes-jobs.js';
import { register as register_safety } from './routes-safety.js';
import { register as register_developer } from './routes-developer.js';
import { register as register_integrations } from './routes-integrations.js';
import { register as register_settings } from './routes-settings.js';
import { register as register_fleet } from './routes-fleet.js';
// </api-imports>
...
app.post("/api/dazza/chat", async (req, res, next) => { const { default: h } = await import("./api/dazza/chat/POST.js"); return h(req, res, next); });
...
// Register route groups (split from entry to reduce chunk size)
register_jobs(app);
register_safety(app);
register_developer(app);
...
app.post("/api/form-templates/seed", async (req, res, next) => { const { default: h } = await import("./api/form-templates/seed/POST.js"); return h(req, res, next); });
...
app.post("/api/migrate-account-recovery", async (req, res, next) => { const { default: h } = await import("./api/migrate-account-recovery/POST.js"); return h(req, res, next); });
app.post("/api/migrate-company-settings", async (req, res, next) => { const { default: h } = await import("./api/migrate-company-settings/POST.js"); return h(req, res, next); });
app.post("/api/migrate-dazza-audit", async (req, res, next) => { const { default: h } = await import("./api/migrate-dazza-audit/POST.js"); return h(req, res, next); });
app.post("/api/migrate-dazza-knowledge", async (req, res, next) => { const { default: h } = await import("./api/migrate-dazza-knowledge/POST.js"); return h(req, res, next); });
app.post("/api/migrate-estimates", async (req, res, next) => { const { default: h } = await import("./api/migrate-estimates/POST.js"); return h(req, res, next); });
app.post("/api/migrate-estimating-library", async (req, res, next) => { const { default: h } = await import("./api/migrate-estimating-library/POST.js"); return h(req, res, next); });
app.post("/api/migrate-files", async (req, res, next) => { const { default: h } = await import("./api/migrate-files/POST.js"); return h(req, res, next); });
app.post("/api/migrate-fleet", async (req, res, next) => { const { default: h } = await import("./api/migrate-fleet/POST.js"); return h(req, res, next); });
app.post("/api/migrate-fleet-driver-sessions", async (req, res, next) => { const { default: h } = await import("./api/migrate-fleet-driver-sessions/POST.js"); return h(req, res, next); });
app.post("/api/migrate-form-fields", async (req, res, next) => { const { default: h } = await import("./api/migrate-form-fields/POST.js"); return h(req, res, next); });
app.post("/api/migrate-form-logic", async (req, res, next) => { const { default: h } = await import("./api/migrate-form-logic/POST.js"); return h(req, res, next); });
app.post("/api/migrate-form-templates", async (req, res, next) => { const { default: h } = await import("./api/migrate-form-templates/POST.js"); return h(req, res, next); });
app.post("/api/migrate-job-forms", async (req, res, next) => { const { default: h } = await import("./api/migrate-job-forms/POST.js"); return h(req, res, next); });
app.post("/api/migrate-job-photos", async (req, res, next) => { const { default: h } = await import("./api/migrate-job-photos/POST.js"); return h(req, res, next); });
app.post("/api/migrate-job-tabs", async (req, res, next) => { const { default: h } = await import("./api/migrate-job-tabs/POST.js"); return h(req, res, next); });
app.post("/api/migrate-jobs", async (req, res, next) => { const { default: h } = await import("./api/migrate-jobs/POST.js"); return h(req, res, next); });
app.post("/api/migrate-notifications", async (req, res, next) => { const { default: h } = await import("./api/migrate-notifications/POST.js"); return h(req, res, next); });
app.post("/api/migrate-owner-console", async (req, res, next) => { const { default: h } = await import("./api/migrate-owner-console/POST.js"); return h(req, res, next); });
app.post("/api/migrate-owner-role", async (req, res, next) => { const { default: h } = await import("./api/migrate-owner-role/POST.js"); return h(req, res, next); });
app.post("/api/migrate-pdf-settings", async (req, res, next) => { const { default: h } = await import("./api/migrate-pdf-settings/POST.js"); return h(req, res, next); });
app.post("/api/migrate-safety", async (req, res, next) => { const { default: h } = await import("./api/migrate-safety/POST.js"); return h(req, res, next); });
app.post("/api/migrate-starter-pack", async (req, res, next) => { const { default: h } = await import("./api/migrate-starter-pack/POST.js"); return h(req, res, next); });
app.post("/api/migrate-subscriptions", async (req, res, next) => { const { default: h } = await import("./api/migrate-subscriptions/POST.js"); return h(req, res, next); });
app.post("/api/migrate-support-mode", async (req, res, next) => { const { default: h } = await import("./api/migrate-support-mode/POST.js"); return h(req, res, next); });
app.post("/api/migrate-takeoff-pad", async (req, res, next) => { const { default: h } = await import("./api/migrate-takeoff-pad/POST.js"); return h(req, res, next); });
app.post("/api/migrate-team", async (req, res, next) => { const { default: h } = await import("./api/migrate-team/POST.js"); return h(req, res, next); });
