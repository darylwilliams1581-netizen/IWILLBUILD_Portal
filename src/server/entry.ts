...
import settings_backup_get_807 from "./api/settings/backup/GET";
import settings_backup_post_808 from "./api/settings/backup/POST";
import settings_backup_company_data_get_809 from "./api/settings/backup/company-data/GET";
import settings_backup_csv_pack_get_810 from "./api/settings/backup/csv-pack/GET";
import settings_backup_export_get_811 from "./api/settings/backup/export/GET";
import settings_backup_run_post_812 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_813 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_814 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_815 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_816 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_817 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_818 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_819 from "./api/settings/retention/GET";
import settings_retention_post_820 from "./api/settings/retention/POST";
import settings_storage_provider_get_821 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_822 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_823 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_824 from "./api/settings/terminology/GET";
import settings_terminology_post_825 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_826 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_827 from "./api/settings/xero-credentials/POST";
import share_token_get_828 from "./api/share/[token]/GET";
import signin_history_get_829 from "./api/signin-history/GET";
import signup_post_830 from "./api/signup/POST";
import sos_get_831 from "./api/sos/GET";
import sos_acknowledge_post_832 from "./api/sos/acknowledge/POST";
import sos_trigger_post_833 from "./api/sos/trigger/POST";
import stakeholders_sms_post_834 from "./api/stakeholders/sms/POST";
import stripe_create_checkout_session_post_835 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_836 from "./api/stripe/session/[sessionId]/GET";
import studio_generate_from_safety_post_837 from "./api/studio/generate-from-safety/POST";
import studio_upload_image_post_838 from "./api/studio/upload-image/POST";
import subscription_create_checkout_post_839 from "./api/subscription/create-checkout/POST";
import subscription_status_get_840 from "./api/subscription/status/GET";
import subscription_webhook_post_841 from "./api/subscription/webhook/POST";
import support_mode_audit_get_842 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_843 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_844 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_845 from "./api/support-mode/enter/POST";
import support_mode_exit_post_846 from "./api/support-mode/exit/POST";
import support_mode_status_get_847 from "./api/support-mode/status/GET";
import tag_tasks_get_848 from "./api/tag-tasks/GET";
import tag_tasks_id_patch_849 from "./api/tag-tasks/[id]/PATCH";
import takeoff_pad_get_850 from "./api/takeoff-pad/GET";
import takeoff_pad_put_851 from "./api/takeoff-pad/PUT";
import tasks_post_852 from "./api/tasks/POST";
import tasks_id_put_853 from "./api/tasks/[id]/PUT";
import team_get_854 from "./api/team/GET";
import team_invite_post_855 from "./api/team/invite/POST";
import team_invites_get_856 from "./api/team/invites/GET";
import team_invites_post_857 from "./api/team/invites/POST";
import team_invites_id_cancel_post_858 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_859 from "./api/team/invites/[id]/resend/POST";
import team_members_get_860 from "./api/team/members/GET";
import team_members_id_icon_permissions_get_861 from "./api/team/members/[id]/icon-permissions/GET";
import team_members_id_icon_permissions_put_862 from "./api/team/members/[id]/icon-permissions/PUT";
import team_resend_verification_post_863 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_864 from "./api/team/schedule/migrate/POST";
import team_shifts_get_865 from "./api/team/shifts/GET";
import team_shifts_post_866 from "./api/team/shifts/POST";
import team_shifts_id_delete_867 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_868 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_869 from "./api/team/time-entries/GET";
import team_time_entries_post_870 from "./api/team/time-entries/POST";
import team_time_entries_export_get_871 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_872 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_873 from "./api/team/verify-user/POST";
import team_id_delete_874 from "./api/team/[id]/DELETE";
import team_id_put_875 from "./api/team/[id]/PUT";
import usage_get_876 from "./api/usage/GET";
import user_logs_get_877 from "./api/user-logs/GET";
import user_logs_users_get_878 from "./api/user-logs/users/GET";
import work_attendance_get_879 from "./api/work/attendance/GET";
import work_delays_get_880 from "./api/work/delays/GET";
import work_notes_get_881 from "./api/work/notes/GET";
import work_progress_get_882 from "./api/work/progress/GET";
import work_tasks_get_883 from "./api/work/tasks/GET";
// </api-imports>
// ── Job Cards ─────────────────────────────────────────────────────────────────
...
app.get("/api/settings/backup", settings_backup_get_807);
app.post("/api/settings/backup", settings_backup_post_808);
app.get("/api/settings/backup/company-data", settings_backup_company_data_get_809);
app.get("/api/settings/backup/csv-pack", settings_backup_csv_pack_get_810);
app.get("/api/settings/backup/export", settings_backup_export_get_811);
app.post("/api/settings/backup/run", settings_backup_run_post_812);
app.get("/api/settings/backup-destination", settings_backup_destination_get_813);
app.post("/api/settings/backup-destination", settings_backup_destination_post_814);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_815);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_816);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_817);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_818);
app.get("/api/settings/retention", settings_retention_get_819);
app.post("/api/settings/retention", settings_retention_post_820);
app.get("/api/settings/storage-provider", settings_storage_provider_get_821);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_822);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_823);
app.get("/api/settings/terminology", settings_terminology_get_824);
app.post("/api/settings/terminology", settings_terminology_post_825);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_826);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_827);
app.get("/api/share/:token", share_token_get_828);
app.get("/api/signin-history", signin_history_get_829);
app.post("/api/signup", signup_post_830);
app.get("/api/sos", sos_get_831);
app.post("/api/sos/acknowledge", sos_acknowledge_post_832);
app.post("/api/sos/trigger", sos_trigger_post_833);
app.post("/api/stakeholders/sms", stakeholders_sms_post_834);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_835);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_836);
app.post("/api/studio/generate-from-safety", studio_generate_from_safety_post_837);
app.post("/api/studio/upload-image", studio_upload_image_post_838);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_839);
app.get("/api/subscription/status", subscription_status_get_840);
app.post("/api/subscription/webhook", subscription_webhook_post_841);
app.get("/api/support-mode/audit", support_mode_audit_get_842);
app.get("/api/support-mode/checklist", support_mode_checklist_get_843);
app.put("/api/support-mode/checklist", support_mode_checklist_put_844);
app.post("/api/support-mode/enter", support_mode_enter_post_845);
app.post("/api/support-mode/exit", support_mode_exit_post_846);
app.get("/api/support-mode/status", support_mode_status_get_847);
app.get("/api/tag-tasks", tag_tasks_get_848);
app.patch("/api/tag-tasks/:id", tag_tasks_id_patch_849);
app.get("/api/takeoff-pad", takeoff_pad_get_850);
app.put("/api/takeoff-pad", takeoff_pad_put_851);
app.post("/api/tasks", tasks_post_852);
app.put("/api/tasks/:id", tasks_id_put_853);
app.get("/api/team", team_get_854);
app.post("/api/team/invite", team_invite_post_855);
app.get("/api/team/invites", team_invites_get_856);
app.post("/api/team/invites", team_invites_post_857);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_858);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_859);
app.get("/api/team/members", team_members_get_860);
app.get("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_get_861);
app.put("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_put_862);
app.post("/api/team/resend-verification", team_resend_verification_post_863);
app.post("/api/team/schedule/migrate", team_schedule_migrate_post_864);
app.get("/api/team/shifts", team_shifts_get_865);
app.post("/api/team/shifts", team_shifts_post_866);
app.delete("/api/team/shifts/:id", team_shifts_id_delete_867);
app.put("/api/team/shifts/:id", team_shifts_id_put_868);
app.get("/api/team/time-entries", team_time_entries_get_869);
app.post("/api/team/time-entries", team_time_entries_post_870);
app.get("/api/team/time-entries/export", team_time_entries_export_get_871);
app.put("/api/team/time-entries/:id", team_time_entries_id_put_872);
app.post("/api/team/verify-user", team_verify_user_post_873);
app.delete("/api/team/:id", team_id_delete_874);
app.put("/api/team/:id", team_id_put_875);
app.get("/api/usage", usage_get_876);
app.get("/api/user-logs", user_logs_get_877);
app.get("/api/user-logs/users", user_logs_users_get_878);
app.get("/api/work/attendance", work_attendance_get_879);
app.get("/api/work/delays", work_delays_get_880);
app.get("/api/work/notes", work_notes_get_881);
app.get("/api/work/progress", work_progress_get_882);
app.get("/api/work/tasks", work_tasks_get_883);
// </api-registrations>
