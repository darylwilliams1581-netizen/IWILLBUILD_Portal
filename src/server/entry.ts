...
import portalJobsGet from "./api/portal/jobs/GET";
import portalJobsIdGet from "./api/portal/jobs/[id]/GET";
import portalEstimatesApprovePost from "./api/portal/estimates/[id]/approve/POST";
import portalInvoicesPayPost from "./api/portal/invoices/[id]/pay/POST";
import teamScheduleMigratePost from "./api/team/schedule/migrate/POST";
import teamShiftsGet from "./api/team/shifts/GET";
import teamShiftsPost from "./api/team/shifts/POST";
import teamShiftsIdPut from "./api/team/shifts/[id]/PUT";
import teamShiftsIdDelete from "./api/team/shifts/[id]/DELETE";
import teamTimeEntriesGet from "./api/team/time-entries/GET";
import teamTimeEntriesPost from "./api/team/time-entries/POST";
import teamTimeEntriesIdPut from "./api/team/time-entries/[id]/PUT";
import teamTimeEntriesExportGet from "./api/team/time-entries/export/GET";
