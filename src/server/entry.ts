...
import estimates_id_export_pdf_get from "./api/estimates/[id]/export-pdf/GET";
...
import invoices_id_export_pdf_get from "./api/invoices/[id]/export-pdf/GET";
...
app.get("/api/estimates/:id/export-pdf", estimates_id_export_pdf_get);
...
app.get("/api/invoices/:id/export-pdf", invoices_id_export_pdf_get);
