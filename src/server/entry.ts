...
import _h_developer_activity_log_get_61 from "./api/developer/activity-log/GET";
import _h_developer_audit_log_get_62 from "./api/developer/audit-log/GET";
import _h_developer_companies_id_archive_post_63 from "./api/developer/companies/[id]/archive/POST";
import _h_developer_company_health_get_64 from "./api/developer/company-health/GET";
import _h_developer_email_log_get_65 from "./api/developer/email-log/GET";
import _h_developer_email_settings_get_66 from "./api/developer/email-settings/GET";
import _h_developer_email_settings_put_67 from "./api/developer/email-settings/PUT";
import _h_developer_email_settings_test_post_68 from "./api/developer/email-settings/test/POST";
import _h_developer_support_notes_get_69 from "./api/developer/support-notes/GET";
import _h_developer_support_notes_post_70 from "./api/developer/support-notes/POST";
import _h_developer_support_notes_id_delete_71 from "./api/developer/support-notes/[id]/DELETE";
import _h_developer_users_id_assign_company_post_72 from "./api/developer/users/[id]/assign-company/POST";
import _h_developer_users_id_deactivate_post_73 from "./api/developer/users/[id]/deactivate/POST";
import _h_developer_users_id_delete_orphan_post_74 from "./api/developer/users/[id]/delete-orphan/POST";
import _h_developer_users_id_force_temp_password_post_75 from "./api/developer/users/[id]/force-temp-password/POST";
import _h_developer_users_id_impersonate_delete_76 from "./api/developer/users/[id]/impersonate/DELETE";
import _h_developer_users_id_impersonate_post_77 from "./api/developer/users/[id]/impersonate/POST";
import _h_developer_users_id_reactivate_post_78 from "./api/developer/users/[id]/reactivate/POST";
import _h_developer_users_id_resend_verification_post_79 from "./api/developer/users/[id]/resend-verification/POST";
import _h_developer_users_id_role_put_80 from "./api/developer/users/[id]/role/PUT";
import _h_developer_users_id_send_reset_email_post_81 from "./api/developer/users/[id]/send-reset-email/POST";
import _h_developer_users_id_sessions_delete_82 from "./api/developer/users/[id]/sessions/DELETE";
import _h_developer_users_id_sessions_get_83 from "./api/developer/users/[id]/sessions/GET";
import _h_developer_users_id_unlock_account_post_84 from "./api/developer/users/[id]/unlock-account/POST";
...
import _h_fleet_get_119 from "./api/fleet/GET";
import _h_fleet_post_120 from "./api/fleet/POST";
import _h_fleet_driver_sessions_post_121 from "./api/fleet/driver-sessions/POST";
import _h_fleet_driver_sessions_active_get_122 from "./api/fleet/driver-sessions/active/GET";
import _h_fleet_driver_sessions_id_stop_post_123 from "./api/fleet/driver-sessions/[id]/stop/POST";
import _h_fleet_flags_get_124 from "./api/fleet/flags/GET";
import _h_fleet_service_logs_logid_delete_125 from "./api/fleet/service-logs/[logId]/DELETE";
import _h_fleet_service_logs_logid_patch_126 from "./api/fleet/service-logs/[logId]/PATCH";
import _h_fleet_vehicles_get_127 from "./api/fleet/vehicles/GET";
import _h_fleet_id_delete_128 from "./api/fleet/[id]/DELETE";
import _h_fleet_id_get_129 from "./api/fleet/[id]/GET";
import _h_fleet_id_put_130 from "./api/fleet/[id]/PUT";
import _h_fleet_id_driver_sessions_get_131 from "./api/fleet/[id]/driver-sessions/GET";
import _h_fleet_id_files_get_132 from "./api/fleet/[id]/files/GET";
import _h_fleet_id_prestarts_get_133 from "./api/fleet/[id]/prestarts/GET";
import _h_fleet_id_prestarts_post_134 from "./api/fleet/[id]/prestarts/POST";
import _h_fleet_id_service_logs_get_135 from "./api/fleet/[id]/service-logs/GET";
import _h_fleet_id_service_logs_post_136 from "./api/fleet/[id]/service-logs/POST";
...
import _h_integrations_myob_auth_url_get_151 from "./api/integrations/myob/auth-url/GET";
import _h_integrations_myob_callback_get_152 from "./api/integrations/myob/callback/GET";
import _h_integrations_myob_disconnect_post_153 from "./api/integrations/myob/disconnect/POST";
import _h_integrations_myob_status_get_154 from "./api/integrations/myob/status/GET";
import _h_integrations_myob_sync_invoice_post_155 from "./api/integrations/myob/sync-invoice/POST";
import _h_integrations_onedrive_auth_url_get_156 from "./api/integrations/onedrive/auth-url/GET";
import _h_integrations_onedrive_callback_get_157 from "./api/integrations/onedrive/callback/GET";
import _h_integrations_onedrive_disconnect_post_158 from "./api/integrations/onedrive/disconnect/POST";
import _h_integrations_onedrive_status_get_159 from "./api/integrations/onedrive/status/GET";
import _h_integrations_onedrive_upload_file_post_160 from "./api/integrations/onedrive/upload-file/POST";
import _h_integrations_qbo_auth_url_get_161 from "./api/integrations/qbo/auth-url/GET";
import _h_integrations_qbo_callback_get_162 from "./api/integrations/qbo/callback/GET";
import _h_integrations_qbo_disconnect_post_163 from "./api/integrations/qbo/disconnect/POST";
import _h_integrations_qbo_status_get_164 from "./api/integrations/qbo/status/GET";
import _h_integrations_qbo_sync_invoice_post_165 from "./api/integrations/qbo/sync-invoice/POST";
import _h_integrations_xero_auth_url_get_166 from "./api/integrations/xero/auth-url/GET";
import _h_integrations_xero_callback_get_167 from "./api/integrations/xero/callback/GET";
import _h_integrations_xero_disconnect_post_168 from "./api/integrations/xero/disconnect/POST";
import _h_integrations_xero_status_get_169 from "./api/integrations/xero/status/GET";
import _h_integrations_xero_sync_customer_post_170 from "./api/integrations/xero/sync-customer/POST";
import _h_integrations_xero_sync_invoice_post_171 from "./api/integrations/xero/sync-invoice/POST";
import _h_integrations_xero_webhook_post_172 from "./api/integrations/xero/webhook/POST";
...
import _h_jobs_get_190 from "./api/jobs/GET";
import _h_jobs_post_191 from "./api/jobs/POST";
import _h_jobs_id_get_192 from "./api/jobs/[id]/GET";
import _h_jobs_id_put_193 from "./api/jobs/[id]/PUT";
import _h_jobs_id_costs_get_194 from "./api/jobs/[id]/costs/GET";
import _h_jobs_id_costs_post_195 from "./api/jobs/[id]/costs/POST";
import _h_jobs_id_costs_export_get_196 from "./api/jobs/[id]/costs/export/GET";
import _h_jobs_id_costs_costid_delete_197 from "./api/jobs/[id]/costs/[costId]/DELETE";
import _h_jobs_id_costs_costid_put_198 from "./api/jobs/[id]/costs/[costId]/PUT";
import _h_jobs_id_costs_costid_receipt_get_199 from "./api/jobs/[id]/costs/[costId]/receipt/GET";
import _h_jobs_id_costs_costid_receipt_post_200 from "./api/jobs/[id]/costs/[costId]/receipt/POST";
import _h_jobs_id_delays_get_201 from "./api/jobs/[id]/delays/GET";
import _h_jobs_id_delays_post_202 from "./api/jobs/[id]/delays/POST";
import _h_jobs_id_delays_delayid_delete_203 from "./api/jobs/[id]/delays/[delayId]/DELETE";
import _h_jobs_id_delays_delayid_put_204 from "./api/jobs/[id]/delays/[delayId]/PUT";
import _h_jobs_id_files_get_205 from "./api/jobs/[id]/files/GET";
import _h_jobs_id_forms_get_206 from "./api/jobs/[id]/forms/GET";
import _h_jobs_id_forms_post_207 from "./api/jobs/[id]/forms/POST";
import _h_jobs_id_ledger_get_208 from "./api/jobs/[id]/ledger/GET";
import _h_jobs_id_ledger_post_209 from "./api/jobs/[id]/ledger/POST";
import _h_jobs_id_ledger_export_get_210 from "./api/jobs/[id]/ledger/export/GET";
import _h_jobs_id_ledger_sync_post_211 from "./api/jobs/[id]/ledger/sync/POST";
import _h_jobs_id_ledger_entryid_delete_212 from "./api/jobs/[id]/ledger/[entryId]/DELETE";
import _h_jobs_id_ledger_entryid_put_213 from "./api/jobs/[id]/ledger/[entryId]/PUT";
import _h_jobs_id_ledger_entryid_correct_post_214 from "./api/jobs/[id]/ledger/[entryId]/correct/POST";
import _h_jobs_id_photos_get_215 from "./api/jobs/[id]/photos/GET";
import _h_jobs_id_photos_post_216 from "./api/jobs/[id]/photos/POST";
import _h_jobs_id_photos_photoid_delete_217 from "./api/jobs/[id]/photos/[photoId]/DELETE";
import _h_jobs_id_photos_photoid_patch_218 from "./api/jobs/[id]/photos/[photoId]/PATCH";
import _h_jobs_id_photos_photoid_download_get_219 from "./api/jobs/[id]/photos/[photoId]/download/GET";
import _h_jobs_id_photos_photoid_replace_post_220 from "./api/jobs/[id]/photos/[photoId]/replace/POST";
import _h_jobs_id_progress_get_221 from "./api/jobs/[id]/progress/GET";
import _h_jobs_id_progress_put_222 from "./api/jobs/[id]/progress/PUT";
import _h_jobs_id_progress_sync_post_223 from "./api/jobs/[id]/progress/sync/POST";
import _h_jobs_id_purchase_orders_get_224 from "./api/jobs/[id]/purchase-orders/GET";
import _h_jobs_id_purchase_orders_post_225 from "./api/jobs/[id]/purchase-orders/POST";
import _h_jobs_id_purchase_orders_poid_delete_226 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import _h_jobs_id_purchase_orders_poid_get_227 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
import _h_jobs_id_purchase_orders_poid_put_228 from "./api/jobs/[id]/purchase-orders/[poId]/PUT";
import _h_jobs_id_purchase_orders_poid_pdf_get_229 from "./api/jobs/[id]/purchase-orders/[poId]/pdf/GET";
import _h_jobs_id_swms_get_230 from "./api/jobs/[id]/swms/GET";
import _h_jobs_id_swms_post_231 from "./api/jobs/[id]/swms/POST";
import _h_jobs_id_swms_swmsid_signoff_post_232 from "./api/jobs/[id]/swms/[swmsId]/signoff/POST";
import _h_jobs_id_todos_get_233 from "./api/jobs/[id]/todos/GET";
import _h_jobs_id_todos_post_234 from "./api/jobs/[id]/todos/POST";
import _h_jobs_id_todos_todoid_delete_235 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import _h_jobs_id_todos_todoid_put_236 from "./api/jobs/[id]/todos/[todoId]/PUT";
...
import _h_safety_ai_draft_post_315 from "./api/safety/ai/draft/POST";
import _h_safety_documents_get_316 from "./api/safety/documents/GET";
import _h_safety_documents_post_317 from "./api/safety/documents/POST";
import _h_safety_documents_id_delete_318 from "./api/safety/documents/[id]/DELETE";
import _h_safety_documents_id_download_get_319 from "./api/safety/documents/[id]/download/GET";
import _h_safety_generated_posters_get_320 from "./api/safety/generated-posters/GET";
import _h_safety_generated_posters_post_321 from "./api/safety/generated-posters/POST";
import _h_safety_generated_posters_id_delete_322 from "./api/safety/generated-posters/[id]/DELETE";
import _h_safety_job_safety_plans_get_323 from "./api/safety/job-safety-plans/GET";
import _h_safety_job_safety_plans_post_324 from "./api/safety/job-safety-plans/POST";
import _h_safety_job_safety_plans_id_delete_325 from "./api/safety/job-safety-plans/[id]/DELETE";
import _h_safety_job_safety_plans_id_put_326 from "./api/safety/job-safety-plans/[id]/PUT";
import _h_safety_job_swms_get_327 from "./api/safety/job-swms/GET";
import _h_safety_job_swms_post_328 from "./api/safety/job-swms/POST";
import _h_safety_job_swms_id_delete_329 from "./api/safety/job-swms/[id]/DELETE";
import _h_safety_job_swms_id_get_330 from "./api/safety/job-swms/[id]/GET";
import _h_safety_job_swms_id_put_331 from "./api/safety/job-swms/[id]/PUT";
import _h_safety_job_swms_id_share_token_post_332 from "./api/safety/job-swms/[id]/share-token/POST";
import _h_safety_job_swms_id_signoffs_get_333 from "./api/safety/job-swms/[id]/signoffs/GET";
import _h_safety_job_swms_id_signoffs_post_334 from "./api/safety/job-swms/[id]/signoffs/POST";
import _h_safety_job_swms_id_signoffs_signoffid_delete_335 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import _h_safety_plans_get_336 from "./api/safety/plans/GET";
import _h_safety_plans_post_337 from "./api/safety/plans/POST";
import _h_safety_plans_seed_post_338 from "./api/safety/plans/seed/POST";
import _h_safety_plans_id_delete_339 from "./api/safety/plans/[id]/DELETE";
import _h_safety_plans_id_put_340 from "./api/safety/plans/[id]/PUT";
import _h_safety_plans_id_export_get_341 from "./api/safety/plans/[id]/export/GET";
import _h_safety_plans_id_pack_get_342 from "./api/safety/plans/[id]/pack/GET";
import _h_safety_posters_get_343 from "./api/safety/posters/GET";
import _h_safety_posters_post_344 from "./api/safety/posters/POST";
import _h_safety_posters_id_delete_345 from "./api/safety/posters/[id]/DELETE";
import _h_safety_swms_get_346 from "./api/safety/swms/GET";
import _h_safety_swms_post_347 from "./api/safety/swms/POST";
import _h_safety_swms_seed_post_348 from "./api/safety/swms/seed/POST";
import _h_safety_swms_id_delete_349 from "./api/safety/swms/[id]/DELETE";
import _h_safety_swms_id_get_350 from "./api/safety/swms/[id]/GET";
import _h_safety_swms_id_put_351 from "./api/safety/swms/[id]/PUT";
import _h_safety_swms_id_duplicate_post_352 from "./api/safety/swms/[id]/duplicate/POST";
import _h_safety_swms_id_export_get_353 from "./api/safety/swms/[id]/export/GET";
...
import _h_settings_backup_get_362 from "./api/settings/backup/GET";
import _h_settings_backup_post_363 from "./api/settings/backup/POST";
import _h_settings_backup_export_get_364 from "./api/settings/backup/export/GET";
import _h_settings_backup_run_post_365 from "./api/settings/backup/run/POST";
import _h_settings_backup_destination_get_366 from "./api/settings/backup-destination/GET";
import _h_settings_backup_destination_post_367 from "./api/settings/backup-destination/POST";
import _h_settings_dazza_ai_key_get_368 from "./api/settings/dazza-ai-key/GET";
import _h_settings_dazza_ai_key_post_369 from "./api/settings/dazza-ai-key/POST";
import _h_settings_file_transfer_backup_get_370 from "./api/settings/file-transfer-backup/GET";
import _h_settings_file_transfer_backup_post_371 from "./api/settings/file-transfer-backup/POST";
import _h_settings_retention_get_372 from "./api/settings/retention/GET";
import _h_settings_retention_post_373 from "./api/settings/retention/POST";
import _h_settings_storage_provider_get_374 from "./api/settings/storage-provider/GET";
import _h_settings_storage_provider_debug_get_375 from "./api/settings/storage-provider/debug/GET";
import _h_settings_storage_provider_test_post_376 from "./api/settings/storage-provider/test/POST";
import _h_settings_terminology_get_377 from "./api/settings/terminology/GET";
import _h_settings_terminology_post_378 from "./api/settings/terminology/POST";
import _h_settings_xero_credentials_get_379 from "./api/settings/xero-credentials/GET";
import _h_settings_xero_credentials_post_380 from "./api/settings/xero-credentials/POST";
...
app.get("/api/developer/activity-log", _h_developer_activity_log_get_61);
app.get("/api/developer/audit-log", _h_developer_audit_log_get_62);
app.post("/api/developer/companies/:id/archive", _h_developer_companies_id_archive_post_63);
app.get("/api/developer/company-health", _h_developer_company_health_get_64);
app.get("/api/developer/email-log", _h_developer_email_log_get_65);
app.get("/api/developer/email-settings", _h_developer_email_settings_get_66);
app.put("/api/developer/email-settings", _h_developer_email_settings_put_67);
app.post("/api/developer/email-settings/test", _h_developer_email_settings_test_post_68);
app.get("/api/developer/support-notes", _h_developer_support_notes_get_69);
app.post("/api/developer/support-notes", _h_developer_support_notes_post_70);
app.delete("/api/developer/support-notes/:id", _h_developer_support_notes_id_delete_71);
app.post("/api/developer/users/:id/assign-company", _h_developer_users_id_assign_company_post_72);
app.post("/api/developer/users/:id/deactivate", _h_developer_users_id_deactivate_post_73);
app.post("/api/developer/users/:id/delete-orphan", _h_developer_users_id_delete_orphan_post_74);
app.post("/api/developer/users/:id/force-temp-password", _h_developer_users_id_force_temp_password_post_75);
app.delete("/api/developer/users/:id/impersonate", _h_developer_users_id_impersonate_delete_76);
app.post("/api/developer/users/:id/impersonate", _h_developer_users_id_impersonate_post_77);
app.post("/api/developer/users/:id/reactivate", _h_developer_users_id_reactivate_post_78);
app.post("/api/developer/users/:id/resend-verification", _h_developer_users_id_resend_verification_post_79);
app.put("/api/developer/users/:id/role", _h_developer_users_id_role_put_80);
app.post("/api/developer/users/:id/send-reset-email", _h_developer_users_id_send_reset_email_post_81);
app.delete("/api/developer/users/:id/sessions", _h_developer_users_id_sessions_delete_82);
app.get("/api/developer/users/:id/sessions", _h_developer_users_id_sessions_get_83);
app.post("/api/developer/users/:id/unlock-account", _h_developer_users_id_unlock_account_post_84);
...
app.get("/api/fleet", _h_fleet_get_119);
app.post("/api/fleet", _h_fleet_post_120);
app.post("/api/fleet/driver-sessions", _h_fleet_driver_sessions_post_121);
app.get("/api/fleet/driver-sessions/active", _h_fleet_driver_sessions_active_get_122);
app.post("/api/fleet/driver-sessions/:id/stop", _h_fleet_driver_sessions_id_stop_post_123);
app.get("/api/fleet/flags", _h_fleet_flags_get_124);
app.delete("/api/fleet/service-logs/:logId", _h_fleet_service_logs_logid_delete_125);
app.patch("/api/fleet/service-logs/:logId", _h_fleet_service_logs_logid_patch_126);
app.get("/api/fleet/vehicles", _h_fleet_vehicles_get_127);
app.delete("/api/fleet/:id", _h_fleet_id_delete_128);
app.get("/api/fleet/:id", _h_fleet_id_get_129);
app.put("/api/fleet/:id", _h_fleet_id_put_130);
app.get("/api/fleet/:id/driver-sessions", _h_fleet_id_driver_sessions_get_131);
app.get("/api/fleet/:id/files", _h_fleet_id_files_get_132);
app.get("/api/fleet/:id/prestarts", _h_fleet_id_prestarts_get_133);
app.post("/api/fleet/:id/prestarts", _h_fleet_id_prestarts_post_134);
app.get("/api/fleet/:id/service-logs", _h_fleet_id_service_logs_get_135);
app.post("/api/fleet/:id/service-logs", _h_fleet_id_service_logs_post_136);
...
app.get("/api/integrations/myob/auth-url", _h_integrations_myob_auth_url_get_151);
app.get("/api/integrations/myob/callback", _h_integrations_myob_callback_get_152);
app.post("/api/integrations/myob/disconnect", _h_integrations_myob_disconnect_post_153);
app.get("/api/integrations/myob/status", _h_integrations_myob_status_get_154);
app.post("/api/integrations/myob/sync-invoice", _h_integrations_myob_sync_invoice_post_155);
app.get("/api/integrations/onedrive/auth-url", _h_integrations_onedrive_auth_url_get_156);
app.get("/api/integrations/onedrive/callback", _h_integrations_onedrive_callback_get_157);
app.post("/api/integrations/onedrive/disconnect", _h_integrations_onedrive_disconnect_post_158);
app.get("/api/integrations/onedrive/status", _h_integrations_onedrive_status_get_159);
app.post("/api/integrations/onedrive/upload-file", _h_integrations_onedrive_upload_file_post_160);
app.get("/api/integrations/qbo/auth-url", _h_integrations_qbo_auth_url_get_161);
app.get("/api/integrations/qbo/callback", _h_integrations_qbo_callback_get_162);
app.post("/api/integrations/qbo/disconnect", _h_integrations_qbo_disconnect_post_163);
app.get("/api/integrations/qbo/status", _h_integrations_qbo_status_get_164);
app.post("/api/integrations/qbo/sync-invoice", _h_integrations_qbo_sync_invoice_post_165);
app.get("/api/integrations/xero/auth-url", _h_integrations_xero_auth_url_get_166);
app.get("/api/integrations/xero/callback", _h_integrations_xero_callback_get_167);
app.post("/api/integrations/xero/disconnect", _h_integrations_xero_disconnect_post_168);
app.get("/api/integrations/xero/status", _h_integrations_xero_status_get_169);
app.post("/api/integrations/xero/sync-customer", _h_integrations_xero_sync_customer_post_170);
app.post("/api/integrations/xero/sync-invoice", _h_integrations_xero_sync_invoice_post_171);
app.post("/api/integrations/xero/webhook", _h_integrations_xero_webhook_post_172);
...
app.get("/api/jobs", _h_jobs_get_190);
app.post("/api/jobs", _h_jobs_post_191);
app.get("/api/jobs/:id", _h_jobs_id_get_192);
app.put("/api/jobs/:id", _h_jobs_id_put_193);
app.get("/api/jobs/:id/costs", _h_jobs_id_costs_get_194);
app.post("/api/jobs/:id/costs", _h_jobs_id_costs_post_195);
app.get("/api/jobs/:id/costs/export", _h_jobs_id_costs_export_get_196);
app.delete("/api/jobs/:id/costs/:costId", _h_jobs_id_costs_costid_delete_197);
app.put("/api/jobs/:id/costs/:costId", _h_jobs_id_costs_costid_put_198);
app.get("/api/jobs/:id/costs/:costId/receipt", _h_jobs_id_costs_costid_receipt_get_199);
app.post("/api/jobs/:id/costs/:costId/receipt", _h_jobs_id_costs_costid_receipt_post_200);
app.get("/api/jobs/:id/delays", _h_jobs_id_delays_get_201);
app.post("/api/jobs/:id/delays", _h_jobs_id_delays_post_202);
app.delete("/api/jobs/:id/delays/:delayId", _h_jobs_id_delays_delayid_delete_203);
app.put("/api/jobs/:id/delays/:delayId", _h_jobs_id_delays_delayid_put_204);
app.get("/api/jobs/:id/files", _h_jobs_id_files_get_205);
app.get("/api/jobs/:id/forms", _h_jobs_id_forms_get_206);
app.post("/api/jobs/:id/forms", _h_jobs_id_forms_post_207);
app.get("/api/jobs/:id/ledger", _h_jobs_id_ledger_get_208);
app.post("/api/jobs/:id/ledger", _h_jobs_id_ledger_post_209);
app.get("/api/jobs/:id/ledger/export", _h_jobs_id_ledger_export_get_210);
app.post("/api/jobs/:id/ledger/sync", _h_jobs_id_ledger_sync_post_211);
app.delete("/api/jobs/:id/ledger/:entryId", _h_jobs_id_ledger_entryid_delete_212);
app.put("/api/jobs/:id/ledger/:entryId", _h_jobs_id_ledger_entryid_put_213);
app.post("/api/jobs/:id/ledger/:entryId/correct", _h_jobs_id_ledger_entryid_correct_post_214);
app.get("/api/jobs/:id/photos", _h_jobs_id_photos_get_215);
app.post("/api/jobs/:id/photos", _h_jobs_id_photos_post_216);
app.delete("/api/jobs/:id/photos/:photoId", _h_jobs_id_photos_photoid_delete_217);
app.patch("/api/jobs/:id/photos/:photoId", _h_jobs_id_photos_photoid_patch_218);
app.get("/api/jobs/:id/photos/:photoId/download", _h_jobs_id_photos_photoid_download_get_219);
app.post("/api/jobs/:id/photos/:photoId/replace", _h_jobs_id_photos_photoid_replace_post_220);
app.get("/api/jobs/:id/progress", _h_jobs_id_progress_get_221);
app.put("/api/jobs/:id/progress", _h_jobs_id_progress_put_222);
app.post("/api/jobs/:id/progress/sync", _h_jobs_id_progress_sync_post_223);
app.get("/api/jobs/:id/purchase-orders", _h_jobs_id_purchase_orders_get_224);
app.post("/api/jobs/:id/purchase-orders", _h_jobs_id_purchase_orders_post_225);
app.delete("/api/jobs/:id/purchase-orders/:poId", _h_jobs_id_purchase_orders_poid_delete_226);
app.get("/api/jobs/:id/purchase-orders/:poId", _h_jobs_id_purchase_orders_poid_get_227);
app.put("/api/jobs/:id/purchase-orders/:poId", _h_jobs_id_purchase_orders_poid_put_228);
app.get("/api/jobs/:id/purchase-orders/:poId/pdf", _h_jobs_id_purchase_orders_poid_pdf_get_229);
app.get("/api/jobs/:id/swms", _h_jobs_id_swms_get_230);
app.post("/api/jobs/:id/swms", _h_jobs_id_swms_post_231);
app.post("/api/jobs/:id/swms/:swmsId/signoff", _h_jobs_id_swms_swmsid_signoff_post_232);
app.get("/api/jobs/:id/todos", _h_jobs_id_todos_get_233);
app.post("/api/jobs/:id/todos", _h_jobs_id_todos_post_234);
app.delete("/api/jobs/:id/todos/:todoId", _h_jobs_id_todos_todoid_delete_235);
app.put("/api/jobs/:id/todos/:todoId", _h_jobs_id_todos_todoid_put_236);
...
app.post("/api/safety/ai/draft", _h_safety_ai_draft_post_315);
app.get("/api/safety/documents", _h_safety_documents_get_316);
app.post("/api/safety/documents", _h_safety_documents_post_317);
app.delete("/api/safety/documents/:id", _h_safety_documents_id_delete_318);
app.get("/api/safety/documents/:id/download", _h_safety_documents_id_download_get_319);
app.get("/api/safety/generated-posters", _h_safety_generated_posters_get_320);
app.post("/api/safety/generated-posters", _h_safety_generated_posters_post_321);
app.delete("/api/safety/generated-posters/:id", _h_safety_generated_posters_id_delete_322);
app.get("/api/safety/job-safety-plans", _h_safety_job_safety_plans_get_323);
app.post("/api/safety/job-safety-plans", _h_safety_job_safety_plans_post_324);
app.delete("/api/safety/job-safety-plans/:id", _h_safety_job_safety_plans_id_delete_325);
app.put("/api/safety/job-safety-plans/:id", _h_safety_job_safety_plans_id_put_326);
app.get("/api/safety/job-swms", _h_safety_job_swms_get_327);
app.post("/api/safety/job-swms", _h_safety_job_swms_post_328);
app.delete("/api/safety/job-swms/:id", _h_safety_job_swms_id_delete_329);
app.get("/api/safety/job-swms/:id", _h_safety_job_swms_id_get_330);
app.put("/api/safety/job-swms/:id", _h_safety_job_swms_id_put_331);
app.post("/api/safety/job-swms/:id/share-token", _h_safety_job_swms_id_share_token_post_332);
app.get("/api/safety/job-swms/:id/signoffs", _h_safety_job_swms_id_signoffs_get_333);
app.post("/api/safety/job-swms/:id/signoffs", _h_safety_job_swms_id_signoffs_post_334);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", _h_safety_job_swms_id_signoffs_signoffid_delete_335);
app.get("/api/safety/plans", _h_safety_plans_get_336);
app.post("/api/safety/plans", _h_safety_plans_post_337);
app.post("/api/safety/plans/seed", _h_safety_plans_seed_post_338);
app.delete("/api/safety/plans/:id", _h_safety_plans_id_delete_339);
app.put("/api/safety/plans/:id", _h_safety_plans_id_put_340);
app.get("/api/safety/plans/:id/export", _h_safety_plans_id_export_get_341);
app.get("/api/safety/plans/:id/pack", _h_safety_plans_id_pack_get_342);
app.get("/api/safety/posters", _h_safety_posters_get_343);
app.post("/api/safety/posters", _h_safety_posters_post_344);
app.delete("/api/safety/posters/:id", _h_safety_posters_id_delete_345);
app.get("/api/safety/swms", _h_safety_swms_get_346);
app.post("/api/safety/swms", _h_safety_swms_post_347);
app.post("/api/safety/swms/seed", _h_safety_swms_seed_post_348);
app.delete("/api/safety/swms/:id", _h_safety_swms_id_delete_349);
app.get("/api/safety/swms/:id", _h_safety_swms_id_get_350);
app.put("/api/safety/swms/:id", _h_safety_swms_id_put_351);
app.post("/api/safety/swms/:id/duplicate", _h_safety_swms_id_duplicate_post_352);
app.get("/api/safety/swms/:id/export", _h_safety_swms_id_export_get_353);
...
app.get("/api/settings/backup", _h_settings_backup_get_362);
app.post("/api/settings/backup", _h_settings_backup_post_363);
app.get("/api/settings/backup/export", _h_settings_backup_export_get_364);
app.post("/api/settings/backup/run", _h_settings_backup_run_post_365);
app.get("/api/settings/backup-destination", _h_settings_backup_destination_get_366);
app.post("/api/settings/backup-destination", _h_settings_backup_destination_post_367);
app.get("/api/settings/dazza-ai-key", _h_settings_dazza_ai_key_get_368);
app.post("/api/settings/dazza-ai-key", _h_settings_dazza_ai_key_post_369);
app.get("/api/settings/file-transfer-backup", _h_settings_file_transfer_backup_get_370);
app.post("/api/settings/file-transfer-backup", _h_settings_file_transfer_backup_post_371);
app.get("/api/settings/retention", _h_settings_retention_get_372);
app.post("/api/settings/retention", _h_settings_retention_post_373);
app.get("/api/settings/storage-provider", _h_settings_storage_provider_get_374);
app.get("/api/settings/storage-provider/debug", _h_settings_storage_provider_debug_get_375);
app.post("/api/settings/storage-provider/test", _h_settings_storage_provider_test_post_376);
app.get("/api/settings/terminology", _h_settings_terminology_get_377);
app.post("/api/settings/terminology", _h_settings_terminology_post_378);
app.get("/api/settings/xero-credentials", _h_settings_xero_credentials_get_379);
app.post("/api/settings/xero-credentials", _h_settings_xero_credentials_post_380);
