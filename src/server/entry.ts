...
import _h_migrate_job_photos_post_32 from "./api/migrate-job-photos/POST";
import _h_migrate_job_tabs_post_33 from "./api/migrate-job-tabs/POST";
import _h_migrate_jobs_post_34 from "./api/migrate-jobs/POST";
import _h_migrate_library_post_35 from "./api/migrate-library/POST";
import _h_migrate_library_downloads_post_36 from "./api/migrate-library-downloads/POST";
import _h_migrate_notifications_post_37 from "./api/migrate-notifications/POST";
import _h_migrate_owner_console_post_38 from "./api/migrate-owner-console/POST";
import _h_migrate_owner_role_post_39 from "./api/migrate-owner-role/POST";
import _h_migrate_pdf_settings_post_40 from "./api/migrate-pdf-settings/POST";
import _h_migrate_plan_manager_post_41 from "./api/migrate-plan-manager/POST";
import _h_migrate_plan_manager_v2_post_42 from "./api/migrate-plan-manager-v2/POST";
import _h_migrate_plan_manager_v3_post_43 from "./api/migrate-plan-manager-v3/POST";
import _h_migrate_safety_post_44 from "./api/migrate-safety/POST";
import _h_migrate_starter_pack_post_45 from "./api/migrate-starter-pack/POST";
import _h_migrate_studio_pdf_post_46 from "./api/migrate-studio-pdf/POST";
import _h_migrate_subscriptions_post_47 from "./api/migrate-subscriptions/POST";
import _h_migrate_support_mode_post_48 from "./api/migrate-support-mode/POST";
import _h_migrate_takeoff_pad_post_49 from "./api/migrate-takeoff-pad/POST";
import _h_migrate_team_post_50 from "./api/migrate-team/POST";
import _h_notifications_alerts_get_51 from "./api/notifications/alerts/GET";
import _h_owner_console_system_ai_builtin_checks_post_52 from "./api/owner-console/system-ai/builtin-checks/POST";
...
app.post("/api/migrate-job-photos", _h_migrate_job_photos_post_32);
app.post("/api/migrate-job-tabs", _h_migrate_job_tabs_post_33);
app.post("/api/migrate-jobs", _h_migrate_jobs_post_34);
app.post("/api/migrate-library", _h_migrate_library_post_35);
app.post("/api/migrate-library-downloads", _h_migrate_library_downloads_post_36);
app.post("/api/migrate-notifications", _h_migrate_notifications_post_37);
app.post("/api/migrate-owner-console", _h_migrate_owner_console_post_38);
app.post("/api/migrate-owner-role", _h_migrate_owner_role_post_39);
app.post("/api/migrate-pdf-settings", _h_migrate_pdf_settings_post_40);
app.post("/api/migrate-plan-manager", _h_migrate_plan_manager_post_41);
app.post("/api/migrate-plan-manager-v2", _h_migrate_plan_manager_v2_post_42);
app.post("/api/migrate-plan-manager-v3", _h_migrate_plan_manager_v3_post_43);
app.post("/api/migrate-safety", _h_migrate_safety_post_44);
app.post("/api/migrate-starter-pack", _h_migrate_starter_pack_post_45);
app.post("/api/migrate-studio-pdf", _h_migrate_studio_pdf_post_46);
app.post("/api/migrate-subscriptions", _h_migrate_subscriptions_post_47);
app.post("/api/migrate-support-mode", _h_migrate_support_mode_post_48);
app.post("/api/migrate-takeoff-pad", _h_migrate_takeoff_pad_post_49);
app.post("/api/migrate-team", _h_migrate_team_post_50);
...
app.get("/api/notifications/alerts", _h_notifications_alerts_get_51);
...
app.post("/api/owner-console/system-ai/builtin-checks", _h_owner_console_system_ai_builtin_checks_post_52);
