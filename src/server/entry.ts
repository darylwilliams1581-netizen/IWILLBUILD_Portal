...
import _h_migrate_ledger_photo_post_35 from "./api/migrate-ledger-photo/POST";
import _h_migrate_job_photo_shares_post_36 from "./api/migrate-job-photo-shares/POST";
...
import _h_migrate_starter_pack_post_47 from "./api/migrate-starter-pack/POST";
import _h_migrate_studio_pdf_post_48 from "./api/migrate-studio-pdf/POST";
import _h_migrate_subscriptions_post_49 from "./api/migrate-subscriptions/POST";
import _h_migrate_support_mode_post_50 from "./api/migrate-support-mode/POST";
import _h_migrate_takeoff_pad_post_51 from "./api/migrate-takeoff-pad/POST";
import _h_migrate_team_post_52 from "./api/migrate-team/POST";
import _h_notifications_alerts_get_53 from "./api/notifications/alerts/GET";
import _h_owner_console_system_ai_builtin_checks_post_54 from "./api/owner-console/system-ai/builtin-checks/POST";
...
import invoices_id_send_email_post from "./api/invoices/[id]/send-email/POST";
...
import jobs_id_site_prestarts_get from "./api/jobs/[id]/site-prestarts/GET";
import jobs_id_site_prestarts_post from "./api/jobs/[id]/site-prestarts/POST";
import jobs_id_site_prestarts_id_get from "./api/jobs/[id]/site-prestarts/[prestartId]/GET";
import jobs_id_site_prestarts_id_put from "./api/jobs/[id]/site-prestarts/[prestartId]/PUT";
...
import library_items_id_install_delete_333 from "./api/library/items/[id]/install/DELETE";
...
app.post("/api/invoices/:id/send-email", invoices_id_send_email_post);
...
app.get("/api/jobs/:id/site-prestarts", jobs_id_site_prestarts_get);
app.post("/api/jobs/:id/site-prestarts", jobs_id_site_prestarts_post);
app.get("/api/jobs/:id/site-prestarts/:prestartId", jobs_id_site_prestarts_id_get);
app.put("/api/jobs/:id/site-prestarts/:prestartId", jobs_id_site_prestarts_id_put);
...
app.delete("/api/library/items/:id/install", library_items_id_install_delete_333);
...
app.post("/api/migrate-ledger-photo", _h_migrate_ledger_photo_post_35);
app.post("/api/migrate-job-photo-shares", _h_migrate_job_photo_shares_post_36);
...
app.post("/api/migrate-starter-pack", _h_migrate_starter_pack_post_47);
app.post("/api/migrate-studio-pdf", _h_migrate_studio_pdf_post_48);
app.post("/api/migrate-subscriptions", _h_migrate_subscriptions_post_49);
app.post("/api/migrate-support-mode", _h_migrate_support_mode_post_50);
app.post("/api/migrate-takeoff-pad", _h_migrate_takeoff_pad_post_51);
app.post("/api/migrate-team", _h_migrate_team_post_52);
...
app.get("/api/notifications/alerts", _h_notifications_alerts_get_53);
...
app.post("/api/owner-console/system-ai/builtin-checks", _h_owner_console_system_ai_builtin_checks_post_54);
