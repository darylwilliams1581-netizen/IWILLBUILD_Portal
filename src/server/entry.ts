...
import documents_get_83 from "./api/documents/GET";
import documents_share_token_get_84 from "./api/documents/share/[token]/GET";
import documents_share_token_post_85 from "./api/documents/share/[token]/POST";
import documents_id_get_86 from "./api/documents/[id]/GET";
import documents_id_put_87 from "./api/documents/[id]/PUT";
import documents_id_events_get_88 from "./api/documents/[id]/events/GET";
import documents_id_share_delete_89 from "./api/documents/[id]/share/DELETE";
import documents_id_share_post_90 from "./api/documents/[id]/share/POST";
import drawings_get_91 from "./api/drawings/GET";
import drawings_post_92 from "./api/drawings/POST";
import drawings_upload_post_93 from "./api/drawings/upload/POST";
import drawings_id_delete_94 from "./api/drawings/[id]/DELETE";
import drawings_id_patch_95 from "./api/drawings/[id]/PATCH";
import drawings_id_markup_post_96 from "./api/drawings/[id]/markup/POST";
import estimates_get_97 from "./api/estimates/GET";
import estimates_post_98 from "./api/estimates/POST";
import estimates_id_delete_99 from "./api/estimates/[id]/DELETE";
import estimates_id_get_100 from "./api/estimates/[id]/GET";
import estimates_id_put_101 from "./api/estimates/[id]/PUT";
import estimates_id_export_csv_get_102 from "./api/estimates/[id]/export-csv/GET";
import estimates_id_import_csv_post_103 from "./api/estimates/[id]/import-csv/POST";
import external_form_token_get_104 from "./api/external/form/[token]/GET";
import external_form_token_post_105 from "./api/external/form/[token]/POST";
import files_get_106 from "./api/files/GET";
import files_post_107 from "./api/files/POST";
import files_id_delete_108 from "./api/files/[id]/DELETE";
import files_id_download_get_109 from "./api/files/[id]/download/GET";
import fleet_get_110 from "./api/fleet/GET";
import fleet_post_111 from "./api/fleet/POST";
import fleet_driver_sessions_post_112 from "./api/fleet/driver-sessions/POST";
import fleet_driver_sessions_active_get_113 from "./api/fleet/driver-sessions/active/GET";
import fleet_driver_sessions_id_stop_post_114 from "./api/fleet/driver-sessions/[id]/stop/POST";
import fleet_flags_get_115 from "./api/fleet/flags/GET";
import fleet_vehicles_get_116 from "./api/fleet/vehicles/GET";
import fleet_id_delete_117 from "./api/fleet/[id]/DELETE";
import fleet_id_get_118 from "./api/fleet/[id]/GET";
import fleet_id_put_119 from "./api/fleet/[id]/PUT";
import fleet_id_driver_sessions_get_120 from "./api/fleet/[id]/driver-sessions/GET";
import fleet_id_files_get_121 from "./api/fleet/[id]/files/GET";
import fleet_id_prestarts_get_122 from "./api/fleet/[id]/prestarts/GET";
import fleet_id_prestarts_post_123 from "./api/fleet/[id]/prestarts/POST";
import form_templates_get_124 from "./api/form-templates/GET";
import form_templates_post_125 from "./api/form-templates/POST";
import form_templates_seed_post_126 from "./api/form-templates/seed/POST";
import form_templates_id_delete_127 from "./api/form-templates/[id]/DELETE";
import form_templates_id_put_128 from "./api/form-templates/[id]/PUT";
import forms_id_fields_get_129 from "./api/forms/[id]/fields/GET";
import forms_id_fields_post_130 from "./api/forms/[id]/fields/POST";
import forms_id_fields_reorder_post_131 from "./api/forms/[id]/fields/reorder/POST";
import forms_id_fields_fieldId_delete_132 from "./api/forms/[id]/fields/[fieldId]/DELETE";
import forms_id_fields_fieldId_patch_133 from "./api/forms/[id]/fields/[fieldId]/PATCH";
import forms_id_fields_fieldId_thumbnail_post_134 from "./api/forms/[id]/fields/[fieldId]/thumbnail/POST";
import health_get_135 from "./api/health/GET";
import integrations_myob_auth_url_get_136 from "./api/integrations/myob/auth-url/GET";
import integrations_myob_callback_get_137 from "./api/integrations/myob/callback/GET";
import integrations_myob_disconnect_post_138 from "./api/integrations/myob/disconnect/POST";
import integrations_myob_status_get_139 from "./api/integrations/myob/status/GET";
import integrations_myob_sync_invoice_post_140 from "./api/integrations/myob/sync-invoice/POST";
import integrations_onedrive_auth_url_get_141 from "./api/integrations/onedrive/auth-url/GET";
import integrations_onedrive_callback_get_142 from "./api/integrations/onedrive/callback/GET";
import integrations_onedrive_disconnect_post_143 from "./api/integrations/onedrive/disconnect/POST";
import integrations_onedrive_status_get_144 from "./api/integrations/onedrive/status/GET";
import integrations_onedrive_upload_file_post_145 from "./api/integrations/onedrive/upload-file/POST";
import integrations_qbo_auth_url_get_146 from "./api/integrations/qbo/auth-url/GET";
import integrations_qbo_callback_get_147 from "./api/integrations/qbo/callback/GET";
import integrations_qbo_disconnect_post_148 from "./api/integrations/qbo/disconnect/POST";
import integrations_qbo_status_get_149 from "./api/integrations/qbo/status/GET";
import integrations_qbo_sync_invoice_post_150 from "./api/integrations/qbo/sync-invoice/POST";
import integrations_xero_auth_url_get_151 from "./api/integrations/xero/auth-url/GET";
import integrations_xero_callback_get_152 from "./api/integrations/xero/callback/GET";
import integrations_xero_disconnect_post_153 from "./api/integrations/xero/disconnect/POST";
import integrations_xero_status_get_154 from "./api/integrations/xero/status/GET";
import integrations_xero_sync_customer_post_155 from "./api/integrations/xero/sync-customer/POST";
import integrations_xero_sync_invoice_post_156 from "./api/integrations/xero/sync-invoice/POST";
import integrations_xero_webhook_post_157 from "./api/integrations/xero/webhook/POST";
import invoices_get_158 from "./api/invoices/GET";
import invoices_post_159 from "./api/invoices/POST";
import invoices_id_delete_160 from "./api/invoices/[id]/DELETE";
import invoices_id_get_161 from "./api/invoices/[id]/GET";
import invoices_id_put_162 from "./api/invoices/[id]/PUT";
import invoices_id_duplicate_post_163 from "./api/invoices/[id]/duplicate/POST";
import invoices_id_mark_sent_post_164 from "./api/invoices/[id]/mark-sent/POST";
import invoices_id_record_payment_post_165 from "./api/invoices/[id]/record-payment/POST";
import invoices_id_void_post_166 from "./api/invoices/[id]/void/POST";
import job_forms_id_delete_167 from "./api/job-forms/[id]/DELETE";
import job_forms_id_get_168 from "./api/job-forms/[id]/GET";
import job_forms_id_put_169 from "./api/job-forms/[id]/PUT";
import job_forms_id_reset_post_170 from "./api/job-forms/[id]/reset/POST";
import job_forms_id_share_delete_171 from "./api/job-forms/[id]/share/DELETE";
import job_forms_id_share_get_172 from "./api/job-forms/[id]/share/GET";
import job_forms_id_share_post_173 from "./api/job-forms/[id]/share/POST";
import jobs_get_174 from "./api/jobs/GET";
import jobs_post_175 from "./api/jobs/POST";
import jobs_id_get_176 from "./api/jobs/[id]/GET";
import jobs_id_put_177 from "./api/jobs/[id]/PUT";
import jobs_id_costs_get_178 from "./api/jobs/[id]/costs/GET";
import jobs_id_costs_post_179 from "./api/jobs/[id]/costs/POST";
import jobs_id_costs_export_get_180 from "./api/jobs/[id]/costs/export/GET";
import jobs_id_costs_costId_delete_181 from "./api/jobs/[id]/costs/[costId]/DELETE";
import jobs_id_costs_costId_put_182 from "./api/jobs/[id]/costs/[costId]/PUT";
import jobs_id_costs_costId_receipt_get_183 from "./api/jobs/[id]/costs/[costId]/receipt/GET";
import jobs_id_costs_costId_receipt_post_184 from "./api/jobs/[id]/costs/[costId]/receipt/POST";
import jobs_id_delays_get_185 from "./api/jobs/[id]/delays/GET";
import jobs_id_delays_post_186 from "./api/jobs/[id]/delays/POST";
import jobs_id_delays_delayId_delete_187 from "./api/jobs/[id]/delays/[delayId]/DELETE";
import jobs_id_delays_delayId_put_188 from "./api/jobs/[id]/delays/[delayId]/PUT";
import jobs_id_files_get_189 from "./api/jobs/[id]/files/GET";
import jobs_id_forms_get_190 from "./api/jobs/[id]/forms/GET";
import jobs_id_forms_post_191 from "./api/jobs/[id]/forms/POST";
import jobs_id_ledger_get_192 from "./api/jobs/[id]/ledger/GET";
import jobs_id_ledger_post_193 from "./api/jobs/[id]/ledger/POST";
import jobs_id_ledger_export_get_194 from "./api/jobs/[id]/ledger/export/GET";
import jobs_id_ledger_sync_post_195 from "./api/jobs/[id]/ledger/sync/POST";
import jobs_id_ledger_entryId_delete_196 from "./api/jobs/[id]/ledger/[entryId]/DELETE";
import jobs_id_ledger_entryId_put_197 from "./api/jobs/[id]/ledger/[entryId]/PUT";
import jobs_id_ledger_entryId_correct_post_198 from "./api/jobs/[id]/ledger/[entryId]/correct/POST";
import jobs_id_photos_get_199 from "./api/jobs/[id]/photos/GET";
import jobs_id_photos_post_200 from "./api/jobs/[id]/photos/POST";
import jobs_id_photos_photoId_delete_201 from "./api/jobs/[id]/photos/[photoId]/DELETE";
import jobs_id_photos_photoId_patch_202 from "./api/jobs/[id]/photos/[photoId]/PATCH";
import jobs_id_photos_photoId_download_get_203 from "./api/jobs/[id]/photos/[photoId]/download/GET";
import jobs_id_photos_photoId_replace_post_204 from "./api/jobs/[id]/photos/[photoId]/replace/POST";
import jobs_id_progress_get_205 from "./api/jobs/[id]/progress/GET";
import jobs_id_progress_put_206 from "./api/jobs/[id]/progress/PUT";
import jobs_id_progress_sync_post_207 from "./api/jobs/[id]/progress/sync/POST";
import jobs_id_purchase_orders_get_208 from "./api/jobs/[id]/purchase-orders/GET";
import jobs_id_purchase_orders_post_209 from "./api/jobs/[id]/purchase-orders/POST";
import jobs_id_purchase_orders_poId_delete_210 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import jobs_id_purchase_orders_poId_get_211 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
import jobs_id_purchase_orders_poId_put_212 from "./api/jobs/[id]/purchase-orders/[poId]/PUT";
import jobs_id_purchase_orders_poId_pdf_get_213 from "./api/jobs/[id]/purchase-orders/[poId]/pdf/GET";
import jobs_id_swms_get_214 from "./api/jobs/[id]/swms/GET";
import jobs_id_swms_post_215 from "./api/jobs/[id]/swms/POST";
import jobs_id_swms_swmsId_signoff_post_216 from "./api/jobs/[id]/swms/[swmsId]/signoff/POST";
import jobs_id_todos_get_217 from "./api/jobs/[id]/todos/GET";
import jobs_id_todos_post_218 from "./api/jobs/[id]/todos/POST";
import jobs_id_todos_todoId_delete_219 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import jobs_id_todos_todoId_put_220 from "./api/jobs/[id]/todos/[todoId]/PUT";
import me_get_221 from "./api/me/GET";
import me_put_222 from "./api/me/PUT";
import me_2fa_disable_post_223 from "./api/me/2fa/disable/POST";
import me_2fa_enable_post_224 from "./api/me/2fa/enable/POST";
import me_2fa_setup_get_225 from "./api/me/2fa/setup/GET";
import me_2fa_status_get_226 from "./api/me/2fa/status/GET";
import me_2fa_verify_post_227 from "./api/me/2fa/verify/POST";
import me_change_password_post_228 from "./api/me/change-password/POST";
import me_email_status_get_229 from "./api/me/email-status/GET";
import me_phone_get_230 from "./api/me/phone/GET";
import me_phone_put_231 from "./api/me/phone/PUT";
import migrate_account_recovery_post_232 from "./api/migrate-account-recovery/POST";
import migrate_company_settings_post_233 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_234 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_235 from "./api/migrate-dazza-knowledge/POST";
import migrate_estimates_post_236 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_237 from "./api/migrate-estimating-library/POST";
import migrate_files_post_238 from "./api/migrate-files/POST";
import migrate_fleet_post_239 from "./api/migrate-fleet/POST";
import migrate_fleet_driver_sessions_post_240 from "./api/migrate-fleet-driver-sessions/POST";
import migrate_form_fields_post_241 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_242 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_243 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_244 from "./api/migrate-job-forms/POST";
import migrate_job_photos_post_245 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_246 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_247 from "./api/migrate-jobs/POST";
import migrate_notifications_post_248 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_249 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_250 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_251 from "./api/migrate-pdf-settings/POST";
import migrate_safety_post_252 from "./api/migrate-safety/POST";
import migrate_starter_pack_post_253 from "./api/migrate-starter-pack/POST";
import migrate_subscriptions_post_254 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_255 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_256 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_257 from "./api/migrate-team/POST";
import notifications_alerts_get_258 from "./api/notifications/alerts/GET";
import notifications_prefs_get_259 from "./api/notifications/prefs/GET";
import notifications_prefs_put_260 from "./api/notifications/prefs/PUT";
import notifications_read_post_261 from "./api/notifications/read/POST";
import owner_console_activity_get_262 from "./api/owner-console/activity/GET";
import owner_console_cancellation_feedback_get_263 from "./api/owner-console/cancellation-feedback/GET";
import owner_console_companies_get_264 from "./api/owner-console/companies/GET";
import owner_console_companies_post_265 from "./api/owner-console/companies/POST";
import owner_console_companies_usage_get_266 from "./api/owner-console/companies/usage/GET";
import owner_console_companies_id_limits_put_267 from "./api/owner-console/companies/[id]/limits/PUT";
import owner_console_form_templates_get_268 from "./api/owner-console/form-templates/GET";
import owner_console_form_templates_post_269 from "./api/owner-console/form-templates/POST";
import owner_console_starter_pack_get_270 from "./api/owner-console/starter-pack/GET";
import owner_console_starter_pack_post_271 from "./api/owner-console/starter-pack/POST";
import owner_console_stats_get_272 from "./api/owner-console/stats/GET";
import owner_console_storage_get_273 from "./api/owner-console/storage/GET";
import owner_console_system_ai_builtin_checks_post_274 from "./api/owner-console/system-ai/builtin-checks/POST";
import owner_console_users_get_275 from "./api/owner-console/users/GET";
import owner_console_users_verify_post_276 from "./api/owner-console/users/verify/POST";
import recipes_get_277 from "./api/recipes/GET";
import recipes_post_278 from "./api/recipes/POST";
import recipes_id_delete_279 from "./api/recipes/[id]/DELETE";
import recipes_id_put_280 from "./api/recipes/[id]/PUT";
import safety_ai_draft_post_281 from "./api/safety/ai/draft/POST";
import safety_documents_get_282 from "./api/safety/documents/GET";
import safety_documents_post_283 from "./api/safety/documents/POST";
import safety_documents_id_delete_284 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_285 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_286 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_287 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_288 from "./api/safety/generated-posters/[id]/DELETE";
import safety_job_safety_plans_get_289 from "./api/safety/job-safety-plans/GET";
import safety_job_safety_plans_post_290 from "./api/safety/job-safety-plans/POST";
import safety_job_safety_plans_id_delete_291 from "./api/safety/job-safety-plans/[id]/DELETE";
import safety_job_safety_plans_id_put_292 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_293 from "./api/safety/job-swms/GET";
import safety_job_swms_post_294 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_295 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_296 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_297 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_signoffs_get_298 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_299 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_300 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_301 from "./api/safety/plans/GET";
import safety_plans_post_302 from "./api/safety/plans/POST";
import safety_plans_seed_post_303 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_304 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_305 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_306 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_307 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_308 from "./api/safety/posters/GET";
import safety_posters_post_309 from "./api/safety/posters/POST";
import safety_posters_id_delete_310 from "./api/safety/posters/[id]/DELETE";
import safety_swms_get_311 from "./api/safety/swms/GET";
import safety_swms_post_312 from "./api/safety/swms/POST";
import safety_swms_seed_post_313 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_314 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_315 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_316 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_317 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_318 from "./api/safety/swms/[id]/export/GET";
import scheduler_jobs_get_319 from "./api/scheduler/jobs/GET";
import secure_share_get_320 from "./api/secure-share/GET";
import secure_share_post_321 from "./api/secure-share/POST";
import secure_share_id_delete_322 from "./api/secure-share/[id]/DELETE";
import secure_share_token_get_323 from "./api/secure-share/[token]/GET";
import secure_share_token_post_324 from "./api/secure-share/[token]/POST";
import settings_backup_get_325 from "./api/settings/backup/GET";
import settings_backup_post_326 from "./api/settings/backup/POST";
import settings_backup_export_get_327 from "./api/settings/backup/export/GET";
import settings_backup_run_post_328 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_329 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_330 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_331 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_332 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_333 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_334 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_335 from "./api/settings/retention/GET";
import settings_retention_post_336 from "./api/settings/retention/POST";
import settings_storage_provider_get_337 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_338 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_339 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_340 from "./api/settings/terminology/GET";
import settings_terminology_post_341 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_342 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_343 from "./api/settings/xero-credentials/POST";
import share_token_get_344 from "./api/share/[token]/GET";
import signup_post_345 from "./api/signup/POST";
import stripe_create_checkout_session_post_346 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_347 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_348 from "./api/subscription/create-checkout/POST";
import subscription_status_get_349 from "./api/subscription/status/GET";
import subscription_webhook_post_350 from "./api/subscription/webhook/POST";
import support_mode_audit_get_351 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_352 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_353 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_354 from "./api/support-mode/enter/POST";
import support_mode_exit_post_355 from "./api/support-mode/exit/POST";
import support_mode_status_get_356 from "./api/support-mode/status/GET";
import takeoff_pad_get_357 from "./api/takeoff-pad/GET";
import takeoff_pad_put_358 from "./api/takeoff-pad/PUT";
import team_get_359 from "./api/team/GET";
import team_invite_post_360 from "./api/team/invite/POST";
import team_invites_get_361 from "./api/team/invites/GET";
import team_invites_post_362 from "./api/team/invites/POST";
import team_invites_id_cancel_post_363 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_364 from "./api/team/invites/[id]/resend/POST";
import team_members_get_365 from "./api/team/members/GET";
import team_resend_verification_post_366 from "./api/team/resend-verification/POST";
import team_verify_user_post_367 from "./api/team/verify-user/POST";
...
app.get("/api/documents", documents_get_83);
app.get("/api/documents/share/:token", documents_share_token_get_84);
app.post("/api/documents/share/:token", documents_share_token_post_85);
app.get("/api/documents/:id", documents_id_get_86);
app.put("/api/documents/:id", documents_id_put_87);
app.get("/api/documents/:id/events", documents_id_events_get_88);
app.delete("/api/documents/:id/share", documents_id_share_delete_89);
app.post("/api/documents/:id/share", documents_id_share_post_90);
app.get("/api/drawings", drawings_get_91);
app.post("/api/drawings", drawings_post_92);
app.post("/api/drawings/upload", drawings_upload_post_93);
app.delete("/api/drawings/:id", drawings_id_delete_94);
app.patch("/api/drawings/:id", drawings_id_patch_95);
app.post("/api/drawings/:id/markup", drawings_id_markup_post_96);
app.get("/api/estimates", estimates_get_97);
app.post("/api/estimates", estimates_post_98);
app.delete("/api/estimates/:id", estimates_id_delete_99);
app.get("/api/estimates/:id", estimates_id_get_100);
app.put("/api/estimates/:id", estimates_id_put_101);
app.get("/api/estimates/:id/export-csv", estimates_id_export_csv_get_102);
app.post("/api/estimates/:id/import-csv", estimates_id_import_csv_post_103);
app.get("/api/external/form/:token", external_form_token_get_104);
app.post("/api/external/form/:token", external_form_token_post_105);
app.get("/api/files", files_get_106);
app.post("/api/files", files_post_107);
app.delete("/api/files/:id", files_id_delete_108);
app.get("/api/files/:id/download", files_id_download_get_109);
app.get("/api/fleet", fleet_get_110);
app.post("/api/fleet", fleet_post_111);
app.post("/api/fleet/driver-sessions", fleet_driver_sessions_post_112);
app.get("/api/fleet/driver-sessions/active", fleet_driver_sessions_active_get_113);
app.post("/api/fleet/driver-sessions/:id/stop", fleet_driver_sessions_id_stop_post_114);
app.get("/api/fleet/flags", fleet_flags_get_115);
app.get("/api/fleet/vehicles", fleet_vehicles_get_116);
app.delete("/api/fleet/:id", fleet_id_delete_117);
app.get("/api/fleet/:id", fleet_id_get_118);
app.put("/api/fleet/:id", fleet_id_put_119);
app.get("/api/fleet/:id/driver-sessions", fleet_id_driver_sessions_get_120);
app.get("/api/fleet/:id/files", fleet_id_files_get_121);
app.get("/api/fleet/:id/prestarts", fleet_id_prestarts_get_122);
app.post("/api/fleet/:id/prestarts", fleet_id_prestarts_post_123);
app.get("/api/form-templates", form_templates_get_124);
app.post("/api/form-templates", form_templates_post_125);
app.post("/api/form-templates/seed", form_templates_seed_post_126);
app.delete("/api/form-templates/:id", form_templates_id_delete_127);
app.put("/api/form-templates/:id", form_templates_id_put_128);
app.get("/api/forms/:id/fields", forms_id_fields_get_129);
app.post("/api/forms/:id/fields", forms_id_fields_post_130);
app.post("/api/forms/:id/fields/reorder", forms_id_fields_reorder_post_131);
app.delete("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_delete_132);
app.patch("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_patch_133);
app.post("/api/forms/:id/fields/:fieldId/thumbnail", forms_id_fields_fieldId_thumbnail_post_134);
app.get("/api/health", health_get_135);
app.get("/api/integrations/myob/auth-url", integrations_myob_auth_url_get_136);
app.get("/api/integrations/myob/callback", integrations_myob_callback_get_137);
app.post("/api/integrations/myob/disconnect", integrations_myob_disconnect_post_138);
app.get("/api/integrations/myob/status", integrations_myob_status_get_139);
app.post("/api/integrations/myob/sync-invoice", integrations_myob_sync_invoice_post_140);
app.get("/api/integrations/onedrive/auth-url", integrations_onedrive_auth_url_get_141);
app.get("/api/integrations/onedrive/callback", integrations_onedrive_callback_get_142);
app.post("/api/integrations/onedrive/disconnect", integrations_onedrive_disconnect_post_143);
app.get("/api/integrations/onedrive/status", integrations_onedrive_status_get_144);
app.post("/api/integrations/onedrive/upload-file", integrations_onedrive_upload_file_post_145);
app.get("/api/integrations/qbo/auth-url", integrations_qbo_auth_url_get_146);
app.get("/api/integrations/qbo/callback", integrations_qbo_callback_get_147);
app.post("/api/integrations/qbo/disconnect", integrations_qbo_disconnect_post_148);
app.get("/api/integrations/qbo/status", integrations_qbo_status_get_149);
app.post("/api/integrations/qbo/sync-invoice", integrations_qbo_sync_invoice_post_150);
app.get("/api/integrations/xero/auth-url", integrations_xero_auth_url_get_151);
app.get("/api/integrations/xero/callback", integrations_xero_callback_get_152);
app.post("/api/integrations/xero/disconnect", integrations_xero_disconnect_post_153);
app.get("/api/integrations/xero/status", integrations_xero_status_get_154);
app.post("/api/integrations/xero/sync-customer", integrations_xero_sync_customer_post_155);
app.post("/api/integrations/xero/sync-invoice", integrations_xero_sync_invoice_post_156);
app.post("/api/integrations/xero/webhook", integrations_xero_webhook_post_157);
app.get("/api/invoices", invoices_get_158);
app.post("/api/invoices", invoices_post_159);
app.delete("/api/invoices/:id", invoices_id_delete_160);
app.get("/api/invoices/:id", invoices_id_get_161);
app.put("/api/invoices/:id", invoices_id_put_162);
app.post("/api/invoices/:id/duplicate", invoices_id_duplicate_post_163);
app.post("/api/invoices/:id/mark-sent", invoices_id_mark_sent_post_164);
app.post("/api/invoices/:id/record-payment", invoices_id_record_payment_post_165);
app.post("/api/invoices/:id/void", invoices_id_void_post_166);
app.delete("/api/job-forms/:id", job_forms_id_delete_167);
app.get("/api/job-forms/:id", job_forms_id_get_168);
app.put("/api/job-forms/:id", job_forms_id_put_169);
app.post("/api/job-forms/:id/reset", job_forms_id_reset_post_170);
app.delete("/api/job-forms/:id/share", job_forms_id_share_delete_171);
app.get("/api/job-forms/:id/share", job_forms_id_share_get_172);
app.post("/api/job-forms/:id/share", job_forms_id_share_post_173);
app.get("/api/jobs", jobs_get_174);
app.post("/api/jobs", jobs_post_175);
app.get("/api/jobs/:id", jobs_id_get_176);
app.put("/api/jobs/:id", jobs_id_put_177);
app.get("/api/jobs/:id/costs", jobs_id_costs_get_178);
app.post("/api/jobs/:id/costs", jobs_id_costs_post_179);
app.get("/api/jobs/:id/costs/export", jobs_id_costs_export_get_180);
app.delete("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_delete_181);
app.put("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_put_182);
app.get("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_get_183);
app.post("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_post_184);
app.get("/api/jobs/:id/delays", jobs_id_delays_get_185);
app.post("/api/jobs/:id/delays", jobs_id_delays_post_186);
app.delete("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_delete_187);
app.put("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_put_188);
app.get("/api/jobs/:id/files", jobs_id_files_get_189);
app.get("/api/jobs/:id/forms", jobs_id_forms_get_190);
app.post("/api/jobs/:id/forms", jobs_id_forms_post_191);
app.get("/api/jobs/:id/ledger", jobs_id_ledger_get_192);
app.post("/api/jobs/:id/ledger", jobs_id_ledger_post_193);
app.get("/api/jobs/:id/ledger/export", jobs_id_ledger_export_get_194);
app.post("/api/jobs/:id/ledger/sync", jobs_id_ledger_sync_post_195);
app.delete("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_delete_196);
app.put("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_put_197);
app.post("/api/jobs/:id/ledger/:entryId/correct", jobs_id_ledger_entryId_correct_post_198);
app.get("/api/jobs/:id/photos", jobs_id_photos_get_199);
app.post("/api/jobs/:id/photos", jobs_id_photos_post_200);
app.delete("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_delete_201);
app.patch("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_patch_202);
app.get("/api/jobs/:id/photos/:photoId/download", jobs_id_photos_photoId_download_get_203);
app.post("/api/jobs/:id/photos/:photoId/replace", jobs_id_photos_photoId_replace_post_204);
app.get("/api/jobs/:id/progress", jobs_id_progress_get_205);
app.put("/api/jobs/:id/progress", jobs_id_progress_put_206);
app.post("/api/jobs/:id/progress/sync", jobs_id_progress_sync_post_207);
app.get("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_get_208);
app.post("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_post_209);
app.delete("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_delete_210);
app.get("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_get_211);
app.put("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_put_212);
app.get("/api/jobs/:id/purchase-orders/:poId/pdf", jobs_id_purchase_orders_poId_pdf_get_213);
app.get("/api/jobs/:id/swms", jobs_id_swms_get_214);
app.post("/api/jobs/:id/swms", jobs_id_swms_post_215);
app.post("/api/jobs/:id/swms/:swmsId/signoff", jobs_id_swms_swmsId_signoff_post_216);
app.get("/api/jobs/:id/todos", jobs_id_todos_get_217);
app.post("/api/jobs/:id/todos", jobs_id_todos_post_218);
app.delete("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_delete_219);
app.put("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_put_220);
app.get("/api/me", me_get_221);
app.put("/api/me", me_put_222);
app.post("/api/me/2fa/disable", me_2fa_disable_post_223);
app.post("/api/me/2fa/enable", me_2fa_enable_post_224);
app.get("/api/me/2fa/setup", me_2fa_setup_get_225);
app.get("/api/me/2fa/status", me_2fa_status_get_226);
app.post("/api/me/2fa/verify", me_2fa_verify_post_227);
app.post("/api/me/change-password", me_change_password_post_228);
app.get("/api/me/email-status", me_email_status_get_229);
app.get("/api/me/phone", me_phone_get_230);
app.put("/api/me/phone", me_phone_put_231);
app.post("/api/migrate-account-recovery", migrate_account_recovery_post_232);
app.post("/api/migrate-company-settings", migrate_company_settings_post_233);
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_234);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_235);
app.post("/api/migrate-estimates", migrate_estimates_post_236);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_237);
app.post("/api/migrate-files", migrate_files_post_238);
app.post("/api/migrate-fleet", migrate_fleet_post_239);
app.post("/api/migrate-fleet-driver-sessions", migrate_fleet_driver_sessions_post_240);
app.post("/api/migrate-form-fields", migrate_form_fields_post_241);
app.post("/api/migrate-form-logic", migrate_form_logic_post_242);
app.post("/api/migrate-form-templates", migrate_form_templates_post_243);
app.post("/api/migrate-job-forms", migrate_job_forms_post_244);
app.post("/api/migrate-job-photos", migrate_job_photos_post_245);
app.post("/api/migrate-job-tabs", migrate_job_tabs_post_246);
app.post("/api/migrate-jobs", migrate_jobs_post_247);
app.post("/api/migrate-notifications", migrate_notifications_post_248);
app.post("/api/migrate-owner-console", migrate_owner_console_post_249);
app.post("/api/migrate-owner-role", migrate_owner_role_post_250);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_251);
app.post("/api/migrate-safety", migrate_safety_post_252);
app.post("/api/migrate-starter-pack", migrate_starter_pack_post_253);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_254);
app.post("/api/migrate-support-mode", migrate_support_mode_post_255);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_256);
app.post("/api/migrate-team", migrate_team_post_257);
app.get("/api/notifications/alerts", notifications_alerts_get_258);
app.get("/api/notifications/prefs", notifications_prefs_get_259);
app.put("/api/notifications/prefs", notifications_prefs_put_260);
app.post("/api/notifications/read", notifications_read_post_261);
app.get("/api/owner-console/activity", owner_console_activity_get_262);
app.get("/api/owner-console/cancellation-feedback", owner_console_cancellation_feedback_get_263);
app.get("/api/owner-console/companies", owner_console_companies_get_264);
app.post("/api/owner-console/companies", owner_console_companies_post_265);
app.get("/api/owner-console/companies/usage", owner_console_companies_usage_get_266);
app.put("/api/owner-console/companies/:id/limits", owner_console_companies_id_limits_put_267);
app.get("/api/owner-console/form-templates", owner_console_form_templates_get_268);
app.post("/api/owner-console/form-templates", owner_console_form_templates_post_269);
app.get("/api/owner-console/starter-pack", owner_console_starter_pack_get_270);
app.post("/api/owner-console/starter-pack", owner_console_starter_pack_post_271);
app.get("/api/owner-console/stats", owner_console_stats_get_272);
app.get("/api/owner-console/storage", owner_console_storage_get_273);
app.post("/api/owner-console/system-ai/builtin-checks", owner_console_system_ai_builtin_checks_post_274);
app.get("/api/owner-console/users", owner_console_users_get_275);
app.post("/api/owner-console/users/verify", owner_console_users_verify_post_276);
app.get("/api/recipes", recipes_get_277);
app.post("/api/recipes", recipes_post_278);
app.delete("/api/recipes/:id", recipes_id_delete_279);
app.put("/api/recipes/:id", recipes_id_put_280);
app.post("/api/safety/ai/draft", safety_ai_draft_post_281);
app.get("/api/safety/documents", safety_documents_get_282);
app.post("/api/safety/documents", safety_documents_post_283);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_284);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_285);
app.get("/api/safety/generated-posters", safety_generated_posters_get_286);
app.post("/api/safety/generated-posters", safety_generated_posters_post_287);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_288);
app.get("/api/safety/job-safety-plans", safety_job_safety_plans_get_289);
app.post("/api/safety/job-safety-plans", safety_job_safety_plans_post_290);
app.delete("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_delete_291);
app.put("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_put_292);
app.get("/api/safety/job-swms", safety_job_swms_get_293);
app.post("/api/safety/job-swms", safety_job_swms_post_294);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_295);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_296);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_297);
app.get("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_get_298);
app.post("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_post_299);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", safety_job_swms_id_signoffs_signoffId_delete_300);
app.get("/api/safety/plans", safety_plans_get_301);
app.post("/api/safety/plans", safety_plans_post_302);
app.post("/api/safety/plans/seed", safety_plans_seed_post_303);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_304);
app.put("/api/safety/plans/:id", safety_plans_id_put_305);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_306);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_307);
app.get("/api/safety/posters", safety_posters_get_308);
app.post("/api/safety/posters", safety_posters_post_309);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_310);
app.get("/api/safety/swms", safety_swms_get_311);
app.post("/api/safety/swms", safety_swms_post_312);
app.post("/api/safety/swms/seed", safety_swms_seed_post_313);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_314);
app.get("/api/safety/swms/:id", safety_swms_id_get_315);
app.put("/api/safety/swms/:id", safety_swms_id_put_316);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_317);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_318);
app.get("/api/scheduler/jobs", scheduler_jobs_get_319);
app.get("/api/secure-share", secure_share_get_320);
app.post("/api/secure-share", secure_share_post_321);
app.delete("/api/secure-share/:id", secure_share_id_delete_322);
app.get("/api/secure-share/:token", secure_share_token_get_323);
app.post("/api/secure-share/:token", secure_share_token_post_324);
app.get("/api/settings/backup", settings_backup_get_325);
app.post("/api/settings/backup", settings_backup_post_326);
app.get("/api/settings/backup/export", settings_backup_export_get_327);
app.post("/api/settings/backup/run", settings_backup_run_post_328);
app.get("/api/settings/backup-destination", settings_backup_destination_get_329);
app.post("/api/settings/backup-destination", settings_backup_destination_post_330);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_331);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_332);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_333);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_334);
app.get("/api/settings/retention", settings_retention_get_335);
app.post("/api/settings/retention", settings_retention_post_336);
app.get("/api/settings/storage-provider", settings_storage_provider_get_337);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_338);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_339);
app.get("/api/settings/terminology", settings_terminology_get_340);
app.post("/api/settings/terminology", settings_terminology_post_341);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_342);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_343);
app.get("/api/share/:token", share_token_get_344);
app.post("/api/signup", signup_post_345);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_346);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_347);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_348);
app.get("/api/subscription/status", subscription_status_get_349);
app.post("/api/subscription/webhook", subscription_webhook_post_350);
app.get("/api/support-mode/audit", support_mode_audit_get_351);
app.get("/api/support-mode/checklist", support_mode_checklist_get_352);
app.put("/api/support-mode/checklist", support_mode_checklist_put_353);
app.post("/api/support-mode/enter", support_mode_enter_post_354);
app.post("/api/support-mode/exit", support_mode_exit_post_355);
app.get("/api/support-mode/status", support_mode_status_get_356);
app.get("/api/takeoff-pad", takeoff_pad_get_357);
app.put("/api/takeoff-pad", takeoff_pad_put_358);
app.get("/api/team", team_get_359);
app.post("/api/team/invite", team_invite_post_360);
app.get("/api/team/invites", team_invites_get_361);
app.post("/api/team/invites", team_invites_post_362);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_363);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_364);
app.get("/api/team/members", team_members_get_365);
app.post("/api/team/resend-verification", team_resend_verification_post_366);
app.post("/api/team/verify-user", team_verify_user_post_367);
