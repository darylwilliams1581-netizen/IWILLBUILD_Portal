...
import files_post_175 from "./api/files/POST";
import files_id_delete_176 from "./api/files/[id]/DELETE";
import files_id_download_get_177 from "./api/files/[id]/download/GET";
import fleet_get_178 from "./api/fleet/GET";
import fleet_post_179 from "./api/fleet/POST";
import fleet_analytics_settings_get_180 from "./api/fleet/analytics-settings/GET";
import fleet_analytics_settings_put_181 from "./api/fleet/analytics-settings/PUT";
import fleet_driver_sessions_post_182 from "./api/fleet/driver-sessions/POST";
import fleet_driver_sessions_active_get_183 from "./api/fleet/driver-sessions/active/GET";
import fleet_driver_sessions_live_get_184 from "./api/fleet/driver-sessions/live/GET";
import fleet_driver_sessions_id_stop_post_185 from "./api/fleet/driver-sessions/[id]/stop/POST";
import fleet_driver_sessions_id_summary_get_186 from "./api/fleet/driver-sessions/[id]/summary/GET";
import fleet_driver_sessions_id_telemetry_post_187 from "./api/fleet/driver-sessions/[id]/telemetry/POST";
import fleet_driver_sessions_id_telemetry_latest_get_188 from "./api/fleet/driver-sessions/[id]/telemetry/latest/GET";
import fleet_flags_get_189 from "./api/fleet/flags/GET";
import fleet_service_logs_logId_delete_190 from "./api/fleet/service-logs/[logId]/DELETE";
import fleet_service_logs_logId_patch_191 from "./api/fleet/service-logs/[logId]/PATCH";
import fleet_vehicles_get_192 from "./api/fleet/vehicles/GET";
import fleet_id_delete_193 from "./api/fleet/[id]/DELETE";
import fleet_id_get_194 from "./api/fleet/[id]/GET";
import fleet_id_put_195 from "./api/fleet/[id]/PUT";
import fleet_id_driver_sessions_get_196 from "./api/fleet/[id]/driver-sessions/GET";
import fleet_id_files_get_197 from "./api/fleet/[id]/files/GET";
import fleet_id_prestarts_get_198 from "./api/fleet/[id]/prestarts/GET";
import fleet_id_prestarts_post_199 from "./api/fleet/[id]/prestarts/POST";
import fleet_id_service_logs_get_200 from "./api/fleet/[id]/service-logs/GET";
import fleet_id_service_logs_post_201 from "./api/fleet/[id]/service-logs/POST";
import fleet_id_signin_post_202 from "./api/fleet/[id]/signin/POST";
import fleet_id_signout_post_203 from "./api/fleet/[id]/signout/POST";
import fleet_id_usage_export_get_204 from "./api/fleet/[id]/usage-export/GET";
import fleet_id_usage_status_get_205 from "./api/fleet/[id]/usage-status/GET";
import fleet_id_usage_summary_get_206 from "./api/fleet/[id]/usage-summary/GET";
import form_templates_get_207 from "./api/form-templates/GET";
import form_templates_post_208 from "./api/form-templates/POST";
import form_templates_seed_post_209 from "./api/form-templates/seed/POST";
...
import forms_submissions_get_215 from "./api/forms/submissions/GET";
import forms_templates_id_share_link_post_216 from "./api/forms/templates/[id]/share-link/POST";
import forms_id_fields_get_217 from "./api/forms/[id]/fields/GET";
import forms_id_fields_post_218 from "./api/forms/[id]/fields/POST";
import forms_id_fields_reorder_post_219 from "./api/forms/[id]/fields/reorder/POST";
import forms_id_fields_fieldId_delete_220 from "./api/forms/[id]/fields/[fieldId]/DELETE";
import forms_id_fields_fieldId_patch_221 from "./api/forms/[id]/fields/[fieldId]/PATCH";
import forms_id_fields_fieldId_thumbnail_post_222 from "./api/forms/[id]/fields/[fieldId]/thumbnail/POST";
import health_get_223 from "./api/health/GET";
import integrations_myob_auth_url_get_224 from "./api/integrations/myob/auth-url/GET";
import integrations_myob_callback_get_225 from "./api/integrations/myob/callback/GET";
import integrations_myob_disconnect_post_226 from "./api/integrations/myob/disconnect/POST";
import integrations_myob_status_get_227 from "./api/integrations/myob/status/GET";
import integrations_myob_sync_invoice_post_228 from "./api/integrations/myob/sync-invoice/POST";
import integrations_onedrive_auth_url_get_229 from "./api/integrations/onedrive/auth-url/GET";
import integrations_onedrive_callback_get_230 from "./api/integrations/onedrive/callback/GET";
import integrations_onedrive_disconnect_post_231 from "./api/integrations/onedrive/disconnect/POST";
import integrations_onedrive_status_get_232 from "./api/integrations/onedrive/status/GET";
import integrations_onedrive_upload_file_post_233 from "./api/integrations/onedrive/upload-file/POST";
import integrations_qbo_auth_url_get_234 from "./api/integrations/qbo/auth-url/GET";
import integrations_qbo_callback_get_235 from "./api/integrations/qbo/callback/GET";
import integrations_qbo_disconnect_post_236 from "./api/integrations/qbo/disconnect/POST";
import integrations_qbo_status_get_237 from "./api/integrations/qbo/status/GET";
import integrations_qbo_sync_invoice_post_238 from "./api/integrations/qbo/sync-invoice/POST";
import integrations_xero_auth_url_get_239 from "./api/integrations/xero/auth-url/GET";
import integrations_xero_callback_get_240 from "./api/integrations/xero/callback/GET";
import integrations_xero_disconnect_post_241 from "./api/integrations/xero/disconnect/POST";
import integrations_xero_status_get_242 from "./api/integrations/xero/status/GET";
import integrations_xero_sync_customer_post_243 from "./api/integrations/xero/sync-customer/POST";
import integrations_xero_sync_invoice_post_244 from "./api/integrations/xero/sync-invoice/POST";
import integrations_xero_webhook_post_245 from "./api/integrations/xero/webhook/POST";
import invoices_get_246 from "./api/invoices/GET";
import invoices_post_247 from "./api/invoices/POST";
import invoices_id_delete_248 from "./api/invoices/[id]/DELETE";
import invoices_id_get_249 from "./api/invoices/[id]/GET";
import invoices_id_put_250 from "./api/invoices/[id]/PUT";
import invoices_id_duplicate_post_251 from "./api/invoices/[id]/duplicate/POST";
import invoices_id_export_pdf_get_252 from "./api/invoices/[id]/export-pdf/GET";
...
import job_forms_id_reset_post_259 from "./api/job-forms/[id]/reset/POST";
import job_forms_id_share_delete_260 from "./api/job-forms/[id]/share/DELETE";
import job_forms_id_share_get_261 from "./api/job-forms/[id]/share/GET";
import job_forms_id_share_post_262 from "./api/job-forms/[id]/share/POST";
import jobs_get_263 from "./api/jobs/GET";
import jobs_post_264 from "./api/jobs/POST";
import jobs_id_get_265 from "./api/jobs/[id]/GET";
import jobs_id_put_266 from "./api/jobs/[id]/PUT";
import jobs_id_attendance_attendanceId_close_post_267 from "./api/jobs/[id]/attendance/[attendanceId]/close/POST";
import jobs_id_costs_get_268 from "./api/jobs/[id]/costs/GET";
import jobs_id_costs_post_269 from "./api/jobs/[id]/costs/POST";
import jobs_id_costs_export_get_270 from "./api/jobs/[id]/costs/export/GET";
import jobs_id_costs_costId_delete_271 from "./api/jobs/[id]/costs/[costId]/DELETE";
import jobs_id_costs_costId_put_272 from "./api/jobs/[id]/costs/[costId]/PUT";
import jobs_id_costs_costId_receipt_get_273 from "./api/jobs/[id]/costs/[costId]/receipt/GET";
import jobs_id_costs_costId_receipt_post_274 from "./api/jobs/[id]/costs/[costId]/receipt/POST";
import jobs_id_delays_get_275 from "./api/jobs/[id]/delays/GET";
import jobs_id_delays_post_276 from "./api/jobs/[id]/delays/POST";
import jobs_id_delays_delayId_delete_277 from "./api/jobs/[id]/delays/[delayId]/DELETE";
import jobs_id_delays_delayId_put_278 from "./api/jobs/[id]/delays/[delayId]/PUT";
import jobs_id_files_get_279 from "./api/jobs/[id]/files/GET";
import jobs_id_forms_get_280 from "./api/jobs/[id]/forms/GET";
import jobs_id_forms_post_281 from "./api/jobs/[id]/forms/POST";
import jobs_id_generate_qr_post_282 from "./api/jobs/[id]/generate-qr/POST";
import jobs_id_ledger_get_283 from "./api/jobs/[id]/ledger/GET";
import jobs_id_ledger_post_284 from "./api/jobs/[id]/ledger/POST";
import jobs_id_ledger_export_get_285 from "./api/jobs/[id]/ledger/export/GET";
import jobs_id_ledger_sync_post_286 from "./api/jobs/[id]/ledger/sync/POST";
import jobs_id_ledger_entryId_delete_287 from "./api/jobs/[id]/ledger/[entryId]/DELETE";
import jobs_id_ledger_entryId_put_288 from "./api/jobs/[id]/ledger/[entryId]/PUT";
import jobs_id_ledger_entryId_correct_post_289 from "./api/jobs/[id]/ledger/[entryId]/correct/POST";
import jobs_id_photos_get_290 from "./api/jobs/[id]/photos/GET";
import jobs_id_photos_post_291 from "./api/jobs/[id]/photos/POST";
import jobs_id_photos_photoId_delete_292 from "./api/jobs/[id]/photos/[photoId]/DELETE";
import jobs_id_photos_photoId_patch_293 from "./api/jobs/[id]/photos/[photoId]/PATCH";
import jobs_id_photos_photoId_download_get_294 from "./api/jobs/[id]/photos/[photoId]/download/GET";
import jobs_id_photos_photoId_replace_post_295 from "./api/jobs/[id]/photos/[photoId]/replace/POST";
import jobs_id_progress_get_296 from "./api/jobs/[id]/progress/GET";
import jobs_id_progress_put_297 from "./api/jobs/[id]/progress/PUT";
import jobs_id_progress_sync_post_298 from "./api/jobs/[id]/progress/sync/POST";
import jobs_id_purchase_orders_get_299 from "./api/jobs/[id]/purchase-orders/GET";
import jobs_id_purchase_orders_post_300 from "./api/jobs/[id]/purchase-orders/POST";
import jobs_id_purchase_orders_poId_delete_301 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import jobs_id_purchase_orders_poId_get_302 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
import jobs_id_purchase_orders_poId_put_303 from "./api/jobs/[id]/purchase-orders/[poId]/PUT";
import jobs_id_purchase_orders_poId_pdf_get_304 from "./api/jobs/[id]/purchase-orders/[poId]/pdf/GET";
import jobs_id_signin_post_305 from "./api/jobs/[id]/signin/POST";
import jobs_id_signin_qr_post_306 from "./api/jobs/[id]/signin-qr/POST";
import jobs_id_signin_status_get_307 from "./api/jobs/[id]/signin-status/GET";
import jobs_id_signout_post_308 from "./api/jobs/[id]/signout/POST";
import jobs_id_signout_qr_post_309 from "./api/jobs/[id]/signout-qr/POST";
import jobs_id_swms_get_310 from "./api/jobs/[id]/swms/GET";
import jobs_id_swms_post_311 from "./api/jobs/[id]/swms/POST";
import jobs_id_swms_swmsId_signoff_post_312 from "./api/jobs/[id]/swms/[swmsId]/signoff/POST";
import jobs_id_todos_get_313 from "./api/jobs/[id]/todos/GET";
import jobs_id_todos_post_314 from "./api/jobs/[id]/todos/POST";
import jobs_id_todos_todoId_delete_315 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import jobs_id_todos_todoId_put_316 from "./api/jobs/[id]/todos/[todoId]/PUT";
import library_items_get_317 from "./api/library/items/GET";
import library_items_id_get_318 from "./api/library/items/[id]/GET";
import library_items_id_patch_319 from "./api/library/items/[id]/PATCH";
import library_items_id_download_get_320 from "./api/library/items/[id]/download/GET";
import library_items_id_install_post_321 from "./api/library/items/[id]/install/POST";
import library_my_installed_get_322 from "./api/library/my-installed/GET";
import library_my_submissions_get_323 from "./api/library/my-submissions/GET";
import me_get_324 from "./api/me/GET";
import me_put_325 from "./api/me/PUT";
import me_2fa_disable_post_326 from "./api/me/2fa/disable/POST";
import me_2fa_enable_post_327 from "./api/me/2fa/enable/POST";
import me_2fa_setup_get_328 from "./api/me/2fa/setup/GET";
import me_2fa_status_get_329 from "./api/me/2fa/status/GET";
import me_2fa_verify_post_330 from "./api/me/2fa/verify/POST";
import me_change_password_post_331 from "./api/me/change-password/POST";
import me_email_status_get_332 from "./api/me/email-status/GET";
import me_phone_get_333 from "./api/me/phone/GET";
import me_phone_put_334 from "./api/me/phone/PUT";
import migrate_account_recovery_post_335 from "./api/migrate-account-recovery/POST";
import migrate_asset_manager_post_336 from "./api/migrate-asset-manager/POST";
import migrate_attendance_post_337 from "./api/migrate-attendance/POST";
import migrate_company_settings_post_338 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_339 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_340 from "./api/migrate-dazza-knowledge/POST";
import migrate_emergency_alerts_post_341 from "./api/migrate-emergency-alerts/POST";
import migrate_estimates_post_342 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_343 from "./api/migrate-estimating-library/POST";
import migrate_files_post_344 from "./api/migrate-files/POST";
import migrate_fleet_post_345 from "./api/migrate-fleet/POST";
import migrate_fleet_analytics_post_346 from "./api/migrate-fleet-analytics/POST";
import migrate_fleet_driver_sessions_post_347 from "./api/migrate-fleet-driver-sessions/POST";
import migrate_fleet_usage_post_348 from "./api/migrate-fleet-usage/POST";
import migrate_form_fields_post_349 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_350 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_351 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_352 from "./api/migrate-job-forms/POST";
import migrate_job_photos_post_353 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_354 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_355 from "./api/migrate-jobs/POST";
import migrate_library_post_356 from "./api/migrate-library/POST";
import migrate_library_downloads_post_357 from "./api/migrate-library-downloads/POST";
import migrate_notifications_post_358 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_359 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_360 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_361 from "./api/migrate-pdf-settings/POST";
import migrate_plan_manager_post_362 from "./api/migrate-plan-manager/POST";
import migrate_plan_manager_v2_post_363 from "./api/migrate-plan-manager-v2/POST";
import migrate_plan_manager_v3_post_364 from "./api/migrate-plan-manager-v3/POST";
import migrate_safety_post_365 from "./api/migrate-safety/POST";
import migrate_starter_pack_post_366 from "./api/migrate-starter-pack/POST";
import migrate_studio_pdf_post_367 from "./api/migrate-studio-pdf/POST";
import migrate_subscriptions_post_368 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_369 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_370 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_371 from "./api/migrate-team/POST";
import notes_get_372 from "./api/notes/GET";
import notes_post_373 from "./api/notes/POST";
import notes_comments_post_374 from "./api/notes/comments/POST";
import notes_migrate_post_375 from "./api/notes/migrate/POST";
import notifications_alerts_get_376 from "./api/notifications/alerts/GET";
import notifications_prefs_get_377 from "./api/notifications/prefs/GET";
import notifications_prefs_put_378 from "./api/notifications/prefs/PUT";
import notifications_read_post_379 from "./api/notifications/read/POST";
import owner_console_activity_get_380 from "./api/owner-console/activity/GET";
import owner_console_cancellation_feedback_get_381 from "./api/owner-console/cancellation-feedback/GET";
import owner_console_companies_get_382 from "./api/owner-console/companies/GET";
import owner_console_companies_post_383 from "./api/owner-console/companies/POST";
import owner_console_companies_usage_get_384 from "./api/owner-console/companies/usage/GET";
import owner_console_companies_id_limits_put_385 from "./api/owner-console/companies/[id]/limits/PUT";
import owner_console_form_templates_get_386 from "./api/owner-console/form-templates/GET";
import owner_console_form_templates_post_387 from "./api/owner-console/form-templates/POST";
import owner_console_library_items_get_388 from "./api/owner-console/library/items/GET";
import owner_console_library_items_post_389 from "./api/owner-console/library/items/POST";
import owner_console_library_items_id_delete_390 from "./api/owner-console/library/items/[id]/DELETE";
import owner_console_library_items_id_patch_391 from "./api/owner-console/library/items/[id]/PATCH";
import owner_console_library_items_id_put_392 from "./api/owner-console/library/items/[id]/PUT";
import owner_console_library_items_id_push_update_post_393 from "./api/owner-console/library/items/[id]/push-update/POST";
import owner_console_library_submissions_get_394 from "./api/owner-console/library/submissions/GET";
import owner_console_library_submissions_id_review_post_395 from "./api/owner-console/library/submissions/[id]/review/POST";
import owner_console_starter_pack_get_396 from "./api/owner-console/starter-pack/GET";
import owner_console_starter_pack_post_397 from "./api/owner-console/starter-pack/POST";
import owner_console_stats_get_398 from "./api/owner-console/stats/GET";
import owner_console_storage_get_399 from "./api/owner-console/storage/GET";
import owner_console_swms_masters_get_400 from "./api/owner-console/swms/masters/GET";
import owner_console_swms_masters_post_401 from "./api/owner-console/swms/masters/POST";
import owner_console_swms_masters_publish_all_post_402 from "./api/owner-console/swms/masters/publish-all/POST";
import owner_console_swms_masters_id_delete_403 from "./api/owner-console/swms/masters/[id]/DELETE";
import owner_console_swms_masters_id_get_404 from "./api/owner-console/swms/masters/[id]/GET";
import owner_console_swms_masters_id_put_405 from "./api/owner-console/swms/masters/[id]/PUT";
import owner_console_swms_masters_id_publish_post_406 from "./api/owner-console/swms/masters/[id]/publish/POST";
import owner_console_swms_migrate_master_library_post_407 from "./api/owner-console/swms/migrate-master-library/POST";
import owner_console_swms_push_post_408 from "./api/owner-console/swms/push/POST";
import owner_console_swms_seed_bricklaying_post_409 from "./api/owner-console/swms/seed-bricklaying/POST";
import owner_console_swms_seed_building_inspection_post_410 from "./api/owner-console/swms/seed-building-inspection/POST";
import owner_console_swms_seed_cabinets_post_411 from "./api/owner-console/swms/seed-cabinets/POST";
import owner_console_swms_seed_carpenter_fixing_post_412 from "./api/owner-console/swms/seed-carpenter-fixing/POST";
import owner_console_swms_seed_carpenter_framing_post_413 from "./api/owner-console/swms/seed-carpenter-framing/POST";
import owner_console_swms_seed_carpenter_lockup_post_414 from "./api/owner-console/swms/seed-carpenter-lockup/POST";
import owner_console_swms_seed_ceramic_tiling_post_415 from "./api/owner-console/swms/seed-ceramic-tiling/POST";
import owner_console_swms_seed_concreting_slab_post_416 from "./api/owner-console/swms/seed-concreting-slab/POST";
import owner_console_swms_seed_delivery_loading_post_417 from "./api/owner-console/swms/seed-delivery-loading/POST";
import owner_console_swms_seed_environmental_spill_post_418 from "./api/owner-console/swms/seed-environmental-spill/POST";
import owner_console_swms_seed_ewp_post_419 from "./api/owner-console/swms/seed-ewp/POST";
import owner_console_swms_seed_excavations_substation_post_420 from "./api/owner-console/swms/seed-excavations-substation/POST";
import owner_console_swms_seed_fencing_post_421 from "./api/owner-console/swms/seed-fencing/POST";
import owner_console_swms_seed_heat_stress_post_422 from "./api/owner-console/swms/seed-heat-stress/POST";
import owner_console_swms_seed_landscaping_post_423 from "./api/owner-console/swms/seed-landscaping/POST";
import owner_console_swms_seed_live_parts_post_424 from "./api/owner-console/swms/seed-live-parts/POST";
import owner_console_swms_seed_manual_handling_post_425 from "./api/owner-console/swms/seed-manual-handling/POST";
import owner_console_swms_seed_moving_plant_post_426 from "./api/owner-console/swms/seed-moving-plant/POST";
import owner_console_swms_seed_painting_post_427 from "./api/owner-console/swms/seed-painting/POST";
import owner_console_swms_seed_power_tools_post_428 from "./api/owner-console/swms/seed-power-tools/POST";
import owner_console_swms_seed_silica_dust_post_429 from "./api/owner-console/swms/seed-silica-dust/POST";
import owner_console_swms_seed_traffic_management_post_430 from "./api/owner-console/swms/seed-traffic-management/POST";
import owner_console_swms_seed_underground_services_post_431 from "./api/owner-console/swms/seed-underground-services/POST";
import owner_console_swms_seed_vacuum_excavation_post_432 from "./api/owner-console/swms/seed-vacuum-excavation/POST";
import owner_console_system_ai_builtin_checks_post_433 from "./api/owner-console/system-ai/builtin-checks/POST";
import owner_console_users_get_434 from "./api/owner-console/users/GET";
import owner_console_users_verify_post_435 from "./api/owner-console/users/verify/POST";
import plan_manager_drawings_get_436 from "./api/plan-manager/drawings/GET";
import plan_manager_drawings_post_437 from "./api/plan-manager/drawings/POST";
import plan_manager_drawings_id_get_438 from "./api/plan-manager/drawings/[id]/GET";
import plan_manager_drawings_id_annotations_put_439 from "./api/plan-manager/drawings/[id]/annotations/PUT";
import plan_manager_drawings_id_archive_post_440 from "./api/plan-manager/drawings/[id]/archive/POST";
import plan_manager_drawings_id_job_links_delete_441 from "./api/plan-manager/drawings/[id]/job-links/DELETE";
import plan_manager_drawings_id_job_links_post_442 from "./api/plan-manager/drawings/[id]/job-links/POST";
import plan_manager_drawings_id_pages_pageNo_annotations_get_443 from "./api/plan-manager/drawings/[id]/pages/[pageNo]/annotations/GET";
import plan_manager_drawings_id_permanent_delete_444 from "./api/plan-manager/drawings/[id]/permanent/DELETE";
import plan_manager_drawings_id_reorder_patch_445 from "./api/plan-manager/drawings/[id]/reorder/PATCH";
import plan_manager_drawings_id_restore_post_446 from "./api/plan-manager/drawings/[id]/restore/POST";
import plan_manager_drawings_id_revisions_post_447 from "./api/plan-manager/drawings/[id]/revisions/POST";
import plan_manager_drawings_id_revisions_revisionId_finalize_post_448 from "./api/plan-manager/drawings/[id]/revisions/[revisionId]/finalize/POST";
import plan_manager_drawings_id_upload_post_449 from "./api/plan-manager/drawings/[id]/upload/POST";
import plan_manager_jobs_with_drawings_get_450 from "./api/plan-manager/jobs-with-drawings/GET";
import plan_manager_share_post_451 from "./api/plan-manager/share/POST";
import plan_manager_share_validate_get_452 from "./api/plan-manager/share/validate/GET";
import portal_estimates_id_approve_post_453 from "./api/portal/estimates/[id]/approve/POST";
import portal_invite_post_454 from "./api/portal/invite/POST";
import portal_invoices_id_pay_post_455 from "./api/portal/invoices/[id]/pay/POST";
import portal_jobs_get_456 from "./api/portal/jobs/GET";
import portal_jobs_id_get_457 from "./api/portal/jobs/[id]/GET";
import portal_migrate_post_458 from "./api/portal/migrate/POST";
import portal_validate_post_459 from "./api/portal/validate/POST";
import public_form_token_get_460 from "./api/public/form/[token]/GET";
import public_form_token_submit_post_461 from "./api/public/form/[token]/submit/POST";
import public_swms_token_get_462 from "./api/public/swms/[token]/GET";
import public_swms_token_signoff_post_463 from "./api/public/swms/[token]/signoff/POST";
import push_subscribe_delete_464 from "./api/push/subscribe/DELETE";
import push_subscribe_post_465 from "./api/push/subscribe/POST";
import push_vapid_key_get_466 from "./api/push/vapid-key/GET";
import recipes_get_467 from "./api/recipes/GET";
import recipes_post_468 from "./api/recipes/POST";
import recipes_id_delete_469 from "./api/recipes/[id]/DELETE";
import recipes_id_put_470 from "./api/recipes/[id]/PUT";
import safety_ai_draft_post_471 from "./api/safety/ai/draft/POST";
import safety_documents_get_472 from "./api/safety/documents/GET";
import safety_documents_post_473 from "./api/safety/documents/POST";
import safety_documents_id_delete_474 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_475 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_476 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_477 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_478 from "./api/safety/generated-posters/[id]/DELETE";
import safety_job_safety_plans_get_479 from "./api/safety/job-safety-plans/GET";
import safety_job_safety_plans_post_480 from "./api/safety/job-safety-plans/POST";
import safety_job_safety_plans_id_delete_481 from "./api/safety/job-safety-plans/[id]/DELETE";
import safety_job_safety_plans_id_put_482 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_483 from "./api/safety/job-swms/GET";
import safety_job_swms_post_484 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_485 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_486 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_487 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_share_token_post_488 from "./api/safety/job-swms/[id]/share-token/POST";
import safety_job_swms_id_signoffs_get_489 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_490 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_491 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_492 from "./api/safety/plans/GET";
import safety_plans_post_493 from "./api/safety/plans/POST";
import safety_plans_seed_post_494 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_495 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_496 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_497 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_498 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_499 from "./api/safety/posters/GET";
import safety_posters_post_500 from "./api/safety/posters/POST";
import safety_posters_id_delete_501 from "./api/safety/posters/[id]/DELETE";
import safety_swms_get_502 from "./api/safety/swms/GET";
import safety_swms_post_503 from "./api/safety/swms/POST";
import safety_swms_import_docx_post_504 from "./api/safety/swms/import-docx/POST";
import safety_swms_seed_post_505 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_506 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_507 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_508 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_509 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_510 from "./api/safety/swms/[id]/export/GET";
import safety_swms_id_publish_to_library_post_511 from "./api/safety/swms/[id]/publish-to-library/POST";
import scheduler_crew_get_512 from "./api/scheduler/crew/GET";
import scheduler_jobs_get_513 from "./api/scheduler/jobs/GET";
import scheduler_jobs_id_reschedule_patch_514 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
import secure_share_get_515 from "./api/secure-share/GET";
import secure_share_post_516 from "./api/secure-share/POST";
import secure_share_id_delete_517 from "./api/secure-share/[id]/DELETE";
import secure_share_token_get_518 from "./api/secure-share/[token]/GET";
import secure_share_token_post_519 from "./api/secure-share/[token]/POST";
import settings_backup_get_520 from "./api/settings/backup/GET";
import settings_backup_post_521 from "./api/settings/backup/POST";
import settings_backup_export_get_522 from "./api/settings/backup/export/GET";
import settings_backup_run_post_523 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_524 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_525 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_526 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_527 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_528 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_529 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_530 from "./api/settings/retention/GET";
import settings_retention_post_531 from "./api/settings/retention/POST";
import settings_storage_provider_get_532 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_533 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_534 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_535 from "./api/settings/terminology/GET";
import settings_terminology_post_536 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_537 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_538 from "./api/settings/xero-credentials/POST";
import share_token_get_539 from "./api/share/[token]/GET";
import signin_history_get_540 from "./api/signin-history/GET";
import signup_post_541 from "./api/signup/POST";
import sos_get_542 from "./api/sos/GET";
import sos_acknowledge_post_543 from "./api/sos/acknowledge/POST";
import sos_trigger_post_544 from "./api/sos/trigger/POST";
import stripe_create_checkout_session_post_545 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_546 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_547 from "./api/subscription/create-checkout/POST";
import subscription_status_get_548 from "./api/subscription/status/GET";
import subscription_webhook_post_549 from "./api/subscription/webhook/POST";
import support_mode_audit_get_550 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_551 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_552 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_553 from "./api/support-mode/enter/POST";
import support_mode_exit_post_554 from "./api/support-mode/exit/POST";
import support_mode_status_get_555 from "./api/support-mode/status/GET";
import tag_tasks_get_556 from "./api/tag-tasks/GET";
import tag_tasks_id_patch_557 from "./api/tag-tasks/[id]/PATCH";
import takeoff_pad_get_558 from "./api/takeoff-pad/GET";
import takeoff_pad_put_559 from "./api/takeoff-pad/PUT";
import team_get_560 from "./api/team/GET";
import team_invite_post_561 from "./api/team/invite/POST";
import team_invites_get_562 from "./api/team/invites/GET";
import team_invites_post_563 from "./api/team/invites/POST";
import team_invites_id_cancel_post_564 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_565 from "./api/team/invites/[id]/resend/POST";
import team_members_get_566 from "./api/team/members/GET";
import team_resend_verification_post_567 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_568 from "./api/team/schedule/migrate/POST";
import team_shifts_get_569 from "./api/team/shifts/GET";
import team_shifts_post_570 from "./api/team/shifts/POST";
import team_shifts_id_delete_571 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_572 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_573 from "./api/team/time-entries/GET";
import team_time_entries_post_574 from "./api/team/time-entries/POST";
import team_time_entries_export_get_575 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_576 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_577 from "./api/team/verify-user/POST";
import team_id_delete_578 from "./api/team/[id]/DELETE";
import team_id_put_579 from "./api/team/[id]/PUT";
import usage_get_580 from "./api/usage/GET";
// </api-imports>
...
app.post("/api/files", files_post_175);
app.delete("/api/files/:id", files_id_delete_176);
app.get("/api/files/:id/download", files_id_download_get_177);
app.get("/api/fleet", fleet_get_178);
app.post("/api/fleet", fleet_post_179);
app.get("/api/fleet/analytics-settings", fleet_analytics_settings_get_180);
app.put("/api/fleet/analytics-settings", fleet_analytics_settings_put_181);
app.post("/api/fleet/driver-sessions", fleet_driver_sessions_post_182);
app.get("/api/fleet/driver-sessions/active", fleet_driver_sessions_active_get_183);
app.get("/api/fleet/driver-sessions/live", fleet_driver_sessions_live_get_184);
app.post("/api/fleet/driver-sessions/:id/stop", fleet_driver_sessions_id_stop_post_185);
app.get("/api/fleet/driver-sessions/:id/summary", fleet_driver_sessions_id_summary_get_186);
app.post("/api/fleet/driver-sessions/:id/telemetry", fleet_driver_sessions_id_telemetry_post_187);
app.get("/api/fleet/driver-sessions/:id/telemetry/latest", fleet_driver_sessions_id_telemetry_latest_get_188);
app.get("/api/fleet/flags", fleet_flags_get_189);
app.delete("/api/fleet/service-logs/:logId", fleet_service_logs_logId_delete_190);
app.patch("/api/fleet/service-logs/:logId", fleet_service_logs_logId_patch_191);
app.get("/api/fleet/vehicles", fleet_vehicles_get_192);
app.delete("/api/fleet/:id", fleet_id_delete_193);
app.get("/api/fleet/:id", fleet_id_get_194);
app.put("/api/fleet/:id", fleet_id_put_195);
app.get("/api/fleet/:id/driver-sessions", fleet_id_driver_sessions_get_196);
app.get("/api/fleet/:id/files", fleet_id_files_get_197);
app.get("/api/fleet/:id/prestarts", fleet_id_prestarts_get_198);
app.post("/api/fleet/:id/prestarts", fleet_id_prestarts_post_199);
app.get("/api/fleet/:id/service-logs", fleet_id_service_logs_get_200);
app.post("/api/fleet/:id/service-logs", fleet_id_service_logs_post_201);
app.post("/api/fleet/:id/signin", fleet_id_signin_post_202);
app.post("/api/fleet/:id/signout", fleet_id_signout_post_203);
app.get("/api/fleet/:id/usage-export", fleet_id_usage_export_get_204);
app.get("/api/fleet/:id/usage-status", fleet_id_usage_status_get_205);
app.get("/api/fleet/:id/usage-summary", fleet_id_usage_summary_get_206);
app.get("/api/form-templates", form_templates_get_207);
app.post("/api/form-templates", form_templates_post_208);
app.post("/api/form-templates/seed", form_templates_seed_post_209);
...
app.get("/api/forms/submissions", forms_submissions_get_215);
app.post("/api/forms/templates/:id/share-link", forms_templates_id_share_link_post_216);
app.get("/api/forms/:id/fields", forms_id_fields_get_217);
app.post("/api/forms/:id/fields", forms_id_fields_post_218);
app.post("/api/forms/:id/fields/reorder", forms_id_fields_reorder_post_219);
app.delete("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_delete_220);
app.patch("/api/forms/:id/fields/:fieldId", forms_id_fields_fieldId_patch_221);
app.post("/api/forms/:id/fields/:fieldId/thumbnail", forms_id_fields_fieldId_thumbnail_post_222);
app.get("/api/health", health_get_223);
app.get("/api/integrations/myob/auth-url", integrations_myob_auth_url_get_224);
app.get("/api/integrations/myob/callback", integrations_myob_callback_get_225);
app.post("/api/integrations/myob/disconnect", integrations_myob_disconnect_post_226);
app.get("/api/integrations/myob/status", integrations_myob_status_get_227);
app.post("/api/integrations/myob/sync-invoice", integrations_myob_sync_invoice_post_228);
app.get("/api/integrations/onedrive/auth-url", integrations_onedrive_auth_url_get_229);
app.get("/api/integrations/onedrive/callback", integrations_onedrive_callback_get_230);
app.post("/api/integrations/onedrive/disconnect", integrations_onedrive_disconnect_post_231);
app.get("/api/integrations/onedrive/status", integrations_onedrive_status_get_232);
app.post("/api/integrations/onedrive/upload-file", integrations_onedrive_upload_file_post_233);
app.get("/api/integrations/qbo/auth-url", integrations_qbo_auth_url_get_234);
app.get("/api/integrations/qbo/callback", integrations_qbo_callback_get_235);
app.post("/api/integrations/qbo/disconnect", integrations_qbo_disconnect_post_236);
app.get("/api/integrations/qbo/status", integrations_qbo_status_get_237);
app.post("/api/integrations/qbo/sync-invoice", integrations_qbo_sync_invoice_post_238);
app.get("/api/integrations/xero/auth-url", integrations_xero_auth_url_get_239);
app.get("/api/integrations/xero/callback", integrations_xero_callback_get_240);
app.post("/api/integrations/xero/disconnect", integrations_xero_disconnect_post_241);
app.get("/api/integrations/xero/status", integrations_xero_status_get_242);
app.post("/api/integrations/xero/sync-customer", integrations_xero_sync_customer_post_243);
app.post("/api/integrations/xero/sync-invoice", integrations_xero_sync_invoice_post_244);
app.post("/api/integrations/xero/webhook", integrations_xero_webhook_post_245);
app.get("/api/invoices", invoices_get_246);
app.post("/api/invoices", invoices_post_247);
app.delete("/api/invoices/:id", invoices_id_delete_248);
app.get("/api/invoices/:id", invoices_id_get_249);
app.put("/api/invoices/:id", invoices_id_put_250);
app.post("/api/invoices/:id/duplicate", invoices_id_duplicate_post_251);
app.get("/api/invoices/:id/export-pdf", invoices_id_export_pdf_get_252);
...
app.post("/api/job-forms/:id/reset", job_forms_id_reset_post_259);
app.delete("/api/job-forms/:id/share", job_forms_id_share_delete_260);
app.get("/api/job-forms/:id/share", job_forms_id_share_get_261);
...
app.get("/api/jobs/:id/costs", jobs_id_costs_get_268);
app.post("/api/jobs/:id/costs", jobs_id_costs_post_269);
app.get("/api/jobs/:id/costs/export", jobs_id_costs_export_get_270);
app.delete("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_delete_271);
app.put("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_put_272);
app.get("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_get_273);
app.post("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_post_274);
app.get("/api/jobs/:id/delays", jobs_id_delays_get_275);
app.post("/api/jobs/:id/delays", jobs_id_delays_post_276);
app.delete("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_delete_277);
app.put("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_put_278);
app.get("/api/jobs/:id/files", jobs_id_files_get_279);
app.get("/api/jobs/:id/forms", jobs_id_forms_get_280);
app.post("/api/jobs/:id/forms", jobs_id_forms_post_281);
app.post("/api/jobs/:id/generate-qr", jobs_id_generate_qr_post_282);
app.get("/api/jobs/:id/ledger", jobs_id_ledger_get_283);
app.post("/api/jobs/:id/ledger", jobs_id_ledger_post_284);
app.get("/api/jobs/:id/ledger/export", jobs_id_ledger_export_get_285);
app.post("/api/jobs/:id/ledger/sync", jobs_id_ledger_sync_post_286);
app.delete("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_delete_287);
app.put("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_put_288);
app.post("/api/jobs/:id/ledger/:entryId/correct", jobs_id_ledger_entryId_correct_post_289);
app.get("/api/jobs/:id/photos", jobs_id_photos_get_290);
app.post("/api/jobs/:id/photos", jobs_id_photos_post_291);
app.delete("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_delete_292);
app.patch("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_patch_293);
app.get("/api/jobs/:id/photos/:photoId/download", jobs_id_photos_photoId_download_get_294);
app.post("/api/jobs/:id/photos/:photoId/replace", jobs_id_photos_photoId_replace_post_295);
app.get("/api/jobs/:id/progress", jobs_id_progress_get_296);
app.put("/api/jobs/:id/progress", jobs_id_progress_put_297);
app.post("/api/jobs/:id/progress/sync", jobs_id_progress_sync_post_298);
app.get("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_get_299);
app.post("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_post_300);
app.delete("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_delete_301);
app.get("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_get_302);
app.put("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_put_303);
app.get("/api/jobs/:id/purchase-orders/:poId/pdf", jobs_id_purchase_orders_poId_pdf_get_304);
app.post("/api/jobs/:id/signin", jobs_id_signin_post_305);
app.post("/api/jobs/:id/signin-qr", jobs_id_signin_qr_post_306);
app.get("/api/jobs/:id/signin-status", jobs_id_signin_status_get_307);
app.post("/api/jobs/:id/signout", jobs_id_signout_post_308);
app.post("/api/jobs/:id/signout-qr", jobs_id_signout_qr_post_309);
app.get("/api/jobs/:id/swms", jobs_id_swms_get_310);
app.post("/api/jobs/:id/swms", jobs_id_swms_post_311);
app.post("/api/jobs/:id/swms/:swmsId/signoff", jobs_id_swms_swmsId_signoff_post_312);
app.get("/api/jobs/:id/todos", jobs_id_todos_get_313);
app.post("/api/jobs/:id/todos", jobs_id_todos_post_314);
app.delete("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_delete_315);
app.put("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_put_316);
app.get("/api/library/items", library_items_get_317);
app.get("/api/library/items/:id", library_items_id_get_318);
app.patch("/api/library/items/:id", library_items_id_patch_319);
app.get("/api/library/items/:id/download", library_items_id_download_get_320);
app.post("/api/library/items/:id/install", library_items_id_install_post_321);
app.get("/api/library/my-installed", library_my_installed_get_322);
app.get("/api/library/my-submissions", library_my_submissions_get_323);
app.get("/api/me", me_get_324);
app.put("/api/me", me_put_325);
app.post("/api/me/2fa/disable", me_2fa_disable_post_326);
app.post("/api/me/2fa/enable", me_2fa_enable_post_327);
app.get("/api/me/2fa/setup", me_2fa_setup_get_328);
app.get("/api/me/2fa/status", me_2fa_status_get_329);
app.post("/api/me/2fa/verify", me_2fa_verify_post_330);
app.post("/api/me/change-password", me_change_password_post_331);
app.get("/api/me/email-status", me_email_status_get_332);
app.get("/api/me/phone", me_phone_get_333);
app.put("/api/me/phone", me_phone_put_334);
app.post("/api/migrate-account-recovery", migrate_account_recovery_post_335);
app.post("/api/migrate-asset-manager", migrate_asset_manager_post_336);
app.post("/api/migrate-attendance", migrate_attendance_post_337);
app.post("/api/migrate-company-settings", migrate_company_settings_post_338);
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_339);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_340);
app.post("/api/migrate-emergency-alerts", migrate_emergency_alerts_post_341);
app.post("/api/migrate-estimates", migrate_estimates_post_342);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_343);
app.post("/api/migrate-files", migrate_files_post_344);
app.post("/api/migrate-fleet", migrate_fleet_post_345);
app.post("/api/migrate-fleet-analytics", migrate_fleet_analytics_post_346);
app.post("/api/migrate-fleet-driver-sessions", migrate_fleet_driver_sessions_post_347);
app.post("/api/migrate-fleet-usage", migrate_fleet_usage_post_348);
app.post("/api/migrate-form-fields", migrate_form_fields_post_349);
app.post("/api/migrate-form-logic", migrate_form_logic_post_350);
app.post("/api/migrate-form-templates", migrate_form_templates_post_351);
app.post("/api/migrate-job-forms", migrate_job_forms_post_352);
app.post("/api/migrate-job-photos", migrate_job_photos_post_353);
app.post("/api/migrate-job-tabs", migrate_job_tabs_post_354);
app.post("/api/migrate-jobs", migrate_jobs_post_355);
app.post("/api/migrate-library", migrate_library_post_356);
app.post("/api/migrate-library-downloads", migrate_library_downloads_post_357);
app.post("/api/migrate-notifications", migrate_notifications_post_358);
app.post("/api/migrate-owner-console", migrate_owner_console_post_359);
app.post("/api/migrate-owner-role", migrate_owner_role_post_360);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_361);
app.post("/api/migrate-plan-manager", migrate_plan_manager_post_362);
app.post("/api/migrate-plan-manager-v2", migrate_plan_manager_v2_post_363);
app.post("/api/migrate-plan-manager-v3", migrate_plan_manager_v3_post_364);
app.post("/api/migrate-safety", migrate_safety_post_365);
app.post("/api/migrate-starter-pack", migrate_starter_pack_post_366);
app.post("/api/migrate-studio-pdf", migrate_studio_pdf_post_367);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_368);
app.post("/api/migrate-support-mode", migrate_support_mode_post_369);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_370);
app.post("/api/migrate-team", migrate_team_post_371);
app.get("/api/notes", notes_get_372);
app.post("/api/notes", notes_post_373);
app.post("/api/notes/comments", notes_comments_post_374);
app.post("/api/notes/migrate", notes_migrate_post_375);
app.get("/api/notifications/alerts", notifications_alerts_get_376);
app.get("/api/notifications/prefs", notifications_prefs_get_377);
app.put("/api/notifications/prefs", notifications_prefs_put_378);
app.post("/api/notifications/read", notifications_read_post_379);
app.get("/api/owner-console/activity", owner_console_activity_get_380);
app.get("/api/owner-console/cancellation-feedback", owner_console_cancellation_feedback_get_381);
app.get("/api/owner-console/companies", owner_console_companies_get_382);
app.post("/api/owner-console/companies", owner_console_companies_post_383);
app.get("/api/owner-console/companies/usage", owner_console_companies_usage_get_384);
app.put("/api/owner-console/companies/:id/limits", owner_console_companies_id_limits_put_385);
app.get("/api/owner-console/form-templates", owner_console_form_templates_get_386);
app.post("/api/owner-console/form-templates", owner_console_form_templates_post_387);
app.get("/api/owner-console/library/items", owner_console_library_items_get_388);
app.post("/api/owner-console/library/items", owner_console_library_items_post_389);
app.delete("/api/owner-console/library/items/:id", owner_console_library_items_id_delete_390);
app.patch("/api/owner-console/library/items/:id", owner_console_library_items_id_patch_391);
app.put("/api/owner-console/library/items/:id", owner_console_library_items_id_put_392);
app.post("/api/owner-console/library/items/:id/push-update", owner_console_library_items_id_push_update_post_393);
app.get("/api/owner-console/library/submissions", owner_console_library_submissions_get_394);
app.post("/api/owner-console/library/submissions/:id/review", owner_console_library_submissions_id_review_post_395);
app.get("/api/owner-console/starter-pack", owner_console_starter_pack_get_396);
app.post("/api/owner-console/starter-pack", owner_console_starter_pack_post_397);
app.get("/api/owner-console/stats", owner_console_stats_get_398);
app.get("/api/owner-console/storage", owner_console_storage_get_399);
app.get("/api/owner-console/swms/masters", owner_console_swms_masters_get_400);
app.post("/api/owner-console/swms/masters", owner_console_swms_masters_post_401);
app.post("/api/owner-console/swms/masters/publish-all", owner_console_swms_masters_publish_all_post_402);
app.delete("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_delete_403);
app.get("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_get_404);
app.put("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_put_405);
app.post("/api/owner-console/swms/masters/:id/publish", owner_console_swms_masters_id_publish_post_406);
app.post("/api/owner-console/swms/migrate-master-library", owner_console_swms_migrate_master_library_post_407);
app.post("/api/owner-console/swms/push", owner_console_swms_push_post_408);
app.post("/api/owner-console/swms/seed-bricklaying", owner_console_swms_seed_bricklaying_post_409);
app.post("/api/owner-console/swms/seed-building-inspection", owner_console_swms_seed_building_inspection_post_410);
app.post("/api/owner-console/swms/seed-cabinets", owner_console_swms_seed_cabinets_post_411);
app.post("/api/owner-console/swms/seed-carpenter-fixing", owner_console_swms_seed_carpenter_fixing_post_412);
app.post("/api/owner-console/swms/seed-carpenter-framing", owner_console_swms_seed_carpenter_framing_post_413);
app.post("/api/owner-console/swms/seed-carpenter-lockup", owner_console_swms_seed_carpenter_lockup_post_414);
app.post("/api/owner-console/swms/seed-ceramic-tiling", owner_console_swms_seed_ceramic_tiling_post_415);
app.post("/api/owner-console/swms/seed-concreting-slab", owner_console_swms_seed_concreting_slab_post_416);
app.post("/api/owner-console/swms/seed-delivery-loading", owner_console_swms_seed_delivery_loading_post_417);
app.post("/api/owner-console/swms/seed-environmental-spill", owner_console_swms_seed_environmental_spill_post_418);
app.post("/api/owner-console/swms/seed-ewp", owner_console_swms_seed_ewp_post_419);
app.post("/api/owner-console/swms/seed-excavations-substation", owner_console_swms_seed_excavations_substation_post_420);
app.post("/api/owner-console/swms/seed-fencing", owner_console_swms_seed_fencing_post_421);
app.post("/api/owner-console/swms/seed-heat-stress", owner_console_swms_seed_heat_stress_post_422);
app.post("/api/owner-console/swms/seed-landscaping", owner_console_swms_seed_landscaping_post_423);
app.post("/api/owner-console/swms/seed-live-parts", owner_console_swms_seed_live_parts_post_424);
app.post("/api/owner-console/swms/seed-manual-handling", owner_console_swms_seed_manual_handling_post_425);
app.post("/api/owner-console/swms/seed-moving-plant", owner_console_swms_seed_moving_plant_post_426);
app.post("/api/owner-console/swms/seed-painting", owner_console_swms_seed_painting_post_427);
app.post("/api/owner-console/swms/seed-power-tools", owner_console_swms_seed_power_tools_post_428);
app.post("/api/owner-console/swms/seed-silica-dust", owner_console_swms_seed_silica_dust_post_429);
app.post("/api/owner-console/swms/seed-traffic-management", owner_console_swms_seed_traffic_management_post_430);
app.post("/api/owner-console/swms/seed-underground-services", owner_console_swms_seed_underground_services_post_431);
app.post("/api/owner-console/swms/seed-vacuum-excavation", owner_console_swms_seed_vacuum_excavation_post_432);
app.post("/api/owner-console/system-ai/builtin-checks", owner_console_system_ai_builtin_checks_post_433);
app.get("/api/owner-console/users", owner_console_users_get_434);
app.post("/api/owner-console/users/verify", owner_console_users_verify_post_435);
app.get("/api/plan-manager/drawings", plan_manager_drawings_get_436);
app.post("/api/plan-manager/drawings", plan_manager_drawings_post_437);
app.get("/api/plan-manager/drawings/:id", plan_manager_drawings_id_get_438);
app.put("/api/plan-manager/drawings/:id/annotations", plan_manager_drawings_id_annotations_put_439);
app.post("/api/plan-manager/drawings/:id/archive", plan_manager_drawings_id_archive_post_440);
app.delete("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_delete_441);
app.post("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_post_442);
app.get("/api/plan-manager/drawings/:id/pages/:pageNo/annotations", plan_manager_drawings_id_pages_pageNo_annotations_get_443);
app.delete("/api/plan-manager/drawings/:id/permanent", plan_manager_drawings_id_permanent_delete_444);
app.patch("/api/plan-manager/drawings/:id/reorder", plan_manager_drawings_id_reorder_patch_445);
app.post("/api/plan-manager/drawings/:id/restore", plan_manager_drawings_id_restore_post_446);
app.post("/api/plan-manager/drawings/:id/revisions", plan_manager_drawings_id_revisions_post_447);
app.post("/api/plan-manager/drawings/:id/revisions/:revisionId/finalize", plan_manager_drawings_id_revisions_revisionId_finalize_post_448);
app.post("/api/plan-manager/drawings/:id/upload", plan_manager_drawings_id_upload_post_449);
app.get("/api/plan-manager/jobs-with-drawings", plan_manager_jobs_with_drawings_get_450);
app.post("/api/plan-manager/share", plan_manager_share_post_451);
app.get("/api/plan-manager/share/validate", plan_manager_share_validate_get_452);
app.post("/api/portal/estimates/:id/approve", portal_estimates_id_approve_post_453);
app.post("/api/portal/invite", portal_invite_post_454);
app.post("/api/portal/invoices/:id/pay", portal_invoices_id_pay_post_455);
app.get("/api/portal/jobs", portal_jobs_get_456);
app.get("/api/portal/jobs/:id", portal_jobs_id_get_457);
app.post("/api/portal/migrate", portal_migrate_post_458);
app.post("/api/portal/validate", portal_validate_post_459);
app.get("/api/public/form/:token", public_form_token_get_460);
app.post("/api/public/form/:token/submit", public_form_token_submit_post_461);
app.get("/api/public/swms/:token", public_swms_token_get_462);
app.post("/api/public/swms/:token/signoff", public_swms_token_signoff_post_463);
app.delete("/api/push/subscribe", push_subscribe_delete_464);
app.post("/api/push/subscribe", push_subscribe_post_465);
app.get("/api/push/vapid-key", push_vapid_key_get_466);
app.get("/api/recipes", recipes_get_467);
app.post("/api/recipes", recipes_post_468);
app.delete("/api/recipes/:id", recipes_id_delete_469);
app.put("/api/recipes/:id", recipes_id_put_470);
app.post("/api/safety/ai/draft", safety_ai_draft_post_471);
app.get("/api/safety/documents", safety_documents_get_472);
app.post("/api/safety/documents", safety_documents_post_473);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_474);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_475);
app.get("/api/safety/generated-posters", safety_generated_posters_get_476);
app.post("/api/safety/generated-posters", safety_generated_posters_post_477);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_478);
app.get("/api/safety/job-safety-plans", safety_job_safety_plans_get_479);
app.post("/api/safety/job-safety-plans", safety_job_safety_plans_post_480);
app.delete("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_delete_481);
app.put("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_put_482);
app.get("/api/safety/job-swms", safety_job_swms_get_483);
app.post("/api/safety/job-swms", safety_job_swms_post_484);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_485);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_486);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_487);
app.post("/api/safety/job-swms/:id/share-token", safety_job_swms_id_share_token_post_488);
app.get("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_get_489);
app.post("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_post_490);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", safety_job_swms_id_signoffs_signoffId_delete_491);
app.get("/api/safety/plans", safety_plans_get_492);
app.post("/api/safety/plans", safety_plans_post_493);
app.post("/api/safety/plans/seed", safety_plans_seed_post_494);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_495);
app.put("/api/safety/plans/:id", safety_plans_id_put_496);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_497);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_498);
app.get("/api/safety/posters", safety_posters_get_499);
app.post("/api/safety/posters", safety_posters_post_500);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_501);
app.get("/api/safety/swms", safety_swms_get_502);
app.post("/api/safety/swms", safety_swms_post_503);
app.post("/api/safety/swms/import-docx", safety_swms_import_docx_post_504);
app.post("/api/safety/swms/seed", safety_swms_seed_post_505);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_506);
app.get("/api/safety/swms/:id", safety_swms_id_get_507);
app.put("/api/safety/swms/:id", safety_swms_id_put_508);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_509);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_510);
app.post("/api/safety/swms/:id/publish-to-library", safety_swms_id_publish_to_library_post_511);
app.get("/api/scheduler/crew", scheduler_crew_get_512);
app.get("/api/scheduler/jobs", scheduler_jobs_get_513);
app.patch("/api/scheduler/jobs/:id/reschedule", scheduler_jobs_id_reschedule_patch_514);
app.get("/api/secure-share", secure_share_get_515);
app.post("/api/secure-share", secure_share_post_516);
app.delete("/api/secure-share/:id", secure_share_id_delete_517);
app.get("/api/secure-share/:token", secure_share_token_get_518);
app.post("/api/secure-share/:token", secure_share_token_post_519);
app.get("/api/settings/backup", settings_backup_get_520);
app.post("/api/settings/backup", settings_backup_post_521);
app.get("/api/settings/backup/export", settings_backup_export_get_522);
app.post("/api/settings/backup/run", settings_backup_run_post_523);
app.get("/api/settings/backup-destination", settings_backup_destination_get_524);
app.post("/api/settings/backup-destination", settings_backup_destination_post_525);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_526);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_527);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_528);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_529);
app.get("/api/settings/retention", settings_retention_get_530);
app.post("/api/settings/retention", settings_retention_post_531);
app.get("/api/settings/storage-provider", settings_storage_provider_get_532);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_533);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_534);
app.get("/api/settings/terminology", settings_terminology_get_535);
app.post("/api/settings/terminology", settings_terminology_post_536);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_537);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_538);
app.get("/api/share/:token", share_token_get_539);
app.get("/api/signin-history", signin_history_get_540);
app.post("/api/signup", signup_post_541);
app.get("/api/sos", sos_get_542);
app.post("/api/sos/acknowledge", sos_acknowledge_post_543);
app.post("/api/sos/trigger", sos_trigger_post_544);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_545);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_546);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_547);
app.get("/api/subscription/status", subscription_status_get_548);
app.post("/api/subscription/webhook", subscription_webhook_post_549);
app.get("/api/support-mode/audit", support_mode_audit_get_550);
app.get("/api/support-mode/checklist", support_mode_checklist_get_551);
app.put("/api/support-mode/checklist", support_mode_checklist_put_552);
app.post("/api/support-mode/enter", support_mode_enter_post_553);
app.post("/api/support-mode/exit", support_mode_exit_post_554);
app.get("/api/support-mode/status", support_mode_status_get_555);
app.get("/api/tag-tasks", tag_tasks_get_556);
app.patch("/api/tag-tasks/:id", tag_tasks_id_patch_557);
app.get("/api/takeoff-pad", takeoff_pad_get_558);
app.put("/api/takeoff-pad", takeoff_pad_put_559);
app.get("/api/team", team_get_560);
app.post("/api/team/invite", team_invite_post_561);
app.get("/api/team/invites", team_invites_get_562);
app.post("/api/team/invites", team_invites_post_563);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_564);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_565);
app.get("/api/team/members", team_members_get_566);
app.post("/api/team/resend-verification", team_resend_verification_post_567);
app.post("/api/team/schedule/migrate", team_schedule_migrate_post_568);
app.get("/api/team/shifts", team_shifts_get_569);
app.post("/api/team/shifts", team_shifts_post_570);
app.delete("/api/team/shifts/:id", team_shifts_id_delete_571);
app.put("/api/team/shifts/:id", team_shifts_id_put_572);
app.get("/api/team/time-entries", team_time_entries_get_573);
app.post("/api/team/time-entries", team_time_entries_post_574);
app.get("/api/team/time-entries/export", team_time_entries_export_get_575);
app.put("/api/team/time-entries/:id", team_time_entries_id_put_576);
app.post("/api/team/verify-user", team_verify_user_post_577);
app.delete("/api/team/:id", team_id_delete_578);
app.put("/api/team/:id", team_id_put_579);
app.get("/api/usage", usage_get_580);
// </api-registrations>
