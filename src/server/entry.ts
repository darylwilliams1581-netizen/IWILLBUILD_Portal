...
import signup_post_111 from "./api/signup/POST";
import stripe_create_checkout_session_post_112 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_113 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_114 from "./api/subscription/create-checkout/POST";
import subscription_status_get_115 from "./api/subscription/status/GET";
import subscription_webhook_post_116 from "./api/subscription/webhook/POST";
import support_mode_audit_get_117 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_118 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_119 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_120 from "./api/support-mode/enter/POST";
import support_mode_exit_post_121 from "./api/support-mode/exit/POST";
import support_mode_status_get_122 from "./api/support-mode/status/GET";
import takeoff_pad_get_123 from "./api/takeoff-pad/GET";
import takeoff_pad_put_124 from "./api/takeoff-pad/PUT";
import team_get_125 from "./api/team/GET";
...
app.post("/api/signup", signup_post_111);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_112);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_113);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_114);
app.get("/api/subscription/status", subscription_status_get_115);
app.post("/api/subscription/webhook", subscription_webhook_post_116);
app.get("/api/support-mode/audit", support_mode_audit_get_117);
app.get("/api/support-mode/checklist", support_mode_checklist_get_118);
app.put("/api/support-mode/checklist", support_mode_checklist_put_119);
app.post("/api/support-mode/enter", support_mode_enter_post_120);
app.post("/api/support-mode/exit", support_mode_exit_post_121);
app.get("/api/support-mode/status", support_mode_status_get_122);
app.get("/api/takeoff-pad", takeoff_pad_get_123);
app.put("/api/takeoff-pad", takeoff_pad_put_124);
app.get("/api/team", team_get_125);
app.post("/api/team/invite", team_invite_post_126);
app.delete("/api/team/:id", team_id_delete_127);
app.put("/api/team/:id", team_id_put_128);
// </api-registrations>
