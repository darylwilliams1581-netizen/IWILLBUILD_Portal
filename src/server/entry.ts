...
app.post("/api/integrations/myob/sync-invoice/:invoiceId", integrations_myob_sync_invoice_post_249);
...
app.post("/api/integrations/qbo/sync-invoice/:invoiceId", integrations_qbo_sync_invoice_post_259);
...
app.post("/api/integrations/xero/sync-invoice/:invoiceId", integrations_xero_sync_invoice_post_265);
