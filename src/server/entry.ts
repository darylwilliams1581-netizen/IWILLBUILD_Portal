...
import library_my_submissions_get from "./api/library/my-submissions/GET";
...
import owner_console_library_submissions_get from "./api/owner-console/library/submissions/GET";
import owner_console_library_submissions_id_review_post from "./api/owner-console/library/submissions/[id]/review/POST";
...
app.get("/api/library/my-submissions", library_my_submissions_get);
...
app.get("/api/owner-console/library/submissions", owner_console_library_submissions_get);
app.post("/api/owner-console/library/submissions/:id/review", owner_console_library_submissions_id_review_post);
