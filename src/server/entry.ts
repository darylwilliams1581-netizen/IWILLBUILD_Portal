...
import dazza_annette_post_48 from "./api/dazza/annette/POST";
...
import dazza_chat_post_52 from "./api/dazza/chat/POST";
import dazza_chat_v2_post_53 from "./api/dazza/chat-v2/POST";
import dazza_chat_v2_stream_post_54 from "./api/dazza/chat-v2/stream/POST";
...
import form_templates_seed_post_139 from "./api/form-templates/seed/POST";
...
import migrate_account_recovery_post_248 from "./api/migrate-account-recovery/POST";
import migrate_company_settings_post_249 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_250 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_251 from "./api/migrate-dazza-knowledge/POST";
import migrate_estimates_post_252 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_253 from "./api/migrate-estimating-library/POST";
import migrate_files_post_254 from "./api/migrate-files/POST";
import migrate_fleet_post_255 from "./api/migrate-fleet/POST";
import migrate_fleet_driver_sessions_post_256 from "./api/migrate-fleet-driver-sessions/POST";
import migrate_form_fields_post_257 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_258 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_259 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_260 from "./api/migrate-job-forms/POST";
import migrate_job_photos_post_261 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_262 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_263 from "./api/migrate-jobs/POST";
import migrate_notifications_post_264 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_265 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_266 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_267 from "./api/migrate-pdf-settings/POST";
import migrate_safety_post_268 from "./api/migrate-safety/POST";
import migrate_starter_pack_post_269 from "./api/migrate-starter-pack/POST";
import migrate_subscriptions_post_270 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_271 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_272 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_273 from "./api/migrate-team/POST";
import notifications_alerts_get_274 from "./api/notifications/alerts/GET";
...
import owner_console_system_ai_builtin_checks_post_290 from "./api/owner-console/system-ai/builtin-checks/POST";
...
app.post("/api/dazza/annette", dazza_annette_post_48);
...
app.post("/api/dazza/chat", dazza_chat_post_52);
app.post("/api/dazza/chat-v2", dazza_chat_v2_post_53);
app.post("/api/dazza/chat-v2/stream", dazza_chat_v2_stream_post_54);
...
app.post("/api/form-templates/seed", form_templates_seed_post_139);
...
app.post("/api/migrate-account-recovery", migrate_account_recovery_post_248);
app.post("/api/migrate-company-settings", migrate_company_settings_post_249);
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_250);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_251);
app.post("/api/migrate-estimates", migrate_estimates_post_252);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_253);
app.post("/api/migrate-files", migrate_files_post_254);
app.post("/api/migrate-fleet", migrate_fleet_post_255);
app.post("/api/migrate-fleet-driver-sessions", migrate_fleet_driver_sessions_post_256);
app.post("/api/migrate-form-fields", migrate_form_fields_post_257);
app.post("/api/migrate-form-logic", migrate_form_logic_post_258);
app.post("/api/migrate-form-templates", migrate_form_templates_post_259);
app.post("/api/migrate-job-forms", migrate_job_forms_post_260);
app.post("/api/migrate-job-photos", migrate_job_photos_post_261);
app.post("/api/migrate-job-tabs", migrate_job_tabs_post_262);
app.post("/api/migrate-jobs", migrate_jobs_post_263);
app.post("/api/migrate-notifications", migrate_notifications_post_264);
app.post("/api/migrate-owner-console", migrate_owner_console_post_265);
app.post("/api/migrate-owner-role", migrate_owner_role_post_266);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_267);
app.post("/api/migrate-safety", migrate_safety_post_268);
app.post("/api/migrate-starter-pack", migrate_starter_pack_post_269);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_270);
app.post("/api/migrate-support-mode", migrate_support_mode_post_271);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_272);
app.post("/api/migrate-team", migrate_team_post_273);
app.get("/api/notifications/alerts", notifications_alerts_get_274);
...
app.post("/api/owner-console/system-ai/builtin-checks", owner_console_system_ai_builtin_checks_post_290);
