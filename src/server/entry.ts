...
app.post("/api/migrate-job-photo-shares", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/migrate-job-photo-shares/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
...
app.post("/api/migrate-ledger-photo", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/migrate-ledger-photo/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
...
app.post("/api/migrate-site-prestart", /* @vite-ignore */ async (req, res, next) => { try { const _m = await import("./api/migrate-site-prestart/POST.js"); return _m.default(req, res, next); } catch(_e) { next(_e); } });
