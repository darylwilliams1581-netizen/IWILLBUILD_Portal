...
import _h_document_templates_id_export_pdf_get_4 from "./api/document-templates/[id]/export/pdf/GET";
import _h_document_templates_id_export_docx_get_5 from "./api/document-templates/[id]/export/docx/GET";
import _h_migrate_fleet_analytics_post_6 from "./api/migrate-fleet-analytics/POST";
import _h_migrate_emergency_alerts_post_7 from "./api/migrate-emergency-alerts/POST";
import _h_form_templates_seed_post_8 from "./api/form-templates/seed/POST";
import _h_jobs_id_ledger_sync_post_9 from "./api/jobs/[id]/ledger/sync/POST";
import _h_jobs_id_purchase_orders_get_10 from "./api/jobs/[id]/purchase-orders/GET";
import _h_jobs_id_purchase_orders_post_11 from "./api/jobs/[id]/purchase-orders/POST";
import _h_jobs_id_purchase_orders_poid_delete_12 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import _h_jobs_id_purchase_orders_poid_get_13 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
import _h_jobs_id_purchase_orders_poid_put_14 from "./api/jobs/[id]/purchase-orders/[poId]/PUT";
import _h_jobs_id_purchase_orders_poid_pdf_get_15 from "./api/jobs/[id]/purchase-orders/[poId]/pdf/GET";
import _h_migrate_account_recovery_post_16 from "./api/migrate-account-recovery/POST";
import _h_migrate_asset_manager_post_17 from "./api/migrate-asset-manager/POST";
import _h_migrate_attendance_post_18 from "./api/migrate-attendance/POST";
import _h_migrate_company_settings_post_19 from "./api/migrate-company-settings/POST";
import _h_migrate_dazza_audit_post_20 from "./api/migrate-dazza-audit/POST";
import _h_migrate_dazza_knowledge_post_21 from "./api/migrate-dazza-knowledge/POST";
...
import document_templates_id_duplicate_post from "./api/document-templates/[id]/duplicate/POST";
...
app.post("/api/document-templates/:id/duplicate", document_templates_id_duplicate_post);
app.get("/api/document-templates/:id/export/pdf", _h_document_templates_id_export_pdf_get_4);
app.get("/api/document-templates/:id/export/docx", _h_document_templates_id_export_docx_get_5);
...
app.post("/api/migrate-fleet-analytics", _h_migrate_fleet_analytics_post_6);
...
app.post("/api/migrate-emergency-alerts", _h_migrate_emergency_alerts_post_7);
...
app.post("/api/form-templates/seed", _h_form_templates_seed_post_8);
...
app.post("/api/jobs/:id/ledger/sync", _h_jobs_id_ledger_sync_post_9);
...
app.get("/api/jobs/:id/purchase-orders", _h_jobs_id_purchase_orders_get_10);
app.post("/api/jobs/:id/purchase-orders", _h_jobs_id_purchase_orders_post_11);
app.delete("/api/jobs/:id/purchase-orders/:poId", _h_jobs_id_purchase_orders_poid_delete_12);
app.get("/api/jobs/:id/purchase-orders/:poId", _h_jobs_id_purchase_orders_poid_get_13);
app.put("/api/jobs/:id/purchase-orders/:poId", _h_jobs_id_purchase_orders_poid_put_14);
app.get("/api/jobs/:id/purchase-orders/:poId/pdf", _h_jobs_id_purchase_orders_poid_pdf_get_15);
...
app.post("/api/migrate-account-recovery", _h_migrate_account_recovery_post_16);
app.post("/api/migrate-asset-manager", _h_migrate_asset_manager_post_17);
app.post("/api/migrate-attendance", _h_migrate_attendance_post_18);
app.post("/api/migrate-company-settings", _h_migrate_company_settings_post_19);
app.post("/api/migrate-dazza-audit", _h_migrate_dazza_audit_post_20);
app.post("/api/migrate-dazza-knowledge", _h_migrate_dazza_knowledge_post_21);
