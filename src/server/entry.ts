...
import auth_trusted_devices_deviceId_clear_pin_patch from "./api/auth/trusted-devices/[deviceId]/clear-pin/PATCH";
...
import me_profile_attachments_download_get from "./api/me/profile-attachments/download/GET";
import me_profile_attachments_thumbnail_get from "./api/me/profile-attachments/thumbnail/GET";
...
import safety_swms_get_616 from "./api/safety/swms/GET";
import safety_swms_post_617 from "./api/safety/swms/POST";
import safety_swms_import_docx_post_618 from "./api/safety/swms/import-docx/POST";
import safety_swms_seed_post_619 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_620 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_621 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_622 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_623 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_624 from "./api/safety/swms/[id]/export/GET";
import safety_swms_id_publish_to_library_post_625 from "./api/safety/swms/[id]/publish-to-library/POST";
import scheduler_crew_get_626 from "./api/scheduler/crew/GET";
import scheduler_jobs_get_627 from "./api/scheduler/jobs/GET";
import scheduler_jobs_id_reschedule_patch_628 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
import scheduler_tasks_get_629 from "./api/scheduler/tasks/GET";
import secure_share_get_630 from "./api/secure-share/GET";
import secure_share_post_631 from "./api/secure-share/POST";
import secure_share_id_delete_632 from "./api/secure-share/[id]/DELETE";
import secure_share_token_get_633 from "./api/secure-share/[token]/GET";
import secure_share_token_post_634 from "./api/secure-share/[token]/POST";
import settings_backup_get_635 from "./api/settings/backup/GET";
import settings_backup_post_636 from "./api/settings/backup/POST";
import settings_backup_company_data_get_637 from "./api/settings/backup/company-data/GET";
import settings_backup_csv_pack_get_638 from "./api/settings/backup/csv-pack/GET";
import settings_backup_export_get_639 from "./api/settings/backup/export/GET";
import settings_backup_run_post_640 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_641 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_642 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_643 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_644 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_645 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_646 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_647 from "./api/settings/retention/GET";
import settings_retention_post_648 from "./api/settings/retention/POST";
import settings_storage_provider_get_649 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_650 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_651 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_652 from "./api/settings/terminology/GET";
import settings_terminology_post_653 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_654 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_655 from "./api/settings/xero-credentials/POST";
import share_token_get_656 from "./api/share/[token]/GET";
import signin_history_get_657 from "./api/signin-history/GET";
import signup_post_658 from "./api/signup/POST";
import sos_get_659 from "./api/sos/GET";
import sos_acknowledge_post_660 from "./api/sos/acknowledge/POST";
import sos_trigger_post_661 from "./api/sos/trigger/POST";
import stakeholders_sms_post_662 from "./api/stakeholders/sms/POST";
import stripe_create_checkout_session_post_663 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_664 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_665 from "./api/subscription/create-checkout/POST";
import subscription_status_get_666 from "./api/subscription/status/GET";
import subscription_webhook_post_667 from "./api/subscription/webhook/POST";
import support_mode_audit_get_668 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_669 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_670 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_671 from "./api/support-mode/enter/POST";
import support_mode_exit_post_672 from "./api/support-mode/exit/POST";
import support_mode_status_get_673 from "./api/support-mode/status/GET";
import tag_tasks_get_674 from "./api/tag-tasks/GET";
import tag_tasks_id_patch_675 from "./api/tag-tasks/[id]/PATCH";
import takeoff_pad_get_676 from "./api/takeoff-pad/GET";
import takeoff_pad_put_677 from "./api/takeoff-pad/PUT";
import tasks_post_678 from "./api/tasks/POST";
import tasks_id_put_679 from "./api/tasks/[id]/PUT";
import team_get_680 from "./api/team/GET";
import team_invite_post_681 from "./api/team/invite/POST";
import team_invites_get_682 from "./api/team/invites/GET";
import team_invites_post_683 from "./api/team/invites/POST";
import team_invites_id_cancel_post_684 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_685 from "./api/team/invites/[id]/resend/POST";
import team_members_get_686 from "./api/team/members/GET";
import team_members_id_icon_permissions_get_687 from "./api/team/members/[id]/icon-permissions/GET";
import team_members_id_icon_permissions_put_688 from "./api/team/members/[id]/icon-permissions/PUT";
import team_resend_verification_post_689 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_690 from "./api/team/schedule/migrate/POST";
import team_shifts_get_691 from "./api/team/shifts/GET";
import team_shifts_post_692 from "./api/team/shifts/POST";
import team_shifts_id_delete_693 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_694 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_695 from "./api/team/time-entries/GET";
import team_time_entries_post_696 from "./api/team/time-entries/POST";
import team_time_entries_export_get_697 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_698 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_699 from "./api/team/verify-user/POST";
import team_id_delete_700 from "./api/team/[id]/DELETE";
import team_id_put_701 from "./api/team/[id]/PUT";
import usage_get_702 from "./api/usage/GET";
import user_logs_get_703 from "./api/user-logs/GET";
import user_logs_users_get_704 from "./api/user-logs/users/GET";
// </api-imports>
// ── Job Cards ─────────────────────────────────────────────────────────────────
