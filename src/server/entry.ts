...
import form_global_lists_get_226 from "./api/form-global-lists/GET";
...
import form_templates_id_delete_233 from "./api/form-templates/[id]/DELETE";
import form_templates_id_put_234 from "./api/form-templates/[id]/PUT";
import form_templates_id_publish_to_library_post_235 from "./api/form-templates/[id]/publish-to-library/POST";
import forms_assets_list_get_236 from "./api/forms/assets-list/GET";
import forms_jobs_list_get_237 from "./api/forms/jobs-list/GET";
import forms_migrate_skip_logic_post_238 from "./api/forms/migrate-skip-logic/POST";
import forms_skip_audit_get_239 from "./api/forms/skip-audit/GET";
import forms_skip_audit_post_240 from "./api/forms/skip-audit/POST";
import forms_start_post_241 from "./api/forms/start/POST";
import forms_submissions_get_242 from "./api/forms/submissions/GET";
import forms_templates_id_share_link_post_243 from "./api/forms/templates/[id]/share-link/POST";
import forms_id_fields_get_244 from "./api/forms/[id]/fields/GET";
import forms_id_fields_post_245 from "./api/forms/[id]/fields/POST";
import forms_id_fields_reorder_post_246 from "./api/forms/[id]/fields/reorder/POST";
import forms_id_fields_fieldId_delete_247 from "./api/forms/[id]/fields/[fieldId]/DELETE";
import forms_id_fields_fieldId_patch_248 from "./api/forms/[id]/fields/[fieldId]/PATCH";
import forms_id_fields_fieldId_thumbnail_post_249 from "./api/forms/[id]/fields/[fieldId]/thumbnail/POST";
import health_get_250 from "./api/health/GET";
import incidents_get_251 from "./api/incidents/GET";
import incidents_post_252 from "./api/incidents/POST";
import incidents_id_archive_post_253 from "./api/incidents/[id]/archive/POST";
import incidents_id_unarchive_post_254 from "./api/incidents/[id]/unarchive/POST";
import incidents_incidentId_get_255 from "./api/incidents/[incidentId]/GET";
import incidents_incidentId_put_256 from "./api/incidents/[incidentId]/PUT";
import incidents_incidentId_close_post_257 from "./api/incidents/[incidentId]/close/POST";
import incidents_incidentId_corrective_actions_post_258 from "./api/incidents/[incidentId]/corrective-actions/POST";
...
import integrations_myob_status_get_265 from "./api/integrations/myob/status/GET";
import integrations_myob_sync_invoice_post_266 from "./api/integrations/myob/sync-invoice/POST";
import integrations_onedrive_auth_url_get_267 from "./api/integrations/onedrive/auth-url/GET";
import integrations_onedrive_callback_get_268 from "./api/integrations/onedrive/callback/GET";
import integrations_onedrive_disconnect_post_269 from "./api/integrations/onedrive/disconnect/POST";
import integrations_onedrive_status_get_270 from "./api/integrations/onedrive/status/GET";
import integrations_onedrive_upload_file_post_271 from "./api/integrations/onedrive/upload-file/POST";
import integrations_qbo_auth_url_get_272 from "./api/integrations/qbo/auth-url/GET";
import integrations_qbo_callback_get_273 from "./api/integrations/qbo/callback/GET";
import integrations_qbo_disconnect_post_274 from "./api/integrations/qbo/disconnect/POST";
import integrations_qbo_status_get_275 from "./api/integrations/qbo/status/GET";
import integrations_qbo_sync_invoice_post_276 from "./api/integrations/qbo/sync-invoice/POST";
import integrations_xero_auth_url_get_277 from "./api/integrations/xero/auth-url/GET";
import integrations_xero_callback_get_278 from "./api/integrations/xero/callback/GET";
import integrations_xero_disconnect_post_279 from "./api/integrations/xero/disconnect/POST";
import integrations_xero_status_get_280 from "./api/integrations/xero/status/GET";
import integrations_xero_sync_customer_post_281 from "./api/integrations/xero/sync-customer/POST";
import integrations_xero_sync_invoice_post_282 from "./api/integrations/xero/sync-invoice/POST";
import integrations_xero_webhook_post_283 from "./api/integrations/xero/webhook/POST";
import invoices_get_284 from "./api/invoices/GET";
import invoices_post_285 from "./api/invoices/POST";
import invoices_id_delete_286 from "./api/invoices/[id]/DELETE";
import invoices_id_get_287 from "./api/invoices/[id]/GET";
import invoices_id_put_288 from "./api/invoices/[id]/PUT";
import invoices_id_duplicate_post_289 from "./api/invoices/[id]/duplicate/POST";
import invoices_id_export_pdf_get_290 from "./api/invoices/[id]/export-pdf/GET";
import invoices_id_mark_sent_post_291 from "./api/invoices/[id]/mark-sent/POST";
import invoices_id_record_payment_post_292 from "./api/invoices/[id]/record-payment/POST";
import invoices_id_send_email_post_293 from "./api/invoices/[id]/send-email/POST";
import invoices_id_unlock_patch_294 from "./api/invoices/[id]/unlock/PATCH";
import invoices_id_void_post_295 from "./api/invoices/[id]/void/POST";
import job_cards_get_296 from "./api/job-cards/GET";
import job_cards_post_297 from "./api/job-cards/POST";
import job_cards_id_delete_298 from "./api/job-cards/[id]/DELETE";
import job_cards_id_get_299 from "./api/job-cards/[id]/GET";
import job_cards_id_put_300 from "./api/job-cards/[id]/PUT";
import job_cards_id_convert_post_301 from "./api/job-cards/[id]/convert/POST";
import job_cards_id_invoice_post_302 from "./api/job-cards/[id]/invoice/POST";
import job_cards_id_photos_post_303 from "./api/job-cards/[id]/photos/POST";
import job_cards_id_photos_photoId_delete_304 from "./api/job-cards/[id]/photos/[photoId]/DELETE";
import job_costs_post_305 from "./api/job-costs/POST";
import job_forms_id_delete_306 from "./api/job-forms/[id]/DELETE";
import job_forms_id_get_307 from "./api/job-forms/[id]/GET";
import job_forms_id_put_308 from "./api/job-forms/[id]/PUT";
import job_forms_id_reset_post_309 from "./api/job-forms/[id]/reset/POST";
import job_forms_id_share_delete_310 from "./api/job-forms/[id]/share/DELETE";
import job_forms_id_share_get_311 from "./api/job-forms/[id]/share/GET";
import job_forms_id_share_post_312 from "./api/job-forms/[id]/share/POST";
import jobs_get_313 from "./api/jobs/GET";
import jobs_post_314 from "./api/jobs/POST";
import jobs_report_generate_post_315 from "./api/jobs/report/generate/POST";
import jobs_id_get_316 from "./api/jobs/[id]/GET";
import jobs_id_put_317 from "./api/jobs/[id]/PUT";
import jobs_id_attendance_attendanceId_close_post_318 from "./api/jobs/[id]/attendance/[attendanceId]/close/POST";
import jobs_id_costs_get_319 from "./api/jobs/[id]/costs/GET";
import jobs_id_costs_post_320 from "./api/jobs/[id]/costs/POST";
import jobs_id_costs_export_get_321 from "./api/jobs/[id]/costs/export/GET";
import jobs_id_costs_costId_delete_322 from "./api/jobs/[id]/costs/[costId]/DELETE";
import jobs_id_costs_costId_put_323 from "./api/jobs/[id]/costs/[costId]/PUT";
import jobs_id_costs_costId_receipt_get_324 from "./api/jobs/[id]/costs/[costId]/receipt/GET";
import jobs_id_costs_costId_receipt_post_325 from "./api/jobs/[id]/costs/[costId]/receipt/POST";
import jobs_id_delays_get_326 from "./api/jobs/[id]/delays/GET";
import jobs_id_delays_post_327 from "./api/jobs/[id]/delays/POST";
import jobs_id_delays_export_csv_get_328 from "./api/jobs/[id]/delays/export-csv/GET";
import jobs_id_delays_delayId_delete_329 from "./api/jobs/[id]/delays/[delayId]/DELETE";
import jobs_id_delays_delayId_put_330 from "./api/jobs/[id]/delays/[delayId]/PUT";
import jobs_id_documents_get_331 from "./api/jobs/[id]/documents/GET";
import jobs_id_documents_post_332 from "./api/jobs/[id]/documents/POST";
import jobs_id_export_zip_get_333 from "./api/jobs/[id]/export-zip/GET";
import jobs_id_field_docs_get_334 from "./api/jobs/[id]/field-docs/GET";
import jobs_id_files_get_335 from "./api/jobs/[id]/files/GET";
import jobs_id_forms_get_336 from "./api/jobs/[id]/forms/GET";
import jobs_id_forms_post_337 from "./api/jobs/[id]/forms/POST";
import jobs_id_forms_export_csv_get_338 from "./api/jobs/[id]/forms/export-csv/GET";
import jobs_id_forms_submissionId_delete_339 from "./api/jobs/[id]/forms/[submissionId]/DELETE";
import jobs_id_forms_submissionId_reopen_post_340 from "./api/jobs/[id]/forms/[submissionId]/reopen/POST";
import jobs_id_generate_qr_post_341 from "./api/jobs/[id]/generate-qr/POST";
import jobs_id_ledger_get_342 from "./api/jobs/[id]/ledger/GET";
import jobs_id_ledger_post_343 from "./api/jobs/[id]/ledger/POST";
import jobs_id_ledger_export_get_344 from "./api/jobs/[id]/ledger/export/GET";
import jobs_id_ledger_sync_post_345 from "./api/jobs/[id]/ledger/sync/POST";
import jobs_id_ledger_entryId_delete_346 from "./api/jobs/[id]/ledger/[entryId]/DELETE";
import jobs_id_ledger_entryId_put_347 from "./api/jobs/[id]/ledger/[entryId]/PUT";
import jobs_id_ledger_entryId_correct_post_348 from "./api/jobs/[id]/ledger/[entryId]/correct/POST";
import jobs_id_milestones_get_349 from "./api/jobs/[id]/milestones/GET";
import jobs_id_milestones_post_350 from "./api/jobs/[id]/milestones/POST";
import jobs_id_milestones_milestoneId_delete_351 from "./api/jobs/[id]/milestones/[milestoneId]/DELETE";
import jobs_id_milestones_milestoneId_patch_352 from "./api/jobs/[id]/milestones/[milestoneId]/PATCH";
import jobs_id_notes_export_csv_get_353 from "./api/jobs/[id]/notes/export-csv/GET";
import jobs_id_photos_get_354 from "./api/jobs/[id]/photos/GET";
import jobs_id_photos_post_355 from "./api/jobs/[id]/photos/POST";
import jobs_id_photos_export_zip_post_356 from "./api/jobs/[id]/photos/export-zip/POST";
import jobs_id_photos_picker_get_357 from "./api/jobs/[id]/photos/picker/GET";
import jobs_id_photos_share_post_358 from "./api/jobs/[id]/photos/share/POST";
import jobs_id_photos_photoId_delete_359 from "./api/jobs/[id]/photos/[photoId]/DELETE";
import jobs_id_photos_photoId_patch_360 from "./api/jobs/[id]/photos/[photoId]/PATCH";
import jobs_id_photos_photoId_download_get_361 from "./api/jobs/[id]/photos/[photoId]/download/GET";
import jobs_id_photos_photoId_replace_post_362 from "./api/jobs/[id]/photos/[photoId]/replace/POST";
import jobs_id_photos_photoId_report_image_get_363 from "./api/jobs/[id]/photos/[photoId]/report-image/GET";
import jobs_id_progress_get_364 from "./api/jobs/[id]/progress/GET";
import jobs_id_progress_put_365 from "./api/jobs/[id]/progress/PUT";
import jobs_id_progress_export_csv_get_366 from "./api/jobs/[id]/progress/export-csv/GET";
import jobs_id_progress_report_get_367 from "./api/jobs/[id]/progress/report/GET";
import jobs_id_progress_report_put_368 from "./api/jobs/[id]/progress/report/PUT";
import jobs_id_progress_report_pdf_get_369 from "./api/jobs/[id]/progress/report/pdf/GET";
import jobs_id_progress_sync_post_370 from "./api/jobs/[id]/progress/sync/POST";
import jobs_id_purchase_orders_get_371 from "./api/jobs/[id]/purchase-orders/GET";
import jobs_id_purchase_orders_post_372 from "./api/jobs/[id]/purchase-orders/POST";
import jobs_id_purchase_orders_poId_delete_373 from "./api/jobs/[id]/purchase-orders/[poId]/DELETE";
import jobs_id_purchase_orders_poId_get_374 from "./api/jobs/[id]/purchase-orders/[poId]/GET";
import jobs_id_purchase_orders_poId_put_375 from "./api/jobs/[id]/purchase-orders/[poId]/PUT";
import jobs_id_purchase_orders_poId_pdf_get_376 from "./api/jobs/[id]/purchase-orders/[poId]/pdf/GET";
import jobs_id_report_pdf_post_377 from "./api/jobs/[id]/report/pdf/POST";
import jobs_id_risky_get_378 from "./api/jobs/[id]/risky/GET";
import jobs_id_risky_post_379 from "./api/jobs/[id]/risky/POST";
import jobs_id_risky_riskyId_get_380 from "./api/jobs/[id]/risky/[riskyId]/GET";
import jobs_id_risky_riskyId_put_381 from "./api/jobs/[id]/risky/[riskyId]/PUT";
import jobs_id_risky_riskyId_finalise_post_382 from "./api/jobs/[id]/risky/[riskyId]/finalise/POST";
import jobs_id_risky_riskyId_signatures_post_383 from "./api/jobs/[id]/risky/[riskyId]/signatures/POST";
import jobs_id_risky_riskyId_supervisor_signoff_post_384 from "./api/jobs/[id]/risky/[riskyId]/supervisor-signoff/POST";
import jobs_id_signin_post_385 from "./api/jobs/[id]/signin/POST";
import jobs_id_signin_qr_post_386 from "./api/jobs/[id]/signin-qr/POST";
import jobs_id_signin_status_get_387 from "./api/jobs/[id]/signin-status/GET";
import jobs_id_signout_post_388 from "./api/jobs/[id]/signout/POST";
import jobs_id_signout_qr_post_389 from "./api/jobs/[id]/signout-qr/POST";
import jobs_id_signout_user_post_390 from "./api/jobs/[id]/signout-user/POST";
import jobs_id_site_prestarts_get_391 from "./api/jobs/[id]/site-prestarts/GET";
import jobs_id_site_prestarts_post_392 from "./api/jobs/[id]/site-prestarts/POST";
import jobs_id_site_prestarts_prestartId_get_393 from "./api/jobs/[id]/site-prestarts/[prestartId]/GET";
import jobs_id_site_prestarts_prestartId_put_394 from "./api/jobs/[id]/site-prestarts/[prestartId]/PUT";
import jobs_id_site_prestarts_prestartId_finalise_post_395 from "./api/jobs/[id]/site-prestarts/[prestartId]/finalise/POST";
import jobs_id_site_prestarts_prestartId_workers_post_396 from "./api/jobs/[id]/site-prestarts/[prestartId]/workers/POST";
import jobs_id_swms_get_397 from "./api/jobs/[id]/swms/GET";
import jobs_id_swms_post_398 from "./api/jobs/[id]/swms/POST";
import jobs_id_swms_swmsId_signoff_post_399 from "./api/jobs/[id]/swms/[swmsId]/signoff/POST";
import jobs_id_todos_get_400 from "./api/jobs/[id]/todos/GET";
import jobs_id_todos_post_401 from "./api/jobs/[id]/todos/POST";
import jobs_id_todos_todoId_delete_402 from "./api/jobs/[id]/todos/[todoId]/DELETE";
import jobs_id_todos_todoId_put_403 from "./api/jobs/[id]/todos/[todoId]/PUT";
import library_items_get_404 from "./api/library/items/GET";
import library_items_id_get_405 from "./api/library/items/[id]/GET";
import library_items_id_patch_406 from "./api/library/items/[id]/PATCH";
import library_items_id_download_get_407 from "./api/library/items/[id]/download/GET";
import library_items_id_install_delete_408 from "./api/library/items/[id]/install/DELETE";
import library_items_id_install_post_409 from "./api/library/items/[id]/install/POST";
import library_my_installed_get_410 from "./api/library/my-installed/GET";
import library_my_submissions_get_411 from "./api/library/my-submissions/GET";
import lists_get_412 from "./api/lists/GET";
import me_get_413 from "./api/me/GET";
import me_put_414 from "./api/me/PUT";
import me_2fa_disable_post_415 from "./api/me/2fa/disable/POST";
import me_2fa_enable_post_416 from "./api/me/2fa/enable/POST";
import me_2fa_setup_get_417 from "./api/me/2fa/setup/GET";
import me_2fa_status_get_418 from "./api/me/2fa/status/GET";
import me_2fa_verify_post_419 from "./api/me/2fa/verify/POST";
import me_active_status_get_420 from "./api/me/active-status/GET";
import me_change_password_post_421 from "./api/me/change-password/POST";
import me_email_status_get_422 from "./api/me/email-status/GET";
import me_phone_get_423 from "./api/me/phone/GET";
import me_phone_put_424 from "./api/me/phone/PUT";
import me_profile_attachments_delete_425 from "./api/me/profile-attachments/DELETE";
import me_profile_attachments_post_426 from "./api/me/profile-attachments/POST";
import me_profile_extras_get_427 from "./api/me/profile-extras/GET";
import me_profile_extras_put_428 from "./api/me/profile-extras/PUT";
import migrate_account_recovery_post_429 from "./api/migrate-account-recovery/POST";
import migrate_asset_manager_post_430 from "./api/migrate-asset-manager/POST";
import migrate_attendance_post_431 from "./api/migrate-attendance/POST";
import migrate_company_settings_post_432 from "./api/migrate-company-settings/POST";
import migrate_dazza_audit_post_433 from "./api/migrate-dazza-audit/POST";
import migrate_dazza_knowledge_post_434 from "./api/migrate-dazza-knowledge/POST";
import migrate_emergency_alerts_post_435 from "./api/migrate-emergency-alerts/POST";
import migrate_estimates_post_436 from "./api/migrate-estimates/POST";
import migrate_estimating_library_post_437 from "./api/migrate-estimating-library/POST";
import migrate_files_post_438 from "./api/migrate-files/POST";
import migrate_fleet_post_439 from "./api/migrate-fleet/POST";
import migrate_fleet_analytics_post_440 from "./api/migrate-fleet-analytics/POST";
import migrate_fleet_driver_sessions_post_441 from "./api/migrate-fleet-driver-sessions/POST";
import migrate_fleet_usage_post_442 from "./api/migrate-fleet-usage/POST";
import migrate_form_fields_post_443 from "./api/migrate-form-fields/POST";
import migrate_form_logic_post_444 from "./api/migrate-form-logic/POST";
import migrate_form_templates_post_445 from "./api/migrate-form-templates/POST";
import migrate_job_forms_post_446 from "./api/migrate-job-forms/POST";
import migrate_job_photo_shares_post_447 from "./api/migrate-job-photo-shares/POST";
import migrate_job_photos_post_448 from "./api/migrate-job-photos/POST";
import migrate_job_tabs_post_449 from "./api/migrate-job-tabs/POST";
import migrate_jobs_post_450 from "./api/migrate-jobs/POST";
import migrate_ledger_photo_post_451 from "./api/migrate-ledger-photo/POST";
import migrate_library_post_452 from "./api/migrate-library/POST";
import migrate_library_downloads_post_453 from "./api/migrate-library-downloads/POST";
import migrate_notifications_post_454 from "./api/migrate-notifications/POST";
import migrate_owner_console_post_455 from "./api/migrate-owner-console/POST";
import migrate_owner_role_post_456 from "./api/migrate-owner-role/POST";
import migrate_pdf_settings_post_457 from "./api/migrate-pdf-settings/POST";
import migrate_plan_manager_post_458 from "./api/migrate-plan-manager/POST";
import migrate_plan_manager_v2_post_459 from "./api/migrate-plan-manager-v2/POST";
import migrate_plan_manager_v3_post_460 from "./api/migrate-plan-manager-v3/POST";
import migrate_safety_post_461 from "./api/migrate-safety/POST";
import migrate_site_prestart_post_462 from "./api/migrate-site-prestart/POST";
import migrate_sms_verified_at_post_463 from "./api/migrate-sms-verified-at/POST";
import migrate_starter_pack_post_464 from "./api/migrate-starter-pack/POST";
import migrate_studio_pdf_post_465 from "./api/migrate-studio-pdf/POST";
import migrate_subscriptions_post_466 from "./api/migrate-subscriptions/POST";
import migrate_support_mode_post_467 from "./api/migrate-support-mode/POST";
import migrate_takeoff_pad_post_468 from "./api/migrate-takeoff-pad/POST";
import migrate_team_post_469 from "./api/migrate-team/POST";
import notes_get_470 from "./api/notes/GET";
import notes_post_471 from "./api/notes/POST";
import notes_comments_post_472 from "./api/notes/comments/POST";
import notes_migrate_post_473 from "./api/notes/migrate/POST";
import notes_id_delete_474 from "./api/notes/[id]/DELETE";
import notifications_alerts_get_475 from "./api/notifications/alerts/GET";
import notifications_prefs_get_476 from "./api/notifications/prefs/GET";
import notifications_prefs_put_477 from "./api/notifications/prefs/PUT";
import notifications_read_post_478 from "./api/notifications/read/POST";
import owner_console_activity_get_479 from "./api/owner-console/activity/GET";
import owner_console_cancellation_feedback_get_480 from "./api/owner-console/cancellation-feedback/GET";
import owner_console_companies_get_481 from "./api/owner-console/companies/GET";
import owner_console_companies_post_482 from "./api/owner-console/companies/POST";
import owner_console_companies_usage_get_483 from "./api/owner-console/companies/usage/GET";
import owner_console_companies_id_limits_put_484 from "./api/owner-console/companies/[id]/limits/PUT";
import owner_console_form_templates_get_485 from "./api/owner-console/form-templates/GET";
import owner_console_form_templates_post_486 from "./api/owner-console/form-templates/POST";
import owner_console_library_items_get_487 from "./api/owner-console/library/items/GET";
import owner_console_library_items_post_488 from "./api/owner-console/library/items/POST";
import owner_console_library_items_id_delete_489 from "./api/owner-console/library/items/[id]/DELETE";
import owner_console_library_items_id_patch_490 from "./api/owner-console/library/items/[id]/PATCH";
import owner_console_library_items_id_put_491 from "./api/owner-console/library/items/[id]/PUT";
import owner_console_library_items_id_push_update_post_492 from "./api/owner-console/library/items/[id]/push-update/POST";
import owner_console_library_submissions_get_493 from "./api/owner-console/library/submissions/GET";
import owner_console_library_submissions_id_review_post_494 from "./api/owner-console/library/submissions/[id]/review/POST";
import owner_console_starter_pack_get_495 from "./api/owner-console/starter-pack/GET";
import owner_console_starter_pack_post_496 from "./api/owner-console/starter-pack/POST";
import owner_console_stats_get_497 from "./api/owner-console/stats/GET";
import owner_console_storage_get_498 from "./api/owner-console/storage/GET";
import owner_console_swms_masters_get_499 from "./api/owner-console/swms/masters/GET";
import owner_console_swms_masters_post_500 from "./api/owner-console/swms/masters/POST";
import owner_console_swms_masters_publish_all_post_501 from "./api/owner-console/swms/masters/publish-all/POST";
import owner_console_swms_masters_id_delete_502 from "./api/owner-console/swms/masters/[id]/DELETE";
import owner_console_swms_masters_id_get_503 from "./api/owner-console/swms/masters/[id]/GET";
import owner_console_swms_masters_id_put_504 from "./api/owner-console/swms/masters/[id]/PUT";
import owner_console_swms_masters_id_publish_post_505 from "./api/owner-console/swms/masters/[id]/publish/POST";
import owner_console_swms_migrate_master_library_post_506 from "./api/owner-console/swms/migrate-master-library/POST";
import owner_console_swms_push_post_507 from "./api/owner-console/swms/push/POST";
import owner_console_swms_seed_bricklaying_post_508 from "./api/owner-console/swms/seed-bricklaying/POST";
import owner_console_swms_seed_building_inspection_post_509 from "./api/owner-console/swms/seed-building-inspection/POST";
import owner_console_swms_seed_cabinets_post_510 from "./api/owner-console/swms/seed-cabinets/POST";
import owner_console_swms_seed_carpenter_fixing_post_511 from "./api/owner-console/swms/seed-carpenter-fixing/POST";
import owner_console_swms_seed_carpenter_framing_post_512 from "./api/owner-console/swms/seed-carpenter-framing/POST";
import owner_console_swms_seed_carpenter_lockup_post_513 from "./api/owner-console/swms/seed-carpenter-lockup/POST";
import owner_console_swms_seed_ceramic_tiling_post_514 from "./api/owner-console/swms/seed-ceramic-tiling/POST";
import owner_console_swms_seed_concreting_slab_post_515 from "./api/owner-console/swms/seed-concreting-slab/POST";
import owner_console_swms_seed_delivery_loading_post_516 from "./api/owner-console/swms/seed-delivery-loading/POST";
import owner_console_swms_seed_environmental_spill_post_517 from "./api/owner-console/swms/seed-environmental-spill/POST";
import owner_console_swms_seed_ewp_post_518 from "./api/owner-console/swms/seed-ewp/POST";
import owner_console_swms_seed_excavations_substation_post_519 from "./api/owner-console/swms/seed-excavations-substation/POST";
import owner_console_swms_seed_fencing_post_520 from "./api/owner-console/swms/seed-fencing/POST";
import owner_console_swms_seed_heat_stress_post_521 from "./api/owner-console/swms/seed-heat-stress/POST";
import owner_console_swms_seed_landscaping_post_522 from "./api/owner-console/swms/seed-landscaping/POST";
import owner_console_swms_seed_live_parts_post_523 from "./api/owner-console/swms/seed-live-parts/POST";
import owner_console_swms_seed_manual_handling_post_524 from "./api/owner-console/swms/seed-manual-handling/POST";
import owner_console_swms_seed_moving_plant_post_525 from "./api/owner-console/swms/seed-moving-plant/POST";
import owner_console_swms_seed_painting_post_526 from "./api/owner-console/swms/seed-painting/POST";
import owner_console_swms_seed_power_tools_post_527 from "./api/owner-console/swms/seed-power-tools/POST";
import owner_console_swms_seed_silica_dust_post_528 from "./api/owner-console/swms/seed-silica-dust/POST";
import owner_console_swms_seed_traffic_management_post_529 from "./api/owner-console/swms/seed-traffic-management/POST";
import owner_console_swms_seed_underground_services_post_530 from "./api/owner-console/swms/seed-underground-services/POST";
import owner_console_swms_seed_vacuum_excavation_post_531 from "./api/owner-console/swms/seed-vacuum-excavation/POST";
import owner_console_system_ai_builtin_checks_post_532 from "./api/owner-console/system-ai/builtin-checks/POST";
import owner_console_users_get_533 from "./api/owner-console/users/GET";
import owner_console_users_verify_post_534 from "./api/owner-console/users/verify/POST";
import plan_manager_drawings_get_535 from "./api/plan-manager/drawings/GET";
import plan_manager_drawings_post_536 from "./api/plan-manager/drawings/POST";
import plan_manager_drawings_id_get_537 from "./api/plan-manager/drawings/[id]/GET";
import plan_manager_drawings_id_annotations_put_538 from "./api/plan-manager/drawings/[id]/annotations/PUT";
import plan_manager_drawings_id_archive_post_539 from "./api/plan-manager/drawings/[id]/archive/POST";
import plan_manager_drawings_id_job_links_delete_540 from "./api/plan-manager/drawings/[id]/job-links/DELETE";
import plan_manager_drawings_id_job_links_post_541 from "./api/plan-manager/drawings/[id]/job-links/POST";
import plan_manager_drawings_id_pages_pageNo_annotations_get_542 from "./api/plan-manager/drawings/[id]/pages/[pageNo]/annotations/GET";
import plan_manager_drawings_id_permanent_delete_543 from "./api/plan-manager/drawings/[id]/permanent/DELETE";
import plan_manager_drawings_id_reorder_patch_544 from "./api/plan-manager/drawings/[id]/reorder/PATCH";
import plan_manager_drawings_id_restore_post_545 from "./api/plan-manager/drawings/[id]/restore/POST";
import plan_manager_drawings_id_revisions_post_546 from "./api/plan-manager/drawings/[id]/revisions/POST";
import plan_manager_drawings_id_revisions_revisionId_finalize_post_547 from "./api/plan-manager/drawings/[id]/revisions/[revisionId]/finalize/POST";
import plan_manager_drawings_id_upload_post_548 from "./api/plan-manager/drawings/[id]/upload/POST";
import plan_manager_jobs_jobId_drawings_zip_get_549 from "./api/plan-manager/jobs/[jobId]/drawings-zip/GET";
import plan_manager_jobs_with_drawings_get_550 from "./api/plan-manager/jobs-with-drawings/GET";
import plan_manager_share_post_551 from "./api/plan-manager/share/POST";
import plan_manager_share_validate_get_552 from "./api/plan-manager/share/validate/GET";
import portal_estimates_id_approve_post_553 from "./api/portal/estimates/[id]/approve/POST";
import portal_invite_post_554 from "./api/portal/invite/POST";
import portal_invoices_id_pay_post_555 from "./api/portal/invoices/[id]/pay/POST";
import portal_jobs_get_556 from "./api/portal/jobs/GET";
import portal_jobs_id_get_557 from "./api/portal/jobs/[id]/GET";
import portal_migrate_post_558 from "./api/portal/migrate/POST";
import portal_validate_post_559 from "./api/portal/validate/POST";
import public_form_token_get_560 from "./api/public/form/[token]/GET";
import public_form_token_submit_post_561 from "./api/public/form/[token]/submit/POST";
import public_job_photos_token_get_562 from "./api/public/job-photos/[token]/GET";
import public_job_photos_token_photo_photoId_get_563 from "./api/public/job-photos/[token]/photo/[photoId]/GET";
import public_swms_token_get_564 from "./api/public/swms/[token]/GET";
import public_swms_token_signoff_post_565 from "./api/public/swms/[token]/signoff/POST";
import push_subscribe_delete_566 from "./api/push/subscribe/DELETE";
import push_subscribe_post_567 from "./api/push/subscribe/POST";
import push_vapid_key_get_568 from "./api/push/vapid-key/GET";
import quick_links_site_meta_get_569 from "./api/quick-links/site-meta/GET";
import recipes_get_570 from "./api/recipes/GET";
import recipes_post_571 from "./api/recipes/POST";
import recipes_id_delete_572 from "./api/recipes/[id]/DELETE";
import recipes_id_put_573 from "./api/recipes/[id]/PUT";
import risk_register_get_574 from "./api/risk-register/GET";
import risk_register_post_575 from "./api/risk-register/POST";
import risk_register_id_get_576 from "./api/risk-register/[id]/GET";
import risk_register_id_put_577 from "./api/risk-register/[id]/PUT";
import risk_register_id_archive_post_578 from "./api/risk-register/[id]/archive/POST";
import risk_register_id_unarchive_post_579 from "./api/risk-register/[id]/unarchive/POST";
import safety_ai_draft_post_580 from "./api/safety/ai/draft/POST";
import safety_documents_get_581 from "./api/safety/documents/GET";
import safety_documents_post_582 from "./api/safety/documents/POST";
import safety_documents_id_delete_583 from "./api/safety/documents/[id]/DELETE";
import safety_documents_id_download_get_584 from "./api/safety/documents/[id]/download/GET";
import safety_generated_posters_get_585 from "./api/safety/generated-posters/GET";
import safety_generated_posters_post_586 from "./api/safety/generated-posters/POST";
import safety_generated_posters_id_delete_587 from "./api/safety/generated-posters/[id]/DELETE";
import safety_job_safety_plans_get_588 from "./api/safety/job-safety-plans/GET";
import safety_job_safety_plans_post_589 from "./api/safety/job-safety-plans/POST";
import safety_job_safety_plans_id_delete_590 from "./api/safety/job-safety-plans/[id]/DELETE";
import safety_job_safety_plans_id_put_591 from "./api/safety/job-safety-plans/[id]/PUT";
import safety_job_swms_get_592 from "./api/safety/job-swms/GET";
import safety_job_swms_post_593 from "./api/safety/job-swms/POST";
import safety_job_swms_id_delete_594 from "./api/safety/job-swms/[id]/DELETE";
import safety_job_swms_id_get_595 from "./api/safety/job-swms/[id]/GET";
import safety_job_swms_id_put_596 from "./api/safety/job-swms/[id]/PUT";
import safety_job_swms_id_share_token_post_597 from "./api/safety/job-swms/[id]/share-token/POST";
import safety_job_swms_id_signoffs_get_598 from "./api/safety/job-swms/[id]/signoffs/GET";
import safety_job_swms_id_signoffs_post_599 from "./api/safety/job-swms/[id]/signoffs/POST";
import safety_job_swms_id_signoffs_signoffId_delete_600 from "./api/safety/job-swms/[id]/signoffs/[signoffId]/DELETE";
import safety_plans_get_601 from "./api/safety/plans/GET";
import safety_plans_post_602 from "./api/safety/plans/POST";
import safety_plans_seed_post_603 from "./api/safety/plans/seed/POST";
import safety_plans_id_delete_604 from "./api/safety/plans/[id]/DELETE";
import safety_plans_id_put_605 from "./api/safety/plans/[id]/PUT";
import safety_plans_id_export_get_606 from "./api/safety/plans/[id]/export/GET";
import safety_plans_id_pack_get_607 from "./api/safety/plans/[id]/pack/GET";
import safety_posters_get_608 from "./api/safety/posters/GET";
import safety_posters_post_609 from "./api/safety/posters/POST";
import safety_posters_id_delete_610 from "./api/safety/posters/[id]/DELETE";
import safety_swms_get_611 from "./api/safety/swms/GET";
import safety_swms_post_612 from "./api/safety/swms/POST";
import safety_swms_import_docx_post_613 from "./api/safety/swms/import-docx/POST";
import safety_swms_seed_post_614 from "./api/safety/swms/seed/POST";
import safety_swms_id_delete_615 from "./api/safety/swms/[id]/DELETE";
import safety_swms_id_get_616 from "./api/safety/swms/[id]/GET";
import safety_swms_id_put_617 from "./api/safety/swms/[id]/PUT";
import safety_swms_id_duplicate_post_618 from "./api/safety/swms/[id]/duplicate/POST";
import safety_swms_id_export_get_619 from "./api/safety/swms/[id]/export/GET";
import safety_swms_id_publish_to_library_post_620 from "./api/safety/swms/[id]/publish-to-library/POST";
import scheduler_crew_get_621 from "./api/scheduler/crew/GET";
import scheduler_jobs_get_622 from "./api/scheduler/jobs/GET";
import scheduler_jobs_id_reschedule_patch_623 from "./api/scheduler/jobs/[id]/reschedule/PATCH";
import scheduler_tasks_get_624 from "./api/scheduler/tasks/GET";
import secure_share_get_625 from "./api/secure-share/GET";
import secure_share_post_626 from "./api/secure-share/POST";
import secure_share_id_delete_627 from "./api/secure-share/[id]/DELETE";
import secure_share_token_get_628 from "./api/secure-share/[token]/GET";
import secure_share_token_post_629 from "./api/secure-share/[token]/POST";
import settings_backup_get_630 from "./api/settings/backup/GET";
import settings_backup_post_631 from "./api/settings/backup/POST";
import settings_backup_company_data_get_632 from "./api/settings/backup/company-data/GET";
import settings_backup_csv_pack_get_633 from "./api/settings/backup/csv-pack/GET";
import settings_backup_export_get_634 from "./api/settings/backup/export/GET";
import settings_backup_run_post_635 from "./api/settings/backup/run/POST";
import settings_backup_destination_get_636 from "./api/settings/backup-destination/GET";
import settings_backup_destination_post_637 from "./api/settings/backup-destination/POST";
import settings_dazza_ai_key_get_638 from "./api/settings/dazza-ai-key/GET";
import settings_dazza_ai_key_post_639 from "./api/settings/dazza-ai-key/POST";
import settings_file_transfer_backup_get_640 from "./api/settings/file-transfer-backup/GET";
import settings_file_transfer_backup_post_641 from "./api/settings/file-transfer-backup/POST";
import settings_retention_get_642 from "./api/settings/retention/GET";
import settings_retention_post_643 from "./api/settings/retention/POST";
import settings_storage_provider_get_644 from "./api/settings/storage-provider/GET";
import settings_storage_provider_debug_get_645 from "./api/settings/storage-provider/debug/GET";
import settings_storage_provider_test_post_646 from "./api/settings/storage-provider/test/POST";
import settings_terminology_get_647 from "./api/settings/terminology/GET";
import settings_terminology_post_648 from "./api/settings/terminology/POST";
import settings_xero_credentials_get_649 from "./api/settings/xero-credentials/GET";
import settings_xero_credentials_post_650 from "./api/settings/xero-credentials/POST";
import share_token_get_651 from "./api/share/[token]/GET";
import signin_history_get_652 from "./api/signin-history/GET";
import signup_post_653 from "./api/signup/POST";
import sos_get_654 from "./api/sos/GET";
import sos_acknowledge_post_655 from "./api/sos/acknowledge/POST";
import sos_trigger_post_656 from "./api/sos/trigger/POST";
import stakeholders_sms_post_657 from "./api/stakeholders/sms/POST";
import stripe_create_checkout_session_post_658 from "./api/stripe/create-checkout-session/POST";
import stripe_session_sessionId_get_659 from "./api/stripe/session/[sessionId]/GET";
import subscription_create_checkout_post_660 from "./api/subscription/create-checkout/POST";
import subscription_status_get_661 from "./api/subscription/status/GET";
import subscription_webhook_post_662 from "./api/subscription/webhook/POST";
import support_mode_audit_get_663 from "./api/support-mode/audit/GET";
import support_mode_checklist_get_664 from "./api/support-mode/checklist/GET";
import support_mode_checklist_put_665 from "./api/support-mode/checklist/PUT";
import support_mode_enter_post_666 from "./api/support-mode/enter/POST";
import support_mode_exit_post_667 from "./api/support-mode/exit/POST";
import support_mode_status_get_668 from "./api/support-mode/status/GET";
import tag_tasks_get_669 from "./api/tag-tasks/GET";
import tag_tasks_id_patch_670 from "./api/tag-tasks/[id]/PATCH";
import takeoff_pad_get_671 from "./api/takeoff-pad/GET";
import takeoff_pad_put_672 from "./api/takeoff-pad/PUT";
import tasks_post_673 from "./api/tasks/POST";
import tasks_id_put_674 from "./api/tasks/[id]/PUT";
import team_get_675 from "./api/team/GET";
import team_invite_post_676 from "./api/team/invite/POST";
import team_invites_get_677 from "./api/team/invites/GET";
import team_invites_post_678 from "./api/team/invites/POST";
import team_invites_id_cancel_post_679 from "./api/team/invites/[id]/cancel/POST";
import team_invites_id_resend_post_680 from "./api/team/invites/[id]/resend/POST";
import team_members_get_681 from "./api/team/members/GET";
import team_members_id_icon_permissions_get_682 from "./api/team/members/[id]/icon-permissions/GET";
import team_members_id_icon_permissions_put_683 from "./api/team/members/[id]/icon-permissions/PUT";
import team_resend_verification_post_684 from "./api/team/resend-verification/POST";
import team_schedule_migrate_post_685 from "./api/team/schedule/migrate/POST";
import team_shifts_get_686 from "./api/team/shifts/GET";
import team_shifts_post_687 from "./api/team/shifts/POST";
import team_shifts_id_delete_688 from "./api/team/shifts/[id]/DELETE";
import team_shifts_id_put_689 from "./api/team/shifts/[id]/PUT";
import team_time_entries_get_690 from "./api/team/time-entries/GET";
import team_time_entries_post_691 from "./api/team/time-entries/POST";
import team_time_entries_export_get_692 from "./api/team/time-entries/export/GET";
import team_time_entries_id_put_693 from "./api/team/time-entries/[id]/PUT";
import team_verify_user_post_694 from "./api/team/verify-user/POST";
import team_id_delete_695 from "./api/team/[id]/DELETE";
import team_id_put_696 from "./api/team/[id]/PUT";
import usage_get_697 from "./api/usage/GET";
import user_logs_get_698 from "./api/user-logs/GET";
import user_logs_users_get_699 from "./api/user-logs/users/GET";
// </api-imports>
// ── Job Cards ─────────────────────────────────────────────────────────────────
...
app.post("/api/incidents/:incidentId/close", incidents_incidentId_close_post_257);
app.post("/api/incidents/:incidentId/corrective-actions", incidents_incidentId_corrective_actions_post_258);
...
app.get("/api/integrations/myob/status", integrations_myob_status_get_265);
app.post("/api/integrations/myob/sync-invoice", integrations_myob_sync_invoice_post_266);
app.get("/api/integrations/onedrive/auth-url", integrations_onedrive_auth_url_get_267);
app.get("/api/integrations/onedrive/callback", integrations_onedrive_callback_get_268);
app.post("/api/integrations/onedrive/disconnect", integrations_onedrive_disconnect_post_269);
app.get("/api/integrations/onedrive/status", integrations_onedrive_status_get_270);
app.post("/api/integrations/onedrive/upload-file", integrations_onedrive_upload_file_post_271);
app.get("/api/integrations/qbo/auth-url", integrations_qbo_auth_url_get_272);
app.get("/api/integrations/qbo/callback", integrations_qbo_callback_get_273);
app.post("/api/integrations/qbo/disconnect", integrations_qbo_disconnect_post_274);
app.get("/api/integrations/qbo/status", integrations_qbo_status_get_275);
app.post("/api/integrations/qbo/sync-invoice", integrations_qbo_sync_invoice_post_276);
app.get("/api/integrations/xero/auth-url", integrations_xero_auth_url_get_277);
app.get("/api/integrations/xero/callback", integrations_xero_callback_get_278);
app.post("/api/integrations/xero/disconnect", integrations_xero_disconnect_post_279);
app.get("/api/integrations/xero/status", integrations_xero_status_get_280);
app.post("/api/integrations/xero/sync-customer", integrations_xero_sync_customer_post_281);
app.post("/api/integrations/xero/sync-invoice", integrations_xero_sync_invoice_post_282);
app.post("/api/integrations/xero/webhook", integrations_xero_webhook_post_283);
app.get("/api/invoices", invoices_get_284);
app.post("/api/invoices", invoices_post_285);
app.delete("/api/invoices/:id", invoices_id_delete_286);
app.get("/api/invoices/:id", invoices_id_get_287);
app.put("/api/invoices/:id", invoices_id_put_288);
app.post("/api/invoices/:id/duplicate", invoices_id_duplicate_post_289);
app.get("/api/invoices/:id/export-pdf", invoices_id_export_pdf_get_290);
app.post("/api/invoices/:id/mark-sent", invoices_id_mark_sent_post_291);
app.post("/api/invoices/:id/record-payment", invoices_id_record_payment_post_292);
app.post("/api/invoices/:id/send-email", invoices_id_send_email_post_293);
app.patch("/api/invoices/:id/unlock", invoices_id_unlock_patch_294);
app.post("/api/invoices/:id/void", invoices_id_void_post_295);
app.get("/api/job-cards", job_cards_get_296);
app.post("/api/job-cards", job_cards_post_297);
app.delete("/api/job-cards/:id", job_cards_id_delete_298);
app.get("/api/job-cards/:id", job_cards_id_get_299);
app.put("/api/job-cards/:id", job_cards_id_put_300);
app.post("/api/job-cards/:id/convert", job_cards_id_convert_post_301);
app.post("/api/job-cards/:id/invoice", job_cards_id_invoice_post_302);
app.post("/api/job-cards/:id/photos", job_cards_id_photos_post_303);
app.delete("/api/job-cards/:id/photos/:photoId", job_cards_id_photos_photoId_delete_304);
app.post("/api/job-costs", job_costs_post_305);
app.delete("/api/job-forms/:id", job_forms_id_delete_306);
app.get("/api/job-forms/:id", job_forms_id_get_307);
app.put("/api/job-forms/:id", job_forms_id_put_308);
app.post("/api/job-forms/:id/reset", job_forms_id_reset_post_309);
app.delete("/api/job-forms/:id/share", job_forms_id_share_delete_310);
app.get("/api/job-forms/:id/share", job_forms_id_share_get_311);
app.post("/api/job-forms/:id/share", job_forms_id_share_post_312);
app.get("/api/jobs", jobs_get_313);
app.post("/api/jobs", jobs_post_314);
app.post("/api/jobs/report/generate", jobs_report_generate_post_315);
app.get("/api/jobs/:id", jobs_id_get_316);
app.put("/api/jobs/:id", jobs_id_put_317);
app.post("/api/jobs/:id/attendance/:attendanceId/close", jobs_id_attendance_attendanceId_close_post_318);
app.get("/api/jobs/:id/costs", jobs_id_costs_get_319);
app.post("/api/jobs/:id/costs", jobs_id_costs_post_320);
app.get("/api/jobs/:id/costs/export", jobs_id_costs_export_get_321);
app.delete("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_delete_322);
app.put("/api/jobs/:id/costs/:costId", jobs_id_costs_costId_put_323);
app.get("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_get_324);
app.post("/api/jobs/:id/costs/:costId/receipt", jobs_id_costs_costId_receipt_post_325);
app.get("/api/jobs/:id/delays", jobs_id_delays_get_326);
app.post("/api/jobs/:id/delays", jobs_id_delays_post_327);
app.get("/api/jobs/:id/delays/export-csv", jobs_id_delays_export_csv_get_328);
app.delete("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_delete_329);
app.put("/api/jobs/:id/delays/:delayId", jobs_id_delays_delayId_put_330);
app.get("/api/jobs/:id/documents", jobs_id_documents_get_331);
app.post("/api/jobs/:id/documents", jobs_id_documents_post_332);
app.get("/api/jobs/:id/export-zip", jobs_id_export_zip_get_333);
app.get("/api/jobs/:id/field-docs", jobs_id_field_docs_get_334);
app.get("/api/jobs/:id/files", jobs_id_files_get_335);
app.get("/api/jobs/:id/forms", jobs_id_forms_get_336);
app.post("/api/jobs/:id/forms", jobs_id_forms_post_337);
app.get("/api/jobs/:id/forms/export-csv", jobs_id_forms_export_csv_get_338);
app.delete("/api/jobs/:id/forms/:submissionId", jobs_id_forms_submissionId_delete_339);
app.post("/api/jobs/:id/forms/:submissionId/reopen", jobs_id_forms_submissionId_reopen_post_340);
app.post("/api/jobs/:id/generate-qr", jobs_id_generate_qr_post_341);
app.get("/api/jobs/:id/ledger", jobs_id_ledger_get_342);
app.post("/api/jobs/:id/ledger", jobs_id_ledger_post_343);
app.get("/api/jobs/:id/ledger/export", jobs_id_ledger_export_get_344);
app.post("/api/jobs/:id/ledger/sync", jobs_id_ledger_sync_post_345);
app.delete("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_delete_346);
app.put("/api/jobs/:id/ledger/:entryId", jobs_id_ledger_entryId_put_347);
app.post("/api/jobs/:id/ledger/:entryId/correct", jobs_id_ledger_entryId_correct_post_348);
app.get("/api/jobs/:id/milestones", jobs_id_milestones_get_349);
app.post("/api/jobs/:id/milestones", jobs_id_milestones_post_350);
app.delete("/api/jobs/:id/milestones/:milestoneId", jobs_id_milestones_milestoneId_delete_351);
app.patch("/api/jobs/:id/milestones/:milestoneId", jobs_id_milestones_milestoneId_patch_352);
app.get("/api/jobs/:id/notes/export-csv", jobs_id_notes_export_csv_get_353);
app.get("/api/jobs/:id/photos", jobs_id_photos_get_354);
app.post("/api/jobs/:id/photos", jobs_id_photos_post_355);
app.post("/api/jobs/:id/photos/export-zip", jobs_id_photos_export_zip_post_356);
app.get("/api/jobs/:id/photos/picker", jobs_id_photos_picker_get_357);
app.post("/api/jobs/:id/photos/share", jobs_id_photos_share_post_358);
app.delete("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_delete_359);
app.patch("/api/jobs/:id/photos/:photoId", jobs_id_photos_photoId_patch_360);
app.get("/api/jobs/:id/photos/:photoId/download", jobs_id_photos_photoId_download_get_361);
app.post("/api/jobs/:id/photos/:photoId/replace", jobs_id_photos_photoId_replace_post_362);
app.get("/api/jobs/:id/photos/:photoId/report-image", jobs_id_photos_photoId_report_image_get_363);
app.get("/api/jobs/:id/progress", jobs_id_progress_get_364);
app.put("/api/jobs/:id/progress", jobs_id_progress_put_365);
app.get("/api/jobs/:id/progress/export-csv", jobs_id_progress_export_csv_get_366);
app.get("/api/jobs/:id/progress/report", jobs_id_progress_report_get_367);
app.put("/api/jobs/:id/progress/report", jobs_id_progress_report_put_368);
app.get("/api/jobs/:id/progress/report/pdf", jobs_id_progress_report_pdf_get_369);
app.post("/api/jobs/:id/progress/sync", jobs_id_progress_sync_post_370);
app.get("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_get_371);
app.post("/api/jobs/:id/purchase-orders", jobs_id_purchase_orders_post_372);
app.delete("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_delete_373);
app.get("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_get_374);
app.put("/api/jobs/:id/purchase-orders/:poId", jobs_id_purchase_orders_poId_put_375);
app.get("/api/jobs/:id/purchase-orders/:poId/pdf", jobs_id_purchase_orders_poId_pdf_get_376);
app.post("/api/jobs/:id/report/pdf", jobs_id_report_pdf_post_377);
app.get("/api/jobs/:id/risky", jobs_id_risky_get_378);
app.post("/api/jobs/:id/risky", jobs_id_risky_post_379);
app.get("/api/jobs/:id/risky/:riskyId", jobs_id_risky_riskyId_get_380);
app.put("/api/jobs/:id/risky/:riskyId", jobs_id_risky_riskyId_put_381);
app.post("/api/jobs/:id/risky/:riskyId/finalise", jobs_id_risky_riskyId_finalise_post_382);
app.post("/api/jobs/:id/risky/:riskyId/signatures", jobs_id_risky_riskyId_signatures_post_383);
app.post("/api/jobs/:id/risky/:riskyId/supervisor-signoff", jobs_id_risky_riskyId_supervisor_signoff_post_384);
app.post("/api/jobs/:id/signin", jobs_id_signin_post_385);
app.post("/api/jobs/:id/signin-qr", jobs_id_signin_qr_post_386);
app.get("/api/jobs/:id/signin-status", jobs_id_signin_status_get_387);
app.post("/api/jobs/:id/signout", jobs_id_signout_post_388);
app.post("/api/jobs/:id/signout-qr", jobs_id_signout_qr_post_389);
app.post("/api/jobs/:id/signout-user", jobs_id_signout_user_post_390);
app.get("/api/jobs/:id/site-prestarts", jobs_id_site_prestarts_get_391);
app.post("/api/jobs/:id/site-prestarts", jobs_id_site_prestarts_post_392);
app.get("/api/jobs/:id/site-prestarts/:prestartId", jobs_id_site_prestarts_prestartId_get_393);
app.put("/api/jobs/:id/site-prestarts/:prestartId", jobs_id_site_prestarts_prestartId_put_394);
app.post("/api/jobs/:id/site-prestarts/:prestartId/finalise", jobs_id_site_prestarts_prestartId_finalise_post_395);
app.post("/api/jobs/:id/site-prestarts/:prestartId/workers", jobs_id_site_prestarts_prestartId_workers_post_396);
app.get("/api/jobs/:id/swms", jobs_id_swms_get_397);
app.post("/api/jobs/:id/swms", jobs_id_swms_post_398);
app.post("/api/jobs/:id/swms/:swmsId/signoff", jobs_id_swms_swmsId_signoff_post_399);
app.get("/api/jobs/:id/todos", jobs_id_todos_get_400);
app.post("/api/jobs/:id/todos", jobs_id_todos_post_401);
app.delete("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_delete_402);
app.put("/api/jobs/:id/todos/:todoId", jobs_id_todos_todoId_put_403);
app.get("/api/library/items", library_items_get_404);
app.get("/api/library/items/:id", library_items_id_get_405);
app.patch("/api/library/items/:id", library_items_id_patch_406);
app.get("/api/library/items/:id/download", library_items_id_download_get_407);
app.delete("/api/library/items/:id/install", library_items_id_install_delete_408);
app.post("/api/library/items/:id/install", library_items_id_install_post_409);
app.get("/api/library/my-installed", library_my_installed_get_410);
app.get("/api/library/my-submissions", library_my_submissions_get_411);
app.get("/api/lists", lists_get_412);
app.get("/api/me", me_get_413);
app.put("/api/me", me_put_414);
app.post("/api/me/2fa/disable", me_2fa_disable_post_415);
app.post("/api/me/2fa/enable", me_2fa_enable_post_416);
app.get("/api/me/2fa/setup", me_2fa_setup_get_417);
app.get("/api/me/2fa/status", me_2fa_status_get_418);
app.post("/api/me/2fa/verify", me_2fa_verify_post_419);
app.get("/api/me/active-status", me_active_status_get_420);
app.post("/api/me/change-password", me_change_password_post_421);
app.get("/api/me/email-status", me_email_status_get_422);
app.get("/api/me/phone", me_phone_get_423);
app.put("/api/me/phone", me_phone_put_424);
app.delete("/api/me/profile-attachments", me_profile_attachments_delete_425);
app.post("/api/me/profile-attachments", me_profile_attachments_post_426);
app.get("/api/me/profile-extras", me_profile_extras_get_427);
app.put("/api/me/profile-extras", me_profile_extras_put_428);
app.post("/api/migrate-account-recovery", migrate_account_recovery_post_429);
app.post("/api/migrate-asset-manager", migrate_asset_manager_post_430);
app.post("/api/migrate-attendance", migrate_attendance_post_431);
app.post("/api/migrate-company-settings", migrate_company_settings_post_432);
app.post("/api/migrate-dazza-audit", migrate_dazza_audit_post_433);
app.post("/api/migrate-dazza-knowledge", migrate_dazza_knowledge_post_434);
app.post("/api/migrate-emergency-alerts", migrate_emergency_alerts_post_435);
app.post("/api/migrate-estimates", migrate_estimates_post_436);
app.post("/api/migrate-estimating-library", migrate_estimating_library_post_437);
app.post("/api/migrate-files", migrate_files_post_438);
app.post("/api/migrate-fleet", migrate_fleet_post_439);
app.post("/api/migrate-fleet-analytics", migrate_fleet_analytics_post_440);
app.post("/api/migrate-fleet-driver-sessions", migrate_fleet_driver_sessions_post_441);
app.post("/api/migrate-fleet-usage", migrate_fleet_usage_post_442);
app.post("/api/migrate-form-fields", migrate_form_fields_post_443);
app.post("/api/migrate-form-logic", migrate_form_logic_post_444);
app.post("/api/migrate-form-templates", migrate_form_templates_post_445);
app.post("/api/migrate-job-forms", migrate_job_forms_post_446);
app.post("/api/migrate-job-photo-shares", migrate_job_photo_shares_post_447);
app.post("/api/migrate-job-photos", migrate_job_photos_post_448);
app.post("/api/migrate-job-tabs", migrate_job_tabs_post_449);
app.post("/api/migrate-jobs", migrate_jobs_post_450);
app.post("/api/migrate-ledger-photo", migrate_ledger_photo_post_451);
app.post("/api/migrate-library", migrate_library_post_452);
app.post("/api/migrate-library-downloads", migrate_library_downloads_post_453);
app.post("/api/migrate-notifications", migrate_notifications_post_454);
app.post("/api/migrate-owner-console", migrate_owner_console_post_455);
app.post("/api/migrate-owner-role", migrate_owner_role_post_456);
app.post("/api/migrate-pdf-settings", migrate_pdf_settings_post_457);
app.post("/api/migrate-plan-manager", migrate_plan_manager_post_458);
app.post("/api/migrate-plan-manager-v2", migrate_plan_manager_v2_post_459);
app.post("/api/migrate-plan-manager-v3", migrate_plan_manager_v3_post_460);
app.post("/api/migrate-safety", migrate_safety_post_461);
app.post("/api/migrate-site-prestart", migrate_site_prestart_post_462);
app.post("/api/migrate-sms-verified-at", migrate_sms_verified_at_post_463);
app.post("/api/migrate-starter-pack", migrate_starter_pack_post_464);
app.post("/api/migrate-studio-pdf", migrate_studio_pdf_post_465);
app.post("/api/migrate-subscriptions", migrate_subscriptions_post_466);
app.post("/api/migrate-support-mode", migrate_support_mode_post_467);
app.post("/api/migrate-takeoff-pad", migrate_takeoff_pad_post_468);
app.post("/api/migrate-team", migrate_team_post_469);
app.get("/api/notes", notes_get_470);
app.post("/api/notes", notes_post_471);
app.post("/api/notes/comments", notes_comments_post_472);
app.post("/api/notes/migrate", notes_migrate_post_473);
app.delete("/api/notes/:id", notes_id_delete_474);
app.get("/api/notifications/alerts", notifications_alerts_get_475);
app.get("/api/notifications/prefs", notifications_prefs_get_476);
app.put("/api/notifications/prefs", notifications_prefs_put_477);
app.post("/api/notifications/read", notifications_read_post_478);
app.get("/api/owner-console/activity", owner_console_activity_get_479);
app.get("/api/owner-console/cancellation-feedback", owner_console_cancellation_feedback_get_480);
app.get("/api/owner-console/companies", owner_console_companies_get_481);
app.post("/api/owner-console/companies", owner_console_companies_post_482);
app.get("/api/owner-console/companies/usage", owner_console_companies_usage_get_483);
app.put("/api/owner-console/companies/:id/limits", owner_console_companies_id_limits_put_484);
app.get("/api/owner-console/form-templates", owner_console_form_templates_get_485);
app.post("/api/owner-console/form-templates", owner_console_form_templates_post_486);
app.get("/api/owner-console/library/items", owner_console_library_items_get_487);
app.post("/api/owner-console/library/items", owner_console_library_items_post_488);
app.delete("/api/owner-console/library/items/:id", owner_console_library_items_id_delete_489);
app.patch("/api/owner-console/library/items/:id", owner_console_library_items_id_patch_490);
app.put("/api/owner-console/library/items/:id", owner_console_library_items_id_put_491);
app.post("/api/owner-console/library/items/:id/push-update", owner_console_library_items_id_push_update_post_492);
app.get("/api/owner-console/library/submissions", owner_console_library_submissions_get_493);
app.post("/api/owner-console/library/submissions/:id/review", owner_console_library_submissions_id_review_post_494);
app.get("/api/owner-console/starter-pack", owner_console_starter_pack_get_495);
app.post("/api/owner-console/starter-pack", owner_console_starter_pack_post_496);
app.get("/api/owner-console/stats", owner_console_stats_get_497);
app.get("/api/owner-console/storage", owner_console_storage_get_498);
app.get("/api/owner-console/swms/masters", owner_console_swms_masters_get_499);
app.post("/api/owner-console/swms/masters", owner_console_swms_masters_post_500);
app.post("/api/owner-console/swms/masters/publish-all", owner_console_swms_masters_publish_all_post_501);
app.delete("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_delete_502);
app.get("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_get_503);
app.put("/api/owner-console/swms/masters/:id", owner_console_swms_masters_id_put_504);
app.post("/api/owner-console/swms/masters/:id/publish", owner_console_swms_masters_id_publish_post_505);
app.post("/api/owner-console/swms/migrate-master-library", owner_console_swms_migrate_master_library_post_506);
app.post("/api/owner-console/swms/push", owner_console_swms_push_post_507);
app.post("/api/owner-console/swms/seed-bricklaying", owner_console_swms_seed_bricklaying_post_508);
app.post("/api/owner-console/swms/seed-building-inspection", owner_console_swms_seed_building_inspection_post_509);
app.post("/api/owner-console/swms/seed-cabinets", owner_console_swms_seed_cabinets_post_510);
app.post("/api/owner-console/swms/seed-carpenter-fixing", owner_console_swms_seed_carpenter_fixing_post_511);
app.post("/api/owner-console/swms/seed-carpenter-framing", owner_console_swms_seed_carpenter_framing_post_512);
app.post("/api/owner-console/swms/seed-carpenter-lockup", owner_console_swms_seed_carpenter_lockup_post_513);
app.post("/api/owner-console/swms/seed-ceramic-tiling", owner_console_swms_seed_ceramic_tiling_post_514);
app.post("/api/owner-console/swms/seed-concreting-slab", owner_console_swms_seed_concreting_slab_post_515);
app.post("/api/owner-console/swms/seed-delivery-loading", owner_console_swms_seed_delivery_loading_post_516);
app.post("/api/owner-console/swms/seed-environmental-spill", owner_console_swms_seed_environmental_spill_post_517);
app.post("/api/owner-console/swms/seed-ewp", owner_console_swms_seed_ewp_post_518);
app.post("/api/owner-console/swms/seed-excavations-substation", owner_console_swms_seed_excavations_substation_post_519);
app.post("/api/owner-console/swms/seed-fencing", owner_console_swms_seed_fencing_post_520);
app.post("/api/owner-console/swms/seed-heat-stress", owner_console_swms_seed_heat_stress_post_521);
app.post("/api/owner-console/swms/seed-landscaping", owner_console_swms_seed_landscaping_post_522);
app.post("/api/owner-console/swms/seed-live-parts", owner_console_swms_seed_live_parts_post_523);
app.post("/api/owner-console/swms/seed-manual-handling", owner_console_swms_seed_manual_handling_post_524);
app.post("/api/owner-console/swms/seed-moving-plant", owner_console_swms_seed_moving_plant_post_525);
app.post("/api/owner-console/swms/seed-painting", owner_console_swms_seed_painting_post_526);
app.post("/api/owner-console/swms/seed-power-tools", owner_console_swms_seed_power_tools_post_527);
app.post("/api/owner-console/swms/seed-silica-dust", owner_console_swms_seed_silica_dust_post_528);
app.post("/api/owner-console/swms/seed-traffic-management", owner_console_swms_seed_traffic_management_post_529);
app.post("/api/owner-console/swms/seed-underground-services", owner_console_swms_seed_underground_services_post_530);
app.post("/api/owner-console/swms/seed-vacuum-excavation", owner_console_swms_seed_vacuum_excavation_post_531);
app.post("/api/owner-console/system-ai/builtin-checks", owner_console_system_ai_builtin_checks_post_532);
app.get("/api/owner-console/users", owner_console_users_get_533);
app.post("/api/owner-console/users/verify", owner_console_users_verify_post_534);
app.get("/api/plan-manager/drawings", plan_manager_drawings_get_535);
app.post("/api/plan-manager/drawings", plan_manager_drawings_post_536);
app.get("/api/plan-manager/drawings/:id", plan_manager_drawings_id_get_537);
app.put("/api/plan-manager/drawings/:id/annotations", plan_manager_drawings_id_annotations_put_538);
app.post("/api/plan-manager/drawings/:id/archive", plan_manager_drawings_id_archive_post_539);
app.delete("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_delete_540);
app.post("/api/plan-manager/drawings/:id/job-links", plan_manager_drawings_id_job_links_post_541);
app.get("/api/plan-manager/drawings/:id/pages/:pageNo/annotations", plan_manager_drawings_id_pages_pageNo_annotations_get_542);
app.delete("/api/plan-manager/drawings/:id/permanent", plan_manager_drawings_id_permanent_delete_543);
app.patch("/api/plan-manager/drawings/:id/reorder", plan_manager_drawings_id_reorder_patch_544);
app.post("/api/plan-manager/drawings/:id/restore", plan_manager_drawings_id_restore_post_545);
app.post("/api/plan-manager/drawings/:id/revisions", plan_manager_drawings_id_revisions_post_546);
app.post("/api/plan-manager/drawings/:id/revisions/:revisionId/finalize", plan_manager_drawings_id_revisions_revisionId_finalize_post_547);
app.post("/api/plan-manager/drawings/:id/upload", plan_manager_drawings_id_upload_post_548);
app.get("/api/plan-manager/jobs/:jobId/drawings-zip", plan_manager_jobs_jobId_drawings_zip_get_549);
app.get("/api/plan-manager/jobs-with-drawings", plan_manager_jobs_with_drawings_get_550);
app.post("/api/plan-manager/share", plan_manager_share_post_551);
app.get("/api/plan-manager/share/validate", plan_manager_share_validate_get_552);
app.post("/api/portal/estimates/:id/approve", portal_estimates_id_approve_post_553);
app.post("/api/portal/invite", portal_invite_post_554);
app.post("/api/portal/invoices/:id/pay", portal_invoices_id_pay_post_555);
app.get("/api/portal/jobs", portal_jobs_get_556);
app.get("/api/portal/jobs/:id", portal_jobs_id_get_557);
app.post("/api/portal/migrate", portal_migrate_post_558);
app.post("/api/portal/validate", portal_validate_post_559);
app.get("/api/public/form/:token", public_form_token_get_560);
app.post("/api/public/form/:token/submit", public_form_token_submit_post_561);
app.get("/api/public/job-photos/:token", public_job_photos_token_get_562);
app.get("/api/public/job-photos/:token/photo/:photoId", public_job_photos_token_photo_photoId_get_563);
app.get("/api/public/swms/:token", public_swms_token_get_564);
app.post("/api/public/swms/:token/signoff", public_swms_token_signoff_post_565);
app.delete("/api/push/subscribe", push_subscribe_delete_566);
app.post("/api/push/subscribe", push_subscribe_post_567);
app.get("/api/push/vapid-key", push_vapid_key_get_568);
app.get("/api/quick-links/site-meta", quick_links_site_meta_get_569);
app.get("/api/recipes", recipes_get_570);
app.post("/api/recipes", recipes_post_571);
app.delete("/api/recipes/:id", recipes_id_delete_572);
app.put("/api/recipes/:id", recipes_id_put_573);
app.get("/api/risk-register", risk_register_get_574);
app.post("/api/risk-register", risk_register_post_575);
app.get("/api/risk-register/:id", risk_register_id_get_576);
app.put("/api/risk-register/:id", risk_register_id_put_577);
app.post("/api/risk-register/:id/archive", risk_register_id_archive_post_578);
app.post("/api/risk-register/:id/unarchive", risk_register_id_unarchive_post_579);
app.post("/api/safety/ai/draft", safety_ai_draft_post_580);
app.get("/api/safety/documents", safety_documents_get_581);
app.post("/api/safety/documents", safety_documents_post_582);
app.delete("/api/safety/documents/:id", safety_documents_id_delete_583);
app.get("/api/safety/documents/:id/download", safety_documents_id_download_get_584);
app.get("/api/safety/generated-posters", safety_generated_posters_get_585);
app.post("/api/safety/generated-posters", safety_generated_posters_post_586);
app.delete("/api/safety/generated-posters/:id", safety_generated_posters_id_delete_587);
app.get("/api/safety/job-safety-plans", safety_job_safety_plans_get_588);
app.post("/api/safety/job-safety-plans", safety_job_safety_plans_post_589);
app.delete("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_delete_590);
app.put("/api/safety/job-safety-plans/:id", safety_job_safety_plans_id_put_591);
app.get("/api/safety/job-swms", safety_job_swms_get_592);
app.post("/api/safety/job-swms", safety_job_swms_post_593);
app.delete("/api/safety/job-swms/:id", safety_job_swms_id_delete_594);
app.get("/api/safety/job-swms/:id", safety_job_swms_id_get_595);
app.put("/api/safety/job-swms/:id", safety_job_swms_id_put_596);
app.post("/api/safety/job-swms/:id/share-token", safety_job_swms_id_share_token_post_597);
app.get("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_get_598);
app.post("/api/safety/job-swms/:id/signoffs", safety_job_swms_id_signoffs_post_599);
app.delete("/api/safety/job-swms/:id/signoffs/:signoffId", safety_job_swms_id_signoffs_signoffId_delete_600);
app.get("/api/safety/plans", safety_plans_get_601);
app.post("/api/safety/plans", safety_plans_post_602);
app.post("/api/safety/plans/seed", safety_plans_seed_post_603);
app.delete("/api/safety/plans/:id", safety_plans_id_delete_604);
app.put("/api/safety/plans/:id", safety_plans_id_put_605);
app.get("/api/safety/plans/:id/export", safety_plans_id_export_get_606);
app.get("/api/safety/plans/:id/pack", safety_plans_id_pack_get_607);
app.get("/api/safety/posters", safety_posters_get_608);
app.post("/api/safety/posters", safety_posters_post_609);
app.delete("/api/safety/posters/:id", safety_posters_id_delete_610);
app.get("/api/safety/swms", safety_swms_get_611);
app.post("/api/safety/swms", safety_swms_post_612);
app.post("/api/safety/swms/import-docx", safety_swms_import_docx_post_613);
app.post("/api/safety/swms/seed", safety_swms_seed_post_614);
app.delete("/api/safety/swms/:id", safety_swms_id_delete_615);
app.get("/api/safety/swms/:id", safety_swms_id_get_616);
app.put("/api/safety/swms/:id", safety_swms_id_put_617);
app.post("/api/safety/swms/:id/duplicate", safety_swms_id_duplicate_post_618);
app.get("/api/safety/swms/:id/export", safety_swms_id_export_get_619);
app.post("/api/safety/swms/:id/publish-to-library", safety_swms_id_publish_to_library_post_620);
app.get("/api/scheduler/crew", scheduler_crew_get_621);
app.get("/api/scheduler/jobs", scheduler_jobs_get_622);
app.patch("/api/scheduler/jobs/:id/reschedule", scheduler_jobs_id_reschedule_patch_623);
app.get("/api/scheduler/tasks", scheduler_tasks_get_624);
app.get("/api/secure-share", secure_share_get_625);
app.post("/api/secure-share", secure_share_post_626);
app.delete("/api/secure-share/:id", secure_share_id_delete_627);
app.get("/api/secure-share/:token", secure_share_token_get_628);
app.post("/api/secure-share/:token", secure_share_token_post_629);
app.get("/api/settings/backup", settings_backup_get_630);
app.post("/api/settings/backup", settings_backup_post_631);
app.get("/api/settings/backup/company-data", settings_backup_company_data_get_632);
app.get("/api/settings/backup/csv-pack", settings_backup_csv_pack_get_633);
app.get("/api/settings/backup/export", settings_backup_export_get_634);
app.post("/api/settings/backup/run", settings_backup_run_post_635);
app.get("/api/settings/backup-destination", settings_backup_destination_get_636);
app.post("/api/settings/backup-destination", settings_backup_destination_post_637);
app.get("/api/settings/dazza-ai-key", settings_dazza_ai_key_get_638);
app.post("/api/settings/dazza-ai-key", settings_dazza_ai_key_post_639);
app.get("/api/settings/file-transfer-backup", settings_file_transfer_backup_get_640);
app.post("/api/settings/file-transfer-backup", settings_file_transfer_backup_post_641);
app.get("/api/settings/retention", settings_retention_get_642);
app.post("/api/settings/retention", settings_retention_post_643);
app.get("/api/settings/storage-provider", settings_storage_provider_get_644);
app.get("/api/settings/storage-provider/debug", settings_storage_provider_debug_get_645);
app.post("/api/settings/storage-provider/test", settings_storage_provider_test_post_646);
app.get("/api/settings/terminology", settings_terminology_get_647);
app.post("/api/settings/terminology", settings_terminology_post_648);
app.get("/api/settings/xero-credentials", settings_xero_credentials_get_649);
app.post("/api/settings/xero-credentials", settings_xero_credentials_post_650);
app.get("/api/share/:token", share_token_get_651);
app.get("/api/signin-history", signin_history_get_652);
app.post("/api/signup", signup_post_653);
app.get("/api/sos", sos_get_654);
app.post("/api/sos/acknowledge", sos_acknowledge_post_655);
app.post("/api/sos/trigger", sos_trigger_post_656);
app.post("/api/stakeholders/sms", stakeholders_sms_post_657);
app.post("/api/stripe/create-checkout-session", stripe_create_checkout_session_post_658);
app.get("/api/stripe/session/:sessionId", stripe_session_sessionId_get_659);
app.post("/api/subscription/create-checkout", subscription_create_checkout_post_660);
app.get("/api/subscription/status", subscription_status_get_661);
app.post("/api/subscription/webhook", subscription_webhook_post_662);
app.get("/api/support-mode/audit", support_mode_audit_get_663);
app.get("/api/support-mode/checklist", support_mode_checklist_get_664);
app.put("/api/support-mode/checklist", support_mode_checklist_put_665);
app.post("/api/support-mode/enter", support_mode_enter_post_666);
app.post("/api/support-mode/exit", support_mode_exit_post_667);
app.get("/api/support-mode/status", support_mode_status_get_668);
app.get("/api/tag-tasks", tag_tasks_get_669);
app.patch("/api/tag-tasks/:id", tag_tasks_id_patch_670);
app.get("/api/takeoff-pad", takeoff_pad_get_671);
app.put("/api/takeoff-pad", takeoff_pad_put_672);
app.post("/api/tasks", tasks_post_673);
app.put("/api/tasks/:id", tasks_id_put_674);
app.get("/api/team", team_get_675);
app.post("/api/team/invite", team_invite_post_676);
app.get("/api/team/invites", team_invites_get_677);
app.post("/api/team/invites", team_invites_post_678);
app.post("/api/team/invites/:id/cancel", team_invites_id_cancel_post_679);
app.post("/api/team/invites/:id/resend", team_invites_id_resend_post_680);
app.get("/api/team/members", team_members_get_681);
app.get("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_get_682);
app.put("/api/team/members/:id/icon-permissions", team_members_id_icon_permissions_put_683);
app.post("/api/team/resend-verification", team_resend_verification_post_684);
app.post("/api/team/schedule/migrate", team_schedule_migrate_post_685);
app.get("/api/team/shifts", team_shifts_get_686);
app.post("/api/team/shifts", team_shifts_post_687);
app.delete("/api/team/shifts/:id", team_shifts_id_delete_688);
app.put("/api/team/shifts/:id", team_shifts_id_put_689);
app.get("/api/team/time-entries", team_time_entries_get_690);
app.post("/api/team/time-entries", team_time_entries_post_691);
app.get("/api/team/time-entries/export", team_time_entries_export_get_692);
app.put("/api/team/time-entries/:id", team_time_entries_id_put_693);
app.post("/api/team/verify-user", team_verify_user_post_694);
app.delete("/api/team/:id", team_id_delete_695);
app.put("/api/team/:id", team_id_put_696);
app.get("/api/usage", usage_get_697);
app.get("/api/user-logs", user_logs_get_698);
app.get("/api/user-logs/users", user_logs_users_get_699);
// </api-registrations>
