...
export default async function handler(req: Request, res: Response) {
  try {
    ...
    const fromName     = settings['from_name']                  || 'IWIIlBUILD';
    ...
    await sendEmail({
      ...
      replyTo,
      fromName,
      subject: `[TEST] IWIIlBUILD Email Settings — ${now}`,
      html: `
