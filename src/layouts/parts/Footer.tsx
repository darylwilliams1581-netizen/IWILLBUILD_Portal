      ...
      >
        ...
        <div>
          <Link to="/" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, textDecoration: 'none', marginBottom: 14 }}>
            ...
            <strong style={{ fontSize: 17, letterSpacing: '-0.03em', color: '#f1f5f9', fontFamily: "'Space Grotesk', sans-serif" }}>
              IWILLBUILD
            </strong>
          </Link>
          <p style={{ fontSize: 13, lineHeight: 1.65, maxWidth: 260, color: '#64748b' }}>
        ...
        <div>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              ...
              { href: '/studio/estimates', label: 'Estimating' },
              { href: '/studio/fleet',     label: 'Fleet' },
      ...
      <div style={{ borderTop: '1px solid #1e293b' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 20 }}>
            <Link to="/privacy" style={{ fontSize: 12, color: '#334155', textDecoration: 'none' }} className="hover:text-slate-300">
              Privacy
            </Link>
            <Link to="/terms" style={{ fontSize: 12, color: '#334155', textDecoration: 'none' }} className="hover:text-slate-300">
              Terms
            </Link>
            <a href="mailto:support@iwillbuild.com" style={{ fontSize: 12, color: '#334155', textDecoration: 'none' }} className="hover:text-slate-300">
              Contact
            </a>
          </div>
        </div>
