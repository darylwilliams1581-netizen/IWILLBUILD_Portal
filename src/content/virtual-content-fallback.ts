...
export const forms: {
  ...
  page: { title: 'Forms — IWIIlBUILD', heading: 'Forms', metaDescription: 'Manage form templates for jobs, fleet, safety and company operations.' },
...
export const job_field_docs: {
  ...
  page: { title: 'Field Docs | IWIIlBUILD', heading: 'Field Docs', metaDescription: 'View, review and sign on to job documents in the field.' },
...
export const login: {
  ...
  page: { title: 'Sign In — IWIIlBUILD Portal', metaDescription: 'Sign in to the IWIIlBUILD portal to manage jobs, crews, fleet, safety and more.', ogTitle: 'Sign In — IWIIlBUILD Portal', ogDescription: 'Sign in to manage your construction jobs, fleet, safety docs and team.' },
